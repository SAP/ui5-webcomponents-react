...
Since the UI5 Web Components for React are based on the `ResizeObserver` and `matchMedia` API, you'll need to polyfill both APIs.
Therefore, create (or edit) your `src/setupTests.js` file:
