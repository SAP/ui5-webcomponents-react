import { Meta, Story, Preview, Title } from '@storybook/addon-docs/blocks';
...
In order to make your app translatable into various languages, you need to import import the following assets:
...
5. **Use texts with placeholder values**
   ...
   arbitrary number of parameters which should be inserted in the translation.
