...
import { MessageStrip, Link } from '@ui5/webcomponents-react';
...
Our community is starting to create templates for UI5 Web Components for React as well! 🎉
You can find the templates in a dedicated [ui5-web-components-templates](https://github.com/ui5-web-components-templates) organization.<br />
A huge "Thank You" goes to [@afuscella](https://github.com/afuscella) for kicking this off!
...
Example - `Popover` with `Ref` type declaration:
...
`@ui5/webcomponents` offers a variety of [feature (side-effect) imports](https://sap.github.io/ui5-webcomponents/playground/getting-started/using-features/) that are available with `@ui5/webcomponents-react` as well.
