...
Please read through the projects' `README` before continuing.
...
_In case you have also other alternatives for improving the bundle size, please feel free to submit a pull request!_
