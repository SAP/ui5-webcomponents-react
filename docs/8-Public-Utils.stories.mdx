...
import { Label, MessageStrip, MessageStripType } from '@ui5/webcomponents-react';
...
<ImportStatement>{`import { useI18nBundle } from '@ui5/webcomponents-react-base/dist/hooks';`}</ImportStatement>
...
<ImportStatement>{`import { useViewportRange } from '@ui5/webcomponents-react-base/dist/hooks';`}</ImportStatement>
