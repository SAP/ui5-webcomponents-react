...
> UI5 Web Components for React **will not** load any of the UI5 Web Components by itself but expects you to provide
> the UI5 Web Components you need. This might be useful for building micro-frontends where your host application
> is already providing the required UI5 Web Components.
>
