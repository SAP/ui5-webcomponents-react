...
_Please also read the [general configuration](https://sap.github.io/ui5-webcomponents/playground/advanced/configuration/) and [i18n documentation](https://sap.github.io/ui5-webcomponents/playground/advanced/using-i18n-for-apps/) of UI5 Web Components._
...
<MessageStrip design={MessageStripDesign.Information} hideCloseButton>
  ...
  <a
    href="https://sap.github.io/ui5-webcomponents/playground/advanced/configuration/#fetchDefaultLanguage"
    target="_blank"
  >
    here
  </a>
...
<MessageStrip design={MessageStripDesign.Information} hideCloseButton>
  If you used <code>create-react-app</code> to create your React application, you can use the <code>public</code> folder
...
<MessageStrip design={MessageStripDesign.Information} hideCloseButton>
  This is just asset registration, no data will be fetched at that point.
</MessageStrip>
