...
<MessageStrip type={MessageStripType.Information} noCloseButton>
...
In case you need the full functionality of the `Logger`, feel free to copy to [source code](https://github.com/SAP/ui5-webcomponents-react/blob/7e060c85d9a247ceb296a9e720d8d393ed68782e/packages/base/src/utils/Logger.ts) into your project.
