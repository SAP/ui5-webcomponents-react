...
- `Device.media.attachHandler` is replaced by `attachHandler` (`'import { attachHandler } from '@ui5/webcomponents-react-base/lib/Media;'`)<br />
  In addition, the second, optional parameter `oListener` got removed from `attachHandler`.
- `Device.media.detachHandler` is replaced by `detachHandler` (`'import { detachHandler } from '@ui5/webcomponents-react-base/lib/Media;'`)<br />
