import{j as e}from"./useIsomorphicLayoutEffect-CRjHBNH3.js";import{r as h,i as k}from"./Boot-C8BaHzi_.js";import{r as f}from"./Icons-YiE9tW4T.js";import{a as B}from"./add-BjGfjR-d.js";import{e as G}from"./employee-CM2OuJvM.js";import{s as J}from"./settings-D8UgBKC0.js";import{b as R,a as g,c as K,d as q,T as t}from"./index-Pf_YMyzo.js";import{_ as Q}from"./iframe-Cx73w9cb.js";import{U as X,e as S}from"./UI5Element-B2h7kErG.js";import{a as x,l as i,b as w,s as H,p as Y,c as Z,d as ee,w as te}from"./withWebComponent-D63zXRZq.js";import{o as y}from"./class-map-BQhMMhlU.js";import{s as v}from"./style-map-BqCgMbDz.js";import{s as F}from"./parameters-bundle.css-_D3nLw4H.js";function ae(a,n,o){return x`<div id="${i(this._id)}" role="separator" class="${y(this.classes.root)}" .realTabReference="${i(this)}"></div>`}function ne(a,n,o){return o?x`<${w("ui5-li-custom",n,o)} id="${i(this._id)}" role="separator" class="${y(this.classes.root)}" disabled style="${v(this._style)}" .realTabReference="${i(this)}"></${w("ui5-li-custom",n,o)}>`:x`<ui5-li-custom id="${i(this._id)}" role="separator" class="${y(this.classes.root)}" disabled style="${v(this._style)}" .realTabReference="${i(this)}"></ui5-li-custom>`}h("@ui5/webcomponents-theming","sap_horizon",async()=>H);h("@ui5/webcomponents","sap_horizon",async()=>F);const oe={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInStrip.css.ts",content:`.ui5-tc__separator{position:relative;width:.5625rem}.ui5-tc__separator:before{content:" ";position:absolute;width:.0625rem;left:.25rem;top:.5rem;bottom:.5rem;background:var(--sapGroup_TitleBorderColor)}
