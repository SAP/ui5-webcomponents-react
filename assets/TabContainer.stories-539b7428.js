import{j as e}from"./jsx-runtime-d079401a.js";import{r as u,U as W,v as y,m as H}from"./UI5Element-a4bd3d38.js";import{r as h}from"./Icons-74c917eb.js";import{a as U}from"./add-bbbd01bc.js";import{e as G}from"./employee-05c578de.js";import{s as J}from"./settings-b88df6a9.js";import{b as k,a as f,c as K,d as S,T as t}from"./index-0ce667b9.js";import{_ as Q}from"./iframe-4e2a5c10.js";import{b as g,l as _,d as v,s as M,a as F,c as X,f as Y,w as Z}from"./withWebComponent-7d7e5133.js";import{o as q}from"./class-map-0ab40ab9.js";import{s as w}from"./style-map-132a30d8.js";function ee(a,n,o){return g`<div id="${_(this._id)}" role="separator" class="${q(this.classes.root)}"></div>`}function te(a,n,o){return o?g`<${v("ui5-li-custom",n,o)} id="${_(this._id)}" role="separator" class="${q(this.classes.root)}" disabled style="${w(this._style)}"></${v("ui5-li-custom",n,o)}>`:g`<ui5-li-custom id="${_(this._id)}" role="separator" class="${q(this.classes.root)}" disabled style="${w(this._style)}"></ui5-li-custom>`}u("@ui5/webcomponents-theming","sap_fiori_3",async()=>M);u("@ui5/webcomponents","sap_fiori_3",async()=>F);const ae={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInStrip.css",content:`.ui5-tc__separator {
	width: 0;
	border-left: 0.0625rem solid var(--sapGroup_TitleBorderColor);
	margin: 0.5rem 0.25rem;
}
`};u("@ui5/webcomponents-theming","sap_fiori_3",async()=>M);u("@ui5/webcomponents","sap_fiori_3",async()=>F);const ne={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInOverflow.css",content:`.ui5-tc__separator {
	min-height: 0.25rem;
...
//# sourceMappingURL=TabContainer.stories-539b7428.js.map
