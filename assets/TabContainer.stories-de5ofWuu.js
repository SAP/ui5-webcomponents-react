import{j as e}from"./jsx-runtime-DtaoT6pD.js";import{r as u,U as W,u as y,h as k}from"./UI5Element-_cJDeK03.js";import{r as h}from"./Icons-dG5I7pqk.js";import{a as U}from"./add-6BLy2D4s.js";import{e as G}from"./employee-2wNDT3_m.js";import{s as J}from"./settings-ljbZAoEU.js";import{b as H,a as f,c as K,d as S,T as t}from"./index-oXCXficU.js";import{_ as Q}from"./iframe-osxsEg1I.js";import{a as g,l as q,b as w,s as M,c as X,f as Y,w as Z}from"./withWebComponent--kEkWNJH.js";import{o as _}from"./class-map-Y-YjCFqX.js";import{s as v}from"./style-map-5njKSr-C.js";import{s as F}from"./parameters-bundle.css-mPCp9TQx.js";function ee(a,n,o){return g`<div id="${q(this._id)}" role="separator" class="${_(this.classes.root)}"></div>`}function te(a,n,o){return o?g`<${w("ui5-li-custom",n,o)} id="${q(this._id)}" role="separator" class="${_(this.classes.root)}" disabled style="${v(this._style)}"></${w("ui5-li-custom",n,o)}>`:g`<ui5-li-custom id="${q(this._id)}" role="separator" class="${_(this.classes.root)}" disabled style="${v(this._style)}"></ui5-li-custom>`}u("@ui5/webcomponents-theming","sap_horizon",async()=>M);u("@ui5/webcomponents","sap_horizon",async()=>F);const ae={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInStrip.css.ts",content:`.ui5-tc__separator{width:0;border-left:.0625rem solid var(--sapGroup_TitleBorderColor);margin:.5rem .25rem}
