...
}`};function Q(e){d.useEffect(e,[])}function m_(){const[e,_]=d.useState(!1);return d.useEffect(()=>{_(!0)},[]),e}const B=e=>`on${$(G(e))}`,H=new Set([]),f_=(e,_,o,r,i,s)=>d.forwardRef((u,x)=>{const{className:g,children:L,waitForDefine:p,...l}=u,[A,z]=Y(x),S=V(e),m=S?`${e}-${S}`:e,[f,P]=d.useState(H.has(m));Q(()=>{s()});const E=_.reduce((t,n)=>l.hasOwnProperty(n)?{...t,[y(n)]:l[n]}:t,{}),N=o.reduce((t,n)=>l[n]===!0||l[n]==="true"?{...t,[y(n)]:!0}:t,{}),R=r.reduce((t,n)=>{var I;const a=l[n];if(!a)return t;if(((I=l[n])==null?void 0:I.$$typeof)===Symbol.for("react.portal"))return console.warn("ReactPortal is not supported for slot props."),t;const h=[];let F=0;const C=c=>{var T;c&&(c.type===d.Fragment?d.Children.toArray((T=c.props)==null?void 0:T.children).filter(Boolean).forEach(j=>{C(j)}):(h.push(d.cloneElement(c,{key:`${n}-${F}`,slot:n})),F++))};return Array.isArray(a)?a.forEach(c=>{C(c)}):C(a),[...t,...h]},[]);q(()=>{const t=z.current,n={};if(!p||f)return i.forEach(a=>{const h=l[B(a)];typeof h=="function"&&(n[a]=h,t==null||t.addEventListener(a,n[a]))}),()=>{for(const a in n)t==null||t.removeEventListener(a,n[a])}},[...i.map(t=>l[B(t)]),f,p]);const U=Object.entries(l).filter(([t])=>!_.includes(t)).filter(([t])=>!r.includes(t)).filter(([t])=>!o.includes(t)).filter(([t])=>!i.map(n=>B(n)).includes(t)).reduce((t,[n,a])=>({...t,[n]:a}),{});return d.useEffect(()=>{p&&!f&&customElements.whenDefined(m).then(()=>{P(!0),H.add(m)})},[m,p,f]),p&&!f?null:X.jsxs(m,{ref:A,...N,...E,...U,class:g,children:[R,L]})});export{c_ as a,p_ as b,n_ as c,l_ as d,b as e,J as f,s_ as g,m_ as h,K as i,i_ as l,d_ as o,a_ as p,u_ as s,Z as t,Y as u,f_ as w};
//# sourceMappingURL=withWebComponent-7b9bd1ee.js.map
