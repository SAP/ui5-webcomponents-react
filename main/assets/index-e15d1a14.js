...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function st(i,e,t){return c`<tr class="ui5-table-row-root" tabindex="${l(this._tabIndex)}" @focusin="${this._onfocusin}" @focusout="${this._onfocusout}" @click="${this._onrowclick}" @keydown="${this._onkeydown}" @keyup="${this._onkeyup}" @mouseup="${this._onmouseup}" @touchstart="${this._ontouchstart}" @touchend="${this._ontouchend}" aria-label="${l(this.ariaLabelText)}" aria-selected="${l(this.selected)}" aria-current="${l(this._ariaCurrent)}" data-sap-focus-ref part="row">${this.isMultiSelect?lt.call(this,i,e,t):void 0}${this.shouldPopin?at.call(this,i,e,t):dt.call(this,i,e,t)}<td class="ui5-table-row-navigated" aria-hidden="true"><div class="ui5-table-div-navigated"></div></td></tr>${this.shouldPopin?ut.call(this,i,e,t):void 0} `}function lt(i,e,t){return t?c`<td class="ui5-table-multi-select-cell" aria-hidden="true" role="presentation"><${R("ui5-checkbox",e,t)} class="ui5-multi-select-checkbox" ?checked="${this.selected}" aria-label="${l(this.ariaLabelRowSelection)}" @ui5-change="${l(this._handleSelection)}" tabindex="-1"></${R("ui5-checkbox",e,t)}></td>`:c`<td class="ui5-table-multi-select-cell" aria-hidden="true" role="presentation"><ui5-checkbox class="ui5-multi-select-checkbox" ?checked="${this.selected}" aria-label="${l(this.ariaLabelRowSelection)}" @ui5-change="${l(this._handleSelection)}" tabindex="-1"></ui5-checkbox></td>`}function at(i,e,t){return c`${I(this.visibleCells,(n,o)=>n._id||o,(n,o)=>rt.call(this,i,e,t,n,o))}`}function rt(i,e,t,n,o){return c`<slot name="${l(n._individualSlot)}"></slot>`}function dt(i,e,t){return c`${I(this.cells,(n,o)=>n._id||o,(n,o)=>ct.call(this,i,e,t,n,o))}`}function ct(i,e,t,n,o){return c`<slot name="${l(n._individualSlot)}"></slot>`}function ut(i,e,t){return c`${I(this.popinCells,(n,o)=>n._id||o,(n,o)=>ht.call(this,i,e,t,n,o))}`}function ht(i,e,t,n,o){return c`<tr part="popin-row" class="${l(n.classes)}" @click="${this._onrowclick}" @keydown="${this._onkeydown}" @keyup="${this._onkeyup}"><td colspan="${l(this.visibleCellsCount)}" role="cell">${n.popinDisplayInline?pt.call(this,i,e,t,n,o):bt.call(this,i,e,t,n,o)}</td><td class="ui5-table-row-navigated" aria-hidden="true"><div class="ui5-table-div-navigated"></div></td></tr>`}function pt(i,e,t,n,o){return c`<div class="ui5-table-display-inline-container">${n.popinText?mt.call(this,i,e,t,n,o):void 0}<span class="ui5-table-cell-display-inline"><slot name="${l(n.cell._individualSlot)}"></slot></span></div>`}function mt(i,e,t,n,o){return c`<span class="ui5-table-row-popin-title">${l(n.popinText)}:</span>`}function bt(i,e,t,n,o){return c`${n.popinText?ft.call(this,i,e,t,n,o):void 0}<div><slot name="${l(n.cell._individualSlot)}"></slot></div>`}function ft(i,e,t,n,o){return c`<span class="ui5-table-row-popin-title">${l(n.popinText)}:</span>`}w("@ui5/webcomponents-theming","sap_fiori_3",async()=>P);w("@ui5/webcomponents","sap_fiori_3",async()=>V);const gt={packageName:"@ui5/webcomponents",fileName:"themes/TableRow.css",content:`:host {
	display: contents;
}
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}export{A as T,F as a,M as b,ne as c,N as d,g as e};
//# sourceMappingURL=index-e15d1a14.js.map
