import{j as e}from"./jsx-runtime-DtaoT6pD.js";import{r as u,U as W,t as y,f as k}from"./UI5Element-oLeGfnU4.js";import{r as h}from"./Icons-B0Lm9Xgp.js";import{a as U}from"./add-xPmSgSwM.js";import{e as G}from"./employee-PrBJTXfy.js";import{s as J}from"./settings-tA6EkyHy.js";import{b as H,a as f,c as K,d as S,T as t}from"./index-iaW_xXvN.js";import{_ as Q}from"./iframe-Kkh0q3zc.js";import{a as g,l as q,b as w,s as M,c as X,f as Y,w as Z}from"./withWebComponent--kEkWNJH.js";import{o as _}from"./class-map-Y-YjCFqX.js";import{s as v}from"./style-map-5njKSr-C.js";import{s as F}from"./parameters-bundle.css-mPCp9TQx.js";function ee(a,n,o){return g`<div id="${q(this._id)}" role="separator" class="${_(this.classes.root)}"></div>`}function te(a,n,o){return o?g`<${w("ui5-li-custom",n,o)} id="${q(this._id)}" role="separator" class="${_(this.classes.root)}" disabled style="${v(this._style)}"></${w("ui5-li-custom",n,o)}>`:g`<ui5-li-custom id="${q(this._id)}" role="separator" class="${_(this.classes.root)}" disabled style="${v(this._style)}"></ui5-li-custom>`}u("@ui5/webcomponents-theming","sap_horizon",async()=>M);u("@ui5/webcomponents","sap_horizon",async()=>F);const ae={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInStrip.css.ts",content:`.ui5-tc__separator{width:0;border-left:.0625rem solid var(--sapGroup_TitleBorderColor);margin:.5rem .25rem}
