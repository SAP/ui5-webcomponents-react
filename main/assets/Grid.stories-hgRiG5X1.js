import{j as n}from"./jsx-runtime-DtaoT6pD.js";import{r as u}from"./index-OjgoNOWw.js";import{g as X,a as G,d as I}from"./Media-2V8ZCQiV.js";import{c as _}from"./clsx-Zbgk8kpT.js";import{c as j}from"./react-jss.esm-tmBtHfec.js";import{f as T}from"./utils-3rf7SAGj.js";var f=(e=>(e.Left="Left",e.Center="Center",e.Right="Right",e))(f||{});const V=()=>{var a;const[e,t]=u.useState((a=X())==null?void 0:a.name);return u.useEffect(()=>{let p=!0;const c=({name:m})=>{p===!0&&t(m)};return G(c),()=>{p=!1,I(c)}},[t]),e},P=()=>{const e={};for(let t=1;t<=12;t++)e[`gridSpan${t}`]={gridColumn:`span ${t}`};return e},E={grid:{display:"grid",gridTemplateColumns:"repeat(12, 1fr)"},...P(),positionCenter:{marginInline:"auto"},positionRight:{marginInline:"auto 0px"}},q=/^([X][L](?<LargeDesktop>[0-9]|1[0-2]))? ?([L](?<Desktop>[0-9]|1[0-2]))? ?([M](?<Tablet>[0-9]|1[0-2]))? ?([S](?<Phone>[0-9]|1[0-2]))?$/i,A=/^([X][L](?<LargeDesktop>[1-9]|1[0-2]))? ?([L](?<Desktop>[1-9]|1[0-2]))? ?([M](?<Tablet>[1-9]|1[0-2]))? ?([S](?<Phone>[1-9]|1[0-2]))?$/i,l=new Map;l.set("Phone",1);l.set("Tablet",2);l.set("Desktop",4);l.set("LargeDesktop",4);const d=new Map;d.set("Phone",0);d.set("Tablet",0);d.set("Desktop",0);d.set("LargeDesktop",0);const $=(e,t)=>{const a=A.exec(e);return(a==null?void 0:a.groups[t])??l.get(t)},F=(e,t)=>{const a=q.exec(e);return(a==null?void 0:a.groups[t])??d.get(t)},H=j(E,{name:"Grid"}),i=u.forwardRef((e,t)=>{const{position:a,children:p,hSpacing:c,vSpacing:m,style:L,className:C,slot:M,defaultIndent:D,defaultSpan:k,...w}=e,o=H(),h=V(),x=_(o.grid,f.Center===a&&o.positionCenter,f.Right===a&&o.positionRight,C);return n.jsx("div",{ref:t,className:x,style:{gridRowGap:m,gridColumnGap:c,...L},slot:M,...w,children:T(p,1/0).map(r=>{if(!u.isValidElement(r))return null;const N=$(r.props["data-layout-span"]??k,h),R=o[`gridSpan${N}`],y=[n.jsx("div",{className:R,children:r},r.key)],g=F(r.props["data-layout-indent"]??D,h);return g&&g>0&&y.unshift(n.jsx("span",{className:o[`gridSpan${g}`],"data-component-name":"GridIndentSpacer","aria-hidden":"true"},`${r.key}-indent`)),y})})});i.displayName="Grid";i.defaultProps={hSpacing:"1rem",vSpacing:"1rem",defaultIndent:"XL0 L0 M0 S0",defaultSpan:"XL3 L3 M6 S12"};try{i.displayName="Grid",i.__docgenInfo={description:"A layout container component used for aligning items with various sizes in a simple grid.",displayName:"Grid",props:{vSpacing:{defaultValue:{value:"1rem"},description:"Vertical spacing between the rows in the Grid. If not specified, then 1rem.",name:"vSpacing",required:!1,type:{name:"Height<string | number>"}},hSpacing:{defaultValue:{value:"1rem"},description:"Horizontal spacing between the content in the Grid. If not specified, then 1rem.",name:"hSpacing",required:!1,type:{name:"Width<string | number>"}},position:{defaultValue:null,description:'Position of the Grid in the window or surrounding container. Possible values are "Center", "Left" and "Right".',name:"position",required:!1,type:{name:"enum",value:[{value:'"Left"'},{value:'"Center"'},{value:'"Right"'},{value:'"Left"'},{value:'"Center"'},{value:'"Right"'}]}},defaultSpan:{defaultValue:{value:"XL3 L3 M6 S12"},description:`A string type that represents Grid's default span values for very large, large, medium and small screens for the whole Grid.
