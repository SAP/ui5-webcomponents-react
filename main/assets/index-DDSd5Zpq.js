import{_ as u}from"./iframe-CWSB2GBZ.js";import{f as m,C as d}from"./UI5Element-B4CRQCUa.js";import{s as h,a as f,m as y,l as b,b as _,w as x}from"./withWebComponent-BxrD_3pN.js";import{a as w}from"./Integer-DgRYWdxf.js";import"./utils-DgTsnvPN.js";import{s as g}from"./parameters-bundle.css-DQGkr9pp.js";import{d as T}from"./CustomElementsScopeUtils-C6IqSY4u.js";m("@ui5/webcomponents-theming","sap_horizon",async()=>h);m("@ui5/webcomponents","sap_horizon",async()=>g);const v={packageName:"@ui5/webcomponents",fileName:"themes/Text.css.ts",content:`:host{display:inline-block;max-width:100%;font-size:var(--sapFontSize);font-family:var(--sapFontFamily);color:var(--sapTextColor);line-height:normal;white-space:pre-line;word-wrap:break-word;cursor:text}:host([max-lines]){display:-webkit-box;-webkit-line-clamp:var(--_ui5-v2-0-0-rc-6_text_max_lines);line-clamp:var(--_ui5-v2-0-0-rc-6_text_max_lines);-webkit-box-orient:vertical;overflow:hidden;white-space:normal}
`};var c=function(t,n,o,s){var r=arguments.length,e=r<3?n:s===null?s=Object.getOwnPropertyDescriptor(n,o):s,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")e=Reflect.decorate(t,n,o,s);else for(var p=t.length-1;p>=0;p--)(l=t[p])&&(e=(r<3?l(e):r>3?l(n,o,e):l(n,o))||e);return r>3&&e&&Object.defineProperty(n,o,e),e};let i=class extends d{onBeforeRendering(){this.style.setProperty(T("--_ui5_text_max_lines"),`${this.maxLines}`)}};c([f({validator:w,defaultValue:1/0})],i.prototype,"maxLines",void 0);i=c([y({tag:"ui5-text",renderer:b,template:()=>_`<bdi><slot></slot></bdi>`,styles:v})],i);i.define();const N=i,D=Object.freeze(Object.defineProperty({__proto__:null,default:N},Symbol.toStringTag,{value:"Module"})),a=x("ui5-text",["maxLines"],[],[],[],()=>u(()=>Promise.resolve().then(()=>D),void 0,import.meta.url));a.displayName="Text";try{a.displayName="Text",a.__docgenInfo={description:`<h3>Overview</h3>
