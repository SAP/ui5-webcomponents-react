import{j as e}from"./jsx-runtime-6b79a019.js";import{r as u,U,v as y,m as k}from"./UI5Element-11982a12.js";import{r as h}from"./Icons-234bf59e.js";import{a as V}from"./add-f5bbced1.js";import{e as G}from"./employee-e34ffee2.js";import{s as J}from"./settings-4143fb8e.js";import{b as H,a as f,c as K,d as S,T as t}from"./index-9d612ce5.js";import{_ as Q}from"./iframe-9f269afc.js";import{b as x,l as _,d as w,s as F,a as L,c as X,f as Y,w as Z}from"./withWebComponent-03662f7f.js";import{o as q}from"./class-map-341004db.js";import{s as v}from"./style-map-9183c00a.js";function ee(a,n,o){return x`<div id="${_(this._id)}" role="separator" class="${q(this.classes.root)}"></div>`}function te(a,n,o){return o?x`<${w("ui5-li-custom",n,o)} id="${_(this._id)}" role="separator" class="${q(this.classes.root)}" disabled style="${v(this._style)}"></${w("ui5-li-custom",n,o)}>`:x`<ui5-li-custom id="${_(this._id)}" role="separator" class="${q(this.classes.root)}" disabled style="${v(this._style)}"></ui5-li-custom>`}u("@ui5/webcomponents-theming","sap_fiori_3",async()=>F);u("@ui5/webcomponents","sap_fiori_3",async()=>L);const ae={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInStrip.css",content:`.ui5-tc__separator {
	width: 0;
...
//# sourceMappingURL=TabContainer.stories-1f53195f.js.map
