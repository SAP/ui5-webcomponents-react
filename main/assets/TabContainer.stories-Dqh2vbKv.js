import{j as e}from"./ManagedStyles-B3AuKgSD.js";import{r as h,i as k}from"./Boot-DOb84JFo.js";import{r as f}from"./Icons-BEU0Gkqb.js";import{a as B}from"./add-JcGrPM4V.js";import{e as G}from"./employee-Cmzn10U8.js";import{s as J}from"./settings-NyRlvaHW.js";import{b as R,a as g,c as K,d as q,T as t}from"./index-DZCuPe0T.js";import{_ as Q}from"./iframe-CWUtUPjE.js";import{U as X,e as S}from"./UI5Element-BDMamLf2.js";import{a as x,l as i,b as w,s as H,p as Y,c as Z,d as ee,w as te}from"./withWebComponent-B6oBGWld.js";import{o as y}from"./class-map-k-XuEcbQ.js";import{s as v}from"./style-map-C_Zo2l27.js";import{s as F}from"./parameters-bundle.css-CG8awnKl.js";function ae(a,n,o){return x`<div id="${i(this._id)}" role="separator" class="${y(this.classes.root)}" .realTabReference="${i(this)}"></div>`}function ne(a,n,o){return o?x`<${w("ui5-li-custom",n,o)} id="${i(this._id)}" role="separator" class="${y(this.classes.root)}" disabled style="${v(this._style)}" .realTabReference="${i(this)}"></${w("ui5-li-custom",n,o)}>`:x`<ui5-li-custom id="${i(this._id)}" role="separator" class="${y(this.classes.root)}" disabled style="${v(this._style)}" .realTabReference="${i(this)}"></ui5-li-custom>`}h("@ui5/webcomponents-theming","sap_horizon",async()=>H);h("@ui5/webcomponents","sap_horizon",async()=>F);const oe={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInStrip.css.ts",content:`.ui5-tc__separator{position:relative;width:.5625rem}.ui5-tc__separator:before{content:" ";position:absolute;width:.0625rem;left:.25rem;top:.5rem;bottom:.5rem;background:var(--sapGroup_TitleBorderColor)}
