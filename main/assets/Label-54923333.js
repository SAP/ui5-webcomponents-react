import{a as m,U as h,d as b}from"./UI5Element-2e105c8a.js";import{e as y,l as f,a as w,b as g,p as c,c as v,d as x}from"./withWebComponent-7b9bd1ee.js";import{W as u}from"./WrappingType-b81e595a.js";import{L as _}from"./i18n-defaults-fca59c5d.js";import"./CustomElementsScopeUtils-137da8c8.js";import"./utils-69f7a0e0.js";import"./index-ebeaab24.js";import"./jsx-runtime-5926aa06.js";import"./useIsomorphicLayoutEffect-38a48652.js";function L(i,e,o){return y`<label class="ui5-label-root" @click=${this._onclick}><span class="ui5-label-text-wrapper"><bdi id="${f(this._id)}-bdi"><slot></slot></bdi></span><span aria-hidden="true" class="ui5-label-required-colon" data-colon="${f(this._colonSymbol)}"></span></label>`}m("@ui5/webcomponents-theming","sap_fiori_3",async()=>w);m("@ui5/webcomponents","sap_fiori_3",async()=>g);const q={packageName:"@ui5/webcomponents",fileName:"themes/Label.css",content:`:host(:not([hidden])) {
	display: inline-flex;
}
...
//# sourceMappingURL=Label-54923333.js.map
