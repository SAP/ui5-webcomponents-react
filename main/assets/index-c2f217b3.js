import{_ as H}from"./iframe-24e42f35.js";import{a as w,U as O,d as oe,C as ce}from"./UI5Element-78be0f3d.js";import{e as c,l,s as R,a as P,b as V,p as r,c as q,d as z,w as W}from"./withWebComponent-d4224c1c.js";import{c as k,e as _}from"./Icon-70a9e5b9.js";import{s as U}from"./slot-76e48863.js";import{R as ie}from"./ResizeHandler-15c77712.js";import{I as fe,N as be}from"./ItemNavigation-e8f3ce94.js";import{I as ue}from"./Integer-f7f172c9.js";import{k as Q,e as he,A as ge,B as se,C as _e,v as K,w as J,D as ve,E as we,F as le,G as ae,b as x,c as D,H as ye}from"./Icons-26e87c01.js";import{g as X,a as re,i as Te,b as pe}from"./TabbableElements-8e49b367.js";import{g as Ce}from"./AriaLabelHelper-43a261ec.js";import{d as Se}from"./debounce-9c2fb7dd.js";import{B as xe}from"./BusyIndicator-4ada5b66.js";import me from"./CheckBox-13a91d81.js";import{T as Ee,y as Re,O as Ie,Q as ke,U as $e,G as Ne,H as Be,W as De}from"./i18n-defaults-f002f496.js";import{s as de}from"./style-map-54298215.js";import{g as Ae}from"./MarkedEvents-b83081e9.js";var Y;(function(i){i.Block="Block",i.Inline="Inline"})(Y||(Y={}));const $=Y;var Z;(function(i){i.Button="Button",i.Scroll="Scroll",i.None="None"})(Z||(Z={}));const N=Z;var ee;(function(i){i.None="None",i.SingleSelect="SingleSelect",i.MultiSelect="MultiSelect"})(ee||(ee={}));const g=ee;var te;(function(i){i.Inactive="Inactive",i.Active="Active"})(te||(te={}));const E=te;function Le(i,e,t){return c`<div class="ui5-table-root" @ui5-selection-requested="${l(this._handleSelect)}" @ui5-_forward-after="${l(this._onForwardAfter)}" @ui5-_forward-before="${l(this._onForwardBefore)}" @focusin="${this._onfocusin}"><div id="${l(this._id)}-before" tabindex="0" class="ui5-table-focusarea"></div>${this.busy?Fe.call(this,i,e,t):void 0}<table border="0" cellspacing="0" cellpadding="0" @keydown="${this._onkeydown}" role="table" aria-label="${l(this.tableAriaLabelText)}"><thead><tr id="${l(this._columnHeader.id)}" class="ui5-table-header-row" aria-label="${l(this.ariaLabelText)}" tabindex="${l(this._columnHeader._tabIndex)}" @click="${this._onColumnHeaderClick}" @focusin="${this._onColumnHeaderFocused}" @keydown="${this._onColumnHeaderKeydown}">${this.isMultiSelect?Me.call(this,i,e,t):void 0}${k(this.visibleColumns,(n,o)=>n._id||o,(n,o)=>Oe.call(this,i,e,t,n,o))}<th class="ui5-table-header-row-navigated" aria-hidden="true"></th></tr></thead><tbody>${k(this.rows,(n,o)=>n._id||o,(n,o)=>Pe.call(this,i,e,t,n,o))}${this.rows.length?void 0:Ve.call(this,i,e,t)}${this.growsWithButton?ze.call(this,i,e,t):void 0}${this.growsOnScroll?Ue.call(this,i,e,t):void 0}</tbody></table><div id="${l(this._id)}-after" tabindex="0" class="ui5-table-focusarea"></div></div> `}function Fe(i,e,t){return t?c`<div tabindex="-1" class="ui5-table-busy-row"><${R("ui5-busy-indicator",e,t)} delay="${l(this.busyDelay)}" class="ui5-table-busy-ind" style="${de(this.styles.busy)}" active size="Medium" data-sap-focus-ref></${R("ui5-busy-indicator",e,t)}></div>`:c`<div tabindex="-1" class="ui5-table-busy-row"><ui5-busy-indicator delay="${l(this.busyDelay)}" class="ui5-table-busy-ind" style="${de(this.styles.busy)}" active size="Medium" data-sap-focus-ref></ui5-busy-indicator></div>`}function Me(i,e,t){return c`<th class="ui5-table-select-all-column" role="presentation" aria-hidden="true">${this.rows.length?He.call(this,i,e,t):void 0}</th>`}function He(i,e,t){return t?c`<${R("ui5-checkbox",e,t)} class="ui5-table-select-all-checkbox" ?checked="${this._allRowsSelected}" @ui5-change="${l(this._selectAll)}" aria-label="${l(this.ariaLabelSelectAllText)}" tabindex="-1"></${R("ui5-checkbox",e,t)}>`:c`<ui5-checkbox class="ui5-table-select-all-checkbox" ?checked="${this._allRowsSelected}" @ui5-change="${l(this._selectAll)}" aria-label="${l(this.ariaLabelSelectAllText)}" tabindex="-1"></ui5-checkbox>`}function Oe(i,e,t,n,o){return c`<slot name="${l(n._individualSlot)}"></slot>`}function Pe(i,e,t,n,o){return c`<slot name="${l(n._individualSlot)}"></slot>`}function Ve(i,e,t){return c`${this.hideNoData?void 0:qe.call(this,i,e,t)}`}function qe(i,e,t){return c`<tr class="ui5-table-no-data-row-root"><td colspan="${l(this.visibleColumnsCount)}" role="cell" style="width: 100%"><div class="ui5-table-no-data-row"><span>${l(this.noDataText)}</span></div></td></tr>`}function ze(i,e,t){return c`<tr><td colspan="${l(this.visibleColumnsCount)}"><div growing-button><div id="${l(this._id)}-growingButton" tabindex="0" role="button" aria-labelledby="${l(this.loadMoreAriaLabelledBy)}" ?active="${this._loadMoreActive}" @click="${this._onLoadMoreClick}" @keydown="${this._onLoadMoreKeydown}" @keyup="${this._onLoadMoreKeyup}" growing-button-inner><span id="${l(this._id)}-growingButton-text" growing-button-text>${l(this._growingButtonText)}</span>${this.growingButtonSubtext?We.call(this,i,e,t):void 0}</div></div></td></tr>`}function We(i,e,t){return c`<span id="${l(this._id)}-growingButton-subtext" growing-button-subtext>${l(this.growingButtonSubtext)}</span>`}function Ue(i,e,t){return c`<tr tabindex="-1" class="ui5-table-end-row"><td tabindex="-1"><span tabindex="-1" aria-hidden="true" class="ui5-table-end-marker"></span></td></tr>`}w("@ui5/webcomponents-theming","sap_fiori_3",async()=>P);w("@ui5/webcomponents","sap_fiori_3",async()=>V);const je={packageName:"@ui5/webcomponents",fileName:"themes/Table.css",content:`[growing-button] {
	display: flex;
	align-items: center;
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function Qe(i,e,t){return c`<td tabindex="-1" part="cell" role="cell"><slot></slot></td>`}w("@ui5/webcomponents-theming","sap_fiori_3",async()=>P);w("@ui5/webcomponents","sap_fiori_3",async()=>V);const Ye={packageName:"@ui5/webcomponents",fileName:"themes/TableCell.css",content:`:host {
	display: table-cell;
	font-family: "72override", var(--sapFontFamily);
	font-size: 0.875rem;
...
::slotted([ui5-label]) {
	color: inherit;
}`};var B=globalThis&&globalThis.__decorate||function(i,e,t,n){var o=arguments.length,s=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(i,e,t,n);else for(var d=i.length-1;d>=0;d--)(a=i[d])&&(s=(o<3?a(s):o>3?a(e,t,s):a(e,t))||s);return o>3&&s&&Object.defineProperty(e,t,s),s},A;let v=A=class extends O{static async onDefine(){A.i18nBundle=await oe("@ui5/webcomponents")}get cellContent(){return this.getSlottedNodes("content")}get ariaLabelEmptyCellText(){return A.i18nBundle.getText($e)}};B([r({type:Boolean})],v.prototype,"lastInRow",void 0);B([r({type:Boolean})],v.prototype,"popined",void 0);B([r({type:Boolean})],v.prototype,"_popinedInline",void 0);B([U({type:HTMLElement,default:!0})],v.prototype,"content",void 0);v=A=B([q({tag:"ui5-table-cell",renderer:z,template:Qe,styles:Ye})],v);v.define();const Ze=v,et=Object.freeze(Object.defineProperty({__proto__:null,default:Ze},Symbol.toStringTag,{value:"Module"})),ne=W("ui5-table-cell",[],[],[],[],()=>H(()=>Promise.resolve().then(()=>et),void 0,import.meta.url));ne.displayName="TableCell";try{ne.displayName="TableCell",ne.__docgenInfo={description:"The `TableCell` component defines the structure of the data in a single `Table` cell.\n\n__Note:__ This component is a web component developed by the UI5 Web Components’ team.\n\n[UI5 Web Components Storybook](https://sap.github.io/ui5-webcomponents/playground/?path=/docs/main-Table)",displayName:"TableCell",props:{children:{defaultValue:null,description:"Specifies the content of the component.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},style:{defaultValue:null,description:`Element style which will be appended to the most outer element of a component.
Use this prop carefully, some css properties might break the component.`,name:"style",required:!1,type:{name:"CSSProperties"}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
Use this prop carefully, overwriting CSS rules might break the component.`,name:"className",required:!1,type:{name:"string"}},waitForDefine:{defaultValue:null,description:`Defines whether the component should wait for the underlying custom element of the web component to be defined. This can be useful, for example, for using instance methods when mounting the component.

__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function tt(i,e,t){return c`<th scope="col" part="column" role="columnheader"><slot></slot></th>`}w("@ui5/webcomponents-theming","sap_fiori_3",async()=>P);w("@ui5/webcomponents","sap_fiori_3",async()=>V);const nt={packageName:"@ui5/webcomponents",fileName:"themes/TableColumn.css",content:`:host {
	display: contents;
}
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function st(i,e,t){return c`<tr class="ui5-table-row-root" tabindex="${l(this._tabIndex)}" @focusin="${this._onfocusin}" @focusout="${this._onfocusout}" @click="${this._onrowclick}" @keydown="${this._onkeydown}" @keyup="${this._onkeyup}" @mouseup="${this._onmouseup}" @touchstart="${this._ontouchstart}" @touchend="${this._ontouchend}" aria-label="${l(this.ariaLabelText)}" aria-selected="${l(this.selected)}" aria-current="${l(this._ariaCurrent)}" data-sap-focus-ref part="row" data-ui5-dir="${l(this.effectiveDir)}">${this.isMultiSelect?lt.call(this,i,e,t):void 0}${this.shouldPopin?at.call(this,i,e,t):dt.call(this,i,e,t)}<td class="ui5-table-row-navigated" aria-hidden="true"><div class="ui5-table-div-navigated"></div></td></tr>${this.shouldPopin?ut.call(this,i,e,t):void 0} `}function lt(i,e,t){return t?c`<td class="ui5-table-multi-select-cell" aria-hidden="true" role="presentation"><${R("ui5-checkbox",e,t)} class="ui5-multi-select-checkbox" ?checked="${this.selected}" aria-label="${l(this.ariaLabelRowSelection)}" @ui5-change="${l(this._handleSelection)}" tabindex="-1"></${R("ui5-checkbox",e,t)}></td>`:c`<td class="ui5-table-multi-select-cell" aria-hidden="true" role="presentation"><ui5-checkbox class="ui5-multi-select-checkbox" ?checked="${this.selected}" aria-label="${l(this.ariaLabelRowSelection)}" @ui5-change="${l(this._handleSelection)}" tabindex="-1"></ui5-checkbox></td>`}function at(i,e,t){return c`${k(this.visibleCells,(n,o)=>n._id||o,(n,o)=>rt.call(this,i,e,t,n,o))}`}function rt(i,e,t,n,o){return c`<slot name="${l(n._individualSlot)}"></slot>`}function dt(i,e,t){return c`${k(this.cells,(n,o)=>n._id||o,(n,o)=>ct.call(this,i,e,t,n,o))}`}function ct(i,e,t,n,o){return c`<slot name="${l(n._individualSlot)}"></slot>`}function ut(i,e,t){return c`${k(this.popinCells,(n,o)=>n._id||o,(n,o)=>ht.call(this,i,e,t,n,o))}`}function ht(i,e,t,n,o){return c`<tr part="popin-row" class="${l(n.classes)}" @click="${this._onrowclick}" @keydown="${this._onkeydown}" @keyup="${this._onkeyup}"><td colspan="${l(this.visibleCellsCount)}" role="cell">${n.popinDisplayInline?pt.call(this,i,e,t,n,o):ft.call(this,i,e,t,n,o)}</td><td class="ui5-table-row-navigated" aria-hidden="true"><div class="ui5-table-div-navigated"></div></td></tr>`}function pt(i,e,t,n,o){return c`<div class="ui5-table-display-inline-container">${n.popinText?mt.call(this,i,e,t,n,o):void 0}<span class="ui5-table-cell-display-inline"><slot name="${l(n.cell._individualSlot)}"></slot></span></div>`}function mt(i,e,t,n,o){return c`<span class="ui5-table-row-popin-title">${l(n.popinText)}:</span>`}function ft(i,e,t,n,o){return c`${n.popinText?bt.call(this,i,e,t,n,o):void 0}<div><slot name="${l(n.cell._individualSlot)}"></slot></div>`}function bt(i,e,t,n,o){return c`<span class="ui5-table-row-popin-title">${l(n.popinText)}:</span>`}w("@ui5/webcomponents-theming","sap_fiori_3",async()=>P);w("@ui5/webcomponents","sap_fiori_3",async()=>V);const gt={packageName:"@ui5/webcomponents",fileName:"themes/TableRow.css",content:`:host {
	display: contents;
}
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}export{L as T,F as a,M as b,ne as c,g as d,N as e};
//# sourceMappingURL=index-c2f217b3.js.map
