...
}`}};const u={title:"Modals & Popovers / MessageBox",parameters:{chromatic:{delay:1e3}},component:g,args:{open:!1,type:B.Confirm,children:'Press "Escape" to close the MessageBox.'},argTypes:{header:{control:{disable:!0}},actions:{control:{disable:!0}},icon:{control:{disable:!0}}},tags:["stories-mdx"],includeStories:["defaultStory","withCustomAction"]};u.parameters=u.parameters||{};u.parameters.docs={...u.parameters.docs||{},page:N};const oo=["defaultStory","withCustomAction"];export{oo as __namedExportsOrder,u as default,v as defaultStory,x as withCustomAction};
//# sourceMappingURL=MessageBox.stories-4bf8848a.js.map
