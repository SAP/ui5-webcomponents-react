import{_ as b}from"./iframe-4ef4ec76.js";import{a as p,U as g,d as v}from"./UI5Element-78be0f3d.js";import{e as m,l as u,a as y,b as w,p as f,c as C,d as N,w as x}from"./withWebComponent-d4224c1c.js";import{s as _}from"./slot-76e48863.js";import{g as T}from"./AriaLabelHelper-43a261ec.js";import{o as R}from"./class-map-18f572ce.js";import{I as D}from"./Icon-70a9e5b9.js";import{j as L,k as I}from"./i18n-defaults-f002f496.js";function k(n,e,t){return m`<div class="${R(this.classes.root)}" role="region" aria-label="${u(this._getAriaLabel)}">${this._hasHeader?A.call(this,n,e,t):void 0}<div role="group" aria-label="${u(this._ariaCardContentLabel)}"><slot></slot></div></div>`}function A(n,e,t){return m`<div class="ui5-card-header-root"><slot name="header"></slot></div>`}p("@ui5/webcomponents-theming","sap_fiori_3",async()=>y);p("@ui5/webcomponents","sap_fiori_3",async()=>w);const S={packageName:"@ui5/webcomponents",fileName:"themes/Card.css",content:`.ui5-hidden-text {
	position: absolute;
...
//# sourceMappingURL=index-bdc1f0bb.js.map
