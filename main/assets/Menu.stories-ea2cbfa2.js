import{a as s,F as m,j as e}from"./jsx-runtime-670450c2.js";import{r}from"./index-f1f749bf.js";import{B as p}from"./index-22be0079.js";import{M as i,a as t}from"./index-c3b6e56c.js";const x={title:"Modals & Popovers / Menu",component:i,argTypes:{children:{control:{disable:!0}}},parameters:{chromatic:{delay:1e3}}},n={render(l){const o=r.useRef(null),d=r.useRef(null);return r.useEffect(()=>{},[]),s(m,{children:[e(p,{ref:d,onClick:f=>{o.current.showAt(f.target)},children:"Show Menu"}),s(i,{...l,ref:o,children:[e(t,{text:"New File",icon:"add-document"}),e(t,{text:"New Folder",icon:"add-folder",disabled:!0}),e(t,{text:"Open",icon:"open-folder",startsSection:!0}),e(t,{text:"Close"}),e(t,{text:"Preferences",icon:"action-settings",startsSection:!0}),e(t,{text:"Exit",icon:"journey-arrive"})]})]})}};var a,c,u;n.parameters={...n.parameters,docs:{...(a=n.parameters)==null?void 0:a.docs,source:{originalSource:`{
  render(args) {
...
//# sourceMappingURL=Menu.stories-ea2cbfa2.js.map
