import{j as t}from"./jsx-runtime-DtaoT6pD.js";import{r}from"./index-OjgoNOWw.js";import{M as v,a as C,b as p}from"./index-ls079uf8.js";import{B as u}from"./index-Qy0gNMgj.js";import{r as x}from"./index-QYh6idnL.js";const l=r.forwardRef((e,n)=>x.createPortal(t.jsx(v,{...e,ref:n}),document.body));l.displayName="MessageBox";try{l.displayName="MessageBox",l.__docgenInfo={description:"",displayName:"MessageBox",props:{accessibleNameRef:{defaultValue:null,description:`Defines the IDs of the elements that label the component.
...
**Note:** The component will be stretched to approximately 90% of the viewport.`,name:"stretch",required:!1,type:{name:"boolean"}},header:{defaultValue:null,description:`Defines the header HTML Element.
...
Learn more about it [here](https://sap.github.io/ui5-webcomponents-react/?path=/docs/knowledge-base-handling-slots--docs).`,name:"header",required:!1,type:{name:"UI5WCSlotsNode"}},onAfterOpen:{defaultValue:null,description:"Fired after the component is opened. **This event does not bubble.**",name:"onAfterOpen",required:!1,type:{name:"(event: Ui5CustomEvent<DialogDomRef, never>) => void"}},onBeforeClose:{defaultValue:null,description:"Fired before the component is closed. This event can be cancelled, which will prevent the popup from closing. **This event does not bubble.**",name:"onBeforeClose",required:!1,type:{name:"(event: Ui5CustomEvent<DialogDomRef, PopupBeforeCloseEventDetail>) => void"}},onBeforeOpen:{defaultValue:null,description:"Fired before the component is opened. This event can be cancelled, which will prevent the popup from opening. **This event does not bubble.**",name:"onBeforeOpen",required:!1,type:{name:"(event: Ui5CustomEvent<DialogDomRef, never>) => void"}}}}}catch{}const B={title:"Modals & Popovers / MessageBox",component:v,argTypes:{header:{control:{disable:!0}},actions:{control:{disable:!0}},icon:{control:{disable:!0}}},args:{open:!1,type:C.Confirm,children:'Press "Escape" to close the MessageBox.'},parameters:{chromatic:{delay:1e3}},tags:["package:@ui5/webcomponents","cem-module:Dialog"]},s={render(e){const[n,o]=r.useState(e.open),c=()=>{o(!0)},d=i=>{o(!1),e.onClose(i)};return r.useEffect(()=>{o(e.open)},[e.open]),t.jsxs(t.Fragment,{children:[t.jsx(u,{onClick:c,children:"Open Messagebox"}),t.jsx(l,{...e,open:n,onClose:d})]})}},a={args:{actions:[p.OK,"Custom Action",p.Cancel,t.jsx(u,{id:"custom-action",children:"Custom Button"},"0")]},render(e){const[n,o]=r.useState(!1),c=()=>{o(!0)},d=i=>{i.detail.action,o(!1),e.onClose(i)};return t.jsxs(t.Fragment,{children:[t.jsx(u,{onClick:c,children:"Open Messagebox"}),t.jsx(l,{...e,open:n,onClose:d})]})}};var h,m,f;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render(args) {
...
}`,...(f=(m=s.parameters)==null?void 0:m.docs)==null?void 0:f.source}}};var g,b,y;a.parameters={...a.parameters,docs:{...(g=a.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
...
}`,...(y=(b=a.parameters)==null?void 0:b.docs)==null?void 0:y.source}}};const w=["Default","WithCustomActions"],A=Object.freeze(Object.defineProperty({__proto__:null,Default:s,WithCustomActions:a,__namedExportsOrder:w,default:B},Symbol.toStringTag,{value:"Module"}));export{A as C,s as D,a as W};
