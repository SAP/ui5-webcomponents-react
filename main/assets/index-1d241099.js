import{_ as v}from"./iframe-fee88bfa.js";import{I as y}from"./Integer-f7f172c9.js";import{a as h,U as b,w as g}from"./UI5Element-3b11b083.js";import{e as _,a as T,b as w,p as i,c as C,d as S,w as B}from"./withWebComponent-d4224c1c.js";import{s as E}from"./style-map-54298215.js";var m;(function(t){t.TopStart="TopStart",t.TopCenter="TopCenter",t.TopEnd="TopEnd",t.MiddleStart="MiddleStart",t.MiddleCenter="MiddleCenter",t.MiddleEnd="MiddleEnd",t.BottomStart="BottomStart",t.BottomCenter="BottomCenter",t.BottomEnd="BottomEnd"})(m||(m={}));const f=m;function M(t,e,n){return _`${this.domRendered?x.call(this,t,e,n):void 0} `}function x(t,e,n){return _`<div class="ui5-toast-root" role="alert" style="${E(this.styles.root)}" @mouseover="${this._onmouseover}" @mouseleave="${this._onmouseleave}" @transitionend="${this._ontransitionend}"><bdi><slot></slot></bdi></div>`}h("@ui5/webcomponents-theming","sap_fiori_3",async()=>T);h("@ui5/webcomponents","sap_fiori_3",async()=>w);const N={packageName:"@ui5/webcomponents",fileName:"themes/Toast.css",content:`:host {
...
`};var r=globalThis&&globalThis.__decorate||function(t,e,n,s){var l=arguments.length,a=l<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,n):s,d;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,e,n,s);else for(var u=t.length-1;u>=0;u--)(d=t[u])&&(a=(l<3?d(a):l>3?d(e,n,a):d(e,n))||a);return l>3&&a&&Object.defineProperty(e,n,a),a};const c=500,D=1e3;let o=class extends b{constructor(){super(),this._reopen=!1}onAfterRendering(){this._reopen&&(this._reopen=!1,this._initiateOpening())}show(){this.open?(this._reopen=!0,this.open=!1):this._initiateOpening()}get effectiveDuration(){return this.duration<c?c:this.duration}get styles(){const e=Math.min(this.effectiveDuration/3,D);return{root:{"transition-duration":this.open?`${e}ms`:"","transition-delay":this.open?`${this.effectiveDuration-e}ms`:"",opacity:this.open&&!this.hover?"0":"","z-index":g()}}}_initiateOpening(){this.domRendered=!0,requestAnimationFrame(()=>{this.open=!0})}_ontransitionend(){this.hover||(this.domRendered=!1,this.open=!1)}_onmouseover(){this.hover=!0}_onmouseleave(){this.hover=!1}};r([i({validator:y,defaultValue:3e3})],o.prototype,"duration",void 0);r([i({type:f,defaultValue:f.BottomCenter})],o.prototype,"placement",void 0);r([i({type:Boolean})],o.prototype,"open",void 0);r([i({type:Boolean})],o.prototype,"hover",void 0);r([i({type:Boolean})],o.prototype,"domRendered",void 0);o=r([C({tag:"ui5-toast",renderer:S,styles:N,template:M})],o);o.define();const R=o,$=Object.freeze(Object.defineProperty({__proto__:null,default:R},Symbol.toStringTag,{value:"Module"})),p=B("ui5-toast",["duration","placement"],[],[],[],()=>v(()=>Promise.resolve().then(()=>$),void 0,import.meta.url));p.displayName="Toast";p.defaultProps={duration:3e3,placement:f.BottomCenter};try{p.displayName="Toast",p.__docgenInfo={description:`The \`Toast\` is a small, non-disruptive popup for success or information messages that disappears automatically after a few seconds.

__Note:__ This component is a web component developed by the UI5 Web Components’ team.

<ui5-link href="https://sap.github.io/ui5-webcomponents/playground/?path=/docs/main-Toast" target="_blank">UI5 Web Components Storybook</ui5-link>`,displayName:"Toast",props:{children:{defaultValue:null,description:`Defines the text of the component.
...
//# sourceMappingURL=index-1d241099.js.map
