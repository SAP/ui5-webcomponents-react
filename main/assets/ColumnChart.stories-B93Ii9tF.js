import{c as ie,s as Ye,a as We}from"./DemoProps-BWWtsAFv.js";import{j as o}from"./useIsomorphicLayoutEffect-J-vjyzBO.js";import{T as h}from"./ThemingParameters-DOkJX3Ed.js";import{e as Ee}from"./index-CBpU8qq5.js";import{r as q}from"./index-DVqgc125.js";import{C as Fe,a as le}from"./defaults-4Sg4PsGo.js";import{u as Be,B as Ke}from"./useCancelAnimationFallback-C-dm4MWj.js";import{u as Me,a as He,C as $e,X as Ue,c as Xe,Y as T,b as z}from"./YAxisTicks-DvCa2ZcM.js";import{u as Ge,C as Je}from"./ChartDataLabel-Z-1kWkb5.js";import{u as Qe,t as Ze,a as et,b as tt}from"./staticProps-3HxSKqj7.js";import{u as at}from"./useLongestYAxisLabel-bDJVFlum.js";import{u as ot}from"./useOnClickInternal-yEpt7jtH.js";import{u as nt,a as rt,r as st,b as R}from"./useTooltipFormatter-CB2ekeSh.js";import{C as it}from"./ChartContainer-BJI6_lVP.js";import{C as lt}from"./react-content-loader.es-CmqtvJxN.js";import{B as ct,a as dt,e as ht,d as ut,R as mt,T as pt,h as gt}from"./generateCategoricalChart-sbBkg3AG.js";import{u as ft}from"./withWebComponent-CZCh4Hye.js";import{u as yt}from"./useIsRTL-B9uUG4cf.js";import"./_baseForOwn-czysEfXW.js";import"./isString-D7zYwilD.js";import"./tiny-invariant-CCoILDQG.js";import"./debounce-D7W5PopO.js";import"./_baseUniq-fADs2fxN.js";import"./index-BfsycYn4.js";import"./clsx-B-dksMZM.js";import"./i18n-defaults-CNyODxfy.js";import"./i18nBundle-Baemx9Ir.js";import"./Boot-DBJWGo1y.js";import"./EventProvider-CVfkyUHo.js";import"./I18nContext-BrA05J-F.js";import"./useStylesheet-DGwRvl1X.js";import"./throttle-Dl_m-peW.js";import"./index-BiYRYNgb.js";import"./iframe-CD3rruG0.js";import"../sb-preview/runtime.js";import"./Label-BcDuAK9i.js";import"./UI5Element-ZIczsayz.js";import"./CustomElementsScopeUtils-Di1jckr8.js";import"./WrappingType-CW8URInd.js";import"./i18n-defaults-BBSxky5H.js";import"./parameters-bundle.css-B_nLitlw.js";import"./isPlainObject-BydcgycZ.js";import"./mapValues-DJmJhyxk.js";import"./utils-xoLr7-0V.js";import"./directionChange-sxDj8oYs.js";const u=t=>o.jsxs(lt,{viewBox:"0 0 165 145",preserveAspectRatio:"xMidYMid meet",width:"100%",height:"100%",speed:2,backgroundColor:h.sapContent_ImagePlaceholderBackground,foregroundColor:h.sapContent_ImagePlaceholderForegroundColor,backgroundOpacity:h.sapContent_DisabledOpacity,...t,children:[o.jsx("rect",{x:"10",y:"135",width:"135",height:"1"}),o.jsx("rect",{x:"20",y:"50",width:"15",height:"85"}),o.jsx("rect",{x:"40",y:"18",width:"15",height:"117"}),o.jsx("rect",{x:"60",y:"68",width:"15",height:"67"}),o.jsx("rect",{x:"80",y:"60",width:"15",height:"75"}),o.jsx("rect",{x:"100",y:"10",width:"15",height:"125"}),o.jsx("rect",{x:"120",y:"75",width:"15",height:"60"})]});try{u.displayName="ColumnChartPlaceholder",u.__docgenInfo={description:"",displayName:"ColumnChartPlaceholder",props:{}}}catch{}try{u.displayName="ColumnChartPlaceholder",u.__docgenInfo={description:"",displayName:"ColumnChartPlaceholder",props:{}}}catch{}const bt={formatter:le},Ct={formatter:le,opacity:1},vt=t=>({payload:A})=>Fe.getValueByDataKey(A,t),c=q.forwardRef((t,A)=>{var V,L;const{loading:ce,dataset:s,noLegend:de,noAnimation:D,tooltipConfig:m,onDataPointClick:p,onLegendClick:he,onClick:I,style:ue,className:me,slot:pe,ChartPlaceholder:ge,syncId:fe,children:ye,...be}=t,a={yAxisVisible:!1,xAxisVisible:!0,gridStroke:h.sapList_BorderColor,gridHorizontal:!0,gridVertical:!1,legendPosition:"bottom",legendHorizontalAlign:"left",barGap:3,zoomingTool:!1,resizeDebounce:250,yAxisConfig:{},xAxisConfig:{},secondYAxisConfig:{},...t.chartConfig},{referenceLine:n}=a,{dimensions:P,measures:d}=nt(t.dimensions,t.measures,bt,Ct),Ce=rt(d),[ve,we]=at(s,d,a.legendPosition),i=P[0],{primaryMeasure:ke,secondaryMeasure:xe}=st(d,(V=a==null?void 0:a.secondYAxis)==null?void 0:V.dataKey),Ae=Ge(i),[Se,j]=ft(A),_e=d.map(({accessor:e})=>e),S=a.secondYAxis?_e.findIndex(e=>{var r;return e===((r=a.secondYAxis)==null?void 0:r.dataKey)}):0,De=Qe(he),Ie=q.useCallback((e,r,g)=>{e&&p&&p(Ee(g,{dataKey:Object.keys(e).filter(l=>e.value.length?e[l]===e.value[1]-e.value[0]:e[l]===e.value&&l!=="value")[0],value:e.value.length?e.value[1]-e.value[0]:e.value,dataIndex:r,payload:e.payload}))},[p]),Pe=ot(I),je=(s==null?void 0:s.length)>30,Ve=i==null?void 0:i.accessor,Le=Me(a.margin,a.zoomingTool),qe=He(j,t.dimensions.length),_=yt(j),{chartConfig:wt,dimensions:kt,measures:xt,...Te}=be,{isMounted:ze,handleBarAnimationStart:Re,handleBarAnimationEnd:Ne}=Be(D);return o.jsx(it,{dataset:s,loading:ce,Placeholder:ge??u,ref:Se,style:ue,className:me,slot:pe,resizeDebounce:a.resizeDebounce,...Te,children:o.jsxs(Ke,{syncId:fe,onClick:Pe,stackOffset:"sign",margin:Le,data:s,barGap:a.barGap,className:typeof p=="function"||typeof I=="function"?"has-click-handler":void 0,children:[o.jsx($e,{vertical:a.gridVertical,horizontal:a.gridHorizontal,stroke:a.gridStroke}),a.xAxisVisible&&P.map((e,r)=>o.jsx(Ue,{dataKey:e.accessor,xAxisId:r,interval:(e==null?void 0:e.interval)??(je?"preserveStart":0),tick:o.jsx(Xe,{config:e}),tickLine:r<1,axisLine:r<1,height:qe[r],allowDuplicatedCategory:r===0,reversed:_,...a.xAxisConfig},e.reactKey)),o.jsx(T,{orientation:_===!0?"right":"left",axisLine:a.yAxisVisible,tickLine:Ze,yAxisId:"left",interval:0,tick:o.jsx(z,{config:ke}),width:ve,...a.yAxisConfig}),((L=a.secondYAxis)==null?void 0:L.dataKey)&&o.jsx(T,{dataKey:a.secondYAxis.dataKey,axisLine:{stroke:a.secondYAxis.color??`var(--sapChart_OrderedColor_${S%11+1})`},tick:o.jsx(z,{config:xe,secondYAxisConfig:{color:a.secondYAxis.color??`var(--sapChart_OrderedColor_${S%11+1})`}}),tickLine:{stroke:a.secondYAxis.color??`var(--sapChart_OrderedColor_${S%11+1})`},label:{value:a.secondYAxis.name,offset:2,angle:90,position:"center"},orientation:_===!0?"left":"right",yAxisId:"right",interval:0,...a.secondYAxisConfig}),ze&&d.map((e,r)=>{var g;return o.jsxs(ct,{yAxisId:((g=a.secondYAxis)==null?void 0:g.dataKey)===e.accessor?"right":"left",stackId:e.stackId,fillOpacity:e.opacity,name:e.label??e.accessor,strokeOpacity:e.opacity,type:"monotone",dataKey:e.accessor,fill:e.color??`var(--sapChart_OrderedColor_${r%11+1})`,stroke:e.color??`var(--sapChart_OrderedColor_${r%11+1})`,barSize:e.width,onClick:Ie,isAnimationActive:!D,onAnimationStart:Re,onAnimationEnd:Ne,children:[o.jsx(dt,{data:s,valueAccessor:vt(e.accessor),content:o.jsx(Je,{config:e,chartType:"column",position:"insideTop"})}),s.map((l,Oe)=>o.jsx(ht,{fill:R(e,l,r),stroke:R(e,l,r)},Oe))]},e.reactKey)}),!de&&o.jsx(ut,{verticalAlign:a.legendPosition,align:a.legendHorizontalAlign,onClick:De,wrapperStyle:we}),n&&o.jsx(mt,{...n,stroke:(n==null?void 0:n.color)??(n==null?void 0:n.stroke),y:(n==null?void 0:n.value)??(n==null?void 0:n.y),yAxisId:(n==null?void 0:n.yAxisId)??"left",label:n==null?void 0:n.label}),(m==null?void 0:m.active)!==!1&&o.jsx(pt,{cursor:et,formatter:Ce,contentStyle:tt,labelFormatter:Ae,...m}),a.zoomingTool&&o.jsx(gt,{y:10,dataKey:Ve,tickFormatter:i==null?void 0:i.formatter,stroke:h.sapObjectHeader_BorderColor,travellerWidth:10,height:20}),ye]})})});c.displayName="ColumnChart";try{c.displayName="ColumnChart",c.__docgenInfo={description:"A `ColumnChart` is a data visualization where each category is represented by a rectangle, with the height of the rectangle being proportional to the values being plotted.",displayName:"ColumnChart",props:{dimensions:{defaultValue:null,description:`An array of config objects. Each object will define one dimension of the chart.
...
}`,...(F=(E=y.parameters)==null?void 0:E.docs)==null?void 0:F.source}}};var B,K,M;b.parameters={...b.parameters,docs:{...(B=b.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    dimensions: [{
      accessor: 'name'
    }, {
...
}`,...(M=(K=b.parameters)==null?void 0:K.docs)==null?void 0:M.source}}};var H,$,U;C.parameters={...C.parameters,docs:{...(H=C.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
    measures: [{
      accessor: 'users',
      stackId: 'A'
...
}`,...(se=(re=x.parameters)==null?void 0:re.docs)==null?void 0:se.source}}};const fa=["Default","WithCustomColor","WithSecondaryDimension","WithStacks","WithFormatter","LoadingPlaceholder","WithReferenceLine","WithHighlightedMeasure"];export{f as Default,w as LoadingPlaceholder,y as WithCustomColor,v as WithFormatter,x as WithHighlightedMeasure,k as WithReferenceLine,b as WithSecondaryDimension,C as WithStacks,fa as __namedExportsOrder,ga as default};
