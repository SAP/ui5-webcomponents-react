...
If set to <code>true</code>, a navigation indicator is displayed at the end of the list item.`,default:"false",privacy:"public",_ui5since:"1.10.0",_ui5validator:"Boolean",inheritedFrom:{name:"ListItem",module:"dist/ListItem.js"}},{kind:"field",name:"selected",type:{text:"boolean"},description:"Defines the selected state of the <code>ListItem</code>.",default:"false",privacy:"public",_ui5validator:"Boolean",inheritedFrom:{name:"ListItemBase",module:"dist/ListItemBase.js"}}],superclass:{name:"TreeItemBase",package:"@ui5/webcomponents",module:"dist/TreeItemBase.js"},tagName:"ui5-tree-item-custom",customElement:!0,_ui5since:"1.9.2",_ui5privacy:"public",events:[{name:"detail-click",_ui5privacy:"public",type:{text:"CustomEvent"},description:"Fired when the user clicks on the detail button when type is <code>Detail</code>.",inheritedFrom:{name:"ListItem",module:"dist/ListItem.js"}}]}],exports:[{kind:"js",name:"default",declaration:{name:"TreeItemCustom",module:"dist/TreeItemCustom.js"}},{kind:"custom-element-definition",name:"ui5-tree-item-custom",declaration:{name:"TreeItemCustom",module:"dist/TreeItemCustom.js"}}]},{kind:"javascript-module",path:"dist/TreeList.js",declarations:[],exports:[{kind:"js",name:"default",declaration:{name:"TreeList",module:"dist/TreeList.js"}}]},{kind:"javascript-module",path:"dist/WheelSlider.js",declarations:[],exports:[{kind:"js",name:"default",declaration:{name:"WheelSlider",module:"dist/WheelSlider.js"}}]},{kind:"javascript-module",path:"dist/YearPicker.js",declarations:[],exports:[{kind:"js",name:"default",declaration:{name:"YearPicker",module:"dist/YearPicker.js"}}]}],H={schemaVersion:U,readme:R,modules:O};function _(i){return e.jsx("pre",{className:s.domRefCodeBlock,children:e.jsx("code",{className:s.domRefCode,children:i.children})})}function z(i){var n;return i.kind==="method"?e.jsxs(_,{children:[e.jsx("span",{style:{color:"rgb(64, 120, 242)"},children:i.name}),e.jsx("span",{style:{color:"rgb(56, 58, 66)"},children:"("}),(n=i.parameters)==null?void 0:n.map((a,r)=>e.jsxs(p.Fragment,{children:[e.jsx("span",{style:{color:"rgb(56, 58, 66)"},children:a.name}),a.optional?e.jsx("span",{style:{color:"rgb(64, 120, 242)"},children:"?"}):null,e.jsx("span",{style:{color:"rgb(64, 120, 242)"},children:": "}),e.jsx("span",{style:{color:"rgb(80, 161, 79)"},children:a.type.text}),r<i.parameters.length-1?e.jsx("span",{style:{color:"rgb(56, 58, 66)"},children:", "}):null]},a.name)),e.jsx("span",{style:{color:"rgb(56, 58, 66)"},children:")"}),e.jsx("span",{style:{color:"rgb(64, 120, 242)"},children:": "}),e.jsx("span",{style:{color:"rgb(80, 161, 79)"},children:i.return.type.text})]}):e.jsxs(_,{children:[i.readonly?e.jsx("span",{style:{color:"rgb(166, 38, 164)"},children:"readonly "}):null,e.jsx("span",{style:{color:"rgb(56, 58, 66)"},children:i.name}),e.jsx("span",{style:{color:"rgb(64, 120, 242)"},children:": "}),e.jsx("span",{style:{color:"rgb(80, 161, 79)"},children:i.type.text})]})}function W(){var f,y,v,g;const i=p.useContext(S),n=(y=(f=i.attachedCSFFile)==null?void 0:f.meta)==null?void 0:y.tags,a=n==null?void 0:n.find(t=>t.startsWith("package:")),r=n==null?void 0:n.find(t=>t.startsWith("cem-module:")),u=i.componentStories().at(0).component.displayName,c=p.useRef(null),I=new Set(Object.keys(i.primaryStory.argTypes));let l;switch(a){case"package:@ui5/webcomponents":l=H;break;case"package:@ui5/webcomponents-fiori":l=L;break}let m=r?r.split(":")[1]:u;const d=((v=l==null?void 0:l.modules.find(t=>t.path===`dist/${m}.js`))==null?void 0:v.declarations.find(t=>t.customElement===!0&&t.name===m))??[],h=((g=d==null?void 0:d.members)==null?void 0:g.filter(t=>{var o,k;return!(I.has(t.name)&&!((k=(o=t.type)==null?void 0:o.text)!=null&&k.includes("HTMLElement")))}))??[],b=(d==null?void 0:d.cssParts)??[];return e.jsxs(e.Fragment,{children:[h.length>0?e.jsxs(e.Fragment,{children:[e.jsx(w,{children:"Attributes & Methods"}),e.jsx("p",{children:"This component exposes public attributes and methods. You can use them directly on the instance of the component, e.g. by using React Refs."}),e.jsxs(T,{hideCloseButton:!0,style:{marginBlockEnd:"10px"},children:["This table is showing ",e.jsx("bold",{children:"additional"})," attributes and methods which are not available as props."," ",e.jsx("br",{}),"All props (without event handlers, children, and slots) are available as attributes on the DOM ref as well."]}),e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Name"}),e.jsx("th",{children:"Parameters"}),e.jsx("th",{children:"Description"})]})}),e.jsx("tbody",{children:h.map(t=>e.jsxs("tr",{children:[e.jsxs("td",{children:[e.jsx(z,{...t}),t.deprecated&&e.jsxs(e.Fragment,{children:[e.jsx("br",{}),e.jsx(B,{className:s.deprecationInfoBadge,design:N.Critical,interactive:typeof t.deprecated=="string",onClick:typeof t.deprecated=="string"?o=>{c.current.innerHTML=t.deprecated,c.current.showAt(o.currentTarget)}:void 0,children:"deprecated"})]})]}),e.jsx("td",{children:t.parameters?t.parameters.map(o=>e.jsxs("div",{className:s.parameters,children:[e.jsx("p",{className:s.parameterName,children:o.name}),o.description?e.jsx("p",{className:s.parameterDetails,dangerouslySetInnerHTML:{__html:o.description}}):null]},o.name)):e.jsx(e.Fragment,{children:"—"})}),e.jsx("td",{dangerouslySetInnerHTML:{__html:t.description}})]},t.name))})]}),D.createPortal(e.jsx(C,{ref:c,className:s.deprecationInfoPopover}),document.body)]}):null,b.length>0?e.jsxs(e.Fragment,{children:[e.jsx(w,{children:"CSS Shadow Parts"}),e.jsxs("p",{children:[e.jsx(P,{target:"_blank",href:"https://developer.mozilla.org/en-US/docs/Web/CSS/::part",children:"CSS Shadow Parts"})," ","allow developers to style elements inside the Shadow DOM."]}),e.jsxs("p",{children:["The ",e.jsx("code",{children:u})," exposes the following CSS Shadow Parts:"]}),e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Name"}),e.jsx("th",{children:"Description"})]})}),e.jsx("tbody",{children:b.map(t=>e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("b",{children:t.name})}),e.jsx("td",{children:t.description})]},t.name))})]})]}):null]})}function Z(i){const{hideHTMLPropsNote:n,noteText:a,...r}=i;return e.jsxs("div",{className:x.container,children:[!n&&e.jsx(T,{design:E.Information,hideCloseButton:!0,className:x.strip,children:a??"This component supports all HTML attributes."}),e.jsx(j,{...r}),e.jsx(W,{})]})}export{Z as C};
