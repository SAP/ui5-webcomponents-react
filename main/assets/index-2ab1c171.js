import{_ as b}from"./iframe-71752497.js";import{r as u,U as g,l as v}from"./UI5Element-11982a12.js";import{b as m,l as p,s as y,a as w,p as f,c as C,f as N,w as x}from"./withWebComponent-99b005ba.js";import{s as _}from"./slot-76e48863.js";import{g as T}from"./AriaLabelHelper-43a261ec.js";import{o as R}from"./class-map-b4d8f3b0.js";import{a as D}from"./Icon-31253496.js";import{h as L,i as A}from"./i18n-defaults-1a83921e.js";function I(n,e,t){return m`<div class="${R(this.classes.root)}" role="region" aria-label="${p(this._getAriaLabel)}">${this._hasHeader?S.call(this,n,e,t):void 0}<div role="group" aria-label="${p(this._ariaCardContentLabel)}"><slot></slot></div></div>`}function S(n,e,t){return m`<div class="ui5-card-header-root"><slot name="header"></slot></div>`}u("@ui5/webcomponents-theming","sap_fiori_3",async()=>y);u("@ui5/webcomponents","sap_fiori_3",async()=>w);const E={packageName:"@ui5/webcomponents",fileName:"themes/Card.css",content:`.ui5-hidden-text {
	position: absolute;
...
//# sourceMappingURL=index-2ab1c171.js.map
