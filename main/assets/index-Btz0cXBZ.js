import{_ as T}from"./iframe-4Fxt_YRx.js";import{C as G}from"./UI5Element-D1gTBhJw.js";import{b as c,l as f,f as x,s as $,a as l,m as C,c as D,w as M}from"./withWebComponent-BqYi3caL.js";import{f as F}from"./slot--DoKcWSY.js";import{t as p}from"./Integer-WDQzHAdZ.js";import{c as V}from"./Icon-DybkHgDw.js";import{f as L}from"./Boot-CUKJMqeB.js";import{s as q}from"./parameters-bundle.css-B_nLitlw.js";import{a as E}from"./Title-DOT2nEnt.js";function k(r,e,o){return c`<div class="ui5-form-root" role="form" aria-labelledby="${f(this.ariaLabelledByID)}">${this.hasHeader?R.call(this,r,e,o):void 0}<div class="ui5-form-layout" part="layout">${this.hasGroupItems?U.call(this,r,e,o):P.call(this,r,e,o)}</div></div>`}function R(r,e,o){return c`<div class="ui5-form-header" part="header">${this.hasCustomHeader?j.call(this,r,e,o):z.call(this,r,e,o)}</div>`}function j(r,e,o){return c`<slot name="header"></slot>`}function z(r,e,o){return o?c`<${x("ui5-title",e,o)} id="${f(this._id)}-header-text" level="H4">${f(this.headerText)}</${x("ui5-title",e,o)}>`:c`<ui5-title id="${f(this._id)}-header-text" level="H4">${f(this.headerText)}</ui5-title>`}function U(r,e,o){return c`${V(this.groupItemsInfo,(t,n)=>t._id||n,(t,n)=>W.call(this,r,e,o,t,n))}`}function W(r,e,o,t,n){return c`<div class="ui5-form-column ${f(t.classes)}" part="column"><div class="ui5-form-group">${t.groupItem.headerText?O.call(this,r,e,o,t,n):void 0}<div class="ui5-form-group-layout"><slot name="${f(t.groupItem._individualSlot)}"></slot></div></div></div>`}function O(r,e,o,t,n){return o?c`<div class="ui5-form-group-heading"><${x("ui5-title",e,o)} level="H6">${f(t.groupItem.headerText)}</${x("ui5-title",e,o)}></div>`:c`<div class="ui5-form-group-heading"><ui5-title level="H6">${f(t.groupItem.headerText)}</ui5-title></div>`}function P(r,e,o){return c`${V(this.itemsInfo,(t,n)=>t._id||n,(t,n)=>H.call(this,r,e,o,t,n))}`}function H(r,e,o,t,n){return c`<div class="ui5-form-item ${f(t.classes)}"><slot name="${f(t.item._individualSlot)}"></slot></div>`}L("@ui5/webcomponents-theming","sap_horizon",async()=>$);L("@ui5/webcomponents","sap_horizon",async()=>q);const A={packageName:"@ui5/webcomponents",fileName:"themes/Form.css.ts",content:`@container (max-width: 600px){.ui5-form-layout{grid-template-columns:1fr}::slotted(*){justify-self:start}::slotted(:nth-child(2n)){margin-bottom:.5rem}}@container (width > 600px) and (width <= 1024px){.ui5-form-layout{grid-template-columns:1fr}:host([columns-m="1"]) .ui5-form-layout{grid-template-columns:1fr}:host([columns-m="2"]) .ui5-form-layout{grid-template-columns:repeat(2,1fr)}.ui5-form-column-spanM-2{grid-column:span 2}.ui5-form-column-spanM-2 .ui5-form-group-layout{grid-template-columns:repeat(2,1fr)}}@container (width > 1024px) and (width <= 1440px){.ui5-form-layout{grid-template-columns:repeat(2,1fr)}.ui5-form-column{grid-template-columns:1fr}:host([columns-l="1"]) .ui5-form-layout{grid-template-columns:1fr}:host([columns-l="2"]) .ui5-form-layout{grid-template-columns:repeat(2,1fr)}:host([columns-l="3"]) .ui5-form-layout{grid-template-columns:repeat(3,1fr)}.ui5-form-column-spanL-2{grid-column:span 2}.ui5-form-column-spanL-2 .ui5-form-group-layout{grid-template-columns:repeat(2,1fr)}.ui5-form-column-spanL-3{grid-column:span 3}.ui5-form-column-spanL-3 .ui5-form-group-layout{grid-template-columns:repeat(3,1fr)}}@container (min-width: 1441px){.ui5-form-layout{grid-template-columns:repeat(2,1fr)}:host([columns-xl="1"]) .ui5-form-layout{grid-template-columns:1fr}:host([columns-xl="2"]) .ui5-form-layout{grid-template-columns:repeat(2,1fr)}:host([columns-xl="3"]) .ui5-form-layout{grid-template-columns:repeat(3,1fr)}:host([columns-xl="4"]) .ui5-form-layout{grid-template-columns:repeat(4,1fr)}:host([columns-xl="5"]) .ui5-form-layout{grid-template-columns:repeat(5,1fr)}:host([columns-xl="6"]) .ui5-form-layout{grid-template-columns:repeat(6,1fr)}.ui5-form-column-spanXL-2{grid-column:span 2}.ui5-form-column-spanXL-2 .ui5-form-group-layout{grid-template-columns:repeat(2,1fr)}.ui5-form-column-spanXL-3{grid-column:span 3}.ui5-form-column-spanXL-3 .ui5-form-group-layout{grid-template-columns:repeat(3,1fr)}.ui5-form-column-spanXL-4{grid-column:span 4}.ui5-form-column-spanXL-4 .ui5-form-group-layout{grid-template-columns:repeat(4,1fr)}.ui5-form-column-spanXL-5{grid-column:span 5}.ui5-form-column-spanXL-5 .ui5-form-group-layout{grid-template-columns:repeat(5,1fr)}.ui5-form-column-spanXL-6{grid-column:span 6}.ui5-form-column-spanXL-6 .ui5-form-group-layout{grid-template-columns:repeat(6,1fr)}}.ui5-form-item-span-2{grid-column:span 2}.ui5-form-item-span-3{grid-column:span 3}.ui5-form-item-span-4{grid-column:span 4}.ui5-form-item-span-5{grid-column:span 5}.ui5-form-item-span-6{grid-column:span 6}@container (max-width: 600px){:host([label-span-s="1"]) .ui5-form-item,:host([label-span-s="1"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span1)}:host([label-span-s="2"]) .ui5-form-item,:host([label-span-s="2"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span2)}:host([label-span-s="3"]) .ui5-form-item,:host([label-span-s="3"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span3)}:host([label-span-s="4"]) .ui5-form-item,:host([label-span-s="4"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span4)}:host([label-span-s="5"]) .ui5-form-item,:host([label-span-s="5"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span5)}:host([label-span-s="6"]) .ui5-form-item,:host([label-span-s="6"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span6)}:host([label-span-s="7"]) .ui5-form-item,:host([label-span-s="7"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span7)}:host([label-span-s="8"]) .ui5-form-item,:host([label-span-s="8"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span8)}:host([label-span-s="9"]) .ui5-form-item,:host([label-span-s="9"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span9)}:host([label-span-s="10"]) .ui5-form-item,:host([label-span-s="10"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span10)}:host([label-span-s="11"]) .ui5-form-item,:host([label-span-s="11"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span11)}:host(:not([label-span-s])) .ui5-form-item,:host(:not([label-span-s])) .ui5-form-group,:host([label-span-s="12"]) .ui5-form-item,:host([label-span-s="12"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span12);--ui5-v2-0-0-rc-5-form-item-label-justify: var(--ui5-v2-0-0-rc-5-form-item-label-justify-span12);--ui5-v2-0-0-rc-5-form-item-label-padding: var(--ui5-v2-0-0-rc-5-form-item-label-padding-span12)}}@container (width > 600px) and (width <= 1024px){:host([label-span-m="1"]) .ui5-form-item,:host([label-span-m="1"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span1)}:host([label-span-m="2"]) .ui5-form-item,:host([label-span-m="2"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span2)}:host([label-span-m="3"]) .ui5-form-item,:host([label-span-m="3"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span3)}:host([label-span-m="4"]) .ui5-form-item,:host([label-span-m="4"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span4)}:host([label-span-m="5"]) .ui5-form-item,:host([label-span-m="5"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span5)}:host([label-span-m="6"]) .ui5-form-item,:host([label-span-m="6"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span6)}:host([label-span-m="7"]) .ui5-form-item,:host([label-span-m="7"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span7)}:host([label-span-m="8"]) .ui5-form-item,:host([label-span-m="8"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span8)}:host([label-span-m="9"]) .ui5-form-item,:host([label-span-m="9"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span9)}:host([label-span-m="10"]) .ui5-form-item,:host([label-span-m="10"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span10)}:host([label-span-m="11"]) .ui5-form-item,:host([label-span-m="11"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span11)}:host([label-span-m="12"]) .ui5-form-item,:host([label-span-m="12"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span12);--ui5-v2-0-0-rc-5-form-item-label-justify: var(--ui5-v2-0-0-rc-5-form-item-label-justify-span12);--ui5-v2-0-0-rc-5-form-item-label-padding: var(--ui5-v2-0-0-rc-5-form-item-label-padding-span12)}}@container (width > 1024px) and (width <= 1440px){:host([label-span-l="1"]) .ui5-form-item,:host([label-span-l="1"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span1)}:host([label-span-l="2"]) .ui5-form-item,:host([label-span-l="2"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span2)}:host([label-span-l="3"]) .ui5-form-item,:host([label-span-l="3"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span3)}:host([label-span-l="4"]) .ui5-form-item,:host([label-span-l="4"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span4)}:host([label-span-l="5"]) .ui5-form-item,:host([label-span-l="5"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span5)}:host([label-span-l="6"]) .ui5-form-item,:host([label-span-l="6"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span6)}:host([label-span-l="7"]) .ui5-form-item,:host([label-span-l="7"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span7)}:host([label-span-l="8"]) .ui5-form-item,:host([label-span-l="8"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span8)}:host([label-span-l="9"]) .ui5-form-item,:host([label-span-l="9"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span9)}:host([label-span-l="10"]) .ui5-form-item,:host([label-span-l="10"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span10)}:host([label-span-l="11"]) .ui5-form-item,:host([label-span-l="11"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span11)}:host([label-span-l="12"]) .ui5-form-item,:host([label-span-l="12"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span12);--ui5-v2-0-0-rc-5-form-item-label-justify: var(--ui5-v2-0-0-rc-5-form-item-label-justify-span12);--ui5-v2-0-0-rc-5-form-item-label-padding: var(--ui5-v2-0-0-rc-5-form-item-label-padding-span12)}}@container (min-width: 1441px){:host([label-span-xl="1"]) .ui5-form-item,:host([label-span-xl="1"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span1)}:host([label-span-xl="2"]) .ui5-form-item,:host([label-span-xl="2"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span2)}:host([label-span-xl="3"]) .ui5-form-item,:host([label-span-xl="3"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span3)}:host([label-span-xl="4"]) .ui5-form-item,:host([label-span-xl="4"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span4)}:host([label-span-xl="5"]) .ui5-form-item,:host([label-span-xl="5"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span5)}:host([label-span-xl="6"]) .ui5-form-item,:host([label-span-xl="6"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span6)}:host([label-span-xl="7"]) .ui5-form-item,:host([label-span-xl="7"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span7)}:host([label-span-xl="8"]) .ui5-form-item,:host([label-span-xl="8"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span8)}:host([label-span-xl="9"]) .ui5-form-item,:host([label-span-xl="9"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span9)}:host([label-span-xl="10"]) .ui5-form-item,:host([label-span-xl="10"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span10)}:host([label-span-xl="11"]) .ui5-form-item,:host([label-span-xl="11"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span11)}:host([label-span-xl="12"]) .ui5-form-item,:host([label-span-xl="12"]) .ui5-form-group{--ui5-v2-0-0-rc-5-form-item-layout: var(--ui5-v2-0-0-rc-5-form-item-layout-span12);--ui5-v2-0-0-rc-5-form-item-label-justify: var(--ui5-v2-0-0-rc-5-form-item-label-justify-span12);--ui5-v2-0-0-rc-5-form-item-label-padding: var(--ui5-v2-0-0-rc-5-form-item-label-padding-span12)}}:host{display:block}.ui5-form-root{display:flex;flex-direction:column;background-color:var(--sapGroup_ContentBackground);border-radius:.75rem;container-type:inline-size}.ui5-form-header{display:flex;height:2.75rem;align-items:center;border-bottom:1px solid var(--sapGroup_TitleBorderColor);padding:0 1rem}.ui5-form-layout{display:grid;column-gap:1rem;row-gap:.125rem;padding:1rem .75rem}.ui5-form-group-layout{display:grid;column-gap:1rem}.ui5-form-group-heading{height:var(--_ui5-v2-0-0-rc-5-form-group-heading-height);line-height:var(--_ui5-v2-0-0-rc-5-form-group-heading-height);padding-inline-start:.25rem}.ui5-form-column{padding-top:.5rem;padding-bottom:1rem;box-sizing:border-box}::slotted([ui5-form-group]){display:contents}
...
e.g how many columns the group should span to.`,name:"columnSpan",required:!1,type:{name:"number"}},headerText:{defaultValue:null,description:"Defines header text of the component.",name:"headerText",required:!1,type:{name:"string"}},style:{defaultValue:null,description:`Element style which will be appended to the most outer element of a component.
Use this prop carefully, some css properties might break the component.`,name:"style",required:!1,type:{name:"CSSProperties"}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
Use this prop carefully, overwriting CSS rules might break the component.`,name:"className",required:!1,type:{name:"string"}},waitForDefine:{defaultValue:null,description:`Defines whether the component should wait for the underlying custom element of the web component to be defined. This can be useful, for example, for using instance methods when mounting the component.
...
A number bigger than the available columns won't take effect.`,name:"columnSpan",required:!1,type:{name:"number"}},style:{defaultValue:null,description:`Element style which will be appended to the most outer element of a component.
Use this prop carefully, some css properties might break the component.`,name:"style",required:!1,type:{name:"CSSProperties"}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
Use this prop carefully, overwriting CSS rules might break the component.`,name:"className",required:!1,type:{name:"string"}},waitForDefine:{defaultValue:null,description:`Defines whether the component should wait for the underlying custom element of the web component to be defined. This can be useful, for example, for using instance methods when mounting the component.
