...
}`}};const h={title:"Modals & Popovers / Popover",component:u,args:{children:e.jsx(b,{children:'Press "Escape" or click outside to close the Popover'}),headerText:"Popover Header",horizontalAlign:x.Center,placementType:P.Right,verticalAlign:j.Center},argTypes:{footer:{control:{disable:!0}},header:{control:{disable:!0}}},tags:["stories-mdx"],includeStories:["defaultStory","withContent"]};h.parameters=h.parameters||{};h.parameters.docs={...h.parameters.docs||{},page:M};const xo=["defaultStory","withContent"];export{xo as __namedExportsOrder,h as default,B as defaultStory,S as withContent};
//# sourceMappingURL=Popover.stories-381843ac.js.map
