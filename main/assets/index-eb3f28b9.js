...
.ui5-card-header-action {
	...
	align-self: flex-start;
}`};var r=globalThis&&globalThis.__decorate||function(a,e,t,s){var u=arguments.length,o=u<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,t):s,h;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(a,e,t,s);else for(var p=a.length-1;p>=0;p--)(h=a[p])&&(o=(u<3?h(o):u>3?h(e,t,o):h(e,t))||o);return u>3&&o&&Object.defineProperty(e,t,o),o},d;let n=d=class extends g{get classes(){return{root:{"ui5-card-header":!0,"ui5-card-header--interactive":this.interactive,"ui5-card-header--active":this.interactive&&this._headerActive,"ui5-card-header-ff":A()}}}get _root(){return this.shadowRoot.querySelector(".ui5-card-header")}get ariaRoleDescription(){return this.interactive?d.i18nBundle.getText(E):d.i18nBundle.getText(N)}get ariaRoleFocusableElement(){return this.interactive?"button":null}get ariaCardAvatarLabel(){return d.i18nBundle.getText(S)}get ariaLabelledBy(){const e=[];return this.titleText&&e.push(`${this._id}-title`),this.subtitleText&&e.push(`${this._id}-subtitle`),this.status&&e.push(`${this._id}-status`),this.hasAvatar&&e.push(`${this._id}-avatar`),e.length!==0?e.join(" "):void 0}get hasAvatar(){return!!this.avatar.length}get hasAction(){return!!this.action.length}static async onDefine(){d.i18nBundle=await y("@ui5/webcomponents")}_actionsFocusin(){this._root.classList.add("ui5-card-header-hide-focus")}_actionsFocusout(){this._root.classList.remove("ui5-card-header-hide-focus")}_click(e){e.stopImmediatePropagation(),this.interactive&&this._root.contains(e.target)&&this.fireEvent("click")}_keydown(e){if(!this.interactive||!this._root.contains(e.target))return;const t=D(e),s=_(e);if(this._headerActive=t||s,t){this.fireEvent("click");return}s&&e.preventDefault()}_keyup(e){if(!this.interactive||!this._root.contains(e.target))return;const t=_(e);this._headerActive=!1,t&&this.fireEvent("click")}};r([c()],n.prototype,"titleText",void 0);r([c()],n.prototype,"subtitleText",void 0);r([c()],n.prototype,"status",void 0);r([c({type:Boolean})],n.prototype,"interactive",void 0);r([c({validator:R,defaultValue:3})],n.prototype,"_ariaLevel",void 0);r([c({type:Boolean,noAttribute:!0})],n.prototype,"_headerActive",void 0);r([v()],n.prototype,"avatar",void 0);r([v()],n.prototype,"action",void 0);n=d=r([T({tag:"ui5-card-header",languageAware:!0,renderer:C,template:F,styles:q}),$("click")],n);n.define();const U=n,z=Object.freeze(Object.defineProperty({__proto__:null,default:U},Symbol.toStringTag,{value:"Module"})),f=k("ui5-card-header",["status","subtitleText","titleText"],["interactive"],["action","avatar"],["click"],()=>b(()=>Promise.resolve().then(()=>z),void 0,import.meta.url));f.displayName="CardHeader";try{f.displayName="CardHeader",f.__docgenInfo={description:'The `CardHeader` is a component, meant to be used as a header of the `Card` component. It displays valuable information, that can be defined with several properties, such as: `titleText`, `subtitleText`, `status` and two slots: `avatar` and `action`.\n\n__Note:__ This component is a web component developed by the UI5 Web Components’ team.\n\n<ui5-link href="https://sap.github.io/ui5-webcomponents/playground/components/Card" target="_blank">UI5 Web Components Playground</ui5-link>',displayName:"CardHeader",props:{action:{defaultValue:null,description:`Defines an action, displayed in the right most part of the header.
...
//# sourceMappingURL=index-eb3f28b9.js.map
