import{j as e}from"./jsx-runtime-Du8NFWEI.js";import{T as n}from"./ThemingParameters--AGRs54p.js";import{T as s}from"./index-5Dv5HHo1.js";import{c as G}from"./clsx-B-dksMZM.js";import{r as N}from"./index-Dl6G-zuu.js";import{c as S}from"./react-jss.esm-BPPChJW9.js";const j={container:{display:"grid"},"@media (max-width: 599px)":{container:{gridTemplateColumns:"repeat(var(--_ui5wcr-rgl-columns-s), minmax(0, 1fr))","& > *":{gridColumn:"span var(--_ui5wcr-rgl-column-span-s)"}}},"@media (min-width: 600px) and (max-width: 1023px)":{container:{gridTemplateColumns:"repeat(var(--_ui5wcr-rgl-columns-m), minmax(0, 1fr))","& > *":{gridColumn:"span var(--_ui5wcr-rgl-column-span-m)"}}},"@media (min-width: 1024px) and (max-width: 1439px)":{container:{gridTemplateColumns:"repeat(var(--_ui5wcr-rgl-columns-l), minmax(0, 1fr))","& > *":{gridColumn:"span var(--_ui5wcr-rgl-column-span-l)"}}},"@media (min-width: 1440px)":{container:{gridTemplateColumns:"repeat(var(--_ui5wcr-rgl-columns-xl), minmax(0, 1fr))","& > *":{gridColumn:"span var(--_ui5wcr-rgl-column-span-xl)"}}}},k=S(j,{name:"ResponsiveGridLayout"}),a=N.forwardRef((o,m)=>{const{children:c,columnGap:d="0.5rem",rowGap:u="0.5rem",columnsS:p=4,columnsM:h=8,columnsL:y=12,columnsXL:g=16,columnSpanS:v=1,columnSpanM:x=1,columnSpanL:f=1,columnSpanXL:b=1,style:w,className:C,...I}=o,L=k(),T=G(L.container,C);return e.jsx("div",{ref:m,className:T,style:{gridRowGap:u,gridColumnGap:d,"--_ui5wcr-rgl-columns-s":p,"--_ui5wcr-rgl-columns-m":h,"--_ui5wcr-rgl-columns-l":y,"--_ui5wcr-rgl-columns-xl":g,"--_ui5wcr-rgl-column-span-s":v,"--_ui5wcr-rgl-column-span-m":x,"--_ui5wcr-rgl-column-span-l":f,"--_ui5wcr-rgl-column-span-xl":b,...w},...I,children:c})});a.displayName="ResponsiveGridLayout";try{a.displayName="ResponsiveGridLayout",a.__docgenInfo={description:`The Responsive Grid Layout positions UI elements in a multi-column flow layout.
...
}`,...(i=(t=l.parameters)==null?void 0:t.docs)==null?void 0:i.source}}};const A=["Default"],X=Object.freeze(Object.defineProperty({__proto__:null,Default:l,__namedExportsOrder:A,default:_},Symbol.toStringTag,{value:"Module"}));export{X as C,l as D};
