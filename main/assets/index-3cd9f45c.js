import{_ as b}from"./iframe-f595a611.js";import{r as u,U as g,l as v}from"./UI5Element-a4bd3d38.js";import{b as m,l as p,s as y,a as w,p as f,c as C,f as N,w as x}from"./withWebComponent-7d7e5133.js";import{s as _}from"./slot-76e48863.js";import{g as T}from"./AriaLabelHelper-43a261ec.js";import{o as R}from"./class-map-0ab40ab9.js";import{a as D}from"./Icon-42236945.js";import{h as L,i as A}from"./i18n-defaults-d5d083dd.js";function I(n,e,t){return m`<div class="${R(this.classes.root)}" role="region" aria-label="${p(this._getAriaLabel)}">${this._hasHeader?S.call(this,n,e,t):void 0}<div role="group" aria-label="${p(this._ariaCardContentLabel)}"><slot></slot></div></div>`}function S(n,e,t){return m`<div class="ui5-card-header-root"><slot name="header"></slot></div>`}u("@ui5/webcomponents-theming","sap_fiori_3",async()=>y);u("@ui5/webcomponents","sap_fiori_3",async()=>w);const E={packageName:"@ui5/webcomponents",fileName:"themes/Card.css",content:`.ui5-hidden-text {
	position: absolute;
...
//# sourceMappingURL=index-3cd9f45c.js.map
