...
}`}};const u={title:"Modals & Popovers / MessageBox",parameters:{chromatic:{delay:1e3}},component:g,args:{open:!1,type:v.Confirm,children:'Press "Escape" to close the MessageBox.'},argTypes:{header:{control:{disable:!0}},actions:{control:{disable:!0}},icon:{control:{disable:!0}}},tags:["stories-mdx"],includeStories:["defaultStory","withCustomAction"]};u.parameters=u.parameters||{};u.parameters.docs={...u.parameters.docs||{},page:N};const lo=["defaultStory","withCustomAction"];export{lo as __namedExportsOrder,u as default,B as defaultStory,x as withCustomAction};
//# sourceMappingURL=MessageBox.stories-zF-Pqk0A.js.map
