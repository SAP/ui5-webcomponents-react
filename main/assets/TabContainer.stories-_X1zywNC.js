import{j as e}from"./jsx-runtime-DtaoT6pD.js";import{r as u,U as W,v as y,h as H}from"./UI5Element-N46uHiF6.js";import{r as h}from"./Icons-JGtWxtgH.js";import{a as U}from"./add-9oMutkQ4.js";import{e as G}from"./employee-1rhW5wth.js";import{s as J}from"./settings-L6haOuuq.js";import{b as k,a as x,c as K,d as S,T as t}from"./index-2GwlK2PX.js";import{_ as Q}from"./iframe-ZYoNH1Ok.js";import{b as g,l as q,d as v,s as M,a as F,c as X,g as Y,w as Z}from"./withWebComponent-m2csmhkT.js";import{o as _}from"./class-map-lkLxloiQ.js";import{s as w}from"./style-map-2OzZTNdj.js";function ee(a,n,o){return g`<div id="${q(this._id)}" role="separator" class="${_(this.classes.root)}"></div>`}function te(a,n,o){return o?g`<${v("ui5-li-custom",n,o)} id="${q(this._id)}" role="separator" class="${_(this.classes.root)}" disabled style="${w(this._style)}"></${v("ui5-li-custom",n,o)}>`:g`<ui5-li-custom id="${q(this._id)}" role="separator" class="${_(this.classes.root)}" disabled style="${w(this._style)}"></ui5-li-custom>`}u("@ui5/webcomponents-theming","sap_horizon",async()=>M);u("@ui5/webcomponents","sap_horizon",async()=>F);const ae={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInStrip.css.ts",content:`.ui5-tc__separator{width:0;border-left:.0625rem solid var(--sapGroup_TitleBorderColor);margin:.5rem .25rem}
`};u("@ui5/webcomponents-theming","sap_horizon",async()=>M);u("@ui5/webcomponents","sap_horizon",async()=>F);const ne={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInOverflow.css.ts",content:`.ui5-tc__separator{min-height:.25rem;border-bottom:.0625rem solid var(--sapGroup_TitleBorderColor);margin-inline-start:calc(var(--_ui5-v1-21-0-rc-5-tab-indentation-level) * .5rem);margin-inline-end:.5rem}[ui5-list]>.ui5-tc__separator:first-child{min-height:.5rem}
