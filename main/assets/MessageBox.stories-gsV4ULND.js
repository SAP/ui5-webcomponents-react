...
`,e.jsx(b,{children:e.jsx(C,{name:"With Custom Action",args:{actions:[m.OK,"Custom Action",m.Cancel,e.jsx(p,{id:"custom-action",children:"Custom Button"},"0")]},children:n=>{const[a,c]=r.useState(!1),h=()=>{c(!0)},f=d=>{d.detail.action,c(!1),n.onClose(d)};return e.jsxs(e.Fragment,{children:[e.jsx(p,{onClick:h,children:"Open Messagebox"}),e.jsx(l,{...n,open:a,onClose:f})]})}})}),`
`,e.jsx(w,{})]})}}const B=t=>{const[i,s]=r.useState(t.open),o=()=>{s(!0)},n=a=>{s(!1),t.onClose(a)};return r.useEffect(()=>{s(t.open)},[t.open]),e.jsxs(e.Fragment,{children:[e.jsx(p,{onClick:o,children:"Open Messagebox"}),e.jsx(l,{...t,open:i,onClose:n})]})};B.storyName="Default";B.parameters={storySource:{source:`args => {
...
}`}};const x=t=>{const[i,s]=r.useState(!1),o=()=>{s(!0)},n=a=>{a.detail.action,s(!1),t.onClose(a)};return e.jsxs(e.Fragment,{children:[e.jsx(p,{onClick:o,children:"Open Messagebox"}),e.jsx(l,{...t,open:i,onClose:n})]})};x.storyName="With Custom Action";x.args={actions:[m.OK,"Custom Action",m.Cancel,e.jsx(p,{id:"custom-action",children:"Custom Button"},"0")]};x.parameters={storySource:{source:`args => {
  const [open, setOpen] = useState(false);
...
}`}};const u={title:"Modals & Popovers / MessageBox",parameters:{chromatic:{delay:1e3}},component:g,args:{open:!1,type:v.Confirm,children:'Press "Escape" to close the MessageBox.'},argTypes:{header:{control:{disable:!0}},actions:{control:{disable:!0}},icon:{control:{disable:!0}}},tags:["stories-mdx"],includeStories:["defaultStory","withCustomAction"]};u.parameters=u.parameters||{};u.parameters.docs={...u.parameters.docs||{},page:N};const mo=["defaultStory","withCustomAction"];export{mo as __namedExportsOrder,u as default,B as defaultStory,x as withCustomAction};
