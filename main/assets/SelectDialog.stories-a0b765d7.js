...
**Note:** The component will be stretched to approximately 90% of the viewport.`,name:"stretch",required:!1,type:{name:"boolean"}},onLoadMore:{defaultValue:null,description:"Fired when the user scrolls to the bottom of the list.\n\n**Note:** The event is fired when the `growing='Scroll'` property is enabled.",name:"onLoadMore",required:!1,type:{name:"(event: Ui5CustomEvent<ListDomRef, never>) => void"}},growing:{defaultValue:null,description:'Defines whether the component will have growing capability either by pressing a `More` button, or via user scroll. In both cases `onLoadMore` event is fired.\n\nAvailable options:\n\n`Button` - Shows a `More` button at the bottom of the list, pressing of which triggers the `onLoadMore` event.\n`Scroll` - The `onLoadMore` event is triggered when the user scrolls to the bottom of the list;\n`None` (default) - The growing is off.\n\n**Restrictions:** `growing="Scroll"` is not supported for Internet Explorer, on IE the component will fallback to `growing="Button"`.',name:"growing",required:!1,type:{name:"enum",value:[{value:'"None"'},{value:'"Button"'},{value:'"Button"'},{value:'"Scroll"'},{value:'"None"'},{value:'"Scroll"'}]}}}}}catch{}const Ae=""+new URL("Laptop1-59a0ea5a.jpg",import.meta.url).href,_e=""+new URL("Laptop2-7b05e4f5.jpg",import.meta.url).href,Oe=""+new URL("PC1-974f5c12.jpg",import.meta.url).href,qe=""+new URL("PC2-9045ab71.jpg",import.meta.url).href,Me={title:"Modals & Popovers / SelectDialog",component:T,argTypes:{children:{control:{disable:!0}}},args:{headerText:"Select Product"}},$=d.forwardRef((o,p)=>be.createPortal(e.jsx(T,{...o,ref:p}),document.body));$.displayName="SelectDialog";const se=[{img:Ae,description:"LT-10",text:"Gaming Laptop"},{img:_e,description:"LT-20",text:"Business Laptop"},{img:qe,description:"HT-10",text:"Gaming PC"},{img:Oe,description:"HT-20",text:"Business PC"}],R={render:o=>{const[p,c]=d.useState(o.open),b=()=>{c(!0)},C=y=>{c(!1),o.onAfterClose(y)};return d.useEffect(()=>{c(o.open)},[o.open]),e.jsxs(e.Fragment,{children:[e.jsx(x,{onClick:b,children:"Open SelectDialog"}),e.jsx($,{...o,open:p,onAfterClose:C,children:new Array(40).fill("").map((y,m)=>{const l=se[m%4];return e.jsx(ie,{image:l.img,description:`${l.description}${m}`,children:l.text},`${l.text}${m}`)})})]})}},L={render:()=>{const o=d.useRef(null),p=()=>{o.current.show()},[c,b]=d.useState(),C=h=>{b(h.detail.value)},y=()=>{b(void 0)},m={"HT-102":!0,"HT-203":!0,"HT-1038":!0},[l,u]=d.useState(m),f=h=>{const n=h.detail.item.dataset.description;u(r=>{if(r[n]){const{[n]:g,...S}=r;return S}else return{...r,[n]:!0}})},B=()=>{u({})},[A,N]=d.useState(Object.keys(m)),V=()=>{N(Object.keys(l))};return e.jsxs(e.Fragment,{children:[e.jsx(x,{onClick:p,children:"Open Dialog"}),e.jsx($,{mode:w.MultiSelect,ref:o,onSearchInput:C,onSearch:C,onSearchReset:y,numberOfSelectedItems:Object.keys(l).length,listProps:{onItemClick:f},showClearButton:!0,onClear:B,onConfirm:V,children:new Array(40).fill("").map((h,n)=>{const r=se[n%4],g=`${r.description}${n}`,S=c==null?void 0:c.toLowerCase();return c&&!g.toLowerCase().includes(S)&&!r.text.toLowerCase().includes(S)?null:e.jsx(ie,{image:r.img,description:`${r.description}${n}`,"data-description":`${r.description}${n}`,selected:l[g],children:r.text},`${r.text}${n}`)}).filter(Boolean)}),e.jsxs(Ce,{children:[e.jsx(ke,{children:"Selected: "}),e.jsx(le,{children:A.join(", ")})]})]})}};var Z,ee,te;R.parameters={...R.parameters,docs:{...(Z=R.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  render: args => {
...
//# sourceMappingURL=SelectDialog.stories-a0b765d7.js.map
