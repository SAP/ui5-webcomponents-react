...
`};var _=globalThis&&globalThis.__decorate||function(r,e,o,t){var i=arguments.length,l=i<3?e:t===null?t=Object.getOwnPropertyDescriptor(e,o):t,h;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")l=Reflect.decorate(r,e,o,t);else for(var m=r.length-1;m>=0;m--)(h=r[m])&&(l=(i<3?h(l):i>3?h(e,o,l):h(e,o))||l);return i>3&&l&&Object.defineProperty(e,o,l),l},b;let p=b=class extends k{static async onDefine(){b.i18nBundle=await S("@ui5/webcomponents")}constructor(){super()}onBeforeRendering(){this._disabled=!this.value,this.phone=I()}get colorLabel(){return b.i18nBundle.getText(q)}get styles(){return{root:{"background-color":this.value}}}};_([u({validator:D})],p.prototype,"value",void 0);_([u({defaultValue:"-1",noAttribute:!0})],p.prototype,"_tabIndex",void 0);_([u({validator:Y})],p.prototype,"index",void 0);_([u({type:Boolean})],p.prototype,"phone",void 0);_([u({type:Boolean})],p.prototype,"_disabled",void 0);p=b=_([R({tag:"ui5-color-palette-item",renderer:T,styles:re,template:te})],p);p.define();const O=p,ie=Object.freeze(Object.defineProperty({__proto__:null,default:O},Symbol.toStringTag,{value:"Module"}));f("@ui5/webcomponents-theming","sap_fiori_3",async()=>P);f("@ui5/webcomponents","sap_fiori_3",async()=>$);const ne={packageName:"@ui5/webcomponents",fileName:"themes/ColorPalette.css",content:`:host(:not([hidden])) {
	display: inline-block;
}
...
//# sourceMappingURL=index-1dde44a2.js.map
