...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const y=R("ui5-side-navigation-sub-item",["icon","text"],["selected"],[],["click"],()=>C(()=>Promise.resolve().then(()=>ve),void 0,import.meta.url));y.displayName="SideNavigationSubItem";try{y.displayName="SideNavigationSubItem",y.__docgenInfo={description:'The `SideNavigationSubItem` is intended to be used inside a `SideNavigationItem` only.\n\n__Note:__ This component is a web component developed by the UI5 Web Components’ team.\n\n<ui5-link href="https://sap.github.io/ui5-webcomponents/playground/?path=/docs/fiori-SideNavigation" target="_blank">UI5 Web Components Storybook</ui5-link>',displayName:"SideNavigationSubItem",props:{onClick:{defaultValue:null,description:"Fired when the component is activated either with a click/tap or by using the Enter or Space key.",name:"onClick",required:!1,type:{name:"(event: Ui5CustomEvent<SideNavigationSubItemDomRef, never>) => void"}},icon:{defaultValue:null,description:`Defines the icon of the item.
...
}`,...(U=(M=S.parameters)==null?void 0:M.docs)==null?void 0:U.source}}};const pt=["Default"],Ct=Object.freeze(Object.defineProperty({__proto__:null,Default:S,__namedExportsOrder:pt,default:ct},Symbol.toStringTag,{value:"Module"}));export{Ct as C,S as D,h as S,y as a};
//# sourceMappingURL=SideNavigation.stories-cf634c73.js.map
