import{j as p}from"./jsx-runtime-5926aa06.js";import{a as y,U as L,d as Se,k as M}from"./UI5Element-78be0f3d.js";import{b as _e,c as we,O as ze,j as x}from"./Icons-26e87c01.js";import{r as G}from"./index-ebeaab24.js";import{a as Te,B as $}from"./Button-427cd4bb.js";import{M as ye,a as xe}from"./index-6ae5d4e0.js";import{W as A}from"./WrappingType-b81e595a.js";import{B as C}from"./index-8cc8e1e7.js";import{C as Ie}from"./index-12ad3739.js";import{I as qe}from"./index-9329da81.js";import{L as D}from"./index-538b53da.js";import{T as k}from"./index-c99a5b19.js";import{_ as oe}from"./iframe-4ef4ec76.js";import{e as u,l as o,s as v,a as H,p as d,c as j,d as ae,w as re}from"./withWebComponent-d4224c1c.js";import{s as $e}from"./slot-76e48863.js";import{I as Ae,e as le,c as q}from"./Icon-70a9e5b9.js";import{I as Ce,N as De}from"./ItemNavigation-e8f3ce94.js";import{F}from"./Float-99d99064.js";import{c as ke}from"./PopupsCommon.css-1eb36bcf.js";import{R as N}from"./ResizeHandler-15c77712.js";import{i as X}from"./Device-99b8bbf4.js";import{d as Ne}from"./debounce-9c2fb7dd.js";import{g as Ee}from"./FocusableElements-53839075.js";import Re from"./ResponsivePopover-5ed17489.js";import{s as Be}from"./BrowserScrollbar.css-119d6915.js";import{af as Pe,ag as K,ah as We,ai as Oe,aj as Le,ak as Me,al as He,am as je,an as Fe,ao as Ve}from"./i18n-defaults-1f5a0024.js";import{s as V}from"./parameters-bundle.css-f9dc8928.js";import{s as Y}from"./style-map-54298215.js";import{o as J}from"./class-map-18f572ce.js";var P;(function(l){l.MultipleSteps="MultipleSteps",l.SingleStep="SingleStep"})(P||(P={}));const W=P;function Ue(l,e,i){return u`<div class="ui5-wiz-step-root" role="listitem" tabindex="${o(this.tabIndex)}" aria-current="${o(this.accInfo.ariaCurrent)}" aria-setsize="${o(this.accInfo.ariaSetsize)}" aria-posinset="${o(this.accInfo.ariaPosinset)}" aria-disabled="${o(this.accInfo.ariaDisabled)}" aria-label="${o(this.accInfo.ariaLabel)}" @click="${this._onclick}" @keyup="${this._onkeyup}" @focusin="${this._onfocusin}"><div class="ui5-wiz-step-main"><div class="ui5-wiz-step-icon-circle">${this.icon?Ze.call(this,l,e,i):Ge.call(this,l,e,i)}</div>${this.hasTexts?Xe.call(this,l,e,i):void 0}</div>${this.hideSeparator?void 0:Ke.call(this,l,e,i)}</div>`}function Ze(l,e,i){return i?u`<${v("ui5-icon",e,i)} class="ui5-wiz-step-icon" name="${o(this.icon)}"></${v("ui5-icon",e,i)}>`:u`<ui5-icon class="ui5-wiz-step-icon" name="${o(this.icon)}"></ui5-icon>`}function Ge(l,e,i){return u`<span class="ui5-wiz-step-number">${o(this.number)}</span>`}function Xe(l,e,i){return u`<div class="ui5-wiz-step-texts"><div class="ui5-wiz-step-title-text">${o(this.titleText)}</div><div class="ui5-wiz-step-subtitle-text">${o(this.subtitleText)}</div></div>`}function Ke(l,e,i){return u`<div class="ui5-wiz-step-hr"></div>`}y("@ui5/webcomponents-theming","sap_fiori_3",async()=>H);y("@ui5/webcomponents-fiori","sap_fiori_3",async()=>V);const Ye={packageName:"@ui5/webcomponents-fiori",fileName:"themes/WizardTab.css",content:`:host(:not([hidden])) {
...
`};var g=globalThis&&globalThis.__decorate||function(l,e,i,t){var n=arguments.length,s=n<3?e:t===null?t=Object.getOwnPropertyDescriptor(e,i):t,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(l,e,i,t);else for(var a=l.length-1;a>=0;a--)(r=l[a])&&(s=(n<3?r(s):n>3?r(e,i,s):r(e,i))||s);return n>3&&s&&Object.defineProperty(e,i,s),s};let h=class extends L{_onclick(){this.disabled||this.fireEvent("selection-change-requested")}_onkeyup(e){this.disabled||(_e(e)||we(e))&&!ze(e)&&(e.preventDefault(),this.fireEvent("selection-change-requested"))}_onfocusin(){this.fireEvent("focused")}get tabIndex(){return Number(this._tabIndex)}get hasTexts(){return this.titleText||this.subtitleText}get accInfo(){return{ariaSetsize:this._wizardTabAccInfo&&this._wizardTabAccInfo.ariaSetsize,ariaPosinset:this._wizardTabAccInfo&&this._wizardTabAccInfo.ariaPosinset,ariaLabel:this._wizardTabAccInfo&&this._wizardTabAccInfo.ariaLabel,ariaCurrent:this.selected?"true":void 0,ariaDisabled:this.disabled?"true":void 0}}};g([d()],h.prototype,"icon",void 0);g([d()],h.prototype,"titleText",void 0);g([d()],h.prototype,"subtitleText",void 0);g([d()],h.prototype,"number",void 0);g([d({type:Boolean})],h.prototype,"disabled",void 0);g([d({type:Boolean})],h.prototype,"selected",void 0);g([d({type:Boolean})],h.prototype,"hideSeparator",void 0);g([d({type:Boolean})],h.prototype,"activeSeparator",void 0);g([d({type:Boolean})],h.prototype,"branchingSeparator",void 0);g([d({defaultValue:"-1"})],h.prototype,"_tabIndex",void 0);h=g([j({tag:"ui5-wizard-tab",renderer:ae,styles:Ye,template:Ue,dependencies:[Ae]}),le("selection-change-requested")],h);h.define();const Je=h;var w=globalThis&&globalThis.__decorate||function(l,e,i,t){var n=arguments.length,s=n<3?e:t===null?t=Object.getOwnPropertyDescriptor(e,i):t,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(l,e,i,t);else for(var a=l.length-1;a>=0;a--)(r=l[a])&&(s=(n<3?r(s):n>3?r(e,i,s):r(e,i))||s);return n>3&&s&&Object.defineProperty(e,i,s),s};let S=class extends L{};w([d()],S.prototype,"titleText",void 0);w([d()],S.prototype,"subtitleText",void 0);w([d()],S.prototype,"icon",void 0);w([d({type:Boolean})],S.prototype,"disabled",void 0);w([d({type:Boolean})],S.prototype,"selected",void 0);w([d({type:Boolean})],S.prototype,"branching",void 0);S=w([j("ui5-wizard-step")],S);S.define();const de=S,Qe=Object.freeze(Object.defineProperty({__proto__:null,default:de},Symbol.toStringTag,{value:"Module"}));function et(l,e,i){return u`<div class="ui5-wiz-root" aria-label="${o(this.ariaLabelText)}" role="region"><nav class="ui5-wiz-nav" part="navigator" aria-label="${o(this.navAriaLabelText)}" tabindex="-1"><div class="ui5-wiz-nav-list" role="list" aria-label="${o(this.listAriaLabelText)}" aria-describedby="wiz-nav-descr" aria-controls="${o(this._id)}-wiz-content">${q(this._stepsInHeader,(t,n)=>t._id||n,(t,n)=>tt.call(this,l,e,i,t,n))}</div></nav><span id="wiz-nav-descr" class="ui5-hidden-text">${o(this.navAriaDescribedbyText)}</span><div id="${o(this._id)}-wiz-content" class="ui5-wiz-content" @scroll="${this.onScroll}">${q(this._steps,(t,n)=>t._id||n,(t,n)=>it.call(this,l,e,i,t,n))}</div></div>`}function tt(l,e,i,t,n){return i?u`<${v("ui5-wizard-tab",e,i)} title-text="${o(t.titleText)}" subtitle-text="${o(t.subtitleText)}" icon="${o(t.icon)}" number="${o(t.number)}" ?disabled="${t.disabled}" ?selected="${t.selected}" ?hide-separator="${t.hideSeparator}" ?active-separator="${t.activeSeparator}" ?branching-separator="${t.branchingSeparator}" ._wizardTabAccInfo="${o(t.accInfo)}" data-ui5-content-ref-id="${o(t.refStepId)}" data-ui5-index="${o(t.pos)}" _tab-index="${o(t.tabIndex)}" @ui5-selection-change-requested="${o(this.onSelectionChangeRequested)}" @ui5-focused="${o(this.onStepInHeaderFocused)}" @click="${this._onGroupedTabClick}" style=${Y(t.styles)}></${v("ui5-wizard-tab",e,i)}>`:u`<ui5-wizard-tab title-text="${o(t.titleText)}" subtitle-text="${o(t.subtitleText)}" icon="${o(t.icon)}" number="${o(t.number)}" ?disabled="${t.disabled}" ?selected="${t.selected}" ?hide-separator="${t.hideSeparator}" ?active-separator="${t.activeSeparator}" ?branching-separator="${t.branchingSeparator}" ._wizardTabAccInfo="${o(t.accInfo)}" data-ui5-content-ref-id="${o(t.refStepId)}" data-ui5-index="${o(t.pos)}" _tab-index="${o(t.tabIndex)}" @ui5-selection-change-requested="${o(this.onSelectionChangeRequested)}" @ui5-focused="${o(this.onStepInHeaderFocused)}" @click="${this._onGroupedTabClick}" style=${Y(t.styles)}></ui5-wizard-tab>`}function it(l,e,i,t,n){return u`<div class="ui5-wiz-content-item" ?hidden="${t.disabled}" ?selected="${t.selected}" ?stretch="${t.stretch}" part="step-content" aria-label="${o(t.stepContentAriaLabel)}" role="region" data-ui5-content-item-ref-id="${o(t._id)}"><div class="ui5-wiz-content-item-wrapper"><slot name="${o(t._individualSlot)}"></slot></div></div>`}function nt(l,e,i){return i?u`<${v("ui5-responsive-popover",e,i)} horizontal-align="Center" placement-type="Bottom" aria-label="${o(this.actionSheetStepsText)}" class="${J(this.classes.popover)}" @ui5-after-close=${o(this._afterClosePopover)} content-only-on-desktop prevent-focus-restore _hide-header><ul class="ui5-wizard-responsive-popover-list">${q(this._groupedTabs,(t,n)=>t._id||n,(t,n)=>Q.call(this,l,e,i,t,n))}</ul><div slot="footer" class="ui5-responsive-popover-footer"><${v("ui5-button",e,i)} design="Transparent" @click="${this._closeRespPopover}">Cancel</${v("ui5-button",e,i)}></div></${v("ui5-responsive-popover",e,i)}>`:u`<ui5-responsive-popover horizontal-align="Center" placement-type="Bottom" aria-label="${o(this.actionSheetStepsText)}" class="${J(this.classes.popover)}" @ui5-after-close=${o(this._afterClosePopover)} content-only-on-desktop prevent-focus-restore _hide-header><ul class="ui5-wizard-responsive-popover-list">${q(this._groupedTabs,(t,n)=>t._id||n,(t,n)=>Q.call(this,l,e,i,t,n))}</ul><div slot="footer" class="ui5-responsive-popover-footer"><ui5-button design="Transparent" @click="${this._closeRespPopover}">Cancel</ui5-button></div></ui5-responsive-popover>`}function Q(l,e,i,t,n){return i?u`<li><${v("ui5-button",e,i)} icon="${o(t.icon)}" ?disabled="${t.disabled}" design="Transparent" data-ui5-header-tab-ref-id="${o(t.accInfo.ariaPosinset)}" @click="${this._onOverflowStepButtonClick}">${o(t.titleText)}</${v("ui5-button",e,i)}></li>`:u`<li><ui5-button icon="${o(t.icon)}" ?disabled="${t.disabled}" design="Transparent" data-ui5-header-tab-ref-id="${o(t.accInfo.ariaPosinset)}" @click="${this._onOverflowStepButtonClick}">${o(t.titleText)}</ui5-button></li>`}y("@ui5/webcomponents-theming","sap_fiori_3",async()=>H);y("@ui5/webcomponents-fiori","sap_fiori_3",async()=>V);const st={packageName:"@ui5/webcomponents-fiori",fileName:"themes/Wizard.css",content:`.ui5-hidden-text {
	position: absolute;
...
`};y("@ui5/webcomponents-theming","sap_fiori_3",async()=>H);y("@ui5/webcomponents-fiori","sap_fiori_3",async()=>V);const ot={packageName:"@ui5/webcomponents-fiori",fileName:"themes/WizardPopover.css",content:`.ui5-hidden-text {
	position: absolute;
	clip: rect(1px,1px,1px,1px);
	user-select: none;
	left: -1000px; /* ensure the invisible texts are never part of the viewport */
...
}`,...(se=(ne=I.parameters)==null?void 0:ne.docs)==null?void 0:se.source}}};const Wt=["Default"],vi=Object.freeze(Object.defineProperty({__proto__:null,Default:I,__namedExportsOrder:Wt,default:Pt},Symbol.toStringTag,{value:"Module"}));export{vi as C,I as D,z as W};
//# sourceMappingURL=Wizard.stories-51aa7548.js.map
