import{_ as b}from"./iframe-fee88bfa.js";import{a as u,U as f,d as v}from"./UI5Element-3b11b083.js";import{e as p,l as y,a as _,b as w,p as m,c as x,d as k,w as S}from"./withWebComponent-d4224c1c.js";import{s as g}from"./slot-76e48863.js";import{w as B}from"./Button-86524f67.js";import{_ as N}from"./i18n-defaults-f002f496.js";function T(n,e,t){return p`<div class="ui5-badge-root"><slot name="icon"></slot>${this.hasText?D.call(this,n,e,t):void 0}<span class="ui5-hidden-text">${y(this.badgeDescription)}</span></div>`}function D(n,e,t){return p`<label class="ui5-badge-text"><bdi><slot></slot></bdi></label>`}u("@ui5/webcomponents-theming","sap_fiori_3",async()=>_);u("@ui5/webcomponents","sap_fiori_3",async()=>w);const I={packageName:"@ui5/webcomponents",fileName:"themes/Badge.css",content:`.ui5-hidden-text {
	position: absolute;
...
<ui5-link href="https://sap.github.io/ui5-webcomponents/playground/?path=/docs/main-Badge" target="_blank">UI5 Web Components Storybook</ui5-link>`,displayName:"Badge",props:{children:{defaultValue:null,description:`Defines the text of the component.
...
//# sourceMappingURL=index-e06c2994.js.map
