import{e as L,l as f,a as g,b,p as r,c as B,d as $}from"./withWebComponent-7b9bd1ee.js";import{a as l,n as T,o as O,U as M,p as D}from"./UI5Element-b1843653.js";import{e as d}from"./Icon-aac9cdc2.js";import{s as N}from"./slot-76e48863.js";import{a as w,b as z}from"./Device-208919c6.js";import{g as k,a as I}from"./FocusableElements-72585d9b.js";import{g as H}from"./AriaLabelHelper-43a261ec.js";import{g as A}from"./decline-d907918c.js";import{d as C,e as V,b as G}from"./Icons-9f549e0f.js";import{a as j,b as W,c as X}from"./PopupUtils-2f7e8748.js";import{R as P}from"./ResizeHandler-8726336f.js";import{M as F}from"./MediaRange-25b98f31.js";import{s as v}from"./style-map-0c64293c.js";import{o as R}from"./class-map-6a9bd920.js";var x;(function(t){t.None="None",t.Dialog="Dialog",t.AlertDialog="AlertDialog"})(x||(x={}));const m=x,ge=(t,e,o)=>Math.min(Math.max(t,e),o);function q(t,e,o){return L`<section style="${v(this.styles.root)}" class="${R(this.classes.root)}" role="${f(this._role)}" aria-modal="${f(this._ariaModal)}" aria-label="${f(this._ariaLabel)}" aria-labelledby="${f(this._ariaLabelledBy)}" @keydown=${this._onkeydown} @focusout=${this._onfocusout} @mouseup=${this._onmouseup} @mousedown=${this._onmousedown}><span class="first-fe" data-ui5-focus-trap tabindex="0" @focusin=${this.forwardToLast}></span><div style="${v(this.styles.content)}" class="${R(this.classes.content)}"  @scroll="${this._scroll}" part="content"><slot></slot></div><span class="last-fe" data-ui5-focus-trap tabindex="0" @focusin=${this.forwardToFirst}></span></section> `}function U(t,e,o){return L`<div class="ui5-block-layer" ?hidden=${this._blockLayerHidden} tabindex="0" style="${v(this.styles.blockLayer)}" @keydown="${this._preventBlockLayerFocus}" @mousedown="${this._preventBlockLayerFocus}"></div>`}let s=[];const Z=(t,e=[])=>{s.some(o=>o.instance===t)||s.push({instance:t,parentPopovers:e}),S(),s.length===1&&K()},J=t=>{s=s.filter(e=>e.instance!==t),S(),s.length||Q()},be=()=>[...s],E=t=>{s.length&&C(t)&&s[s.length-1].instance.close(!0)},K=()=>{document.addEventListener("keydown",E)},Q=()=>{document.removeEventListener("keydown",E)},S=()=>{let t,e=!1;for(let o=s.length-1;o>=0;o--)t=s[o].instance,!e&&t.isModal?(t.isTopModalPopup=!0,e=!0):t.isTopModalPopup=!1};l("@ui5/webcomponents-theming","sap_fiori_3",async()=>g);l("@ui5/webcomponents","sap_fiori_3",async()=>b);const Y={packageName:"@ui5/webcomponents",fileName:"themes/Popup.css",content:`:host {
...
`};export{m as P,Z as a,ve as b,ge as c,be as g,J as r,xe as s};
//# sourceMappingURL=PopupsCommon.css-38257fbf.js.map
