...
import{j as t}from"./jsx-runtime-DoxjgJx5.js";import"./index-CQTAO8tP.js";import{r as C}from"./index-Cu9bd8lq.js";import{r as k}from"./index-Ckls47V4.js";import{B as I}from"./index-BeutTfwK.js";import{a as S,C as s}from"./index-me5BC6Zi.js";import{_ as N}from"./iframe-B9ojHKoH.js";import{U as j}from"./UI5Element-TZfj5eGG.js";import{D as E}from"./Popover-Jk90pyiT.js";import{a as y,b as c,l as a,s as q,p as h,c as V,f as O,w as x}from"./withWebComponent-CmHHCrVX.js";import{s as B}from"./slot-Df15G--e.js";import{e as w}from"./event-CegLCnR0.js";import{b as M}from"./i18nBundle-C2WczoLt.js";import{C as A}from"./CSSColor-CzaElTOH.js";import{c as b}from"./Icon-xNvpL1oe.js";import{r as $}from"./Boot-CiW9Yqx0.js";import{s as U}from"./parameters-bundle.css-B6zgRRib.js";import{s as L}from"./ResponsivePopoverCommon.css-CNtxlEP6.js";import{$ as F,e as z}from"./i18n-defaults-weVOdquz.js";import{b as Y}from"./Button-BzhOkI6c.js";import{a as H}from"./Title-Dz2AvBrM.js";import W from"./ResponsivePopover-vsmk_8wm.js";function G(l,e,o){return o?y`<${c("ui5-responsive-popover",e,o)} hide-arrow content-only-on-desktop placement-type="Bottom" ?open="${this._open}" .opener="${a(this.opener)}" @ui5-after-close="${a(this.onAfterClose)}"><div slot="header" class="ui5-cp-header"><${c("ui5-title",e,o)} level="H5">${a(this._colorPaletteTitle)}</${c("ui5-title",e,o)}></div><div><${c("ui5-color-palette",e,o)} ?show-more-colors="${this.showMoreColors}" ?show-recent-colors="${this.showRecentColors}" ?show-default-color="${this.showDefaultColor}" default-color="${a(this.defaultColor)}" popup-mode @ui5-item-click="${a(this.onSelectedColor)}">${b(this.colorPaletteColors,(r,n)=>r._id||n,(r,n)=>g.call(this,l,e,o,r,n))}</${c("ui5-color-palette",e,o)}></div><div slot="footer" class="ui5-cp-footer"><${c("ui5-button",e,o)} design="Transparent" @click="${this.closePopover}">${a(this._cancelButtonLabel)}</${c("ui5-button",e,o)}></div></${c("ui5-responsive-popover",e,o)}>`:y`<ui5-responsive-popover hide-arrow content-only-on-desktop placement-type="Bottom" ?open="${this._open}" .opener="${a(this.opener)}" @ui5-after-close="${a(this.onAfterClose)}"><div slot="header" class="ui5-cp-header"><ui5-title level="H5">${a(this._colorPaletteTitle)}</ui5-title></div><div><ui5-color-palette ?show-more-colors="${this.showMoreColors}" ?show-recent-colors="${this.showRecentColors}" ?show-default-color="${this.showDefaultColor}" default-color="${a(this.defaultColor)}" popup-mode @ui5-item-click="${a(this.onSelectedColor)}">${b(this.colorPaletteColors,(r,n)=>r._id||n,(r,n)=>g.call(this,l,e,o,r,n))}</ui5-color-palette></div><div slot="footer" class="ui5-cp-footer"><ui5-button design="Transparent" @click="${this.closePopover}">${a(this._cancelButtonLabel)}</ui5-button></div></ui5-responsive-popover>`}function g(l,e,o,r,n){return y`<slot name="${a(r._individualSlot)}"></slot>`}$("@ui5/webcomponents-theming","sap_horizon",async()=>q);$("@ui5/webcomponents","sap_horizon",async()=>U);const J={packageName:"@ui5/webcomponents",fileName:"themes/ColorPalettePopover.css.ts",content:`.ui5-cp-header{width:100%;height:var(--_ui5-v1-23-1_color-palette-button-height);display:flex;align-items:center}.ui5-cp-footer{width:100%;display:flex;justify-content:flex-end;align-items:center;margin:.1875rem 0}[ui5-responsive-popover]::part(content){padding:0}.ui5-cp-item-container{padding:.3125rem .6875rem}
`};var u=function(l,e,o,r){var n=arguments.length,p=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,o):r,v;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")p=Reflect.decorate(l,e,o,r);else for(var P=l.length-1;P>=0;P--)(v=l[P])&&(p=(n<3?v(p):n>3?v(e,o,p):v(e,o))||p);return n>3&&p&&Object.defineProperty(e,o,p),p},m;let i=m=class extends j{static async onDefine(){m.i18nBundle=await M("@ui5/webcomponents")}constructor(){super()}get responsivePopover(){return this.shadowRoot.querySelector("[ui5-responsive-popover]")}get respPopover(){return this.shadowRoot.querySelector("[ui5-responsive-popover]")}showAt(e){console.warn("The method 'showAt' is deprecated and will be removed in future, use 'open' and 'opener' props instead."),this.open=!0,this.opener=e}openPopover(e){console.warn("The method 'openPopover' is deprecated and will be removed in future, use 'open' and 'opener' props instead."),this.showAt(e)}closePopover(){this.open=!1}onAfterClose(){this.closePopover(),this.fireEvent("close")}onSelectedColor(e){this.closePopover(),this.fireEvent("item-click",e.detail)}isOpen(){return this.open}get colorPaletteColors(){return this.getSlottedNodes("colors")}get _colorPaletteTitle(){return m.i18nBundle.getText(F)}get _cancelButtonLabel(){return m.i18nBundle.getText(z)}get _open(){return this.open||void 0}};u([h({type:Boolean})],i.prototype,"showRecentColors",void 0);u([h({type:Boolean})],i.prototype,"showMoreColors",void 0);u([h({type:Boolean})],i.prototype,"showDefaultColor",void 0);u([h({validator:A})],i.prototype,"defaultColor",void 0);u([h({type:Boolean})],i.prototype,"open",void 0);u([h({validator:E})],i.prototype,"opener",void 0);u([B({default:!0,type:HTMLElement,individualSlots:!0})],i.prototype,"colors",void 0);i=m=u([V({tag:"ui5-color-palette-popover",renderer:O,styles:[L,J],template:G,dependencies:[W,Y,H,S]}),w("item-click",{detail:{color:{type:String}}}),w("close")],i);i.define();const K=i,Q=Object.freeze(Object.defineProperty({__proto__:null,default:K},Symbol.toStringTag,{value:"Module"})),d=x("ui5-color-palette-popover",["defaultColor","opener"],["open","showDefaultColor","showMoreColors","showRecentColors"],[],["close","item-click"],()=>N(()=>Promise.resolve().then(()=>Q),void 0,import.meta.url));d.displayName="ColorPalettePopover";try{d.displayName="ColorPalettePopover",d.__docgenInfo={description:`Represents a predefined range of colors for easier selection.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const X={title:"Modals & Popovers / ColorPalettePopover",component:d,argTypes:{children:{control:{disable:!0}},defaultColor:{control:{type:"color"}}},parameters:{chromatic:{delay:1e3}},tags:["package:@ui5/webcomponents"]},T=C.forwardRef((l,e)=>k.createPortal(t.jsx(d,{...l,ref:e}),document.body));T.displayName="ColorPalettePopover";const f={render(l){const e=C.useRef(null),o=C.useRef(null);C.useEffect(()=>{},[]);const r=n=>{e.current.showAt(n.target)};return t.jsxs(t.Fragment,{children:[t.jsx(I,{onClick:r,ref:o,children:"Open ColorPalettePopover"}),t.jsxs(T,{...l,ref:e,children:[t.jsx(s,{value:"black"}),t.jsx(s,{value:"darkblue"}),t.jsx(s,{value:"#444444"}),t.jsx(s,{value:"rgb(0,200,0)"}),t.jsx(s,{value:"green"}),t.jsx(s,{value:"darkred"}),t.jsx(s,{value:"yellow"}),t.jsx(s,{value:"blue"}),t.jsx(s,{value:"cyan"}),t.jsx(s,{value:"orange"}),t.jsx(s,{value:"#5480e7"}),t.jsx(s,{value:"#ff6699"})]})]})}};var _,D,R;f.parameters={...f.parameters,docs:{...(_=f.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render(args) {
