import{j as e}from"./useIsomorphicLayoutEffect-CJg151Ok.js";import{P as te}from"./Popover-CLYhCt6_.js";import{T as ae}from"./Title-DOT2nEnt.js";import{o as T}from"./ValueState-Bg0UWejw.js";import{r as d}from"./index-CP2MHerv.js";import{D as ne}from"./index-C35Ti9m2.js";import{M as re,a as x}from"./index-DR8dPv92.js";import{O as h}from"./index-BLxobInj.js";import{S as le}from"./index-7JEYO2NU.js";import{a as se,F as _}from"./index-CUrjcEwV.js";import{b as ie,a as A,F as de}from"./index-BNngaerw.js";import{T as k}from"./index-DymV_ww8.js";import{V as P,a}from"./VariantItem-DetIZTVw.js";const oe={title:"Inputs / VariantManagement",component:P,args:{placement:te.Bottom,level:ae.H4}},b={render:o=>e.jsxs(P,{...o,children:[e.jsx(a,{children:"Default VariantItem"}),e.jsx(a,{selected:!0,children:"Selected"}),e.jsx(a,{author:"SAP",children:"Author"}),e.jsx(a,{favorite:!0,children:"Favorite"}),e.jsx(a,{isDefault:!0,children:"IsDefault"}),e.jsx(a,{favorite:!0,labelReadOnly:!0,children:"Favorite & labelReadOnly"}),e.jsx(a,{applyAutomatically:!0,children:"ApplyAutomatically"}),e.jsx(a,{applyAutomatically:!0,applyAutomaticallyText:"Describe your exceptions that deviate from the standard behavior here.",children:"applyAutomatically & applyAutomaticallyText"}),e.jsx(a,{readOnly:!0,children:"ReadOnly"}),e.jsx(a,{global:!0,children:"Global"}),e.jsx(a,{global:!0,readOnly:!0,children:"Global & readOnly"}),e.jsx(a,{global:!0,children:"Not deletable -> global"}),e.jsx(a,{hideDelete:!0,children:"Not deletable -> hideDelete"}),e.jsx(a,{hideDelete:!1,global:!0,children:"Deletable -> hideDelete: false, global: true"})]})},w={render:({selectedByIndex:o=1})=>{const[p,V]=d.useState(void 0),[v,f]=d.useState(void 0),[S,M]=d.useState({1:"Only alphanumeric chars in Save View input",2:"Max 12 chars"}),g=n=>{n.target.value.match(/^[a-z0-9\s]+$/i)?(n.isInvalid=!1,V(void 0)):(n.isInvalid=!0,V(T.Negative))},D=n=>{M(i=>({...i,[n.detail["data-id"]]:n.detail.children}))},O=n=>{n.target.value.length>12?(n.isInvalid=!0,f(T.Negative)):(n.isInvalid=!1,f(void 0))},u=n=>{const i=n.detail.updatedVariants.find(y=>y["data-custom-manage-views"]);!v&&i&&M(y=>({...y,[i["data-id"]]:i.children}))},R=()=>{f(void 0)},m=()=>{V(void 0)};return e.jsxs(P,{onSaveAs:D,onSaveManageViews:u,onManageViewsCancel:R,onSaveViewCancel:m,children:[e.jsx(a,{"data-id":1,selected:o===0,saveViewInputProps:{valueState:p,valueStateMessage:p?e.jsx("div",{children:"Only alphanumeric and space characters allowed!"}):void 0,onInput:g,"data-testid":"alphanumeric"},children:S[1]}),e.jsx(a,{"data-custom-manage-views":!0,"data-id":2,selected:o===1,manageViewsInputProps:{valueState:v,valueStateMessage:v?e.jsx("div",{children:"No more than 12 characters allowed!"}):void 0,onInput:O,"data-testid":"12chars"},children:S[2]})]})}},j={name:"in FilterBar",render:()=>{const[o,p]=d.useState("Standard"),[V,v]=d.useState("Standard"),[f,S]=d.useState([]),[M,g]=d.useState(!1),[D,O]=d.useState(!1),u=d.useRef({Standard:{selectedCountry:"Indonesia",date:"",selectedCodes:{}}}),R=(t,l)=>{const{payload:s,type:r}=l;switch(O(!0),r){case"selectedCountry":return{...t,selectedCountry:s};case"date":return{...t,date:s};case"selectedCodes":return{...t,selectedCodes:s};case"changeVariant":return s;default:return console.warn("Unknown action type!"),t}},[m,n]=d.useReducer(R,u.current.Standard),{selectedCountry:i,date:y,selectedCodes:I}=m,H=t=>{const{selectedOption:l}=t.detail;n({type:"selectedCountry",payload:l.textContent})},q=t=>{n({type:"date",payload:t.detail.value})},J=t=>{n({type:"selectedCodes",payload:t.detail.items.reduce((l,s)=>(l[s.dataset.code]=!0,l),{})})},K=t=>{const{variantItem:l,selected:s,readOnly:r,labelReadOnly:C,...c}=t.detail;c.isDefault&&v(c.children),S(F=>[...F,{...c,author:"Current User"}]),u.current[c.children]=m,p(c.children),g(!1)},Q=t=>{const{variantItem:l,selected:s,...r}=t.detail;u.current[r.children]=m,g(!1)},Y=t=>{const{deletedVariants:l,updatedVariants:s}=t.detail;l.forEach(r=>{delete u.current[r.children],S(C=>C.filter(c=>c.children!==r.children))}),s.forEach(r=>{const{variantItem:C,selected:c,...F}=r;u.current[r.children]=F,r.isDefault&&v(r.children),r.selected&&p(r.children),S(ee=>ee.map(B=>B.children===r.prevVariant.children?F:B))})},Z=t=>{const l=t.detail.selectedVariant.children;n({type:"changeVariant",payload:u.current[l]}),p(l)};return d.useEffect(()=>{if(D){const t=Object.entries(u.current[o]).some(([l,s])=>{if(l==="selectedCodes"){const r=Object.keys(m.selectedCodes).length;return Object.keys(s).length!==r?!0:Object.entries(m.selectedCodes).some(([C,c])=>(s==null?void 0:s[C])!==c)}return m[l]!==s});O(!1),g(t)}},[D,o]),e.jsxs(e.Fragment,{children:[e.jsxs(se,{header:e.jsxs(P,{hideApplyAutomatically:!0,dirtyState:M,onSaveAs:K,onSave:Q,onSelect:Z,onSaveManageViews:Y,children:[e.jsx(a,{selected:o==="Standard",global:!0,isDefault:V==="Standard",author:"SAP",readOnly:!0,labelReadOnly:!0,children:"Standard"}),f.map(t=>e.jsx(a,{...t,selected:o===t.children,isDefault:V===t.children,children:t.children},t.children))]}),children:[e.jsx(_,{label:"Countries",children:e.jsxs(le,{onChange:H,children:[e.jsx(h,{selected:i==="Indonesia",children:"Indonesia"}),e.jsx(h,{selected:i==="Costa Rica",children:"Costa Rica"}),e.jsx(h,{selected:i==="Slovakia",children:"Slovakia"}),e.jsx(h,{selected:i==="Iceland",children:"Iceland"}),e.jsx(h,{selected:i==="Malta",children:"Malta"}),e.jsx(h,{selected:i==="Guyana",children:"Guyana"}),e.jsx(h,{selected:i==="Spain",children:"Spain"}),e.jsx(h,{selected:i==="Austria",children:"Austria"})]})}),e.jsx(_,{label:"Date",children:e.jsx(ne,{value:y,onChange:q})}),e.jsx(_,{label:"Company Code",children:e.jsxs(re,{onSelectionChange:J,children:[e.jsx(x,{text:"001",selected:I["001"],"data-code":"001"}),e.jsx(x,{text:"002",selected:I["002"],"data-code":"002"}),e.jsx(x,{text:"003",selected:I["003"],"data-code":"003"}),e.jsx(x,{text:"004",selected:I["004"],"data-code":"004"}),e.jsx(x,{text:"005",selected:I["005"],"data-code":"005"})]})})]}),e.jsxs(ie,{style:{marginBlockStart:"2rem"},columnsS:1,columnsM:1,columnsL:1,columnsXL:1,labelSpanM:2,labelSpanL:2,labelSpanXL:2,children:[e.jsx(A,{label:"Current View",children:e.jsx(k,{children:o})}),e.jsxs(de,{titleText:"Filters",children:[e.jsx(A,{label:"Selected Country",children:e.jsx(k,{children:i})}),e.jsx(A,{label:"Selected Date",children:e.jsx(k,{children:y})}),e.jsx(A,{label:"Selected Company Codes",children:e.jsx(k,{children:Object.keys(I).join(", ")})})]})]})]})}};var G,L,E;b.parameters={...b.parameters,docs:{...(G=b.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: args => {
...
}`,...(E=(L=b.parameters)==null?void 0:L.docs)==null?void 0:E.source}}};var N,W,U;w.parameters={...w.parameters,docs:{...(N=w.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: ({
    selectedByIndex = 1
  }: any) => {
