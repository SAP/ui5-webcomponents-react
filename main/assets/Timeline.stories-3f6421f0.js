...
}`};var w=globalThis&&globalThis.__decorate||function(n,e,t,o){var l=arguments.length,i=l<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,u;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,t,o);else for(var b=n.length-1;b>=0;b--)(u=n[b])&&(i=(l<3?u(i):l>3?u(e,t,i):u(e,t))||i);return l>3&&i&&Object.defineProperty(e,t,i),i},_;const be="ShortLineWidth",pe="LargeLineWidth";let p=_=class extends ${constructor(){super(),this._itemNavigation=new Y(this,{getItemsCallback:()=>this.items})}static async onDefine(){_.i18nBundle=await F("@ui5/webcomponents-fiori")}get ariaLabel(){return this.accessibleName?`${_.i18nBundle.getText(x)} ${this.accessibleName}`:_.i18nBundle.getText(x)}_onfocusin(e){const t=e.target;this._itemNavigation.setCurrentItem(t)}onBeforeRendering(){this._itemNavigation._navigationMode=this.layout===d.Horizontal?k.Horizontal:k.Vertical;for(let e=0;e<this.items.length;e++)this.items[e].layout=this.layout,this.items[e+1]&&this.items[e+1].icon?this.items[e]._lineWidth=be:this.items[e].icon&&this.items[e+1]&&!this.items[e+1].icon&&(this.items[e]._lineWidth=pe)}_onkeydown(e){const t=e.target;q(e)?(!t.nameClickable||K(e)==="link")&&this._handleTabNextOrPrevious(e,q(e)):B(e)&&this._handleTabNextOrPrevious(e)}_handleTabNextOrPrevious(e,t){const o=e.target,l=t?this.items.indexOf(o)+1:this.items.indexOf(o)-1,i=this.items[l];if(i){if(i.nameClickable&&!t){e.preventDefault(),i.focusLink();return}e.preventDefault(),i.focus(),this._itemNavigation.setCurrentItem(i)}}};w([c({type:d,defaultValue:d.Vertical})],p.prototype,"layout",void 0);w([c()],p.prototype,"accessibleName",void 0);w([Q({type:HTMLElement,individualSlots:!0,default:!0})],p.prototype,"items",void 0);p=_=w([L({tag:"ui5-timeline",languageAware:!0,renderer:P,styles:de,template:Z,dependencies:[O]})],p);p.define();const he=p,_e=Object.freeze(Object.defineProperty({__proto__:null,default:he},Symbol.toStringTag,{value:"Module"})),h=E("ui5-timeline",["accessibleName","layout"],[],[],[],()=>D(()=>Promise.resolve().then(()=>_e),void 0,import.meta.url));h.displayName="Timeline";h.defaultProps={layout:d.Vertical};try{h.displayName="Timeline",h.__docgenInfo={description:`The \`Timeline\` component shows entries (such as objects, events, or posts) in chronological order. A common use case is to provide information about changes to an object, or events related to an object. These entries can be generated by the system (for example, value XY changed from A to B), or added manually. There are two distinct variants of the timeline: basic and social. The basic timeline is read-only, while the social timeline offers a high level of interaction and collaboration, and is integrated within SAP Jam
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const g=E("ui5-timeline-item",["icon","name","subtitleText","titleText"],["nameClickable"],[],["name-click"],()=>D(()=>Promise.resolve().then(()=>me),void 0,import.meta.url));g.displayName="TimelineItem";try{g.displayName="TimelineItem",g.__docgenInfo={description:`An entry posted on the timeline
...
}`,...(C=(H=f.parameters)==null?void 0:H.docs)==null?void 0:C.source}}};const xe=["Default"],Me=Object.freeze(Object.defineProperty({__proto__:null,Default:f,__namedExportsOrder:xe,default:ke},Symbol.toStringTag,{value:"Module"}));export{Me as C,f as D,g as T};
//# sourceMappingURL=Timeline.stories-3f6421f0.js.map
