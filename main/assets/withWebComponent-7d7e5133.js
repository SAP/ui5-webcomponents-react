import{b as k,x as j,y as O,Z as M,w as D,c as T,a as V,k as $}from"./utils-626dc1bf.js";import{g as v,a as G}from"./CustomElementsScopeUtils-137da8c8.js";import{j as X}from"./jsx-runtime-d079401a.js";import{u as q}from"./useIsomorphicLayoutEffect-c49de97d.js";import{r as d}from"./index-f1f2c4b1.js";function Y(e){const _=d.useRef(null);return[d.useCallback(n=>{e&&(typeof e=="function"&&e(n),{}.hasOwnProperty.call(e,"current")&&(e.current=n)),_.current=n},[e]),_]}const n_=e=>_=>{if(Object.prototype.hasOwnProperty.call(_,"metadata")||(_.metadata={}),typeof e=="string"){_.metadata.tag=e;return}const{tag:o,languageAware:n,themeAware:i,fastNavigation:s}=e;_.metadata.tag=o,n&&(_.metadata.languageAware=n),i&&(_.metadata.themeAware=i),s&&(_.metadata.fastNavigation=s),["render","renderer","template","staticAreaTemplate","styles","staticAreaStyles","dependencies"].forEach(u=>{const g=e[u==="render"?"renderer":u];g&&Object.defineProperty(_,u,{get:()=>g})})},a_=e=>(_,o)=>{const n=_.constructor;Object.prototype.hasOwnProperty.call(n,"metadata")||(n.metadata={});const i=n.metadata;i.properties||(i.properties={});const s=i.properties;s[o]||(s[o]=e||{type:String})};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Z={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},J=e=>(..._)=>({_$litDirective$:e,values:_});class K{constructor(_){}get _$AU(){return this._$AM._$AU}_$AT(_,o,n){this._$Ct=_,this._$AM=o,this._$Ci=n}_$AS(_,o){return this.update(_,o)}update(_,o){return this.render(...o)}}/**
 * @license
...
}`};function Q(e){d.useEffect(e,[])}function m_(){const[e,_]=d.useState(!1);return d.useEffect(()=>{_(!0)},[]),e}const B=e=>`on${V($(e))}`,H=new Set([]),f_=(e,_,o,n,i,s)=>d.forwardRef((u,x)=>{const{className:g,children:L,waitForDefine:p,...l}=u,[A,z]=Y(x),S=G(e),m=S?`${e}-${S}`:e,[f,P]=d.useState(H.has(m));Q(()=>{s()});const E=_.reduce((t,r)=>l.hasOwnProperty(r)?{...t,[T(r)]:l[r]}:t,{}),N=o.reduce((t,r)=>l[r]===!0||l[r]==="true"?{...t,[T(r)]:!0}:t,{}),U=n.reduce((t,r)=>{var y;const a=l[r];if(!a)return t;if(((y=l[r])==null?void 0:y.$$typeof)===Symbol.for("react.portal"))return console.warn("ReactPortal is not supported for slot props."),t;const h=[];let F=0;const C=c=>{var I;c&&(c.type===d.Fragment?d.Children.toArray((I=c.props)==null?void 0:I.children).filter(Boolean).forEach(W=>{C(W)}):(h.push(d.cloneElement(c,{key:`${r}-${F}`,slot:r})),F++))};return Array.isArray(a)?a.forEach(c=>{C(c)}):C(a),[...t,...h]},[]);q(()=>{const t=z.current,r={};if(!p||f)return i.forEach(a=>{const h=l[B(a)];typeof h=="function"&&(r[a]=h,t==null||t.addEventListener(a,r[a]))}),()=>{for(const a in r)t==null||t.removeEventListener(a,r[a])}},[...i.map(t=>l[B(t)]),f,p]);const R=Object.entries(l).filter(([t])=>!_.includes(t)).filter(([t])=>!n.includes(t)).filter(([t])=>!o.includes(t)).filter(([t])=>!i.map(r=>B(r)).includes(t)).reduce((t,[r,a])=>(!r.startsWith("aria-")&&!r.startsWith("data-")&&a===!1||(t[r]=a),t),{});return d.useEffect(()=>{p&&!f&&customElements.whenDefined(m).then(()=>{P(!0),H.add(m)})},[m,p,f]),p&&!f?null:X.jsxs(m,{ref:A,...N,...E,...R,class:g,children:[U,L]})});export{p_ as a,b,n_ as c,u_ as d,J as e,l_ as f,s_ as g,m_ as h,K as i,i_ as l,d_ as o,a_ as p,c_ as s,Z as t,Y as u,f_ as w};
//# sourceMappingURL=withWebComponent-7d7e5133.js.map
