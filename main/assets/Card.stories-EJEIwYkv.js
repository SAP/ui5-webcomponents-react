import{j as e}from"./useIsomorphicLayoutEffect-CJg151Ok.js";import"./Boot-CUKJMqeB.js";import"./person-placeholder-rdL4W06p.js";import{L as h}from"./LineChart-RIdSdqOB.js";import{A as C,D as S,V as i,N as o}from"./index-Cr16W1DR.js";import{C as f}from"./index-Ch5ePNr_.js";import{I as g}from"./index-S83HuHpL.js";import{L as j}from"./index-DC9ih2rz.js";import{S as a}from"./index-DWaAzLZB.js";import{C as s}from"./index-iF-tKoUE.js";const T="person-placeholder",D={title:"Data Display / Card",component:s,argTypes:{header:{control:{disable:!0}},children:{control:{disable:!0}}},args:{style:{width:"300px"},header:e.jsx(f,{titleText:"TeamSpace",subtitleText:"Direct Reports",additionalText:"3 of 5",avatar:e.jsx(g,{name:T})})},tags:["package:@ui5/webcomponents"]},r={render:n=>e.jsx(s,{...n,children:e.jsxs(j,{children:[e.jsx(a,{description:"Software Architect",children:"Richard Wilson"}),e.jsx(a,{description:"Visual Designer",children:"Elena Petrova"}),e.jsx(a,{description:"Quality Specialist",children:"John Miller"})]})})},L=[{name:"January",users:76},{name:"February",users:230},{name:"March",users:240},{name:"April",users:280},{name:"May",users:100}],t={render:n=>e.jsx(s,{header:e.jsxs(C,{titleText:"Project Cloud Transformation",subtitleText:"Revenue",unitOfMeasurement:"EUR",trend:S.Down,value:"65.34",state:i.Error,scale:"K",description:"Q1, 2018",children:[e.jsx(o,{titleText:"Target",number:"100",unit:"k"}),e.jsx(o,{titleText:"Deviation",number:"34.7",unit:"%",state:i.Critical})]}),children:e.jsx(h,{className:"chromatic-ignore",noLegend:!0,dimensions:[{accessor:"name"}],measures:[{accessor:"users",formatter:x=>`${x}k`}],dataset:L})})};var d,c,l;r.parameters={...r.parameters,docs:{...(d=r.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: args => {
    return <Card {...args}>
        <List>
