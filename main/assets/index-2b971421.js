import{_ as b}from"./iframe-1cb4d8f7.js";import{r as u,U as f,l as v}from"./UI5Element-11982a12.js";import{b as p,l as y,s as _,a as w,p as m,c as x,f as S,w as k}from"./withWebComponent-03662f7f.js";import{s as g}from"./slot-76e48863.js";import{w as B}from"./Button-3da2aede.js";import{l as N}from"./i18n-defaults-1a83921e.js";function T(n,e,t){return p`<div class="ui5-badge-root"><slot name="icon"></slot>${this.hasText?D.call(this,n,e,t):void 0}<span class="ui5-hidden-text">${y(this.badgeDescription)}</span></div>`}function D(n,e,t){return p`<label class="ui5-badge-text"><bdi><slot></slot></bdi></label>`}u("@ui5/webcomponents-theming","sap_fiori_3",async()=>_);u("@ui5/webcomponents","sap_fiori_3",async()=>w);const I={packageName:"@ui5/webcomponents",fileName:"themes/Badge.css",content:`.ui5-hidden-text {
	position: absolute;
...
//# sourceMappingURL=index-2b971421.js.map
