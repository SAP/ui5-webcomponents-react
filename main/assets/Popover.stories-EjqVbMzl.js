...
}`}};const h={title:"Modals & Popovers / Popover",component:u,args:{children:e.jsx(C,{children:'Press "Escape" or click outside to close the Popover'}),headerText:"Popover Header",horizontalAlign:P.Center,placementType:b.Right,verticalAlign:j.Center,className:"footerPartNoPadding"},argTypes:{footer:{control:{disable:!0}},header:{control:{disable:!0}}},tags:["stories-mdx"],includeStories:["defaultStory","withContent"]};h.parameters=h.parameters||{};h.parameters.docs={...h.parameters.docs||{},page:E};const Ro=["defaultStory","withContent"];export{Ro as __namedExportsOrder,h as default,O as defaultStory,I as withContent};
//# sourceMappingURL=Popover.stories-EjqVbMzl.js.map
