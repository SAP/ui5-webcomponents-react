import{j as v}from"./jsx-runtime-6b79a019.js";import{c as W}from"./calendar-09fa063d.js";import{r as T,U as $,l as F,m as M}from"./UI5Element-11982a12.js";import{m as z,n as B,r as S}from"./Icons-234bf59e.js";import{_ as D}from"./iframe-4136d8d1.js";import{b as s,l as r,d as y,s as V,p as c,c as L,f as P,w as E}from"./withWebComponent-03662f7f.js";import{c as U,a as G,e as J}from"./Icon-3498e12d.js";import{a as X}from"./Link-6cd3dd1c.js";import{o as q}from"./class-map-341004db.js";import{s as R}from"./parameters-bundle.css-f9dc8928.js";import{s as Q}from"./slot-76e48863.js";import{I as Y,N as k}from"./ItemNavigation-a882fb90.js";import{g as K}from"./MarkedEvents-b83081e9.js";import{ay as x}from"./i18n-defaults-b490e4f6.js";var I;(function(n){n.Vertical="Vertical",n.Horizontal="Horizontal"})(I||(I={}));const d=I;function Z(n,t,e){return s`<div class="ui5-timeline-root" @focusin=${this._onfocusin} @keydown=${this._onkeydown}><div class="ui5-timeline-scroll-container"><ul class="ui5-timeline-list" aria-live="polite" aria-label="${r(this.ariaLabel)}">${U(this.items,(o,l)=>o._id||l,(o,l)=>tt.call(this,n,t,e,o,l))}</ul></div></div>`}function tt(n,t,e,o,l){return s`<li class="ui5-timeline-list-item"><slot name="${r(o._individualSlot)}"></slot></li>`}function et(n,t,e){return s`<div class="ui5-tli-root" dir="${r(this.effectiveDir)}"><div class="${q(this.classes.indicator)}"><div class="ui5-tli-icon-outer">${this.icon?nt.call(this,n,t,e):it.call(this,n,t,e)}</div></div><div class="ui5-tli-bubble" tabindex="${r(this._tabIndex)}" data-sap-focus-ref><div class="ui5-tli-title">${this.name?ot.call(this,n,t,e):void 0}<span>${r(this.titleText)}</span></div><div class="ui5-tli-subtitle">${r(this.subtitleText)}</div>${this.textContent?at.call(this,n,t,e):void 0}<span class="${q(this.classes.bubbleArrowPosition)}"></span></div></div>`}function nt(n,t,e){return e?s`<${y("ui5-icon",t,e)} class="ui5-tli-icon" name="${r(this.icon)}"></${y("ui5-icon",t,e)}>`:s`<ui5-icon class="ui5-tli-icon" name="${r(this.icon)}"></ui5-icon>`}function it(n,t,e){return s`<div class="ui5-tli-dummy-icon-container"></div>`}function ot(n,t,e){return s`${this.nameClickable?lt.call(this,n,t,e):rt.call(this,n,t,e)}`}function lt(n,t,e){return e?s`<${y("ui5-link",t,e)} @ui5-click="${r(this.onNamePress)}" class="ui5-tli-title-name-clickable">${r(this.name)}&nbsp;</${y("ui5-link",t,e)}>`:s`<ui5-link @ui5-click="${r(this.onNamePress)}" class="ui5-tli-title-name-clickable">${r(this.name)}&nbsp;</ui5-link>`}function rt(n,t,e){return s`<span class="ui5-tli-title-name">${r(this.name)}&nbsp;</span>`}function at(n,t,e){return s`<div class="ui5-tli-desc"><slot></slot></div>`}T("@ui5/webcomponents-theming","sap_fiori_3",async()=>V);T("@ui5/webcomponents-fiori","sap_fiori_3",async()=>R);const st={packageName:"@ui5/webcomponents-fiori",fileName:"themes/TimelineItem.css",content:`:host(:not([hidden])) {
	display: block;
}
...
:host([layout="Horizontal"]) [dir=rtl] .ui5-tli-indicator::before {
	left: var(--_ui5_timeline_tli_indicator_before_right);
	right: 2.125rem;
}`};var m=globalThis&&globalThis.__decorate||function(n,t,e,o){var l=arguments.length,i=l<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,u;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,t,e,o);else for(var b=n.length-1;b>=0;b--)(u=n[b])&&(i=(l<3?u(i):l>3?u(t,e,i):u(t,e))||i);return l>3&&i&&Object.defineProperty(t,e,i),i};const ct="ShortLineWidth",ut="LargeLineWidth";let a=class extends ${constructor(){super()}onNamePress(){this.fireEvent("name-click",{})}focusLink(){var t;(t=this.shadowRoot.querySelector("[ui5-link]"))==null||t.focus()}get classes(){return{indicator:{"ui5-tli-indicator":!0,"ui5-tli-indicator-short-line":this._lineWidth===ct,"ui5-tli-indicator-large-line":this._lineWidth===ut},bubbleArrowPosition:{"ui5-tli-bubble-arrow":!0,"ui5-tli-bubble-arrow--left":this.layout===d.Vertical,"ui5-tli-bubble-arrow--top":this.layout===d.Horizontal}}}};m([c()],a.prototype,"icon",void 0);m([c()],a.prototype,"name",void 0);m([c({type:Boolean})],a.prototype,"nameClickable",void 0);m([c()],a.prototype,"titleText",void 0);m([c()],a.prototype,"subtitleText",void 0);m([c({defaultValue:"-1",noAttribute:!0})],a.prototype,"_tabIndex",void 0);m([c({type:d,defaultValue:d.Vertical})],a.prototype,"layout",void 0);m([c()],a.prototype,"_lineWidth",void 0);a=m([L({tag:"ui5-timeline-item",renderer:P,styles:st,template:et,dependencies:[G,X]}),J("name-click")],a);a.define();const O=a,mt=Object.freeze(Object.defineProperty({__proto__:null,default:O},Symbol.toStringTag,{value:"Module"}));T("@ui5/webcomponents-theming","sap_fiori_3",async()=>V);T("@ui5/webcomponents-fiori","sap_fiori_3",async()=>R);const dt={packageName:"@ui5/webcomponents-fiori",fileName:"themes/Timeline.css",content:`:host(:not([hidden])) {
	display: block;
}
...
}`};var w=globalThis&&globalThis.__decorate||function(n,t,e,o){var l=arguments.length,i=l<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,u;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,t,e,o);else for(var b=n.length-1;b>=0;b--)(u=n[b])&&(i=(l<3?u(i):l>3?u(t,e,i):u(t,e))||i);return l>3&&i&&Object.defineProperty(t,e,i),i},_;const bt="ShortLineWidth",pt="LargeLineWidth";let p=_=class extends ${constructor(){super(),this._itemNavigation=new Y(this,{getItemsCallback:()=>this.items})}static async onDefine(){_.i18nBundle=await F("@ui5/webcomponents-fiori")}get ariaLabel(){return this.accessibleName?`${_.i18nBundle.getText(x)} ${this.accessibleName}`:_.i18nBundle.getText(x)}_onfocusin(t){const e=t.target;this._itemNavigation.setCurrentItem(e)}onBeforeRendering(){this._itemNavigation._navigationMode=this.layout===d.Horizontal?k.Horizontal:k.Vertical;for(let t=0;t<this.items.length;t++)this.items[t].layout=this.layout,this.items[t+1]&&this.items[t+1].icon?this.items[t]._lineWidth=bt:this.items[t].icon&&this.items[t+1]&&!this.items[t+1].icon&&(this.items[t]._lineWidth=pt)}_onkeydown(t){const e=t.target;z(t)?(!e.nameClickable||K(t)==="link")&&this._handleTabNextOrPrevious(t,z(t)):B(t)&&this._handleTabNextOrPrevious(t)}_handleTabNextOrPrevious(t,e){const o=t.target,l=e?this.items.indexOf(o)+1:this.items.indexOf(o)-1,i=this.items[l];if(i){if(i.nameClickable&&!e){t.preventDefault(),i.focusLink();return}t.preventDefault(),i.focus(),this._itemNavigation.setCurrentItem(i)}}};w([c({type:d,defaultValue:d.Vertical})],p.prototype,"layout",void 0);w([c()],p.prototype,"accessibleName",void 0);w([Q({type:HTMLElement,individualSlots:!0,default:!0})],p.prototype,"items",void 0);p=_=w([L({tag:"ui5-timeline",languageAware:!0,renderer:P,styles:dt,template:Z,dependencies:[O]})],p);p.define();const ht=p,_t=Object.freeze(Object.defineProperty({__proto__:null,default:ht},Symbol.toStringTag,{value:"Module"})),h=E("ui5-timeline",["accessibleName","layout"],[],[],[],()=>D(()=>Promise.resolve().then(()=>_t),void 0,import.meta.url));h.displayName="Timeline";h.defaultProps={layout:d.Vertical};try{h.displayName="Timeline",h.__docgenInfo={description:`The \`Timeline\` component shows entries (such as objects, events, or posts) in chronological order. A common use case is to provide information about changes to an object, or events related to an object. These entries can be generated by the system (for example, value XY changed from A to B), or added manually. There are two distinct variants of the timeline: basic and social. The basic timeline is read-only, while the social timeline offers a high level of interaction and collaboration, and is integrated within SAP Jam

__Note:__ This component is a web component developed by the UI5 Web Components’ team.

[UI5 Web Components Storybook](https://sap.github.io/ui5-webcomponents/playground/?path=/docs/fiori-Timeline)`,displayName:"Timeline",props:{children:{defaultValue:null,description:"Determines the content of the `Timeline`.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},accessibleName:{defaultValue:null,description:"Defines the accessible ARIA name of the component.",name:"accessibleName",required:!1,type:{name:"string"}},layout:{defaultValue:{value:"TimelineLayout.Vertical"},description:`Defines the items orientation.
...
}`,...(C=(H=f.parameters)==null?void 0:H.docs)==null?void 0:C.source}}};const xt=["Default"],Mt=Object.freeze(Object.defineProperty({__proto__:null,Default:f,__namedExportsOrder:xt,default:kt},Symbol.toStringTag,{value:"Module"}));export{Mt as C,f as D,g as T};
//# sourceMappingURL=Timeline.stories-2e221ac2.js.map
