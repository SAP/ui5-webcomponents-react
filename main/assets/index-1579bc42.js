import{_ as b}from"./iframe-cbfe8030.js";import{a as p,U as g,d as v}from"./UI5Element-2e105c8a.js";import{e as m,l as u,a as y,b as w,p as f,c as C,d as N,w as x}from"./withWebComponent-7b9bd1ee.js";import{s as _}from"./slot-76e48863.js";import{g as T}from"./AriaLabelHelper-43a261ec.js";import{o as R}from"./class-map-6a9bd920.js";import{I as D}from"./Icon-1927e688.js";import{O as L,Q as I}from"./i18n-defaults-2f9956dc.js";function A(n,e,t){return m`<div class="${R(this.classes.root)}" role="region" aria-label="${u(this._getAriaLabel)}">${this._hasHeader?S.call(this,n,e,t):void 0}<div role="group" aria-label="${u(this._ariaCardContentLabel)}"><slot></slot></div></div>`}function S(n,e,t){return m`<div class="ui5-card-header-root"><slot name="header"></slot></div>`}p("@ui5/webcomponents-theming","sap_fiori_3",async()=>y);p("@ui5/webcomponents","sap_fiori_3",async()=>w);const k={packageName:"@ui5/webcomponents",fileName:"themes/Card.css",content:`.ui5-hidden-text {
	position: absolute;
...
//# sourceMappingURL=index-1579bc42.js.map
