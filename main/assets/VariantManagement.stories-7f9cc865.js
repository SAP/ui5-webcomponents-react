import{a as w,j as e}from"./jsx-runtime-670450c2.js";import{r as l}from"./index-f1f749bf.js";import{V as o,a}from"./VariantItem-ef10819e.js";import{P as D}from"./Popover-cbbb060d.js";import{T as O}from"./Title-b986a4bd.js";import{V}from"./ValueState-ab6838cc.js";const A={title:"Inputs / VariantManagement",component:o,args:{placement:D.Bottom,level:O.H4}},n={render:r=>w(o,{...r,children:[e(a,{manageViewsInputProps:{valueState:"Error",onInput:console.log},children:"Default VariantItem"}),e(a,{selected:!0,children:"Selected"}),e(a,{author:"SAP",children:"Author"}),e(a,{favorite:!0,children:"Favorite"}),e(a,{isDefault:!0,children:"IsDefault"}),e(a,{favorite:!0,labelReadOnly:!0,children:"Favorite & labelReadOnly"}),e(a,{applyAutomatically:!0,children:"ApplyAutomatically"}),e(a,{readOnly:!0,children:"ReadOnly"}),e(a,{global:!0,children:"Global"}),e(a,{global:!0,readOnly:!0,children:"Global & readOnly"}),e(a,{global:!0,children:"Not deletable -> global"}),e(a,{hideDelete:!0,children:"Not deletable -> hideDelete"}),e(a,{hideDelete:!1,global:!0,children:"Deletable -> hideDelete: false, global: true"})]})},i={render:({selectedByIndex:r=1})=>{const[d,u]=l.useState(void 0),[f,M]=l.useState("Only alphanumeric chars in Save View input"),[s,c]=l.useState(void 0),[b,y]=l.useState("Max 12 chars");return w(o,{onSaveAs:t=>{M(t.detail.children)},onSaveManageViews:t=>{const m=t.detail.updatedVariants.find(x=>x["data-custom-manage-views"]);!s&&m&&y(m.children)},children:[e(a,{"data-custom-save-view":!0,selected:r===0,saveViewInputProps:{valueState:d,valueStateMessage:d?e("div",{children:"Only alphanumeric and space characters allowed!"}):void 0,onInput:t=>{t.target.value.match(/^[a-z0-9\s]+$/i)?(t.isInvalid=!1,u(void 0)):(t.isInvalid=!0,u(V.Error))},"data-testid":"alphanumeric"},children:f}),e(a,{"data-custom-manage-views":!0,selected:r===1,manageViewsInputProps:{valueState:s,valueStateMessage:s?e("div",{children:"No more than 12 characters allowed!"}):void 0,onInput:t=>{t.target.value.length>12?(t.isInvalid=!0,c(V.Error)):(t.isInvalid=!1,c(void 0))},"data-testid":"12chars"},children:b})]})}};var v,p,g;n.parameters={...n.parameters,docs:{...(v=n.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: args => {
    return <VariantManagement {...args}>
        <VariantItem manageViewsInputProps={{
        valueState: 'Error',
        onInput: console.log
      }}>
          Default VariantItem
...
}`,...(g=(p=n.parameters)==null?void 0:p.docs)==null?void 0:g.source}}};var h,S,I;i.parameters={...i.parameters,docs:{...(h=i.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: ({
    selectedByIndex = 1
  }: any) => {
...
}`,...(I=(S=i.parameters)==null?void 0:S.docs)==null?void 0:I.source}}};const T=["Default","WithCustomValidation"],z=Object.freeze(Object.defineProperty({__proto__:null,Default:n,WithCustomValidation:i,__namedExportsOrder:T,default:A},Symbol.toStringTag,{value:"Module"}));export{z as C,n as D,i as W};
//# sourceMappingURL=VariantManagement.stories-7f9cc865.js.map
