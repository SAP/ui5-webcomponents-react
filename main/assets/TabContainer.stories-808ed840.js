import{j as e}from"./jsx-runtime-5926aa06.js";import{a as u,U,q as y,k as P}from"./UI5Element-b1843653.js";import{h}from"./Icons-9f549e0f.js";import{a as V}from"./add-7ec0d85a.js";import{e as G}from"./employee-2384bc11.js";import{s as J}from"./settings-eb949844.js";import{b as H,T as f,c as K,d as S,a as t}from"./index-0143b167.js";import{_ as Q}from"./iframe-50e562b3.js";import{e as x,l as _,s as w,a as F,b as L,c as X,d as Y,w as Z}from"./withWebComponent-7b9bd1ee.js";import{o as q}from"./class-map-6a9bd920.js";import{s as v}from"./style-map-0c64293c.js";function ee(a,n,o){return x`<div id="${_(this._id)}" role="separator" class="${q(this.classes.root)}"></div>`}function te(a,n,o){return o?x`<${w("ui5-li-custom",n,o)} id="${_(this._id)}" role="separator" class="${q(this.classes.root)}" disabled style="${v(this._style)}"></${w("ui5-li-custom",n,o)}>`:x`<ui5-li-custom id="${_(this._id)}" role="separator" class="${q(this.classes.root)}" disabled style="${v(this._style)}"></ui5-li-custom>`}u("@ui5/webcomponents-theming","sap_fiori_3",async()=>F);u("@ui5/webcomponents","sap_fiori_3",async()=>L);const ae={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInStrip.css",content:`.ui5-tc__separator {
	width: 0;
...
//# sourceMappingURL=TabContainer.stories-808ed840.js.map
