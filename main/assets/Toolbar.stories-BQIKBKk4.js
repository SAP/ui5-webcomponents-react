import{j as e}from"./useIsomorphicLayoutEffect-VT0hzFUo.js";import{i as ue}from"./Boot-BVnGU0ip.js";import{r as Y}from"./Icons-DyBGPyMo.js";import{j as Z}from"./i18n-defaults-BdfZArTM.js";import{e as d}from"./ListItem-LdCakL46.js";import{f as m}from"./favorite-D3Hb15Tu.js";import{s as ee}from"./settings-CPdSV6lN.js";import{r as B}from"./index-BP8_t0zE.js";import{B as o}from"./index-DkakSETs.js";import{D as pe}from"./index-MrE-w4Lf.js";import{I as S}from"./index-DmMNvWU6.js";import{I as te}from"./index-Dr6ItcMY.js";import{M as ce,a as j}from"./index-XH5yBlQE.js";import{S as de}from"./index-a1E7TrDt.js";import{S as me}from"./index-CgzWxoH4.js";import{S as ne}from"./index-DOVZGaIa.js";import{T as x}from"./index-CtO5js3k.js";import{u as oe,T as s,a as he,b as fe}from"./index-BZDqwTE4.js";import{T as i}from"./index-CNIrU-iy.js";import{T as D}from"./index-D_2f2GOU.js";import{T as N}from"./index-CtAABS1j.js";import{B as t}from"./Button-BsmQPuS3.js";const l=B.forwardRef((n,a)=>{const{children:r,...p}=n,{inPopover:c}=oe();return e.jsx(o,{...p,ref:a,children:c?r:""})});l.displayName="OverflowToolbarButton";try{l.displayName="OverflowToolbarButton",l.__docgenInfo={description:"The `OverflowToolbarButton` represents a push button that shows its text only when in the overflow area of a `Toolbar`.\n\n__Note:__ This component is only compatible with the `Toolbar` component and __not__ with `ToolbarV2`.",displayName:"OverflowToolbarButton",props:{children:{defaultValue:null,description:"Defines the text of the component which is only visible in the overflow area of a `Toolbar`.\n\n**Note:** Although this slot accepts HTML Elements, it is strongly recommended that you only use text in order to preserve the intended design.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},icon:{defaultValue:null,description:`Defines the icon to be displayed as graphical element within the component. The SAP-icons font provides numerous options.

Example: See all the available icons in the <ui5-link target="_blank" href="https://openui5.hana.ondemand.com/test-resources/sap/m/demokit/iconExplorer/webapp/index.html" class="api-table-content-cell-link">Icon Explorer</ui5-link>.`,name:"icon",required:!0,type:{name:"string"}},design:{defaultValue:{value:'"Default"'},description:"Defines the component design.",name:"design",required:!1,type:{name:"enum",value:[{value:'"Positive"'},{value:'"Negative"'},{value:'"Default"'},{value:'"Transparent"'},{value:'"Emphasized"'},{value:'"Default"'},{value:'"Positive"'},{value:'"Negative"'},{value:'"Transparent"'},{value:'"Emphasized"'},{value:'"Attention"'},{value:'"Attention"'}]}},style:{defaultValue:null,description:`Element style which will be appended to the most outer element of a component.
...
**Note:** Available since [v1.23](https://github.com/SAP/ui5-webcomponents/releases/tag/v1.23) of **@ui5/webcomponents**.`,name:"accessibleRole",required:!1,type:{name:"enum",value:[{value:'"Button"'},{value:'"Link"'},{value:'"Button"'},{value:'"Link"'}]}},disabled:{defaultValue:{value:"false"},description:`Defines whether the component is disabled.
A disabled component can't be pressed or
focused, and it is not in the tab chain.`,name:"disabled",required:!1,type:{name:"boolean"}},pressed:{defaultValue:{value:"false"},description:"Determines whether the component is displayed as pressed.",name:"pressed",required:!1,type:{name:"boolean"}}}}}catch{}const ve="download",ae="M480 448q13 0 22.5 9.5T512 480q0 14-9.5 23t-22.5 9H32q-14 0-23-9t-9-23q0-13 9-22.5t23-9.5h448zm-200-74q-10 10-22.5 9.5T235 374L133 273q-12-12 0-23 11-11 22 0l85 85V16q0-16 16-16t16 16v321l87-87q11-11 23 0 12 12 0 23z",be=!1,ge=Z,ye="SAP-icons-v4",Te="@ui5/webcomponents-icons";Y(ve,{pathData:ae,ltr:be,accData:ge,collection:ye,packageName:Te});const we="download",se="M123 261q-8-8-8-18 0-11 7.5-18t18.5-7 18 7l71 72V26q0-11 7.5-18.5T256 0t18.5 7.5T282 26v271l71-72q7-7 18-7t18.5 7 7.5 18q0 10-8 18L274 376q-8 8-18 8t-18-8zm363 200q11 0 18.5 7t7.5 18-7.5 18.5T486 512H26q-11 0-18.5-7.5T0 486t7.5-18 18.5-7h460z",Be=!1,xe=Z,Se="SAP-icons-v5",De="@ui5/webcomponents-icons";Y(we,{pathData:se,ltr:Be,accData:xe,collection:Se,packageName:De});ue();const re="download",Ne={title:"Layouts & Floorplans / Toolbar",component:s,argTypes:{children:{control:{disable:!0}},as:{control:{disable:!0}},overflowButton:{control:{disable:!0}}},args:{design:he.Auto,toolbarStyle:fe.Standard},parameters:{chromatic:{delay:1e3}}},h={render(n){return e.jsxs(s,{...n,children:[e.jsx(i,{children:"Toolbar"}),e.jsx(o,{design:t.Transparent,children:"Button One"}),e.jsx(o,{design:t.Transparent,children:"Button Two"}),e.jsx(te,{}),e.jsx(pe,{}),e.jsx(ne,{})]})}},f={name:"right aligned items",render(n){return e.jsxs(s,{...n,children:[e.jsx(N,{}),e.jsx(o,{design:t.Transparent,children:"Button"}),e.jsx(S,{name:ee}),e.jsx(S,{name:re})]})}},v={name:"evenly aligned items",render(n){return e.jsxs(s,{...n,children:[e.jsx(i,{children:"Left"}),e.jsx(N,{}),e.jsx(o,{design:t.Transparent,children:"Center"}),e.jsx(N,{}),e.jsx(i,{children:"Right"}),e.jsx(S,{name:ee}),e.jsx(S,{name:re})]})}},b={name:"with separator",render(n){return e.jsxs(s,{...n,children:[e.jsx(o,{design:t.Transparent,children:"Item1"}),e.jsx(o,{design:t.Transparent,children:"Item2"}),e.jsx(o,{design:t.Transparent,children:"Item3"}),e.jsx(D,{}),e.jsx(o,{design:t.Transparent,children:"Item4"}),e.jsx(o,{design:t.Transparent,children:"Item5"}),e.jsx(D,{}),e.jsx(o,{design:t.Transparent,children:"Item6"}),e.jsx(D,{}),e.jsx(o,{design:t.Transparent,children:"Item7"})]})}},g={name:"Popover in Overflow Popover",render(n){const[a,r]=B.useState(!1),[p,c]=B.useState("openMenuBtn"),ie=le=>{c(le.target.id),r(!0)};return e.jsxs(e.Fragment,{children:[e.jsxs(s,{...n,style:{width:"400px"},children:[e.jsx(i,{children:"Toolbar"}),e.jsx(o,{design:t.Transparent,children:"Button One"}),e.jsx(o,{design:t.Transparent,children:"Button Two"}),e.jsx(o,{design:t.Transparent,id:"openMenuBtn",onClick:ie,children:"Open Popover (Menu)"})]}),e.jsxs(ce,{opener:p,open:a,onAfterClose:()=>{r(!1)},children:[e.jsx(j,{text:"New File"}),e.jsx(j,{text:"New Folder"})]})]})}},y={name:"with overflow button",render(n){const[a,r]=B.useState(100),p=c=>{r(c.target.value)};return e.jsxs(e.Fragment,{children:[e.jsx(me,{onInput:p,value:a}),e.jsxs(s,{...n,style:{width:`calc(100% * ${a/100})`},children:[e.jsx(i,{children:"Toolbar"}),e.jsx(o,{design:t.Transparent,children:"Button One"}),e.jsx(o,{design:t.Transparent,icon:"accept"}),e.jsx(o,{design:t.Transparent,children:"Button Two"}),e.jsx(de,{style:{width:"auto"}}),e.jsx(ne,{}),e.jsx(o,{design:t.Transparent,children:"Button Three"}),e.jsx(o,{design:t.Transparent,children:"Button Four"}),e.jsx(l,{icon:d,children:"Edit"}),e.jsx(u,{design:t.Transparent,icon:m,children:"Favorite"})]})]})}},T={name:"OverflowToolbarButton & OverflowToolbarToggleButton",render(n){return e.jsxs(s,{...n,style:{width:"500px",...n.style},children:[e.jsx(o,{design:t.Transparent,icon:d,tooltip:"Text always visible",children:"Default Button"}),e.jsx(l,{design:t.Transparent,icon:d,tooltip:"Text only visible in popover",children:"OverflowToolbarButton (only visible in popover)"}),e.jsx(x,{design:t.Transparent,icon:m,tooltip:"Text always visible",children:"Default ToggleButton"}),e.jsx(u,{design:t.Transparent,icon:m,tooltip:"Text only visible in popover",children:"OverflowToolbarToggleButton (only visible in popover)"}),e.jsx(o,{design:t.Transparent,icon:d,tooltip:"Text always visible",children:"Default Button"}),e.jsx(l,{design:t.Transparent,icon:d,tooltip:"Text only visible in popover",children:"OverflowToolbarButton (only visible in popover)"}),e.jsx(x,{design:t.Transparent,icon:m,tooltip:"Text always visible",children:"Default ToggleButton"}),e.jsx(u,{design:t.Transparent,icon:m,tooltip:"Text only visible in popover",children:"OverflowToolbarToggleButton (only visible in popover)"})]})}},w={name:"with custom overflow button",render(n){return e.jsxs(e.Fragment,{children:[e.jsxs(s,{...n,style:{width:"300px",...n.style},overflowButton:e.jsx(x,{icon:"menu2",design:t.Transparent,onClick:()=>{alert("Custom action")}}),children:[e.jsx(te,{}),e.jsx(i,{wrapping:!1,children:"Overflow Content"})]}),e.jsxs(s,{...n,style:{width:"300px",...n.style},overflowButton:e.jsx(x,{icon:"menu2",design:t.Transparent,onClick:a=>{a.preventDefault(),alert("Custom action")}}),children:[e.jsx(i,{wrapping:!1,children:"Opening the popover is prevented"}),e.jsx(i,{wrapping:!1,children:"Overflow Content"})]})]})}};var I,O,_;h.parameters={...h.parameters,docs:{...(I=h.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render(args) {
    return <Toolbar {...args}>
        <Text>Toolbar</Text>
...
}`,...(_=(O=h.parameters)==null?void 0:O.docs)==null?void 0:_.source}}};var A,q,V;f.parameters={...f.parameters,docs:{...(A=f.parameters)==null?void 0:A.docs,source:{originalSource:`{
...
}`,...(V=(q=f.parameters)==null?void 0:q.docs)==null?void 0:V.source}}};var k,E,P;v.parameters={...v.parameters,docs:{...(k=v.parameters)==null?void 0:k.docs,source:{originalSource:`{
...
}`,...(P=(E=v.parameters)==null?void 0:E.docs)==null?void 0:P.source}}};var R,C,F;b.parameters={...b.parameters,docs:{...(R=b.parameters)==null?void 0:R.docs,source:{originalSource:`{
  name: 'with separator',
  render(args) {
    return <Toolbar {...args}>
...
}`,...(F=(C=b.parameters)==null?void 0:C.docs)==null?void 0:F.source}}};var M,L,H;g.parameters={...g.parameters,docs:{...(M=g.parameters)==null?void 0:M.docs,source:{originalSource:`{
