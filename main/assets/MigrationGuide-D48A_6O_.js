...
`,e.jsx(n.p,{children:"Only the names of the following enums have changed, so it's sufficient to replace them with the new name."}),`
`,e.jsxs(n.ul,{children:[`
...
`]}),`
`,e.jsx(o,{})]})}function Be(i={}){const{wrapper:n}={...r(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}export{Be as default};
