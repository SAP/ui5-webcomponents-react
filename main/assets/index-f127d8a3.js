import{_ as E}from"./iframe-46c415bc.js";import{a as N,U as A,d as x}from"./UI5Element-2e105c8a.js";import{e as u,s as d,l as o,a as U,b as j,p as r,c as R,d as W,w as V}from"./withWebComponent-7b9bd1ee.js";import{s as q}from"./slot-76e48863.js";import{c as g,I as H,e as f}from"./Icon-1927e688.js";import{D as F}from"./Popover-898d0a68.js";import{s as I,q as $,b as z}from"./Icons-fe8ad928.js";import{c as _,f as S,d as K}from"./Device-208919c6.js";import"./slim-arrow-right-d68231f1.js";import{I as L}from"./Integer-f7f172c9.js";import G from"./ResponsivePopover-cca20b42.js";import{B as J}from"./Button-a741ea37.js";import{L as Q}from"./ListItemBase-9f02a20e.js";import X from"./StandardListItem-e9d00b86.js";import{B as Y}from"./BusyIndicator-ed5c055b.js";import{aA as Z,aB as ee}from"./i18n-defaults-2f9956dc.js";function te(s,e,t){return t?u`<${d("ui5-responsive-popover",e,t)} id="${o(this._id)}-menu-rp" class="ui5-menu-rp" horizontal-align="Left" placement-type=${o(this.placementType)} vertical-align=${o(this.verticalAlign)} hide-arrow allow-target-overlap ?sub-menu=${this._isSubMenu} @ui5-before-open=${o(this._beforePopoverOpen)} @ui5-after-open=${o(this._afterPopoverOpen)} @ui5-before-close=${o(this._beforePopoverClose)} @ui5-after-close=${o(this._afterPopoverClose)}>${this.isPhone?w.call(this,s,e,t):void 0}<div id="${o(this._id)}-menu-main">${this._currentItems.length?C.call(this,s,e,t):B.call(this,s,e,t)}</div></${d("ui5-responsive-popover",e,t)}><div class="ui5-menu-submenus"></div>`:u`<ui5-responsive-popover id="${o(this._id)}-menu-rp" class="ui5-menu-rp" horizontal-align="Left" placement-type=${o(this.placementType)} vertical-align=${o(this.verticalAlign)} hide-arrow allow-target-overlap ?sub-menu=${this._isSubMenu} @ui5-before-open=${o(this._beforePopoverOpen)} @ui5-after-open=${o(this._afterPopoverOpen)} @ui5-before-close=${o(this._beforePopoverClose)} @ui5-after-close=${o(this._afterPopoverClose)}>${this.isPhone?w.call(this,s,e,t):void 0}<div id="${o(this._id)}-menu-main">${this._currentItems.length?C.call(this,s,e,t):B.call(this,s,e,t)}</div></ui5-responsive-popover><div class="ui5-menu-submenus"></div>`}function w(s,e,t){return t?u`<div slot="header" class="ui5-menu-dialog-header">${this.isSubMenuOpened?T.call(this,s,e,t):void 0}<div class="ui5-menu-dialog-title"><div>${o(this.menuHeaderTextPhone)}</div></div><${d("ui5-button",e,t)} icon="decline" design="Transparent" aria-label="${o(this.labelClose)}" @click=${this.close}></${d("ui5-button",e,t)}></div>`:u`<div slot="header" class="ui5-menu-dialog-header">${this.isSubMenuOpened?T.call(this,s,e,t):void 0}<div class="ui5-menu-dialog-title"><div>${o(this.menuHeaderTextPhone)}</div></div><ui5-button icon="decline" design="Transparent" aria-label="${o(this.labelClose)}" @click=${this.close}></ui5-button></div>`}function T(s,e,t){return t?u`<${d("ui5-button",e,t)} icon="nav-back" class="ui5-menu-back-button" design="Transparent" aria-label="${o(this.labelBack)}" @click=${this._navigateBack}></${d("ui5-button",e,t)}>`:u`<ui5-button icon="nav-back" class="ui5-menu-back-button" design="Transparent" aria-label="${o(this.labelBack)}" @click=${this._navigateBack}></ui5-button>`}function C(s,e,t){return t?u`<${d("ui5-list",e,t)} id="${o(this._id)}-menu-list" mode="None" ?busy="${this.busy}" busy-delay="${o(this.busyDelay)}" separators="None" accessible-role="menu" @ui5-item-click=${o(this._itemClick)} @mouseover="${this._busyMouseOver}">${g(this._currentItems,(n,i)=>n._id||i,(n,i)=>D.call(this,s,e,t,n,i))}</${d("ui5-list",e,t)}>`:u`<ui5-list id="${o(this._id)}-menu-list" mode="None" ?busy="${this.busy}" busy-delay="${o(this.busyDelay)}" separators="None" accessible-role="menu" @ui5-item-click=${o(this._itemClick)} @mouseover="${this._busyMouseOver}">${g(this._currentItems,(n,i)=>n._id||i,(n,i)=>D.call(this,s,e,t,n,i))}</ui5-list>`}function D(s,e,t,n,i){return t?u`<${d("ui5-li",e,t)} .associatedItem="${o(n.item)}" class="ui5-menu-item" id="${o(this._id)}-menu-item-${i}" .icon="${o(n.item.icon)}" accessible-name=${o(n.item.ariaLabelledByText)} accessible-role="menuitem" .additionalText="${o(n.item._additionalText)}" ._ariaHasPopup=${o(n.ariaHasPopup)} ?disabled=${n.item.disabled} ?starts-section=${n.item.startsSection} ?selected=${n.item.subMenuOpened} ?is-phone=${this.isPhone} @mouseover=${this._itemMouseOver} @mouseout=${this._itemMouseOut} @keydown=${this._itemKeyDown}>${n.item.hasDummyIcon?k.call(this,s,e,t,n,i):void 0}${o(n.item.text)}${n.item.hasSubmenu?P.call(this,s,e,t,n,i):O.call(this,s,e,t,n,i)}</${d("ui5-li",e,t)}>`:u`<ui5-li .associatedItem="${o(n.item)}" class="ui5-menu-item" id="${o(this._id)}-menu-item-${i}" .icon="${o(n.item.icon)}" accessible-name=${o(n.item.ariaLabelledByText)} accessible-role="menuitem" .additionalText="${o(n.item._additionalText)}" ._ariaHasPopup=${o(n.ariaHasPopup)} ?disabled=${n.item.disabled} ?starts-section=${n.item.startsSection} ?selected=${n.item.subMenuOpened} ?is-phone=${this.isPhone} @mouseover=${this._itemMouseOver} @mouseout=${this._itemMouseOut} @keydown=${this._itemKeyDown}>${n.item.hasDummyIcon?k.call(this,s,e,t,n,i):void 0}${o(n.item.text)}${n.item.hasSubmenu?P.call(this,s,e,t,n,i):O.call(this,s,e,t,n,i)}</ui5-li>`}function k(s,e,t,n,i){return u`<div class="ui5-menu-item-dummy-icon"></div>`}function P(s,e,t,n,i){return t?u`<${d("ui5-icon",e,t)} part="icon" name="slim-arrow-right" class="ui5-menu-item-icon-end"></${d("ui5-icon",e,t)}>`:u`<ui5-icon part="icon" name="slim-arrow-right" class="ui5-menu-item-icon-end"></ui5-icon>`}function O(s,e,t,n,i){return u`${n.item._siblingsWithChildren?ne.call(this,s,e,t,n,i):void 0}`}function ne(s,e,t,n,i){return u`<div class="ui5-menu-item-no-icon-end"></div>`}function B(s,e,t){return u`${this.busy?ie.call(this,s,e,t):void 0}`}function ie(s,e,t){return t?u`<${d("ui5-busy-indicator",e,t)} id="${o(this._id)}-menu-busy-indicator" delay="${o(this.busyDelay)}" class="ui5-menu-busy-indicator" @mouseover="${this._busyMouseOver}" active></${d("ui5-busy-indicator",e,t)}>`:u`<ui5-busy-indicator id="${o(this._id)}-menu-busy-indicator" delay="${o(this.busyDelay)}" class="ui5-menu-busy-indicator" @mouseover="${this._busyMouseOver}" active></ui5-busy-indicator>`}N("@ui5/webcomponents-theming","sap_fiori_3",async()=>U);N("@ui5/webcomponents","sap_fiori_3",async()=>j);const oe={packageName:"@ui5/webcomponents",fileName:"themes/Menu.css",content:`
...
//# sourceMappingURL=index-f127d8a3.js.map
