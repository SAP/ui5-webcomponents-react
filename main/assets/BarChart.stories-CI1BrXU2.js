import{c as Oe,s as We,a as Ee}from"./DemoProps-BWWtsAFv.js";import{j as n}from"./useIsomorphicLayoutEffect-J-vjyzBO.js";import{T as R}from"./ThemingParameters-DOkJX3Ed.js";import{e as Fe}from"./index-CBpU8qq5.js";import{r as j}from"./index-DVqgc125.js";import{d as Ne,C as he,a as ue}from"./defaults-4Sg4PsGo.js";import{u as Ye,B as Me}from"./useCancelAnimationFallback-C-dm4MWj.js";import{u as Ke,a as He,C as $e,X as O,c as W,Y as Ue,b as Xe}from"./YAxisTicks-DvCa2ZcM.js";import{u as Ge,C as Je}from"./ChartDataLabel-Z-1kWkb5.js";import{u as Qe,t as Ze,a as et,b as tt}from"./staticProps-3HxSKqj7.js";import{g as at,u as ot,a as nt,r as rt,b as E}from"./useTooltipFormatter-CB2ekeSh.js";import{u as st}from"./useOnClickInternal-yEpt7jtH.js";import{C as it}from"./ChartContainer-BJI6_lVP.js";import{B as lt}from"./Placeholder-DVHBXGTZ.js";import{B as ct,a as dt,e as ht,d as ut,R as mt,T as pt,h as ft}from"./generateCategoricalChart-sbBkg3AG.js";import{u as gt}from"./withWebComponent-CZCh4Hye.js";import{u as bt}from"./useIsRTL-B9uUG4cf.js";import"./_baseForOwn-czysEfXW.js";import"./isString-D7zYwilD.js";import"./tiny-invariant-CCoILDQG.js";import"./debounce-D7W5PopO.js";import"./_baseUniq-fADs2fxN.js";import"./index-BfsycYn4.js";import"./clsx-B-dksMZM.js";import"./i18n-defaults-CNyODxfy.js";import"./i18nBundle-Baemx9Ir.js";import"./Boot-DBJWGo1y.js";import"./EventProvider-CVfkyUHo.js";import"./I18nContext-BrA05J-F.js";import"./useStylesheet-DGwRvl1X.js";import"./throttle-Dl_m-peW.js";import"./index-BiYRYNgb.js";import"./iframe-CD3rruG0.js";import"../sb-preview/runtime.js";import"./Label-BcDuAK9i.js";import"./UI5Element-ZIczsayz.js";import"./CustomElementsScopeUtils-Di1jckr8.js";import"./WrappingType-CW8URInd.js";import"./i18n-defaults-BBSxky5H.js";import"./parameters-bundle.css-B_nLitlw.js";import"./react-content-loader.es-CmqtvJxN.js";import"./isPlainObject-BydcgycZ.js";import"./mapValues-DJmJhyxk.js";import"./utils-xoLr7-0V.js";import"./directionChange-sxDj8oYs.js";const yt=(a,l,h="")=>j.useMemo(()=>{let r=Array(l.length).fill(0),m=0;if(a instanceof Array&&l){const g=i=>l.map(c=>c.formatter(he.getValueByDataKey(i,c.accessor,"")));a.map(g).forEach(i=>{i.forEach((c,f)=>{r[f]=Math.max(at(c),r[f])})}),r=r.map(i=>Math.min(Ne,i)),m=r.reduce((i,c)=>i+c,0)}return h==="middle"?[r,{width:"auto"}]:[r,{marginLeft:m,maxWidth:`calc(100% - ${m+8}px)`}]},[a,l,h]),Ct={formatter:ue},vt={formatter:ue,opacity:1},wt=a=>({payload:l})=>he.getValueByDataKey(l,a),u=j.forwardRef((a,l)=>{var z,B;const{loading:h,dataset:r,noLegend:m,noAnimation:g,tooltipConfig:p,onDataPointClick:i,onLegendClick:c,onClick:f,style:me,className:pe,slot:fe,syncId:ge,ChartPlaceholder:be,children:ye,...Ce}=a,t={margin:{},yAxisVisible:!0,xAxisVisible:!0,gridStroke:R.sapList_BorderColor,gridHorizontal:!0,gridVertical:!1,legendPosition:"bottom",legendHorizontalAlign:"left",barGap:3,zoomingTool:!1,resizeDebounce:250,yAxisConfig:{},xAxisConfig:{},secondXAxisConfig:{},...a.chartConfig},o=t.referenceLine,{dimensions:I,measures:b}=ot(a.dimensions,a.measures,Ct,vt),ve=nt(b),d=I[0],{primaryMeasure:y,secondaryMeasure:we}=rt(b,(z=t==null?void 0:t.secondYAxis)==null?void 0:z.dataKey),ke=b.map(({accessor:e})=>e),_=t.secondYAxis?ke.findIndex(e=>{var s;return e===((s=t.secondYAxis)==null?void 0:s.dataKey)}):0,[Ae,T]=gt(l),xe=Qe(c),Se=Ge(d),De=j.useCallback((e,s,C)=>{if(e&&i){const v=e.value.length?e.value[1]-e.value[0]:e.value;i(Fe(C,{dataKey:Object.keys(e).filter(P=>P!=="value").find(P=>e[P]===v),value:v,payload:e.payload,dataIndex:s}))}},[i]),Le=st(f),Ve=(r==null?void 0:r.length)>30,Ie=d==null?void 0:d.accessor,[_e,Pe]=yt(r,I,t.legendPosition),je=Ke(t.margin,t.zoomingTool),[Te]=He(T,1),q=bt(T),{isMounted:qe,handleBarAnimationStart:ze,handleBarAnimationEnd:Be}=Ye(g),{chartConfig:kt,dimensions:At,measures:xt,...Re}=Ce;return n.jsx(it,{dataset:r,loading:h,Placeholder:be??lt,ref:Ae,style:me,className:pe,slot:fe,resizeDebounce:t.resizeDebounce,...Re,children:n.jsxs(Me,{syncId:ge,onClick:Le,stackOffset:"sign",margin:je,layout:"vertical",data:r,barGap:t.barGap,className:typeof i=="function"||typeof f=="function"?"has-click-handler":void 0,children:[n.jsx($e,{vertical:t.gridVertical,horizontal:t.gridHorizontal,stroke:t.gridStroke}),t.xAxisVisible&&n.jsx(O,{interval:0,type:"number",tick:n.jsx(W,{config:y}),axisLine:t.xAxisVisible,tickLine:Ze,tickFormatter:y==null?void 0:y.formatter,height:Te,reversed:q,...t.xAxisConfig}),((B=t.secondYAxis)==null?void 0:B.dataKey)&&n.jsx(O,{dataKey:t.secondYAxis.dataKey,axisLine:{stroke:t.secondYAxis.color??`var(--sapChart_OrderedColor_${_%11+1})`},tick:n.jsx(W,{config:we,secondYAxisConfig:{color:t.secondYAxis.color??`var(--sapChart_OrderedColor_${_%11+1})`}}),tickLine:{stroke:t.secondYAxis.color??`var(--sapChart_OrderedColor_${_%11+1})`},label:{value:t.secondYAxis.name,offset:2,angle:90,position:"center"},orientation:"top",interval:0,xAxisId:"secondary",type:"number",...t.secondXAxisConfig}),t.yAxisVisible&&I.map((e,s)=>n.jsx(Ue,{interval:(e==null?void 0:e.interval)??(Ve?"preserveStart":0),type:"category",dataKey:e.accessor,tick:n.jsx(Xe,{config:e}),tickLine:s<1,axisLine:s<1,yAxisId:s,width:_e[s],allowDuplicatedCategory:s===0,orientation:q?"right":"left",...t.yAxisConfig},e.reactKey)),qe&&b.map((e,s)=>n.jsxs(ct,{stackId:e.stackId,fillOpacity:e.opacity,name:e.label??e.accessor,strokeOpacity:e.opacity,type:"monotone",dataKey:e.accessor,fill:e.color??`var(--sapChart_OrderedColor_${s%11+1})`,stroke:e.color??`var(--sapChart_OrderedColor_${s%11+1})`,barSize:e.width,onClick:De,isAnimationActive:!g,onAnimationStart:ze,onAnimationEnd:Be,children:[n.jsx(dt,{data:r,valueAccessor:wt(e.accessor),content:n.jsx(Je,{config:e,chartType:"bar",position:"insideRight"})}),r.map((C,v)=>n.jsx(ht,{fill:E(e,C,s),stroke:E(e,C,s)},v))]},e.reactKey)),!m&&n.jsx(ut,{verticalAlign:t.legendPosition,align:t.legendHorizontalAlign,onClick:xe,wrapperStyle:Pe}),o&&n.jsx(mt,{...o,stroke:(o==null?void 0:o.color)??(o==null?void 0:o.stroke),x:(o==null?void 0:o.value)??(o==null?void 0:o.x),label:o==null?void 0:o.label}),(p==null?void 0:p.active)!==!1&&n.jsx(pt,{cursor:et,formatter:ve,contentStyle:tt,labelFormatter:Se,...p}),t.zoomingTool&&n.jsx(ft,{y:10,dataKey:Ie,tickFormatter:d==null?void 0:d.formatter,stroke:R.sapObjectHeader_BorderColor,travellerWidth:10,height:20}),ye]})})});u.displayName="BarChart";try{u.displayName="BarChart",u.__docgenInfo={description:"A `BarChart` is a data visualization where each category is represented by a rectangle, with the width of the rectangle being proportional to the values being plotted.",displayName:"BarChart",props:{dimensions:{defaultValue:null,description:`An array of config objects. Each object will define one dimension of the chart.
...
Use this prop carefully, overwriting CSS rules might break the component.`,name:"className",required:!1,type:{name:"string"}}}}}catch{}try{u.displayName="BarChart",u.__docgenInfo={description:"A `BarChart` is a data visualization where each category is represented by a rectangle, with the width of the rectangle being proportional to the values being plotted.",displayName:"BarChart",props:{dimensions:{defaultValue:null,description:`An array of config objects. Each object will define one dimension of the chart.
...
}`,...(de=(ce=V.parameters)==null?void 0:ce.docs)==null?void 0:de.source}}};const ba=["Default","WithCustomColor","WithSecondaryDimension","WithDataLabels","WithFormatter","LoadingPlaceholder","WithReferenceLine","WithHighlightedMeasure"];export{w as Default,D as LoadingPlaceholder,k as WithCustomColor,x as WithDataLabels,S as WithFormatter,V as WithHighlightedMeasure,L as WithReferenceLine,A as WithSecondaryDimension,ba as __namedExportsOrder,ga as default};
