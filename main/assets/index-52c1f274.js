...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const P=ne("ui5-cb-item",["additionalText","text"],[],[],[],()=>J(()=>import("./ComboBoxItem-2845789f.js").then(i=>i.b),["./ComboBoxItem-2845789f.js","./withWebComponent-03662f7f.js","./utils-f515de3e.js","./CustomElementsScopeUtils-137da8c8.js","./index-ccf6a75d.js","./jsx-runtime-6b79a019.js","./useIsomorphicLayoutEffect-0a189966.js","./UI5Element-11982a12.js"],import.meta.url));P.displayName="ComboBoxItem";try{P.displayName="ComboBoxItem",P.__docgenInfo={description:"The `ComboBoxItem` represents the item for a `ComboBox`",displayName:"ComboBoxItem",props:{additionalText:{defaultValue:null,description:"Defines the additional text of the component.",name:"additionalText",required:!1,type:{name:"string"}},text:{defaultValue:null,description:"Defines the text of the component.",name:"text",required:!1,type:{name:"string"}},style:{defaultValue:null,description:`Element style which will be appended to the most outer element of a component.
Use this prop carefully, some css properties might break the component.`,name:"style",required:!1,type:{name:"CSSProperties"}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
Use this prop carefully, overwriting CSS rules might break the component.`,name:"className",required:!1,type:{name:"string"}},waitForDefine:{defaultValue:null,description:`Defines whether the component should wait for the underlying custom element of the web component to be defined. This can be useful, for example, for using instance methods when mounting the component.
...
//# sourceMappingURL=index-52c1f274.js.map
