import{j as e}from"./jsx-runtime-DoxjgJx5.js";import{k as ue}from"./Boot-CiW9Yqx0.js";import{r as Y}from"./Icons-Bz_R9SHk.js";import{j as Z}from"./i18n-defaults-BdfZArTM.js";import{e as m}from"./ListItem-DCABFpTS.js";import{f as h}from"./favorite-_2i0OVKF.js";import{s as ee}from"./settings-DltrQ7V8.js";import{r as c}from"./index-Cu9bd8lq.js";import{B as o}from"./index-jLapLn2t.js";import{D as pe}from"./index-B6xrdQa4.js";import{I as D}from"./index-BV3IYVwU.js";import{I as te}from"./index-Bd9AAAJe.js";import{M as de,a as I}from"./index-C5IzI4of.js";import{S as ce}from"./index-lA0BHzLJ.js";import{S as me}from"./index-Dhic48eL.js";import{S as ne}from"./index-Cc5ZKUsA.js";import{T as x}from"./index-CGB99NXT.js";import{O as oe,T as r,a as he,b as fe}from"./index-CZ_6IuFI.js";import{T as i}from"./index-Clgb5PFv.js";import{T as S}from"./index-CT0zjvF8.js";import{T as j}from"./index-BmAVlnso.js";import{B as t}from"./Button-BzhOkI6c.js";const l=c.forwardRef((n,a)=>{const{children:s,...p}=n,{inPopover:d}=c.useContext(oe);return e.jsx(o,{...p,ref:a,children:d?s:""})});l.displayName="OverflowToolbarButton";try{l.displayName="OverflowToolbarButton",l.__docgenInfo={description:"The `OverflowToolbarButton` represents a push button that shows its text only when in the overflow area of a `Toolbar`.",displayName:"OverflowToolbarButton",props:{children:{defaultValue:null,description:"Defines the text of the component which is only visible in the overflow area of a `Toolbar`.\n\n**Note:** Although this slot accepts HTML Elements, it is strongly recommended that you only use text in order to preserve the intended design.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},icon:{defaultValue:null,description:`Defines the icon to be displayed as graphical element within the component. The SAP-icons font provides numerous options.
...
**Note:** Use link role only with a press handler, which performs a navigation. In all other scenarios the default button semantics are recommended.`,name:"accessibleRole",required:!1,type:{name:"enum",value:[{value:'"Button"'},{value:'"Link"'},{value:'"Button"'},{value:'"Link"'}]}},disabled:{defaultValue:{value:"false"},description:`Defines whether the component is disabled.
A disabled component can't be pressed or
focused, and it is not in the tab chain.`,name:"disabled",required:!1,type:{name:"boolean"}},pressed:{defaultValue:{value:"false"},description:"Determines whether the component is displayed as pressed.",name:"pressed",required:!1,type:{name:"boolean"}}}}}catch{}const ve="download",ae="M480 448q13 0 22.5 9.5T512 480q0 14-9.5 23t-22.5 9H32q-14 0-23-9t-9-23q0-13 9-22.5t23-9.5h448zm-200-74q-10 10-22.5 9.5T235 374L133 273q-12-12 0-23 11-11 22 0l85 85V16q0-16 16-16t16 16v321l87-87q11-11 23 0 12 12 0 23z",ge=!1,be=Z,ye="SAP-icons-v4",Te="@ui5/webcomponents-icons";Y(ve,{pathData:ae,ltr:ge,accData:be,collection:ye,packageName:Te});const we="download",re="M123 261q-8-8-8-18 0-11 7.5-18t18.5-7 18 7l71 72V26q0-11 7.5-18.5T256 0t18.5 7.5T282 26v271l71-72q7-7 18-7t18.5 7 7.5 18q0 10-8 18L274 376q-8 8-18 8t-18-8zm363 200q11 0 18.5 7t7.5 18-7.5 18.5T486 512H26q-11 0-18.5-7.5T0 486t7.5-18 18.5-7h460z",Be=!1,xe=Z,De="SAP-icons-v5",Se="@ui5/webcomponents-icons";Y(we,{pathData:re,ltr:Be,accData:xe,collection:De,packageName:Se});ue();const se="download",je={title:"Layouts & Floorplans / Toolbar",component:r,argTypes:{children:{control:{disable:!0}},as:{control:{disable:!0}},overflowButton:{control:{disable:!0}}},args:{design:he.Auto,toolbarStyle:fe.Standard},parameters:{chromatic:{delay:1e3}}},f={render(n){return e.jsxs(r,{...n,children:[e.jsx(i,{children:"Toolbar"}),e.jsx(o,{design:t.Transparent,children:"Button One"}),e.jsx(o,{design:t.Transparent,children:"Button Two"}),e.jsx(te,{}),e.jsx(pe,{}),e.jsx(ne,{})]})}},v={name:"right aligned items",render(n){return e.jsxs(r,{...n,children:[e.jsx(j,{}),e.jsx(o,{design:t.Transparent,children:"Button"}),e.jsx(D,{name:ee}),e.jsx(D,{name:se})]})}},g={name:"evenly aligned items",render(n){return e.jsxs(r,{...n,children:[e.jsx(i,{children:"Left"}),e.jsx(j,{}),e.jsx(o,{design:t.Transparent,children:"Center"}),e.jsx(j,{}),e.jsx(i,{children:"Right"}),e.jsx(D,{name:ee}),e.jsx(D,{name:se})]})}},b={name:"with separator",render(n){return e.jsxs(r,{...n,children:[e.jsx(o,{design:t.Transparent,children:"Item1"}),e.jsx(o,{design:t.Transparent,children:"Item2"}),e.jsx(o,{design:t.Transparent,children:"Item3"}),e.jsx(S,{}),e.jsx(o,{design:t.Transparent,children:"Item4"}),e.jsx(o,{design:t.Transparent,children:"Item5"}),e.jsx(S,{}),e.jsx(o,{design:t.Transparent,children:"Item6"}),e.jsx(S,{}),e.jsx(o,{design:t.Transparent,children:"Item7"})]})}},y={name:"Popover in Overflow Popover",render(n){const[a,s]=c.useState(!1),[p,d]=c.useState("openMenuBtn"),ie=le=>{d(le.target.id),s(!0)};return e.jsxs(e.Fragment,{children:[e.jsxs(r,{...n,style:{width:"400px"},children:[e.jsx(i,{children:"Toolbar"}),e.jsx(o,{design:t.Transparent,children:"Button One"}),e.jsx(o,{design:t.Transparent,children:"Button Two"}),e.jsx(o,{design:t.Transparent,id:"openMenuBtn",onClick:ie,children:"Open Popover (Menu)"})]}),e.jsxs(de,{opener:p,open:a,onAfterClose:()=>{s(!1)},children:[e.jsx(I,{text:"New File"}),e.jsx(I,{text:"New Folder"})]})]})}},T={name:"with overflow button",render(n){const[a,s]=c.useState(100),p=d=>{s(d.target.value)};return e.jsxs(e.Fragment,{children:[e.jsx(me,{onInput:p,value:a}),e.jsxs(r,{...n,style:{width:`calc(100% * ${a/100})`},children:[e.jsx(i,{children:"Toolbar"}),e.jsx(o,{design:t.Transparent,children:"Button One"}),e.jsx(o,{design:t.Transparent,icon:"accept"}),e.jsx(o,{design:t.Transparent,children:"Button Two"}),e.jsx(ce,{style:{width:"auto"}}),e.jsx(ne,{}),e.jsx(o,{design:t.Transparent,children:"Button Three"}),e.jsx(o,{design:t.Transparent,children:"Button Four"}),e.jsx(l,{icon:m,children:"Edit"}),e.jsx(u,{design:t.Transparent,icon:h,children:"Favorite"})]})]})}},w={name:"OverflowToolbarButton & OverflowToolbarToggleButton",render(n){return e.jsxs(r,{...n,style:{width:"500px",...n.style},children:[e.jsx(o,{design:t.Transparent,icon:m,tooltip:"Text always visible",children:"Default Button"}),e.jsx(l,{design:t.Transparent,icon:m,tooltip:"Text only visible in popover",children:"OverflowToolbarButton (only visible in popover)"}),e.jsx(x,{design:t.Transparent,icon:h,tooltip:"Text always visible",children:"Default ToggleButton"}),e.jsx(u,{design:t.Transparent,icon:h,tooltip:"Text only visible in popover",children:"OverflowToolbarToggleButton (only visible in popover)"}),e.jsx(o,{design:t.Transparent,icon:m,tooltip:"Text always visible",children:"Default Button"}),e.jsx(l,{design:t.Transparent,icon:m,tooltip:"Text only visible in popover",children:"OverflowToolbarButton (only visible in popover)"}),e.jsx(x,{design:t.Transparent,icon:h,tooltip:"Text always visible",children:"Default ToggleButton"}),e.jsx(u,{design:t.Transparent,icon:h,tooltip:"Text only visible in popover",children:"OverflowToolbarToggleButton (only visible in popover)"})]})}},B={name:"with custom overflow button",render(n){return e.jsxs(e.Fragment,{children:[e.jsxs(r,{...n,style:{width:"300px",...n.style},overflowButton:e.jsx(x,{icon:"menu2",design:t.Transparent,onClick:()=>{alert("Custom action")}}),children:[e.jsx(te,{}),e.jsx(i,{wrapping:!1,children:"Overflow Content"})]}),e.jsxs(r,{...n,style:{width:"300px",...n.style},overflowButton:e.jsx(x,{icon:"menu2",design:t.Transparent,onClick:a=>{a.preventDefault(),alert("Custom action")}}),children:[e.jsx(i,{wrapping:!1,children:"Opening the popover is prevented"}),e.jsx(i,{wrapping:!1,children:"Overflow Content"})]})]})}};var N,O,q;f.parameters={...f.parameters,docs:{...(N=f.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render(args) {
    return <Toolbar {...args}>
        <Text>Toolbar</Text>
...
}`,...(q=(O=f.parameters)==null?void 0:O.docs)==null?void 0:q.source}}};var k,V,E;v.parameters={...v.parameters,docs:{...(k=v.parameters)==null?void 0:k.docs,source:{originalSource:`{
...
}`,...(E=(V=v.parameters)==null?void 0:V.docs)==null?void 0:E.source}}};var C,R,_;g.parameters={...g.parameters,docs:{...(C=g.parameters)==null?void 0:C.docs,source:{originalSource:`{
...
}`,...(_=(R=g.parameters)==null?void 0:R.docs)==null?void 0:_.source}}};var A,P,F;b.parameters={...b.parameters,docs:{...(A=b.parameters)==null?void 0:A.docs,source:{originalSource:`{
  name: 'with separator',
  render(args) {
    return <Toolbar {...args}>
...
}`,...(F=(P=b.parameters)==null?void 0:P.docs)==null?void 0:F.source}}};var M,L,H;y.parameters={...y.parameters,docs:{...(M=y.parameters)==null?void 0:M.docs,source:{originalSource:`{
...
}`,...(X=(Q=B.parameters)==null?void 0:Q.docs)==null?void 0:X.source}}};const Ie=["Default","RightAlignedItems","EvenlyAlignedItems","WithSeparator","PopoverInOverflowPopover","WithOverflowButton","OverflowBtns","CustomOverflowButton"],Qe=Object.freeze(Object.defineProperty({__proto__:null,CustomOverflowButton:B,Default:f,EvenlyAlignedItems:g,OverflowBtns:w,PopoverInOverflowPopover:y,RightAlignedItems:v,WithOverflowButton:T,WithSeparator:b,__namedExportsOrder:Ie,default:je},Symbol.toStringTag,{value:"Module"}));export{Qe as C,f as D,g as E,w as O,y as P,v as R,b as W,T as a,B as b,l as c,u as d};
