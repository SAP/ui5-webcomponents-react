import{_ as u}from"./iframe-DSY2u4nw.js";import{f as m,I as h}from"./UI5Element-CpDKvy14.js";import{s as d,a as f,m as y,l as b,b as _,w as x}from"./withWebComponent-BS5KmJ8y.js";import"./utils-BKwn1mod.js";import{s as w}from"./parameters-bundle.css-BFbT_feV.js";import{d as g}from"./CustomElementsScopeUtils-CUyxdJhU.js";m("@ui5/webcomponents-theming","sap_horizon",async()=>d);m("@ui5/webcomponents","sap_horizon",async()=>w);const T={packageName:"@ui5/webcomponents",fileName:"themes/Text.css.ts",content:`:host{display:inline-block;max-width:100%;font-size:var(--sapFontSize);font-family:var(--sapFontFamily);color:var(--sapTextColor);line-height:normal;white-space:pre-line;word-wrap:break-word;cursor:text}:host([max-lines]){display:-webkit-box;-webkit-line-clamp:var(--_ui5-v2-0-1_text_max_lines);line-clamp:var(--_ui5-v2-0-1_text_max_lines);-webkit-box-orient:vertical;overflow:hidden;white-space:normal}
`};var c=function(t,n,o,s){var r=arguments.length,e=r<3?n:s===null?s=Object.getOwnPropertyDescriptor(n,o):s,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")e=Reflect.decorate(t,n,o,s);else for(var p=t.length-1;p>=0;p--)(l=t[p])&&(e=(r<3?l(e):r>3?l(n,o,e):l(n,o))||e);return r>3&&e&&Object.defineProperty(n,o,e),e};let i=class extends h{constructor(){super(...arguments),this.maxLines=1/0}onBeforeRendering(){this.style.setProperty(g("--_ui5_text_max_lines"),`${this.maxLines}`)}};c([f({type:Number})],i.prototype,"maxLines",void 0);i=c([y({tag:"ui5-text",renderer:b,template:()=>_`<bdi><slot></slot></bdi>`,styles:T})],i);i.define();const v=i,N=Object.freeze(Object.defineProperty({__proto__:null,default:v},Symbol.toStringTag,{value:"Module"})),a=x("ui5-text",["maxLines"],[],[],[],()=>u(()=>Promise.resolve().then(()=>N),void 0,import.meta.url));a.displayName="Text";try{a.displayName="Text",a.__docgenInfo={description:`<h3>Overview</h3>
