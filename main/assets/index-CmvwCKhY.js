import{_ as b}from"./iframe-4Fxt_YRx.js";import{b as r,l as a,f as l,s as y,a as d,m as _,c as w,w as R}from"./withWebComponent-BqYi3caL.js";import{s as I}from"./event-Dq0fpeHi.js";import{C as $}from"./UI5Element-D1gTBhJw.js";import{D as N,C as T,K as C,c as D,f as x,b as A,p as S,F as V}from"./Keys-B00bFMgT.js";import{v as q}from"./AriaLabelHelper-LMIEtYQL.js";import{f as k}from"./i18nBundle-DqiJMVwP.js";import{t as E}from"./Integer-WDQzHAdZ.js";import{e as P}from"./Float-B4RcRBnE.js";import{y as O,z as U,B as z}from"./i18n-defaults-BhCgZGmI.js";import{c as B,I as M}from"./Icon-DybkHgDw.js";import{f as g}from"./Boot-CUKJMqeB.js";import"./useIsomorphicLayoutEffect-CJg151Ok.js";import"./favorite-BC3CeKI2.js";import"./unfavorite-Xx5kXx0Z.js";import{s as F}from"./parameters-bundle.css-B_nLitlw.js";function W(o,e,i){return r`<div class="ui5-rating-indicator-root" role="slider" aria-roledescription="${a(this._ariaRoleDescription)}" aria-valuemin="0" aria-valuenow="${a(this.value)}" aria-valuemax="${a(this.max)}" aria-valuetext="${a(this.value)} of ${a(this.max)}" aria-orientation="horizontal" aria-disabled="${a(this._ariaDisabled)}" aria-readonly="${a(this.ariaReadonly)}" aria-description="${a(this._ariaDescription)}" tabindex="${a(this.effectiveTabIndex)}" @focusin="${this._onfocusin}" @focusout="${this._onfocusout}" @click="${this._onclick}" @keydown="${this._onkeydown}" title="${a(this.ratingTooltip)}" aria-label="${a(this._ariaLabel)}"><ul class="ui5-rating-indicator-list" aria-hidden="true">${B(this._stars,(t,n)=>t._id||n,(t,n)=>H.call(this,o,e,i,t,n))}</ul></div>`}function H(o,e,i,t,n){return r`${t.selected?L.call(this,o,e,i,t,n):j.call(this,o,e,i,t,n)}`}function L(o,e,i,t,n){return i?r`<li data-ui5-value="${a(t.index)}" class="ui5-rating-indicator-item ui5-rating-indicator-item-sel"><${l("ui5-icon",e,i)} data-ui5-value="${a(t.index)}" name="favorite"></${l("ui5-icon",e,i)}></li>`:r`<li data-ui5-value="${a(t.index)}" class="ui5-rating-indicator-item ui5-rating-indicator-item-sel"><ui5-icon data-ui5-value="${a(t.index)}" name="favorite"></ui5-icon></li>`}function j(o,e,i,t,n){return r`${t.halfStar?G.call(this,o,e,i,t,n):K.call(this,o,e,i,t,n)}`}function G(o,e,i,t,n){return i?r`<li class="ui5-rating-indicator-item ui5-rating-indicator-item-half"><${l("ui5-icon",e,i)} data-ui5-value="${a(t.index)}" name="unfavorite"></${l("ui5-icon",e,i)}><div class="ui5-rating-indicator-half-icon-wrapper"><${l("ui5-icon",e,i)} data-ui5-value="${a(t.index)}" name="favorite" class="ui5-rating-indicator-half-icon"></${l("ui5-icon",e,i)}></div></li>`:r`<li class="ui5-rating-indicator-item ui5-rating-indicator-item-half"><ui5-icon data-ui5-value="${a(t.index)}" name="unfavorite"></ui5-icon><div class="ui5-rating-indicator-half-icon-wrapper"><ui5-icon data-ui5-value="${a(t.index)}" name="favorite" class="ui5-rating-indicator-half-icon"></ui5-icon></div></li>`}function K(o,e,i,t,n){return r`${this.readonly?X.call(this,o,e,i,t,n):Y.call(this,o,e,i,t,n)}`}function X(o,e,i,t,n){return i?r`<li class="ui5-rating-indicator-item ui5-rating-indicator-item-unsel"><${l("ui5-icon",e,i)} data-ui5-value="${a(t.index)}" name="favorite"></${l("ui5-icon",e,i)}></li>`:r`<li class="ui5-rating-indicator-item ui5-rating-indicator-item-unsel"><ui5-icon data-ui5-value="${a(t.index)}" name="favorite"></ui5-icon></li>`}function Y(o,e,i,t,n){return r`${this.disabled?J.call(this,o,e,i,t,n):Q.call(this,o,e,i,t,n)}`}function J(o,e,i,t,n){return i?r`<li class="ui5-rating-indicator-item ui5-rating-indicator-item-unsel"><${l("ui5-icon",e,i)} data-ui5-value="${a(t.index)}" name="favorite"></${l("ui5-icon",e,i)}></li>`:r`<li class="ui5-rating-indicator-item ui5-rating-indicator-item-unsel"><ui5-icon data-ui5-value="${a(t.index)}" name="favorite"></ui5-icon></li>`}function Q(o,e,i,t,n){return i?r`<li data-ui5-value="${a(t.index)}" class="ui5-rating-indicator-item ui5-rating-indicator-item-unsel"><${l("ui5-icon",e,i)} data-ui5-value="${a(t.index)}" name="unfavorite"></${l("ui5-icon",e,i)}></li>`:r`<li data-ui5-value="${a(t.index)}" class="ui5-rating-indicator-item ui5-rating-indicator-item-unsel"><ui5-icon data-ui5-value="${a(t.index)}" name="unfavorite"></ui5-icon></li>`}g("@ui5/webcomponents-theming","sap_horizon",async()=>y);g("@ui5/webcomponents","sap_horizon",async()=>F);const Z={packageName:"@ui5/webcomponents",fileName:"themes/RatingIndicator.css.ts",content:`:host(:not([hidden])){display:inline-block;font-size:24px;margin:var(--_ui5-v2-0-0-rc-5_rating_indicator_component_spacing);cursor:pointer}:host([disabled]){opacity:.4;cursor:initial;outline:none}:host([readonly]){cursor:initial}:host([disabled]) .ui5-rating-indicator-item-unsel,:host([readonly]) .ui5-rating-indicator-item-unsel{padding-inline:var(--_ui5-v2-0-0-rc-5_rating_indicator_readonly_item_spacing);width:var(--_ui5-v2-0-0-rc-5_rating_indicator_readonly_item_width);height:var(--_ui5-v2-0-0-rc-5_rating_indicator_readonly_item_height)}:host(:not([readonly]):not([disabled])) .ui5-rating-indicator-root:hover{opacity:.9}:host([_focused]){outline:var(--sapContent_FocusWidth) var(--sapContent_FocusStyle) var(--sapContent_FocusColor);outline-offset:var(--_ui5-v2-0-0-rc-5_rating_indicator_outline_offset);border-radius:var(--_ui5-v2-0-0-rc-5_rating_indicator_border_radius)}[ui5-icon]{display:flex;text-shadow:var(--sapContent_TextShadow)}.ui5-rating-indicator-root{outline:none;position:relative}.ui5-rating-indicator-list{list-style-type:none;display:flex;align-items:center;margin:0;padding:0}.ui5-rating-indicator-item{position:relative;width:var(--_ui5-v2-0-0-rc-5_rating_indicator_item_width);height:var(--_ui5-v2-0-0-rc-5_rating_indicator_item_height)}.ui5-rating-indicator-item:not(:last-child){margin-inline-end:.1875rem}.ui5-rating-indicator-item [ui5-icon]{width:100%;height:100%;color:inherit;user-select:none}.ui5-rating-indicator-item.ui5-rating-indicator-item-sel{color:var(--sapContent_RatedColor)}.ui5-rating-indicator-item.ui5-rating-indicator-item-unsel,.ui5-rating-indicator-item.ui5-rating-indicator-item-half{color:var(--sapContent_UnratedColor)}.ui5-rating-indicator-item [ui5-icon].ui5-rating-indicator-half-icon{position:absolute;inset-inline-start:50%;color:var(--sapContent_RatedColor)}.ui5-rating-indicator-half-icon-wrapper{width:100%;height:100%;position:absolute;inset-inline-start:-50%;top:0;z-index:32;overflow:hidden}
`};var c=function(o,e,i,t){var n=arguments.length,u=n<3?e:t===null?t=Object.getOwnPropertyDescriptor(e,i):t,h;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")u=Reflect.decorate(o,e,i,t);else for(var m=o.length-1;m>=0;m--)(h=o[m])&&(u=(n<3?h(u):n>3?h(e,i,u):h(e,i))||u);return n>3&&u&&Object.defineProperty(e,i,u),u},p;let s=p=class extends ${static async onDefine(){p.i18nBundle=await k("@ui5/webcomponents")}constructor(){super()}onBeforeRendering(){this.calcState()}calcState(){this._stars=[];for(let e=1;e<this.max+1;e++){const i=Math.round((this.value-Math.floor(this.value))*10);let t=!1,n=this.value;Math.floor(this.value)+1===e&&i>2&&i<8?t=!0:i<=2?n=Math.floor(this.value):i>=8&&(n=Math.ceil(this.value)),this._stars.push({selected:e<=n,index:e,halfStar:t})}}_onclick(e){const i=e.target;if(!(i instanceof HTMLElement)||this.disabled||this.readonly)return;const t=i.getAttribute("data-ui5-value");t!==null&&(this.value=parseInt(t),this.value===1&&this._liveValue===1&&(this.value=0),this._liveValue!==this.value&&(this.fireEvent("change"),this._liveValue=this.value))}_onkeydown(e){if(this.disabled||this.readonly)return;const i=N(e)||T(e),t=C(e)||D(e),n=x(e)||A(e),u=S(e),h=V(e),m=e.keyCode>=48&&e.keyCode<=57||e.keyCode>=96&&e.keyCode<=105;if(i||t||n||u||h||m){if(e.preventDefault(),i&&this.value>0)this.value=Math.round(this.value-1);else if(t&&this.value<this.max)this.value=Math.round(this.value+1);else if(n){const f=Math.round(this.value+1);this.value=f>this.max?0:f}else if(u)this.value=0;else if(h)this.value=this.max;else if(m){const f=parseInt(e.key);this.value=f>this.max?this.max:f}this.fireEvent("change")}}_onfocusin(){this.disabled||(this._focused=!0,this._liveValue=this.value)}_onfocusout(){this._focused=!1}get effectiveTabIndex(){const e=this.getAttribute("tabindex");return this.disabled?"-1":e||"0"}get ratingTooltip(){return this.tooltip||this.defaultTooltip}get defaultTooltip(){return p.i18nBundle.getText(O)}get _ariaRoleDescription(){return p.i18nBundle.getText(U)}get _ariaDisabled(){return this.disabled||void 0}get _ariaLabel(){return q(this)}get _ariaDescription(){return this.required?p.i18nBundle.getText(z):void 0}get ariaReadonly(){return this.readonly?"true":void 0}};c([d({validator:P,defaultValue:0})],s.prototype,"value",void 0);c([d({validator:E,defaultValue:5})],s.prototype,"max",void 0);c([d({type:Boolean})],s.prototype,"disabled",void 0);c([d({type:Boolean})],s.prototype,"readonly",void 0);c([d()],s.prototype,"accessibleName",void 0);c([d({defaultValue:""})],s.prototype,"accessibleNameRef",void 0);c([d({type:Boolean})],s.prototype,"required",void 0);c([d()],s.prototype,"tooltip",void 0);c([d({type:Object,multiple:!0})],s.prototype,"_stars",void 0);c([d({type:Boolean})],s.prototype,"_focused",void 0);s=p=c([_({tag:"ui5-rating-indicator",languageAware:!0,renderer:w,styles:Z,template:W,dependencies:[M]}),I("change")],s);s.define();const ee=s,ie=Object.freeze(Object.defineProperty({__proto__:null,default:ee},Symbol.toStringTag,{value:"Module"})),v=R("ui5-rating-indicator",["accessibleName","accessibleNameRef","max","tooltip","value"],["disabled","readonly","required"],[],["change"],()=>b(()=>Promise.resolve().then(()=>ie),void 0,import.meta.url));v.displayName="RatingIndicator";try{v.displayName="RatingIndicator",v.__docgenInfo={description:`The Rating Indicator is used to display a specific number of icons that are used to rate an item.
