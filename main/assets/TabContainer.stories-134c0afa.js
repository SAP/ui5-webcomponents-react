import{j as e}from"./jsx-runtime-5926aa06.js";import{a as u,U,z as y,k}from"./UI5Element-78be0f3d.js";import{j as h}from"./Icons-26e87c01.js";import{a as V}from"./add-2a0590e1.js";import{e as G}from"./employee-1c1d2fc1.js";import{s as J}from"./settings-439530af.js";import{b as H,T as f,c as K,d as S,a as t}from"./index-190860bf.js";import{_ as Q}from"./iframe-24e42f35.js";import{e as x,l as _,s as w,a as F,b as L,c as X,d as Y,w as Z}from"./withWebComponent-d4224c1c.js";import{o as q}from"./class-map-18f572ce.js";import{s as v}from"./style-map-54298215.js";function ee(a,n,o){return x`<div id="${_(this._id)}" role="separator" class="${q(this.classes.root)}"></div>`}function te(a,n,o){return o?x`<${w("ui5-li-custom",n,o)} id="${_(this._id)}" role="separator" class="${q(this.classes.root)}" disabled style="${v(this._style)}"></${w("ui5-li-custom",n,o)}>`:x`<ui5-li-custom id="${_(this._id)}" role="separator" class="${q(this.classes.root)}" disabled style="${v(this._style)}"></ui5-li-custom>`}u("@ui5/webcomponents-theming","sap_fiori_3",async()=>F);u("@ui5/webcomponents","sap_fiori_3",async()=>L);const ae={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInStrip.css",content:`.ui5-tc__separator {
	width: 0;
...
//# sourceMappingURL=TabContainer.stories-134c0afa.js.map
