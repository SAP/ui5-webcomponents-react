import{j as e}from"./useIsomorphicLayoutEffect-Cwmfti2R.js";import{M as n}from"./index-MvOxTw_Z.js";import{B as o}from"./index-BVu0J4ga.js";import{B as R}from"./index-gR0kZEia.js";import{M as l}from"./index-CpM_ijVx.js";import{a as D}from"./index-CUCEh5tl.js";const I={title:"User Feedback / Modals",component:n},r={render:()=>e.jsx(e.Fragment,{children:e.jsx(o,{onClick:()=>{const{close:F}=n.showDialog({headerText:"Dialog Title",children:"I'm a Dialog!",footer:e.jsx(R,{endContent:e.jsx(o,{onClick:()=>F(),children:"Close"})})})},children:"Show Dialog"})})},s={render:()=>e.jsx(e.Fragment,{children:e.jsx(o,{id:"modals-show-popover",onClick:()=>{n.showPopover({opener:"modals-show-popover",headerText:"Popover Title",children:"I'm a Popover!"})},children:"Show Popover"})})},a={render:()=>e.jsx(e.Fragment,{children:e.jsx(o,{id:"modals-show-responsive-popover",onClick:()=>{n.showResponsivePopover({opener:"modals-show-responsive-popover",headerText:"Responsive Popover Title",children:"I'm a Responsive Popover!"})},children:"Show ResponsivePopover"})})},t={render:()=>e.jsx(e.Fragment,{children:e.jsx(o,{id:"modals-show-menu",onClick:()=>{n.showMenu({opener:"modals-show-menu",headerText:"Menu Title",children:e.jsxs(e.Fragment,{children:[e.jsx(l,{text:"New File",icon:"add-document"}),e.jsx(l,{text:"New Folder",icon:"add-folder",disabled:!0})]})})},children:"Show Menu"})})},d={render:()=>e.jsx(e.Fragment,{children:e.jsx(o,{onClick:()=>{n.showMessageBox({type:D.Confirm,children:"Can you see this MessageBox?"})},children:"Show MessageBox"})})},i={render:()=>e.jsx(e.Fragment,{children:e.jsx(o,{onClick:()=>{n.showToast({children:"I'm a Message Toast!"})},children:"Show Toast"})})};var c,p,m;r.parameters={...r.parameters,docs:{...(c=r.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => {
    return <>
        <Button onClick={() => {
        const {
