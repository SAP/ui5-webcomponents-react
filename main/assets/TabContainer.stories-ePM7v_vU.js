import{j as e}from"./jsx-runtime-DtaoT6pD.js";import{r as u,U as W,v as y,h as H}from"./UI5Element-kBA_KQxG.js";import{r as h}from"./Icons-jRef6OLh.js";import{a as U}from"./add-VNrMzBh9.js";import{e as G}from"./employee-APVUdoZS.js";import{s as J}from"./settings-YGq2Totv.js";import{b as k,a as x,c as K,d as S,T as t}from"./index-qIQhVFgR.js";import{_ as Q}from"./iframe-AWO6TD2f.js";import{b as g,l as q,d as v,s as M,a as F,c as X,g as Y,w as Z}from"./withWebComponent-22JjwLkL.js";import{o as _}from"./class-map-2qwEQoLI.js";import{s as w}from"./style-map-duavIDje.js";function ee(a,n,o){return g`<div id="${q(this._id)}" role="separator" class="${_(this.classes.root)}"></div>`}function te(a,n,o){return o?g`<${v("ui5-li-custom",n,o)} id="${q(this._id)}" role="separator" class="${_(this.classes.root)}" disabled style="${w(this._style)}"></${v("ui5-li-custom",n,o)}>`:g`<ui5-li-custom id="${q(this._id)}" role="separator" class="${_(this.classes.root)}" disabled style="${w(this._style)}"></ui5-li-custom>`}u("@ui5/webcomponents-theming","sap_horizon",async()=>M);u("@ui5/webcomponents","sap_horizon",async()=>F);const ae={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInStrip.css.ts",content:`.ui5-tc__separator{width:0;border-left:.0625rem solid var(--sapGroup_TitleBorderColor);margin:.5rem .25rem}
