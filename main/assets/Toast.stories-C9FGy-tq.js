import{j as n}from"./useIsomorphicLayoutEffect-CpdNMtv3.js";import{i as u}from"./utils-Clk5PNT8.js";import{T as c,a as h}from"./index-C6WlYSiv.js";import{r as s}from"./index-DEe9W-hO.js";import{B as f}from"./index-jYDynjsO.js";const T={title:"Modals & Popovers / Toast",component:c,args:{placement:h.BottomCenter,children:"Toast Text",open:u},argTypes:{children:{control:"text"}},parameters:{chromatic:{delay:1e3}},tags:["package:@ui5/webcomponents"]},o={render(e){const[l,t]=s.useState(e.open);s.useEffect(()=>{t(e.open)},[e.open]);const i=()=>{t(!0)},m=d=>{t(!1),e.onClose(d)};return n.jsxs("div",{style:{height:"300px"},children:[n.jsx(c,{open:l,duration:e.duration,placement:e.placement,onClose:m,children:e.children}),n.jsx(f,{onClick:i,children:"Show Toast"})]})}};var r,a,p;o.parameters={...o.parameters,docs:{...(r=o.parameters)==null?void 0:r.docs,source:{originalSource:`{
  render(args) {
