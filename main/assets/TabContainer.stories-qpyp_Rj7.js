import{j as e}from"./jsx-runtime-DtaoT6pD.js";import{r as u,U as W,u as y,h as H}from"./UI5Element-_cJDeK03.js";import{r as h}from"./Icons-1V9ErOOl.js";import{a as U}from"./add-wUHcn77S.js";import{e as G}from"./employee-zEMWRMpH.js";import{s as J}from"./settings-yQr512OC.js";import{b as k,a as x,c as K,d as S,T as t}from"./index-sGI-HfPx.js";import{_ as Q}from"./iframe-RXQu8Ybn.js";import{b as g,l as q,c as v,s as M,a as F,d as X,g as Y,w as Z}from"./withWebComponent-UxvJwa3A.js";import{o as _}from"./class-map--zj6Ctao.js";import{s as w}from"./style-map-21pwAbrQ.js";function ee(a,n,o){return g`<div id="${q(this._id)}" role="separator" class="${_(this.classes.root)}"></div>`}function te(a,n,o){return o?g`<${v("ui5-li-custom",n,o)} id="${q(this._id)}" role="separator" class="${_(this.classes.root)}" disabled style="${w(this._style)}"></${v("ui5-li-custom",n,o)}>`:g`<ui5-li-custom id="${q(this._id)}" role="separator" class="${_(this.classes.root)}" disabled style="${w(this._style)}"></ui5-li-custom>`}u("@ui5/webcomponents-theming","sap_horizon",async()=>M);u("@ui5/webcomponents","sap_horizon",async()=>F);const ae={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInStrip.css.ts",content:`.ui5-tc__separator{width:0;border-left:.0625rem solid var(--sapGroup_TitleBorderColor);margin:.5rem .25rem}
