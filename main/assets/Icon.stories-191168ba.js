...
`;function k(n={}){const{wrapper:i}=Object.assign({},p(),n.components);return i?e.jsx(i,{...n,children:e.jsx(s,{})}):s();function s(){const r=Object.assign({h2:"h2"},p(),n.components);return e.jsxs(e.Fragment,{children:[e.jsx(m,{title:"Data Display / Icon",component:o,args:{name:"employee"}}),`
`,e.jsx(b,{}),`
`,e.jsx("br",{}),`
`,e.jsx(r.h2,{id:"example",children:"Example"}),`
`,e.jsx(l,{children:e.jsx(u,{name:"Default",children:a=>e.jsx(o,{...a})})}),`
`,e.jsx(r.h2,{id:"properties",children:"Properties"}),`
`,e.jsx(d,{story:"Default"}),`
`,e.jsx(h,{children:g}),`
`,e.jsx(w,{})]})}}const c=n=>e.jsx(o,{...n});c.storyName="Default";c.parameters={storySource:{source:`args => {
  return <Icon {...args} />;
}`}};const t={title:"Data Display / Icon",component:o,args:{name:"employee"},tags:["stories-mdx"],includeStories:["defaultStory"]};t.parameters=t.parameters||{};t.parameters.docs={...t.parameters.docs||{},page:k};const Ee=["defaultStory"];export{Ee as __namedExportsOrder,t as default,c as defaultStory};
//# sourceMappingURL=Icon.stories-191168ba.js.map
