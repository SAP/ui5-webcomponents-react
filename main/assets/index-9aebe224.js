import{a as f,U as x,d as S}from"./UI5Element-78be0f3d.js";import{e as a,l as n,s,a as P,b as $,p as u,c as R,d as T,w as z}from"./withWebComponent-d4224c1c.js";import{s as B}from"./slot-76e48863.js";import{c as I,e as L}from"./Icon-70a9e5b9.js";import{I as E,a as k}from"./ItemNavigation-e8f3ce94.js";import{C as D}from"./CSSColor-f91c8158.js";import{i as M}from"./Device-99b8bbf4.js";import{b as A,c as F,k as N,p as g,o as v}from"./Icons-26e87c01.js";import{g as w}from"./CustomElementsScopeUtils-137da8c8.js";import{o as j}from"./class-map-18f572ce.js";import{a as K}from"./Button-427cd4bb.js";import{aY as q,aZ as U,a_ as V}from"./i18n-defaults-f002f496.js";import{_ as W}from"./iframe-71b0b41d.js";import{I as H}from"./Integer-f7f172c9.js";import{s as Y}from"./style-map-54298215.js";function G(r,e,o){return a`<div class="${j(this.classes.colorPaletteRoot)}" @click=${this._onclick} @keyup=${this._onkeyup} @keydown=${this._onkeydown}>${this.showDefaultColor?X.call(this,r,e,o):void 0}<div class="ui5-cp-item-container" role="region" aria-label="${n(this.colorContainerLabel)}" @keydown="${this._onColorContainerKeyDown}">${I(this.displayedColors,(t,i)=>t._id||i,(t,i)=>Z.call(this,r,e,o,t,i))}</div>${this._showMoreColors?J.call(this,r,e,o):void 0}${this.showRecentColors?Q.call(this,r,e,o):void 0}</div>`}function X(r,e,o){return o?a`<div class="ui5-cp-default-color-button-wrapper"><${s("ui5-button",e,o)} class="ui5-cp-default-color-button" design="Transparent" @click=${this._onDefaultColorClick} @keydown=${this._onDefaultColorKeyDown}>Default color</${s("ui5-button",e,o)}><div class="ui5-cp-separator"></div></div>`:a`<div class="ui5-cp-default-color-button-wrapper"><ui5-button class="ui5-cp-default-color-button" design="Transparent" @click=${this._onDefaultColorClick} @keydown=${this._onDefaultColorKeyDown}>Default color</ui5-button><div class="ui5-cp-separator"></div></div>`}function Z(r,e,o,t,i){return a`<slot name="${n(t._individualSlot)}"></slot>`}function J(r,e,o){return o?a`<div class="ui5-cp-more-colors-wrapper"><div class="ui5-cp-separator"></div><${s("ui5-button",e,o)} design="Transparent" class="ui5-cp-more-colors" @click="${this._openMoreColorsDialog}" @keydown=${this._onMoreColorsKeyDown}>${n(this.colorPaleteMoreColorsText)}</${s("ui5-button",e,o)}></div>`:a`<div class="ui5-cp-more-colors-wrapper"><div class="ui5-cp-separator"></div><ui5-button design="Transparent" class="ui5-cp-more-colors" @click="${this._openMoreColorsDialog}" @keydown=${this._onMoreColorsKeyDown}>${n(this.colorPaleteMoreColorsText)}</ui5-button></div>`}function Q(r,e,o){return a`<div class="ui5-cp-recent-colors-wrapper"><div class="ui5-cp-separator"></div><div class="ui5-cp-recent-colors-container" @keydown="${this._onRecentColorsContainerKeyDown}">${I(this.recentColors,(t,i)=>t._id||i,(t,i)=>ee.call(this,r,e,o,t,i))}</div></div>`}function ee(r,e,o,t,i){return o?a`<${s("ui5-color-palette-item",e,o)} value="${n(t)}"></${s("ui5-color-palette-item",e,o)}>`:a`<ui5-color-palette-item value="${n(t)}"></ui5-color-palette-item>`}function oe(r,e,o){return o?a`<${s("ui5-dialog",e,o)} header-text="${n(this.moreColorsFeature.colorPaletteDialogTitle)}"><div class="ui5-cp-dialog-content"><${s("ui5-color-picker",e,o)}></${s("ui5-color-picker",e,o)}></div><div slot="footer" class="ui5-cp-dialog-footer"><${s("ui5-button",e,o)} design="Emphasized" @click="${this._chooseCustomColor}">${n(this.moreColorsFeature.colorPaletteDialogOKButton)}</${s("ui5-button",e,o)}><${s("ui5-button",e,o)} design="Transparent" @click="${this._closeDialog}">${n(this.moreColorsFeature.colorPaletteCancelButton)}</${s("ui5-button",e,o)}></div></${s("ui5-dialog",e,o)}>`:a`<ui5-dialog header-text="${n(this.moreColorsFeature.colorPaletteDialogTitle)}"><div class="ui5-cp-dialog-content"><ui5-color-picker></ui5-color-picker></div><div slot="footer" class="ui5-cp-dialog-footer"><ui5-button design="Emphasized" @click="${this._chooseCustomColor}">${n(this.moreColorsFeature.colorPaletteDialogOKButton)}</ui5-button><ui5-button design="Transparent" @click="${this._closeDialog}">${n(this.moreColorsFeature.colorPaletteCancelButton)}</ui5-button></div></ui5-dialog>`}function te(r,e,o){return a`<div class="ui5-cp-item" style="${Y(this.styles.root)}" value="${n(this.value)}" tabindex="${n(this._tabIndex)}" role="button" aria-label="${n(this.colorLabel)} - ${n(this.index)}: ${n(this.value)}" title="${n(this.colorLabel)} - ${n(this.index)}: ${n(this.value)}" ?disabled="${this._disabled}"></div>`}f("@ui5/webcomponents-theming","sap_fiori_3",async()=>P);f("@ui5/webcomponents","sap_fiori_3",async()=>$);const re={packageName:"@ui5/webcomponents",fileName:"themes/ColorPaletteItem.css",content:`:host(:not([hidden])) {
...
`};var _=globalThis&&globalThis.__decorate||function(r,e,o,t){var i=arguments.length,l=i<3?e:t===null?t=Object.getOwnPropertyDescriptor(e,o):t,h;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")l=Reflect.decorate(r,e,o,t);else for(var m=r.length-1;m>=0;m--)(h=r[m])&&(l=(i<3?h(l):i>3?h(e,o,l):h(e,o))||l);return i>3&&l&&Object.defineProperty(e,o,l),l},b;let p=b=class extends x{static async onDefine(){b.i18nBundle=await S("@ui5/webcomponents")}constructor(){super()}onBeforeRendering(){this._disabled=!this.value,this.phone=M()}get colorLabel(){return b.i18nBundle.getText(q)}get styles(){return{root:{"background-color":this.value}}}};_([u({validator:D})],p.prototype,"value",void 0);_([u({defaultValue:"-1",noAttribute:!0})],p.prototype,"_tabIndex",void 0);_([u({validator:H})],p.prototype,"index",void 0);_([u({type:Boolean})],p.prototype,"phone",void 0);_([u({type:Boolean})],p.prototype,"_disabled",void 0);p=b=_([R({tag:"ui5-color-palette-item",renderer:T,styles:re,template:te})],p);p.define();const O=p,ie=Object.freeze(Object.defineProperty({__proto__:null,default:O},Symbol.toStringTag,{value:"Module"}));f("@ui5/webcomponents-theming","sap_fiori_3",async()=>P);f("@ui5/webcomponents","sap_fiori_3",async()=>$);const ne={packageName:"@ui5/webcomponents",fileName:"themes/ColorPalette.css",content:`:host(:not([hidden])) {
	display: inline-block;
}
...
.ui5-cp-more-colors {
	padding: 0.0625rem;
}`};f("@ui5/webcomponents-theming","sap_fiori_3",async()=>P);f("@ui5/webcomponents","sap_fiori_3",async()=>$);const le={packageName:"@ui5/webcomponents",fileName:"themes/ColorPaletteStaticArea.css",content:`.ui5-cp-dialog-content {
	display: flex;
...
//# sourceMappingURL=index-9aebe224.js.map
