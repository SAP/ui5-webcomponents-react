...
}`}};const h={title:"Modals & Popovers / Popover",component:u,args:{children:e.jsx(w,{children:'Press "Escape" or click outside to close the Popover'}),headerText:"Popover Header",horizontalAlign:P.Center,placementType:j.Right,verticalAlign:y.Center,className:"footerPartNoPadding"},argTypes:{footer:{control:{disable:!0}},header:{control:{disable:!0}}},tags:["stories-mdx"],includeStories:["defaultStory","withContent"]};h.parameters=h.parameters||{};h.parameters.docs={...h.parameters.docs||{},page:F};const bo=["defaultStory","withContent"];export{bo as __namedExportsOrder,h as default,O as defaultStory,I as withContent};
//# sourceMappingURL=Popover.stories-6adedfbc.js.map
