import{j as e}from"./useIsomorphicLayoutEffect-CJg151Ok.js";import{B as t}from"./Button-BJ75y3Nh.js";import"./Boot-CUKJMqeB.js";import{f as Y}from"./Icons-DKhvPm64.js";import{k as Z}from"./i18n-defaults-C2wY9l8t.js";import"./List-B3Nvovdr.js";import{f as d}from"./favorite-Cp3tDieR.js";import{s as ee}from"./settings-CRJwjilh.js";import{r as B}from"./index-CP2MHerv.js";import{B as o}from"./index-BLLqbIKJ.js";import{D as re}from"./index-CE4eKsqG.js";import{I as S}from"./index-DzomO99L.js";import{I as te}from"./index-DSnvilz0.js";import{M as le,a as I}from"./index-Tral8md1.js";import{S as ue}from"./index-ChWiy-8e.js";import{S as pe}from"./index-BCJB9b_C.js";import{S as ne}from"./index-jGfTHkb4.js";import{T as x}from"./index-2VpgkMSq.js";import{u as oe,T as s,a as ce,b as de}from"./index-Dt9Qivh6.js";import{T as r}from"./index-DymV_ww8.js";import{T as N}from"./index-BAkyhZkW.js";import{T as D}from"./index-BcgR5kdV.js";const m="edit",l=B.forwardRef((n,a)=>{const{children:i,...p}=n,{inPopover:c}=oe();return e.jsx(o,{...p,ref:a,children:c?i:""})});l.displayName="OverflowToolbarButton";try{l.displayName="OverflowToolbarButton",l.__docgenInfo={description:"The `OverflowToolbarButton` represents a push button that shows its text only when in the overflow area of a `Toolbar`.\n\n__Note:__ This component is only compatible with the `Toolbar` component and __not__ with `ToolbarV2`.",displayName:"OverflowToolbarButton",props:{children:{defaultValue:null,description:"Defines the text of the component which is only visible in the overflow area of a `Toolbar`.\n\n**Note:** Although this slot accepts HTML Elements, it is strongly recommended that you only use text in order to preserve the intended design.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},icon:{defaultValue:null,description:`Defines the icon to be displayed as graphical element within the component. The SAP-icons font provides numerous options.
...
**Note:** Available since [v1.2.0](https://github.com/SAP/ui5-webcomponents/releases/tag/v1.2.0) of **@ui5/webcomponents**.`,name:"tooltip",required:!1,type:{name:"string"}},design:{defaultValue:{value:'"Default"'},description:"Defines the component design.",name:"design",required:!1,type:{name:"enum",value:[{value:'"Positive"'},{value:'"Negative"'},{value:'"Default"'},{value:'"Transparent"'},{value:'"Emphasized"'},{value:'"Default"'},{value:'"Positive"'},{value:'"Negative"'},{value:'"Transparent"'},{value:'"Emphasized"'},{value:'"Attention"'},{value:'"Attention"'}]}},type:{defaultValue:{value:'"Button"'},description:`Defines whether the button has special form-related functionality.
