import{j as e}from"./jsx-runtime-5926aa06.js";import{r}from"./index-ebeaab24.js";import{B as f}from"./index-9686d3d0.js";import{M as u,a as t}from"./index-79e37859.js";const m={title:"Modals & Popovers / Menu",component:u,argTypes:{children:{control:{disable:!0}}},parameters:{chromatic:{delay:1e3}}},n={render(i){const o=r.useRef(null),l=r.useRef(null);return r.useEffect(()=>{},[]),e.jsxs(e.Fragment,{children:[e.jsx(f,{ref:l,onClick:d=>{o.current.showAt(d.target)},children:"Show Menu"}),e.jsxs(u,{...i,ref:o,children:[e.jsx(t,{text:"New File",icon:"add-document"}),e.jsx(t,{text:"New Folder",icon:"add-folder",disabled:!0}),e.jsx(t,{text:"Open",icon:"open-folder",startsSection:!0}),e.jsx(t,{text:"Close"}),e.jsx(t,{text:"Preferences",icon:"action-settings",startsSection:!0}),e.jsx(t,{text:"Exit",icon:"journey-arrive"})]})]})}};var s,c,a;n.parameters={...n.parameters,docs:{...(s=n.parameters)==null?void 0:s.docs,source:{originalSource:`{
  render(args) {
...
//# sourceMappingURL=Menu.stories-2a7afe5a.js.map
