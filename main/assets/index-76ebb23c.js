import{_ as t}from"./iframe-03ac1d6f.js";import{a}from"./Icon-70a9e5b9.js";import{w as o}from"./withWebComponent-d4224c1c.js";const e=o("ui5-icon",["accessibleName","accessibleRole","design","name"],["interactive","showTooltip"],[],[],()=>t(()=>import("./Icon-70a9e5b9.js").then(n=>n.b),["./Icon-70a9e5b9.js","./UI5Element-78be0f3d.js","./CustomElementsScopeUtils-137da8c8.js","./withWebComponent-d4224c1c.js","./utils-69f7a0e0.js","./index-ebeaab24.js","./jsx-runtime-5926aa06.js","./useIsomorphicLayoutEffect-38a48652.js","./Icons-26e87c01.js"],import.meta.url));e.displayName="Icon";e.defaultProps={design:a.Default};try{e.displayName="Icon",e.__docgenInfo={description:`The \`Icon\` component represents an SVG icon. There are two main scenarios how the \`Icon\` component is used: as a purely decorative element,
or as an interactive element that can be focused and clicked.

__Note:__ This component is a web component developed by the UI5 Web Components’ team.

<ui5-link href="https://sap.github.io/ui5-webcomponents/playground/?path=/docs/main-Icon" target="_blank">UI5 Web Components Storybook</ui5-link>`,displayName:"Icon",props:{accessibleName:{defaultValue:null,description:`Defines the text alternative of the component. If not provided a default text alternative will be set, if present.

**Note:** Every icon should have a text alternative in order to calculate its accessible name.`,name:"accessibleName",required:!1,type:{name:"string"}},accessibleRole:{defaultValue:null,description:"Defines the accessibility role of the component.",name:"accessibleRole",required:!1,type:{name:"string"}},design:{defaultValue:{value:"IconDesign.Default"},description:"Defines the component semantic design.\n\n**The available values are:**\n\n*   `Contrast`\n*   `Critical`\n*   `Default`\n*   `Information`\n*   `Negative`\n*   `Neutral`\n*   `NonInteractive`\n*   `Positive`",name:"design",required:!1,type:{name:"enum",value:[{value:'"Critical"'},{value:'"Neutral"'},{value:'"Information"'},{value:'"Positive"'},{value:'"Negative"'},{value:'"Contrast"'},{value:'"Critical"'},{value:'"Default"'},{value:'"Information"'},{value:'"Negative"'},{value:'"Neutral"'},{value:'"NonInteractive"'},{value:'"Positive"'},{value:'"Contrast"'},{value:'"Default"'},{value:'"NonInteractive"'}]}},interactive:{defaultValue:null,description:"Defines if the icon is interactive (focusable and pressable)",name:"interactive",required:!1,type:{name:"boolean"}},name:{defaultValue:null,description:`Defines the unique identifier (icon name) of the component.
...
//# sourceMappingURL=index-76ebb23c.js.map
