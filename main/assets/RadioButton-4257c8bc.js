...
`};var s=globalThis&&globalThis.__decorate||function(u,e,t,i){var o=arguments.length,n=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(u,e,t,i);else for(var v=u.length-1;v>=0;v--)(l=u[v])&&(n=(o<3?l(n):o>3?l(e,t,n):l(e,t))||n);return o>3&&n&&Object.defineProperty(e,t,n),n},c;let w=!1,p,r=c=class extends I{constructor(){super(),this._deactivate=()=>{p&&(p.active=!1)},w||(document.addEventListener("mouseup",this._deactivate),w=!0)}static async onDefine(){c.i18nBundle=await T("@ui5/webcomponents")}onBeforeRendering(){this.syncGroup(),this._enableFormSupport()}onExitDOM(){this.syncGroup(!0)}syncGroup(e){const t=this._name,i=this.name,o=this._checked,n=this.checked;e&&_.removeFromGroup(this,t),i!==t?(t&&_.removeFromGroup(this,t),i&&_.addToGroup(this,i)):i&&_.enforceSingleSelection(this,i),this.name&&n!==o&&_.updateTabOrder(this.name),this._name=this.name,this._checked=this.checked}_enableFormSupport(){const e=R("FormSupport");e?e.syncNativeHiddenInput(this,(t,i)=>{i.value=t.value,i.type="radio",i.checked=t.checked}):this.value&&console.warn('In order for the "value" property to have effect, you should also: import "@ui5/webcomponents/dist/features/InputElementsFormSupport.js";')}_onclick(){return this.toggle()}_handleDown(e){const t=this.name;t&&(e.preventDefault(),_.selectNextItem(this,t))}_handleUp(e){const t=this.name;t&&(e.preventDefault(),_.selectPreviousItem(this,t))}_onkeydown(e){if(g(e))return this.active=!0,e.preventDefault();if(W(e))return this.active=!0,this.toggle();const t=this.effectiveDir==="rtl";(O(e)||!t&&m(e)||t&&k(e))&&this._handleDown(e),(V(e)||!t&&k(e)||t&&m(e))&&this._handleUp(e)}_onkeyup(e){g(e)&&this.toggle(),this.active=!1}_onmousedown(){this.active=!0,p=this}_onmouseup(){this.active=!1}_onfocusout(){this.active=!1}toggle(){return this.canToggle()?this.name?(_.selectItem(this,this.name),this):(this.checked=!this.checked,this.fireEvent("change"),this):this}canToggle(){return!(this.disabled||this.readonly||this.checked)}get classes(){return{inner:{"ui5-radio-inner--hoverable":!this.disabled&&!this.readonly&&S()}}}get effectiveAriaDisabled(){return this.disabled?"true":null}get ariaLabelText(){return[L(this),this.text].filter(Boolean).join(" ")}get effectiveAriaDescribedBy(){return this.hasValueState?`${this._id}-descr`:void 0}get hasValueState(){return this.valueState!==h.None}get valueStateText(){switch(this.valueState){case h.Error:return c.i18nBundle.getText(q);case h.Warning:return c.i18nBundle.getText(j);case h.Success:return c.i18nBundle.getText(P);case h.Information:return c.i18nBundle.getText(z);default:return""}}get effectiveTabIndex(){const e=this.getAttribute("tabindex");return this.disabled?"-1":this.name?this._tabIndex:e||"0"}get strokeWidth(){return this.valueState==="None"?"1":"2"}};s([d({type:Boolean})],r.prototype,"disabled",void 0);s([d({type:Boolean})],r.prototype,"readonly",void 0);s([d({type:Boolean})],r.prototype,"required",void 0);s([d({type:Boolean})],r.prototype,"checked",void 0);s([d()],r.prototype,"text",void 0);s([d({type:h,defaultValue:h.None})],r.prototype,"valueState",void 0);s([d()],r.prototype,"name",void 0);s([d()],r.prototype,"value",void 0);s([d({type:y,defaultValue:y.None})],r.prototype,"wrappingType",void 0);s([d()],r.prototype,"accessibleName",void 0);s([d()],r.prototype,"accessibleNameRef",void 0);s([d({defaultValue:"-1",noAttribute:!0})],r.prototype,"_tabIndex",void 0);s([d({type:Boolean})],r.prototype,"active",void 0);s([A()],r.prototype,"formSupport",void 0);r=c=s([F({tag:"ui5-radio-button",languageAware:!0,renderer:C,template:M,styles:Q,dependencies:[B]}),D("change")],r);r.define();const ve=r;export{ve as default};
//# sourceMappingURL=RadioButton-4257c8bc.js.map
