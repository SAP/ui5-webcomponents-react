...
`};var b=globalThis&&globalThis.__decorate||function(n,t,e,s){var c=arguments.length,u=c<3?t:s===null?s=Object.getOwnPropertyDescriptor(t,e):s,f;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")u=Reflect.decorate(n,t,e,s);else for(var y=n.length-1;y>=0;y--)(f=n[y])&&(u=(c<3?f(u):c>3?f(t,e,u):f(t,e))||u);return c>3&&u&&Object.defineProperty(t,e,u),u},l;let d=l=class extends D{onBeforeRendering(){this.busy&&this.clearChildBusyIndicator()}clearChildBusyIndicator(){this.items.forEach(t=>{t.busy=!1})}get itemsCount(){return this.items.length}get overflowBtnAccessibleName(){return l.i18nFioriBundle.getText(H)}get closeBtnAccessibleName(){return l.i18nFioriBundle.getText(U)}get toggleBtnAccessibleName(){return this.collapsed?l.i18nFioriBundle.getText(W):l.i18nFioriBundle.getText(X)}get priorityText(){return this.priority===p.High?l.i18nFioriBundle.getText(Y):this.priority===p.Medium?l.i18nFioriBundle.getText(J):this.priority===p.Low?l.i18nFioriBundle.getText(K):""}get accInvisibleText(){return`${this.groupText} ${this.readText} ${this.priorityText} ${this.counterText}`}get readText(){return this.read?l.i18nFioriBundle.getText(Q):l.i18nFioriBundle.getText(Z)}get groupText(){return l.i18nFioriBundle.getText(ee)}get counterText(){const t=l.i18nFioriBundle.getText(te);return this.showCounter?`${t} ${this.itemsCount}`:""}get ariaLabelledBy(){const t=this._id,e=[];return this.hasTitleText&&e.push(`${t}-title-text`),e.push(`${t}-invisibleText`),e.join(" ")}get _ariaExpanded(){return!this.collapsed}_onBtnToggleClick(){this.collapsed=!this.collapsed,this.fireEvent("toggle",{item:this})}};b([B({type:Boolean})],d.prototype,"collapsed",void 0);b([B({type:Boolean})],d.prototype,"showCounter",void 0);b([S({type:HTMLElement,default:!0})],d.prototype,"items",void 0);d=l=b([F({tag:"ui5-li-notification-group",languageAware:!0,styles:re,template:ne,dependencies:[M,q,G,z,V]}),R("toggle")],d);d.define();const le=d,ce=Object.freeze(Object.defineProperty({__proto__:null,default:le},Symbol.toStringTag,{value:"Module"})),h=P("ui5-li-notification-group",["busyDelay","priority","titleText"],["collapsed","showCounter","busy","read","showClose","selected"],["actions"],["toggle","close"],()=>E(()=>Promise.resolve().then(()=>ce),void 0,import.meta.url));h.displayName="NotificationListGroupItem";h.defaultProps={busyDelay:1e3,priority:p.None};try{h.displayName="NotificationListGroupItem",h.__docgenInfo={description:'The `NotificationListGroupItem` is a special type of list item, that unlike others can group items within self, usually `NotificationListItem` items.\nThe component consists of:\n\n*   `Toggle` button to expand and collapse the group\n*   `Priority` icon to display the priority of the group\n*   `TitleText` to entitle the group\n*   Custom actions - with the use of `NotificationAction`\n*   Items of the group\n\n__Note:__ This component is a web component developed by the UI5 Web Components’ team.\n\n<ui5-link href="https://sap.github.io/ui5-webcomponents/playground/components/NotificationListGroupItem" target="_blank">UI5 Web Components Playground</ui5-link>',displayName:"NotificationListGroupItem",props:{children:{defaultValue:null,description:"Defines the items of the `NotificationListGroupItem`, usually `NotificationListItem` items.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},actions:{defaultValue:null,description:`Defines the actions, displayed in the top-right area.
...
}`,...(A=(C=g.parameters)==null?void 0:C.docs)==null?void 0:A.source}}};const pe=["Default"],Oe=Object.freeze(Object.defineProperty({__proto__:null,Default:g,__namedExportsOrder:pe,default:ue},Symbol.toStringTag,{value:"Module"}));export{Oe as C,g as D};
//# sourceMappingURL=NotificationListGroupItem.stories-884f9142.js.map
