...
import{j as e}from"./jsx-runtime-DtaoT6pD.js";import{r as u,k}from"./Boot-vTaFuwdG.js";import{r as h}from"./Icons-Vbmmw7bO.js";import{a as W}from"./add-io1xPP4b.js";import{e as U}from"./employee-EyN-jrGw.js";import{s as G}from"./settings-CosKTHSq.js";import{b as H,a as f,c as J,d as y,T as t}from"./index-MEueiLx6.js";import{_ as K}from"./iframe-datKVotR.js";import{U as Q,e as S}from"./UI5Element-9EXj3atz.js";import{a as g,l as q,b as w,s as M,c as X,f as Y,w as Z}from"./withWebComponent-LTFbYRvs.js";import{o as _}from"./class-map-gjOVarQw.js";import{s as v}from"./style-map-tejh5TI3.js";import{s as F}from"./parameters-bundle.css-EKzfhWK3.js";function ee(a,n,o){return g`<div id="${q(this._id)}" role="separator" class="${_(this.classes.root)}"></div>`}function te(a,n,o){return o?g`<${w("ui5-li-custom",n,o)} id="${q(this._id)}" role="separator" class="${_(this.classes.root)}" disabled style="${v(this._style)}"></${w("ui5-li-custom",n,o)}>`:g`<ui5-li-custom id="${q(this._id)}" role="separator" class="${_(this.classes.root)}" disabled style="${v(this._style)}"></ui5-li-custom>`}u("@ui5/webcomponents-theming","sap_horizon",async()=>M);u("@ui5/webcomponents","sap_horizon",async()=>F);const ae={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInStrip.css.ts",content:`.ui5-tc__separator{width:0;border-left:.0625rem solid var(--sapGroup_TitleBorderColor);margin:.5rem .25rem}
