import{r as b,U as h,A as m,l as f}from"./UI5Element-a4bd3d38.js";import{b as t,l as o,d as g,s as y,a as w,p as u,c as V,f as I}from"./withWebComponent-7d7e5133.js";import{V as v}from"./ValueState-2c5e5904.js";import{I as k}from"./Integer-f7f172c9.js";import{g as $}from"./AnimationMode-392b388d.js";import{a as x}from"./Icon-42236945.js";import{V as S,a as T,b as E,c as B}from"./i18n-defaults-d5d083dd.js";import{o as A}from"./class-map-0ab40ab9.js";import{s as P}from"./style-map-132a30d8.js";import"./CustomElementsScopeUtils-137da8c8.js";import"./utils-626dc1bf.js";import"./index-f1f2c4b1.js";import"./jsx-runtime-d079401a.js";import"./useIsomorphicLayoutEffect-c49de97d.js";import"./Icons-74c917eb.js";function R(n,i,r){return t`<div class="ui5-progress-indicator-root ${A(this.classes.root)}" role="progressbar" aria-valuemin="0" aria-valuenow="${o(this.validatedValue)}" aria-valuemax="100" aria-valuetext="${o(this.valueStateText)}" aria-disabled="${o(this._ariaDisabled)}" aria-label="${o(this.accessibleName)}"><div class="ui5-progress-indicator-bar" style="${P(this.styles.bar)}">${this.showValueInRemainingBar?void 0:N.call(this,n,i,r)}</div><div class="ui5-progress-indicator-remaining-bar">${this.showValueInRemainingBar?U.call(this,n,i,r):void 0}</div></div>`}function N(n,i,r){return t`${this.showIcon?z.call(this,n,i,r):void 0}${this.hideValue?void 0:D.call(this,n,i,r)}`}function z(n,i,r){return r?t`<${g("ui5-icon",i,r)} name="${o(this.valueStateIcon)}" class="ui5-progress-indicator-icon"></${g("ui5-icon",i,r)}>`:t`<ui5-icon name="${o(this.valueStateIcon)}" class="ui5-progress-indicator-icon"></ui5-icon>`}function D(n,i,r){return t`<span class="ui5-progress-indicator-value">${this.displayValue?M.call(this,n,i,r):W.call(this,n,i,r)}</span>`}function M(n,i,r){return t`${o(this.displayValue)}`}function W(n,i,r){return t`${o(this.validatedValue)}% `}function U(n,i,r){return t`${this.showIcon?O.call(this,n,i,r):void 0}${this.hideValue?void 0:j.call(this,n,i,r)}`}function O(n,i,r){return r?t`<${g("ui5-icon",i,r)} name="${o(this.valueStateIcon)}" class="ui5-progress-indicator-icon"></${g("ui5-icon",i,r)}>`:t`<ui5-icon name="${o(this.valueStateIcon)}" class="ui5-progress-indicator-icon"></ui5-icon>`}function j(n,i,r){return t`<span class="ui5-progress-indicator-value">${this.displayValue?L.call(this,n,i,r):F.call(this,n,i,r)}</span>`}function L(n,i,r){return t`${o(this.displayValue)}`}function F(n,i,r){return t`${o(this.validatedValue)}% `}b("@ui5/webcomponents-theming","sap_fiori_3",async()=>y);b("@ui5/webcomponents","sap_fiori_3",async()=>w);const C={packageName:"@ui5/webcomponents",fileName:"themes/ProgressIndicator.css",content:`:host(:not([hidden])) {
...
`};var _=globalThis&&globalThis.__decorate||function(n,i,r,c){var d=arguments.length,a=d<3?i:c===null?c=Object.getOwnPropertyDescriptor(i,r):c,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(n,i,r,c);else for(var p=n.length-1;p>=0;p--)(l=n[p])&&(a=(d<3?l(a):d>3?l(i,r,a):l(i,r))||a);return d>3&&a&&Object.defineProperty(i,r,a),a},s;let e=s=class extends h{constructor(){super(),this._previousValue=0,this._transitionDuration=0}onBeforeRendering(){this._transitionDuration=Math.abs(this._previousValue-this.validatedValue)*20,this._previousValue=this.validatedValue}valueStateTextMappings(){return{Error:s.i18nBundle.getText(S),Warning:s.i18nBundle.getText(T),Success:s.i18nBundle.getText(E),Information:s.i18nBundle.getText(B)}}valueStateIconMappings(){return{Error:"status-negative",Warning:"status-critical",Success:"status-positive",Information:"information"}}get styles(){return{bar:{width:`${this.validatedValue}%`,"transition-duration":this.shouldAnimate?`${this._transitionDuration}ms`:"none"}}}get classes(){return{root:{"ui5-progress-indicator-max-value":this.validatedValue===100,"ui5-progress-indicator-min-value":this.validatedValue===0}}}get validatedValue(){return this.value<0?0:this.value>100?100:this.value}get showValueInRemainingBar(){return this.value<=50}get shouldAnimate(){return $()!==m.None}get valueStateText(){const i=`${this.validatedValue}%`,r=this.valueStateTextMappings()[this.valueState];return r?`${i} ${r}`:i}get showIcon(){return this.valueState!==v.None}get valueStateIcon(){return this.valueStateIconMappings()[this.valueState]}get _ariaDisabled(){return this.disabled||void 0}static async onDefine(){s.i18nBundle=await f("@ui5/webcomponents")}};_([u()],e.prototype,"accessibleName",void 0);_([u({type:Boolean})],e.prototype,"disabled",void 0);_([u({type:Boolean})],e.prototype,"hideValue",void 0);_([u({validator:k,defaultValue:0})],e.prototype,"value",void 0);_([u()],e.prototype,"displayValue",void 0);_([u({type:v,defaultValue:v.None})],e.prototype,"valueState",void 0);e=s=_([V({tag:"ui5-progress-indicator",renderer:I,styles:C,template:R,dependencies:[x]})],e);e.define();const sr=e;export{sr as default};
//# sourceMappingURL=ProgressIndicator-6287fcae.js.map
