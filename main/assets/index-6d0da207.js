import{_ as Q}from"./iframe-c3106ff6.js";import{a as $,U as X,d as se}from"./UI5Element-fb9ecf93.js";import{e as r,l as s,s as l,a as ee,b as te,p,c as oe,d as ae,w as ne}from"./withWebComponent-d4224c1c.js";import{c as w,I as re,e as x}from"./Icon-ef594e9f.js";import{s as V}from"./slot-76e48863.js";import{V as d}from"./ValueState-2c5e5904.js";import{i as m,c as le,h as ue}from"./Device-99b8bbf4.js";import{I as ce}from"./Integer-f7f172c9.js";import{a as F,I as N}from"./InvisibleMessage-fac05f08.js";import{g as de}from"./AriaLabelHelper-43a261ec.js";import"./slim-arrow-down-d78fcf2d.js";import"./decline-3df8c953.js";import{s as pe,a as he,F as _e,S as ve}from"./Suggestions.css-66403272.js";import"./information-451d615b.js";import{g as me}from"./CustomElementsScopeUtils-137da8c8.js";import{D as E,H as B,o as D,J as R,K as A,p as M,x as fe,y as ge,c as be,d as ye,z as we,e as Se,l as Ie}from"./Icons-2c98f222.js";import{D as $e,au as xe,I as Te,S as ke,r as Pe,s as Ve,t as Ce,u as Fe,n as Ne,o as Ee,p as Be,q as De}from"./i18n-defaults-a58643fd.js";import{o as f}from"./class-map-18f572ce.js";import{s as g}from"./style-map-54298215.js";import{s as Re}from"./ResponsivePopoverCommon.css-e9e92f0e.js";import{s as Ae}from"./ValueStateMessage.css-332efe2d.js";import{a as T,C as Me}from"./ComboBoxItem-647871b6.js";import{c as We,a as W}from"./Popover-510446d9.js";import Le from"./ResponsivePopover-a7253ba3.js";import{L as qe}from"./ListItemBase-32e7e45c.js";import{B as ze}from"./BusyIndicator-80d43f0f.js";import{b as He}from"./Button-4160b137.js";import Ue from"./StandardListItem-049f31eb.js";import Oe from"./GroupHeaderListItem-84974bca.js";import{V as Ge}from"./ValueState-ab6838cc.js";function je(i,e,t){return r`<div class="ui5-combobox-root ui5-input-focusable-element">${this.hasValueState?Ke.call(this,i,e,t):void 0}<input id="ui5-combobox-input" .value="${s(this.value)}" inner-input placeholder="${s(this.placeholder)}" ?disabled=${this.disabled} ?readonly=${this.readonly} value-state="${s(this.valueState)}" @keydown="${this._keydown}" @input="${this._input}" @change="${this._inputChange}" @click=${this._click} @keyup="${this._keyup}" @focusin="${this._focusin}" @focusout="${this._focusout}" aria-expanded="${s(this.open)}" role="combobox" aria-haspopup="listbox" aria-autocomplete="both" aria-describedby="value-state-description" aria-label="${s(this.ariaLabelText)}" aria-required="${s(this.required)}" data-sap-focus-ref />${this.icon?Ye.call(this,i,e,t):void 0}${this.readonly?void 0:Je.call(this,i,e,t)}</div>`}function Ke(i,e,t){return r`<span id="value-state-description" class="ui5-hidden-text">${s(this.ariaValueStateHiddenText)}</span>`}function Ye(i,e,t){return r`<slot name="icon"></slot>`}function Je(i,e,t){return t?r`<${l("ui5-icon",e,t)} name="slim-arrow-down" slot="icon" tabindex="-1" input-icon ?pressed="${this._iconPressed}" @click="${this._arrowClick}" accessible-name="${s(this._iconAccessibleNameText)}"></${l("ui5-icon",e,t)}>`:r`<ui5-icon name="slim-arrow-down" slot="icon" tabindex="-1" input-icon ?pressed="${this._iconPressed}" @click="${this._arrowClick}" accessible-name="${s(this._iconAccessibleNameText)}"></ui5-icon>`}function Ze(i,e,t){return t?r`<${l("ui5-responsive-popover",e,t)} class="${f(this.classes.popover)}" hide-arrow _disable-initial-focus placement-type="Bottom" horizontal-align="Left" style="${g(this.styles.suggestionsPopover)}" @ui5-after-open=${s(this._afterOpenPopover)} @ui5-after-close=${s(this._afterClosePopover)}><${l("ui5-busy-indicator",e,t)} ?active=${this.loading} size="Medium" class="ui5-combobox-busy"></${l("ui5-busy-indicator",e,t)}>${this._isPhone?L.call(this,i,e,t):void 0}${this._isPhone?void 0:U.call(this,i,e,t)}<${l("ui5-list",e,t)} separators="None" @ui5-item-click=${s(this._selectItem)} @ui5-item-focused=${s(this._onItemFocus)} @mousedown=${this._itemMousedown} mode="SingleSelect">${w(this._filteredItems,(o,n)=>o._id||n,(o,n)=>j.call(this,i,e,t,o,n))}</${l("ui5-list",e,t)}>${this._isPhone?K.call(this,i,e,t):void 0}</${l("ui5-responsive-popover",e,t)}>${this.shouldOpenValueStateMessagePopover?Y.call(this,i,e,t):void 0} `:r`<ui5-responsive-popover class="${f(this.classes.popover)}" hide-arrow _disable-initial-focus placement-type="Bottom" horizontal-align="Left" style="${g(this.styles.suggestionsPopover)}" @ui5-after-open=${s(this._afterOpenPopover)} @ui5-after-close=${s(this._afterClosePopover)}><ui5-busy-indicator ?active=${this.loading} size="Medium" class="ui5-combobox-busy"></ui5-busy-indicator>${this._isPhone?L.call(this,i,e,t):void 0}${this._isPhone?void 0:U.call(this,i,e,t)}<ui5-list separators="None" @ui5-item-click=${s(this._selectItem)} @ui5-item-focused=${s(this._onItemFocus)} @mousedown=${this._itemMousedown} mode="SingleSelect">${w(this._filteredItems,(o,n)=>o._id||n,(o,n)=>j.call(this,i,e,t,o,n))}</ui5-list>${this._isPhone?K.call(this,i,e,t):void 0}</ui5-responsive-popover>${this.shouldOpenValueStateMessagePopover?Y.call(this,i,e,t):void 0} `}function L(i,e,t){return t?r`<div slot="header" class="ui5-responsive-popover-header"><div class="row"><span>${s(this._headerTitleText)}</span><${l("ui5-button",e,t)} class="ui5-responsive-popover-close-btn" icon="decline" design="Transparent" @click="${this._closeRespPopover}"></${l("ui5-button",e,t)}></div><div class="row"><div class="input-root-phone" value-state="${s(this.valueState)}"><input class="ui5-input-inner-phone" .value="${s(this.value)}" inner-input placeholder="${s(this.placeholder)}" value-state="${s(this.valueState)}" @input="${this._input}" @change="${this._inputChange}" @keydown="${this._keydown}" aria-autocomplete="both" /></div></div>${this.hasValueStateText?q.call(this,i,e,t):void 0}</div>`:r`<div slot="header" class="ui5-responsive-popover-header"><div class="row"><span>${s(this._headerTitleText)}</span><ui5-button class="ui5-responsive-popover-close-btn" icon="decline" design="Transparent" @click="${this._closeRespPopover}"></ui5-button></div><div class="row"><div class="input-root-phone" value-state="${s(this.valueState)}"><input class="ui5-input-inner-phone" .value="${s(this.value)}" inner-input placeholder="${s(this.placeholder)}" value-state="${s(this.valueState)}" @input="${this._input}" @change="${this._inputChange}" @keydown="${this._keydown}" aria-autocomplete="both" /></div></div>${this.hasValueStateText?q.call(this,i,e,t):void 0}</div>`}function q(i,e,t){return t?r`<div class="${f(this.classes.popoverValueState)}" style="${g(this.styles.popoverValueStateMessage)}"><${l("ui5-icon",e,t)} class="ui5-input-value-state-message-icon" name="${s(this._valueStateMessageIcon)}"></${l("ui5-icon",e,t)}>${this.shouldDisplayDefaultValueStateMessage?z.call(this,i,e,t):H.call(this,i,e,t)}</div>`:r`<div class="${f(this.classes.popoverValueState)}" style="${g(this.styles.popoverValueStateMessage)}"><ui5-icon class="ui5-input-value-state-message-icon" name="${s(this._valueStateMessageIcon)}"></ui5-icon>${this.shouldDisplayDefaultValueStateMessage?z.call(this,i,e,t):H.call(this,i,e,t)}</div>`}function z(i,e,t){return r`${s(this.valueStateDefaultText)}`}function H(i,e,t){return r`${w(this.valueStateMessageText,(o,n)=>o._id||n,(o,n)=>Qe.call(this,i,e,t,o,n))}`}function Qe(i,e,t,o,n){return r`${s(o)}`}function U(i,e,t){return r`${this.hasValueStateText?Xe.call(this,i,e,t):void 0}`}function Xe(i,e,t){return t?r`<div slot="header" class="ui5-responsive-popover-header ${f(this.classes.popoverValueState)}" ?focused=${this._isValueStateFocused} tabindex="0" style="${g(this.styles.suggestionPopoverHeader)}"><${l("ui5-icon",e,t)} class="ui5-input-value-state-message-icon" name="${s(this._valueStateMessageIcon)}"></${l("ui5-icon",e,t)}>${this.shouldDisplayDefaultValueStateMessage?O.call(this,i,e,t):G.call(this,i,e,t)}</div>`:r`<div slot="header" class="ui5-responsive-popover-header ${f(this.classes.popoverValueState)}" ?focused=${this._isValueStateFocused} tabindex="0" style="${g(this.styles.suggestionPopoverHeader)}"><ui5-icon class="ui5-input-value-state-message-icon" name="${s(this._valueStateMessageIcon)}"></ui5-icon>${this.shouldDisplayDefaultValueStateMessage?O.call(this,i,e,t):G.call(this,i,e,t)}</div>`}function O(i,e,t){return r`${s(this.valueStateDefaultText)}`}function G(i,e,t){return r`${w(this.valueStateMessageText,(o,n)=>o._id||n,(o,n)=>et.call(this,i,e,t,o,n))}`}function et(i,e,t,o,n){return r`${s(o)}`}function j(i,e,t,o,n){return r`${o.isGroupItem?tt.call(this,i,e,t,o,n):ot.call(this,i,e,t,o,n)}`}function tt(i,e,t,o,n){return t?r`<${l("ui5-li-groupheader",e,t)} ?focused=${o.focused}>${s(o.text)}</${l("ui5-li-groupheader",e,t)}>`:r`<ui5-li-groupheader ?focused=${o.focused}>${s(o.text)}</ui5-li-groupheader>`}function ot(i,e,t,o,n){return t?r`<${l("ui5-li",e,t)} type="Active" additional-text=${s(o.additionalText)} group-name=${s(o.groupName)} ._tabIndex=${s(o.itemTabIndex)} .mappedItem=${s(o)} ?selected=${o.selected} ?focused=${o.focused}>${s(o.text)}</${l("ui5-li",e,t)}>`:r`<ui5-li type="Active" additional-text=${s(o.additionalText)} group-name=${s(o.groupName)} ._tabIndex=${s(o.itemTabIndex)} .mappedItem=${s(o)} ?selected=${o.selected} ?focused=${o.focused}>${s(o.text)}</ui5-li>`}function K(i,e,t){return t?r`<div slot="footer" class="ui5-responsive-popover-footer"><${l("ui5-button",e,t)} design="Transparent" @click="${this._closeRespPopover}">OK</${l("ui5-button",e,t)}></div>`:r`<div slot="footer" class="ui5-responsive-popover-footer"><ui5-button design="Transparent" @click="${this._closeRespPopover}">OK</ui5-button></div>`}function Y(i,e,t){return t?r`<${l("ui5-popover",e,t)} skip-registry-update _disable-initial-focus prevent-focus-restore hide-arrow class="ui5-valuestatemessage-popover" horizontal-align="${s(this._valueStatePopoverHorizontalAlign)}" placement-type="Bottom"><div slot="header" class="${f(this.classes.popoverValueState)}" style="${g(this.styles.popoverHeader)}"><${l("ui5-icon",e,t)} class="ui5-input-value-state-message-icon" name="${s(this._valueStateMessageIcon)}"></${l("ui5-icon",e,t)}>${this.shouldDisplayDefaultValueStateMessage?J.call(this,i,e,t):Z.call(this,i,e,t)}</div></${l("ui5-popover",e,t)}>`:r`<ui5-popover skip-registry-update _disable-initial-focus prevent-focus-restore hide-arrow class="ui5-valuestatemessage-popover" horizontal-align="${s(this._valueStatePopoverHorizontalAlign)}" placement-type="Bottom"><div slot="header" class="${f(this.classes.popoverValueState)}" style="${g(this.styles.popoverHeader)}"><ui5-icon class="ui5-input-value-state-message-icon" name="${s(this._valueStateMessageIcon)}"></ui5-icon>${this.shouldDisplayDefaultValueStateMessage?J.call(this,i,e,t):Z.call(this,i,e,t)}</div></ui5-popover>`}function J(i,e,t){return r`${s(this.valueStateDefaultText)}`}function Z(i,e,t){return r`${w(this.valueStateMessageText,(o,n)=>o._id||n,(o,n)=>nt.call(this,i,e,t,o,n))}`}function nt(i,e,t,o,n){return r`${s(o)}`}$("@ui5/webcomponents-theming","sap_fiori_3",async()=>ee);$("@ui5/webcomponents","sap_fiori_3",async()=>te);const it={packageName:"@ui5/webcomponents",fileName:"themes/ComboBox.css",content:`:host {
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const P=ne("ui5-cb-item",["additionalText","text"],[],[],[],()=>Q(()=>import("./ComboBoxItem-647871b6.js").then(i=>i.b),["./ComboBoxItem-647871b6.js","./withWebComponent-d4224c1c.js","./utils-69f7a0e0.js","./CustomElementsScopeUtils-137da8c8.js","./index-ebeaab24.js","./jsx-runtime-5926aa06.js","./useIsomorphicLayoutEffect-38a48652.js","./UI5Element-fb9ecf93.js"],import.meta.url));P.displayName="ComboBoxItem";try{P.displayName="ComboBoxItem",P.__docgenInfo={description:"The `ComboBoxItem` represents the item for a `ComboBox`",displayName:"ComboBoxItem",props:{additionalText:{defaultValue:null,description:"Defines the additional text of the component.",name:"additionalText",required:!1,type:{name:"string"}},text:{defaultValue:null,description:"Defines the text of the component.",name:"text",required:!1,type:{name:"string"}},style:{defaultValue:null,description:`Element style which will be appended to the most outer element of a component.
Use this prop carefully, some css properties might break the component.`,name:"style",required:!1,type:{name:"CSSProperties"}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
Use this prop carefully, overwriting CSS rules might break the component.`,name:"className",required:!1,type:{name:"string"}},waitForDefine:{defaultValue:null,description:`Defines whether the component should wait for the underlying custom element of the web component to be defined. This can be useful, for example, for using instance methods when mounting the component.
...
//# sourceMappingURL=index-6d0da207.js.map
