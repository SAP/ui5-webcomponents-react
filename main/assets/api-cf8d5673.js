import{a as s,j as t,F as _}from"./jsx-runtime-670450c2.js";import{H as v,a as N}from"./chunk-PCJTTTQV-07df005d.js";import{r as w}from"./index-f1f749bf.js";function d(r){return r?r.map((i,c,a)=>{let m=i.name;return a.length>1&&c+1!==a.length&&(m+=", "),m}):""}const l=({api:r})=>r.map(i=>{var m,u,b,g,y,h,k;const{signatures:c}=i,{parameters:a}=c[0];return s(w.Fragment,{children:[t(v,{children:i.name}),s("code",{children:[i.name,"(",a==null?void 0:a.map(e=>{var n,o;return`${e.name}:${e.type.name}${(o=(n=e.type)==null?void 0:n.typeArguments)!=null&&o.length?`<${d(e.type.typeArguments)}>`:""}`}).join(", "),"):",(u=(m=c[0])==null?void 0:m.type)==null?void 0:u.name,`<${d((b=c[0].type)==null?void 0:b.typeArguments)}>`]}),s("div",{children:[t(N,{children:(g=c[0])==null?void 0:g.comment.summary.reduce((e,n)=>`${e}${n.text.replaceAll(`
`,"<br>")}`,"")}),(k=(h=(y=c[0])==null?void 0:y.comment)==null?void 0:h.blockTags)==null?void 0:k.filter(e=>e.tag==="@example").map((e,n)=>s(w.Fragment,{children:[n===0&&t("b",{children:"Example"}),t(N,{children:e.content.reduce((o,p)=>`${o}${p.text}`,"")})]},`${e.tag}${n}`)),(a==null?void 0:a.length)&&s(_,{children:[t("b",{children:"Parameters"}),s("table",{children:[t("thead",{children:s("tr",{children:[t("td",{children:"Name"}),t("td",{children:"Type"}),t("td",{children:"Description"})]})}),t("tbody",{children:a==null?void 0:a.map(e=>{var n,o,p,f,x;return s("tr",{children:[s("td",{children:[e.name,((n=e.flags)==null?void 0:n.isOptional)&&"?"]}),t("td",{children:s("code",{children:[(o=e.type)==null?void 0:o.name,((p=e.type)==null?void 0:p.typeArguments)&&`<${((f=e.type)==null?void 0:f.typeArguments)&&d(e.type.typeArguments)}>`]})}),t("td",{children:(x=e.comment)==null?void 0:x.summary.reduce((C,q)=>`${C}${q.text.replaceAll(`
`,"<br>")}`,"")})]},e.name)})})]})]}),s("p",{children:[t("b",{children:"Source:"})," ",t("a",{href:i.sources[0].url,children:`${i.sources[0].fileName}:${i.sources[0].line}`})]})]}),t("br",{}),t("br",{})]},i.name)});l.displayName="CommandsAndQueries";try{l.displayName="CommandsAndQueries",l.__docgenInfo={description:"",displayName:"CommandsAndQueries",props:{api:{defaultValue:null,description:"",name:"api",required:!0,type:{name:"CommandsAndQueries[]"}}}}}catch{}const A=0,T="ui5-webcomponents-react",F="project",P=1,S={},U=[{id:28,name:"src",variant:"declaration",kind:2,flags:{},sources:[{fileName:"index.ts",line:1,character:0,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/index.ts#L1"}]},{id:1,name:"src/commands",variant:"declaration",kind:2,flags:{},children:[{id:2,name:"Cypress",variant:"declaration",kind:4,flags:{},children:[{id:3,name:"Chainable",variant:"declaration",kind:256,flags:{},children:[{id:25,name:"clickUi5ListItemByText",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"commands.ts",line:61,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/commands.ts#L61"}],signatures:[{id:26,name:"clickUi5ListItemByText",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:"Click on a list item of the "},{kind:"code",text:"`List`"},{kind:"text",text:" component by text."}],blockTags:[{tag:"@example",content:[{kind:"code",text:'```ts\ncy.clickUi5ListItemByText("List Item")\n```'}]}]},sources:[{fileName:"commands.ts",line:61,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/commands.ts#L61"}],parameters:[{id:27,name:"text",variant:"param",kind:32768,flags:{},comment:{summary:[{kind:"text",text:"The text of the list item that should be clicked."}]},type:{type:"intrinsic",name:"string"}}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]},{id:21,name:"clickUi5RadioButton",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"commands.ts",line:48,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/commands.ts#L48"}],signatures:[{id:22,name:"clickUi5RadioButton",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:"Click on a "},{kind:"code",text:"`ui5-radio-button`"}],blockTags:[{tag:"@example",content:[{kind:"code",text:"```ts\ncy.get('[ui5-radio-button]').clickUi5RadioButton();\n```"}]}]},sources:[{fileName:"commands.ts",line:48,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/commands.ts#L48"}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]},{id:23,name:"closeUi5PopupWithEsc",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"commands.ts",line:54,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/commands.ts#L54"}],signatures:[{id:24,name:"closeUi5PopupWithEsc",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:"Close ui5-webcomponents popups like "},{kind:"code",text:"`ui5-dialog`"},{kind:"text",text:" or "},{kind:"code",text:"`ui5-popover`"},{kind:"text",text:' by pressing the "Escape" key.'}],blockTags:[{tag:"@example",content:[{kind:"code",text:"```ts\ncy.closeUi5PopupWithEsc()\n```"}]}]},sources:[{fileName:"commands.ts",line:54,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/commands.ts#L54"}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]},{id:17,name:"toggleUi5Checkbox",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"commands.ts",line:36,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/commands.ts#L36"}],signatures:[{id:18,name:"toggleUi5Checkbox",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:"Toggles the state of a "},{kind:"code",text:"`ui5-checkbox`"},{kind:"text",text:"."}],blockTags:[{tag:"@example",content:[{kind:"code",text:"```ts\ncy.get('[ui5-checkbox]').toggleUi5Checkbox();\n```"}]}]},sources:[{fileName:"commands.ts",line:36,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/commands.ts#L36"}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]},{id:19,name:"toggleUi5Switch",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"commands.ts",line:42,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/commands.ts#L42"}],signatures:[{id:20,name:"toggleUi5Switch",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:"Toggles the state of a "},{kind:"code",text:"`ui5-switch`"}],blockTags:[{tag:"@example",content:[{kind:"code",text:"```ts\ncy.get('[ui5-switch]').toggleUi5Switch();\n```"}]}]},sources:[{fileName:"commands.ts",line:42,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/commands.ts#L42"}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]},{id:4,name:"typeIntoUi5Input",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"commands.ts",line:11,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/commands.ts#L11"}],signatures:[{id:5,name:"typeIntoUi5Input",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:"Types a value into a ui5-webcomponent that offers a typeable input field."}],blockTags:[{tag:"@example",content:[{kind:"code",text:"```ts\ncy.get('[ui5-input]').typeIntoUi5Input('Hello World');\n```"}]}]},sources:[{fileName:"commands.ts",line:11,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/commands.ts#L11"}],parameters:[{id:6,name:"text",variant:"param",kind:32768,flags:{},comment:{summary:[{kind:"text",text:"Text that will be typed into the input."}]},type:{type:"intrinsic",name:"string"}},{id:7,name:"options",variant:"param",kind:32768,flags:{isOptional:!0},type:{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.es5.d.ts",qualifiedName:"Partial"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.TypeOptions"},name:"TypeOptions",package:"cypress",qualifiedName:"Cypress.TypeOptions"}],name:"Partial",package:"typescript"}}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]},{id:8,name:"typeIntoUi5InputWithDelay",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"commands.ts",line:23,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/commands.ts#L23"}],signatures:[{id:9,name:"typeIntoUi5InputWithDelay",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:`Types a value with a delay into an ui5-webcomponent that offers a typeable input field.
...
The delay time can vary from environment to environment.`}],blockTags:[{tag:"@example",content:[{kind:"code",text:"```ts\ncy.get('[ui5-combobox]').typeIntoUi5InputWithDelay('Hello World', 1000);\n```"}]}]},sources:[{fileName:"commands.ts",line:23,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/commands.ts#L23"}],parameters:[{id:10,name:"text",variant:"param",kind:32768,flags:{},comment:{summary:[{kind:"text",text:"Text that will be typed into the input."}]},type:{type:"intrinsic",name:"string"}},{id:11,name:"delay",variant:"param",kind:32768,flags:{isOptional:!0},comment:{summary:[{kind:"text",text:"Delay in ms to wait for the web-component to be ready. Default: 500"}]},type:{type:"intrinsic",name:"number"}},{id:12,name:"options",variant:"param",kind:32768,flags:{isOptional:!0},type:{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.es5.d.ts",qualifiedName:"Partial"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.TypeOptions"},name:"TypeOptions",package:"cypress",qualifiedName:"Cypress.TypeOptions"}],name:"Partial",package:"typescript"}}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]},{id:13,name:"typeIntoUi5TextArea",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"commands.ts",line:30,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/commands.ts#L30"}],signatures:[{id:14,name:"typeIntoUi5TextArea",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:"Types a value into "},{kind:"code",text:"`ui5-textarea`"},{kind:"text",text:"."}],blockTags:[{tag:"@example",content:[{kind:"code",text:"```ts\ncy.get('[ui5-textarea]').typeIntoUi5TextArea('Hello World');\n```"}]}]},sources:[{fileName:"commands.ts",line:30,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/commands.ts#L30"}],parameters:[{id:15,name:"text",variant:"param",kind:32768,flags:{},comment:{summary:[{kind:"text",text:"Text that will be typed into the text-area."}]},type:{type:"intrinsic",name:"string"}},{id:16,name:"options",variant:"param",kind:32768,flags:{isOptional:!0},type:{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.es5.d.ts",qualifiedName:"Partial"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.TypeOptions"},name:"TypeOptions",package:"cypress",qualifiedName:"Cypress.TypeOptions"}],name:"Partial",package:"typescript"}}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]}],groups:[{title:"Methods",children:[25,21,23,17,19,4,8,13]}],sources:[{fileName:"commands.ts",line:4,character:14,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/commands.ts#L4"}]}],groups:[{title:"Interfaces",children:[3]}],sources:[{fileName:"commands.ts",line:3,character:12,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/commands.ts#L3"}]}],groups:[{title:"Namespaces",children:[2]}],sources:[{fileName:"commands.ts",line:1,character:0,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/commands.ts#L1"}]},{id:29,name:"src/queries",variant:"declaration",kind:2,flags:{},children:[{id:30,name:"Cypress",variant:"declaration",kind:4,flags:{},children:[{id:31,name:"Chainable",variant:"declaration",kind:256,flags:{},children:[{id:32,name:"findUi5TabByText",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"queries.ts",line:15,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/queries.ts#L15"}],signatures:[{id:33,name:"findUi5TabByText",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:"Returns the tab of the "},{kind:"code",text:"`ui5-tabcontainer`"},{kind:"text",text:` by its text.

__Note:__ Has to be chained to a `},{kind:"code",text:"`ui5-tabcontainer`"},{kind:"text",text:`.
__Note:__ This will not work for sub-tabs.`}],blockTags:[{tag:"@example",content:[{kind:"code",text:"```ts\ncy.get('[ui5-tab-container]').findUi5TabByText('Tab 1');\n```"}]}]},sources:[{fileName:"queries.ts",line:15,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/queries.ts#L15"}],parameters:[{id:34,name:"text",variant:"param",kind:32768,flags:{},comment:{summary:[{kind:"text",text:"The text of the tab that should be queried."}]},type:{type:"intrinsic",name:"string"}}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]},{id:35,name:"findUi5TabOpenPopoverButtonByText",variant:"declaration",kind:2048,flags:{},sources:[{fileName:"queries.ts",line:26,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/queries.ts#L26"}],signatures:[{id:36,name:"findUi5TabOpenPopoverButtonByText",variant:"signature",kind:4096,flags:{},comment:{summary:[{kind:"text",text:`Returns the open-popover button for sub-tabs by its text.

__Note:__ Has to be chained to a `},{kind:"code",text:"`ui5-tabcontainer`"},{kind:"text",text:`.
__Note:__ The tab only renders a button fur sub-tabs if the tab itself has content, otherwise the whole tab is responsible for opening the popover.`}],blockTags:[{tag:"@example",content:[{kind:"code",text:"```ts\ncy.get('[ui5-tab-container]').findUi5TabOpenPopoverButtonByText('Tab 1.1');\n```"}]}]},sources:[{fileName:"queries.ts",line:26,character:6,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/queries.ts#L26"}],parameters:[{id:37,name:"text",variant:"param",kind:32768,flags:{},comment:{summary:[{kind:"text",text:"The text of the sub-tab that should be queried."}]},type:{type:"intrinsic",name:"string"}},{id:38,name:"options",variant:"param",kind:32768,flags:{isOptional:!0},type:{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.es5.d.ts",qualifiedName:"Partial"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.ClickOptions"},name:"ClickOptions",package:"cypress",qualifiedName:"Cypress.ClickOptions"}],name:"Partial",package:"typescript"}}],type:{type:"reference",target:{sourceFileName:"node_modules/cypress/types/cypress.d.ts",qualifiedName:"Cypress.Chainable"},typeArguments:[{type:"reference",target:{sourceFileName:"node_modules/typescript/lib/lib.dom.d.ts",qualifiedName:"Element"},name:"Element",package:"typescript"}],name:"Chainable",package:"cypress",qualifiedName:"Cypress.Chainable"}}]}],groups:[{title:"Methods",children:[32,35]}],sources:[{fileName:"queries.ts",line:4,character:14,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/queries.ts#L4"}]}],groups:[{title:"Interfaces",children:[31]}],sources:[{fileName:"queries.ts",line:3,character:12,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/queries.ts#L3"}]}],groups:[{title:"Namespaces",children:[30]}],sources:[{fileName:"queries.ts",line:1,character:0,url:"https://github.com/SAP/ui5-webcomponents-react/blob/d52147d/packages/cypress-commands/src/queries.ts#L1"}]}],I=[{title:"Modules",children:[28,1,29]}],B="ui5-webcomponents-react",L=[{kind:"text",text:`<a name="top"></a>
