...
Scroll - The rows are loaded automatically by scrolling to the bottom of the table. If the table is not scrollable, this option is the same as the Button.`,name:"type",required:!1,type:{name:"enum",value:[{value:'"Button"'},{value:'"Scroll"'},{value:'"Button"'},{value:'"Scroll"'}]}},style:{defaultValue:null,description:`Element style which will be appended to the most outer element of a component.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const Y={title:"Data Display / Table",component:x,argTypes:{headerRow:{control:{disable:!0}},features:{control:{disable:!0}},children:{control:{disable:!0}}},args:{headerRow:e.jsxs(N,{sticky:!0,children:[e.jsx(p,{width:"12rem",children:e.jsx("span",{children:"Product"})}),e.jsx(p,{minWidth:"800px",children:e.jsx("span",{children:"Supplier"})}),e.jsx(p,{minWidth:"600px",children:e.jsx("span",{children:"Dimensions"})}),e.jsx(p,{minWidth:"600px",children:e.jsx("span",{children:"Weight"})}),e.jsx(p,{children:e.jsx("span",{children:"Price"})})]})},tags:["package:@ui5/webcomponents"]},g={render:o=>e.jsxs(x,{...o,children:[e.jsxs(T,{children:[e.jsx(s,{children:e.jsx("span",{children:"Notebook Basic"})}),e.jsx(s,{children:e.jsx("span",{children:"Very Best Screens"})}),e.jsx(s,{children:e.jsx("span",{children:"30 x 18 x 3cm"})}),e.jsx(s,{children:e.jsx("span",{children:"4.2KG"})}),e.jsx(s,{children:e.jsx("span",{children:"956EUR"})})]}),e.jsxs(T,{children:[e.jsx(s,{children:e.jsx("span",{children:"Notebook Basic 17HT-1001"})}),e.jsx(s,{children:e.jsx("span",{children:"Very Best Screens"})}),e.jsx(s,{children:e.jsx("span",{children:"29 x 17 x 3.1cm"})}),e.jsx(s,{children:e.jsx("span",{children:"4.5KG"})}),e.jsx(s,{children:e.jsx("span",{children:"1249EUR"})})]})]})},m={render:o=>{const t=a=>new Array(25).fill("").map((h,d)=>e.jsxs(T,{children:[e.jsx(s,{children:e.jsx("span",{children:d+a})}),e.jsx(s,{children:e.jsx("span",{children:"Placeholder"})}),e.jsx(s,{children:e.jsx("span",{children:"Placeholder 2"})})]},`${d+a}-row`)),[n,i]=E.useState(t(1)),l=()=>{i(a=>[...a,...t(a.length+1)])};return e.jsx("div",{style:{height:"250px",overflow:"auto"},children:e.jsxs(x,{...o,children:[n,e.jsx(c,{slot:"features",onLoadMore:l,type:f.Button})]})})}};var C,j,B;g.parameters={...g.parameters,docs:{...(C=g.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: args => {
    return <Table {...args}>
        <TableRow>
          <TableCell>
...
}`,...(D=(G=m.parameters)==null?void 0:G.docs)==null?void 0:D.source}}};const Z=["Default","GrowingTable"],pe=Object.freeze(Object.defineProperty({__proto__:null,Default:g,GrowingTable:m,__namedExportsOrder:Z,default:Y},Symbol.toStringTag,{value:"Module"}));export{pe as C,g as D,m as G,c as T};
