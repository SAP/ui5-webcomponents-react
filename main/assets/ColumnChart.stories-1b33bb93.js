import{c as ie,s as We,a as Be}from"./DemoProps-4ae16275.js";import{j as s}from"./jsx-runtime-d079401a.js";import{T as y}from"./ThemingParameters-7e2e4e30.js";import{e as Fe}from"./index-99d317a4.js";import{r as T}from"./index-f1f2c4b1.js";import{g as Me,a as le}from"./defaults-9bc74041.js";import{u as Ne,B as Ee}from"./useCancelAnimationFallback-5df5a09e.js";import{u as Ke,a as He,C as $e,X as Ue,c as Xe,Y as O,b as z}from"./YAxisTicks-d47bc48b.js";import{u as Ge,C as Je}from"./ChartDataLabel-57c5321d.js";import{u as Qe,t as Ze,a as ea,b as aa}from"./staticProps-d8b65b3f.js";import{u as ta}from"./useLongestYAxisLabel-dc6f65dd.js";import{u as sa}from"./useOnClickInternal-7ffac7fa.js";import{u as oa,a as ra,r as na,b as Y}from"./useTooltipFormatter-72292188.js";import{C as ia}from"./ChartContainer-7af7ea2b.js";import{C as la}from"./react-content-loader.es-27eb8e7e.js";import{B as ca,b as da,k as ua,l as ha,R as ma,T as pa,m as ga}from"./generateCategoricalChart-0366adbc.js";import{u as fa}from"./withWebComponent-99b005ba.js";import{u as ba}from"./debounce-be6825b8.js";const _=t=>s.jsxs(la,{viewBox:"0 0 165 145",preserveAspectRatio:"xMidYMid meet",width:"100%",height:"100%",speed:2,backgroundColor:y.sapContent_ImagePlaceholderBackground,foregroundColor:y.sapContent_ImagePlaceholderForegroundColor,backgroundOpacity:y.sapContent_DisabledOpacity,...t,children:[s.jsx("rect",{x:"10",y:"135",width:"135",height:"1"}),s.jsx("rect",{x:"20",y:"50",width:"15",height:"85"}),s.jsx("rect",{x:"40",y:"18",width:"15",height:"117"}),s.jsx("rect",{x:"60",y:"68",width:"15",height:"67"}),s.jsx("rect",{x:"80",y:"60",width:"15",height:"75"}),s.jsx("rect",{x:"100",y:"10",width:"15",height:"125"}),s.jsx("rect",{x:"120",y:"75",width:"15",height:"60"})]});try{_.displayName="ColumnChartPlaceholder",_.__docgenInfo={description:"",displayName:"ColumnChartPlaceholder",props:{}}}catch{}const ya={formatter:le},Ca={formatter:le,opacity:1},va=t=>({payload:k})=>Me(k,t),C=T.forwardRef((t,k)=>{var P,V;const{loading:ce,dataset:n,noLegend:de,noAnimation:j,tooltipConfig:v,onDataPointClick:x,onLegendClick:ue,onClick:D,style:he,className:me,slot:pe,ChartPlaceholder:ge,syncId:fe,children:be,...ye}=t,a={yAxisVisible:!1,xAxisVisible:!0,gridStroke:y.sapList_BorderColor,gridHorizontal:!0,gridVertical:!1,legendPosition:"bottom",legendHorizontalAlign:"left",barGap:3,zoomingTool:!1,resizeDebounce:250,yAxisConfig:{},xAxisConfig:{},secondYAxisConfig:{},...t.chartConfig},{referenceLine:o}=a,{dimensions:I,measures:c}=oa(t.dimensions,t.measures,ya,Ca),Ce=ra(c),[ve,xe]=ta(n,c),i=I[0],{primaryMeasure:Ae,secondaryMeasure:ke}=na(c,(P=a==null?void 0:a.secondYAxis)==null?void 0:P.dataKey),we=Ge(i),[Se,L]=fa(k),_e=c.map(({accessor:e})=>e),w=a.secondYAxis?_e.findIndex(e=>{var r;return e===((r=a.secondYAxis)==null?void 0:r.dataKey)}):0,je=Qe(ue),De=T.useCallback((e,r,A)=>{e&&x&&x(Fe(A,{dataKey:Object.keys(e).filter(l=>e.value.length?e[l]===e.value[1]-e.value[0]:e[l]===e.value&&l!=="value")[0],value:e.value.length?e.value[1]-e.value[0]:e.value,dataIndex:r,payload:e.payload}))},[x]),Ie=sa(D),Le=(n==null?void 0:n.length)>30,Pe=i==null?void 0:i.accessor,Ve=Ke(a.margin,a.zoomingTool),Te=He(L,t.dimensions.length),S=ba(L),{chartConfig:ka,dimensions:wa,measures:Sa,...Oe}=ye,{isMounted:ze,handleBarAnimationStart:Ye,handleBarAnimationEnd:Re}=Ne(j);return s.jsx(ia,{dataset:n,loading:ce,Placeholder:ge??_,ref:Se,style:he,className:me,slot:pe,resizeDebounce:a.resizeDebounce,...Oe,children:s.jsxs(Ee,{syncId:fe,onClick:Ie,stackOffset:"sign",margin:Ve,data:n,barGap:a.barGap,className:typeof x=="function"||typeof D=="function"?"has-click-handler":void 0,children:[s.jsx($e,{vertical:a.gridVertical,horizontal:a.gridHorizontal,stroke:a.gridStroke}),a.xAxisVisible&&I.map((e,r)=>s.jsx(Ue,{dataKey:e.accessor,xAxisId:r,interval:(e==null?void 0:e.interval)??(Le?"preserveStart":0),tick:s.jsx(Xe,{config:e}),tickLine:r<1,axisLine:r<1,height:Te[r],allowDuplicatedCategory:r===0,reversed:S,...a.xAxisConfig},e.accessor)),s.jsx(O,{orientation:S===!0?"right":"left",axisLine:a.yAxisVisible,tickLine:Ze,yAxisId:"left",interval:0,tick:s.jsx(z,{config:Ae}),width:ve,...a.yAxisConfig}),((V=a.secondYAxis)==null?void 0:V.dataKey)&&s.jsx(O,{dataKey:a.secondYAxis.dataKey,axisLine:{stroke:a.secondYAxis.color??`var(--sapChart_OrderedColor_${w%11+1})`},tick:s.jsx(z,{config:ke,secondYAxisConfig:{color:a.secondYAxis.color??`var(--sapChart_OrderedColor_${w%11+1})`}}),tickLine:{stroke:a.secondYAxis.color??`var(--sapChart_OrderedColor_${w%11+1})`},label:{value:a.secondYAxis.name,offset:2,angle:90,position:"center"},orientation:S===!0?"left":"right",yAxisId:"right",interval:0,...a.secondYAxisConfig}),ze&&c.map((e,r)=>{var A;return s.jsxs(ca,{yAxisId:((A=a.secondYAxis)==null?void 0:A.dataKey)===e.accessor?"right":"left",stackId:e.stackId,fillOpacity:e.opacity,name:e.label??e.accessor,strokeOpacity:e.opacity,type:"monotone",dataKey:e.accessor,fill:e.color??`var(--sapChart_OrderedColor_${r%11+1})`,stroke:e.color??`var(--sapChart_OrderedColor_${r%11+1})`,barSize:e.width,onClick:De,isAnimationActive:j===!1,onAnimationStart:Ye,onAnimationEnd:Re,children:[s.jsx(da,{data:n,valueAccessor:va(e.accessor),content:s.jsx(Je,{config:e,chartType:"column",position:"insideTop"})}),n.map((l,qe)=>s.jsx(ua,{fill:Y(e,l,r),stroke:Y(e,l,r)},qe))]},e.accessor)}),!de&&s.jsx(ha,{verticalAlign:a.legendPosition,align:a.legendHorizontalAlign,onClick:je,wrapperStyle:xe}),o&&s.jsx(ma,{...o,stroke:(o==null?void 0:o.color)??(o==null?void 0:o.stroke),y:(o==null?void 0:o.value)??(o==null?void 0:o.y),yAxisId:(o==null?void 0:o.yAxisId)??"left",label:o==null?void 0:o.label}),(v==null?void 0:v.active)!==!1&&s.jsx(pa,{cursor:ea,formatter:Ce,contentStyle:aa,labelFormatter:we,...v}),a.zoomingTool&&s.jsx(ga,{y:10,dataKey:Pe,tickFormatter:i==null?void 0:i.formatter,stroke:y.sapObjectHeader_BorderColor,travellerWidth:10,height:20}),be]})})});C.defaultProps={noLegend:!1,noAnimation:!1};C.displayName="ColumnChart";try{C.displayName="ColumnChart",C.__docgenInfo={description:"A `ColumnChart` is a data visualization where each category is represented by a rectangle, with the height of the rectangle being proportional to the values being plotted.",displayName:"ColumnChart",props:{dimensions:{defaultValue:null,description:`An array of config objects. Each object will define one dimension of the chart.
...
}`,...(ee=(Z=g.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};var ae,te,se;f.parameters={...f.parameters,docs:{...(ae=f.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  args: {
    chartConfig: {
      referenceLine: {
        color: 'red',
...
}`,...(se=(te=f.parameters)==null?void 0:te.docs)==null?void 0:se.source}}};var oe,re,ne;b.parameters={...b.parameters,docs:{...(oe=b.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  args: {
    measures: [{
      accessor: 'users',
      label: 'Users',
...
//# sourceMappingURL=ColumnChart.stories-1b33bb93.js.map
