import{a as k,U as C,d as E}from"./UI5Element-fb9ecf93.js";import{e as v,l as a,s as B,a as z,b as $,p as r,c as I,d as R}from"./withWebComponent-d4224c1c.js";import{e as S,I as N}from"./Icon-ef594e9f.js";import{s as H}from"./slot-76e48863.js";import{g as O,b as y,c as x}from"./Icons-2c98f222.js";import{g as P}from"./AriaLabelHelper-43a261ec.js";import{g as T}from"./CustomElementsScopeUtils-137da8c8.js";import{m as c}from"./MarkedEvents-b83081e9.js";import{i as j,a as F,b as D,c as L,d as w}from"./Device-99b8bbf4.js";import{B as U,f as V,g as M}from"./i18n-defaults-a58643fd.js";var g;(function(n){n.Default="Default",n.Positive="Positive",n.Negative="Negative",n.Transparent="Transparent",n.Emphasized="Emphasized",n.Attention="Attention"})(g||(g={}));const b=g;var m;(function(n){n.Button="Button",n.Submit="Submit",n.Reset="Reset"})(m||(m={}));const _=m,Y=n=>Array.from(n).filter(t=>t.nodeType!==Node.COMMENT_NODE&&(t.nodeType!==Node.TEXT_NODE||(t.nodeValue||"").trim().length!==0)).length>0;function G(n,t,i){return v`<button type="button" class="ui5-button-root" ?disabled="${this.disabled}" data-sap-focus-ref  @focusout=${this._onfocusout} @focusin=${this._onfocusin} @click=${this._onclick} @mousedown=${this._onmousedown} @mouseup=${this._onmouseup} @keydown=${this._onkeydown} @keyup=${this._onkeyup} @touchstart="${this._ontouchstart}" @touchend="${this._ontouchend}" tabindex=${a(this.tabIndexValue)} aria-expanded="${a(this.accessibilityAttributes.expanded)}" aria-controls="${a(this.accessibilityAttributes.controls)}" aria-haspopup="${a(this.accessibilityAttributes.hasPopup)}" aria-label="${a(this.ariaLabelText)}" title="${a(this.buttonTitle)}" part="button">${this.icon?J.call(this,n,t,i):void 0}<span id="${a(this._id)}-content" class="ui5-button-text"><bdi><slot></slot></bdi></span>${this.hasButtonType?W.call(this,n,t,i):void 0}</button> `}function J(n,t,i){return i?v`<${B("ui5-icon",t,i)} class="ui5-button-icon" name="${a(this.icon)}" accessible-role="${a(this.iconRole)}" part="icon" ?show-tooltip=${this.showIconTooltip}></${B("ui5-icon",t,i)}>`:v`<ui5-icon class="ui5-button-icon" name="${a(this.icon)}" accessible-role="${a(this.iconRole)}" part="icon" ?show-tooltip=${this.showIconTooltip}></ui5-icon>`}function W(n,t,i){return v`<span class="ui5-hidden-text">${a(this.buttonTypeText)}</span>`}k("@ui5/webcomponents-theming","sap_fiori_3",async()=>z);k("@ui5/webcomponents","sap_fiori_3",async()=>$);const X={packageName:"@ui5/webcomponents",fileName:"themes/Button.css",content:`:host {
