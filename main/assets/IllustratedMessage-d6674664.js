import{q as F,r as x,U as T,l as D}from"./UI5Element-11982a12.js";import{s as k,b as o,o as O,d as A,l as f,g as P,p as n,c as N,f as Z}from"./withWebComponent-03662f7f.js";import{s as v}from"./slot-76e48863.js";import{R as w}from"./ResizeHandler-9ebe913c.js";import{g as L}from"./AriaLabelHelper-43a261ec.js";import{a as R}from"./Title-01e28931.js";import{S as j,T as z}from"./i18n-defaults-b490e4f6.js";import{s as U}from"./parameters-bundle.css-f9dc8928.js";var _;(function(t){t.Auto="Auto",t.Base="Base",t.Spot="Spot",t.Dialog="Dialog",t.Scene="Scene"})(_||(_={}));const d=_;var C;(function(t){t.BeforeSearch="BeforeSearch",t.NoActivities="NoActivities",t.NoColumnsSet="NoColumnsSet",t.NoData="NoData",t.NoMail="NoMail",t.NoMail_v1="NoMail_v1",t.NoEntries="NoEntries",t.NoNotifications="NoNotifications",t.NoSavedItems="NoSavedItems",t.NoSavedItems_v1="NoSavedItems_v1",t.NoSearchResults="NoSearchResults",t.NoTasks="NoTasks",t.NoTasks_v1="NoTasks_v1",t.NoDimensionsSet="NoDimensionsSet",t.UnableToLoad="UnableToLoad",t.UnableToLoadImage="UnableToLoadImage",t.UnableToUpload="UnableToUpload",t.UploadToCloud="UploadToCloud",t.AddColumn="AddColumn",t.AddPeople="AddPeople",t.AddDimensions="AddDimensions",t.BalloonSky="BalloonSky",t.Connection="Connection",t.EmptyCalendar="EmptyCalendar",t.EmptyList="EmptyList",t.EmptyPlanningCalendar="EmptyPlanningCalendar",t.ErrorScreen="ErrorScreen",t.FilterTable="FilterTable",t.GroupTable="GroupTable",t.NoFilterResults="NoFilterResults",t.PageNotFound="PageNotFound",t.ReloadScreen="ReloadScreen",t.ResizeColumn="ResizeColumn",t.SearchEarth="SearchEarth",t.SearchFolder="SearchFolder",t.SimpleBalloon="SimpleBalloon",t.SimpleBell="SimpleBell",t.SimpleCalendar="SimpleCalendar",t.SimpleCheckMark="SimpleCheckMark",t.SimpleConnection="SimpleConnection",t.SimpleEmptyDoc="SimpleEmptyDoc",t.SimpleEmptyList="SimpleEmptyList",t.SimpleError="SimpleError",t.SimpleMagnifier="SimpleMagnifier",t.SimpleMail="SimpleMail",t.SimpleNoSavedItems="SimpleNoSavedItems",t.SimpleNotFoundMagnifier="SimpleNotFoundMagnifier",t.SimpleReload="SimpleReload",t.SimpleTask="SimpleTask",t.SleepingBell="SleepingBell",t.SortColumn="SortColumn",t.SuccessBalloon="SuccessBalloon",t.SuccessCheckMark="SuccessCheckMark",t.SuccessHighFive="SuccessHighFive",t.SuccessScreen="SuccessScreen",t.Survey="Survey",t.Tent="Tent",t.UploadCollection="UploadCollection",t.TntChartArea="TntChartArea",t.TntChartArea2="TntChartArea2",t.TntChartBar="TntChartBar",t.TntChartBPMNFlow="TntChartBPMNFlow",t.TntChartBullet="TntChartBullet",t.TntChartDoughnut="TntChartDoughnut",t.TntChartFlow="TntChartFlow",t.TntChartGantt="TntChartGantt",t.TntChartOrg="TntChartOrg",t.TntChartPie="TntChartPie",t.TntCodePlaceholder="TntCodePlaceholder",t.TntCompany="TntCompany",t.TntComponents="TntComponents",t.TntExternalLink="TntExternalLink",t.TntFaceID="TntFaceID",t.TntFingerprint="TntFingerprint",t.TntLock="TntLock",t.TntMission="TntMission",t.TntNoApplications="TntNoApplications",t.TntNoFlows="TntNoFlows",t.TntNoUsers="TntNoUsers",t.TntRadar="TntRadar",t.TntSecrets="TntSecrets",t.TntServices="TntServices",t.TntSessionExpired="TntSessionExpired",t.TntSessionExpiring="TntSessionExpiring",t.TntSuccess="TntSuccess",t.TntSuccessfulAuth="TntSuccessfulAuth",t.TntSystems="TntSystems",t.TntTeams="TntTeams",t.TntTools="TntTools",t.TntUnableToLoad="TntUnableToLoad",t.TntUnlock="TntUnlock",t.TntUnsuccessfulAuth="TntUnsuccessfulAuth",t.TntUser2="TntUser2"})(C||(C={}));const p=C,g=new Map,b=F("SVGIllustration.registry",new Map),S=F("SVGIllustration.promises",new Map),$=(t,l)=>{b.set(`${l.set}/${t}`,{dialogSvg:l.dialogSvg,sceneSvg:l.sceneSvg,spotSvg:l.spotSvg,title:l.title,subtitle:l.subtitle})},m1=(t,l)=>{g.set(t,l)},y=async t=>{if(!S.has(t)){if(!g.has(t)){const a=t.startsWith("Tnt")?`tnt/${t.replace(/^Tnt/,"")}`:t;throw new Error(`No loader registered for the ${t} illustration. Probably you forgot to import the "@ui5/webcomponents-fiori/dist/illustrations/${a}.js" module. Or you can import the "@ui5/webcomponents-fiori/dist/illustrations/AllIllustrations.js" module that will make all illustrations available, but fetch only the ones used.`)}const l=g.get(t);S.set(t,l(t))}return S.get(t)},H=t=>{let l="fiori";return t.startsWith("Tnt")&&(l="tnt",t=t.replace(/^Tnt/,"")),b.get(`${l}/${t}`)},q=async t=>{let l="fiori";return await y(t),t.startsWith("Tnt")&&(l="tnt",t=t.replace(/^Tnt/,"")),b.get(`${l}/${t}`)},I=`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="160" height="160" viewBox="0 0 160 160" id="sapIllus-Dialog-BeforeSearch">
...
`,B=`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="320" height="240" viewBox="0 0 320 240" id="sapIllus-Scene-BeforeSearch">
...
`,E=`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="128" height="128" viewBox="0 0 128 128" id="sapIllus-Spot-BeforeSearch">
...
`,M="BeforeSearch",G="fiori",W=j,K=z;$(M,{dialogSvg:I,sceneSvg:B,spotSvg:E,title:W,subtitle:K,set:G});const S1=Object.freeze(Object.defineProperty({__proto__:null,dialogSvg:I,sceneSvg:B,spotSvg:E},Symbol.toStringTag,{value:"Module"}));x("@ui5/webcomponents-theming","sap_fiori_3",async()=>k);x("@ui5/webcomponents-fiori","sap_fiori_3",async()=>U);const V={packageName:"@ui5/webcomponents-fiori",fileName:"themes/IllustratedMessage.css",content:`:host(:not([hidden])) {
	display: block;
}
...
`};function J(t,l,a){return o`<div class="ui5-illustrated-message-root"><div class="ui5-illustrated-message-illustration">${O(this.effectiveIllustration)}</div>${this.hasTitle?Q.call(this,t,l,a):void 0}${this.hasSubtitle?t1.call(this,t,l,a):void 0}${this.hasActions?e1.call(this,t,l,a):void 0}<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="ui5-illustrated-message-util">${s1.call(this,t,l,a)}</svg></div>`}function Q(t,l,a){return o`${this.hasFormattedTitle?X.call(this,t,l,a):Y.call(this,t,l,a)}`}function X(t,l,a){return o`<slot name="title"></slot>`}function Y(t,l,a){return a?o`<${A("ui5-title",l,a)} level="H2" class="ui5-illustrated-message-title" wrapping-type="Normal">${f(this.effectiveTitleText)}</${A("ui5-title",l,a)}>`:o`<ui5-title level="H2" class="ui5-illustrated-message-title" wrapping-type="Normal">${f(this.effectiveTitleText)}</ui5-title>`}function t1(t,l,a){return o`<div class="ui5-illustrated-message-subtitle">${this.hasFormattedSubtitle?l1.call(this,t,l,a):a1.call(this,t,l,a)}</div>`}function l1(t,l,a){return o`<slot name="subtitle"></slot>`}function a1(t,l,a){return o`${f(this.effectiveSubitleText)}`}function e1(t,l,a){return o`<div class="ui5-illustrated-message-actions"><slot></slot></div>`}function s1(t,l,a){return P`<defs><pattern id="sapIllus_PatternShadow" data-name="sapIllus_PatternShadow" width="3" height="5.5" patternUnits="userSpaceOnUse" viewBox="0 0 3 5.5"><rect class="sapIllus_NoColor sapIllus_NoColor_Fill" width="3" height="5.5" /><circle class="sapIllus_BrandColorPrimary sapIllus_BrandColorPrimary_Fill" cx="3" cy="5.5001" r="0.5" /><circle class="sapIllus_BrandColorPrimary sapIllus_BrandColorPrimary_Fill" cy="5.5001" r="0.5" /><circle class="sapIllus_BrandColorPrimary sapIllus_BrandColorPrimary_Fill" cx="1.5" cy="2.7501" r="0.5" /><circle class="sapIllus_BrandColorPrimary sapIllus_BrandColorPrimary_Fill" cx="3" cy="0.0001" r="0.5" /><circle class="sapIllus_BrandColorPrimary sapIllus_BrandColorPrimary_Fill" cy="0.0001" r="0.5" /></pattern><pattern id="sapIllus_PatternHighlight" data-name="sapIllus_PatternHighlight" width="3" height="5.5" patternTransform="translate(35.9059 309.6208)" patternUnits="userSpaceOnUse" viewBox="0 0 3 5.5"><rect class="sapIllus_NoColor sapIllus_NoColor_Fill" width="3" height="5.5" /><circle class="sapIllus_ObjectFillColor sapIllus_ObjectFillColor_Fill" cx="3.0001" cy="5.5001" r="0.5" /><circle class="sapIllus_ObjectFillColor sapIllus_ObjectFillColor_Fill" cx="0.0001" cy="5.5001" r="0.5" /><circle class="sapIllus_ObjectFillColor sapIllus_ObjectFillColor_Fill" cx="1.5001" cy="2.7501" r="0.5" /><circle class="sapIllus_ObjectFillColor sapIllus_ObjectFillColor_Fill" cx="3.0001" cy="0.0001" r="0.5" /><circle class="sapIllus_ObjectFillColor sapIllus_ObjectFillColor_Fill" cx="0.0001" cy="0.0001" r="0.5" /></pattern></defs>`}var i=globalThis&&globalThis.__decorate||function(t,l,a,c){var h=arguments.length,r=h<3?l:c===null?c=Object.getOwnPropertyDescriptor(l,a):c,u;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(t,l,a,c);else for(var m=t.length-1;m>=0;m--)(u=t[m])&&(r=(h<3?u(r):h>3?u(l,a,r):u(l,a))||r);return h>3&&r&&Object.defineProperty(l,a,r),r},e;let s=e=class extends T{constructor(){super(),this._handleResize=this.handleResize.bind(this),this._lastKnownOffsetWidthForMedia={},this._lastKnownMedia="base"}static async onDefine(){e.i18nBundle=await D("@ui5/webcomponents-fiori")}static get BREAKPOINTS(){return{DIALOG:679,SPOT:319,BASE:259}}static get MEDIA(){return{BASE:"base",SPOT:"spot",DIALOG:"dialog",SCENE:"scene"}}async onBeforeRendering(){let l=H(this.name);const a=this.getAttribute("name");this.hasAttribute("name")&&!this.isValidIllustration(a)&&console.warn(`The illustration "${a}" does not exist. The default illustration "${p.BeforeSearch}" is loaded instead.`),l===void 0&&(l=await q(this.name)),this.spotSvg=l.spotSvg,this.dialogSvg=l.dialogSvg,this.sceneSvg=l.sceneSvg,this.illustrationTitle=e.i18nBundle.getText(l.title),this.illustrationSubtitle=e.i18nBundle.getText(l.subtitle),this.size!==d.Auto&&this._handleCustomSize()}onEnterDOM(){w.register(this,this._handleResize)}onExitDOM(){w.deregister(this,this._handleResize)}handleResize(){this.size===d.Auto&&this._applyMedia()}_applyMedia(){const l=this.offsetWidth;let a="";this.offsetWidth<=e.BREAKPOINTS.BASE?a=e.MEDIA.BASE:this.offsetWidth<=e.BREAKPOINTS.SPOT?a=e.MEDIA.SPOT:this.offsetWidth<=e.BREAKPOINTS.DIALOG?a=e.MEDIA.DIALOG:a=e.MEDIA.SCENE;const c=this._lastKnownOffsetWidthForMedia[a];(!(c&&l===c)||this._lastKnownOffsetWidthForMedia[this._lastKnownMedia]===0)&&(this.media=a,this._lastKnownOffsetWidthForMedia[a]=l,this._lastKnownMedia=a)}_setSVGAccAttrs(){const l=this.shadowRoot.querySelector(".ui5-illustrated-message-illustration svg");l&&(this.ariaLabelText?l.setAttribute("aria-label",this.ariaLabelText):l.removeAttribute("aria-label"))}onAfterRendering(){this._setSVGAccAttrs()}_handleCustomSize(){switch(this.size){case d.Base:this.media=e.MEDIA.BASE;return;case d.Spot:this.media=e.MEDIA.SPOT;return;case d.Dialog:this.media=e.MEDIA.DIALOG;return;default:this.media=e.MEDIA.SCENE}}get ariaLabelText(){return L(this)}get effectiveIllustration(){switch(this.media){case e.MEDIA.SPOT:return this.spotSvg;case e.MEDIA.DIALOG:return this.dialogSvg;case e.MEDIA.SCENE:return this.sceneSvg;default:return""}}get hasFormattedSubtitle(){return!!this.subtitle.length}get hasFormattedTitle(){return!!this.title.length}get effectiveTitleText(){return this.titleText?this.titleText:this.illustrationTitle}get effectiveSubitleText(){return this.subtitleText?this.subtitleText:this.illustrationSubtitle}get hasTitle(){return!!(this.hasFormattedTitle||this.titleText||this.illustrationTitle)}get hasSubtitle(){return!!(this.hasFormattedSubtitle||this.subtitleText||this.illustrationSubtitle)}get hasActions(){return!!this.actions.length&&this.media!==e.MEDIA.BASE}isValidIllustration(l){return l in p}};i([n({type:p,defaultValue:p.BeforeSearch})],s.prototype,"name",void 0);i([n({type:d,defaultValue:d.Auto})],s.prototype,"size",void 0);i([n()],s.prototype,"subtitleText",void 0);i([n()],s.prototype,"titleText",void 0);i([n({defaultValue:""})],s.prototype,"accessibleNameRef",void 0);i([n({noAttribute:!0})],s.prototype,"spotSvg",void 0);i([n({noAttribute:!0})],s.prototype,"sceneSvg",void 0);i([n({noAttribute:!0})],s.prototype,"dialogSvg",void 0);i([n()],s.prototype,"media",void 0);i([v({type:HTMLElement})],s.prototype,"title",void 0);i([v({type:HTMLElement})],s.prototype,"subtitle",void 0);i([v({type:HTMLElement,default:!0})],s.prototype,"actions",void 0);s=e=i([N({tag:"ui5-illustrated-message",languageAware:!0,renderer:Z,styles:V,template:J,dependencies:[R]})],s);s.define();const i1=s,_1=Object.freeze(Object.defineProperty({__proto__:null,default:i1},Symbol.toStringTag,{value:"Module"}));export{S1 as B,p as I,d as a,$ as b,i1 as c,_1 as d,m1 as r};
//# sourceMappingURL=IllustratedMessage-d6674664.js.map
