...
}`}};const f={title:"Modals & Popovers / MessageBox",parameters:{chromatic:{delay:1e3}},component:g,args:{open:!1,type:v.Confirm,children:'Press "Escape" to close the MessageBox.'},argTypes:{header:{control:{disable:!0}},actions:{control:{disable:!0}},icon:{control:{disable:!0}}},tags:["stories-mdx"],includeStories:["defaultStory","withCustomAction"]};f.parameters=f.parameters||{};f.parameters.docs={...f.parameters.docs||{},page:T};const Ye=["defaultStory","withCustomAction"];export{Ye as __namedExportsOrder,f as default,w as defaultStory,b as withCustomAction};
//# sourceMappingURL=MessageBox.stories-226a5856.js.map
