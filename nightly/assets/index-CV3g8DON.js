import{m as v,k as y,a as _,s as b,q as d,v as w,z as g,S as T,G as C,w as E}from"./withWebComponent-B0663feL.js";import{H as S}from"./Keys-CAuuEE_3.js";import{l as N}from"./event-strict-DgQLNDEV.js";import{s as D}from"./parameters-bundle.css-DlWxkghp.js";function F(e,t,o){return v`${this.open?P.call(this,e,t,o):void 0} `}function P(e,t,o){return v`<div class="ui5-toast-root" role="alert" tabindex="${y(this._tabindex)}"><bdi><slot></slot></bdi></div>`}_("@ui5/webcomponents-theming","sap_horizon",async()=>b);_("@ui5/webcomponents","sap_horizon",async()=>D);const x={packageName:"@ui5/webcomponents",fileName:"themes/Toast.css.ts",content:`:host{font-family:"72override",var(--sapFontFamily);color:var(--sapList_TextColor);font-size:var(--sapFontSize);position:fixed;display:none;box-sizing:border-box;max-width:15rem;overflow:hidden;background:var(--_ui5-v2-5-0_toast_background);box-shadow:var(--_ui5-v2-5-0_toast_shadow);border-radius:var(--sapElement_BorderCornerRadius);transition-property:opacity;opacity:1;word-wrap:break-word;text-align:center;text-overflow:ellipsis;white-space:pre-line;padding:1rem}.ui5-toast-root{height:100%;width:100%;padding:0;outline:none;box-sizing:border-box}:host([open]){display:block}:host(:not([placement])){bottom:var(--_ui5-v2-5-0_toast_vertical_offset);left:50%;transform:translate(-50%)}:host([placement="TopStart"]){top:var(--_ui5-v2-5-0_toast_vertical_offset);left:var(--_ui5-v2-5-0_toast_horizontal_offset)}:host([placement="MiddleStart"]){left:var(--_ui5-v2-5-0_toast_horizontal_offset);top:50%;transform:translateY(-50%)}:host([placement="BottomStart"]){left:var(--_ui5-v2-5-0_toast_horizontal_offset);bottom:var(--_ui5-v2-5-0_toast_vertical_offset)}:host([placement="TopCenter"]){top:var(--_ui5-v2-5-0_toast_vertical_offset);left:50%;transform:translate(-50%)}:host([placement="MiddleCenter"]){left:50%;top:50%;transform:translate(-50%,-50%)}:host([placement="BottomCenter"]){bottom:var(--_ui5-v2-5-0_toast_vertical_offset);left:50%;transform:translate(-50%)}:host([placement="TopEnd"]){right:var(--_ui5-v2-5-0_toast_horizontal_offset);top:var(--_ui5-v2-5-0_toast_vertical_offset)}:host([placement="MiddleEnd"]){right:var(--_ui5-v2-5-0_toast_horizontal_offset);top:50%;transform:translateY(-50%)}:host([placement="BottomEnd"]){right:var(--_ui5-v2-5-0_toast_horizontal_offset);bottom:var(--_ui5-v2-5-0_toast_vertical_offset)}:host([focused]){outline-width:var(--sapContent_FocusWidth);outline-style:var(--sapContent_FocusStyle);outline-color:var(--sapContent_FocusColor);outline-offset:var(--_ui5-v2-5-0_toast_offset_width)}
`};var r=function(e,t,o,l){var u=arguments.length,s=u<3?t:l===null?l=Object.getOwnPropertyDescriptor(t,o):l,m;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(e,t,o,l);else for(var h=e.length-1;h>=0;h--)(m=e[h])&&(s=(u<3?m(s):u>3?m(t,o,s):m(t,o))||s);return u>3&&s&&Object.defineProperty(t,o,s),s};const p=500,A=1e3,a=[];let i,f=!1;const M=e=>{const t=e.metaKey||!C()&&e.ctrlKey,o=e.key&&e.key.toLowerCase()==="m",l=t&&e.shiftKey&&o,u=a.length;l&&(e.preventDefault(),u&&(a[0].focusable=!0,a[0].focused?(a[0].focused=!1,i==null||i.focus()):(i=document.activeElement,a[0].focus())))};let n=class extends T{constructor(){super(),this.duration=3e3,this.placement="BottomCenter",this.open=!1,this.hover=!1,this.focusable=!1,this.focused=!1,this._onfocusinFn=this._onfocusin.bind(this),this._onfocusoutFn=this._onfocusout.bind(this),this._onkeydownFn=this._onkeydown.bind(this),this._onmouseoverFn=this._onmouseover.bind(this),this._onmouseleaveFn=this._onmouseleave.bind(this),this._ontransitionendFn=this._ontransitionend.bind(this)}onBeforeRendering(){this.open&&(a.pop(),a.push(this)),requestAnimationFrame(()=>{const t=Math.min(this.effectiveDuration/3,A);this.style.transitionDuration=this.open?`${t}ms`:"",this.style.transitionDelay=this.open?`${this.effectiveDuration-t}ms`:"",this.style.opacity=this.open&&!this.hover&&!this.focused?"0":""}),f||(document.addEventListener("keydown",M),f=!0)}_onfocusin(){this.focusable&&(this.focused=!0)}_onfocusout(){this.focused=!1}get effectiveDuration(){return this.duration<p?p:this.duration}_ontransitionend(){this.hover||this.focused||(this.open=!1,this.focusable=!1,this.focused=!1,this.fireDecoratorEvent("close"))}_onmouseover(){this.hover=!0}_onmouseleave(){this.hover=!1}_onkeydown(t){S(t)&&(this.focused=!1,i==null||i.focus())}get _tabindex(){return this.focused?"0":"-1"}onEnterDOM(){this.addEventListener("focusin",this._onfocusinFn),this.addEventListener("focusout",this._onfocusoutFn),this.addEventListener("keydown",this._onkeydownFn),this.addEventListener("mouseover",this._onmouseoverFn),this.addEventListener("mouseleave",this._onmouseleaveFn),this.addEventListener("transitionend",this._ontransitionendFn),this.addEventListener("transitioncancel",this._ontransitionendFn)}onExitDOM(){this.removeEventListener("focusin",this._onfocusinFn),this.removeEventListener("focusout",this._onfocusoutFn),this.removeEventListener("keydown",this._onkeydownFn),this.removeEventListener("mouseover",this._onmouseoverFn),this.removeEventListener("mouseleave",this._onmouseleaveFn),this.removeEventListener("transitionend",this._ontransitionendFn),this.removeEventListener("transitioncancel",this._ontransitionendFn)}};r([d({type:Number})],n.prototype,"duration",void 0);r([d()],n.prototype,"placement",void 0);r([d({type:Boolean})],n.prototype,"open",void 0);r([d({type:Boolean})],n.prototype,"hover",void 0);r([d({type:Boolean})],n.prototype,"focusable",void 0);r([d({type:Boolean})],n.prototype,"focused",void 0);n=r([w({tag:"ui5-toast",renderer:g,styles:x,template:F}),N("close",{bubbles:!0})],n);n.define();const c=E("ui5-toast",["duration","placement"],["open"],[],["close"]);c.displayName="Toast";try{c.displayName="Toast",c.__docgenInfo={description:`The \`Toast\` is a small, non-disruptive popup for success or information messages that
