import{c as Je,s as Qe,a as Ze,e as et,t as tt,l as at}from"./DemoProps-DuFaqo3J.js";import{j as a}from"./jsx-runtime-BjG_zV1W.js";import{T as I}from"./ThemingParameters-B358vlzA.js";import{e as ot}from"./index-C-Zfmu7Z.js";import{r as B}from"./index-B7gF9TUu.js";import{d as nt,C as Ae,u as rt,t as st,a as it,b as lt,c as ct,e as Se}from"./staticProps-BUAbn2pn.js";import{u as dt,B as ht}from"./useCancelAnimationFallback-C1Y36LYl.js";import{u as ut,a as mt,C as pt,X as F,c as Y,Y as gt,b as ft}from"./YAxisTicks-Xi_6T1jx.js";import{u as yt,C as bt}from"./ChartDataLabel-BagQu07B.js";import{g as Ct,u as vt,a as wt,r as kt,b as M}from"./useTooltipFormatter-0ALjlxDq.js";import{u as xt}from"./useOnClickInternal-DjdYT5ze.js";import{n as At,B as St,g as Dt,p as _t,o as Lt,R as jt,T as It,q as Vt}from"./ChartContainer-BvWaLHuM.js";import{C as Pt}from"./react-content-loader.es-CXJNlgSt.js";import{j as Tt}from"./withWebComponent-CEvNJu7C.js";import{u as qt}from"./useIsRTL-DV1DKYoi.js";const zt=(o,c,u="")=>B.useMemo(()=>{let d=Array(c.length).fill(0),s=0;if(o instanceof Array&&c){const V=i=>c.map(l=>l.formatter(Ae.getValueByDataKey(i,l.accessor,"")));o.map(V).forEach(i=>{i.forEach((l,S)=>{d[S]=Math.max(Ct(l),d[S])})}),d=d.map(i=>Math.min(nt,i)),s=d.reduce((i,l)=>i+l,0)}return u==="middle"?[d,{width:"auto"}]:[d,{marginLeft:s,maxWidth:`calc(100% - ${s+8}px)`}]},[o,c,u]),Bt=()=>a.jsxs(Pt,{viewBox:"0 0 165 145",preserveAspectRatio:"xMidYMid meet",width:"100%",height:"100%",speed:2,backgroundColor:I.sapContent_ImagePlaceholderBackground,foregroundColor:I.sapContent_ImagePlaceholderForegroundColor,backgroundOpacity:I.sapContent_DisabledOpacity,children:[a.jsx("rect",{x:"20",y:"10",width:"1",height:"135"}),a.jsx("rect",{x:"20",y:"20",width:"85",height:"15"}),a.jsx("rect",{x:"20",y:"40",width:"117",height:"15"}),a.jsx("rect",{x:"20",y:"60",width:"67",height:"15"}),a.jsx("rect",{x:"20",y:"80",width:"75",height:"15"}),a.jsx("rect",{x:"20",y:"100",width:"125",height:"15"}),a.jsx("rect",{x:"20",y:"120",width:"60",height:"15"})]}),Nt={formatter:Se},Wt={formatter:Se,opacity:1},Ot=o=>({payload:c})=>Ae.getValueByDataKey(c,o),m=B.forwardRef((o,c)=>{var R,E;const{loading:u,loadingDelay:d,dataset:s,noLegend:V,noAnimation:P,tooltipConfig:i,onDataPointClick:l,onLegendClick:S,onClick:N,style:De,className:_e,slot:Le,syncId:je,ChartPlaceholder:Ie,children:Ve,...Pe}=o,t={margin:{},yAxisVisible:!0,xAxisVisible:!0,gridStroke:I.sapList_BorderColor,gridHorizontal:!0,gridVertical:!1,legendPosition:"bottom",legendHorizontalAlign:"left",barGap:3,zoomingTool:!1,resizeDebounce:250,yAxisConfig:{},xAxisConfig:{},secondXAxisConfig:{},...o.chartConfig},n=t.referenceLine,{dimensions:T,measures:D}=vt(o.dimensions,o.measures,Nt,Wt),Te=wt(D),h=T[0],{primaryMeasure:_,secondaryMeasure:qe}=kt(D,(R=t==null?void 0:t.secondYAxis)==null?void 0:R.dataKey),ze=D.map(({accessor:e})=>e),q=t.secondYAxis?ze.findIndex(e=>{var r;return e===((r=t.secondYAxis)==null?void 0:r.dataKey)}):0,[Be,W]=Tt(c),Ne=rt(S),We=yt(h),Oe=B.useCallback((e,r,L)=>{if(e&&l){const j=e.value.length?e.value[1]-e.value[0]:e.value;l(ot(L,{dataKey:Object.keys(e).filter(z=>z!=="value").find(z=>e[z]===j),value:j,payload:e.payload,dataIndex:r}))}},[l]),Re=xt(N),Ee=(s==null?void 0:s.length)>30,Fe=h==null?void 0:h.accessor,[Ye,Me]=zt(s,T,t.legendPosition),Ke=ut(t.margin,t.zoomingTool),[He]=mt(W,1),O=qt(W),{isMounted:$e,handleBarAnimationStart:Ue,handleBarAnimationEnd:Xe}=dt(P),{chartConfig:Ft,dimensions:Yt,measures:Mt,...Ge}=Pe;return a.jsx(At,{dataset:s,loading:u,loadingDelay:d,Placeholder:Ie??Bt,ref:Be,style:De,className:_e,slot:Le,resizeDebounce:t.resizeDebounce,...Ge,children:a.jsxs(ht,{syncId:je,onClick:Re,stackOffset:"sign",margin:Ke,layout:"vertical",data:s,barGap:t.barGap,accessibilityLayer:t.accessibilityLayer,className:typeof l=="function"||typeof N=="function"?"has-click-handler":void 0,children:[a.jsx(pt,{vertical:t.gridVertical,horizontal:t.gridHorizontal,stroke:t.gridStroke}),t.xAxisVisible&&a.jsx(F,{interval:0,type:"number",tick:a.jsx(Y,{config:_}),axisLine:t.xAxisVisible,tickLine:st,tickFormatter:_==null?void 0:_.formatter,height:He,reversed:O,...t.xAxisConfig}),((E=t.secondYAxis)==null?void 0:E.dataKey)&&a.jsx(F,{dataKey:t.secondYAxis.dataKey,axisLine:{stroke:t.secondYAxis.color??`var(--sapChart_OrderedColor_${q%12+1})`},tick:a.jsx(Y,{config:qe,secondYAxisConfig:{color:t.secondYAxis.color??`var(--sapChart_OrderedColor_${q%12+1})`}}),tickLine:{stroke:t.secondYAxis.color??`var(--sapChart_OrderedColor_${q%12+1})`},label:{value:t.secondYAxis.name,offset:2,angle:90,position:"center"},orientation:"top",interval:0,xAxisId:"secondary",type:"number",...t.secondXAxisConfig}),t.yAxisVisible&&T.map((e,r)=>a.jsx(gt,{interval:(e==null?void 0:e.interval)??"preserveStartEnd",minTickGap:Ee?void 0:-10,type:"category",dataKey:e.accessor,tick:a.jsx(ft,{config:e}),tickLine:r<1,axisLine:r<1,yAxisId:r,width:Ye[r],allowDuplicatedCategory:r===0,orientation:O?"right":"left",...t.yAxisConfig},e.reactKey)),$e&&D.map((e,r)=>a.jsxs(St,{stackId:e.stackId,fillOpacity:e.opacity,name:e.label??e.accessor,strokeOpacity:e.opacity,type:"monotone",dataKey:e.accessor,fill:e.color??`var(--sapChart_OrderedColor_${r%12+1})`,stroke:e.color??`var(--sapChart_OrderedColor_${r%12+1})`,barSize:e.width,onClick:Oe,isAnimationActive:!P,onAnimationStart:Ue,onAnimationEnd:Xe,children:[a.jsx(Dt,{data:s,valueAccessor:Ot(e.accessor),content:a.jsx(bt,{config:e,chartType:"bar",position:"insideRight"})}),s.map((L,j)=>a.jsx(_t,{fill:M(e,L,r),stroke:M(e,L,r)},j))]},e.reactKey)),!V&&a.jsx(Lt,{verticalAlign:t.legendPosition,align:t.legendHorizontalAlign,onClick:Ne,wrapperStyle:Me,...t.legendConfig}),n&&a.jsx(jt,{...n,stroke:(n==null?void 0:n.color)??(n==null?void 0:n.stroke),x:(n==null?void 0:n.value)??(n==null?void 0:n.x),label:n==null?void 0:n.label}),(i==null?void 0:i.active)!==!1&&a.jsx(It,{cursor:it,formatter:Te,contentStyle:lt,labelFormatter:We,...i}),!!t.zoomingTool&&a.jsx(Vt,{dataKey:Fe,tickFormatter:h==null?void 0:h.formatter,...ct,...typeof t.zoomingTool=="object"?t.zoomingTool:{}}),Ve]})})});m.displayName="BarChart";try{m.displayName="BarChart",m.__docgenInfo={description:"A `BarChart` is a data visualization where each category is represented by a rectangle, with the width of the rectangle being proportional to the values being plotted.",displayName:"BarChart",props:{dimensions:{defaultValue:null,description:`An array of config objects. Each object will define one dimension of the chart.
