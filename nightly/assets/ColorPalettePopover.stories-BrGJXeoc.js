import{j as o}from"./jsx-runtime-CLpGMVip.js";import{i as _}from"./utils--fxPZxKN.js";import{r as C}from"./index-CjmQ2z5u.js";import{B as D}from"./index-C7c7stHm.js";import{a as R,C as n}from"./index-DsKd-CmO.js";import{o as S,j as p,r as g,d as T,p as d,q as N,t as O,U as x,w as I}from"./withWebComponent-DbOtF11K.js";import{s as k}from"./slot-Df15G--e.js";import{e as b}from"./event-strict-C2lE4gn2.js";import{i as j}from"./i18n-BLQCbquq.js";import{D as E}from"./Popover-BEou1Y9a.js";import{g as q}from"./useIsomorphicLayoutEffect-U1V4gMqc.js";import{a as V}from"./Title-HEcUckFf.js";import{a as M}from"./Button-Df0TC0Md.js";import{R as A}from"./ResponsivePopover-DhwVJmwv.js";import{d as B}from"./parameters-bundle.css-BzaqQttB.js";import{R as U}from"./ResponsivePopoverCommon.css-B2_65n15.js";import{ak as L,O as F}from"./i18n-defaults-Do22Zz-4.js";function Y(){return S(A,{hideArrow:!0,contentOnlyOnDesktop:!0,placement:"Bottom",opener:this.opener,open:this._open,onClose:this.onAfterClose,onOpen:this.onAfterOpen,children:[p("div",{slot:"header",class:"ui5-cp-header",children:p(V,{level:"H1",wrappingType:"None",children:this._colorPaletteTitle})}),p("div",{children:p(R,{showMoreColors:this.showMoreColors,showRecentColors:this.showRecentColors,showDefaultColor:this.showDefaultColor,defaultColor:this.defaultColor,popupMode:!0,onItemClick:this.onSelectedColor,children:this.colorPaletteColors.map(t=>p("slot",{name:t._individualSlot}))})}),p("div",{slot:"footer",class:"ui5-cp-footer",children:p(M,{design:"Transparent",onClick:this.closePopover,children:this._cancelButtonLabel})})]})}g("@ui5/webcomponents-theming","sap_horizon",async()=>T);g("@ui5/webcomponents","sap_horizon",async()=>B);const H=`.ui5-cp-header{width:100%;height:var(--_ui5-v2-6-2_color-palette-button-height);display:flex;align-items:center}.ui5-cp-footer{width:100%;display:flex;justify-content:flex-end;align-items:center;margin:.1875rem 0}[ui5-responsive-popover]::part(content){padding:0}.ui5-cp-item-container{padding:.3125rem .6875rem}
`;var i=function(t,e,s,a){var u=arguments.length,r=u<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,s):a,h;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(t,e,s,a);else for(var v=t.length-1;v>=0;v--)(h=t[v])&&(r=(u<3?h(r):u>3?h(e,s,r):h(e,s))||r);return u>3&&r&&Object.defineProperty(e,s,r),r},m;let l=m=class extends x{constructor(){super(),this.showRecentColors=!1,this.showMoreColors=!1,this.showDefaultColor=!1,this.open=!1}get responsivePopover(){return this.shadowRoot.querySelector("[ui5-responsive-popover]")}get respPopover(){return this.shadowRoot.querySelector("[ui5-responsive-popover]")}closePopover(){this.open=!1}onAfterClose(){this.closePopover(),this.fireDecoratorEvent("close")}onAfterOpen(){var s;const e=this._colorPalette;e._currentlySelected?(s=e._currentlySelected)==null||s.focus():e.showRecentColors&&e.recentColorsElements.length?e.recentColorsElements[0].focus():e.showDefaultColor&&e.colorPaletteNavigationElements[0].focus(),e.allColorsInPalette.forEach(a=>{const u=a.offsetHeight+4;a.style.setProperty(q("--_ui5_color_palette_item_height"),`${u}px`)})}onSelectedColor(e){this.closePopover(),this.fireDecoratorEvent("item-click",e.detail)}get _colorPalette(){return this.responsivePopover.content[0].querySelector("[ui5-color-palette]")}isOpen(){return this.open}get colorPaletteColors(){return this.getSlottedNodes("colors")}get _colorPaletteTitle(){return m.i18nBundle.getText(L)}get _cancelButtonLabel(){return m.i18nBundle.getText(F)}get _open(){return this.open||void 0}};i([d({type:Boolean})],l.prototype,"showRecentColors",void 0);i([d({type:Boolean})],l.prototype,"showMoreColors",void 0);i([d({type:Boolean})],l.prototype,"showDefaultColor",void 0);i([d()],l.prototype,"defaultColor",void 0);i([d({type:Boolean})],l.prototype,"open",void 0);i([d({converter:E})],l.prototype,"opener",void 0);i([k({default:!0,type:HTMLElement,individualSlots:!0})],l.prototype,"colors",void 0);i([j("@ui5/webcomponents")],l,"i18nBundle",void 0);l=m=i([N({tag:"ui5-color-palette-popover",renderer:O,styles:[U,H],template:Y}),b("item-click",{bubbles:!0}),b("close",{bubbles:!0})],l);l.define();const c=I("ui5-color-palette-popover",["defaultColor","opener"],["open","showDefaultColor","showMoreColors","showRecentColors"],[],["close","item-click"]);c.displayName="ColorPalettePopover";try{c.displayName="ColorPalettePopover",c.__docgenInfo={description:`Represents a predefined range of colors for easier selection.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const z={title:"Modals & Popovers / ColorPalettePopover",component:c,argTypes:{children:{control:{disable:!0}},defaultColor:{control:{type:"color"}}},parameters:{chromatic:{delay:1e3},open:_},tags:["package:@ui5/webcomponents"]},f={render(t){const e=C.useRef(null),[s,a]=C.useState(t.open),u=r=>{a(h=>!h)};return o.jsxs(o.Fragment,{children:[o.jsx(D,{onClick:u,ref:e,children:"Open ColorPalettePopover"}),o.jsxs(c,{...t,opener:e.current,open:s,onClose:r=>{t.onClose(r),a(!1)},children:[o.jsx(n,{value:"black"}),o.jsx(n,{value:"darkblue"}),o.jsx(n,{value:"#444444"}),o.jsx(n,{value:"rgb(0,200,0)"}),o.jsx(n,{value:"green"}),o.jsx(n,{value:"darkred"}),o.jsx(n,{value:"yellow"}),o.jsx(n,{value:"blue"}),o.jsx(n,{value:"cyan"}),o.jsx(n,{value:"orange"}),o.jsx(n,{value:"#5480e7"}),o.jsx(n,{value:"#ff6699"})]})]})}};var w,y,P;f.parameters={...f.parameters,docs:{...(w=f.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render(args) {
...
}`,...(P=(y=f.parameters)==null?void 0:y.docs)==null?void 0:P.source}}};const W=["Default"],ce=Object.freeze(Object.defineProperty({__proto__:null,Default:f,__namedExportsOrder:W,default:z},Symbol.toStringTag,{value:"Module"}));export{ce as C,f as D};
