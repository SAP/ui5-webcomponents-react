import{l as X,c as y,p as Q,d as Y,s as x,A as $,m as Z,b7 as ee,ah as te,b5 as ne,ba as T,b9 as oe,w as re,j as e,Q as B,J as v,$ as G}from"./iframe-yjMKSaW2.js";import{i as ae}from"./Person-Bk5r7PMP.js";import{S as se,s as ie,b as le,m as K,a as ce}from"./sys-help-B3l-XGk4.js";import{F as de}from"./index-BTcK53Xp.js";import{L as he}from"./index-tTu9lfPG.js";import{d as pe}from"./parameters-bundle.css-gLosEED4.js";import{S as me}from"./index-D-Fwabve.js";import{T as c}from"./index-D2oaGTxE.js";import{S as d}from"./index-BNw238I_.js";import{A as ue}from"./index-BFYU0Mvp.js";function ge(){return X("a",{class:"ui5-shellbar-branding-root",href:this.parsedRef,target:this.target,role:this._role,tabIndex:0,"aria-label":this.accessibleNameText,onClick:this._onclick,onKeyDown:this._onkeydown,onKeyUp:this._onkeyup,children:[y("span",{class:"ui5-shellbar-logo",children:y("slot",{name:"logo"})}),!this._isSBreakPoint&&y("bdi",{class:"ui5-shellbar-title",children:y("slot",{})})]})}Q("@ui5/webcomponents-theming","sap_horizon",async()=>Y);Q("@ui5/webcomponents-fiori","sap_horizon",async()=>pe);const fe=`:host(:not([hidden])) .ui5-shellbar-branding-root{text-decoration:none}:host(:not([hidden])){display:inline}.ui5-shellbar-branding-root{overflow:hidden;display:flex;align-items:center;padding-block:.25rem;padding-inline:.25rem .5rem;box-sizing:border-box;cursor:pointer;background:var(--sapButton_Lite_Background);border:1px solid var(--sapButton_Lite_BorderColor);color:var(--sapShell_TextColor);margin-inline-start:.125rem;margin-inline-end:.5rem}.ui5-shellbar-branding-root:focus{outline:var(--_ui5-v2-13-1_shellbar_logo_outline);border-radius:var(--_ui5-v2-13-1_shellbar_logo_border_radius)}.ui5-shellbar-branding-root:hover{box-shadow:var(--_ui5-v2-13-1_shellbar_button_box_shadow);border-radius:var(--_ui5-v2-13-1_shellbar_logo_border_radius)}.ui5-shellbar-branding-root:active:focus{background:var(--sapShell_Active_Background);border:1px solid var(--sapButton_Lite_Active_BorderColor);color:var(--sapShell_Active_TextColor)}.ui5-shellbar-title{display:inline-block;font-family:var(--sapFontSemiboldDuplexFamily);margin:0;font-size:var(--_ui5-v2-13-1_shellbar_menu_button_title_font_size);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;color:var(--sapShell_SubBrand_TextColor);margin-inline-start:.25rem}.ui5-shellbar-logo-area{overflow:hidden;display:flex;align-items:center;padding:.25rem .5rem .25rem .25rem;box-sizing:border-box;cursor:pointer;background:var(--sapButton_Lite_Background);border:1px solid var(--sapButton_Lite_BorderColor);color:var(--sapShell_TextColor);margin-inline-start:.125rem}::slotted([slot="logo"]){max-height:2rem;max-width:3.75rem;pointer-events:none;padding-inline:.25rem}
`;var l=function(n,t,a,s){var i=arguments.length,o=i<3?t:s===null?s=Object.getOwnPropertyDescriptor(t,a):s,S;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,t,a,s);else for(var w=n.length-1;w>=0;w--)(S=n[w])&&(o=(i<3?S(o):i>3?S(t,a,o):S(t,a))||o);return i>3&&o&&Object.defineProperty(t,a,o),o};let r=class extends ne{constructor(){super(...arguments),this._isSBreakPoint=!1}get parsedRef(){return this.href&&this.href.length>0?this.href:void 0}get _role(){return this.href&&this.href.length>0?"link":"button"}get accessibleNameText(){var a,s;if(this.accessibleName)return this.accessibleName;const t=(a=this.shadowRoot)==null?void 0:a.querySelector("slot:not([name])");return(s=t==null?void 0:t.assignedNodes({flatten:!0}).find(i=>{var o;return i.nodeType===Node.TEXT_NODE&&((o=i.textContent)==null?void 0:o.trim())}))==null?void 0:s.textContent.trim()}_fireClick(){this.fireDecoratorEvent("click")}_onclick(t){t.stopPropagation(),this._fireClick()}_onkeyup(t){T(t)&&this._fireClick()}_onkeydown(t){if(T(t)){t.preventDefault();return}oe(t)&&this._fireClick()}};l([x()],r.prototype,"href",void 0);l([x()],r.prototype,"target",void 0);l([x()],r.prototype,"accessibleName",void 0);l([x({type:Boolean})],r.prototype,"_isSBreakPoint",void 0);l([$({type:HTMLElement,default:!0})],r.prototype,"content",void 0);l([$({type:HTMLElement})],r.prototype,"logo",void 0);r=l([Z({tag:"ui5-shellbar-branding",languageAware:!0,renderer:te,template:ge,styles:fe}),ee("click",{bubbles:!0})],r);r.define();const h=re("ui5-shellbar-branding",["accessibleName","href","target"],[],["logo"],["click"]);h.displayName="ShellBarBranding";try{h.displayName="ShellBarBranding",h.__docgenInfo={description:"The `ShellBarBranding` component is intended to be placed inside the branding slot of the\n`ShellBar` component. Its content has higher priority than the `primaryTitle` property\nand the `logo` slot of `ShellBar`.\n\n__Note__: This is a UI5 Web Component! [Repository](https://github.com/SAP/ui5-webcomponents) | [Documentation](https://sap.github.io/ui5-webcomponents/)",displayName:"ShellBarBranding",props:{children:{defaultValue:null,description:`Defines the title for the ui5-shellbar-branding component.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}try{h.displayName="ShellBarBranding",h.__docgenInfo={description:"The `ShellBarBranding` component is intended to be placed inside the branding slot of the\n`ShellBar` component. Its content has higher priority than the `primaryTitle` property\nand the `logo` slot of `ShellBar`.\n\n__Note__: This is a UI5 Web Component! [Repository](https://github.com/SAP/ui5-webcomponents) | [Documentation](https://sap.github.io/ui5-webcomponents/)",displayName:"ShellBarBranding",props:{children:{defaultValue:null,description:`Defines the title for the ui5-shellbar-branding component.
...
}`,...(E=(D=m.parameters)==null?void 0:D.docs)==null?void 0:E.source}}};var A,F,I;u.parameters={...u.parameters,docs:{...(A=u.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    startButton: <Button icon={navBackIcon} tooltip="Back" accessibleName="Back" />
  }
}`,...(I=(F=u.parameters)==null?void 0:F.docs)==null?void 0:I.source}}};var P,R,L;g.parameters={...g.parameters,docs:{...(P=g.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    content: <>
        <Tag design="Set2" colorScheme="7">
          Trial
...
}`,...(J=(O=_.parameters)==null?void 0:O.docs)==null?void 0:J.source}}};const _e=["Default","AllFeatures","EmbeddedBackNavigation","TrialExample","ProductiveInstances","NonProductiveInstances","ShellBarBrandingStory"],De=Object.freeze(Object.defineProperty({__proto__:null,AllFeatures:m,Default:p,EmbeddedBackNavigation:u,NonProductiveInstances:b,ProductiveInstances:f,ShellBarBrandingStory:_,TrialExample:g,__namedExportsOrder:_e,default:be},Symbol.toStringTag,{value:"Module"}));export{m as A,De as C,p as D,u as E,b as N,f as P,_ as S,g as T,h as a};
