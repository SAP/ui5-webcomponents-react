...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var W=function(a,t,o,s){var l=arguments.length,n=l<3?t:s===null?s=Object.getOwnPropertyDescriptor(t,o):s,i;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(a,t,o,s);else for(var r=a.length-1;r>=0;r--)(i=a[r])&&(n=(l<3?i(n):l>3?i(t,o,n):i(t,o))||n);return l>3&&n&&Object.defineProperty(t,o,n),n},$;let M=$=class extends Be{constructor(){super(...arguments),this.interactive=!1}isFixedAction(){return!0}getRenderInfo(){return{text:this._i18nNavigation,icon:"navigation-right-arrow",interactive:this.interactive}}get _i18nNavigation(){return $.i18nBundle.getText(fe)}};W([p({type:Boolean})],M.prototype,"interactive",void 0);W([J("@ui5/webcomponents")],M,"i18nBundle",void 0);M=$=W([F({tag:"ui5-table-row-action-navigation"})],M);M.define();const S=G("ui5-table-row-action-navigation",[],["interactive","invisible"],[],["click"]);S.displayName="TableRowActionNavigation";try{S.displayName="TableRowActionNavigation",S.__docgenInfo={description:`The \`TableRowActionNavigation\` component defines a navigation action for table rows.
...
}`,...q.parameters?.docs?.source}}};const Ze=["Default","GrowingTable","WithSelection","VirtualizedTableRows","withRowActions","dragAndDropRows"],dt=Object.freeze(Object.defineProperty({__proto__:null,Default:N,GrowingTable:D,VirtualizedTableRows:I,WithSelection:B,__namedExportsOrder:Ze,default:Ye,dragAndDropRows:q,withRowActions:V},Symbol.toStringTag,{value:"Module"}));export{dt as C,N as D,D as G,S as T,I as V,B as W,x as a,C as b,j as c,q as d,V as w};
