import{w as C,j as e,r as u,J as D}from"./iframe-DofHecbS.js";import{L as N}from"./index-C1xP7ttJ.js";import{T as n}from"./index-BDbaktdp.js";import"./Token-BCMx04Lv.js";const o=C("ui5-tokenizer",["accessibleName","accessibleNameRef"],["disabled","multiLine","readonly","showClearAll"],[],["selection-change","token-delete"]);o.displayName="Tokenizer";try{o.displayName="Tokenizer",o.__docgenInfo={description:`A \`Tokenizer\` is an invisible container for \`Token\`s that supports keyboard navigation and token selection.
...
}`,...(k=(b=r.parameters)==null?void 0:b.docs)==null?void 0:k.source}}};const _=["Default","WithLogic"],V=Object.freeze(Object.defineProperty({__proto__:null,Default:l,WithLogic:r,__namedExportsOrder:_,default:S},Symbol.toStringTag,{value:"Module"}));export{V as C,l as D,r as W};
