...
| cancelable | bubbles |
| :--------: | :-----: |
| ❌|✅|`,name:"onLoadMore",required:!1,type:{name:"(event: Ui5CustomEvent<ListDomRef, never>) => void"}}}}}catch{}const je=""+new URL("Laptop1-BiqZozDV.jpg",import.meta.url).href,Ue=""+new URL("Laptop2-CLTht4yo.jpg",import.meta.url).href,Fe=""+new URL("PC1-BekXrNHY.jpg",import.meta.url).href,$e=""+new URL("PC2-DZLCUDFz.jpg",import.meta.url).href,ze={title:"Modals & Popovers / SelectDialog",component:m,argTypes:{children:{control:{disable:!0}}},args:{headerText:"Select Product",open:De},parameters:{chromatic:{delay:1e3}},tags:["package:@ui5/webcomponents","cem-module:Dialog"]},de=[{img:je,description:"LT-10",text:"Gaming Laptop"},{img:Ue,description:"LT-20",text:"Business Laptop"},{img:$e,description:"HT-10",text:"Gaming PC"},{img:Fe,description:"HT-20",text:"Business PC"}],q={render:l=>{const[S,c]=i.useState(l.open),u=()=>{c(!0)},g=v=>{c(!1),l.onClose(v)};return i.useEffect(()=>{c(l.open)},[l.open]),t.jsxs(t.Fragment,{children:[t.jsx(x,{onClick:u,children:"Open SelectDialog"}),t.jsx(m,{...l,open:S,onClose:g,children:new Array(40).fill("").map((v,a)=>{const p=de[a%4];return t.jsx(se,{selected:a===1,image:t.jsx("img",{src:p.img,alt:"Example Image"}),description:`${p.description}${a}`,text:p.text},`${p.text}${a}`)})})]})}},N={render:()=>{const[l,S]=i.useState(!1),c={"HT-102":!0,"HT-203":!0,"HT-1038":!0},[u,g]=i.useState(c),v=i.useRef(u),[a,p]=i.useState(),[U,V]=i.useState(Object.keys(c)),h=()=>{v.current=u},b=()=>{S(!0)},R=()=>{S(!1)},E=f=>{p(f.detail.value)},L=()=>{p(void 0)},k=f=>{const o=f.detail.targetItem.dataset.description;g(n=>{if(n[o]){const{[o]:D,...y}=n;return y}else return{...n,[o]:!0}})},O=()=>{g({})},w=()=>{V(Object.keys(u))},F=()=>{g(v.current)};return t.jsxs(t.Fragment,{children:[t.jsx(x,{onClick:b,children:"Open Dialog"}),t.jsx(m,{open:l,selectionMode:_.Multiple,numberOfSelectedItems:Object.keys(u).length,listProps:{onSelectionChange:k},showClearButton:!0,rememberSelections:!0,onClear:O,onConfirm:w,onClose:R,onSearchInput:E,onSearch:E,onSearchReset:L,onBeforeOpen:h,onCancel:F,children:new Array(40).fill("").map((f,o)=>{const n=de[o%4],D=`${n.description}${o}`,y=a==null?void 0:a.toLowerCase();return a&&!D.toLowerCase().includes(y)&&!n.text.toLowerCase().includes(y)?null:t.jsx(se,{image:t.jsx("img",{src:n.img,alt:"Example Image"}),description:`${n.description}${o}`,"data-description":`${n.description}${o}`,selected:u[D],text:n.text},`${n.text}${o}`)}).filter(Boolean)}),t.jsxs(ce,{children:[t.jsx(_e,{children:"Selected: "}),t.jsx(re,{children:U.join(", ")})]})]})}};var te,ne,oe;q.parameters={...q.parameters,docs:{...(te=q.parameters)==null?void 0:te.docs,source:{originalSource:`{
  render: args => {
...
}`,...(oe=(ne=q.parameters)==null?void 0:ne.docs)==null?void 0:oe.source}}};var ie,le,ae;N.parameters={...N.parameters,docs:{...(ie=N.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  render: () => {
...
}`,...(ae=(le=N.parameters)==null?void 0:le.docs)==null?void 0:ae.source}}};const He=["Default","MultiSelect"],vt=Object.freeze(Object.defineProperty({__proto__:null,Default:q,MultiSelect:N,__namedExportsOrder:He,default:ze},Symbol.toStringTag,{value:"Module"}));export{vt as C,q as D,N as M};
