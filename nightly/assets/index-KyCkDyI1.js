import{p as s,q as a,v as l,a as g,s as b,b as c,m as y,y as _,S as w,w as R}from"./withWebComponent-CatvTRGM.js";import{s as I}from"./event-Dq0fpeHi.js";import{l as N}from"./Tooltips-CHzLKGx6.js";import{P as $,K as T,c as D,D as C,i as x,b as A,F as S,W as q}from"./Keys-DoZifIQ_.js";import{v as V}from"./AriaLabelHelper-C5uDZewF.js";import{i as k}from"./i18n-DEVDpFvK.js";import{z as E,D as P,E as U}from"./i18n-defaults-NO4RLLYJ.js";import{c as z,I as B}from"./Icon-DpVcsMQ1.js";import"./favorite-Cd6jbgiu.js";import"./unfavorite-DFyJTafg.js";import{s as M}from"./parameters-bundle.css-BOSi_lPd.js";function O(o,e,i){return s`<div class="ui5-rating-indicator-root" role="slider" aria-roledescription="${a(this._ariaRoleDescription)}" aria-valuemin="0" aria-valuenow="${a(this.value)}" aria-valuemax="${a(this.max)}" aria-valuetext="${a(this.value)} of ${a(this.max)}" aria-orientation="horizontal" aria-disabled="${a(this._ariaDisabled)}" aria-readonly="${a(this.ariaReadonly)}" aria-description="${a(this._ariaDescription)}" tabindex="${a(this.effectiveTabIndex)}" @focusin="${this._onfocusin}" @focusout="${this._onfocusout}" @click="${this._onclick}" @keydown="${this._onkeydown}" title="${a(this.ratingTooltip)}" aria-label="${a(this._ariaLabel)}"><ul class="ui5-rating-indicator-list" aria-hidden="true">${z(this._stars,(t,n)=>t._id||n,(t,n)=>F.call(this,o,e,i,t,n))}</ul></div>`}function F(o,e,i,t,n){return s`${t.selected?W.call(this,o,e,i,t,n):H.call(this,o,e,i,t,n)}`}function W(o,e,i,t,n){return i?s`<li data-ui5-value="${a(t.index)}" class="ui5-rating-indicator-item ui5-rating-indicator-item-sel"><${l("ui5-icon",e,i)} data-ui5-value="${a(t.index)}" name="favorite"></${l("ui5-icon",e,i)}></li>`:s`<li data-ui5-value="${a(t.index)}" class="ui5-rating-indicator-item ui5-rating-indicator-item-sel"><ui5-icon data-ui5-value="${a(t.index)}" name="favorite"></ui5-icon></li>`}function H(o,e,i,t,n){return s`${t.halfStar?L.call(this,o,e,i,t,n):G.call(this,o,e,i,t,n)}`}function L(o,e,i,t,n){return i?s`<li class="ui5-rating-indicator-item ui5-rating-indicator-item-half"><${l("ui5-icon",e,i)} data-ui5-value="${a(t.index)}" name="unfavorite"></${l("ui5-icon",e,i)}><div class="ui5-rating-indicator-half-icon-wrapper"><${l("ui5-icon",e,i)} data-ui5-value="${a(t.index)}" name="favorite" class="ui5-rating-indicator-half-icon"></${l("ui5-icon",e,i)}></div></li>`:s`<li class="ui5-rating-indicator-item ui5-rating-indicator-item-half"><ui5-icon data-ui5-value="${a(t.index)}" name="unfavorite"></ui5-icon><div class="ui5-rating-indicator-half-icon-wrapper"><ui5-icon data-ui5-value="${a(t.index)}" name="favorite" class="ui5-rating-indicator-half-icon"></ui5-icon></div></li>`}function G(o,e,i,t,n){return s`${this.readonly?j.call(this,o,e,i,t,n):K.call(this,o,e,i,t,n)}`}function j(o,e,i,t,n){return i?s`<li class="ui5-rating-indicator-item ui5-rating-indicator-item-unsel"><${l("ui5-icon",e,i)} data-ui5-value="${a(t.index)}" name="favorite"></${l("ui5-icon",e,i)}></li>`:s`<li class="ui5-rating-indicator-item ui5-rating-indicator-item-unsel"><ui5-icon data-ui5-value="${a(t.index)}" name="favorite"></ui5-icon></li>`}function K(o,e,i,t,n){return s`${this.disabled?X.call(this,o,e,i,t,n):Y.call(this,o,e,i,t,n)}`}function X(o,e,i,t,n){return i?s`<li class="ui5-rating-indicator-item ui5-rating-indicator-item-unsel"><${l("ui5-icon",e,i)} data-ui5-value="${a(t.index)}" name="favorite"></${l("ui5-icon",e,i)}></li>`:s`<li class="ui5-rating-indicator-item ui5-rating-indicator-item-unsel"><ui5-icon data-ui5-value="${a(t.index)}" name="favorite"></ui5-icon></li>`}function Y(o,e,i,t,n){return i?s`<li data-ui5-value="${a(t.index)}" class="ui5-rating-indicator-item ui5-rating-indicator-item-unsel"><${l("ui5-icon",e,i)} data-ui5-value="${a(t.index)}" name="unfavorite"></${l("ui5-icon",e,i)}></li>`:s`<li data-ui5-value="${a(t.index)}" class="ui5-rating-indicator-item ui5-rating-indicator-item-unsel"><ui5-icon data-ui5-value="${a(t.index)}" name="unfavorite"></ui5-icon></li>`}g("@ui5/webcomponents-theming","sap_horizon",async()=>b);g("@ui5/webcomponents","sap_horizon",async()=>M);const J={packageName:"@ui5/webcomponents",fileName:"themes/RatingIndicator.css.ts",content:`:host(:not([hidden])){display:inline-block;font-size:24px;margin:var(--_ui5-v2-3-0_rating_indicator_component_spacing);cursor:pointer}:host([disabled]){opacity:.4;cursor:initial;outline:none}:host([readonly]){cursor:initial}:host([disabled]) .ui5-rating-indicator-item-unsel,:host([readonly]) .ui5-rating-indicator-item-unsel{padding-inline:var(--_ui5-v2-3-0_rating_indicator_readonly_item_spacing);width:var(--_ui5-v2-3-0_rating_indicator_readonly_item_width);height:var(--_ui5-v2-3-0_rating_indicator_readonly_item_height)}:host(:not([readonly]):not([disabled])) .ui5-rating-indicator-root:hover{opacity:.9}:host([_focused]){outline:var(--sapContent_FocusWidth) var(--sapContent_FocusStyle) var(--sapContent_FocusColor);outline-offset:var(--_ui5-v2-3-0_rating_indicator_outline_offset);border-radius:var(--_ui5-v2-3-0_rating_indicator_border_radius)}[ui5-icon]{display:flex;text-shadow:var(--sapContent_TextShadow)}.ui5-rating-indicator-root{outline:none;position:relative}.ui5-rating-indicator-list{list-style-type:none;display:flex;align-items:center;margin:0;padding:0}.ui5-rating-indicator-item{position:relative;width:var(--_ui5-v2-3-0_rating_indicator_item_width);height:var(--_ui5-v2-3-0_rating_indicator_item_height)}.ui5-rating-indicator-item:not(:last-child){margin-inline-end:.1875rem}.ui5-rating-indicator-item [ui5-icon]{width:100%;height:100%;color:inherit;user-select:none}.ui5-rating-indicator-item.ui5-rating-indicator-item-sel{color:var(--sapContent_RatedColor)}.ui5-rating-indicator-item.ui5-rating-indicator-item-unsel,.ui5-rating-indicator-item.ui5-rating-indicator-item-half{color:var(--sapContent_UnratedColor)}.ui5-rating-indicator-item [ui5-icon].ui5-rating-indicator-half-icon{position:absolute;inset-inline-start:50%;color:var(--sapContent_RatedColor)}.ui5-rating-indicator-half-icon-wrapper{width:100%;height:100%;position:absolute;inset-inline-start:-50%;top:0;z-index:32;overflow:hidden}
`};var u=function(o,e,i,t){var n=arguments.length,d=n<3?e:t===null?t=Object.getOwnPropertyDescriptor(e,i):t,h;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")d=Reflect.decorate(o,e,i,t);else for(var m=o.length-1;m>=0;m--)(h=o[m])&&(d=(n<3?h(d):n>3?h(e,i,d):h(e,i))||d);return n>3&&d&&Object.defineProperty(e,i,d),d},f;let r=f=class extends w{constructor(){super(),this.value=0,this.max=5,this.disabled=!1,this.readonly=!1,this.required=!1,this._stars=[],this._focused=!1}onBeforeRendering(){this.calcState()}calcState(){this._stars=[];for(let e=1;e<this.max+1;e++){const i=Math.round((this.value-Math.floor(this.value))*10);let t=!1,n=this.value;Math.floor(this.value)+1===e&&i>2&&i<8?t=!0:i<=2?n=Math.floor(this.value):i>=8&&(n=Math.ceil(this.value)),this._stars.push({selected:e<=n,index:e,halfStar:t})}}_onclick(e){const i=e.target;if(!(i instanceof HTMLElement)||this.disabled||this.readonly)return;const t=i.getAttribute("data-ui5-value");t!==null&&(this.value=parseInt(t),this.value===1&&this._liveValue===1&&(this.value=0),this._liveValue!==this.value&&(this.fireEvent("change"),this._liveValue=this.value))}_onkeydown(e){if(this.disabled||this.readonly){e.preventDefault();return}const i=$(e)||T(e),t=D(e)||C(e),n=x(e)||A(e),d=S(e),h=q(e),m=e.keyCode>=48&&e.keyCode<=57||e.keyCode>=96&&e.keyCode<=105;if(i||t||n||d||h||m){if(e.preventDefault(),i&&this.value>0)this.value=Math.round(this.value-1);else if(t&&this.value<this.max)this.value=Math.round(this.value+1);else if(n){const p=Math.round(this.value+1);this.value=p>this.max?0:p}else if(d)this.value=0;else if(h)this.value=this.max;else if(m){const p=parseInt(e.key);this.value=p>this.max?this.max:p}this.fireEvent("change")}}_onfocusin(){this.disabled||(this._focused=!0,this._liveValue=this.value)}_onfocusout(){this._focused=!1}get effectiveTabIndex(){const e=this.getAttribute("tabindex");return this.disabled?"-1":e||"0"}get ratingTooltip(){return this.tooltip?this.tooltip:N()?this.defaultTooltip:void 0}get defaultTooltip(){return f.i18nBundle.getText(E)}get _ariaRoleDescription(){return f.i18nBundle.getText(P)}get _ariaDisabled(){return this.disabled||void 0}get _ariaLabel(){return V(this)}get _ariaDescription(){return this.required?f.i18nBundle.getText(U):void 0}get ariaReadonly(){return this.readonly?"true":void 0}};u([c({type:Number})],r.prototype,"value",void 0);u([c({type:Number})],r.prototype,"max",void 0);u([c({type:Boolean})],r.prototype,"disabled",void 0);u([c({type:Boolean})],r.prototype,"readonly",void 0);u([c()],r.prototype,"accessibleName",void 0);u([c()],r.prototype,"accessibleNameRef",void 0);u([c({type:Boolean})],r.prototype,"required",void 0);u([c()],r.prototype,"tooltip",void 0);u([c({type:Array})],r.prototype,"_stars",void 0);u([c({type:Boolean})],r.prototype,"_focused",void 0);u([k("@ui5/webcomponents")],r,"i18nBundle",void 0);r=f=u([y({tag:"ui5-rating-indicator",languageAware:!0,renderer:_,styles:J,template:O,dependencies:[B]}),I("change")],r);r.define();const v=R("ui5-rating-indicator",["accessibleName","accessibleNameRef","max","tooltip","value"],["disabled","readonly","required"],[],["change"]);v.displayName="RatingIndicator";try{v.displayName="RatingIndicator",v.__docgenInfo={description:`The Rating Indicator is used to display a specific number of icons that are used to rate an item.
