import{j as e}from"./useIsomorphicLayoutEffect-dLBi2t77.js";import{a as H,b as h,c as A,T as o}from"./index-mTNYQ1A1.js";import{h as x,j as S,f,s as M,m as E,k as L,I as W,H as w,w as U}from"./withWebComponent-_WQ2NUTk.js";import{f as _}from"./Icon-F4CTdRe4.js";import{a as B}from"./add-DR-GBXr-.js";import{e as G}from"./employee-B3bmkxqw.js";import{s as J}from"./settings-DZ4G1n00.js";import{_ as K}from"./iframe-hZ9PAetX.js";import{l as i}from"./if-defined-B1auRMLy.js";import{o as q}from"./class-map-BevVk84l.js";import{s as v}from"./style-map-BtPMqoOr.js";import{s as R}from"./parameters-bundle.css-P4kwt3kq.js";function Q(t,a,n){return x`<div id="${i(this._id)}" role="separator" class="${q(this.classes.root)}" .realTabReference="${i(this)}"></div>`}function X(t,a,n){return n?x`<${S("ui5-li-custom",a,n)} id="${i(this._id)}" role="separator" class="${q(this.classes.root)}" disabled style="${v(this._forcedStyleInOverflow)}" .realTabReference="${i(this)}"></${S("ui5-li-custom",a,n)}>`:x`<ui5-li-custom id="${i(this._id)}" role="separator" class="${q(this.classes.root)}" disabled style="${v(this._forcedStyleInOverflow)}" .realTabReference="${i(this)}"></ui5-li-custom>`}f("@ui5/webcomponents-theming","sap_horizon",async()=>M);f("@ui5/webcomponents","sap_horizon",async()=>R);const Y={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInStrip.css.ts",content:`div.ui5-tc__separator{position:relative;width:.5625rem}div.ui5-tc__separator:before{content:" ";position:absolute;width:.0625rem;left:.25rem;top:.5rem;bottom:.5rem;background:var(--sapGroup_TitleBorderColor)}
