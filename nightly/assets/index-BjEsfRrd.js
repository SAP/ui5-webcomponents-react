import{w as n}from"./iframe-C-EBr6B5.js";const e=n("ui5-li-group",["headerAccessibleName","headerText","wrappingType"],[],["header"],["move-over","move"]);e.displayName="ListItemGroup";try{e.displayName="ListItemGroup",e.__docgenInfo={description:`The \`ListItemGroup\` is a special list item, used only to create groups of list items.
