import{r as m,j as e,I as f,T as I,J as a,Q as i}from"./iframe-BaUS3k1G.js";import{b,c as P,U as n,a as s}from"./action-settings-IU6EEeaQ.js";import{S as w}from"./index-DzaTfk11.js";import{A as T}from"./index-BVDlh8LB.js";import{U as L,a as R,b as y}from"./index-_9rVq8Zo.js";import{L as t}from"./index-DCjJA-51.js";import{P as p}from"./index-CkCW2Ijd.js";import{L as C}from"./index-CmvusNlc.js";import{L as d}from"./index-DNH4Ez_N.js";import{C as S}from"./index-DqvL999O.js";import{C as M,a as l}from"./index-D3ER6B4N.js";import{R as j}from"./index-UZqLq6pV.js";const B={title:"Modals & Popovers / UserSettingsDialog",component:b,argTypes:{children:{control:{disable:!0}},fixedItems:{control:{disable:!0}}},args:{},tags:["package:@ui5/webcomponents","experimental"]},c={render(o){const h=m.useRef(null),[v,g]=m.useState(!1),[A,x]=m.useState(o.open),U=r=>{const{settings:u}=r.detail.item.dataset;u&&x(!0)};return m.useEffect(()=>{x(o.open)},[o.open]),e.jsxs(e.Fragment,{children:[e.jsx(w,{primaryTitle:"Corporate Portal",logo:e.jsx("img",{src:"https://sap.github.io/ui5-webcomponents/images/sap-logo-svg.svg",alt:"SAP Logo"}),profile:e.jsx(T,{children:e.jsx("img",{src:"https://sap.github.io/ui5-webcomponents/images/avatars/woman_avatar_3.png",alt:"Avatar of the current user"})}),onProfileClick:r=>{h.current.opener=r.detail.targetRef,h.current.open=!0,g(u=>!u)}}),e.jsx(L,{ref:h,open:v,accounts:e.jsx(y,{avatarSrc:"https://sap.github.io/ui5-webcomponents/images/avatars/woman_avatar_3.png",titleText:"Alaina Chevalier",subtitleText:"aliana.chevalier@sap.com",description:"Delivery Manager, SAP SE",selected:!0}),onClose:()=>{g(!1)},onItemClick:U,children:e.jsx(R,{icon:P,text:"Settings","data-settings":"true"})}),e.jsxs(b,{...o,open:A,onClose:r=>{o.onClose(r),x(!1)},children:[e.jsx(n,{icon:"user-settings",text:"User Account",tooltip:"User Account",headerText:"User Account",pages:e.jsx(e.Fragment,{children:e.jsxs(s,{children:[e.jsx(f,{name:"person-placeholder"}),e.jsx(I,{level:"H3",size:"H3",className:"ua-name",children:"Alain Chevalier"}),e.jsxs("div",{className:"container",children:[e.jsxs("div",{className:"ua-info-item",children:[e.jsx(t,{for:"name",children:"Name:"}),e.jsx(a,{children:"Alain Chevalier"})]}),e.jsxs("div",{className:"ua-info-item",children:[e.jsx(t,{for:"email",children:"Email:"}),e.jsx(a,{children:"alian.chevalier@sap.com"})]}),e.jsxs("div",{className:"ua-info-item",children:[e.jsx(t,{for:"server",children:"Server:"}),e.jsx(a,{children:"delivery-001.sap.com"})]})]}),e.jsx(t,{for:"reset-all-button",children:"Personalization"}),e.jsx("br",{}),e.jsx(i,{children:"Reset All Personalization"}),e.jsx(p,{fixed:!0,className:"ua-panel",children:e.jsx(a,{children:"Reset your personalization settings for the launchpad (such as theme, language, user activities, and home page content)."})})]})})}),e.jsxs(n,{icon:"palette",text:"Appearance",tooltip:"Appearance",headerText:"Appearance",children:[e.jsxs(s,{text:"Themes",children:[e.jsxs(C,{separators:"Inner",children:[e.jsx(d,{icon:"palette",text:"SAP Morning Horizon"}),e.jsx(d,{icon:"palette",text:"SAP Evening Horizon"}),e.jsx(d,{icon:"palette",text:"SAP High Contrast Black (SAP Horizon)"}),e.jsx(d,{icon:"palette",text:"SAP High Contrast White (SAP Horizon)"})]}),e.jsx(i,{className:"save-btn",design:"Emphasized",children:"Save"})]}),e.jsxs(s,{text:"Display settings",children:[e.jsx(S,{checked:!0,text:"Optimized for Touch Input"}),e.jsx(p,{fixed:!0,children:e.jsx(t,{children:"Increases the size and spacing of controls to allow you to interact with them more easily using your fingertip. This is useful for hybrid devices that combine touch and mouse events."})})]})]}),e.jsx(n,{text:"Language & Region",tooltip:"Language & Region",headerText:"Language & Region",pages:e.jsxs(s,{children:[e.jsxs("div",{className:"us-container",children:[e.jsxs("div",{className:"lr-item",children:[e.jsx(t,{children:"Language and Region:"}),e.jsxs(M,{placeholder:"Language",children:[e.jsx(l,{text:"Browse Language"}),e.jsx(l,{text:"English"}),e.jsx(l,{text:"European Spanish"}),e.jsx(l,{text:"French (France)"}),e.jsx(l,{text:"Germany"})]})]}),e.jsxs("div",{className:"lr-item",children:[e.jsx(t,{for:"format",children:"Date Format:"}),e.jsx(a,{children:"MMM d, y"})]})]}),e.jsx(p,{fixed:!0,children:e.jsx(t,{children:`The time zone will not be applied in UI5 apps. If you don't know the type of an app, you can check it in the "About" dialog in the "ID of the Application Framework” field.`})}),e.jsx("br",{}),e.jsxs("div",{className:"lt-time-format",children:[e.jsx(t,{for:"timeFormat",children:"Time Format:"}),e.jsx(j,{name:"timeFormat",text:"12h"}),e.jsx(j,{checked:!0,name:"timeFormat",text:"24h"})]}),e.jsx(p,{fixed:!0,children:e.jsx(t,{children:"After you save your settings, the browser will refresh for the new settings to take effect."})})]})}),e.jsxs(n,{icon:"iphone",text:"SAP Mobile Start Application",tooltip:"SAP Mobile Start Application",headerText:"SAP Mobile Start Application",children:[e.jsxs(s,{slot:"pages",children:[e.jsx(i,{children:"iOS"}),e.jsx(i,{children:"Android"})]}),e.jsxs(s,{slot:"pages",text:"Inner Page",secondary:!0,children:[e.jsx(a,{children:"Enable access to your site from the SAP Mobile Start application."}),e.jsx(i,{children:"Install"}),e.jsx(i,{children:"Register"}),e.jsx(a,{children:"Scan the QR Code to install the mobile application"}),e.jsx(f,{name:"qr-code",style:{width:"20rem",height:"20rem"}})]})]}),e.jsx(n,{icon:"bell",text:"Notifications",tooltip:"Notifications",headerText:"Notifications",children:e.jsx(s,{slot:"pages",children:e.jsx(S,{checked:!0,text:"Show High-Priority Notification Alerts"})})}),e.jsxs(n,{icon:"reset",slot:"fixedItems",text:"Reset Settings",tooltip:"Reset Settings",headerText:"Reset Settings",children:[e.jsx(s,{text:"Reset Personalization",children:e.jsx(i,{children:"Reset Personalization content"})}),e.jsx(s,{text:"Reset All Settings",children:e.jsx(i,{children:"Reset All Settings content"})})]})]})]})}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  render(args) {
