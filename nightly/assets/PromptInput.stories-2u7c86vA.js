import{f as m,c as r,c1 as g,O as y,d as S,s as o,p as v,ab as _,m as N,aS as f,a4 as A,aQ as x,aT as I,w as P,A as C}from"./iframe-C-EBr6B5.js";import{d as T,P as D,a as E}from"./parameters-bundle.css-Chce_F9i.js";import{I as q}from"./Input-Ds_HDP4O.js";import{p as V}from"./paper-plane-C05qekUe.js";import{p as w}from"./i18n-DCXZOGva.js";function M(){return m("div",{class:"ai-prompt-input-wrapper",children:[this.label&&r(g,{for:"input",children:this.label}),m("div",{class:"ai-prompt-input-form-wrapper",children:[m("div",{class:"ai-prompt-inner-input-wrapper",children:[m(q,{id:"input",value:this.value,placeholder:this.placeholder,valueState:this.valueState,showClearIcon:this.showClearIcon,disabled:this.disabled,readonly:this.readonly,showSuggestions:this.showSuggestions,onKeyDown:this._onkeydown,onInput:this._onInnerInput,onChange:this._onInnerChange,onTypeAhead:this._onTypeAhead,children:[r("slot",{}),this.valueStateMessage.length>0&&r("slot",{name:"valueStateMessage",slot:"valueStateMessage"})]}),this.showExceededText&&r(g,{class:"ai-prompt-input-counter",children:this._exceededText})]}),r(y,{icon:V,disabled:this._submitButtonDisabled,class:"ai-prompt-input-button",design:"Emphasized",onClick:this._onButtonClick})]})]})}w("@ui5/webcomponents-theming","sap_horizon",async()=>S);w("@ui5/webcomponents-ai","sap_horizon",async()=>T);const R=`.ai-prompt-input-button{margin-left:.5rem;margin-top:3px}.ai-prompt-input-wrapper{display:flex;flex-direction:column;width:270px}.ai-prompt-input-form-wrapper{display:flex;flex:1}.ai-prompt-input-counter{font-size:.75rem;align-self:flex-end}#input{width:100%}.ai-prompt-inner-input-wrapper{display:flex;flex-direction:column;flex:1}
