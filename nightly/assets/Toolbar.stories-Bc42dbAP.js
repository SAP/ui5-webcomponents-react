import{j as e}from"./jsx-runtime-CLpGMVip.js";import{B as n}from"./Button-D2qpVKd_.js";import"./withWebComponent-BAC46Qgl.js";import{r as Z}from"./Icon-KwQmOmwG.js";import{m as ee}from"./i18n-defaults-CUGG7UPM.js";import{e as h}from"./ListItemTemplate-BIBE7761.js";import{f as b}from"./favorite-BGM_59SD.js";import{s as te}from"./settings-COqQsmgw.js";import{B as o}from"./index-H87Uqpad.js";import{D as le}from"./index-DgdNNY1x.js";import{I as N}from"./index-ChvoqC4M.js";import{I as ne}from"./index-BF3N10Og.js";import{M as re}from"./index-3eo_bU_Z.js";import{M as I}from"./index-DCtiyzFa.js";import{S as ce}from"./index-CTOgNVuE.js";import{S as ue}from"./index-Bjho_ZGy.js";import{S as oe}from"./index-CeWfCA5e.js";import{T as u}from"./index-f_HIS5b8.js";import{T as S}from"./index-BntX-uEF.js";import{r as m}from"./index-CjmQ2z5u.js";import{u as ae,a as i,b as pe,c as de,T as A}from"./index-B2y-hwJi.js";import{c as me}from"./clsx-B-dksMZM.js";import{u as he}from"./useStylesheet-HR5-WzWz.js";const be="download",fe="M280 374q-10 10-21 10-1 0-7.5-.5T235 374L133 273q-6-6-6-12t6-11q6-6 11-6 6 0 11 6l85 85V16q0-16 16-16t16 16v321l87-87q6-6 11-6 6 0 12 6t6 12q0 5-6 11zm200 74q13 0 22.5 9.5T512 480q0 14-9.5 23t-22.5 9H32q-14 0-23-9t-9-23q0-13 9-22.5t23-9.5h448z",ve=!1,ge=ee,ye="SAP-icons-v4",we="@ui5/webcomponents-icons";Z(be,{pathData:fe,ltr:ve,accData:ge,collection:ye,packageName:we});const Te="download",xe="M123 261q-8-8-8-18 0-11 7.5-18t18.5-7 18 7l71 72V26q0-11 7.5-18.5T256 0t18.5 7.5T282 26v271l71-72q7-7 18-7t18.5 7 7.5 18q0 10-8 18L274 377q-9 7-18 7t-18-7zm363 200q11 0 18.5 7t7.5 18-7.5 18.5T486 512H26q-11 0-18.5-7.5T0 486t7.5-18 18.5-7h460z",Be=!1,Se=ee,Ne="SAP-icons-v5",De="@ui5/webcomponents-icons";Z(Te,{pathData:xe,ltr:Be,accData:Se,collection:Ne,packageName:De});const se="download",p=m.forwardRef((t,a)=>{const{children:s,...l}=t,{inPopover:r}=ae();return e.jsx(o,{...l,ref:a,children:r?s:""})});p.displayName="OverflowToolbarButton";try{p.displayName="OverflowToolbarButton",p.__docgenInfo={description:"The `OverflowToolbarButton` represents a push button that shows its text only when in the overflow area of a `Toolbar`.\n\n__Note:__ This component is only compatible with the `Toolbar` component from the `@ui5/webcomponents-react-compat` package.",displayName:"OverflowToolbarButton",props:{children:{defaultValue:null,description:"Defines the text of the component which is only visible in the overflow area of a `Toolbar`.\n\n**Note:** Although this slot accepts HTML Elements, it is strongly recommended that you only use text in order to preserve the intended design.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},icon:{defaultValue:null,description:`Defines the icon to be displayed as graphical element within the component. The SAP-icons font provides numerous options.
...
**Note:** Available since [v2.5.0](https://github.com/SAP/ui5-webcomponents/releases/tag/v2.5.0) of **@ui5/webcomponents**.`,name:"accessibleDescription",required:!1,type:{name:"string"}},disabled:{defaultValue:{value:"false"},description:`Defines whether the component is disabled.
A disabled component can't be pressed or
focused, and it is not in the tab chain.`,name:"disabled",required:!1,type:{name:"boolean"}},endIcon:{defaultValue:{value:"undefined"},description:"Defines the icon, displayed as graphical element within the component after the button text.\n\n**Note:** It is highly recommended to use `endIcon` property only together with `icon` and/or `text` properties.\nUsage of `endIcon` only should be avoided.\n\nThe SAP-icons font provides numerous options.\n\nExample:\nSee all the available icons within the [Icon Explorer](https://sdk.openui5.org/test-resources/sap/m/demokit/iconExplorer/webapp/index.html).",name:"endIcon",required:!1,type:{name:"string"}},pressed:{defaultValue:{value:"false"},description:"Determines whether the component is displayed as pressed.",name:"pressed",required:!1,type:{name:"boolean"}}}}}catch{}const Ae="@layer ui5-webcomponents-react{._separator_1lvhp_1{background:var(--sapToolbar_SeparatorColor);height:var(--_ui5wcr-ToolbarSeparatorHeight);width:.0625rem}}",Ie={separator:"_separator_1lvhp_1"},c=m.forwardRef((t,a)=>{const{style:s,className:l,...r}=t;he(Ae,c.displayName);const D=me(Ie.separator,l);return e.jsx("div",{ref:a,style:s,className:D,role:"separator",...r})});c.displayName="ToolbarSeparator";try{c.displayName="ToolbarSeparator",c.__docgenInfo={description:"Creates a visual separator between the preceding and succeeding `Toolbar` item.\n\n__Note:__ This component is only compatible with the `Toolbar` component from the `@ui5/webcomponents-react-compat` package.",displayName:"ToolbarSeparator",props:{style:{defaultValue:null,description:`Element style which will be appended to the most outer element of a component.
...
}`,...(k=(q=f.parameters)==null?void 0:q.docs)==null?void 0:k.source}}};var O,j,P;v.parameters={...v.parameters,docs:{...(O=v.parameters)==null?void 0:O.docs,source:{originalSource:`{
...
}`,...(Y=(X=B.parameters)==null?void 0:X.docs)==null?void 0:Y.source}}};const qe=["Default","RightAlignedItems","EvenlyAlignedItems","WithSeparator","PopoverInOverflowPopover","WithOverflowButton","OverflowBtns","CustomOverflowButton"],et=Object.freeze(Object.defineProperty({__proto__:null,CustomOverflowButton:B,Default:f,EvenlyAlignedItems:g,OverflowBtns:x,PopoverInOverflowPopover:w,RightAlignedItems:v,WithOverflowButton:T,WithSeparator:y,__namedExportsOrder:qe,default:_e},Symbol.toStringTag,{value:"Module"}));export{et as C,f as D,g as E,x as O,w as P,v as R,c as T,y as W,T as a,B as b,p as c,d};
