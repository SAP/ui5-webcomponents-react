import{c as $e,s as Ue,a as Xe,t as Ge,l as Je}from"./DemoProps-BXtrSXe3.js";import{j as a}from"./jsx-runtime-D6fbYt3N.js";import{T as j}from"./ThemingParameters-B358vlzA.js";import{e as Qe}from"./index-C-Zfmu7Z.js";import{r as z}from"./index-DysCNOs_.js";import{d as Ze,C as ve,u as et,t as tt,a as at,b as ot,c as nt,e as we}from"./staticProps-CjOJWtKM.js";import{u as rt,B as st}from"./useCancelAnimationFallback-tZ7KVkvV.js";import{u as it,a as lt,C as ct,X as E,c as F,Y as dt,b as ht}from"./YAxisTicks-Ejc0Kn0E.js";import{u as ut,C as mt}from"./ChartDataLabel-BS-byyEH.js";import{g as pt,u as gt,a as ft,r as yt,b as Y}from"./useTooltipFormatter-CTnmLa8U.js";import{u as bt}from"./useOnClickInternal-D3NUJALO.js";import{r as Ct,B as vt,g as wt,t as kt,s as xt,R as At,T as St,v as Dt}from"./ChartContainer-DyjUDeTv.js";import{C as _t}from"./react-content-loader.es-DGUccsgf.js";import{j as Lt}from"./withWebComponent-D2290JWW.js";import{u as jt}from"./useIsRTL-B7wlz2ZX.js";const It=(o,c,u="")=>z.useMemo(()=>{let d=Array(c.length).fill(0),s=0;if(o instanceof Array&&c){const I=i=>c.map(l=>l.formatter(ve.getValueByDataKey(i,l.accessor,"")));o.map(I).forEach(i=>{i.forEach((l,A)=>{d[A]=Math.max(pt(l),d[A])})}),d=d.map(i=>Math.min(Ze,i)),s=d.reduce((i,l)=>i+l,0)}return u==="middle"?[d,{width:"auto"}]:[d,{marginLeft:s,maxWidth:`calc(100% - ${s+8}px)`}]},[o,c,u]),Vt=()=>a.jsxs(_t,{viewBox:"0 0 165 145",preserveAspectRatio:"xMidYMid meet",width:"100%",height:"100%",speed:2,backgroundColor:j.sapContent_ImagePlaceholderBackground,foregroundColor:j.sapContent_ImagePlaceholderForegroundColor,backgroundOpacity:j.sapContent_DisabledOpacity,children:[a.jsx("rect",{x:"20",y:"10",width:"1",height:"135"}),a.jsx("rect",{x:"20",y:"20",width:"85",height:"15"}),a.jsx("rect",{x:"20",y:"40",width:"117",height:"15"}),a.jsx("rect",{x:"20",y:"60",width:"67",height:"15"}),a.jsx("rect",{x:"20",y:"80",width:"75",height:"15"}),a.jsx("rect",{x:"20",y:"100",width:"125",height:"15"}),a.jsx("rect",{x:"20",y:"120",width:"60",height:"15"})]}),Pt={formatter:we},Tt={formatter:we,opacity:1},qt=o=>({payload:c})=>ve.getValueByDataKey(c,o),m=z.forwardRef((o,c)=>{var W,N;const{loading:u,loadingDelay:d,dataset:s,noLegend:I,noAnimation:V,tooltipConfig:i,onDataPointClick:l,onLegendClick:A,onClick:B,style:ke,className:xe,slot:Ae,syncId:Se,ChartPlaceholder:De,children:_e,...Le}=o,t={margin:{},yAxisVisible:!0,xAxisVisible:!0,gridStroke:j.sapList_BorderColor,gridHorizontal:!0,gridVertical:!1,legendPosition:"bottom",legendHorizontalAlign:"left",barGap:3,zoomingTool:!1,resizeDebounce:250,yAxisConfig:{},xAxisConfig:{},secondXAxisConfig:{},...o.chartConfig},n=t.referenceLine,{dimensions:P,measures:S}=gt(o.dimensions,o.measures,Pt,Tt),je=ft(S),h=P[0],{primaryMeasure:D,secondaryMeasure:Ie}=yt(S,(W=t==null?void 0:t.secondYAxis)==null?void 0:W.dataKey),Ve=S.map(({accessor:e})=>e),T=t.secondYAxis?Ve.findIndex(e=>{var r;return e===((r=t.secondYAxis)==null?void 0:r.dataKey)}):0,[Pe,O]=Lt(c),Te=et(A),qe=ut(h),ze=z.useCallback((e,r,_)=>{if(e&&l){const L=e.value.length?e.value[1]-e.value[0]:e.value;l(Qe(_,{dataKey:Object.keys(e).filter(q=>q!=="value").find(q=>e[q]===L),value:L,payload:e.payload,dataIndex:r}))}},[l]),Be=bt(B),Oe=(s==null?void 0:s.length)>30,Re=h==null?void 0:h.accessor,[We,Ne]=It(s,P,t.legendPosition),Ee=it(t.margin,t.zoomingTool),[Fe]=lt(O,1),R=jt(O),{isMounted:Ye,handleBarAnimationStart:Me,handleBarAnimationEnd:Ke}=rt(V),{chartConfig:Ot,dimensions:Rt,measures:Wt,...He}=Le;return a.jsx(Ct,{dataset:s,loading:u,loadingDelay:d,Placeholder:De??Vt,ref:Pe,style:ke,className:xe,slot:Ae,resizeDebounce:t.resizeDebounce,...He,children:a.jsxs(st,{syncId:Se,onClick:Be,stackOffset:"sign",margin:Ee,layout:"vertical",data:s,barGap:t.barGap,accessibilityLayer:t.accessibilityLayer,className:typeof l=="function"||typeof B=="function"?"has-click-handler":void 0,children:[a.jsx(ct,{vertical:t.gridVertical,horizontal:t.gridHorizontal,stroke:t.gridStroke}),t.xAxisVisible&&a.jsx(E,{interval:0,type:"number",tick:a.jsx(F,{config:D}),axisLine:t.xAxisVisible,tickLine:tt,tickFormatter:D==null?void 0:D.formatter,height:Fe,reversed:R,...t.xAxisConfig}),((N=t.secondYAxis)==null?void 0:N.dataKey)&&a.jsx(E,{dataKey:t.secondYAxis.dataKey,axisLine:{stroke:t.secondYAxis.color??`var(--sapChart_OrderedColor_${T%12+1})`},tick:a.jsx(F,{config:Ie,secondYAxisConfig:{color:t.secondYAxis.color??`var(--sapChart_OrderedColor_${T%12+1})`}}),tickLine:{stroke:t.secondYAxis.color??`var(--sapChart_OrderedColor_${T%12+1})`},label:{value:t.secondYAxis.name,offset:2,angle:90,position:"center"},orientation:"top",interval:0,xAxisId:"secondary",type:"number",...t.secondXAxisConfig}),t.yAxisVisible&&P.map((e,r)=>a.jsx(dt,{interval:(e==null?void 0:e.interval)??"preserveStartEnd",minTickGap:Oe?void 0:-10,type:"category",dataKey:e.accessor,tick:a.jsx(ht,{config:e}),tickLine:r<1,axisLine:r<1,yAxisId:r,width:We[r],allowDuplicatedCategory:r===0,orientation:R?"right":"left",...t.yAxisConfig},e.reactKey)),Ye&&S.map((e,r)=>a.jsxs(vt,{stackId:e.stackId,fillOpacity:e.opacity,name:e.label??e.accessor,strokeOpacity:e.opacity,type:"monotone",dataKey:e.accessor,fill:e.color??`var(--sapChart_OrderedColor_${r%12+1})`,stroke:e.color??`var(--sapChart_OrderedColor_${r%12+1})`,barSize:e.width,onClick:ze,isAnimationActive:!V,onAnimationStart:Me,onAnimationEnd:Ke,children:[a.jsx(wt,{data:s,valueAccessor:qt(e.accessor),content:a.jsx(mt,{config:e,chartType:"bar",position:"insideRight"})}),s.map((_,L)=>a.jsx(kt,{fill:Y(e,_,r),stroke:Y(e,_,r)},L))]},e.reactKey)),!I&&a.jsx(xt,{verticalAlign:t.legendPosition,align:t.legendHorizontalAlign,onClick:Te,wrapperStyle:Ne,...t.legendConfig}),n&&a.jsx(At,{...n,stroke:(n==null?void 0:n.color)??(n==null?void 0:n.stroke),x:(n==null?void 0:n.value)??(n==null?void 0:n.x),label:n==null?void 0:n.label}),(i==null?void 0:i.active)!==!1&&a.jsx(St,{cursor:at,formatter:je,contentStyle:ot,labelFormatter:qe,...i}),!!t.zoomingTool&&a.jsx(Dt,{dataKey:Re,tickFormatter:h==null?void 0:h.formatter,...nt,...typeof t.zoomingTool=="object"?t.zoomingTool:{}}),_e]})})});m.displayName="BarChart";try{m.displayName="BarChart",m.__docgenInfo={description:"A `BarChart` is a data visualization where each category is represented by a rectangle, with the width of the rectangle being proportional to the values being plotted.",displayName:"BarChart",props:{dimensions:{defaultValue:null,description:`An array of config objects. Each object will define one dimension of the chart.
