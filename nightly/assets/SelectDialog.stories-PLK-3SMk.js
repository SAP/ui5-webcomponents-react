...
| cancelable | bubbles |
| :--------: | :-----: |
| ❌|❌|`,name:"onClose",required:!1,type:{name:"(event: Ui5CustomEvent<DialogDomRef, never>) => void"}},initialFocus:{defaultValue:{value:"undefined"},description:"Defines the ID of the HTML Element, which will get the initial focus.\n\n**Note:** If an element with `autofocus` attribute is added inside the component,\n`initialFocus` won't take effect.",name:"initialFocus",required:!1,type:{name:"string"}},open:{defaultValue:{value:"false"},description:`Indicates if the element is open
...
| cancelable | bubbles |
| :--------: | :-----: |
| ❌|✅|`,name:"onLoadMore",required:!1,type:{name:"(event: Ui5CustomEvent<ListDomRef, never>) => void"}}}}}catch{}const Ue=""+new URL("Laptop1-BiqZozDV.jpg",import.meta.url).href,Fe=""+new URL("Laptop2-CLTht4yo.jpg",import.meta.url).href,$e=""+new URL("PC1-BekXrNHY.jpg",import.meta.url).href,ze=""+new URL("PC2-DZLCUDFz.jpg",import.meta.url).href,He={title:"Modals & Popovers / SelectDialog",component:m,argTypes:{children:{control:{disable:!0}}},args:{headerText:"Select Product",open:De},parameters:{chromatic:{delay:1e3}},tags:["package:@ui5/webcomponents","cem-module:Dialog"]},ue=[{img:Ue,description:"LT-10",text:"Gaming Laptop"},{img:Fe,description:"LT-20",text:"Business Laptop"},{img:ze,description:"HT-10",text:"Gaming PC"},{img:$e,description:"HT-20",text:"Business PC"}],q={render:l=>{const[S,p]=i.useState(l.open),a=()=>{p(!0)},g=v=>{p(!1),l.onClose(v)};return i.useEffect(()=>{p(l.open)},[l.open]),t.jsxs(t.Fragment,{children:[t.jsx(x,{onClick:a,children:"Open SelectDialog"}),t.jsx(m,{...l,open:S,onClose:g,children:new Array(40).fill("").map((v,s)=>{const u=ue[s%4];return t.jsx(re,{selected:s===1,image:t.jsx("img",{src:u.img,alt:"Example Image"}),description:`${u.description}${s}`,text:u.text},`${u.text}${s}`)})})]})}},V={render:()=>{const[l,S]=i.useState(!1),p={"HT-102":!0,"HT-203":!0,"HT-1038":!0},[a,g]=i.useState(p),v=i.useRef(a),[s,u]=i.useState(),[U,R]=i.useState(Object.keys(p)),E=()=>{v.current=a},h=()=>{S(!0)},b=()=>{S(!1)},I=_=>{u(_.detail.value)},F=()=>{u(void 0)},L=_=>{const o=_.detail.targetItem.dataset.description;g(n=>{if(n[o]){const{[o]:f,...y}=n;return y}else return{...n,[o]:!0}})},k=()=>{g({})},O=()=>{R(Object.keys(a))},w=()=>{g(v.current)};return t.jsxs(t.Fragment,{children:[t.jsx(x,{onClick:h,children:"Open Dialog"}),t.jsx(m,{open:l,selectionMode:D.Multiple,numberOfSelectedItems:Object.keys(a).length,listProps:{onSelectionChange:L},showClearButton:!0,rememberSelections:!0,onClear:k,onConfirm:O,onClose:b,onSearchInput:I,onSearch:I,onSearchReset:F,onBeforeOpen:E,onCancel:w,children:new Array(40).fill("").map((_,o)=>{const n=ue[o%4],f=`${n.description}${o}`,y=s==null?void 0:s.toLowerCase();return s&&!f.toLowerCase().includes(y)&&!n.text.toLowerCase().includes(y)?null:t.jsx(re,{image:t.jsx("img",{src:n.img,alt:"Example Image"}),description:`${n.description}${o}`,"data-description":`${n.description}${o}`,selected:a[f],text:n.text},`${n.text}${o}`)}).filter(Boolean)}),t.jsxs(de,{children:[t.jsx(xe,{children:"Selected: "}),t.jsx(ce,{children:U.join(", ")})]})]})}};var ne,oe,ie;q.parameters={...q.parameters,docs:{...(ne=q.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  render: args => {
...
}`,...(ie=(oe=q.parameters)==null?void 0:oe.docs)==null?void 0:ie.source}}};var le,ae,se;V.parameters={...V.parameters,docs:{...(le=V.parameters)==null?void 0:le.docs,source:{originalSource:`{
  render: () => {
...
}`,...(se=(ae=V.parameters)==null?void 0:ae.docs)==null?void 0:se.source}}};const We=["Default","MultiSelect"],bt=Object.freeze(Object.defineProperty({__proto__:null,Default:q,MultiSelect:V,__namedExportsOrder:We,default:He},Symbol.toStringTag,{value:"Module"}));export{bt as C,q as D,V as M};
