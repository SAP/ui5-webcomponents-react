import{w,j as e,r as v}from"./iframe-C5HYk_w9.js";import{S,a as r}from"./index-DyhhPEhS.js";import"./Search-cjNRdnaR.js";const t=w("ui5-search",["accessibleDescription","accessibleName","placeholder","value"],["loading","noTypeahead","open","showClearIcon"],["action","filterButton","illustration","messageArea","scopes"],["close","input","open","scope-change","search"]);t.displayName="Search";try{t.displayName="Search",t.__docgenInfo={description:`A \`Search\` is an input with suggestions, used for user search.
