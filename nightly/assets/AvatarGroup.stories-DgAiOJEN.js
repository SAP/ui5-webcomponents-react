import{j as p}from"./jsx-runtime-D_zvdyIk.js";import{A as m}from"./index-5xYsTlk-.js";import{p as N,d as B,j as b,h as x,s as v,m as R,y as D,B as E,e as O,w as L}from"./jsx-runtime-xa789Fx-.js";import{f as _}from"./ResizeHandler-OXK24k1p.js";import{f as z}from"./ItemNavigation-CN_qUVl5.js";import{d as S}from"./slot-_4yKMUwC.js";import{l as w}from"./event-strict-DgQLNDEV.js";import{i as P}from"./i18n-CjR4HGlq.js";import{b as W,i as y}from"./Keys-CLf_QmYW.js";import{A as r}from"./AvatarSize-BtKTMFJ5.js";import{A}from"./AvatarColorScheme-CysxkulG.js";import{aF as U,aG as V,aH as q,aI as G,aJ as H}from"./i18n-defaults-Wx6G1HAa.js";import{d as j}from"./parameters-bundle.css-D0uTR4GL.js";import{a as M}from"./Button-BAohpRXl.js";import{A as F}from"./AccessibilityTextsHelper-4hgGqLyb.js";var a;(function(i){i.Group="Group",i.Individual="Individual"})(a||(a={}));N("@ui5/webcomponents-theming","sap_horizon",async()=>B);N("@ui5/webcomponents","sap_horizon",async()=>j);const Y=`:host{-webkit-tap-highlight-color:rgba(0,0,0,0)}:host(:not([hidden])){display:block;width:100%}:host{--_ui5-v2-12-0_button_focused_border: var(--_ui5-v2-12-0_avatar_group_button_focus_border)}.ui5-avatar-group-items:focus{outline:none}:host([type="Group"][desktop]) .ui5-avatar-group-items:focus,:host([type="Group"]) .ui5-avatar-group-items:focus-visible{outline:var(--_ui5-v2-12-0_avatar_outline);outline-offset:var(--_ui5-v2-12-0_avatar_focus_offset);border-radius:var(--_ui5-v2-12-0_avatar_group_focus_border_radius)}.ui5-avatar-group-root{display:flex;padding:var(--_ui5-v2-12-0_avatar_group_padding)}.ui5-avatar-group-items{white-space:nowrap;position:relative;display:inline-flex}:host([type="Group"]) .ui5-avatar-group-items{cursor:pointer}:host([type="Group"]) ::slotted([ui5-button]),:host([type="Group"]) ::slotted([ui5-avatar]){pointer-events:none}.ui5-avatar-group-overflow-btn{overflow:visible}.ui5-avatar-group-overflow-btn::part(button){min-width:auto}::slotted([ui5-button]:not([hidden])),.ui5-avatar-group-overflow-btn:not([hidden]){--_ui5-v2-12-0_button_base_padding: 0;border-radius:50%;display:inline-flex;text-overflow:initial;z-index:0}::slotted([ui5-button][desktop]:focus),.ui5-avatar-group-overflow-btn[desktop]:focus{outline:var(--_ui5-v2-12-0_avatar_outline);outline-offset:var(--_ui5-v2-12-0_avatar_overflow_button_focus_offset)}.ui5-avatar-group-overflow-btn::part(button):focus-visible:after{outline:var(--_ui5-v2-12-0_avatar_outline);outline-offset:var(--_ui5-v2-12-0_avatar_focus_offset);border-radius:50%}.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-xs{height:2rem;width:2rem;min-width:2rem;font-size:.75rem}::slotted([ui5-button]),.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-s{height:3rem;width:3rem;min-width:3rem;font-size:1.125rem}.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-m{height:4rem;width:4rem;min-width:4rem;font-size:1.625rem}.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-l{height:5rem;width:5rem;min-width:5rem;font-size:2rem}.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-xl{height:7rem;width:7rem;min-width:7rem;font-size:2.75rem}
`;function $(){return b("div",{class:"ui5-avatar-group-root",children:x("div",{class:"ui5-avatar-group-items",role:this._role,tabindex:this._groupTabIndex,"aria-label":this._ariaLabelText,"aria-haspopup":this._containerAriaHasPopup,onClick:this._onClick,onKeyUp:this._onkeyup,onKeyDown:this._onkeydown,onFocusIn:this._onfocusin,children:[b("slot",{onClick:this.onAvatarClick,"onui5-click":this.onAvatarUI5Click}),this._customOverflowButton?b("slot",{onClick:this.onOverflowButtonClick,name:"overflowButton"}):b(M,{onClick:this.onOverflowButtonClick,accessibilityAttributes:this._overflowButtonAccAttributes,accessibleName:this._overflowButtonAriaLabelText,hidden:this._overflowBtnHidden,nonInteractive:this._isGroup,class:{"ui5-avatar-group-overflow-btn":!0,"ui5-avatar-group-overflow-btn-xs":this.firstAvatarSize===r.XS,"ui5-avatar-group-overflow-btn-s":this.firstAvatarSize===r.S,"ui5-avatar-group-overflow-btn-m":this.firstAvatarSize===r.M,"ui5-avatar-group-overflow-btn-l":this.firstAvatarSize===r.L,"ui5-avatar-group-overflow-btn-xl":this.firstAvatarSize===r.XL},children:this._overflowButtonText})]})})}var l=function(i,e,t,o){var n=arguments.length,u=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,f;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")u=Reflect.decorate(i,e,t,o);else for(var g=i.length-1;g>=0;g--)(f=i[g])&&(u=(n<3?f(u):n>3?f(e,t,u):f(e,t))||u);return n>3&&u&&Object.defineProperty(e,t,u),u},h;const k="ui5-avatar-group-overflow-btn",K=`.${k}`,X={[r.XS]:{[a.Individual]:"0.0625rem",[a.Group]:"-0.5rem"},[r.S]:{[a.Individual]:"0.125rem",[a.Group]:"-1.25rem"},[r.M]:{[a.Individual]:"0.125rem",[a.Group]:"-1.625rem"},[r.L]:{[a.Individual]:"0.125rem",[a.Group]:" -2rem"},[r.XL]:{[a.Individual]:"0.25rem",[a.Group]:"-2.75rem"}};let s=h=class extends E{constructor(){super(),this.type="Group",this.accessibilityAttributes={},this._colorIndex=0,this._hiddenItems=0,this._itemNavigation=new z(this,{getItemsCallback:()=>this._isGroup?[]:this.items.slice(0,this._hiddenStartIndex)}),this._onResizeHandler=this._onResize.bind(this)}get hiddenItems(){return this.items.slice(this._hiddenStartIndex)}get colorScheme(){return this.items.map(e=>e.effectiveBackgroundColor)}get _customOverflowButton(){return this.overflowButton.length?this.overflowButton[0]:void 0}get _ariaLabelText(){if(this.accessibleName||this.accessibleNameRef)return F(this);const e=this.hiddenItems.length,t=this._isGroup?U:V;let o=h.i18nBundle.getText(t);return o+=` ${h.i18nBundle.getText(q,this._itemsCount-e,e)}`,this._isGroup?o+=` ${h.i18nBundle.getText(G)}`:o+=` ${h.i18nBundle.getText(H)}`,o}get _overflowButtonAriaLabelText(){return this._isGroup?void 0:h.i18nBundle.getText(G)}get _containerAriaHasPopup(){return this._isGroup?this._getAriaHasPopup():void 0}get _overflowButtonAccAttributes(){return{hasPopup:this._isGroup?void 0:this._getAriaHasPopup()}}get _role(){return this._isGroup?"button":"group"}get _hiddenStartIndex(){return this._itemsCount-this._hiddenItems}get _overflowBtnHidden(){return this._hiddenItems===0}get _isGroup(){return this.type===a.Group}get _itemsCount(){return this.items.length}get _groupTabIndex(){return this._isGroup?0:-1}get _overflowButton(){return this.shadowRoot.querySelector(K)}get _overflowButtonEffectiveWidth(){const e=this._customOverflowButton?this._customOverflowButton:this._overflowButton;if(!e)return 0;if(this._isGroup){let t=this.items[1];const o=t.offsetLeft-this.offsetLeft;return(!t||t.hidden)&&(t=e),this.effectiveDir==="rtl"?this._getWidthToItem(t):o}return e.offsetWidth}get firstAvatarSize(){var e;return((e=this.items[0])==null?void 0:e.size)??r.S}onAfterRendering(){this._overflowItems()}onBeforeRendering(){this._customOverflowButton&&(this._customOverflowButton.nonInteractive=this._isGroup),this._prepareAvatars()}onEnterDOM(){O()&&this.setAttribute("desktop",""),_.register(this,this._onResizeHandler)}onExitDOM(){_.deregister(this,this._onResizeHandler)}_onResize(){this._overflowItems()}_onkeydown(e){this._isGroup&&(W(e)?this._fireGroupEvent(e.target):y(e)&&e.preventDefault())}_onkeyup(e){!e.shiftKey&&y(e)&&this._isGroup&&(this._fireGroupEvent(e.target),e.preventDefault())}_fireGroupEvent(e){const t=e.classList.contains(k)||e===this._customOverflowButton;this.fireDecoratorEvent("click",{targetRef:e,overflowButtonClicked:t})}_onClick(e){e.stopPropagation(),this._isGroup&&this._fireGroupEvent(e.target)}onAvatarClick(e){e.stopPropagation(),this.fireDecoratorEvent("click",{targetRef:e.target,overflowButtonClicked:!1})}onAvatarUI5Click(e){e.stopPropagation()}onOverflowButtonClick(e){e.stopPropagation(),this.fireDecoratorEvent("click",{targetRef:e.target,overflowButtonClicked:!0})}_prepareAvatars(){this._colorIndex=0,this.items.forEach((e,t)=>{const o=this._getNextBackgroundColor();e.interactive=!this._isGroup,e.getAttribute("_color-scheme")===A.Auto&&e.setAttribute("_color-scheme",A[`Accent${o}`]),t!==this._itemsCount-1||this._customOverflowButton?e.style.marginInlineEnd=X[e.effectiveSize][this.type]:e.style.marginInlineEnd=""})}_onfocusin(e){this._itemNavigation.setCurrentItem(e.target)}getFocusDomRef(){return this._itemNavigation._getCurrentItem()}_getWidthToItem(e){const t=this.effectiveDir==="rtl",o=e.offsetLeft-this.offsetLeft;if(t){const n=e.offsetParent;return n?n.offsetWidth-e.offsetLeft-e.offsetWidth:0}return o}_overflowItems(){if(this.items.length<2){this._setHiddenItems(0);return}let e=0;for(let t=0;t<this._itemsCount;t++){const o=this.items[t];o.hidden=!1;let n=this._getWidthToItem(o)+o.offsetWidth;if((t!==this._itemsCount-1||this._customOverflowButton)&&(n+=this._overflowButtonEffectiveWidth),n>this.offsetWidth){e=this._itemsCount-t;break}}this._setHiddenItems(e)}_getNextBackgroundColor(){return++this._colorIndex>10&&(this._colorIndex=1),this._colorIndex}_setHiddenItems(e){const t=this._hiddenItems!==e;this._hiddenItems=e,this.items.forEach((o,n)=>{o.hidden=n>=this._hiddenStartIndex}),this._overflowButtonText=`+${e>99?99:e}`,t&&this.fireDecoratorEvent("overflow")}_getAriaHasPopup(){return this.accessibilityAttributes.hasPopup}};l([v()],s.prototype,"type",void 0);l([v({type:Object})],s.prototype,"accessibilityAttributes",void 0);l([v({noAttribute:!0})],s.prototype,"_overflowButtonText",void 0);l([v()],s.prototype,"accessibleName",void 0);l([v()],s.prototype,"accessibleNameRef",void 0);l([S({type:HTMLElement,default:!0})],s.prototype,"items",void 0);l([S()],s.prototype,"overflowButton",void 0);l([P("@ui5/webcomponents")],s,"i18nBundle",void 0);s=h=l([R({tag:"ui5-avatar-group",renderer:D,template:$,styles:Y}),w("click"),w("overflow")],s);s.define();const c=L("ui5-avatar-group",["accessibilityAttributes","accessibleName","accessibleNameRef","type"],[],["overflowButton"],["click","overflow"]);c.displayName="AvatarGroup";try{c.displayName="AvatarGroup",c.__docgenInfo={description:`Displays a group of avatars arranged horizontally. It is useful to visually
...
}`,...(T=(C=d.parameters)==null?void 0:C.docs)==null?void 0:T.source}}};const Q=["Default"],fe=Object.freeze(Object.defineProperty({__proto__:null,Default:d,__namedExportsOrder:Q,default:J},Symbol.toStringTag,{value:"Module"}));export{fe as C,d as D};
