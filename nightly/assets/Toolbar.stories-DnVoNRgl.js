...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var R=function(t,e,n,a){var l=arguments.length,o=l<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,n):a,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,n,a);else for(var s=t.length-1;s>=0;s--)(r=t[s])&&(o=(l<3?r(o):l>3?r(e,n,o):r(e,n))||o);return l>3&&o&&Object.defineProperty(e,n,o),o};let w=class extends F{constructor(){super(...arguments),this.selected=!1}};R([u({type:Boolean})],w.prototype,"selected",void 0);R([j({type:Node,default:!0,invalidateOnChildChange:!0})],w.prototype,"text",void 0);w=R([S("ui5-toolbar-select-option")],w);w.define();const p=_("ui5-toolbar-select-option",[],["selected"],[],[]);p.displayName="ToolbarSelectOption";try{p.displayName="ToolbarSelectOption",p.__docgenInfo={description:"The `ToolbarSelectOption` component defines the content of an option in the `ToolbarSelect`.\n\n__Note__: This is a UI5 Web Component! [Repository](https://github.com/SAP/ui5-webcomponents) | [Documentation](https://sap.github.io/ui5-webcomponents/)",displayName:"ToolbarSelectOption",props:{children:{defaultValue:null,description:`Defines the text of the component.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function M(){return N("div",{class:"ui5-tb-separator ui5-tb-item","data-ui5-external-action-item-id":this._id})}T("@ui5/webcomponents-theming","sap_horizon",async()=>V);T("@ui5/webcomponents","sap_horizon",async()=>I);const H=`.ui5-tb-separator{height:var(--_ui5-v2-14-0-toolbar-separator-height);width:.0625rem;background:var(--sapToolbar_SeparatorColor);box-sizing:border-box}
`;var E=function(t,e,n,a){var l=arguments.length,o=l<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,n):a,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,n,a);else for(var s=t.length-1;s>=0;s--)(r=t[s])&&(o=(l<3?r(o):l>3?r(e,n,o):r(e,n))||o);return l>3&&o&&Object.defineProperty(e,n,o),o};let y=class extends x{constructor(){super(...arguments),this.visible=!1}get isSeparator(){return!0}get isInteractive(){return!1}};E([u({type:Boolean})],y.prototype,"visible",void 0);y=E([S({tag:"ui5-toolbar-separator",template:M,renderer:A,styles:[H]})],y);y.define();const f=_("ui5-toolbar-separator",["overflowPriority"],["preventOverflowClosing"],[],[]);f.displayName="ToolbarSeparator";try{f.displayName="ToolbarSeparator",f.__docgenInfo={description:`The \`ToolbarSeparator\` is an element, used for visual separation between two elements.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var U=function(t,e,n,a){var l=arguments.length,o=l<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,n):a,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,n,a);else for(var s=t.length-1;s>=0;s--)(r=t[s])&&(o=(l<3?r(o):l>3?r(e,n,o):r(e,n))||o);return l>3&&o&&Object.defineProperty(e,n,o),o};let g=class extends x{get styles(){return this.width?{width:this.width}:{flex:"auto"}}get ignoreSpace(){return this.width===""||this.width===void 0||this.width==="auto"}get hasFlexibleWidth(){return this.width===""||this.width===void 0||this.width==="auto"}get isInteractive(){return!1}};U([u()],g.prototype,"width",void 0);g=U([S({tag:"ui5-toolbar-spacer",styles:W})],g);g.define();const h=_("ui5-toolbar-spacer",["overflowPriority","width"],["preventOverflowClosing"],[],[]);h.displayName="ToolbarSpacer";try{h.displayName="ToolbarSpacer",h.__docgenInfo={description:`The \`ToolbarSpacer\` is an element, used for taking needed space for toolbar items to take 100% width.
It takes no space in calculating toolbar items width.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var D;(function(t){t.Start="Start",t.End="End"})(D||(D={}));const Q={title:"Layouts & Floorplans / Toolbar",component:P,argTypes:{children:{control:{disable:!0}}},args:{alignContent:D.Start},tags:["package:@ui5/webcomponents"]},v={render:t=>i.jsxs(P,{...t,children:[i.jsx(C,{text:"Button 1"}),i.jsxs(d,{children:[i.jsx(p,{children:"Option 1"}),i.jsx(p,{children:"Option 2"}),i.jsx(p,{children:"Option 3"})]}),i.jsx(f,{}),i.jsx(h,{}),i.jsx(f,{}),i.jsx(C,{text:"Button 2"}),i.jsxs(d,{children:[i.jsx(p,{children:"Option 1"}),i.jsx(p,{children:"Option 2"}),i.jsx(p,{children:"Option 3"})]})]})},b={name:"Opening Popovers via ToolbarButton",render(t){const[e,n]=q.useState(!1),a=q.useRef(null);return i.jsxs(i.Fragment,{children:[i.jsx(P,{...t,children:i.jsx(C,{onClick:l=>{const{targetRef:o}=l.detail;a.current&&(a.current.opener=o,n(!0))},text:"Open Popover"})}),i.jsx(k,{open:e,ref:a,onClose:()=>{n(!1)},children:"Content"})]})}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
...
}`,...b.parameters?.docs?.source}}};const G=["Default","OpenPopover"],le=Object.freeze(Object.defineProperty({__proto__:null,Default:v,OpenPopover:b,__namedExportsOrder:G,default:Q},Symbol.toStringTag,{value:"Module"}));export{le as C,v as D,b as O,d as T,p as a,f as b,h as c};
