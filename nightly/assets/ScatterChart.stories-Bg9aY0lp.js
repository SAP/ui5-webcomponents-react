import{g as ve,h as xe,t as we,l as ke}from"./DemoProps-DpAHnTHz.js";import{j as n,r as k,ap as Ae,o as T}from"./iframe-BCRKbB-F.js";import{T as A}from"./ThemingParameters-pyhX3s39.js";import{X as G,Y as Z,a as _e,u as Pe,C as Se,c as je,b as De}from"./YAxisTicks-cpjPKQk-.js";import{u as Ve,x as Te,t as Ie,a as qe,b as ze,e as Ne}from"./staticProps-CL5uldzL.js";import{u as Le}from"./useLongestYAxisLabel-DoF59uZw.js";import{u as Re,a as Ee}from"./useTooltipFormatter-ChNLwMsD.js";import{k as Oe,l as We,m as Fe,n as Be,R as I,T as He}from"./ChartContainer-C2dQXD77.js";import{C as Ue}from"./react-content-loader.es-wJYJ4Zmw.js";import{S as J,Z as Q}from"./Scatter-XoDmjtY8.js";import{u as Ye}from"./useIsRTL-CHXXP87C.js";var Ke=Oe({chartName:"ScatterChart",GraphicalChild:J,defaultTooltipEventType:"item",validateTooltipEventTypes:["item"],axisComponents:[{axisType:"xAxis",AxisComp:G},{axisType:"yAxis",AxisComp:Z},{axisType:"zAxis",AxisComp:Q}],formatAxisMap:We});const C=l=>n.jsxs(Ue,{viewBox:"0 0 165 145",preserveAspectRatio:"xMidYMid meet",width:"100%",height:"100%",speed:2,backgroundColor:A.sapContent_ImagePlaceholderBackground,foregroundColor:A.sapContent_ImagePlaceholderForegroundColor,backgroundOpacity:A.sapContent_DisabledOpacity,...l,children:[n.jsx("rect",{x:"10",y:"135",width:"135",height:"1"}),n.jsx("circle",{cx:"20",cy:"90",r:"2"}),n.jsx("circle",{cx:"40",cy:"58",r:"3"}),n.jsx("circle",{cx:"60",cy:"108",r:"14"}),n.jsx("circle",{cx:"85",cy:"87",r:"8"}),n.jsx("circle",{cx:"105",cy:"50",r:"6"}),n.jsx("circle",{cx:"125",cy:"115",r:"4"}),n.jsx("circle",{cx:"78",cy:"58",r:"10"}),n.jsx("circle",{cx:"28",cy:"115",r:"4"})]});try{C.displayName="ScatterChartPlaceholder",C.__docgenInfo={description:"",displayName:"ScatterChartPlaceholder",props:{}}}catch{}try{C.displayName="ScatterChartPlaceholder",C.__docgenInfo={description:"",displayName:"ScatterChartPlaceholder",props:{}}}catch{}const $e={formatter:Ne},h=k.forwardRef((l,X)=>{var D;const{dataset:c,loading:M,loadingDelay:ee,noLegend:te,noAnimation:ae,tooltipConfig:v,onDataPointClick:p,onLegendClick:ne,onClick:_,style:oe,className:ie,slot:se,ChartPlaceholder:re,children:le,...ce}=l,r={yAxisVisible:!1,xAxisVisible:!0,gridStroke:A.sapList_BorderColor,gridHorizontal:!0,gridVertical:!1,legendPosition:"bottom",legendHorizontalAlign:"left",zoomingTool:!1,resizeDebounce:250,...l.chartConfig},{referenceLine:o,referenceLineX:i}=r,{measures:x}=Re([],l.measures,{},$e),de=Ee(x),[he,S]=Ae(X),d=k.useRef(!1),pe=Ve(ne),ue=k.useCallback((e,u)=>{var w,V;typeof _=="function"&&!d.current&&_(T(u,{payload:(V=(w=e==null?void 0:e.activePayload)==null?void 0:w[0])==null?void 0:V.payload,activePayloads:e==null?void 0:e.activePayload})),d.current&&(d.current=!1)},[_,d.current]),me=k.useCallback((e,u,w)=>{e&&p&&(p(T(w,{value:e.node,dataKey:e.zAxis.dataKey,dataIndex:u,payload:e.payload})),d.current=!0)},[p,d.current]),fe=(c==null?void 0:c.length)>30,a=x.find(({axis:e})=>e==="x"),t=x.find(({axis:e})=>e==="y"),s=x.find(({axis:e})=>e==="z"),[j,ge]=Le((D=c==null?void 0:c[0])==null?void 0:D.data,[t],r.legendPosition),be=_e(S,1),ye=Pe(r.margin,r.zoomingTool),{chartConfig:Je,measures:Qe,...Ce}=ce,P=Ye(S);return n.jsx(Fe,{dataset:c,loading:M,loadingDelay:ee,Placeholder:re??C,ref:he,style:oe,className:ie,slot:se,resizeDebounce:r.resizeDebounce,...Ce,children:n.jsxs(Ke,{onClick:ue,margin:ye,accessibilityLayer:r.accessibilityLayer,className:typeof p=="function"?"has-click-handler":void 0,children:[n.jsx(Se,{vertical:r.gridVertical,horizontal:r.gridHorizontal,stroke:r.gridStroke}),r.xAxisVisible&&n.jsx(G,{type:"number",name:a==null?void 0:a.label,dataKey:a==null?void 0:a.accessor,xAxisId:0,interval:(a==null?void 0:a.interval)??(fe?"preserveStart":0),tick:n.jsx(je,{formatter:a==null?void 0:a.formatter}),padding:Te,height:be[0],reversed:P,label:a!=null&&a.label?{value:a==null?void 0:a.label,dy:15,position:"insideRight"}:0},typeof(a==null?void 0:a.accessor)!="function"?a==null?void 0:a.accessor:a==null?void 0:a.label),n.jsx(Z,{label:t!=null&&t.label?{value:t==null?void 0:t.label,angle:-90,position:P?"insideRight":"insideLeft"}:null,type:"number",name:t==null?void 0:t.label,axisLine:r.yAxisVisible,tickLine:Ie,dataKey:t==null?void 0:t.accessor,interval:0,tick:n.jsx(De,{formatter:t==null?void 0:t.formatter}),width:t!=null&&t.label?j+10:j,orientation:P===!0?"right":"left"},typeof(t==null?void 0:t.accessor)!="function"?t==null?void 0:t.accessor:t==null?void 0:t.label),n.jsx(Q,{name:s==null?void 0:s.label,dataKey:s==null?void 0:s.accessor,range:[0,5e3]},typeof(s==null?void 0:s.accessor)!="function"?s==null?void 0:s.accessor:s==null?void 0:s.label),c==null?void 0:c.map((e,u)=>n.jsx(J,{className:typeof p=="function"?"has-click-handler":void 0,onMouseDown:me,opacity:e.opacity,data:e==null?void 0:e.data,name:e==null?void 0:e.label,fill:(e==null?void 0:e.color)??`var(--sapChart_OrderedColor_${u%12+1})`,isAnimationActive:!ae},e==null?void 0:e.label)),!te&&n.jsx(Be,{verticalAlign:r.legendPosition,align:r.legendHorizontalAlign,onClick:pe,wrapperStyle:ge,...r.legendConfig}),o&&n.jsx(I,{...o,stroke:(o==null?void 0:o.color)??(o==null?void 0:o.stroke),y:(o==null?void 0:o.value)??(o==null?void 0:o.y),label:o==null?void 0:o.label}),i&&n.jsx(I,{...i,stroke:(i==null?void 0:i.color)??(i==null?void 0:i.stroke),x:(i==null?void 0:i.value)??(i==null?void 0:i.x),label:i==null?void 0:i.label}),(v==null?void 0:v.active)!==!1&&n.jsx(He,{cursor:ze,formatter:de,contentStyle:qe,...v}),le]})})});h.displayName="ScatterChart";try{h.displayName="ScatterChart",h.__docgenInfo={description:`
