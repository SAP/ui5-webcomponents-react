import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{d as be}from"./Friends500-CRbR9XAn.js";import{e as Se}from"./edit-BOpKjwiH.js";import{h as Re,j as k,p as fe,d as je,s as p,m as F,y as Ne,B as ge,w as G}from"./jsx-runtime-2NO35c9p.js";import{f as we}from"./Icon-Dy5MqRQN.js";import{v as ve}from"./i18n-defaults-CmVK7_Fz.js";import{r as v}from"./index-U0ga5oGA.js";import{L as De}from"./index-D9y7p1Ga.js";import{a as ye,S as q}from"./index-D2Tisrj8.js";import{T as y,c as Te,d as m,a as g,b as c}from"./index-gxrz3lA1.js";import{l as _e}from"./event-strict-DgQLNDEV.js";import{i as xe}from"./i18n-CjR4HGlq.js";import{d as Ve}from"./parameters-bundle.css-D0uTR4GL.js";import{i as Y,b as Be,B as Ie,m as qe,P as Me,u as Ae,Z as Pe,W as Ee,D as He,O as Fe,Y as Ge,F as ze}from"./Keys-CLf_QmYW.js";import{cb as Oe,cc as ke,cd as Ue}from"./i18n-defaults-Wx6G1HAa.js";import{d as Le,t as We}from"./TableUtils-BdnmFIk7.js";import{a as $e,T as Z}from"./index-CGYuc86j.js";import"./navigation-right-arrow-tFe_ameE.js";import{a as Ke,T as Ye}from"./index-Cn1bVH_V.js";import{t as Ze}from"./getActiveElement-kltGt_DR.js";import{b as U}from"./TabbableElements-CqFMEI5U.js";var f;(function(i){i.Button="Button",i.Scroll="Scroll"})(f||(f={}));function Je(){return Re("div",{id:"button",tabindex:-1,"data-ui5-growing-active":this._activeState,onClick:this.loadMore,onKeyDown:this._onKeydown,onKeyUp:this._onKeyup,onFocusOut:this._onFocusout,role:"button","aria-labelledby":"text subtext","aria-describedby":"description",children:[k("span",{id:"text",children:this._buttonText}),this.subtext&&k("span",{id:"subtext",children:this.subtext}),k("span",{id:"description",class:"ui5-hidden-text","aria-hidden":"true",children:this._buttonDescription})]})}fe("@ui5/webcomponents-theming","sap_horizon",async()=>je);fe("@ui5/webcomponents","sap_horizon",async()=>Ve);const Qe=`.ui5-hidden-text{position:absolute;clip:rect(1px,1px,1px,1px);user-select:none;left:-1000px;top:-1000px;pointer-events:none;font-size:0}:host{flex-grow:1}#button:focus{outline:var(--sapContent_FocusWidth) var(--sapContent_FocusStyle) var(--sapContent_FocusColor);outline-offset:calc(-1 * var(--sapContent_FocusWidth))}#button{margin:0;padding:0;display:flex;justify-content:center;align-items:center;flex-direction:column;cursor:pointer}@media (hover: hover){#button:hover{background:var(--sapButton_Hover_Background)}}#button:active,#button[data-ui5-growing-active=true]{background:var(--sapList_Active_Background)}#text{padding:1rem 0;font-size:var(--sapFontSize);color:var(--sapButton_TextColor);font-weight:700}#subtext{padding-bottom:1rem;color:var(--sapButton_TextColor)}
`;var T=function(i,t,n,s){var r=arguments.length,o=r<3?t:s===null?s=Object.getOwnPropertyDescriptor(t,n):s,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(i,t,n,s);else for(var l=i.length-1;l>=0;l--)(a=i[l])&&(o=(r<3?a(o):r>3?a(t,n,o):a(t,n))||o);return r>3&&o&&Object.defineProperty(t,n,o),o},P;let b=P=class extends ge{constructor(){super(...arguments),this.mode="Button",this._activeState=!1,this._invalidate=0,this.identifier="TableGrowing",this._renderContent=!0}onTableActivate(t){this._table=t,this._shouldFocusRow=!1}onTableAfterRendering(){var t,n;if(this._shouldFocusRow){this._shouldFocusRow=!1;let s=(t=this._currentLastRow)==null?void 0:t.nextElementSibling;this.hasGrowingComponent()&&(s||(s=this.getFocusDomRef())),s||(s=(n=this._table)==null?void 0:n.rows[0]),s==null||s.focus()}if(this._renderContent!==this.hasGrowingComponent()){this._invalidate++;return}this._hasScrollToLoad()&&!this.hasGrowingComponent()&&!this._observer&&this._observeTableEnd()}onExitDOM(){var t;this._table=void 0,(t=this._observer)==null||t.disconnect(),this._observer=void 0,this._currentLastRow=void 0}onBeforeRendering(){var t;(t=this._observer)==null||t.disconnect(),this._observer=void 0,this._renderContent=this.hasGrowingComponent(),this._invalidateTable()}hasGrowingComponent(){return this.mode===f.Scroll?!!this._table&&this._table._scrollContainer.clientHeight>=this._table._tableElement.scrollHeight:this.mode===`${f.Button}`}loadMore(){this._table&&this.hasGrowingComponent()&&(this._currentLastRow=this._table.rows[this._table.rows.length-1],this._shouldFocusRow=!0),this.fireDecoratorEvent("load-more")}_hasScrollToLoad(){return this.mode===f.Scroll}_observeTableEnd(){this._table&&this._getIntersectionObserver().observe(this._table._endRow)}_getIntersectionObserver(){return this._observer||(this._observer=new IntersectionObserver(this._onIntersection.bind(this),{root:Le(this._table??document.body),rootMargin:"5px"})),this._observer}_onIntersection(t){t.some(n=>n.isIntersecting)&&this.loadMore()}_invalidateTable(){this._table&&this._table._invalidate++}_onKeydown(t){Y(t)&&(t.preventDefault(),this._activeState=!0),Be(t)&&(this.loadMore(),this._activeState=!0)}_onKeyup(t){Y(t)&&this.loadMore(),this._activeState=!1}_onFocusout(){this._activeState=!1}get _buttonText(){return this.text||P.i18nBundle.getText(Oe)}get _buttonDescription(){return P.i18nBundle.getText(ke)}get _hasButton(){return this.hasGrowingComponent()}};T([p()],b.prototype,"mode",void 0);T([p()],b.prototype,"text",void 0);T([p()],b.prototype,"subtext",void 0);T([p({type:Boolean,noAttribute:!0})],b.prototype,"_activeState",void 0);T([p({type:Number,noAttribute:!0})],b.prototype,"_invalidate",void 0);T([xe("@ui5/webcomponents")],b,"i18nBundle",void 0);b=P=T([F({tag:"ui5-table-growing",renderer:Ne,template:Je,styles:Qe}),_e("load-more",{bubbles:!1})],b);b.define();const _=G("ui5-table-growing",["mode","subtext","text"],[],[],["load-more"]);_.displayName="TableGrowing";try{_.displayName="TableGrowing",_.__docgenInfo={description:`The \`TableGrowing\` component is used inside the \`Table\` to add a growing/data loading functionalities
to the table.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var W=function(i,t,n,s){var r=arguments.length,o=r<3?t:s===null?s=Object.getOwnPropertyDescriptor(t,n):s,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(i,t,n,s);else for(var l=i.length-1;l>=0;l--)(a=i[l])&&(o=(r<3?a(o):r>3?a(t,n,o):a(t,n))||o);return r>3&&o&&Object.defineProperty(t,n,o),o},L;let M=L=class extends $e{constructor(){super(...arguments),this.interactive=!1}isFixedAction(){return!0}getRenderInfo(){return{text:this._i18nNavigation,icon:"navigation-right-arrow",interactive:this.interactive}}get _i18nNavigation(){return L.i18nBundle.getText(Ue)}};W([p({type:Boolean})],M.prototype,"interactive",void 0);W([xe("@ui5/webcomponents")],M,"i18nBundle",void 0);M=L=W([F({tag:"ui5-table-row-action-navigation"})],M);M.define();const x=G("ui5-table-row-action-navigation",[],["interactive","invisible"],[],["click"]);x.displayName="TableRowActionNavigation";try{x.displayName="TableRowActionNavigation",x.__docgenInfo={description:`The \`TableRowActionNavigation\` component defines a navigation action for table rows.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}try{x.displayName="TableRowActionNavigation",x.__docgenInfo={description:`The \`TableRowActionNavigation\` component defines a navigation action for table rows.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var z=function(i,t,n,s){var r=arguments.length,o=r<3?t:s===null?s=Object.getOwnPropertyDescriptor(t,n):s,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(i,t,n,s);else for(var l=i.length-1;l>=0;l--)(a=i[l])&&(o=(r<3?a(o):r>3?a(t,n,o):a(t,n))||o);return r>3&&o&&Object.defineProperty(t,n,o),o},h;(function(i){i[i.None=0]="None",i[i.Next=1]="Next",i[i.Previous=2]="Previous",i[i.Released=4]="Released",i[i.NextReleased=5]="NextReleased",i[i.PreviousReleased=6]="PreviousReleased"})(h||(h={}));let S=class extends ge{constructor(){super(),this.rowHeight=45,this.rowCount=100,this.extraRows=0,this.identifier="TableVirtualizer",this._lastRowPosition=0,this._firstRowPosition=0,this._visibleRowCount=0,this._tabBlockingState=h.None,this._onScrollBound=We(this._onScroll.bind(this)),this._onRowInvalidateBound=this._onRowInvalidate.bind(this)}onAfterRendering(){this._table&&this._table._invalidate++}onTableAfterRendering(t){if(this._table?this._updateRowsHeight():(this._table=t,this._scrollContainer.addEventListener("scroll",this._onScrollBound,{passive:!0}),this._updateRowsHeight(),this._onScroll()),this._tabBlockingState&h.Released){const n=this._table.rows.at(this._tabBlockingState&h.Next?-1:0),s=U(n).at(this._tabBlockingState&h.Next?0:-1);this._tabBlockingState=h.None,(s||n).focus()}}onExitDOM(){this._table&&(this._scrollContainer.removeEventListener("scroll",this._onScrollBound),this._table=void 0)}reset(){this._lastRowPosition=-1,this._firstRowPosition=-1,this._table&&(this._scrollContainer.scrollTop>0?this._scrollContainer.scrollTop=0:this._onScroll())}get _scrollContainer(){return this._table._tableElement}get _rowsContainer(){return this._table.shadowRoot.getElementById("rows")}_onScroll(){const t=this._table.headerRow[0],n=t.offsetHeight;let s=this._scrollContainer.scrollTop,r=this._scrollContainer.clientHeight;t.sticky?r=Math.max(0,r-n):s=Math.max(0,s-n),this._visibleRowCount=Math.ceil(r/this.rowHeight);let o=Math.floor(s/this.rowHeight)-this.extraRows;o=Math.max(0,o);let a=Math.max(0,o+this._visibleRowCount+2*this.extraRows);a=Math.min(a,this.rowCount),!(this._firstRowPosition===o&&this._lastRowPosition===a)&&(this._lastRowPosition=a,this._firstRowPosition=o,this.fireDecoratorEvent("range-change",{first:o,last:a}))}_updateRowsHeight(){const t=this.rowCount*this.rowHeight;this._rowsContainer.style.height=`${t}px`}_getTransform(){if(!this._table)return;const t=this._table.rows[0];if(t&&t.position!==void 0&&t.position>0)return`translateY(${t.position*this.rowHeight}px)`}_onRowInvalidate(t){t.name==="position"&&(t.target.detachInvalidate(this._onRowInvalidateBound),this._tabBlockingState|=h.Released)}_onKeyDown(t){if(!this._table)return;let n=0;const s=this._table.rows,r=s[0],o=s[s.length-1],a=r.position!==0,l=o.position!==this.rowCount-1,u=this._table._tableNavigation,d=Ze();if(Ie(t)&&l&&U(this._rowsContainer).pop()===d?(this._tabBlockingState=h.Next,o.attachInvalidate(this._onRowInvalidateBound),n=this.rowHeight):qe(t)&&a&&U(this._rowsContainer).shift()===d?(this._tabBlockingState=h.Previous,r.attachInvalidate(this._onRowInvalidateBound),n=this.rowHeight*-1):l&&u._getNavigationItemsOfRow(o).includes(d)?Me(t)||Ae(t)?n=this.rowHeight:Pe(t)?n=this._visibleRowCount*this.rowHeight:Ee(t)&&d===o&&(n=this.rowCount*this.rowHeight):a&&u._getNavigationItemsOfRow(r).includes(d)&&(He(t)||Fe(t)?n=this.rowHeight*-1:Ge(t)?n=this._visibleRowCount*this.rowHeight*-1:ze(t)&&d===r&&(n=this.rowCount*this.rowHeight*-1)),n){const w=this._table.scrollTop;this._scrollContainer.scrollTop+=n,this._scrollContainer.scrollTop!==w&&t.preventDefault()}}};z([p({type:Number})],S.prototype,"rowHeight",void 0);z([p({type:Number})],S.prototype,"rowCount",void 0);z([p({type:Number})],S.prototype,"extraRows",void 0);S=z([F({tag:"ui5-table-virtualizer"}),_e("range-change")],S);S.define();const R=G("ui5-table-virtualizer",["extraRows","rowCount","rowHeight"],[],[],["range-change"]);R.displayName="TableVirtualizer";try{R.displayName="TableVirtualizer",R.__docgenInfo={description:`The \`TableVirtualizer\` component is used inside the \`Table\` to virtualize the table rows, if the \`overflowMode\` property of the table is set to 'Scroll'.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}try{R.displayName="TableVirtualizer",R.__docgenInfo={description:`The \`TableVirtualizer\` component is used inside the \`Table\` to virtualize the table rows, if the \`overflowMode\` property of the table is set to 'Scroll'.
It is responsible for rendering only the rows that are visible in the viewport and updating them on scroll.
This allows large numbers of rows to exist, but maintain high performance by only paying the cost for those that are currently visible.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const Xe="save",et="M32 363V86q0-23 15.5-38.5T86 32h340q22 0 38 15.5T480 86v340q0 23-16 38.5T426 480H149q-5 0-13-5L37 375q-5-5-5-12zm32-6l91 91h5V320q0-14 9-23t23-9h128q13 0 22.5 9t9.5 23v128h74q9 0 15.5-6.5T448 426V86q0-9-6.5-15.5T426 64h-42v128q0 14-9.5 23t-22.5 9H160q-14 0-23-9t-9-23V64H86q-9 0-15.5 6.5T64 86v271zm96-293v128h192V64H160zm160 384V320H192v128h128zm-96-56v-48q0-8 7-8h17q8 0 8 8v48q0 8-8 8h-17q-7 0-7-8z",tt=!1,nt=ve,ot="SAP-icons-v4",it="@ui5/webcomponents-icons";we(Xe,{pathData:et,ltr:tt,accData:nt,collection:ot,packageName:it});const at="save",st="M505 151q7 9 7 19v252q0 38-26 64t-64 26H90q-38 0-64-26T0 422V90q0-38 26-64T90 0h252q10 0 19 7zm-44 29L332 51H179v90h147q11 0 18.5 7.5T352 167t-7.5 18-18.5 7H153q-11 0-18-7t-7-18V51H90q-17 0-28 11T51 90v332q0 17 11 28t28 11h38V314q0-11 7-18.5t18-7.5h206q11 0 18 7.5t7 18.5v147h38q17 0 28-11t11-28V180zM333 339H179v122h154V339z",lt=!1,rt=ve,ct="SAP-icons-v5",dt="@ui5/webcomponents-icons";we(at,{pathData:st,ltr:lt,accData:rt,collection:ct,packageName:dt});const ut="save",ht=e.jsxs(Te,{sticky:!0,children:[e.jsx(m,{width:"200px",minWidth:"200px",children:e.jsx("span",{children:"Product"})}),e.jsx(m,{minWidth:"200px",children:e.jsx("span",{children:"Supplier"})}),e.jsx(m,{minWidth:"200px",children:e.jsx("span",{children:"Dimensions"})}),e.jsx(m,{minWidth:"100px",maxWidth:"200px",children:e.jsx("span",{children:"Weight"})}),e.jsx(m,{minWidth:"200px",children:e.jsx("span",{children:"Price"})})]}),$=e.jsxs(Te,{sticky:!0,children:[e.jsx(m,{children:"Name"}),e.jsx(m,{children:"Age"}),e.jsx(m,{children:"Friend Name"}),e.jsx(m,{children:"Friend Age"})]}),pt={title:"Data Display / Table",component:y,argTypes:{headerRow:{control:{disable:!0}},features:{control:{disable:!0}},children:{control:{disable:!0}}},args:{headerRow:ht},tags:["package:@ui5/webcomponents"]},j={render:i=>e.jsxs(y,{...i,children:[e.jsxs(g,{children:[e.jsx(c,{children:e.jsx("span",{children:"Notebook Basic"})}),e.jsx(c,{children:e.jsx("span",{children:"Very Best Screens"})}),e.jsx(c,{children:e.jsx("span",{children:"30 x 18 x 3cm"})}),e.jsx(c,{children:e.jsx("span",{children:"4.2KG"})}),e.jsx(c,{children:e.jsx("span",{children:"956EUR"})})]}),e.jsxs(g,{children:[e.jsx(c,{children:e.jsx("span",{children:"Notebook Basic 17HT-1001"})}),e.jsx(c,{children:e.jsx("span",{children:"Very Best Screens"})}),e.jsx(c,{children:e.jsx("span",{children:"29 x 17 x 3.1cm"})}),e.jsx(c,{children:e.jsx("span",{children:"4.5KG"})}),e.jsx(c,{children:e.jsx("span",{children:"1249EUR"})})]})]})},N={render:i=>{const[t,n]=v.useState(f.Button),s=l=>new Array(25).fill("").map((u,d)=>e.jsxs(g,{children:[e.jsx(c,{children:e.jsx("span",{children:d+l})}),e.jsx(c,{children:e.jsx("span",{children:"Placeholder"})}),e.jsx(c,{children:e.jsx("span",{children:"Placeholder 2"})}),e.jsx(c,{children:e.jsx("span",{children:"Placeholder 3"})}),e.jsx(c,{children:e.jsx("span",{children:"Placeholder 4"})})]},`${d+l}-row`)),[r,o]=v.useState(s(1)),a=()=>{o(l=>[...l,...s(l.length+1)])};return e.jsxs(e.Fragment,{children:[e.jsxs(De,{showColon:!0,style:{marginInlineEnd:"0.5rem"},children:["Growing ",e.jsx("code",{children:"mode"})]}),e.jsxs(ye,{style:{marginBlockEnd:"0.5rem"},onSelectionChange:l=>{n(l.detail.selectedItems[0].textContent)},children:[e.jsx(q,{selected:t===f.Scroll,children:"Scroll"}),e.jsx(q,{selected:t===f.Button,children:"Button"})]}),e.jsx("div",{style:{height:"250px",overflow:"auto"},children:e.jsx(y,{...i,features:e.jsx(_,{onLoadMore:a,mode:t}),children:r})})]})}},D={render(i){const[t,n]=v.useState("Single");return e.jsxs(e.Fragment,{children:[e.jsxs(ye,{onSelectionChange:s=>{n(s.detail.selectedItems[0].textContent)},children:[e.jsx(q,{selected:t==="None",children:"None"}),e.jsx(q,{selected:t==="Single",children:"Single"}),e.jsx(q,{selected:t==="Multi",children:"Multi"})]}),e.jsxs(y,{...i,features:e.jsxs(e.Fragment,{children:[t==="Single"&&e.jsx(C,{}),t==="Multi"&&e.jsx(Ye,{})]}),children:[e.jsxs(g,{children:[e.jsx(c,{children:e.jsx("span",{children:"Notebook Basic"})}),e.jsx(c,{children:e.jsx("span",{children:"Very Best Screens"})}),e.jsx(c,{children:e.jsx("span",{children:"30 x 18 x 3cm"})}),e.jsx(c,{children:e.jsx("span",{children:"4.2KG"})}),e.jsx(c,{children:e.jsx("span",{children:"956EUR"})})]}),e.jsxs(g,{children:[e.jsx(c,{children:e.jsx("span",{children:"Notebook Basic 17HT-1001"})}),e.jsx(c,{children:e.jsx("span",{children:"Very Best Screens"})}),e.jsx(c,{children:e.jsx("span",{children:"29 x 17 x 3.1cm"})}),e.jsx(c,{children:e.jsx("span",{children:"4.5KG"})}),e.jsx(c,{children:e.jsx("span",{children:"1249EUR"})})]})]})]})}},E=be.map((i,t)=>({...i,position:t})),V={args:{className:"tableHeightContentDensity",headerRow:$},render(i){const[t,n]=v.useState(E.slice(0,9)),[s,r]=v.useState(!0),o=a=>{const{first:l,last:u}=a.detail,d=Math.max(l-2,0),w=Math.min(u+2,E.length);n(E.slice(d,w))};return v.useEffect(()=>{const a=document.body;if(!a)return;const l=new MutationObserver(u=>{u.forEach(d=>{d.type==="attributes"&&d.attributeName==="class"&&r(!a.classList.contains("ui5-content-density-compact"))})});return l.observe(a,{attributes:!0,attributeFilter:["class"]}),()=>{l.disconnect()}},[]),e.jsx(y,{...i,features:e.jsx(R,{rowCount:500,rowHeight:s?44:32,onRangeChange:o}),children:t.map(a=>e.jsxs(g,{position:a.position,children:[e.jsx(c,{children:e.jsx("span",{children:a.name})}),e.jsx(c,{children:e.jsx("span",{children:a.age})}),e.jsx(c,{children:e.jsx("span",{children:a.friend.name})}),e.jsx(c,{children:e.jsx("span",{children:a.friend.age})})]},a.position))})}},B={args:{headerRow:$,rowActionCount:3},render(i){return e.jsx(y,{...i,children:be.slice(0,10).map((t,n)=>e.jsxs(g,{actions:e.jsxs(e.Fragment,{children:[e.jsx(Z,{icon:Se,text:"Edit"}),e.jsx(Z,{icon:ut,text:"Save"}),e.jsx(x,{interactive:!!(n%2)})]}),children:[e.jsx(c,{children:e.jsx("span",{children:t.name})}),e.jsx(c,{children:e.jsx("span",{children:t.age})}),e.jsx(c,{children:e.jsx("span",{children:t.friend.name})}),e.jsx(c,{children:e.jsx("span",{children:t.friend.age})})]},`${t.name}-${t.age}`))})}},I={args:{headerRow:$},render(i){const[t,n]=v.useState(E.slice(0,10)),s=o=>{const{source:a,destination:l}=o.detail;n(u=>{const d=u.findIndex(O=>`${O.position}`===a.element.dataset.id),w=u.findIndex(O=>`${O.position}`===l.element.dataset.id);if(d===-1||w===-1)return u;const A=[...u],[K]=A.splice(d,1);return l.placement==="Before"?A.splice(w,0,K):l.placement==="After"&&A.splice(w+1,0,K),A})},r=o=>{const{source:a,destination:l}=o.detail;a.element.hasAttribute("ui5-table-row")&&l.element.hasAttribute("ui5-table-row")&&l.placement!=="On"&&o.preventDefault()};return e.jsx(y,{...i,onMove:s,onMoveOver:r,children:t.map(o=>e.jsxs(g,{movable:!0,"data-id":o.position,children:[e.jsx(c,{children:e.jsx("span",{children:o.name})}),e.jsx(c,{children:e.jsx("span",{children:o.age})}),e.jsx(c,{children:e.jsx("span",{children:o.friend.name})}),e.jsx(c,{children:e.jsx("span",{children:o.friend.age})})]},o.position))})}};var J,Q,X;j.parameters={...j.parameters,docs:{...(J=j.parameters)==null?void 0:J.docs,source:{originalSource:`{
  render: args => {
    return <Table {...args}>
        <TableRow>
          <TableCell>
...
}`,...(X=(Q=j.parameters)==null?void 0:Q.docs)==null?void 0:X.source}}};var ee,te,ne;N.parameters={...N.parameters,docs:{...(ee=N.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  render: args => {
...
}`,...(ne=(te=N.parameters)==null?void 0:te.docs)==null?void 0:ne.source}}};var oe,ie,ae;D.parameters={...D.parameters,docs:{...(oe=D.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  render(args) {
...
}`,...(ae=(ie=D.parameters)==null?void 0:ie.docs)==null?void 0:ae.source}}};var se,le,re;V.parameters={...V.parameters,docs:{...(se=V.parameters)==null?void 0:se.docs,source:{originalSource:`{
  args: {
...
}`,...(re=(le=V.parameters)==null?void 0:le.docs)==null?void 0:re.source}}};var ce,de,ue;B.parameters={...B.parameters,docs:{...(ce=B.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  args: {
    headerRow: columns,
    rowActionCount: 3
  },
...
}`,...(ue=(de=B.parameters)==null?void 0:de.docs)==null?void 0:ue.source}}};var he,pe,me;I.parameters={...I.parameters,docs:{...(he=I.parameters)==null?void 0:he.docs,source:{originalSource:`{
  args: {
    headerRow: columns
  },
  render(args) {
...
}`,...(me=(pe=I.parameters)==null?void 0:pe.docs)==null?void 0:me.source}}};const mt=["Default","GrowingTable","WithSelection","VirtualizedTableRows","withRowActions","dragAndDropRows"],Gt=Object.freeze(Object.defineProperty({__proto__:null,Default:j,GrowingTable:N,VirtualizedTableRows:V,WithSelection:D,__namedExportsOrder:mt,default:pt,dragAndDropRows:I,withRowActions:B},Symbol.toStringTag,{value:"Module"}));export{Gt as C,j as D,N as G,x as T,V,D as W,_ as a,C as b,R as c,I as d,B as w};
