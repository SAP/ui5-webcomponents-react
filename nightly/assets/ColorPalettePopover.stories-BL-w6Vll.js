import{j as r}from"./jsx-runtime-D6fbYt3N.js";import{i as S}from"./utils-CxvrB1Lz.js";import{r as w}from"./index-DysCNOs_.js";import{B as k}from"./index-DczEHKsk.js";import{a as N,C as a}from"./index-CUOS67xi.js";import{m as b,p as u,k as l,a as R,s as T,q as m,v as I,z as O,S as q,w as E}from"./withWebComponent-D2290JWW.js";import{d as j}from"./slot-_4yKMUwC.js";import{l as y}from"./event-strict-DgQLNDEV.js";import{i as V}from"./i18n-DEVDpFvK.js";import{e as A}from"./Popover-D4qFMFR_.js";import{d as M}from"./useIsomorphicLayoutEffect-UXkgNLQC.js";import{c as P}from"./Icon-DNC_Q8W5.js";import{s as x}from"./parameters-bundle.css-DlWxkghp.js";import{s as B}from"./ResponsivePopoverCommon.css-BAdqMtzc.js";import{ao as L,n as U}from"./i18n-defaults-B_32hVC3.js";import{a as F}from"./Button-B25Pr19o.js";import{a as Y}from"./Title-B_OApkG5.js";import{R as H}from"./ResponsivePopover-D-Js_a1v.js";function z(s,e,o){return o?b`<${u("ui5-responsive-popover",e,o)} hide-arrow content-only-on-desktop placement="Bottom" .opener="${l(this.opener)}" ?open="${this._open}" @ui5-close="${l(this.onAfterClose)}" @ui5-open="${l(this.onAfterOpen)}"><div slot="header" class="ui5-cp-header"><${u("ui5-title",e,o)} level="H1" wrapping-type="None">${l(this._colorPaletteTitle)}</${u("ui5-title",e,o)}></div><div><${u("ui5-color-palette",e,o)} ?show-more-colors="${this.showMoreColors}" ?show-recent-colors="${this.showRecentColors}" ?show-default-color="${this.showDefaultColor}" default-color="${l(this.defaultColor)}" popup-mode @ui5-item-click="${l(this.onSelectedColor)}">${P(this.colorPaletteColors,(t,n)=>t._id||n,(t,n)=>g.call(this,s,e,o,t,n))}</${u("ui5-color-palette",e,o)}></div><div slot="footer" class="ui5-cp-footer"><${u("ui5-button",e,o)} design="Transparent" @click="${this.closePopover}">${l(this._cancelButtonLabel)}</${u("ui5-button",e,o)}></div></${u("ui5-responsive-popover",e,o)}>`:b`<ui5-responsive-popover hide-arrow content-only-on-desktop placement="Bottom" .opener="${l(this.opener)}" ?open="${this._open}" @ui5-close="${l(this.onAfterClose)}" @ui5-open="${l(this.onAfterOpen)}"><div slot="header" class="ui5-cp-header"><ui5-title level="H1" wrapping-type="None">${l(this._colorPaletteTitle)}</ui5-title></div><div><ui5-color-palette ?show-more-colors="${this.showMoreColors}" ?show-recent-colors="${this.showRecentColors}" ?show-default-color="${this.showDefaultColor}" default-color="${l(this.defaultColor)}" popup-mode @ui5-item-click="${l(this.onSelectedColor)}">${P(this.colorPaletteColors,(t,n)=>t._id||n,(t,n)=>g.call(this,s,e,o,t,n))}</ui5-color-palette></div><div slot="footer" class="ui5-cp-footer"><ui5-button design="Transparent" @click="${this.closePopover}">${l(this._cancelButtonLabel)}</ui5-button></div></ui5-responsive-popover>`}function g(s,e,o,t,n){return b`<slot name="${l(t._individualSlot)}"></slot>`}R("@ui5/webcomponents-theming","sap_horizon",async()=>T);R("@ui5/webcomponents","sap_horizon",async()=>x);const W={packageName:"@ui5/webcomponents",fileName:"themes/ColorPalettePopover.css.ts",content:`.ui5-cp-header{width:100%;height:var(--_ui5-v2-5-0_color-palette-button-height);display:flex;align-items:center}.ui5-cp-footer{width:100%;display:flex;justify-content:flex-end;align-items:center;margin:.1875rem 0}[ui5-responsive-popover]::part(content){padding:0}.ui5-cp-item-container{padding:.3125rem .6875rem}
