...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}try{S.displayName="UserSettingsDialog",S.__docgenInfo={description:`The \`UserSettingsDialog\` is an SAP Fiori-specific web component used in the \`UserMenu\`.
It allows the user to easily view information and settings for an account.
