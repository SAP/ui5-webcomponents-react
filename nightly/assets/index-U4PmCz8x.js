import{j as p,l as d,k as F,f as _,s as G,a as l,m as L,p as C,I as N,w as I}from"./withWebComponent-CjthvP8A.js";import{d as w}from"./slot-_4yKMUwC.js";import{c as T}from"./Icon-BiQiH9AZ.js";import{s as M}from"./parameters-bundle.css-Bga-3Zi8.js";import{a as $}from"./Title-XDMvnQZn.js";function X(a,e,o){return p`<div class="ui5-form-root" role="form" aria-labelledby="${d(this.ariaLabelledByID)}">${this.hasHeader?q.call(this,a,e,o):void 0}<div class="ui5-form-layout" part="layout">${this.hasGroupItems?E.call(this,a,e,o):z.call(this,a,e,o)}</div></div>`}function q(a,e,o){return p`<div class="ui5-form-header" part="header">${this.hasCustomHeader?V.call(this,a,e,o):k.call(this,a,e,o)}</div>`}function V(a,e,o){return p`<slot name="header"></slot>`}function k(a,e,o){return o?p`<${F("ui5-title",e,o)} id="${d(this._id)}-header-text" level="H4">${d(this.headerText)}</${F("ui5-title",e,o)}>`:p`<ui5-title id="${d(this._id)}-header-text" level="H4">${d(this.headerText)}</ui5-title>`}function E(a,e,o){return p`${T(this.groupItemsInfo,(t,n)=>t._id||n,(t,n)=>R.call(this,a,e,o,t,n))}`}function R(a,e,o,t,n){return p`<div class="ui5-form-column ${d(t.classes)}" part="column"><div class="ui5-form-group">${t.groupItem.headerText?U.call(this,a,e,o,t,n):void 0}<div class="ui5-form-group-layout"><slot name="${d(t.groupItem._individualSlot)}"></slot></div></div></div>`}function U(a,e,o,t,n){return o?p`<div class="ui5-form-group-heading"><${F("ui5-title",e,o)} level="H6">${d(t.groupItem.headerText)}</${F("ui5-title",e,o)}></div>`:p`<div class="ui5-form-group-heading"><ui5-title level="H6">${d(t.groupItem.headerText)}</ui5-title></div>`}function z(a,e,o){return p`${T(this.itemsInfo,(t,n)=>t._id||n,(t,n)=>W.call(this,a,e,o,t,n))}`}function W(a,e,o,t,n){return p`<div class="ui5-form-item ${d(t.classes)}"><slot name="${d(t.item._individualSlot)}"></slot></div>`}_("@ui5/webcomponents-theming","sap_horizon",async()=>G);_("@ui5/webcomponents","sap_horizon",async()=>M);const j={packageName:"@ui5/webcomponents",fileName:"themes/Form.css.ts",content:`@container (max-width: 600px){.ui5-form-layout{grid-template-columns:1fr}::slotted(*){justify-self:start}::slotted(:nth-child(2n)){margin-bottom:.5rem}}@container (width > 600px) and (width <= 1024px){.ui5-form-layout{grid-template-columns:1fr}:host([columns-m="1"]) .ui5-form-layout{grid-template-columns:1fr}:host([columns-m="2"]) .ui5-form-layout{grid-template-columns:repeat(2,1fr)}.ui5-form-column-spanM-2{grid-column:span 2}.ui5-form-column-spanM-2 .ui5-form-group-layout{grid-template-columns:repeat(2,1fr)}}@container (width > 1024px) and (width <= 1440px){.ui5-form-layout{grid-template-columns:repeat(2,1fr)}.ui5-form-column{grid-template-columns:1fr}:host([columns-l="1"]) .ui5-form-layout{grid-template-columns:1fr}:host([columns-l="2"]) .ui5-form-layout{grid-template-columns:repeat(2,1fr)}:host([columns-l="3"]) .ui5-form-layout{grid-template-columns:repeat(3,1fr)}.ui5-form-column-spanL-2{grid-column:span 2}.ui5-form-column-spanL-2 .ui5-form-group-layout{grid-template-columns:repeat(2,1fr)}.ui5-form-column-spanL-3{grid-column:span 3}.ui5-form-column-spanL-3 .ui5-form-group-layout{grid-template-columns:repeat(3,1fr)}}@container (min-width: 1441px){.ui5-form-layout{grid-template-columns:repeat(2,1fr)}:host([columns-xl="1"]) .ui5-form-layout{grid-template-columns:1fr}:host([columns-xl="2"]) .ui5-form-layout{grid-template-columns:repeat(2,1fr)}:host([columns-xl="3"]) .ui5-form-layout{grid-template-columns:repeat(3,1fr)}:host([columns-xl="4"]) .ui5-form-layout{grid-template-columns:repeat(4,1fr)}:host([columns-xl="5"]) .ui5-form-layout{grid-template-columns:repeat(5,1fr)}:host([columns-xl="6"]) .ui5-form-layout{grid-template-columns:repeat(6,1fr)}.ui5-form-column-spanXL-2{grid-column:span 2}.ui5-form-column-spanXL-2 .ui5-form-group-layout{grid-template-columns:repeat(2,1fr)}.ui5-form-column-spanXL-3{grid-column:span 3}.ui5-form-column-spanXL-3 .ui5-form-group-layout{grid-template-columns:repeat(3,1fr)}.ui5-form-column-spanXL-4{grid-column:span 4}.ui5-form-column-spanXL-4 .ui5-form-group-layout{grid-template-columns:repeat(4,1fr)}.ui5-form-column-spanXL-5{grid-column:span 5}.ui5-form-column-spanXL-5 .ui5-form-group-layout{grid-template-columns:repeat(5,1fr)}.ui5-form-column-spanXL-6{grid-column:span 6}.ui5-form-column-spanXL-6 .ui5-form-group-layout{grid-template-columns:repeat(6,1fr)}}.ui5-form-item-span-2{grid-column:span 2}.ui5-form-item-span-3{grid-column:span 3}.ui5-form-item-span-4{grid-column:span 4}.ui5-form-item-span-5{grid-column:span 5}.ui5-form-item-span-6{grid-column:span 6}@container (max-width: 600px){:host([label-span-s="1"]) .ui5-form-item,:host([label-span-s="1"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span1)}:host([label-span-s="2"]) .ui5-form-item,:host([label-span-s="2"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span2)}:host([label-span-s="3"]) .ui5-form-item,:host([label-span-s="3"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span3)}:host([label-span-s="4"]) .ui5-form-item,:host([label-span-s="4"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span4)}:host([label-span-s="5"]) .ui5-form-item,:host([label-span-s="5"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span5)}:host([label-span-s="6"]) .ui5-form-item,:host([label-span-s="6"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span6)}:host([label-span-s="7"]) .ui5-form-item,:host([label-span-s="7"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span7)}:host([label-span-s="8"]) .ui5-form-item,:host([label-span-s="8"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span8)}:host([label-span-s="9"]) .ui5-form-item,:host([label-span-s="9"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span9)}:host([label-span-s="10"]) .ui5-form-item,:host([label-span-s="10"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span10)}:host([label-span-s="11"]) .ui5-form-item,:host([label-span-s="11"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span11)}:host(:not([label-span-s])) .ui5-form-item,:host(:not([label-span-s])) .ui5-form-group,:host([label-span-s="12"]) .ui5-form-item,:host([label-span-s="12"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span12);--ui5-v2-2-0-form-item-label-justify: var(--ui5-v2-2-0-form-item-label-justify-span12);--ui5-v2-2-0-form-item-label-padding: var(--ui5-v2-2-0-form-item-label-padding-span12)}}@container (width > 600px) and (width <= 1024px){:host([label-span-m="1"]) .ui5-form-item,:host([label-span-m="1"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span1)}:host([label-span-m="2"]) .ui5-form-item,:host([label-span-m="2"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span2)}:host([label-span-m="3"]) .ui5-form-item,:host([label-span-m="3"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span3)}:host([label-span-m="4"]) .ui5-form-item,:host([label-span-m="4"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span4)}:host([label-span-m="5"]) .ui5-form-item,:host([label-span-m="5"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span5)}:host([label-span-m="6"]) .ui5-form-item,:host([label-span-m="6"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span6)}:host([label-span-m="7"]) .ui5-form-item,:host([label-span-m="7"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span7)}:host([label-span-m="8"]) .ui5-form-item,:host([label-span-m="8"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span8)}:host([label-span-m="9"]) .ui5-form-item,:host([label-span-m="9"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span9)}:host([label-span-m="10"]) .ui5-form-item,:host([label-span-m="10"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span10)}:host([label-span-m="11"]) .ui5-form-item,:host([label-span-m="11"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span11)}:host([label-span-m="12"]) .ui5-form-item,:host([label-span-m="12"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span12);--ui5-v2-2-0-form-item-label-justify: var(--ui5-v2-2-0-form-item-label-justify-span12);--ui5-v2-2-0-form-item-label-padding: var(--ui5-v2-2-0-form-item-label-padding-span12)}}@container (width > 1024px) and (width <= 1440px){:host([label-span-l="1"]) .ui5-form-item,:host([label-span-l="1"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span1)}:host([label-span-l="2"]) .ui5-form-item,:host([label-span-l="2"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span2)}:host([label-span-l="3"]) .ui5-form-item,:host([label-span-l="3"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span3)}:host([label-span-l="4"]) .ui5-form-item,:host([label-span-l="4"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span4)}:host([label-span-l="5"]) .ui5-form-item,:host([label-span-l="5"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span5)}:host([label-span-l="6"]) .ui5-form-item,:host([label-span-l="6"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span6)}:host([label-span-l="7"]) .ui5-form-item,:host([label-span-l="7"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span7)}:host([label-span-l="8"]) .ui5-form-item,:host([label-span-l="8"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span8)}:host([label-span-l="9"]) .ui5-form-item,:host([label-span-l="9"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span9)}:host([label-span-l="10"]) .ui5-form-item,:host([label-span-l="10"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span10)}:host([label-span-l="11"]) .ui5-form-item,:host([label-span-l="11"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span11)}:host([label-span-l="12"]) .ui5-form-item,:host([label-span-l="12"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span12);--ui5-v2-2-0-form-item-label-justify: var(--ui5-v2-2-0-form-item-label-justify-span12);--ui5-v2-2-0-form-item-label-padding: var(--ui5-v2-2-0-form-item-label-padding-span12)}}@container (min-width: 1441px){:host([label-span-xl="1"]) .ui5-form-item,:host([label-span-xl="1"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span1)}:host([label-span-xl="2"]) .ui5-form-item,:host([label-span-xl="2"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span2)}:host([label-span-xl="3"]) .ui5-form-item,:host([label-span-xl="3"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span3)}:host([label-span-xl="4"]) .ui5-form-item,:host([label-span-xl="4"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span4)}:host([label-span-xl="5"]) .ui5-form-item,:host([label-span-xl="5"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span5)}:host([label-span-xl="6"]) .ui5-form-item,:host([label-span-xl="6"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span6)}:host([label-span-xl="7"]) .ui5-form-item,:host([label-span-xl="7"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span7)}:host([label-span-xl="8"]) .ui5-form-item,:host([label-span-xl="8"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span8)}:host([label-span-xl="9"]) .ui5-form-item,:host([label-span-xl="9"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span9)}:host([label-span-xl="10"]) .ui5-form-item,:host([label-span-xl="10"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span10)}:host([label-span-xl="11"]) .ui5-form-item,:host([label-span-xl="11"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span11)}:host([label-span-xl="12"]) .ui5-form-item,:host([label-span-xl="12"]) .ui5-form-group{--ui5-v2-2-0-form-item-layout: var(--ui5-v2-2-0-form-item-layout-span12);--ui5-v2-2-0-form-item-label-justify: var(--ui5-v2-2-0-form-item-label-justify-span12);--ui5-v2-2-0-form-item-label-padding: var(--ui5-v2-2-0-form-item-label-padding-span12)}}:host{display:block}.ui5-form-root{display:flex;flex-direction:column;background-color:var(--sapGroup_ContentBackground);border-radius:.75rem;container-type:inline-size}.ui5-form-header{display:flex;height:2.75rem;align-items:center;border-bottom:1px solid var(--sapGroup_TitleBorderColor);padding:0 1rem}.ui5-form-layout{display:grid;column-gap:1rem;row-gap:.125rem;padding:1rem .75rem}.ui5-form-group-layout{display:grid;column-gap:1rem}.ui5-form-group-heading{height:var(--_ui5-v2-2-0-form-group-heading-height);line-height:var(--_ui5-v2-2-0-form-group-heading-height);padding-inline-start:.25rem}.ui5-form-column{padding-top:.5rem;padding-bottom:1rem;box-sizing:border-box}::slotted([ui5-form-group]){display:contents}
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var h=function(a,e,o,t){var n=arguments.length,r=n<3?e:t===null?t=Object.getOwnPropertyDescriptor(e,o):t,i;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(a,e,o,t);else for(var s=a.length-1;s>=0;s--)(i=a[s])&&(r=(n<3?i(r):n>3?i(e,o,r):i(e,o))||r);return n>3&&r&&Object.defineProperty(e,o,r),r};let c=class extends N{constructor(){super(...arguments),this.colsS=1,this.colsM=1,this.colsL=1,this.colsXl=1,this.itemSpacing="Normal",this.labelSpan="S12 M4 L4 XL4"}onBeforeRendering(){this.processFormItems()}processFormItems(){this.items.forEach(e=>{e.labelSpan=this.labelSpan,e.itemSpacing=this.itemSpacing})}get isGroup(){return!0}};h([l()],c.prototype,"headerText",void 0);h([l({type:Number})],c.prototype,"columnSpan",void 0);h([w({type:HTMLElement,default:!0})],c.prototype,"items",void 0);h([l({type:Number})],c.prototype,"colsS",void 0);h([l({type:Number})],c.prototype,"colsM",void 0);h([l({type:Number})],c.prototype,"colsL",void 0);h([l({type:Number})],c.prototype,"colsXl",void 0);h([l()],c.prototype,"itemSpacing",void 0);c=h([L("ui5-form-group")],c);c.define();const v=I("ui5-form-group",["columnSpan","headerText"],[],[],[]);v.displayName="FormGroup";try{v.displayName="FormGroup",v.__docgenInfo={description:`The FormGroup (ui5-form-group) represents a group inside the Form (ui5-form) component
