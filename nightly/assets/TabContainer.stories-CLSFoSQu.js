import{j as e}from"./jsx-runtime-D6fbYt3N.js";import{a as F,b as T,c as M,T as n}from"./index-DBBVmbZ8.js";import{m as g,k as i,p as w,a as h,s as P,v as E,z as H,S as U,X as S,w as A}from"./withWebComponent-D2290JWW.js";import{f as R}from"./Icon-DNC_Q8W5.js";import{a as B}from"./add-BOxZfmZK.js";import{e as G}from"./employee-C28GNKYG.js";import{m as V}from"./menu-BRJduY-n.js";import{s as X}from"./settings-CbNgtgml.js";import{o as x}from"./class-map-BHSYgJ9u.js";import{s as v}from"./style-map-CKH5i8-O.js";import{s as W}from"./parameters-bundle.css-DlWxkghp.js";function J(t,a,o){return g`<div id="${i(this._id)}" role="separator" class="${x(this.classes.root)}" .realTabReference="${i(this)}"></div>`}function K(t,a,o){return o?g`<${w("ui5-li-custom",a,o)} id="${i(this._id)}" role="separator" class="${x(this.classes.root)}" disabled style="${v(this._forcedStyleInOverflow)}" .realTabReference="${i(this)}"></${w("ui5-li-custom",a,o)}>`:g`<ui5-li-custom id="${i(this._id)}" role="separator" class="${x(this.classes.root)}" disabled style="${v(this._forcedStyleInOverflow)}" .realTabReference="${i(this)}"></ui5-li-custom>`}h("@ui5/webcomponents-theming","sap_horizon",async()=>P);h("@ui5/webcomponents","sap_horizon",async()=>W);const Q={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInStrip.css.ts",content:`div.ui5-tc__separator{position:relative;width:.5625rem}div.ui5-tc__separator:before{content:" ";position:absolute;width:.0625rem;left:.25rem;top:.5rem;bottom:.5rem;background:var(--sapGroup_TitleBorderColor)}
`};h("@ui5/webcomponents-theming","sap_horizon",async()=>P);h("@ui5/webcomponents","sap_horizon",async()=>W);const Y={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInOverflow.css.ts",content:`[ui5-li-custom].ui5-tc__separator{min-height:.25rem;border-bottom:.0625rem solid var(--sapGroup_TitleBorderColor);margin-inline-start:calc(var(--_ui5-v2-5-0-tab-indentation-level) * .5rem);margin-inline-end:.5rem}[ui5-list]>[ui5-li-custom].ui5-tc__separator:first-child{min-height:.5rem}
...
}`,...(q=($=c.parameters)==null?void 0:$.docs)==null?void 0:q.source}}};var I,N,D;l.parameters={...l.parameters,docs:{...(I=l.parameters)==null?void 0:I.docs,source:{originalSource:`{
