import{j as h}from"./useIsomorphicLayoutEffect-dLBi2t77.js";import{A as m}from"./index-v2bCH09b.js";import{f as C,s as N,h as g,j as y,a as w,m as R,k as L,I as $,w as O}from"./withWebComponent-6t4MTiZ-.js";import{f as A}from"./ResizeHandler-BL_t98Y7.js";import{f as z}from"./ItemNavigation-C_v-ZRVk.js";import{f as U}from"./i18nBundle-BwSTHZvs.js";import{d as D}from"./slot-_4yKMUwC.js";import{s as G}from"./event-Dq0fpeHi.js";import{f as W,b as P,a as T}from"./Keys-F_3Gvx0K.js";import{b as V}from"./Button-ein9a_YJ.js";import{A as r}from"./AvatarSize-BceVhWoP.js";import{A as H}from"./AvatarColorScheme-Bo7yU2Uu.js";import{aq as q,ar as M,as as j,at as I,au as F}from"./i18n-defaults-sl2p4TZC.js";import{s as Y}from"./parameters-bundle.css-P4kwt3kq.js";import{l as s}from"./if-defined-B1auRMLy.js";import{o as B}from"./class-map-D9jLILSY.js";var b;(function(a){a.Group="Group",a.Individual="Individual"})(b||(b={}));const i=b;C("@ui5/webcomponents-theming","sap_horizon",async()=>N);C("@ui5/webcomponents","sap_horizon",async()=>Y);const X={packageName:"@ui5/webcomponents",fileName:"themes/AvatarGroup.css.ts",content:`:host{-webkit-tap-highlight-color:rgba(0,0,0,0)}:host(:not([hidden])){display:block;width:100%}:host{--_ui5-v2-1-2_button_focused_border: var(--_ui5-v2-1-2_avatar_group_button_focus_border)}.ui5-avatar-group-items:focus{outline:none}:host([type="Group"][desktop]) .ui5-avatar-group-items:focus,:host([type="Group"]) .ui5-avatar-group-items:focus-visible{outline:var(--_ui5-v2-1-2_avatar_outline);outline-offset:var(--_ui5-v2-1-2_avatar_focus_offset);border-radius:var(--_ui5-v2-1-2_avatar_group_focus_border_radius)}.ui5-avatar-group-root{display:flex}.ui5-avatar-group-items{white-space:nowrap;position:relative;display:inline-flex}:host([type="Group"]) .ui5-avatar-group-items{cursor:pointer}:host([type="Group"]) ::slotted([ui5-button]),:host([type="Group"]) ::slotted([ui5-avatar]){pointer-events:none}.ui5-avatar-group-overflow-btn{overflow:visible}.ui5-avatar-group-overflow-btn::part(button){min-width:auto}::slotted([ui5-button]:not([hidden])),.ui5-avatar-group-overflow-btn:not([hidden]){--_ui5-v2-1-2_button_base_padding: 0;border-radius:50%;display:inline-flex;text-overflow:initial;z-index:0}::slotted([ui5-button][desktop]:focus),.ui5-avatar-group-overflow-btn[desktop]:focus{outline:var(--_ui5-v2-1-2_avatar_outline);outline-offset:var(--_ui5-v2-1-2_avatar_overflow_button_focus_offset)}.ui5-avatar-group-overflow-btn::part(button):focus-visible:after{outline:var(--_ui5-v2-1-2_avatar_outline);outline-offset:var(--_ui5-v2-1-2_avatar_focus_offset);border-radius:50%}.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-xs{height:2rem;width:2rem;min-width:2rem;font-size:.75rem}::slotted([ui5-button]),.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-s{height:3rem;width:3rem;min-width:3rem;font-size:1.125rem}.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-m{height:4rem;width:4rem;min-width:4rem;font-size:1.625rem}.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-l{height:5rem;width:5rem;min-width:5rem;font-size:2rem}.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-xl{height:7rem;width:7rem;min-width:7rem;font-size:2.75rem}
`};function K(a,e,t){return g`<div class="ui5-avatar-group-root"><div class="ui5-avatar-group-items" @keyup="${this._onkeyup}" @keydown="${this._onkeydown}" @focusin="${this._onfocusin}" tabindex="${s(this._groupTabIndex)}" @click="${this._onClick}" @ui5-click="${s(this._onUI5Click)}" aria-label="${s(this._ariaLabelText)}" role="${s(this._role)}" aria-haspopup="${s(this._containerAriaHasPopup)}"><slot></slot>${this._customOverflowButton?J.call(this,a,e,t):Q.call(this,a,e,t)}</div></div>`}function J(a,e,t){return g`<slot name="overflowButton"></slot>`}function Q(a,e,t){return t?g`<${y("ui5-button",e,t)} .accessibilityAttributes="${s(this._overflowButtonAccAttributes)}" accessible-name="${s(this._overflowButtonAriaLabelText)}" ?hidden="${this._overflowBtnHidden}" ?non-interactive=${this._isGroup} class="${B(this.classes.overflowButton)}">${s(this._overflowButtonText)}</${y("ui5-button",e,t)}>`:g`<ui5-button .accessibilityAttributes="${s(this._overflowButtonAccAttributes)}" accessible-name="${s(this._overflowButtonAriaLabelText)}" ?hidden="${this._overflowBtnHidden}" ?non-interactive=${this._isGroup} class="${B(this.classes.overflowButton)}">${s(this._overflowButtonText)}</ui5-button>`}var d=function(a,e,t,o){var n=arguments.length,l=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,v;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")l=Reflect.decorate(a,e,t,o);else for(var _=a.length-1;_>=0;_--)(v=a[_])&&(l=(n<3?v(l):n>3?v(e,t,l):v(e,t))||l);return n>3&&l&&Object.defineProperty(e,t,l),l},u;const E="ui5-avatar-group-overflow-btn",Z=`.${E}`,ee={[r.XS]:{[i.Individual]:"0.0625rem",[i.Group]:"-0.75rem"},[r.S]:{[i.Individual]:"0.125rem",[i.Group]:"-1.25rem"},[r.M]:{[i.Individual]:"0.125rem",[i.Group]:"-1.625rem"},[r.L]:{[i.Individual]:"0.125rem",[i.Group]:" -2rem"},[r.XL]:{[i.Individual]:"0.25rem",[i.Group]:"-2.75rem"}};let p=u=class extends ${constructor(){super(),this.type="Group",this.accessibilityAttributes={},this._colorIndex=0,this._hiddenItems=0,this._itemNavigation=new z(this,{getItemsCallback:()=>this._isGroup?[]:this.items.slice(0,this._hiddenStartIndex)}),this._onResizeHandler=this._onResize.bind(this)}static async onDefine(){u.i18nBundle=await U("@ui5/webcomponents")}get hiddenItems(){return this.items.slice(this._hiddenStartIndex)}get colorScheme(){return this.items.map(e=>e.еffectiveBackgroundColor)}get _customOverflowButton(){return this.overflowButton.length?this.overflowButton[0]:void 0}get _ariaLabelText(){const e=this.hiddenItems.length,t=this._isGroup?q:M;let o=u.i18nBundle.getText(t);return o+=` ${u.i18nBundle.getText(j,this._itemsCount-e,e)}`,this._isGroup?o+=` ${u.i18nBundle.getText(I)}`:o+=` ${u.i18nBundle.getText(F)}`,o}get _overflowButtonAriaLabelText(){return this._isGroup?void 0:u.i18nBundle.getText(I)}get _containerAriaHasPopup(){return this._isGroup?this._getAriaHasPopup():void 0}get _overflowButtonAccAttributes(){return{hasPopup:this._isGroup?void 0:this._getAriaHasPopup()}}get _role(){return this._isGroup?"button":"group"}get _hiddenStartIndex(){return this._itemsCount-this._hiddenItems}get _overflowBtnHidden(){return this._hiddenItems===0}get _isGroup(){return this.type===i.Group}get _itemsCount(){return this.items.length}get _groupTabIndex(){return this._isGroup?"0":"-1"}get _overflowButton(){return this.shadowRoot.querySelector(Z)}get _overflowButtonEffectiveWidth(){const e=this._customOverflowButton?this._customOverflowButton:this._overflowButton;if(!e)return 0;if(this._isGroup){let t=this.items[1];const o=t.offsetLeft-this.offsetLeft;return(!t||t.hidden)&&(t=e),this.effectiveDir==="rtl"?this._getWidthToItem(t):o}return e.offsetWidth}get firstAvatarSize(){var e;return((e=this.items[0])==null?void 0:e.size)??r.S}get classes(){return{overflowButton:{"ui5-avatar-group-overflow-btn":!0,"ui5-avatar-group-overflow-btn-xs":this.firstAvatarSize===r.XS,"ui5-avatar-group-overflow-btn-s":this.firstAvatarSize===r.S,"ui5-avatar-group-overflow-btn-m":this.firstAvatarSize===r.M,"ui5-avatar-group-overflow-btn-l":this.firstAvatarSize===r.L,"ui5-avatar-group-overflow-btn-xl":this.firstAvatarSize===r.XL}}}onAfterRendering(){this._overflowItems()}onBeforeRendering(){this._customOverflowButton&&(this._customOverflowButton.nonInteractive=this._isGroup),this._prepareAvatars()}onEnterDOM(){W()&&this.setAttribute("desktop",""),A.register(this,this._onResizeHandler)}onExitDOM(){A.deregister(this,this._onResizeHandler)}_onResize(){this._overflowItems()}_onkeydown(e){this._isGroup&&(P(e)?this._fireGroupEvent(e.target):T(e)&&e.preventDefault())}_onkeyup(e){!e.shiftKey&&T(e)&&this._isGroup&&(this._fireGroupEvent(e.target),e.preventDefault())}_fireGroupEvent(e){const t=e.classList.contains(E)||e===this._customOverflowButton;this.fireEvent("click",{targetRef:e,overflowButtonClicked:t})}_onClick(e){const t=e.target,o=t.hasAttribute("ui5-button");e.stopPropagation(),(this._isGroup||o)&&this._fireGroupEvent(t)}_onUI5Click(e){const t=e.target,o=t.hasAttribute("ui5-avatar");e.stopPropagation(),o&&this._fireGroupEvent(t)}_prepareAvatars(){this._colorIndex=0,this.items.forEach((e,t)=>{const o=this._getNextBackgroundColor();e.interactive=!this._isGroup,e.getAttribute("_color-scheme")||e.setAttribute("_color-scheme",H[`Accent${o}`]),(t!==this._itemsCount-1||this._customOverflowButton)&&(e.style.marginInlineEnd=ee[e.effectiveSize][this.type])})}_onfocusin(e){this._itemNavigation.setCurrentItem(e.target)}_getWidthToItem(e){const t=this.effectiveDir==="rtl",o=e.offsetLeft-this.offsetLeft;if(t){const n=e.offsetParent;return n?n.offsetWidth-e.offsetLeft-e.offsetWidth:0}return o}_overflowItems(){if(this.items.length<2)return;let e=0;for(let t=0;t<this._itemsCount;t++){const o=this.items[t];o.hidden=!1;let n=this._getWidthToItem(o)+o.offsetWidth;if((t!==this._itemsCount-1||this._customOverflowButton)&&(n+=this._overflowButtonEffectiveWidth),n>this.offsetWidth){e=this._itemsCount-t;break}}this._setHiddenItems(e)}_getNextBackgroundColor(){return++this._colorIndex>10&&(this._colorIndex=1),this._colorIndex}_setHiddenItems(e){const t=this._hiddenItems!==e;this._hiddenItems=e,this.items.forEach((o,n)=>{o.hidden=n>=this._hiddenStartIndex}),this._overflowButtonText=`+${e>99?99:e}`,t&&this.fireEvent("overflow")}_getAriaHasPopup(){return this.accessibilityAttributes.hasPopup}};d([w()],p.prototype,"type",void 0);d([w({type:Object})],p.prototype,"accessibilityAttributes",void 0);d([w({noAttribute:!0})],p.prototype,"_overflowButtonText",void 0);d([D({type:HTMLElement,default:!0})],p.prototype,"items",void 0);d([D()],p.prototype,"overflowButton",void 0);p=u=d([R({tag:"ui5-avatar-group",renderer:L,template:K,styles:X,dependencies:[V]}),G("click",{detail:{targetRef:{type:HTMLElement},overflowButtonClicked:{type:Boolean}}}),G("overflow")],p);p.define();const c=O("ui5-avatar-group",["accessibilityAttributes","type"],[],["overflowButton"],["click","overflow"]);c.displayName="AvatarGroup";try{c.displayName="AvatarGroup",c.__docgenInfo={description:`Displays a group of avatars arranged horizontally. It is useful to visually
...
}`,...(x=(k=f.parameters)==null?void 0:k.docs)==null?void 0:x.source}}};const oe=["Default"],we=Object.freeze(Object.defineProperty({__proto__:null,Default:f,__namedExportsOrder:oe,default:te},Symbol.toStringTag,{value:"Module"}));export{we as C,f as D};
