import{j as h}from"./jsx-runtime-D6fbYt3N.js";import{r}from"./index-DysCNOs_.js";import{r as g}from"./index-C4cLd1FO.js";import{s as y}from"./useStylesheet-9EPR2ucC.js";import{I as f}from"./useIsomorphicLayoutEffect-m1Y1SyRb.js";import{M as w}from"./index-BimAlfsQ.js";import{P as D}from"./index-RaHuZLhN.js";import{M as N}from"./index-BDnIOEnZ.js";import{T as C}from"./index-CyEiIB6T.js";import{D as S}from"./index--nLY0eke.js";import{R as _}from"./index-CedtYN8-.js";const u=()=>"randomUUID"in crypto?crypto.randomUUID():window.crypto.getRandomValues(new Uint32Array(1))[0].toString(16);globalThis["@ui5/webcomponents-react"]??(globalThis["@ui5/webcomponents-react"]={});const i=globalThis["@ui5/webcomponents-react"];function d(){return Symbol.for(`@ui5/webcomponents-react/Modals-${f()}/Listeners`)}function p(){return Symbol.for(`@ui5/webcomponents-react/Modals-${f()}`)}const v=[];function b(){var e;return i[e=d()]??(i[e]=[]),i[d()]}function m(){for(const e of b())e()}function c(){var e;return i[e=p()]??(i[e]=v),i[p()]}function V(e){const n=b();return i[d()]=[...n,e],()=>{i[d()]=n.filter(a=>a!==e)}}const l={subscribe:V,getSnapshot:c,getServerSnapshot:()=>v,addModal(e){i[p()]=[...c(),e],m()},removeModal(e){i[p()]=c().filter(n=>n.id!==e),m()}};function q(e,n){const a=u(),o=r.createRef();return l.addModal({Component:S,props:{...e,open:!0,onClose:s=>{typeof e.onClose=="function"&&e.onClose(s),l.removeModal(a)}},ref:o,container:n,id:a}),{ref:o,close:()=>{o.current&&(o.current.open=!1)}}}function M(e,n){const a=u(),o=r.createRef();return l.addModal({Component:D,props:{...e,open:!0,onClose:s=>{typeof e.onClose=="function"&&e.onClose(s),l.removeModal(a)}},ref:o,container:n,id:a}),{ref:o,close:()=>{o.current&&(o.current.open=!1)}}}function T(e,n){const a=u(),o=r.createRef();return l.addModal({Component:_,props:{...e,open:!0,onClose:s=>{typeof e.onClose=="function"&&e.onClose(s),l.removeModal(a)}},ref:o,container:n,id:a}),{ref:o,close:()=>{o.current&&(o.current.open=!1)}}}function R(e,n){const a=u(),o=r.createRef();return l.addModal({Component:N,props:{...e,open:!0,onClose:s=>{typeof e.onClose=="function"&&e.onClose(s),l.removeModal(a)}},ref:o,container:n,id:a}),{ref:o,close:()=>{o.current&&(o.current.open=!1)}}}function A(e,n){const a=u(),o=r.createRef();return l.addModal({Component:w,props:{...e,open:!0,onClose:s=>{typeof e.onClose=="function"&&e.onClose(s),l.removeModal(a)}},ref:o,container:n,id:a}),{ref:o,close:()=>{o.current&&(o.current.open=!1)}}}function E(e,n){const a=r.createRef(),o=u();return l.addModal({Component:C,props:{...e,open:!0,onClose:s=>{typeof e.onClose=="function"&&e.onClose(s),l.removeModal(o)}},ref:a,container:n,id:o}),{ref:a}}function t(){const e=y.useSyncExternalStore(l.subscribe,l.getSnapshot,l.getServerSnapshot);return h.jsx(h.Fragment,{children:e.map(n=>{if(n!=null&&n.Component)return n.container?g.createPortal(r.createElement(n.Component,{...n.props,ref:n.ref,key:n.id,"data-id":n.id}),n.container):r.createElement(n.Component,{...n.props,ref:n.ref,key:n.id,"data-id":n.id})})})}t.displayName="Modals";t.showDialog=q;t.showPopover=M;t.showResponsivePopover=T;t.showMenu=R;t.showMessageBox=A;t.showToast=E;try{t.displayName="Modals",t.__docgenInfo={description:`Utility class for opening modals in an imperative way.
...
**Note:** Upon resizing, externally defined height and width styling will be ignored.`,name:"resizable",required:!1,type:{name:"boolean"}},state:{defaultValue:{value:'"None"'},description:'Defines the state of the `Dialog`.\n\n**Note:** If `"Negative"` and `"Critical"` states is set, it will change the\naccessibility role to "alertdialog", if the accessibleRole property is set to `"Dialog"`.',name:"state",required:!1,type:{name:"enum",value:[{value:'"None"'},{value:'"Positive"'},{value:'"Critical"'},{value:'"Negative"'},{value:'"Information"'},{value:'"None"'},{value:'"Positive"'},{value:'"Critical"'},{value:'"Negative"'},{value:'"Information"'}]}},stretch:{defaultValue:{value:"false"},description:`Determines whether the component should be stretched to fullscreen.
