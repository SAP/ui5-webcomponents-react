import{w,j as e,r as v}from"./iframe-CG2rGjbc.js";import{S,a as r}from"./index-BOnPAue0.js";import"./Search-D9SuIbQK.js";const t=w("ui5-search",["accessibleDescription","accessibleName","placeholder","value"],["loading","noTypeahead","open","showClearIcon"],["action","filterButton","illustration","messageArea","scopes"],["close","input","open","scope-change","search"]);t.displayName="Search";try{t.displayName="Search",t.__docgenInfo={description:`A \`Search\` is an input with suggestions, used for user search.
...
}`,...(f=(m=a.parameters)==null?void 0:m.docs)==null?void 0:f.source}}};const C=["Default","WithScopeAndItems"],U=Object.freeze(Object.defineProperty({__proto__:null,Default:n,WithScopeAndItems:a,__namedExportsOrder:C,default:_},Symbol.toStringTag,{value:"Module"}));export{U as C,n as D,a as W};
