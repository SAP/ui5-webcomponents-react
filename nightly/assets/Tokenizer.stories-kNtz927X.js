import{w as g,j as e,r as u,J as y}from"./iframe-BxIaMIJ2.js";import{L as T}from"./index-BSQj9ICh.js";import{T as n}from"./index-DadpQyJK.js";import"./Token-DKlGFJle.js";const o=g("ui5-tokenizer",["accessibleName","accessibleNameRef"],["disabled","multiLine","readonly","showClearAll"],[],["selection-change","token-delete"]);o.displayName="Tokenizer";try{o.displayName="Tokenizer",o.__docgenInfo={description:`A \`Tokenizer\` is an invisible container for \`Token\`s that supports keyboard navigation and token selection.
