import{j as e}from"./jsx-runtime-DEdD30eg.js";import"./index-Cjg5BcNW.js";import{F as k}from"./index-B8hyS_5D.js";import{T as $}from"./index-CHNB8-uH.js";import"./index-C_4wwPiO.js";import{r as l}from"./index-RYns6xqu.js";import{c as pe}from"./clsx-B-dksMZM.js";import{B as ye}from"./Button-BoqZ1Nk6.js";import{u as J}from"./withWebComponent-BS26LpJo.js";import{f as he}from"./Icon-BwGmtu7y.js";import"./vertical-grip-BWLwmPmT.js";import{u as _e,a9 as Y}from"./i18n-defaults-CD7M3G7m.js";import{u as Se}from"./useIsRTL-DtzqLicj.js";import{u as K}from"./useStylesheet-CIcp3lSM.js";import{u as be}from"./useCurrentTheme-KnTl4Oiu.js";import{B as m}from"./index-P1IZkdfp.js";import{I as xe}from"./index-WgZpfqk2.js";import{d as ve}from"./debounce-D7W5PopO.js";import{u as Q}from"./useIsomorphicLayoutEffect-BErBnqdY.js";import{h as Z}from"./Keys-D1SxbTOd.js";import{L as ze}from"./index-D5w6Jnaw.js";import{a as we,S as ee}from"./index-CLoYl4Ag.js";const te="vertical-grip",me=l.createContext({vertical:!0,reset:!1}),Ce={packageName:"@ui5/webcomponents-react",fileName:"SplitterElement.module.css",content:"@layer ui5-webcomponents-react{._splitterElement_5jt3n_1{display:flex;min-height:0;min-width:0;overflow:hidden;position:relative;will-change:flex-basis}}"},ke={splitterElement:"_splitterElement_5jt3n_1"},r=l.forwardRef((n,u)=>{const{children:o,style:_,className:v,minSize:t=0,size:a="auto",resizable:c,...z}=n,[E,R]=J(u),{vertical:S,reset:C}=l.useContext(me),i=Z()?{width:"min-content",flex:"1 1 auto"}:{},w=a!=="auto"?{flex:`0 1 ${a}`}:{flex:"1 0 min-content",...i},[B,s]=l.useState(w),[V,j]=l.useState(!1);return K(Ce,r.displayName),l.useEffect(()=>{const L=new ResizeObserver(([A])=>{if(A.target.getBoundingClientRect().width!==0&&!V){const G=Z()?{width:"unset"}:{};s({flex:`0 0 ${A.target.getBoundingClientRect()[S?"height":"width"]}px`,...G}),j(!0)}});return a==="auto"&&R.current?L.observe(R.current):s({flex:`0 1 ${a}`}),()=>{L.disconnect()}},[a,V,S]),Q(()=>{C&&(s(void 0),j(!1))},[C,a]),Q(()=>{B===void 0&&s(w)},[B]),e.jsx("div",{ref:E,className:pe(ke.splitterElement,v),style:{minHeight:S&&t?`${t}px`:void 0,minWidth:!S&&t?`${t}px`:void 0,...B,..._},...z,"data-min-size":t,children:o})});r.displayName="SplitterElement";try{r.displayName="SplitterElement",r.__docgenInfo={description:"The `SplitterElement` holds the component of the content area. Allowed size values are of the type css property width or\nheight according to the orientation of the `SplitterLayout`. If `size` isn't passed to the element, the width or\nheight of the content area will be calculated automatically according to the size of the given `SplitterLayout`.\nThe `minSize` defines the minimum width or height of the area and is set to 0 when no minimum size is given, so the\ncontent can be completely collapsed.",displayName:"SplitterElement",props:{resizable:{defaultValue:null,description:"Defines whether a resizer element is displayed.\n\nIf the next `SplitterElement` has the prop `resizable={false}`, no resizer element will be shown after this\n`SplitterElement`. The resizer element is only shown when all siblings of the resizer are resizable.\nDefault value of resizable is `true`.",name:"resizable",required:!1,type:{name:"boolean"}},size:{defaultValue:{value:'`"auto"`'},description:"Defines the initial size of the `SplitterElement`.",name:"size",required:!1,type:{name:"string | number | (string & {})"}},minSize:{defaultValue:{value:"`0`"},description:"Defines the minimum size of the `SplitterElement`. The resizer element stops when the minimum size is reached.",name:"minSize",required:!1,type:{name:"number"}},children:{defaultValue:null,description:"Defines the content which is shown inside the `SplitterElement`.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},style:{defaultValue:null,description:`Element style which will be appended to the most outer element of a component.
...
}`,...(de=(ue=U.parameters)==null?void 0:ue.docs)==null?void 0:de.source}}};const Ue=["Default","LimitedAreas","Nested"],pt=Object.freeze(Object.defineProperty({__proto__:null,Default:O,LimitedAreas:P,Nested:U,__namedExportsOrder:Ue,default:Pe},Symbol.toStringTag,{value:"Module"}));export{pt as C,O as D,P as L,U as N,r as S};
