import{j as o}from"./jsx-runtime-D_zvdyIk.js";import{i as _}from"./utils-D-RqbMW2.js";import{r as C}from"./index-U0ga5oGA.js";import{B as D}from"./index-C2cs6waD.js";import{a as R,C as r}from"./index-BxNpFtrh.js";import{h as S,j as u,p as g,d as T,s as h,m as O,y as N,B as x,w as k}from"./jsx-runtime-2NO35c9p.js";import{d as E}from"./slot-_4yKMUwC.js";import{l as b}from"./event-strict-DgQLNDEV.js";import{i as I}from"./i18n-CjR4HGlq.js";import{e as q}from"./Popover-DHgn1IwJ.js";import{d as j}from"./CustomElementsScope-BZQ-yqK5.js";import{a as V}from"./Title-l18RNg85.js";import{a as A}from"./Button-DsiN4KEf.js";import{R as B}from"./ResponsivePopover-DbareGdm.js";import{d as M}from"./parameters-bundle.css-D0uTR4GL.js";import{R as U}from"./ResponsivePopoverCommon.css-D8oCtj4w.js";import{an as L,ao as F}from"./i18n-defaults-Wx6G1HAa.js";function Y(){return S(B,{hideArrow:!0,contentOnlyOnDesktop:!0,placement:"Bottom",opener:this.opener,open:this._open,onClose:this.onAfterClose,onOpen:this.onAfterOpen,children:[u("div",{slot:"header",class:"ui5-cp-header",children:u(V,{level:"H1",wrappingType:"None",children:this._colorPaletteTitle})}),u("div",{children:u(R,{showMoreColors:this.showMoreColors,showRecentColors:this.showRecentColors,showDefaultColor:this.showDefaultColor,defaultColor:this.defaultColor,popupMode:!0,onItemClick:this.onSelectedColor,children:this.colorPaletteColors.map(t=>u("slot",{name:t._individualSlot}))})}),u("div",{slot:"footer",class:"ui5-cp-footer",children:u(A,{design:"Transparent",onClick:this.closePopover,children:this._cancelButtonLabel})})]})}g("@ui5/webcomponents-theming","sap_horizon",async()=>T);g("@ui5/webcomponents","sap_horizon",async()=>M);const H=`.ui5-cp-header{width:100%;height:var(--_ui5-v2-12-0_color-palette-button-height);display:flex;align-items:center}.ui5-cp-footer{width:100%;display:flex;justify-content:flex-end;align-items:center;margin:.1875rem 0}[ui5-responsive-popover]::part(content){padding:0}.ui5-cp-item-container{padding:.3125rem .6875rem}
