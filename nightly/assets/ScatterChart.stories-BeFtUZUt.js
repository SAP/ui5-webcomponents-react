import{g as ne,h as oe,t as ie,l as re}from"./DemoProps-JoqQtnsn.js";import{j as e,r as x,ap as se,o as j}from"./iframe-D1CS9P6r.js";import{T as w}from"./ThemingParameters-pyhX3s39.js";import{X as D,Y as V,a as le,u as ce,C as de,c as he,b as pe}from"./YAxisTicks-CBb-o2cx.js";import{u as ue,x as me,t as fe,a as ge,b as ye,e as be}from"./staticProps-CJfbstaq.js";import{u as Ce}from"./useLongestYAxisLabel-BaGbnwPt.js";import{u as ve,a as xe}from"./useTooltipFormatter-9W2Ko2WX.js";import{k as we,l as ke,m as Se,n as Ae,R as L,T as _e}from"./ChartContainer-DVqWnXFw.js";import{C as Pe}from"./react-content-loader.es-Bpwng07w.js";import{S as z,Z as T}from"./Scatter-BqV6SsES.js";import{u as je}from"./useIsRTL-DcXN3FqO.js";var Le=we({chartName:"ScatterChart",GraphicalChild:z,defaultTooltipEventType:"item",validateTooltipEventTypes:["item"],axisComponents:[{axisType:"xAxis",AxisComp:D},{axisType:"yAxis",AxisComp:V},{axisType:"zAxis",AxisComp:T}],formatAxisMap:ke});const b=n=>e.jsxs(Pe,{viewBox:"0 0 165 145",preserveAspectRatio:"xMidYMid meet",width:"100%",height:"100%",speed:2,backgroundColor:w.sapContent_ImagePlaceholderBackground,foregroundColor:w.sapContent_ImagePlaceholderForegroundColor,backgroundOpacity:w.sapContent_DisabledOpacity,...n,children:[e.jsx("rect",{x:"10",y:"135",width:"135",height:"1"}),e.jsx("circle",{cx:"20",cy:"90",r:"2"}),e.jsx("circle",{cx:"40",cy:"58",r:"3"}),e.jsx("circle",{cx:"60",cy:"108",r:"14"}),e.jsx("circle",{cx:"85",cy:"87",r:"8"}),e.jsx("circle",{cx:"105",cy:"50",r:"6"}),e.jsx("circle",{cx:"125",cy:"115",r:"4"}),e.jsx("circle",{cx:"78",cy:"58",r:"10"}),e.jsx("circle",{cx:"28",cy:"115",r:"4"})]});try{b.displayName="ScatterChartPlaceholder",b.__docgenInfo={description:"",displayName:"ScatterChartPlaceholder",props:{}}}catch{}try{b.displayName="ScatterChartPlaceholder",b.__docgenInfo={description:"",displayName:"ScatterChartPlaceholder",props:{}}}catch{}const De={formatter:be},c=x.forwardRef((n,I)=>{const{dataset:C,loading:q,loadingDelay:N,noLegend:R,noAnimation:E,tooltipConfig:A,onDataPointClick:d,onLegendClick:O,onClick:k,style:M,className:W,slot:F,ChartPlaceholder:B,children:H,...U}=n,a={yAxisVisible:!1,xAxisVisible:!0,gridStroke:w.sapList_BorderColor,gridHorizontal:!0,gridVertical:!1,legendPosition:"bottom",legendHorizontalAlign:"left",zoomingTool:!1,resizeDebounce:250,...n.chartConfig},{referenceLine:r,referenceLineX:s}=a,{measures:v}=ve([],n.measures,{},De),Y=xe(v),[K,_]=se(I),l=x.useRef(!1),X=ue(O),$=x.useCallback((t,p)=>{typeof k=="function"&&!l.current&&k(j(p,{payload:t?.activePayload?.[0]?.payload,activePayloads:t?.activePayload})),l.current&&(l.current=!1)},[k,l.current]),G=x.useCallback((t,p,ae)=>{t&&d&&(d(j(ae,{value:t.node,dataKey:t.zAxis.dataKey,dataIndex:p,payload:t.payload})),l.current=!0)},[d,l.current]),Z=C?.length>30,i=v.find(({axis:t})=>t==="x"),o=v.find(({axis:t})=>t==="y"),h=v.find(({axis:t})=>t==="z"),[P,J]=Ce(C?.[0]?.data,[o],a.legendPosition),Q=le(_,1),ee=ce(a.margin,a.zoomingTool),{chartConfig:Te,measures:Ie,...te}=U,S=je(_);return e.jsx(Se,{dataset:C,loading:q,loadingDelay:N,Placeholder:B??b,ref:K,style:M,className:W,slot:F,resizeDebounce:a.resizeDebounce,...te,children:e.jsxs(Le,{onClick:$,margin:ee,accessibilityLayer:a.accessibilityLayer,className:typeof d=="function"?"has-click-handler":void 0,children:[e.jsx(de,{vertical:a.gridVertical,horizontal:a.gridHorizontal,stroke:a.gridStroke}),a.xAxisVisible&&e.jsx(D,{type:"number",name:i?.label,dataKey:i?.accessor,xAxisId:0,interval:i?.interval??(Z?"preserveStart":0),tick:e.jsx(he,{formatter:i?.formatter}),padding:me,height:Q[0],reversed:S,label:i?.label?{value:i?.label,dy:15,position:"insideRight"}:0},typeof i?.accessor!="function"?i?.accessor:i?.label),e.jsx(V,{label:o?.label?{value:o?.label,angle:-90,position:S?"insideRight":"insideLeft"}:null,type:"number",name:o?.label,axisLine:a.yAxisVisible,tickLine:fe,dataKey:o?.accessor,interval:0,tick:e.jsx(pe,{formatter:o?.formatter}),width:o?.label?P+10:P,orientation:S===!0?"right":"left"},typeof o?.accessor!="function"?o?.accessor:o?.label),e.jsx(T,{name:h?.label,dataKey:h?.accessor,range:[0,5e3]},typeof h?.accessor!="function"?h?.accessor:h?.label),C?.map((t,p)=>e.jsx(z,{className:typeof d=="function"?"has-click-handler":void 0,onMouseDown:G,opacity:t.opacity,data:t?.data,name:t?.label,fill:t?.color??`var(--sapChart_OrderedColor_${p%12+1})`,isAnimationActive:!E},t?.label)),!R&&e.jsx(Ae,{verticalAlign:a.legendPosition,align:a.legendHorizontalAlign,onClick:X,wrapperStyle:J,...a.legendConfig}),r&&e.jsx(L,{...r,stroke:r?.color??r?.stroke,y:r?.value??r?.y,label:r?.label}),s&&e.jsx(L,{...s,stroke:s?.color??s?.stroke,x:s?.value??s?.x,label:s?.label}),A?.active!==!1&&e.jsx(_e,{cursor:ye,formatter:Y,contentStyle:ge,...A}),H]})})});c.displayName="ScatterChart";try{c.displayName="ScatterChart",c.__docgenInfo={description:`
...
__Note:__ It is possible to override internally used tooltip props, so please use with caution!`,name:"tooltipConfig",required:!1,type:{name:"TooltipProps<string | number | (string | number)[], string | number>"}},ChartPlaceholder:{defaultValue:null,description:`Injects a custom loading placeholder which is used when no data are available. If the property isn't set the
standard loading placeholder of the specific chart is used.`,name:"ChartPlaceholder",required:!1,type:{name:"ComponentType"}}}}}catch{}const Ve={title:"ScatterChart",component:c,argTypes:{children:{control:{disable:!0}}},args:{dataset:ne,measures:[{accessor:"users",label:"Users",axis:"x"},{accessor:"sessions",label:"Sessions",formatter:n=>`${n}k`,axis:"y"},{accessor:"volume",axis:"z"}]}},u={},m={args:{dataset:oe,measures:[{accessor:"users",label:"Users",axis:"x"},{accessor:"sessions",label:"Sessions",axis:"y"},{accessor:"volume",axis:"z"}]}},f={args:{dataset:[]}},g={args:ie},y={args:re};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:"{}",...u.parameters?.docs?.source}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
