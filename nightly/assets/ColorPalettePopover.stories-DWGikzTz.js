import{j as o}from"./jsx-runtime-D_zvdyIk.js";import{i as _}from"./utils-DkCt3A4F.js";import{r as C}from"./index-U0ga5oGA.js";import{B as D}from"./index-CK7zNLqv.js";import{a as R,C as r}from"./index-DwaBOtSU.js";import{h as S,j as u,p as g,d as T,s as h,m as O,y as N,E as x,w as k}from"./jsx-runtime-CTdjW1dy.js";import{d as E}from"./slot-_4yKMUwC.js";import{l as b}from"./event-strict-DgQLNDEV.js";import{i as I}from"./i18n-CjR4HGlq.js";import{e as q}from"./Popover-D3TB1XeJ.js";import{d as j}from"./CustomElementsScope-BI7irdrP.js";import{a as V}from"./Title-JqJU4F4n.js";import{a as A}from"./Button-CddyUUJt.js";import{R as M}from"./ResponsivePopover-CSpqicr4.js";import{d as B}from"./parameters-bundle.css-CKhNLE8L.js";import{R as U}from"./ResponsivePopoverCommon.css-CrKOj95L.js";import{an as L,ao as F}from"./i18n-defaults-Bwpyempw.js";function Y(){return S(M,{hideArrow:!0,contentOnlyOnDesktop:!0,placement:"Bottom",opener:this.opener,open:this._open,onClose:this.onAfterClose,onOpen:this.onAfterOpen,children:[u("div",{slot:"header",class:"ui5-cp-header",children:u(V,{level:"H1",wrappingType:"None",children:this._colorPaletteTitle})}),u("div",{children:u(R,{showMoreColors:this.showMoreColors,showRecentColors:this.showRecentColors,showDefaultColor:this.showDefaultColor,defaultColor:this.defaultColor,popupMode:!0,onItemClick:this.onSelectedColor,children:this.colorPaletteColors.map(t=>u("slot",{name:t._individualSlot}))})}),u("div",{slot:"footer",class:"ui5-cp-footer",children:u(A,{design:"Transparent",onClick:this.closePopover,children:this._cancelButtonLabel})})]})}g("@ui5/webcomponents-theming","sap_horizon",async()=>T);g("@ui5/webcomponents","sap_horizon",async()=>B);const H=`.ui5-cp-header{width:100%;height:var(--_ui5-v2-11-0_color-palette-button-height);display:flex;align-items:center}.ui5-cp-footer{width:100%;display:flex;justify-content:flex-end;align-items:center;margin:.1875rem 0}[ui5-responsive-popover]::part(content){padding:0}.ui5-cp-item-container{padding:.3125rem .6875rem}
