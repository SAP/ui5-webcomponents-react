import"./List-CxytAChQ.js";import{w as o}from"./withWebComponent-CjthvP8A.js";const e=o("ui5-li-group",["headerAccessibleName","headerText"],[],["header"],["move-over","move"]);e.displayName="ListItemGroup";try{e.displayName="ListItemGroup",e.__docgenInfo={description:`The \`ListItemGroup\` is a special list item, used only to create groups of list items.
