import{j as i}from"./jsx-runtime-D_zvdyIk.js";import{r as q}from"./index-U0ga5oGA.js";import{P as L}from"./index-GYOhI-mh.js";import{a as P,T as N}from"./index-Dw58ABZm.js";import{p as S,d as F,j as C,s as u,m as _,y as k,w as T,E as M}from"./jsx-runtime-CTdjW1dy.js";import{d as B}from"./slot-_4yKMUwC.js";import{l as O}from"./event-strict-DgQLNDEV.js";import{d as z}from"./parameters-bundle.css-CKhNLE8L.js";import{S as H}from"./Select-DoiT59jx.js";import{O as G}from"./Option-CgLQMwAq.js";import{T as x,a as J}from"./ToolbarButton-DT8pLMZn.js";S("@ui5/webcomponents-theming","sap_horizon",async()=>F);S("@ui5/webcomponents","sap_horizon",async()=>z);const K=`:host(:not([hidden])){width:100%}.ui5-tb-popover-item{width:inherit}
`;function Q(){return C(H,{class:this.classes.root,style:this.styles,"data-ui5-external-action-item-id":this._id,valueState:this.valueState,disabled:this.disabled,accessibleName:this.accessibleName,accessibleNameRef:this.accessibleNameRef,onClick:(...t)=>this.onClick(...t),onClose:(...t)=>this.onClose(...t),onOpen:(...t)=>this.onOpen(...t),onChange:(...t)=>this.onChange(...t),children:this.options.map((t,e)=>C(G,{selected:t.selected,"data-ui5-external-action-item-index":e,children:t.textContent}))})}var m=function(t,e,n,a){var l=arguments.length,o=l<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,n):a,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,n,a);else for(var s=t.length-1;s>=0;s--)(r=t[s])&&(o=(l<3?r(o):l>3?r(e,n,o):r(e,n))||o);return l>3&&o&&Object.defineProperty(e,n,o),o};let c=class extends x{constructor(){super(...arguments),this.valueState="None",this.disabled=!1}onClick(e){e.stopImmediatePropagation(),!this.fireDecoratorEvent("click",{targetRef:e.target})&&!this.preventOverflowClosing&&this.fireDecoratorEvent("close-overflow")}onOpen(e){e.stopImmediatePropagation(),!this.fireDecoratorEvent("open",{targetRef:e.target})&&this.fireDecoratorEvent("close-overflow")}onClose(e){e.stopImmediatePropagation(),!this.fireDecoratorEvent("close",{targetRef:e.target})&&this.fireDecoratorEvent("close-overflow")}onChange(e){e.stopImmediatePropagation(),!this.fireDecoratorEvent("change",{...e.detail,targetRef:e.target})||this.fireDecoratorEvent("close-overflow"),this._syncOptions(e.detail.selectedOption)}_syncOptions(e){const n=Number(e==null?void 0:e.getAttribute("data-ui5-external-action-item-index"));this.options.forEach((a,l)=>{l===n?a.setAttribute("selected",""):a.removeAttribute("selected")})}get styles(){return{width:this.width}}};m([u()],c.prototype,"width",void 0);m([B({default:!0,type:HTMLElement,invalidateOnChildChange:!0})],c.prototype,"options",void 0);m([u()],c.prototype,"valueState",void 0);m([u({type:Boolean})],c.prototype,"disabled",void 0);m([u()],c.prototype,"accessibleName",void 0);m([u()],c.prototype,"accessibleNameRef",void 0);c=m([_({tag:"ui5-toolbar-select",template:Q,renderer:k,styles:K}),O("change",{bubbles:!0,cancelable:!0}),O("open",{bubbles:!0}),O("close")],c);c.define();const d=T("ui5-toolbar-select",["accessibleName","accessibleNameRef","overflowPriority","valueState","width"],["disabled","preventOverflowClosing"],[],["change","close","open"]);d.displayName="ToolbarSelect";try{d.displayName="ToolbarSelect",d.__docgenInfo={description:'The `ToolbarSelect` component is used to create a toolbar drop-down list.\nThe items inside the `ToolbarSelect` define the available options by using the `ToolbarSelectOption` component.\n\n\n\n`import "@ui5/webcomponents/dist/ToolbarSelectOption.js";` (comes with `ToolbarSelect`)\n\n__Note__: This is a UI5 Web Component! [Repository](https://github.com/SAP/ui5-webcomponents) | [Documentation](https://sap.github.io/ui5-webcomponents/)',displayName:"ToolbarSelect",props:{children:{defaultValue:null,description:`Defines the component options.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function X(){return C("div",{class:"ui5-tb-separator ui5-tb-item","data-ui5-external-action-item-id":this._id})}S("@ui5/webcomponents-theming","sap_horizon",async()=>F);S("@ui5/webcomponents","sap_horizon",async()=>z);const Y=`.ui5-tb-separator{height:var(--_ui5-v2-11-0-toolbar-separator-height);width:.0625rem;background:var(--sapToolbar_SeparatorColor);box-sizing:border-box}
`;var W=function(t,e,n,a){var l=arguments.length,o=l<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,n):a,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,n,a);else for(var s=t.length-1;s>=0;s--)(r=t[s])&&(o=(l<3?r(o):l>3?r(e,n,o):r(e,n))||o);return l>3&&o&&Object.defineProperty(e,n,o),o};let y=class extends x{constructor(){super(...arguments),this.visible=!1}get isSeparator(){return!0}get isInteractive(){return!1}};W([u({type:Boolean})],y.prototype,"visible",void 0);y=W([_({tag:"ui5-toolbar-separator",template:X,renderer:k,styles:[Y]})],y);y.define();const f=T("ui5-toolbar-separator",["overflowPriority"],["preventOverflowClosing"],[],[]);f.displayName="ToolbarSeparator";try{f.displayName="ToolbarSeparator",f.__docgenInfo={description:`The \`ToolbarSeparator\` is an element, used for visual separation between two elements.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var D;(function(t){t.Start="Start",t.End="End"})(D||(D={}));const Z={title:"Layouts & Floorplans / Toolbar",component:P,argTypes:{children:{control:{disable:!0}}},args:{alignContent:D.Start},tags:["package:@ui5/webcomponents"]},v={render:t=>i.jsxs(P,{...t,children:[i.jsx(N,{text:"Button 1"}),i.jsxs(d,{children:[i.jsx(p,{children:"Option 1"}),i.jsx(p,{children:"Option 2"}),i.jsx(p,{children:"Option 3"})]}),i.jsx(f,{}),i.jsx(h,{}),i.jsx(f,{}),i.jsx(N,{text:"Button 2"}),i.jsxs(d,{children:[i.jsx(p,{children:"Option 1"}),i.jsx(p,{children:"Option 2"}),i.jsx(p,{children:"Option 3"})]})]})},b={name:"Opening Popovers via ToolbarButton",render(t){const[e,n]=q.useState(!1),a=q.useRef(null);return i.jsxs(i.Fragment,{children:[i.jsx(P,{...t,children:i.jsx(N,{onClick:l=>{const{targetRef:o}=l.detail;a.current&&(a.current.opener=o,n(!0))},text:"Open Popover"})}),i.jsx(L,{open:e,ref:a,onClose:()=>{n(!1)},children:"Content"})]})}};var V,I,j;v.parameters={...v.parameters,docs:{...(V=v.parameters)==null?void 0:V.docs,source:{originalSource:`{
...
}`,...(j=(I=v.parameters)==null?void 0:I.docs)==null?void 0:j.source}}};var A,E,U;b.parameters={...b.parameters,docs:{...(A=b.parameters)==null?void 0:A.docs,source:{originalSource:`{
...
}`,...(U=(E=b.parameters)==null?void 0:E.docs)==null?void 0:U.source}}};const ee=["Default","OpenPopover"],ve=Object.freeze(Object.defineProperty({__proto__:null,Default:v,OpenPopover:b,__namedExportsOrder:ee,default:Z},Symbol.toStringTag,{value:"Module"}));export{ve as C,v as D,b as O,d as T,p as a,f as b,h as c};
