import{j as e}from"./jsx-runtime-CLpGMVip.js";import{r as d,C as p}from"./utils-5ouIlTbN.js";import{w as h,o as s,j as a}from"./withWebComponent-DbOtF11K.js";import{a as i}from"./Button-Df0TC0Md.js";import{D as f}from"./Dialog-B5eXWXJL.js";import{C}from"./ColorPicker-DmSS2cNa.js";import{K as g,N as P,O as _}from"./i18n-defaults-Do22Zz-4.js";import{C as t}from"./index-DsKd-CmO.js";const o=h("ui5-color-palette",[],[],[],["item-click"]);o.displayName="ColorPalette";try{o.displayName="ColorPalette",o.__docgenInfo={description:`The \`ColorPalette\` provides the users with a range of predefined colors. The colors are fixed and do not change with the theme.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function b(){return s(f,{headerText:this.colorPaletteDialogTitle,children:[a("div",{class:"ui5-cp-dialog-content",children:a(C,{})}),s("div",{slot:"footer",class:"ui5-cp-dialog-footer",children:[a(i,{design:"Emphasized",onClick:this._chooseCustomColor,children:this.colorPaletteDialogOKButton}),a(i,{design:"Transparent",onClick:this._closeDialog,children:this.colorPaletteCancelButton})]})]})}class l extends p{get template(){return b}get colorPaletteDialogTitle(){return l.i18nBundle.getText(g)}get colorPaletteDialogOKButton(){return l.i18nBundle.getText(P)}get colorPaletteCancelButton(){return l.i18nBundle.getText(_)}}d("ColorPaletteMoreColors",l);const y={title:"Data Display / ColorPalette",component:o,argTypes:{children:{control:{disable:!0}}},args:{},tags:["package:@ui5/webcomponents"]},n={render:r=>e.jsxs(o,{...r,children:[e.jsx(t,{value:"darkblue"}),e.jsx(t,{value:"pink"}),e.jsx(t,{value:"#444444"}),e.jsx(t,{value:"rgb(0,200,0)"}),e.jsx(t,{value:"green"}),e.jsx(t,{value:"darkred"}),e.jsx(t,{value:"yellow"}),e.jsx(t,{value:"blue"}),e.jsx(t,{value:"cyan"}),e.jsx(t,{value:"orange"}),e.jsx(t,{value:"#5480e7"}),e.jsx(t,{value:"#ff6699"})]})};var c,u,m;n.parameters={...n.parameters,docs:{...(c=n.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: args => {
...
}`,...(m=(u=n.parameters)==null?void 0:u.docs)==null?void 0:m.source}}};const v=["Default"],O=Object.freeze(Object.defineProperty({__proto__:null,Default:n,__namedExportsOrder:v,default:y},Symbol.toStringTag,{value:"Module"}));export{O as C,n as D};
