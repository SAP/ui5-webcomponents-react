import{az as oe,fb as re,r as g,j as n,o as B,Q as j,J as T}from"./iframe-DofHecbS.js";import{d as ie}from"./Friends500-CRbR9XAn.js";import{A as b,d as Z,g as le,m as de,e as S,f as ce}from"./AnalyticalTable.stories-Q-Brjg83.js";import{a as ue}from"./Input-N_-j7LxY.js";import{F as w,c as A,a as me}from"./index-2GOtqWe8.js";import{T as H}from"./index-SKTvANbT.js";import{C as ee}from"./index-BFWBQ7NN.js";import{L as x}from"./index-C1xP7ttJ.js";import{d as ge}from"./debounce-D7W5PopO.js";import{I as he}from"./index-fNtdlXtU.js";const ae=e=>{const o=oe("@ui5/webcomponents").getText(re),r=g.useCallback((c,{cell:{value:t}})=>typeof t!="number"&&!t?[c,{"aria-label":`${c["aria-label"]} ${o}`}]:c,[o]);e.getCellProps.push(r)};ae.pluginName="useAnnounceEmptyCells";const fe=(e,a)=>{let o=e.lastIndexOf(".");o===-1&&(o=1/0);const r=e.slice(0,o);return[a[r],o]},ne=e=>{const a={},o=e.lastIndexOf(".");return a[e]=!0,o!==-1&&Object.assign(a,ne(e.slice(0,o))),a},pe=(e,a,o)=>{const r={};let c="";const t=(u,s=null)=>{for(const i of u)if(i.subRows.length>0)t(i.subRows,i.id);else if(s!==null&&c!==s){c=s;const l=d=>{const[m,f]=fe(d,a),p=m.subRows.filter(y=>o.selectedRowIds[y.id]),h=m.subRows.length===p.length;if(p.length>0&&!h){const y=m.id;Object.assign(r,ne(y));return}f!==1/0&&l(m.id)};l(i.id)}};return t(e),r},N=e=>{const a=(t,{row:u,instance:s})=>{var l,d;let i;return s.isAllRowsSelected?i=!1:i=((d=(l=s==null?void 0:s.state)==null?void 0:l.indeterminateRows)==null?void 0:d[u.id])??!1,t.checked&&!s.state.selectedRowIds[u.id]&&u.toggleRowSelected(!0),[t,{indeterminate:i,checked:i?!0:t.checked}]},o=(t,u,s,i)=>{const{rowsById:l,state:d,rows:m}=i;if(u.type==="INDETERMINATE_ROW_IDS"){if(u.payload==="reset")return{...t,indeterminateRows:{}};const f=pe(m,l,d);return{...t,indeterminateRows:f}}},r=t=>{const{data:u,dispatch:s,rowsById:i,state:{selectedRowIds:l,indeterminateRows:d},webComponentsReactProperties:{selectionMode:m,selectionBehavior:f,isTreeTable:p}}=t;g.useEffect(()=>{p&&m===b.Multiple&&f!==Z.RowOnly&&Object.keys(l).length&&Object.keys(i).length!==Object.keys(l).length?s({type:"INDETERMINATE_ROW_IDS"}):typeof d=="object"&&Object.keys(d).length&&s({type:"INDETERMINATE_ROW_IDS",payload:"reset"})},[u,l,p,m,f]),g.useEffect(()=>{typeof e=="function"&&d&&e({indeterminateRowsById:d,tableInstance:t})},[d])},c=t=>{t.getToggleRowSelectedProps.push(a),t.stateReducers.push(o),t.useInstanceAfterData.push(r)};return c.pluginName="useIndeterminate",c};try{N.displayName="useIndeterminateRowSelection",N.__docgenInfo={description:"A plugin hook that marks parent rows as indeterminate if a child row is selected in `Multiple` mode.\nWhen using this hook, it is recommended to also select all sub-rows when selecting a row. (`reactTableOptions={{ selectSubRows: true }}`)\n\n__Note:__ The `indeterminate` state has a higher priority than the `selected` state. Therefore, a row can be selected and indeterminate at the same time. This can for example happen, if `selectSubRows: true` is set and a row with sub-rows is selected and then a sub-row is unselected.\n\n__Note:__ This hook has to traverse the whole data tree on each selection, which can lead to performance degradation with large datasets. Please use with caution!",displayName:"useIndeterminateRowSelection",props:{}}}catch{}try{N.displayName="useIndeterminateRowSelection",N.__docgenInfo={description:"A plugin hook that marks parent rows as indeterminate if a child row is selected in `Multiple` mode.\nWhen using this hook, it is recommended to also select all sub-rows when selecting a row. (`reactTableOptions={{ selectSubRows: true }}`)\n\n__Note:__ The `indeterminate` state has a higher priority than the `selected` state. Therefore, a row can be selected and indeterminate at the same time. This can for example happen, if `selectSubRows: true` is set and a row with sub-rows is selected and then a sub-row is unselected.\n\n__Note:__ This hook has to traverse the whole data tree on each selection, which can lead to performance degradation with large datasets. Please use with caution!",displayName:"useIndeterminateRowSelection",props:{}}}catch{}const be=(e="isSelected")=>{const a=({flatRows:r,toggleRowSelected:c})=>{g.useEffect(()=>{r.forEach(({id:t,original:u})=>{e in u&&c(t,u.isSelected)})},[r,e])},o=r=>{r.useInstanceAfterData.push(a)};return o.pluginName="useManualRowSelect",o},Se=(e,a)=>{const o=ge(e,(a==null?void 0:a.wait)??100),r=t=>{const{state:u,columns:s}=t,{columnResizing:i}=u,{isResizingColumn:l,columnWidths:d}=i,m=g.useRef(void 0);g.useEffect(()=>{if(l&&(a!=null&&a.liveUpdate)){const f=s.find(p=>p.id===l);o({columnWidth:d[l],header:f})}},[i,a==null?void 0:a.liveUpdate,s]),g.useEffect(()=>{if(a!=null&&a.liveUpdate)return()=>o.cancel()},[a==null?void 0:a.liveUpdate]),g.useEffect(()=>{if(!(a!=null&&a.liveUpdate)){const f=s.find(p=>p.id===m.current);l&&(m.current=l),!l&&m.current&&e({columnWidth:d[m.current],header:f})}},[i,a==null?void 0:a.liveUpdate,s])},c=t=>{t.useFinalInstance.push(r)};return c.pluginName="useOnColumnResize",c},we=e=>{const a=o=>{o.stateReducers.push((r,c)=>{if(c.type==="toggleSortBy"){if(r.sortBy.length<=1)return r;{const t=[...r.sortBy],u=e.flatMap(s=>{const i=t.findIndex(l=>l.id===s);if(i!==-1){const l=t[i];return t.splice(i,1),[l]}return[]});return{...r,sortBy:[...u,...t]}}}return r})};return a.pluginName="useOrderedMultiSort",a},Re={verticalAlign:"middle"},ye=(e,{instance:{webComponentsReactProperties:{selectionMode:a}}})=>{if(e.key==="header___ui5wcr__internal_selection_column"&&a===b.Multiple){const o={...e.style,cursor:"auto"};return[e,{onClick:void 0,onKeyDown:void 0,title:void 0,style:o}]}return e},xe=e=>e.map(a=>a.id==="__ui5wcr__internal_selection_column"?{...a,Cell:o=>{const{webComponentsReactProperties:r,row:c}=o;return c.disableSelect===!0?c.isGrouped&&r.selectionMode===b.Single?null:r.selectionMode===b.Single?n.jsx("div",{onClick:void 0,"data-name":"internal_selection_column"}):n.jsx(ee,{...c.getToggleRowSelectedProps(),disabled:!0,style:Re,"data-name":"internal_selection_column",tabIndex:-1}):a.Cell(o)},Header:()=>null}:a),R=e=>{const a=typeof e=="function"?e:s=>le(s.original,e,void 0),o=(s,{row:i,instance:l})=>{const{webComponentsReactProperties:d}=l;return a(i)===!0?(i.disableSelect=!0,{...s,onClick:h=>{typeof d.onRowClick=="function"&&d.onRowClick(B(h,{row:i}))},onKeyDown:h=>{(h.code==="Enter"||h.code==="Space")&&(h.preventDefault(),h.code==="Enter"&&typeof d.onRowClick=="function"&&d.onRowClick(B(h,{row:i})))},onKeyUp:h=>{h.code==="Space"&&(h.preventDefault(),typeof d.onRowClick=="function"&&d.onRowClick(B(h,{row:i})))},className:d.classes.tr}):s},r=s=>[...s,e],c=(s,{cell:{row:i,column:l},instance:d})=>{const{selectionMode:m,selectionBehavior:f}=d.webComponentsReactProperties;if(a(i)===!0&&m!==b.None&&(f!==Z.RowSelector||l.id==="__ui5wcr__internal_selection_column")){const{"aria-label":p,...h}=s;if(l.id==="__ui5wcr__internal_selection_column"){const se={...s.style,cursor:"auto"};return{...h,"aria-disabled":!0,style:se}}const{"aria-selected":te,...y}=h;return y}return s},t=(s,{row:i})=>{if(a(i)===!0){const{title:l,...d}=s;return d}return s},u=s=>{s.getHeaderProps.push(ye),s.getRowProps.push(o),s.columns.push(xe),s.columnsDeps.push(r),s.getCellProps.push(c),s.getToggleRowSelectedProps.push(t)};return u.pluginName="useRowDisableSelection",u};try{R.displayName="useRowDisableSelection",R.__docgenInfo={description:`A plugin hook for disabling row selection of specific rows.
...
}`,...(O=(F=C.parameters)==null?void 0:F.docs)==null?void 0:O.source}}};var E,L,P;v.parameters={...v.parameters,docs:{...(E=v.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
...
}`,...(P=(L=v.parameters)==null?void 0:L.docs)==null?void 0:P.source}}};var W,z,U;k.parameters={...k.parameters,docs:{...(W=k.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: args => {
...
}`,...(U=(z=k.parameters)==null?void 0:z.docs)==null?void 0:U.source}}};var J,G,K;M.parameters={...M.parameters,docs:{...(J=M.parameters)==null?void 0:J.docs,source:{originalSource:`{
  args: {
