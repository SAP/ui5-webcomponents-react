import{j as e}from"./useIsomorphicLayoutEffect-DCJrFAVs.js";import"./index-DuQ-WT3I.js";import{r as i}from"./index-ClU-Tc1p.js";import{M as p,a as h,b as m}from"./index-C6ojkR0j.js";import{B as u}from"./index-BvdAAmCm.js";const O={title:"Modals & Popovers / MessageBox",component:p,argTypes:{header:{control:{disable:!0}},actions:{control:{disable:!0}},icon:{control:{disable:!0}}},args:{open:!1,type:h.Confirm,children:'Press "Escape" to close the MessageBox.'},parameters:{chromatic:{delay:1e3}},tags:["package:@ui5/webcomponents","cem-module:Dialog"]},t={render(n){const[r,o]=i.useState(n.open),c=()=>{o(!0)},l=a=>{o(!1),n.onClose(a)};return i.useEffect(()=>{o(n.open)},[n.open]),e.jsxs(e.Fragment,{children:[e.jsx(u,{onClick:c,children:"Open Messagebox"}),e.jsx(p,{...n,open:r,onClose:l})]})}},s={args:{actions:[m.OK,"Custom Action",m.Cancel,e.jsx(u,{id:"custom-action",children:"Custom Button"},"0")]},render(n){const[r,o]=i.useState(!1),c=()=>{o(!0)},l=a=>{a.detail.action,o(!1),n.onClose(a)};return e.jsxs(e.Fragment,{children:[e.jsx(u,{onClick:c,children:"Open Messagebox"}),e.jsx(p,{...n,open:r,onClose:l})]})}};var d,C,g;t.parameters={...t.parameters,docs:{...(d=t.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render(args) {
