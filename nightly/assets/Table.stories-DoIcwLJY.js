...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const He={title:"Data Display / Table",component:R,argTypes:{headerRow:{control:{disable:!0}},features:{control:{disable:!0}},children:{control:{disable:!0}}},args:{headerRow:e.jsxs(J,{sticky:!0,children:[e.jsx(u,{width:"200px",minWidth:"200px",children:e.jsx("span",{children:"Product"})}),e.jsx(u,{minWidth:"200px",children:e.jsx("span",{children:"Supplier"})}),e.jsx(u,{minWidth:"200px",children:e.jsx("span",{children:"Dimensions"})}),e.jsx(u,{minWidth:"100px",maxWidth:"200px",children:e.jsx("span",{children:"Weight"})}),e.jsx(u,{minWidth:"200px",children:e.jsx("span",{children:"Price"})})]})},tags:["package:@ui5/webcomponents"]},y={render:o=>e.jsxs(R,{...o,children:[e.jsxs(g,{children:[e.jsx(r,{children:e.jsx("span",{children:"Notebook Basic"})}),e.jsx(r,{children:e.jsx("span",{children:"Very Best Screens"})}),e.jsx(r,{children:e.jsx("span",{children:"30 x 18 x 3cm"})}),e.jsx(r,{children:e.jsx("span",{children:"4.2KG"})}),e.jsx(r,{children:e.jsx("span",{children:"956EUR"})})]}),e.jsxs(g,{children:[e.jsx(r,{children:e.jsx("span",{children:"Notebook Basic 17HT-1001"})}),e.jsx(r,{children:e.jsx("span",{children:"Very Best Screens"})}),e.jsx(r,{children:e.jsx("span",{children:"29 x 17 x 3.1cm"})}),e.jsx(r,{children:e.jsx("span",{children:"4.5KG"})}),e.jsx(r,{children:e.jsx("span",{children:"1249EUR"})})]})]})},x={render:o=>{const t=a=>new Array(25).fill("").map((i,d)=>e.jsxs(g,{children:[e.jsx(r,{children:e.jsx("span",{children:d+a})}),e.jsx(r,{children:e.jsx("span",{children:"Placeholder"})}),e.jsx(r,{children:e.jsx("span",{children:"Placeholder 2"})}),e.jsx(r,{children:e.jsx("span",{children:"Placeholder 3"})}),e.jsx(r,{children:e.jsx("span",{children:"Placeholder 4"})})]},`${d+a}-row`)),[n,s]=S.useState(t(1)),l=()=>{s(a=>[...a,...t(a.length+1)])};return e.jsx("div",{style:{height:"250px",overflow:"auto"},children:e.jsx(R,{...o,features:e.jsx(w,{onLoadMore:l,type:j.Scroll}),children:n})})}},C={render(o){const[t,n]=S.useState(G.Multiple);return e.jsxs(e.Fragment,{children:[e.jsx(ve,{onSelectionChange:s=>{n(s.detail.selectedItems[0].textContent)},children:Object.values(G).map(s=>e.jsx(Se,{selected:s===t,children:s},s))}),e.jsxs(R,{...o,features:e.jsx(oe,{mode:t}),children:[e.jsxs(g,{children:[e.jsx(r,{children:e.jsx("span",{children:"Notebook Basic"})}),e.jsx(r,{children:e.jsx("span",{children:"Very Best Screens"})}),e.jsx(r,{children:e.jsx("span",{children:"30 x 18 x 3cm"})}),e.jsx(r,{children:e.jsx("span",{children:"4.2KG"})}),e.jsx(r,{children:e.jsx("span",{children:"956EUR"})})]}),e.jsxs(g,{children:[e.jsx(r,{children:e.jsx("span",{children:"Notebook Basic 17HT-1001"})}),e.jsx(r,{children:e.jsx("span",{children:"Very Best Screens"})}),e.jsx(r,{children:e.jsx("span",{children:"29 x 17 x 3.1cm"})}),e.jsx(r,{children:e.jsx("span",{children:"4.5KG"})}),e.jsx(r,{children:e.jsx("span",{children:"1249EUR"})})]})]})]})}},E=ne.map((o,t)=>({...o,position:t})),v={args:{className:"tableHeightContentDensity"},render(o){const[t,n]=S.useState(E.slice(0,9)),[s,l]=S.useState(!0),a=i=>{const{first:d,last:f}=i.detail,h=Math.max(d-2,0),D=Math.min(f+2,E.length);n(E.slice(h,D))};return S.useEffect(()=>{const i=document.body;if(!i)return;const d=new MutationObserver(f=>{f.forEach(h=>{h.type==="attributes"&&h.attributeName==="class"&&l(!i.classList.contains("ui5-content-density-compact"))})});return d.observe(i,{attributes:!0,attributeFilter:["class"]}),()=>{d.disconnect()}},[]),e.jsx(R,{...o,headerRow:e.jsxs(J,{sticky:!0,children:[e.jsx(u,{children:"Name"}),e.jsx(u,{children:"Age"}),e.jsx(u,{children:"Friend Name"}),e.jsx(u,{children:"Friend Age"})]}),features:e.jsx(_,{rowCount:500,rowHeight:s?44:32,onRangeChange:a}),children:t.map(i=>e.jsxs(g,{position:i.position,children:[e.jsx(r,{children:e.jsx("span",{children:i.name})}),e.jsx(r,{children:e.jsx("span",{children:i.age})}),e.jsx(r,{children:e.jsx("span",{children:i.friend.name})}),e.jsx(r,{children:e.jsx("span",{children:i.friend.age})})]},i.position))})}};var z,F,k;y.parameters={...y.parameters,docs:{...(z=y.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: args => {
    return <Table {...args}>
        <TableRow>
          <TableCell>
...
}`,...(k=(F=y.parameters)==null?void 0:F.docs)==null?void 0:k.source}}};var U,q,L;x.parameters={...x.parameters,docs:{...(U=x.parameters)==null?void 0:U.docs,source:{originalSource:`{
  render: args => {
...
}`,...(L=(q=x.parameters)==null?void 0:q.docs)==null?void 0:L.source}}};var O,W,A;C.parameters={...C.parameters,docs:{...(O=C.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render(args) {
...
}`,...(A=(W=C.parameters)==null?void 0:W.docs)==null?void 0:A.source}}};var $,K,Y;v.parameters={...v.parameters,docs:{...($=v.parameters)==null?void 0:$.docs,source:{originalSource:`{
  args: {
...
}`,...(Y=(K=v.parameters)==null?void 0:K.docs)==null?void 0:Y.source}}};const Ee=["Default","GrowingTable","WithSelection","VirtualizedTableRows"],Xe=Object.freeze(Object.defineProperty({__proto__:null,Default:y,GrowingTable:x,VirtualizedTableRows:v,WithSelection:C,__namedExportsOrder:Ee,default:He},Symbol.toStringTag,{value:"Module"}));export{Xe as C,y as D,x as G,w as T,v as V,C as W,_ as a};
