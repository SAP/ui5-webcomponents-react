import{_ as u}from"./iframe-CtsffICr.js";import{f as c,s as h,a as d,m as f,k as y,h as b,I as _,w as x}from"./withWebComponent-jpg_vyBt.js";import{d as w}from"./utils-C0V6LSSR.js";import{s as g}from"./parameters-bundle.css-DJWIHzS2.js";c("@ui5/webcomponents-theming","sap_horizon",async()=>h);c("@ui5/webcomponents","sap_horizon",async()=>g);const T={packageName:"@ui5/webcomponents",fileName:"themes/Text.css.ts",content:`:host{display:inline-block;max-width:100%;font-size:var(--sapFontSize);font-family:var(--sapFontFamily);color:var(--sapTextColor);line-height:normal;white-space:pre-line;word-wrap:break-word;cursor:text}:host([max-lines]){display:-webkit-box;-webkit-line-clamp:var(--_ui5-v2-1-1_text_max_lines);line-clamp:var(--_ui5-v2-1-1_text_max_lines);-webkit-box-orient:vertical;overflow:hidden;white-space:normal}
`};var m=function(t,n,o,s){var r=arguments.length,e=r<3?n:s===null?s=Object.getOwnPropertyDescriptor(n,o):s,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")e=Reflect.decorate(t,n,o,s);else for(var p=t.length-1;p>=0;p--)(l=t[p])&&(e=(r<3?l(e):r>3?l(n,o,e):l(n,o))||e);return r>3&&e&&Object.defineProperty(n,o,e),e};let i=class extends _{constructor(){super(...arguments),this.maxLines=1/0}onBeforeRendering(){this.style.setProperty(w("--_ui5_text_max_lines"),`${this.maxLines}`)}};m([d({type:Number})],i.prototype,"maxLines",void 0);i=m([f({tag:"ui5-text",renderer:y,template:()=>b`<span><slot></slot></span>`,styles:T})],i);i.define();const v=i,N=Object.freeze(Object.defineProperty({__proto__:null,default:v},Symbol.toStringTag,{value:"Module"})),a=x("ui5-text",["maxLines"],[],[],[],()=>u(()=>Promise.resolve().then(()=>N),void 0,import.meta.url));a.displayName="Text";try{a.displayName="Text",a.__docgenInfo={description:`<h3>Overview</h3>
