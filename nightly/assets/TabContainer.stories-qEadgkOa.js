import{j as e}from"./useIsomorphicLayoutEffect-DCJrFAVs.js";import{a as H,b as h,c as A,T as n}from"./index-Dd5Kc-5G.js";import{h as x,j as S,f,s as R,m as E,k as L,I as W,H as w,w as U}from"./withWebComponent-Dj0CMfaz.js";import{f as _}from"./Icon-8rAbDJhl.js";import{a as B}from"./add-C5dI5j4J.js";import{e as G}from"./employee-BNdbT3qA.js";import{s as J}from"./settings-D5A_cXK5.js";import{_ as K}from"./iframe-CNne69o2.js";import{l as i}from"./if-defined-B8mU3KX1.js";import{o as q}from"./class-map-DwAhupCS.js";import{s as v}from"./style-map-CpZMqJvf.js";import{s as F}from"./parameters-bundle.css-BFbT_feV.js";function Q(t,a,o){return x`<div id="${i(this._id)}" role="separator" class="${q(this.classes.root)}" .realTabReference="${i(this)}"></div>`}function X(t,a,o){return o?x`<${S("ui5-li-custom",a,o)} id="${i(this._id)}" role="separator" class="${q(this.classes.root)}" disabled style="${v(this._forcedStyleInOverflow)}" .realTabReference="${i(this)}"></${S("ui5-li-custom",a,o)}>`:x`<ui5-li-custom id="${i(this._id)}" role="separator" class="${q(this.classes.root)}" disabled style="${v(this._forcedStyleInOverflow)}" .realTabReference="${i(this)}"></ui5-li-custom>`}f("@ui5/webcomponents-theming","sap_horizon",async()=>R);f("@ui5/webcomponents","sap_horizon",async()=>F);const Y={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInStrip.css.ts",content:`div.ui5-tc__separator{position:relative;width:.5625rem}div.ui5-tc__separator:before{content:" ";position:absolute;width:.0625rem;left:.25rem;top:.5rem;bottom:.5rem;background:var(--sapGroup_TitleBorderColor)}
