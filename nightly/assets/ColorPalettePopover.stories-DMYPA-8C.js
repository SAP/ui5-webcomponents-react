import{j as o}from"./jsx-runtime-CLpGMVip.js";import{i as _}from"./utils-Cfen_njI.js";import{r as C}from"./index-D23YZj_x.js";import{B as D}from"./index-CKIQi-Zb.js";import{a as R,C as r}from"./index-CBcisgMz.js";import{b as S,j as p,p as g,d as T,s as h,m as O,k as N,S as k,w as x}from"./jsx-runtime--4q9epG_.js";import{d as E}from"./slot-_4yKMUwC.js";import{l as b}from"./event-strict-DgQLNDEV.js";import{i as I}from"./i18n-oG4QvOAt.js";import{e as q}from"./Popover-BM5bmFmi.js";import{d as j}from"./CustomElementsScope-CyyomP-e.js";import{a as V}from"./Title-DXDOdGV-.js";import{a as A}from"./Button-DiEZky6d.js";import{R as M}from"./ResponsivePopover-CbckT81y.js";import{d as B}from"./parameters-bundle.css-Ct2Rzfjz.js";import{R as U}from"./ResponsivePopoverCommon.css-t3br_qnt.js";import{ad as L,ae as F}from"./i18n-defaults-B3xVhWeJ.js";function Y(){return S(M,{hideArrow:!0,contentOnlyOnDesktop:!0,placement:"Bottom",opener:this.opener,open:this._open,onClose:this.onAfterClose,onOpen:this.onAfterOpen,children:[p("div",{slot:"header",class:"ui5-cp-header",children:p(V,{level:"H1",wrappingType:"None",children:this._colorPaletteTitle})}),p("div",{children:p(R,{showMoreColors:this.showMoreColors,showRecentColors:this.showRecentColors,showDefaultColor:this.showDefaultColor,defaultColor:this.defaultColor,popupMode:!0,onItemClick:this.onSelectedColor,children:this.colorPaletteColors.map(t=>p("slot",{name:t._individualSlot}))})}),p("div",{slot:"footer",class:"ui5-cp-footer",children:p(A,{design:"Transparent",onClick:this.closePopover,children:this._cancelButtonLabel})})]})}g("@ui5/webcomponents-theming","sap_horizon",async()=>T);g("@ui5/webcomponents","sap_horizon",async()=>B);const H=`.ui5-cp-header{width:100%;height:var(--_ui5-v2-7-3_color-palette-button-height);display:flex;align-items:center}.ui5-cp-footer{width:100%;display:flex;justify-content:flex-end;align-items:center;margin:.1875rem 0}[ui5-responsive-popover]::part(content){padding:0}.ui5-cp-item-container{padding:.3125rem .6875rem}
`;var i=function(t,e,s,l){var u=arguments.length,n=u<3?e:l===null?l=Object.getOwnPropertyDescriptor(e,s):l,f;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,s,l);else for(var v=t.length-1;v>=0;v--)(f=t[v])&&(n=(u<3?f(n):u>3?f(e,s,n):f(e,s))||n);return u>3&&n&&Object.defineProperty(e,s,n),n},m;let a=m=class extends k{constructor(){super(),this.showRecentColors=!1,this.showMoreColors=!1,this.showDefaultColor=!1,this.open=!1}get responsivePopover(){return this.shadowRoot.querySelector("[ui5-responsive-popover]")}get respPopover(){return this.shadowRoot.querySelector("[ui5-responsive-popover]")}closePopover(){this.open=!1}onAfterClose(){this.closePopover(),this.fireDecoratorEvent("close")}onAfterOpen(){var s;const e=this._colorPalette;e._currentlySelected?(s=e._currentlySelected)==null||s.focus():e.showRecentColors&&e.recentColorsElements.length?e.recentColorsElements[0].focus():e.showDefaultColor&&e.colorPaletteNavigationElements[0].focus(),e.allColorsInPalette.forEach(l=>{const u=l.offsetHeight+4;l.style.setProperty(j("--_ui5_color_palette_item_height"),`${u}px`)})}onSelectedColor(e){this.closePopover(),this.fireDecoratorEvent("item-click",e.detail)}get _colorPalette(){return this.responsivePopover.content[0].querySelector("[ui5-color-palette]")}isOpen(){return this.open}get colorPaletteColors(){return this.getSlottedNodes("colors")}get _colorPaletteTitle(){return m.i18nBundle.getText(L)}get _cancelButtonLabel(){return m.i18nBundle.getText(F)}get _open(){return this.open||void 0}};i([h({type:Boolean})],a.prototype,"showRecentColors",void 0);i([h({type:Boolean})],a.prototype,"showMoreColors",void 0);i([h({type:Boolean})],a.prototype,"showDefaultColor",void 0);i([h()],a.prototype,"defaultColor",void 0);i([h({type:Boolean})],a.prototype,"open",void 0);i([h({converter:q})],a.prototype,"opener",void 0);i([E({default:!0,type:HTMLElement,individualSlots:!0})],a.prototype,"colors",void 0);i([I("@ui5/webcomponents")],a,"i18nBundle",void 0);a=m=i([O({tag:"ui5-color-palette-popover",renderer:N,styles:[U,H],template:Y}),b("item-click",{bubbles:!0}),b("close",{bubbles:!0})],a);a.define();const c=x("ui5-color-palette-popover",["defaultColor","opener"],["open","showDefaultColor","showMoreColors","showRecentColors"],[],["close","item-click"]);c.displayName="ColorPalettePopover";try{c.displayName="ColorPalettePopover",c.__docgenInfo={description:`Represents a predefined range of colors for easier selection.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const z={title:"Modals & Popovers / ColorPalettePopover",component:c,argTypes:{children:{control:{disable:!0}},defaultColor:{control:{type:"color"}}},parameters:{chromatic:{delay:1e3},open:_},tags:["package:@ui5/webcomponents"]},d={render(t){const e=C.useRef(null),[s,l]=C.useState(t.open),u=()=>{l(n=>!n)};return C.useEffect(()=>{l(t.open)},[t.open]),o.jsxs(o.Fragment,{children:[o.jsx(D,{onClick:u,ref:e,children:"Open ColorPalettePopover"}),o.jsxs(c,{...t,opener:e.current,open:s,onClose:n=>{t.onClose(n),l(!1)},children:[o.jsx(r,{value:"black"}),o.jsx(r,{value:"darkblue"}),o.jsx(r,{value:"#444444"}),o.jsx(r,{value:"rgb(0,200,0)"}),o.jsx(r,{value:"green"}),o.jsx(r,{value:"darkred"}),o.jsx(r,{value:"yellow"}),o.jsx(r,{value:"blue"}),o.jsx(r,{value:"cyan"}),o.jsx(r,{value:"orange"}),o.jsx(r,{value:"#5480e7"}),o.jsx(r,{value:"#ff6699"})]})]})}};var w,y,P;d.parameters={...d.parameters,docs:{...(w=d.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render(args) {
