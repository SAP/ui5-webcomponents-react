...
will be the value of the currently selected radio button.`,name:"value",required:!1,type:{name:"string"}},valueState:{defaultValue:{value:'"None"'},description:"Defines the value state of the component.",name:"valueState",required:!1,type:{name:"enum",value:[{value:'"None"'},{value:'"Critical"'},{value:'"Information"'},{value:'"Positive"'},{value:'"Negative"'},{value:'"None"'},{value:'"Positive"'},{value:'"Critical"'},{value:'"Negative"'},{value:'"Information"'}]}},wrappingType:{defaultValue:{value:'"Normal"'},description:`Defines whether the component text wraps when there is not enough space.
