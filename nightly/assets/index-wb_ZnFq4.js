import{c as y,j as m,F as b,p as _,d as w,s as d,m as g,e as T,I as C,A as E,w as S}from"./withWebComponent-CT6sGXpP.js";import{H as F}from"./Keys-D3vKxxqj.js";import{l as N}from"./event-strict-DgQLNDEV.js";import{d as D}from"./parameters-bundle.css-BzaqQttB.js";function A(){return y(b,{children:["this.open &&",m("div",{class:"ui5-toast-root",role:"alert",tabindex:this._tabindex,children:m("bdi",{children:m("slot",{})})})]})}_("@ui5/webcomponents-theming","sap_horizon",async()=>w);_("@ui5/webcomponents","sap_horizon",async()=>D);const P=`:host{font-family:"72override",var(--sapFontFamily);color:var(--sapList_TextColor);font-size:var(--sapFontSize);position:fixed;display:none;box-sizing:border-box;max-width:15rem;overflow:hidden;background:var(--_ui5-v2-6-2_toast_background);box-shadow:var(--_ui5-v2-6-2_toast_shadow);border-radius:var(--sapElement_BorderCornerRadius);transition-property:opacity;opacity:1;word-wrap:break-word;text-align:center;text-overflow:ellipsis;white-space:pre-line;padding:1rem;inset:unset;margin:0;border:none}.ui5-toast-root{height:100%;width:100%;padding:0;outline:none;box-sizing:border-box}:host([open]){display:block}:host(:not([placement])){bottom:var(--_ui5-v2-6-2_toast_vertical_offset);left:50%;transform:translate(-50%)}:host([placement="TopStart"]){top:var(--_ui5-v2-6-2_toast_vertical_offset);left:var(--_ui5-v2-6-2_toast_horizontal_offset)}:host([placement="MiddleStart"]){left:var(--_ui5-v2-6-2_toast_horizontal_offset);top:50%;transform:translateY(-50%)}:host([placement="BottomStart"]){left:var(--_ui5-v2-6-2_toast_horizontal_offset);bottom:var(--_ui5-v2-6-2_toast_vertical_offset)}:host([placement="TopCenter"]){top:var(--_ui5-v2-6-2_toast_vertical_offset);left:50%;transform:translate(-50%)}:host([placement="MiddleCenter"]){left:50%;top:50%;transform:translate(-50%,-50%)}:host([placement="BottomCenter"]){bottom:var(--_ui5-v2-6-2_toast_vertical_offset);left:50%;transform:translate(-50%)}:host([placement="TopEnd"]){right:var(--_ui5-v2-6-2_toast_horizontal_offset);top:var(--_ui5-v2-6-2_toast_vertical_offset)}:host([placement="MiddleEnd"]){right:var(--_ui5-v2-6-2_toast_horizontal_offset);top:50%;transform:translateY(-50%)}:host([placement="BottomEnd"]){right:var(--_ui5-v2-6-2_toast_horizontal_offset);bottom:var(--_ui5-v2-6-2_toast_vertical_offset)}:host([focused]){outline-width:var(--sapContent_FocusWidth);outline-style:var(--sapContent_FocusStyle);outline-color:var(--sapContent_FocusColor);outline-offset:var(--_ui5-v2-6-2_toast_offset_width)}
`;var r=function(e,t,s,l){var u=arguments.length,n=u<3?t:l===null?l=Object.getOwnPropertyDescriptor(t,s):l,h;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,s,l);else for(var p=e.length-1;p>=0;p--)(h=e[p])&&(n=(u<3?h(n):u>3?h(t,s,n):h(t,s))||n);return u>3&&n&&Object.defineProperty(t,s,n),n};const f=500,x=1e3,a=[];let i,v=!1;const B=e=>{const t=e.metaKey||!E()&&e.ctrlKey,s=e.key&&e.key.toLowerCase()==="m",l=t&&e.shiftKey&&s,u=a.length;l&&(e.preventDefault(),u&&(a[0].focusable=!0,a[0].focused?(a[0].focused=!1,i==null||i.focus()):(i=document.activeElement,a[0].focus())))};let o=class extends C{constructor(){super(),this.duration=3e3,this.placement="BottomCenter",this.open=!1,this.hover=!1,this.focusable=!1,this.focused=!1,this._onfocusinFn=this._onfocusin.bind(this),this._onfocusoutFn=this._onfocusout.bind(this),this._onkeydownFn=this._onkeydown.bind(this),this._onmouseoverFn=this._onmouseover.bind(this),this._onmouseleaveFn=this._onmouseleave.bind(this),this._ontransitionendFn=this._ontransitionend.bind(this)}onBeforeRendering(){this.open&&(a.pop(),a.push(this)),requestAnimationFrame(()=>{const t=Math.min(this.effectiveDuration/3,x);this.style.transitionDuration=this.open?`${t}ms`:"",this.style.transitionDelay=this.open?`${this.effectiveDuration-t}ms`:"",this.style.opacity=this.open&&!this.hover&&!this.focused?"0":""}),v||(document.addEventListener("keydown",B),v=!0)}onAfterRendering(){this.hasAttribute("popover")||this.setAttribute("popover","manual"),this.open&&this.showPopover()}_onfocusin(){this.focusable&&(this.focused=!0)}_onfocusout(){this.focused=!1}get effectiveDuration(){return this.duration<f?f:this.duration}_ontransitionend(){this.hover||this.focused||(this.open=!1,this.focusable=!1,this.focused=!1,this.fireDecoratorEvent("close"),this.hidePopover())}_onmouseover(){this.hover=!0}_onmouseleave(){this.hover=!1}_onkeydown(t){F(t)&&(this.focused=!1,i==null||i.focus())}get _tabindex(){return this.focused?0:-1}onEnterDOM(){this.addEventListener("focusin",this._onfocusinFn),this.addEventListener("focusout",this._onfocusoutFn),this.addEventListener("keydown",this._onkeydownFn),this.addEventListener("mouseover",this._onmouseoverFn),this.addEventListener("mouseleave",this._onmouseleaveFn),this.addEventListener("transitionend",this._ontransitionendFn),this.addEventListener("transitioncancel",this._ontransitionendFn)}onExitDOM(){this.removeEventListener("focusin",this._onfocusinFn),this.removeEventListener("focusout",this._onfocusoutFn),this.removeEventListener("keydown",this._onkeydownFn),this.removeEventListener("mouseover",this._onmouseoverFn),this.removeEventListener("mouseleave",this._onmouseleaveFn),this.removeEventListener("transitionend",this._ontransitionendFn),this.removeEventListener("transitioncancel",this._ontransitionendFn)}};r([d({type:Number})],o.prototype,"duration",void 0);r([d()],o.prototype,"placement",void 0);r([d({type:Boolean})],o.prototype,"open",void 0);r([d({type:Boolean})],o.prototype,"hover",void 0);r([d({type:Boolean})],o.prototype,"focusable",void 0);r([d({type:Boolean})],o.prototype,"focused",void 0);o=r([g({tag:"ui5-toast",renderer:T,styles:P,template:A}),N("close",{bubbles:!0})],o);o.define();const c=S("ui5-toast",["duration","placement"],["open"],[],["close"]);c.displayName="Toast";try{c.displayName="Toast",c.__docgenInfo={description:`The \`Toast\` is a small, non-disruptive popup for success or information messages that
