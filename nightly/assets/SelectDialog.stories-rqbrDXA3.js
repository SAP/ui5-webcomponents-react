...
| cancelable | bubbles |
| :--------: | :-----: |
| ❌|✅|`,name:"onLoadMore",required:!1,type:{name:"(event: Ui5CustomEvent<ListDomRef, never>) => void"}},growing:{defaultValue:{value:'"None"'},description:'Defines whether the component will have growing capability either by pressing a `More` button,\nor via user scroll. In both cases `load-more` event is fired.\n\n**Restrictions:** `growing="Scroll"` is not supported for Internet Explorer,\non IE the component will fallback to `growing="Button"`.',name:"growing",required:!1,type:{name:"enum",value:[{value:'"None"'},{value:'"Button"'},{value:'"Scroll"'},{value:'"Button"'},{value:'"Scroll"'},{value:'"None"'}]}}}}}catch{}const je=""+new URL("Laptop1-BiqZozDV.jpg",import.meta.url).href,Fe=""+new URL("Laptop2-CLTht4yo.jpg",import.meta.url).href,Ue=""+new URL("PC1-BekXrNHY.jpg",import.meta.url).href,$e=""+new URL("PC2-DZLCUDFz.jpg",import.meta.url).href,He={title:"Modals & Popovers / SelectDialog",component:p,argTypes:{children:{control:{disable:!0}}},args:{headerText:"Select Product",open:De},parameters:{chromatic:{delay:1e3}},tags:["package:@ui5/webcomponents","cem-module:Dialog"]},de=[{img:je,description:"LT-10",text:"Gaming Laptop"},{img:Fe,description:"LT-20",text:"Business Laptop"},{img:$e,description:"HT-10",text:"Gaming PC"},{img:Ue,description:"HT-20",text:"Business PC"}],q={render:l=>{const[S,c]=i.useState(l.open),u=()=>{c(!0)},g=v=>{c(!1),l.onClose(v)};return i.useEffect(()=>{c(l.open)},[l.open]),t.jsxs(t.Fragment,{children:[t.jsx(I,{onClick:u,children:"Open SelectDialog"}),t.jsx(p,{...l,open:S,onClose:g,children:new Array(40).fill("").map((v,a)=>{const m=de[a%4];return t.jsx(se,{selected:a===1,image:t.jsx("img",{src:m.img,alt:"Example Image"}),description:`${m.description}${a}`,children:m.text},`${m.text}${a}`)})})]})}},N={render:()=>{const[l,S]=i.useState(!1),c={"HT-102":!0,"HT-203":!0,"HT-1038":!0},[u,g]=i.useState(c),v=i.useRef(u),[a,m]=i.useState(),[F,V]=i.useState(Object.keys(c)),f=()=>{v.current=u},b=()=>{S(!0)},R=()=>{S(!1)},L=h=>{m(h.detail.value)},E=()=>{m(void 0)},k=h=>{const o=h.detail.item.dataset.description;g(n=>{if(n[o]){const{[o]:D,...y}=n;return y}else return{...n,[o]:!0}})},O=()=>{g({})},w=()=>{V(Object.keys(u))},U=()=>{g(v.current)};return t.jsxs(t.Fragment,{children:[t.jsx(I,{onClick:b,children:"Open Dialog"}),t.jsx(p,{open:l,selectionMode:_.Multiple,numberOfSelectedItems:Object.keys(u).length,listProps:{onItemClick:k},showClearButton:!0,rememberSelections:!0,onClear:O,onConfirm:w,onClose:R,onSearchInput:L,onSearch:L,onSearchReset:E,onBeforeOpen:f,onCancel:U,children:new Array(40).fill("").map((h,o)=>{const n=de[o%4],D=`${n.description}${o}`,y=a==null?void 0:a.toLowerCase();return a&&!D.toLowerCase().includes(y)&&!n.text.toLowerCase().includes(y)?null:t.jsx(se,{image:t.jsx("img",{src:n.img,alt:"Example Image"}),description:`${n.description}${o}`,"data-description":`${n.description}${o}`,selected:u[D],children:n.text},`${n.text}${o}`)}).filter(Boolean)}),t.jsxs(ce,{children:[t.jsx(_e,{children:"Selected: "}),t.jsx(re,{children:F.join(", ")})]})]})}};var te,ne,oe;q.parameters={...q.parameters,docs:{...(te=q.parameters)==null?void 0:te.docs,source:{originalSource:`{
  render: args => {
...
}`,...(ae=(le=N.parameters)==null?void 0:le.docs)==null?void 0:ae.source}}};const ze=["Default","MultiSelect"],vt=Object.freeze(Object.defineProperty({__proto__:null,Default:q,MultiSelect:N,__namedExportsOrder:ze,default:He},Symbol.toStringTag,{value:"Module"}));export{vt as C,q as D,N as M};
