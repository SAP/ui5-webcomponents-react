...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function E(){return V.call(this,k)}function k(){return y(D,{children:T("header",{slot:"header",class:"ui5-search-popup-searching-header",children:[y("div",{class:"ui5-shellbar-search-field-wrapper",children:N.call(this,{forceExpanded:!0})}),y(I,{design:B.Transparent,onClick:this._handleCancel,children:this.cancelButtonText})]})})}function x(){return T(D,{children:[N.call(this),E.call(this)]})}var L=function(n,e,o,a){var s=arguments.length,t=s<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,o):a,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,o,a);else for(var i=n.length-1;i>=0;i--)(l=n[i])&&(t=(s<3?l(t):s>3?l(e,o,t):l(e,o))||t);return s>3&&t&&Object.defineProperty(e,o,t),t},c;let v=c=class extends U{_handleSearchIconPress(){super._handleSearchIconPress(),this.collapsed?this.collapsed=!1:this.value||(this.collapsed=!0)}_onFocusOutSearch(e){f()||super._onFocusOutSearch(e)}_handleInput(e){super._handleInput(e),f()&&(this._performItemSelectionOnMobile=this._shouldPerformSelectionOnMobile(e.inputType))}get _effectiveIconTooltip(){return this.collapsed?c.i18nBundle.getText(A):this.value?c.i18nBundle.getText(R):c.i18nBundle.getText(W)}get nativeInput(){const e=this.shadowRoot;return f()?e==null?void 0:e.querySelector("[ui5-responsive-popover] input"):super.nativeInput}onBeforeRendering(){super.onBeforeRendering(),f()&&(this.collapsed=!0)}};v=c=L([w({tag:"ui5-shellbar-search",template:x})],v);v.define();const h=S("ui5-shellbar-search",["accessibleDescription","accessibleName","placeholder","value"],["loading","noTypeahead","open","showClearIcon"],["action","filterButton","illustration","messageArea","scopes"],["close","input","open","scope-change","search"]);h.displayName="ShellBarSearch";try{h.displayName="ShellBarSearch",h.__docgenInfo={description:`Search field for the ShellBar component.
