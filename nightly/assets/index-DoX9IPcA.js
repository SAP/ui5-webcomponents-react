const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./iframe-D3WSfxnn.js","./preload-helper-D9Z9MdNV.js","./i18n-DSpjDgSK.js","./iframe-CIHg7SeG.css"])))=>i.map(i=>d[i]);
import{c as u,O as v,J as g,a3 as A,a2 as T,d as x,b as R,s as d,aS as C,m as w,a4 as I,aQ as N,w as k}from"./iframe-D3WSfxnn.js";import{_ as f}from"./preload-helper-D9Z9MdNV.js";import{I as D}from"./IconDesign-DXd8PPVF.js";import{p as _}from"./i18n-DSpjDgSK.js";function E(){return u(T,{children:this.invisible?u("div",{}):this._isInteractive?u(v,{icon:this._icon,tooltip:this._text,onClick:this._onActionClick,design:g.Transparent}):u(A,{name:this._icon,accessibleName:this._text,showTooltip:!0,design:D.NonInteractive})})}_("@ui5/webcomponents-theming","sap_horizon",async()=>x);_("@ui5/webcomponents","sap_horizon",async()=>R);const S=`:host([invisible]){display:block;width:var(--_ui5-v2-13-3_button_base_min_width)}:host([_fixed]){margin-inline-start:auto}[ui5-icon]{display:flex;width:var(--_ui5-v2-13-3_button_base_min_width);height:.75rem}
`;var y=function(i,n,o,s){var t=arguments.length,e=t<3?n:s===null?s=Object.getOwnPropertyDescriptor(n,o):s,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")e=Reflect.decorate(i,n,o,s);else for(var r=i.length-1;r>=0;r--)(a=i[r])&&(e=(t<3?a(e):t>3?a(n,o,e):a(n,o))||e);return t>3&&e&&Object.defineProperty(n,o,e),e};let m,b,l=class extends N{constructor(){super(...arguments),this.invisible=!1}static async showMenu(n,o){m||([m,b]=await Promise.all([f(()=>import("./iframe-D3WSfxnn.js").then(t=>t.iw),__vite__mapDeps([0,1,2,3]),import.meta.url).then(t=>t.default),f(()=>import("./iframe-D3WSfxnn.js").then(t=>t.iv),__vite__mapDeps([0,1,2,3]),import.meta.url).then(t=>t.default)])),(!this._menu||!this._menu.isConnected)&&(this._menu=new m,this._menu.addEventListener("item-click",t=>{const e=t.detail.item;this._menuItems.get(e)._fireClickEvent()}),document.body.append(this._menu));const s=n.map(t=>{const e=new b;return e.icon=t._icon,e.text=t._text,e.disabled=!t._isInteractive,this._menuItems.set(e,t),e});this._menu.replaceChildren(...s),this._menu.opener=o,this._menu.open=!0}isFixedAction(){return!1}onEnterDOM(){this.toggleAttribute("_fixed",this.isFixedAction())}_fireClickEvent(){const o=this.parentElement.parentElement;this.fireDecoratorEvent("click"),o._onRowActionClick(this)}_onActionClick(n){this._fireClickEvent(),n.stopPropagation()}get _text(){return this.getRenderInfo().text}get _icon(){return this.getRenderInfo().icon}get _isInteractive(){return this.getRenderInfo().interactive}};l._menuItems=new WeakMap;y([d({type:Boolean})],l.prototype,"invisible",void 0);l=y([C("click",{bubbles:!1}),w({renderer:I,styles:S,template:E})],l);const P=l;var h=function(i,n,o,s){var t=arguments.length,e=t<3?n:s===null?s=Object.getOwnPropertyDescriptor(n,o):s,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")e=Reflect.decorate(i,n,o,s);else for(var r=i.length-1;r>=0;r--)(a=i[r])&&(e=(t<3?a(e):t>3?a(n,o,e):a(n,o))||e);return t>3&&e&&Object.defineProperty(n,o,e),e};let c=class extends P{constructor(){super(...arguments),this.icon="",this.text=""}getRenderInfo(){return{text:this.text,icon:this.icon,interactive:!0}}};h([d()],c.prototype,"icon",void 0);h([d()],c.prototype,"text",void 0);c=h([w({tag:"ui5-table-row-action"})],c);c.define();const p=k("ui5-table-row-action",["icon","text"],["invisible"],[],["click"]);p.displayName="TableRowAction";try{p.displayName="TableRowAction",p.__docgenInfo={description:`The \`TableRowAction\` component defines an action for table rows.
