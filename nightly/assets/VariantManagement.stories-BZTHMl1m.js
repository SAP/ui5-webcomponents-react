import{H as ne,Z as re,j as e,r as d,J as A,R as G}from"./iframe-DvixYE7k.js";import{D as le}from"./index-CE17g3cg.js";import{F as se,a as T,b as k}from"./index-BxKmHuLT.js";import{L as P}from"./index-DPl_fZ6u.js";import{M as ie,a as x}from"./index-DXioqJ7a.js";import{O as h}from"./index-DombZ1wK.js";import{S as de}from"./index-BnQriH7I.js";import{a as oe,F as _}from"./index-Cxgy9uQ5.js";import{V as R,a}from"./VariantItem-rtfyWqhb.js";const ce={title:"Inputs / VariantManagement",component:R,args:{placement:re.Bottom,level:ne.H4}},b={render:o=>e.jsxs(R,{...o,children:[e.jsx(a,{children:"Default VariantItem"}),e.jsx(a,{selected:!0,children:"Selected"}),e.jsx(a,{author:"SAP",children:"Author"}),e.jsx(a,{favorite:!0,children:"Favorite"}),e.jsx(a,{isDefault:!0,children:"IsDefault"}),e.jsx(a,{favorite:!0,labelReadOnly:!0,children:"Favorite & labelReadOnly"}),e.jsx(a,{applyAutomatically:!0,children:"ApplyAutomatically"}),e.jsx(a,{applyAutomatically:!0,applyAutomaticallyText:"Describe your exceptions that deviate from the standard behavior here.",children:"applyAutomatically & applyAutomaticallyText"}),e.jsx(a,{readOnly:!0,children:"ReadOnly"}),e.jsx(a,{global:!0,children:"Global"}),e.jsx(a,{global:!0,readOnly:!0,children:"Global & readOnly"}),e.jsx(a,{global:!0,children:"Not deletable -> global"}),e.jsx(a,{hideDelete:!0,children:"Not deletable -> hideDelete"}),e.jsx(a,{hideDelete:!1,global:!0,children:"Deletable -> hideDelete: false, global: true"})]})},w={render:({selectedByIndex:o=1})=>{const[p,V]=d.useState(void 0),[v,I]=d.useState(void 0),[S,M]=d.useState({1:"Only alphanumeric chars in Save View input",2:"Max 12 chars"}),f=n=>{n.target.value.match(/^[a-z0-9\s]+$/i)?(n.isInvalid=!1,V(void 0)):(n.isInvalid=!0,V(G.Negative))},D=n=>{M(i=>({...i,[n.detail["data-id"]]:n.detail.children}))},O=n=>{n.target.value.length>12?(n.isInvalid=!0,I(G.Negative)):(n.isInvalid=!1,I(void 0))},u=n=>{const i=n.detail.updatedVariants.find(y=>y["data-custom-manage-views"]);!v&&i&&M(y=>({...y,[i["data-id"]]:i.children}))},L=()=>{I(void 0)},m=()=>{V(void 0)};return e.jsxs(R,{onSaveAs:D,onSaveManageViews:u,onManageViewsCancel:L,onSaveViewCancel:m,children:[e.jsx(a,{"data-id":1,selected:o===0,saveViewInputProps:{valueState:p,valueStateMessage:p?e.jsx("div",{children:"Only alphanumeric and space characters allowed!"}):void 0,onInput:f,"data-testid":"alphanumeric"},children:S[1]}),e.jsx(a,{"data-custom-manage-views":!0,"data-id":2,selected:o===1,manageViewsInputProps:{valueState:v,valueStateMessage:v?e.jsx("div",{children:"No more than 12 characters allowed!"}):void 0,onInput:O,"data-testid":"12chars"},children:S[2]})]})}},j={name:"in FilterBar",render:()=>{const[o,p]=d.useState("Standard"),[V,v]=d.useState("Standard"),[I,S]=d.useState([]),[M,f]=d.useState(!1),[D,O]=d.useState(!1),u=d.useRef({Standard:{selectedCountry:"Indonesia",date:"",selectedCodes:{}}}),L=(t,l)=>{const{payload:s,type:r}=l;switch(O(!0),r){case"selectedCountry":return{...t,selectedCountry:s};case"date":return{...t,date:s};case"selectedCodes":return{...t,selectedCodes:s};case"changeVariant":return s;default:return console.warn("Unknown action type!"),t}},[m,n]=d.useReducer(L,u.current.Standard),{selectedCountry:i,date:y,selectedCodes:C}=m,J=t=>{const{selectedOption:l}=t.detail;n({type:"selectedCountry",payload:l.textContent})},Z=t=>{n({type:"date",payload:t.detail.value})},q=t=>{n({type:"selectedCodes",payload:t.detail.items.reduce((l,s)=>(l[s.dataset.code]=!0,l),{})})},Q=t=>{const{variantItem:l,selected:s,readOnly:r,labelReadOnly:g,...c}=t.detail;c.isDefault&&v(c.children),S(F=>[...F,{...c,author:"Current User"}]),u.current[c.children]=m,p(c.children),f(!1)},Y=t=>{const{variantItem:l,selected:s,...r}=t.detail;u.current[r.children]=m,f(!1)},ee=t=>{const{deletedVariants:l,updatedVariants:s}=t.detail;l.forEach(r=>{delete u.current[r.children],S(g=>g.filter(c=>c.children!==r.children))}),s.forEach(r=>{const{variantItem:g,selected:c,...F}=r;u.current[r.children]=F,r.isDefault&&v(r.children),r.selected&&p(r.children),S(ae=>ae.map(B=>B.children===r.prevVariant.children?F:B))})},te=t=>{const l=t.detail.selectedVariant.children;n({type:"changeVariant",payload:u.current[l]}),p(l)};return d.useEffect(()=>{if(D){const t=Object.entries(u.current[o]).some(([l,s])=>{if(l==="selectedCodes"){const r=Object.keys(m.selectedCodes).length;return Object.keys(s).length!==r?!0:Object.entries(m.selectedCodes).some(([g,c])=>(s==null?void 0:s[g])!==c)}return m[l]!==s});O(!1),f(t)}},[D,o]),e.jsxs(e.Fragment,{children:[e.jsxs(oe,{header:e.jsxs(R,{hideApplyAutomatically:!0,dirtyState:M,onSaveAs:Q,onSave:Y,onSelect:te,onSaveManageViews:ee,children:[e.jsx(a,{selected:o==="Standard",global:!0,isDefault:V==="Standard",author:"SAP",readOnly:!0,labelReadOnly:!0,children:"Standard"}),I.map(t=>e.jsx(a,{...t,selected:o===t.children,isDefault:V===t.children,children:t.children},t.children))]}),children:[e.jsx(_,{label:"Countries",filterKey:0,children:e.jsxs(de,{onChange:J,children:[e.jsx(h,{selected:i==="Indonesia",children:"Indonesia"}),e.jsx(h,{selected:i==="Costa Rica",children:"Costa Rica"}),e.jsx(h,{selected:i==="Slovakia",children:"Slovakia"}),e.jsx(h,{selected:i==="Iceland",children:"Iceland"}),e.jsx(h,{selected:i==="Malta",children:"Malta"}),e.jsx(h,{selected:i==="Guyana",children:"Guyana"}),e.jsx(h,{selected:i==="Spain",children:"Spain"}),e.jsx(h,{selected:i==="Austria",children:"Austria"})]})}),e.jsx(_,{label:"Date",filterKey:1,children:e.jsx(le,{value:y,onChange:Z})}),e.jsx(_,{label:"Company Code",filterKey:2,children:e.jsxs(ie,{onSelectionChange:q,children:[e.jsx(x,{text:"001",selected:C["001"],"data-code":"001"}),e.jsx(x,{text:"002",selected:C["002"],"data-code":"002"}),e.jsx(x,{text:"003",selected:C["003"],"data-code":"003"}),e.jsx(x,{text:"004",selected:C["004"],"data-code":"004"}),e.jsx(x,{text:"005",selected:C["005"],"data-code":"005"})]})})]}),e.jsxs(se,{style:{marginBlockStart:"2rem"},layout:"S1 M1 L1 XL1",labelSpan:"S3 M3 L3 XL3",children:[e.jsx(T,{headerText:"Variant",children:e.jsx(k,{labelContent:e.jsx(P,{showColon:!0,children:"Current View"}),children:e.jsx(A,{children:o})})}),e.jsxs(T,{headerText:"Filters",children:[e.jsx(k,{labelContent:e.jsx(P,{showColon:!0,children:"Selected Country"}),children:e.jsx(A,{children:i})}),e.jsx(k,{labelContent:e.jsx(P,{showColon:!0,children:"Selected Date"}),children:e.jsx(A,{children:y})}),e.jsx(k,{labelContent:e.jsx(P,{showColon:!0,children:"Selected Company Codes"}),children:e.jsx(A,{children:Object.keys(C).join(", ")})})]})]})]})}};var E,N,K;b.parameters={...b.parameters,docs:{...(E=b.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: args => {
...
}`,...($=(H=j.parameters)==null?void 0:H.docs)==null?void 0:$.source}}};const ue=["Default","WithCustomValidation","WithFilterBarImplementation"],fe=Object.freeze(Object.defineProperty({__proto__:null,Default:b,WithCustomValidation:w,WithFilterBarImplementation:j,__namedExportsOrder:ue,default:ce},Symbol.toStringTag,{value:"Module"}));export{fe as C,b as D,w as W,j as a};
