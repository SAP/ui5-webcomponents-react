import{d as N,b as S,c as m,f as k,O as B,s as v,p as C,ab as R,m as x,aS as _,a4 as D,aQ as E,cX as O,be as L,cY as z,cZ as P,c_ as W,c$ as w,d0 as U,aR as y,aT as V,aU as A,w as q,j as p}from"./iframe-BGPLLWda.js";import{A as b}from"./index-DkEMFegB.js";import{p as I,f as H}from"./i18n-DSpjDgSK.js";import{A as r}from"./AvatarSize-BtKTMFJ5.js";import{A as G}from"./AvatarColorScheme-CysxkulG.js";var a;(function(i){i.Group="Group",i.Individual="Individual"})(a||(a={}));I("@ui5/webcomponents-theming","sap_horizon",async()=>N);I("@ui5/webcomponents","sap_horizon",async()=>S);const M=`:host{-webkit-tap-highlight-color:rgba(0,0,0,0)}:host(:not([hidden])){display:block;width:100%}:host{--_ui5-v2-13-3_button_focused_border: var(--_ui5-v2-13-3_avatar_group_button_focus_border)}.ui5-avatar-group-items:focus{outline:none}:host([type="Group"][desktop]) .ui5-avatar-group-items:focus,:host([type="Group"]) .ui5-avatar-group-items:focus-visible{outline:var(--_ui5-v2-13-3_avatar_outline);outline-offset:var(--_ui5-v2-13-3_avatar_focus_offset);border-radius:var(--_ui5-v2-13-3_avatar_group_focus_border_radius)}.ui5-avatar-group-root{display:flex;padding:var(--_ui5-v2-13-3_avatar_group_padding)}.ui5-avatar-group-items{white-space:nowrap;position:relative;display:inline-flex}:host([type="Group"]) .ui5-avatar-group-items{cursor:pointer}:host([type="Group"]) ::slotted([ui5-button]),:host([type="Group"]) ::slotted([ui5-avatar]),:host([type="Group"]) .ui5-avatar-group-overflow-btn{pointer-events:none}.ui5-avatar-group-overflow-btn{overflow:visible}.ui5-avatar-group-overflow-btn::part(button){min-width:auto}::slotted([ui5-button]:not([hidden])),.ui5-avatar-group-overflow-btn:not([hidden]){--_ui5-v2-13-3_button_base_padding: 0;border-radius:50%;display:inline-flex;text-overflow:initial;z-index:0}::slotted([ui5-button][desktop]:focus),.ui5-avatar-group-overflow-btn[desktop]:focus{outline:var(--_ui5-v2-13-3_avatar_outline);outline-offset:var(--_ui5-v2-13-3_avatar_overflow_button_focus_offset)}.ui5-avatar-group-overflow-btn::part(button):focus-visible:after{outline:var(--_ui5-v2-13-3_avatar_outline);outline-offset:var(--_ui5-v2-13-3_avatar_focus_offset);border-radius:50%}.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-xs{height:2rem;width:2rem;min-width:2rem;font-size:.75rem}::slotted([ui5-button]),.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-s{height:3rem;width:3rem;min-width:3rem;font-size:1.125rem}.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-m{height:4rem;width:4rem;min-width:4rem;font-size:1.625rem}.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-l{height:5rem;width:5rem;min-width:5rem;font-size:2rem}.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-xl{height:7rem;width:7rem;min-width:7rem;font-size:2.75rem}
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const $={title:"Data Display / AvatarGroup",component:c,argTypes:{children:{control:{disable:!0}},overflowButton:{control:{disable:!0}}},args:{type:a.Group},tags:["package:@ui5/webcomponents"]},d={render(i){return p.jsxs(c,{...i,children:[p.jsx(b,{icon:"employee"}),p.jsx(b,{initials:"JD"}),p.jsx(b,{children:p.jsx("img",{src:"https://sap.github.io/ui5-webcomponents/images/avatars/woman_avatar_5.png",alt:"Avatar1"})}),p.jsx(b,{children:p.jsx("img",{src:"https://sap.github.io/ui5-webcomponents/images/avatars/man_avatar_3.png",alt:"Avatar2"})})]})}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  render(args) {
...
}`,...d.parameters?.docs?.source}}};const X=["Default"],oe=Object.freeze(Object.defineProperty({__proto__:null,Default:d,__namedExportsOrder:X,default:$},Symbol.toStringTag,{value:"Module"}));export{oe as C,d as D};
