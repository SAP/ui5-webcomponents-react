import{j as c}from"./jsx-runtime-D_zvdyIk.js";import{I as b,u as w}from"./CustomElementsScope-CraI7z9b.js";import{r}from"./index-CEr2UAyE.js";import{A as D}from"./jsx-runtime-xa789Fx-.js";import{r as N}from"./index-7Z4Dhk6u.js";import{a as C}from"./index-uU-jEzfl.js";import{P as S}from"./index-BKXgMucs.js";import{M as _}from"./index-CjCZXMMP.js";import{T as q}from"./index-Dbkcovbd.js";import{D as V}from"./index-G4PRVoLy.js";import{R as M}from"./index-BxPaN3Uj.js";const u=()=>"randomUUID"in crypto?crypto.randomUUID():window.crypto.getRandomValues(new Uint32Array(1))[0].toString(16);globalThis["@ui5/webcomponents-react"]??(globalThis["@ui5/webcomponents-react"]={});const s=globalThis["@ui5/webcomponents-react"];function p(){return Symbol.for(`@ui5/webcomponents-react/Modals-${b()}/Listeners`)}function d(){return Symbol.for(`@ui5/webcomponents-react/Modals-${b()}`)}const g=[];function y(){var e;return s[e=p()]??(s[e]=[]),s[p()]}function f(){for(const e of y())e()}function h(){var e;return s[e=d()]??(s[e]=g),s[d()]}function A(e){const n=y();return s[p()]=[...n,e],()=>{s[p()]=n.filter(a=>a!==e)}}const l={subscribe:A,getSnapshot:h,getServerSnapshot:()=>g,addModal(e){s[d()]=[...h(),e],f()},removeModal(e){s[d()]=h().filter(n=>n.id!==e),f()}};function R(e,n){const a=u(),o=r.createRef();return l.addModal({Component:V,props:{...e,open:!0,onClose:i=>{typeof e.onClose=="function"&&e.onClose(i),l.removeModal(a)}},ref:o,container:n,id:a}),{ref:o,close:()=>{o.current&&(o.current.open=!1)}}}function T(e,n){const a=u(),o=r.createRef();return l.addModal({Component:S,props:{...e,open:!0,onClose:i=>{typeof e.onClose=="function"&&e.onClose(i),l.removeModal(a)}},ref:o,container:n,id:a}),{ref:o,close:()=>{o.current&&(o.current.open=!1)}}}function E(e,n){const a=u(),o=r.createRef();return l.addModal({Component:M,props:{...e,open:!0,onClose:i=>{typeof e.onClose=="function"&&e.onClose(i),l.removeModal(a)}},ref:o,container:n,id:a}),{ref:o,close:()=>{o.current&&(o.current.open=!1)}}}function I(e,n){const a=u(),o=r.createRef();return l.addModal({Component:_,props:{...e,open:!0,onClose:i=>{typeof e.onClose=="function"&&e.onClose(i),l.removeModal(a)}},ref:o,container:n,id:a}),{ref:o,close:()=>{o.current&&(o.current.open=!1)}}}function P(e,n){const a=u(),o=r.createRef();return l.addModal({Component:C,props:{...e,open:!0,onClose:i=>{typeof e.onClose=="function"&&e.onClose(i),l.removeModal(a)}},ref:o,container:n,id:a}),{ref:o,close:()=>{o.current&&(o.current.open=!1)}}}function B(e,n){const a=r.createRef(),o=u();return l.addModal({Component:q,props:{...e,open:!0,onClose:i=>{typeof e.onClose=="function"&&e.onClose(i),l.removeModal(o)}},ref:a,container:n,id:o}),{ref:a}}function v({modal:e}){const[n,a]=D(e.ref);w(()=>{const m=a.current;m&&requestAnimationFrame(()=>{m.open=!0})},[]);const{open:o,...i}=e.props;return c.jsx(e.Component,{...i,ref:n,"data-id":e.id})}function t(){const e=r.useSyncExternalStore(l.subscribe,l.getSnapshot,l.getServerSnapshot);return c.jsx(c.Fragment,{children:e.map(n=>{if(n!=null&&n.Component)return n.container?N.createPortal(c.jsx(v,{modal:n},n.id),n.container):c.jsx(v,{modal:n},n.id)})})}t.displayName="Modals";t.showDialog=R;t.showPopover=T;t.showResponsivePopover=E;t.showMenu=I;t.showMessageBox=P;t.showToast=B;try{t.displayName="Modals",t.__docgenInfo={description:`Utility class for opening modals in an imperative way.
...
**Note:** Upon resizing, externally defined height and width styling will be ignored.`,name:"resizable",required:!1,type:{name:"boolean"}},state:{defaultValue:{value:'"None"'},description:'Defines the state of the `Dialog`.\n\n**Note:** If `"Negative"` and `"Critical"` states is set, it will change the\naccessibility role to "alertdialog", if the accessibleRole property is set to `"Dialog"`.',name:"state",required:!1,type:{name:"enum",value:[{value:'"Positive"'},{value:'"Negative"'},{value:'"None"'},{value:'"Positive"'},{value:'"Critical"'},{value:'"Negative"'},{value:'"Information"'},{value:'"None"'},{value:'"Critical"'},{value:'"Information"'}]}},stretch:{defaultValue:{value:"false"},description:`Determines if the dialog will be stretched to full screen on mobile. On desktop,
the dialog will be stretched to approximately 90% of the viewport.

**Note:** For better usability of the component it is recommended to set this property to "true" when the dialog is opened on phone.`,name:"stretch",required:!1,type:{name:"boolean"}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
...
| cancelable | bubbles |
| :--------: | :-----: |
| ❌|❌|`,name:"onOpen",required:!1,type:{name:"(event: Ui5CustomEvent<PopoverDomRef, never>) => void"}},accessibleDescription:{defaultValue:{value:"undefined"},description:`Defines the accessible description of the component.
...
| cancelable | bubbles |
| :--------: | :-----: |
| ✅|✅|`,name:"onBeforeClose",required:!1,type:{name:"(event: Ui5CustomEvent<MenuDomRef, MenuBeforeCloseEventDetail>) => void"}},onBeforeOpen:{defaultValue:null,description:`Fired before the menu is opened. This event can be cancelled, which will prevent the menu from opening.
...
| cancelable | bubbles |
| :--------: | :-----: |
| ✅|✅|`,name:"onBeforeOpen",required:!1,type:{name:"(event: Ui5CustomEvent<MenuDomRef, MenuBeforeOpenEventDetail>) => void"}},onClose:{defaultValue:null,description:`Fired after the menu is closed.
...
| cancelable | bubbles |
| :--------: | :-----: |
| ✅|❌|`,name:"onItemClick",required:!1,type:{name:"(event: Ui5CustomEvent<MenuDomRef, MenuItemClickEventDetail>) => void"}},onOpen:{defaultValue:null,description:`Fired after the menu is opened.

**Note:** Available since [v1.10.0](https://github.com/SAP/ui5-webcomponents/releases/tag/v1.10.0) of **@ui5/webcomponents**.

| cancelable | bubbles |
| :--------: | :-----: |
| ❌|✅|`,name:"onOpen",required:!1,type:{name:"(event: Ui5CustomEvent<MenuDomRef, never>) => void"}},headerText:{defaultValue:{value:"undefined"},description:"Defines the header text of the menu (displayed on mobile).",name:"headerText",required:!1,type:{name:"string"}},horizontalAlign:{defaultValue:{value:'"Start"'},description:"Determines the horizontal alignment of the menu relative to its opener control.",name:"horizontalAlign",required:!1,type:{name:"enum",value:[{value:'"Center"'},{value:'"Start"'},{value:'"End"'},{value:'"Stretch"'},{value:'"Center"'},{value:'"Start"'},{value:'"End"'},{value:'"Stretch"'}]}},loading:{defaultValue:{value:"false"},description:`Defines if a loading indicator would be displayed inside the corresponding ui5-menu popover.
...
**Note:** Available since [v2.11.0](https://github.com/SAP/ui5-webcomponents/releases/tag/v2.11.0) of **@ui5/webcomponents**.`,name:"accessibleDescriptionRef",required:!1,type:{name:"string"}},onOpen:{defaultValue:null,description:`Fired after the component is opened.
...
**Note:** Upon resizing, externally defined height and width styling will be ignored.`,name:"resizable",required:!1,type:{name:"boolean"}},accessibleRole:{defaultValue:{value:'"Dialog"'},description:`Allows setting a custom role.
...
| cancelable | bubbles |
| :--------: | :-----: |
| ✅|❌|`,name:"onBeforeOpen",required:!1,type:{name:"(event: Ui5CustomEvent<DialogDomRef, never>) => void"}}}}}catch{}try{t.showToast.displayName="Modals.showToast",t.showToast.__docgenInfo={description:"",displayName:"Modals.showToast",props:{children:{defaultValue:null,description:`Defines the text of the component.
