import"./Icon-BdT1PzT1.js";import{w as t}from"./withWebComponent-pt4_FAs2.js";const e=t("ui5-icon",["accessibleName","design","mode","name"],["showTooltip"],[],[]);e.displayName="Icon";try{e.displayName="Icon",e.__docgenInfo={description:`The \`Icon\` component represents an SVG icon.
...
**Note:** Available since [v1.9.2](https://github.com/SAP/ui5-webcomponents/releases/tag/v1.9.2) of **@ui5/webcomponents**.`,name:"design",required:!1,type:{name:"enum",value:[{value:'"Information"'},{value:'"Positive"'},{value:'"Critical"'},{value:'"Negative"'},{value:'"Neutral"'},{value:'"Default"'},{value:'"Contrast"'},{value:'"Critical"'},{value:'"Default"'},{value:'"Information"'},{value:'"Negative"'},{value:'"Neutral"'},{value:'"NonInteractive"'},{value:'"Positive"'},{value:'"Contrast"'},{value:'"NonInteractive"'}]}},mode:{defaultValue:{value:'"Image"'},description:`Defines the mode of the component.
