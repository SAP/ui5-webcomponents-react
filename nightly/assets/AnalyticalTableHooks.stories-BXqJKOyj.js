import{aj as W,eL as z,r as g,j as n,i as B,B as j,v as T}from"./iframe-S1rR11cQ.js";import{d as U}from"./Friends500-CRbR9XAn.js";import{A as b,d as D,g as J,m as G,e as S,f as K}from"./AnalyticalTable.stories-BYRCdEc9.js";import{a as $}from"./Input-BFiJeabE.js";import{F as w,c as A,a as V}from"./index-qWGPhuwe.js";import{T as H}from"./index-BwzYicPU.js";import{C as F}from"./index-D4DGjUgH.js";import{L as x}from"./index-0zwvIbNd.js";import{d as Y}from"./debounce-D7W5PopO.js";import{I as q}from"./index-DC42DZTr.js";const O=e=>{const o=W("@ui5/webcomponents").getText(z),r=g.useCallback((d,{cell:{value:t}})=>typeof t!="number"&&!t?[d,{"aria-label":`${d["aria-label"]} ${o}`}]:d,[o]);e.getCellProps.push(r)};O.pluginName="useAnnounceEmptyCells";const Q=(e,a)=>{let o=e.lastIndexOf(".");o===-1&&(o=1/0);const r=e.slice(0,o);return[a[r],o]},L=e=>{const a={},o=e.lastIndexOf(".");return a[e]=!0,o!==-1&&Object.assign(a,L(e.slice(0,o))),a},X=(e,a,o)=>{const r={};let d="";const t=(u,s=null)=>{for(const i of u)if(i.subRows.length>0)t(i.subRows,i.id);else if(s!==null&&d!==s){d=s;const l=c=>{const[m,h]=Q(c,a),f=m.subRows.filter(y=>o.selectedRowIds[y.id]),p=m.subRows.length===f.length;if(f.length>0&&!p){const y=m.id;Object.assign(r,L(y));return}h!==1/0&&l(m.id)};l(i.id)}};return t(e),r},N=e=>{const a=(t,{row:u,instance:s})=>{let i;return s.isAllRowsSelected?i=!1:i=s?.state?.indeterminateRows?.[u.id]??!1,t.checked&&!s.state.selectedRowIds[u.id]&&u.toggleRowSelected(!0),[t,{indeterminate:i,checked:i?!0:t.checked}]},o=(t,u,s,i)=>{const{rowsById:l,state:c,rows:m}=i;if(u.type==="INDETERMINATE_ROW_IDS"){if(u.payload==="reset")return{...t,indeterminateRows:{}};const h=X(m,l,c);return{...t,indeterminateRows:h}}},r=t=>{const{data:u,dispatch:s,rowsById:i,state:{selectedRowIds:l,indeterminateRows:c},webComponentsReactProperties:{selectionMode:m,selectionBehavior:h,isTreeTable:f}}=t;g.useEffect(()=>{f&&m===b.Multiple&&h!==D.RowOnly&&Object.keys(l).length&&Object.keys(i).length!==Object.keys(l).length?s({type:"INDETERMINATE_ROW_IDS"}):typeof c=="object"&&Object.keys(c).length&&s({type:"INDETERMINATE_ROW_IDS",payload:"reset"})},[u,l,f,m,h]),g.useEffect(()=>{typeof e=="function"&&c&&e({indeterminateRowsById:c,tableInstance:t})},[c])},d=t=>{t.getToggleRowSelectedProps.push(a),t.stateReducers.push(o),t.useInstanceAfterData.push(r)};return d.pluginName="useIndeterminate",d};try{N.displayName="useIndeterminateRowSelection",N.__docgenInfo={description:"A plugin hook that marks parent rows as indeterminate if a child row is selected in `Multiple` mode.\nWhen using this hook, it is recommended to also select all sub-rows when selecting a row. (`reactTableOptions={{ selectSubRows: true }}`)\n\n__Note:__ The `indeterminate` state has a higher priority than the `selected` state. Therefore, a row can be selected and indeterminate at the same time. This can for example happen, if `selectSubRows: true` is set and a row with sub-rows is selected and then a sub-row is unselected.\n\n__Note:__ This hook has to traverse the whole data tree on each selection, which can lead to performance degradation with large datasets. Please use with caution!",displayName:"useIndeterminateRowSelection",props:{}}}catch{}try{N.displayName="useIndeterminateRowSelection",N.__docgenInfo={description:"A plugin hook that marks parent rows as indeterminate if a child row is selected in `Multiple` mode.\nWhen using this hook, it is recommended to also select all sub-rows when selecting a row. (`reactTableOptions={{ selectSubRows: true }}`)\n\n__Note:__ The `indeterminate` state has a higher priority than the `selected` state. Therefore, a row can be selected and indeterminate at the same time. This can for example happen, if `selectSubRows: true` is set and a row with sub-rows is selected and then a sub-row is unselected.\n\n__Note:__ This hook has to traverse the whole data tree on each selection, which can lead to performance degradation with large datasets. Please use with caution!",displayName:"useIndeterminateRowSelection",props:{}}}catch{}const Z=(e="isSelected")=>{const a=({flatRows:r,toggleRowSelected:d})=>{g.useEffect(()=>{r.forEach(({id:t,original:u})=>{e in u&&d(t,u.isSelected)})},[r,e])},o=r=>{r.useInstanceAfterData.push(a)};return o.pluginName="useManualRowSelect",o},ee=(e,a)=>{const o=Y(e,a?.wait??100),r=t=>{const{state:u,columns:s}=t,{columnResizing:i}=u,{isResizingColumn:l,columnWidths:c}=i,m=g.useRef(void 0);g.useEffect(()=>{if(l&&a?.liveUpdate){const h=s.find(f=>f.id===l);o({columnWidth:c[l],header:h})}},[i,a?.liveUpdate,s]),g.useEffect(()=>{if(a?.liveUpdate)return()=>o.cancel()},[a?.liveUpdate]),g.useEffect(()=>{if(!a?.liveUpdate){const h=s.find(f=>f.id===m.current);l&&(m.current=l),!l&&m.current&&e({columnWidth:c[m.current],header:h})}},[i,a?.liveUpdate,s])},d=t=>{t.useFinalInstance.push(r)};return d.pluginName="useOnColumnResize",d},ne=e=>{const a=o=>{o.stateReducers.push((r,d)=>{if(d.type==="toggleSortBy"){if(r.sortBy.length<=1)return r;{const t=[...r.sortBy],u=e.flatMap(s=>{const i=t.findIndex(l=>l.id===s);if(i!==-1){const l=t[i];return t.splice(i,1),[l]}return[]});return{...r,sortBy:[...u,...t]}}}return r})};return a.pluginName="useOrderedMultiSort",a},ae={verticalAlign:"middle"},te=(e,{instance:{webComponentsReactProperties:{selectionMode:a}}})=>{if(e.key==="header___ui5wcr__internal_selection_column"&&a===b.Multiple){const o={...e.style,cursor:"auto"};return[e,{onClick:void 0,onKeyDown:void 0,title:void 0,style:o}]}return e},se=e=>e.map(a=>a.id==="__ui5wcr__internal_selection_column"?{...a,Cell:o=>{const{webComponentsReactProperties:r,row:d}=o;return d.disableSelect===!0?d.isGrouped&&r.selectionMode===b.Single?null:r.selectionMode===b.Single?n.jsx("div",{onClick:void 0,"data-name":"internal_selection_column"}):n.jsx(F,{...d.getToggleRowSelectedProps(),disabled:!0,style:ae,"data-name":"internal_selection_column",tabIndex:-1}):a.Cell(o)},Header:()=>null}:a),R=e=>{const a=typeof e=="function"?e:s=>J(s.original,e,void 0),o=(s,{row:i,instance:l})=>{const{webComponentsReactProperties:c}=l;return a(i)===!0?(i.disableSelect=!0,{...s,onClick:p=>{typeof c.onRowClick=="function"&&c.onRowClick(B(p,{row:i}))},onKeyDown:p=>{(p.code==="Enter"||p.code==="Space")&&(p.preventDefault(),p.code==="Enter"&&typeof c.onRowClick=="function"&&c.onRowClick(B(p,{row:i})))},onKeyUp:p=>{p.code==="Space"&&(p.preventDefault(),typeof c.onRowClick=="function"&&c.onRowClick(B(p,{row:i})))},className:c.classes.tr}):s},r=s=>[...s,e],d=(s,{cell:{row:i,column:l},instance:c})=>{const{selectionMode:m,selectionBehavior:h}=c.webComponentsReactProperties;if(a(i)===!0&&m!==b.None&&(h!==D.RowSelector||l.id==="__ui5wcr__internal_selection_column")){const{"aria-label":f,...p}=s;if(l.id==="__ui5wcr__internal_selection_column"){const P={...s.style,cursor:"auto"};return{...p,"aria-disabled":!0,style:P}}const{"aria-selected":E,...y}=p;return y}return s},t=(s,{row:i})=>{if(a(i)===!0){const{title:l,...c}=s;return c}return s},u=s=>{s.getHeaderProps.push(te),s.getRowProps.push(o),s.columns.push(se),s.columnsDeps.push(r),s.getCellProps.push(d),s.getToggleRowSelectedProps.push(t)};return u.pluginName="useRowDisableSelection",u};try{R.displayName="useRowDisableSelection",R.__docgenInfo={description:`A plugin hook for disabling row selection of specific rows.
