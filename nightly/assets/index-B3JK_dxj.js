import{p as d,q as h,a as f,s as b,b as y,m as x,y as w,S as _,w as v}from"./withWebComponent-wFYtA7If.js";import{d as g}from"./slot-_4yKMUwC.js";import"./utils-U7G133b4.js";import{i as T}from"./i18n-DEVDpFvK.js";import{t as I}from"./willShowContent-CZcfsNXp.js";import{a1 as N,a2 as S}from"./i18n-defaults-NO4RLLYJ.js";import{s as O}from"./parameters-bundle.css-BOSi_lPd.js";import{d as D}from"./useIsomorphicLayoutEffect-Dm78g2BF.js";var u;(function(e){e.Off="Off",e.On="On"})(u||(u={}));const C=u;function M(e,t,n){return d`<span>${this._renderEmptyIndicator?R.call(this,e,t,n):q.call(this,e,t,n)}</span>`}function R(e,t,n){return d`<span class="empty-indicator" aria-hidden="true">${h(this._emptyIndicatorSymbol)}</span><span class="empty-indicator-aria-label">${h(this._emptyIndicatorAriaLabel)}</span>`}function q(e,t,n){return d`<slot></slot>`}f("@ui5/webcomponents-theming","sap_horizon",async()=>b);f("@ui5/webcomponents","sap_horizon",async()=>O);const E={packageName:"@ui5/webcomponents",fileName:"themes/Text.css.ts",content:`:host{display:inline-block;max-width:100%;font-size:var(--sapFontSize);font-family:var(--sapFontFamily);color:var(--sapTextColor);line-height:normal;white-space:pre-line;word-wrap:break-word;cursor:text}:host([max-lines]){display:-webkit-box;-webkit-line-clamp:var(--_ui5-v2-3-0_text_max_lines);line-clamp:var(--_ui5-v2-3-0_text_max_lines);-webkit-box-orient:vertical;overflow:hidden;white-space:normal}.empty-indicator-aria-label{position:absolute!important;clip:rect(1px,1px,1px,1px);user-select:none;left:0;top:0;font-size:0}
`};var s=function(e,t,n,r){var l=arguments.length,o=l<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,p;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,n,r);else for(var m=e.length-1;m>=0;m--)(p=e[m])&&(o=(l<3?p(o):l>3?p(t,n,o):p(t,n))||o);return l>3&&o&&Object.defineProperty(t,n,o),o},c;let a=c=class extends _{constructor(){super(...arguments),this.maxLines=1/0,this.emptyIndicatorMode="Off"}onBeforeRendering(){this.style.setProperty(D("--_ui5_text_max_lines"),`${this.maxLines}`)}get hasText(){return I(this.text)}get _renderEmptyIndicator(){return!this.hasText&&this.emptyIndicatorMode===C.On}get _emptyIndicatorAriaLabel(){return c.i18nBundle.getText(N)}get _emptyIndicatorSymbol(){return c.i18nBundle.getText(S)}};s([y({type:Number})],a.prototype,"maxLines",void 0);s([y()],a.prototype,"emptyIndicatorMode",void 0);s([g({type:Node,default:!0})],a.prototype,"text",void 0);s([T("@ui5/webcomponents")],a,"i18nBundle",void 0);a=c=s([x({tag:"ui5-text",renderer:w,template:M,styles:E})],a);a.define();const i=v("ui5-text",["emptyIndicatorMode","maxLines"],[],[],[]);i.displayName="Text";try{i.displayName="Text",i.__docgenInfo={description:`<h3>Overview</h3>
