import{j as s}from"./jsx-runtime-D_zvdyIk.js";import{B as I}from"./Button-DsiN4KEf.js";import{a as F}from"./Icon-Dy5MqRQN.js";import{P as k}from"./PopupsCommon.css-1ftV5PB8.js";import{T as L}from"./Title-l18RNg85.js";import{o as u}from"./ValueState-Bg0UWejw.js";import"./jsx-runtime-2NO35c9p.js";import"./sys-help-2-CQSD8GDX.js";import"./CustomElementsScope-BZQ-yqK5.js";import{r as m}from"./index-U0ga5oGA.js";import{c as W}from"./clsx-B-dksMZM.js";import{u as P,Y as H,R as U,O as j,N as $,h as K,D as Y,C as G,i as J,j as Q,W as X,S as Z,I as ee,E as te,k as ne}from"./i18n-defaults-DHddteo6.js";import{D as oe}from"./index-B23f-h2l.js";import{T as ae}from"./index-BLz-vMdv.js";import{T as se}from"./index-Z1IFI4-r.js";import{u as ie}from"./useStylesheet-DhspXHhi.js";import{B as re}from"./index-C2cs6waD.js";import{I as le}from"./index-hij65avV.js";var n=(e=>(e.Abort="Abort",e.Cancel="Cancel",e.Close="Close",e.Delete="Delete",e.Ignore="Ignore",e.No="No",e.OK="OK",e.Retry="Retry",e.Yes="Yes",e))(n||{}),a=(e=>(e.Confirm="Confirm",e.Error="Error",e.Information="Information",e.Success="Success",e.Warning="Warning",e))(a||{});const de="sys-help-2",ce="@layer ui5-webcomponents-react{._messageBox_13pdm_1[data-type=Confirm]::part(header){box-shadow:inset 0 -.0625rem var(--sapNeutralBorderColor),var(--sapContent_HeaderShadow)}._messageBox_13pdm_1[data-type=Confirm] ._header_13pdm_8{--sapContent_NonInteractiveIconColor:var(--sapNeutralElementColor)}._header_13pdm_8{align-items:center;border-bottom:1px solid var(--messageBoxBorderColor);box-sizing:border-box;color:var(--sapContent_LabelColor);display:flex;font-size:1rem;height:var(--_ui5wcr-BarHeight);text-align:center;width:100%}._header_13pdm_8 [ui5-icon]:first-child{height:1rem;width:1rem}._header_13pdm_8 [ui5-title]{font-size:1rem}._spacer_13pdm_34{width:.5rem}._confirmIcon_13pdm_38{color:var(--sapNeutralColor)}._footer_13pdm_42{align-items:center;display:flex;height:var(--_ui5wcr-BarHeight);justify-content:flex-end;width:100%}._footer_13pdm_42>*{margin:0 .25rem}._footer_13pdm_42>[ui5-button]{display:flex;min-width:4rem}}",p={messageBox:"_messageBox_13pdm_1",header:"_header_13pdm_8",spacer:"_spacer_13pdm_34",confirmIcon:"_confirmIcon_13pdm_38",footer:"_footer_13pdm_42"},ue=(e,r,f)=>{if(m.isValidElement(e))return e;switch(r){case a.Confirm:return s.jsx(le,{name:de,mode:F.Decorative,className:f.confirmIcon});default:return null}},pe=e=>{switch(e){case a.Information:return u.Information;case a.Success:return u.Positive;case a.Warning:return u.Critical;case a.Error:return u.Negative;default:return u.None}},me=(e,r)=>e&&e.length>0?e:r===a.Confirm?[n.OK,n.Cancel]:r===a.Error?[n.Close]:[n.OK],d=m.forwardRef((e,r)=>{const{open:f,type:c=a.Confirm,children:R,className:B,titleText:y,icon:V,actions:E=[],emphasizedAction:q=n.OK,onClose:h,initialFocus:w,...S}=e;ie(ce,d.displayName);const o=P("@ui5/webcomponents-react"),A={[n.Abort]:o.getText(Q),[n.Cancel]:o.getText(J),[n.Close]:o.getText(G),[n.Delete]:o.getText(Y),[n.Ignore]:o.getText(K),[n.No]:o.getText($),[n.OK]:o.getText(j),[n.Retry]:o.getText(U),[n.Yes]:o.getText(H)},_=()=>{if(y)return y;switch(c){case a.Confirm:return o.getText(ne);case a.Error:return o.getText(te);case a.Information:return o.getText(ee);case a.Success:return o.getText(Z);case a.Warning:return o.getText(X);default:return null}},M=t=>{typeof e.onBeforeClose=="function"&&e.onBeforeClose(t),t.detail.escPressed&&typeof h=="function"&&h(void 0,t.detail.escPressed)},g=t=>{const{action:i}=t.currentTarget.dataset;typeof h=="function"&&h(i)},l=m.useId(),b=me(E,c),O=()=>{const t=b.findIndex(i=>i===w);return t!==-1&&typeof b[t]=="string"?`${l}-action-${t}`:w},{footer:he,headerText:fe,onClose:ge,onBeforeClose:be,...z}=S,v=ue(V,c,p),N=!e.header&&!!v;return s.jsxs(oe,{open:f,ref:r,className:W(p.messageBox,B),onBeforeClose:M,accessibleNameRef:N?`${l}-title ${l}-text`:void 0,accessibleRole:k.AlertDialog,...z,headerText:_(),state:pe(c),initialFocus:O(),"data-type":c,children:[N&&s.jsxs("div",{slot:"header",className:p.header,children:[v,v&&s.jsx("span",{className:p.spacer}),s.jsx(ae,{id:`${l}-title`,level:L.H1,children:_()})]}),s.jsx(se,{id:`${l}-text`,children:R}),s.jsx("div",{slot:"footer",className:p.footer,children:b.map((t,i)=>{var C,D;return typeof t!="string"&&m.isValidElement(t)?m.cloneElement(t,{onClick:(C=t==null?void 0:t.props)!=null&&C.onClick?x=>{var T;(T=t==null?void 0:t.props)==null||T.onClick(x),g(x)}:g,"data-action":((D=t==null?void 0:t.props)==null?void 0:D["data-action"])??`${i}: custom action`}):typeof t=="string"?s.jsx(re,{id:`${l}-action-${i}`,design:q===t?I.Emphasized:I.Transparent,onClick:g,"data-action":t,children:A[t]??t},`${t}-${i}`):null})})]})});d.displayName="MessageBox";try{d.displayName="MessageBox",d.__docgenInfo={description:"The `MessageBox` component provides easier methods to create a `Dialog`, such as standard alerts, confirmation dialogs, or arbitrary message dialogs.",displayName:"MessageBox",props:{accessibleNameRef:{defaultValue:null,description:`Defines the IDs of the elements that label the component.
...
| cancelable | bubbles |
| :--------: | :-----: |
| ✅|❌|`,name:"onBeforeOpen",required:!1,type:{name:"(event: Ui5CustomEvent<DialogDomRef, never>) => void"}}}}}catch{}export{a as M,d as a,n as b};
