import{a as _,j as r,F as f,p as v,d as y,s as d,m as w,e as k,w as T}from"./withWebComponent-XJjz10u8.js";import{d as S}from"./slot-_4yKMUwC.js";import{l as m}from"./event-strict-DgQLNDEV.js";import{F as I,K as N,x as D,a as q,_ as C,c as V,P as M,W as R}from"./Keys-Can65e7H.js";import"./utils-DyMdBfPm.js";import{aF as z,aG as A}from"./i18n-defaults-CjsTKlnu.js";import{b as x,a as g}from"./Input-OmHoX_CV.js";import{f as b,I as U}from"./Icon-D3cRfWaZ.js";import{T as H,g as P}from"./Token-DFNpFnby.js";import{d as E}from"./parameters-bundle.css-DSUsAvJy.js";import{d as L}from"./useIsomorphicLayoutEffect-Bu4xop1x.js";const F="value-help",O="M470 41q10 9 10 23v192q0 12-10 22t-22 10H256q-14 0-23-10-9-9-9-22V64q0-14 9-23t23-9h192q13 0 22 9zm-22 23H256v192h192V64zm-96 256h32v128q0 14-9 23t-23 9H64q-12 0-23-9-9-9-9-23V160q0-14 9-23t23-9h128v32H64v288h288V320z",W=!1,B="SAP-icons-v4",$="@ui5/webcomponents-icons";b(F,{pathData:O,ltr:W,collection:B,packageName:$});const G="value-help",j="M294 160q24 0 41 17t17 41v204q0 24-17 41t-41 17H90q-24 0-41-17t-17-41V218q0-24 17-41t41-17h204zM422 32q24 0 41 17t17 41v204q0 24-17 41t-41 17h-12q-11 0-18.5-7.5T384 326t7.5-18 18.5-7h12q7 0 7-7V90q0-7-7-7H218q-7 0-7 7v12q0 11-7 18.5t-18 7.5-18.5-7.5T160 102V90q0-24 17-41t41-17h204zM301 218q0-7-7-7H90q-7 0-7 7v204q0 7 7 7h204q7 0 7-7V218z",K=!1,X="SAP-icons-v5",J="@ui5/webcomponents-icons";b(G,{pathData:j,ltr:K,collection:X,packageName:J});const Q="value-help";function Y(){return[x.call(this,{preContent:Z,postContent:ee})]}function Z(){return _(f,{children:[r("span",{id:"hiddenText-nMore",class:"ui5-hidden-text",children:this._tokensCountText}),r(H,{class:"ui5-multi-input-tokenizer",opener:this.morePopoverOpener,popoverMinWidth:this._inputWidth,hidePopoverArrow:!0,expanded:this.tokenizerExpanded,onKeyDown:this._onTokenizerKeydown,onTokenDelete:this.tokenDelete,onFocusOut:this._tokenizerFocusOut,children:this.tokens.map(a=>r("slot",{name:a._individualSlot}))})]})}function ee(){return r(f,{children:this.showValueHelpIcon&&r(U,{class:"inputIcon",name:Q,accessibleName:this.valueHelpLabel,onMouseUp:this.valueHelpMouseUp,onMouseDown:this.valueHelpMouseDown,onClick:this.valueHelpPress})})}v("@ui5/webcomponents-theming","sap_horizon",async()=>y);v("@ui5/webcomponents","sap_horizon",async()=>E);const te=`.inputIcon{color:var(--_ui5-v2-7-1_input_icon_color);cursor:pointer;outline:none;padding:var(--_ui5-v2-7-1_input_icon_padding);border-inline-start:var(--_ui5-v2-7-1_input_icon_border);min-width:1rem;min-height:1rem;border-radius:var(--_ui5-v2-7-1_input_icon_border_radius)}.inputIcon.inputIcon--pressed{background:var(--_ui5-v2-7-1_input_icon_pressed_bg);box-shadow:var(--_ui5-v2-7-1_input_icon_box_shadow);border-inline-start:var(--_ui5-v2-7-1_select_hover_icon_left_border);color:var(--_ui5-v2-7-1_input_icon_pressed_color)}.inputIcon:active{background-color:var(--sapButton_Active_Background);box-shadow:var(--_ui5-v2-7-1_input_icon_box_shadow);border-inline-start:var(--_ui5-v2-7-1_select_hover_icon_left_border);color:var(--_ui5-v2-7-1_input_icon_pressed_color)}.inputIcon:not(.inputIcon--pressed):not(:active):hover{background:var(--_ui5-v2-7-1_input_icon_hover_bg);box-shadow:var(--_ui5-v2-7-1_input_icon_box_shadow)}.inputIcon:hover{border-inline-start:var(--_ui5-v2-7-1_select_hover_icon_left_border);box-shadow:var(--_ui5-v2-7-1_input_icon_box_shadow)}:host{min-width:calc(var(--_ui5-v2-7-1_input_min_width) + (var(--_ui5-v2-7-1-input-icons-count)*var(--_ui5-v2-7-1_input_icon_width)))}:host([tokenizer-available]){min-width:calc(var(--_ui5-v2-7-1_input_min_width) + (var(--_ui5-v2-7-1-input-icons-count)*var(--_ui5-v2-7-1_input_icon_width)) + var(--_ui5-v2-7-1_input_tokenizer_min_width))}.ui5-multi-input-tokenizer{min-width:var(--_ui5-v2-7-1_input_tokenizer_min_width);max-width:calc(100% - 3rem - var(--_ui5-v2-7-1-input-icons-count) * var(--_ui5-v2-7-1_input_icon_min_width));border:none;width:auto;height:100%}:host([readonly]) .ui5-multi-input-tokenizer::part(n-more-text){color:var(--sapLinkColor)}.ui5-multi-input-tokenizer::part(n-more-text){padding-inline-end:var(--_ui5-v2-7-1_input_inner_space_to_n_more_text)}[inner-input][inner-input-with-icon]{padding:var(--_ui5-v2-7-1_input_inner_padding_with_icon)}:host([tokenizer-available]) [inner-input]{padding-inline-start:var(--_ui5-v2-7-1_input_inner_space_to_tokenizer)}:host(:not([tokenizer-available])) .ui5-multi-input-tokenizer{--_ui5-v2-7-1_input_tokenizer_min_width: 0px;width:var(--_ui5-v2-7-1_input_tokenizer_min_width)}
`;var p=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var c=a.length-1;c>=0;c--)(s=a[c])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i},h;let l=h=class extends g{get formValidity(){const e=this.tokens||[];return{valueMissing:this.required&&!this.value&&!e.length}}get formFormattedValue(){const e=this.tokens||[];if(e.length&&this.name){const t=new FormData;t.append(this.name,this.value);for(let n=0;n<e.length;n++)t.append(this.name,e[n].text||"");return t}return this.value}constructor(){super(),this.showValueHelpIcon=!1,this.tokenizerAvailable=!1,this._skipOpenSuggestions=!1,this._valueHelpIconPressed=!1}valueHelpPress(){this.closeValueStatePopover(),this.fireDecoratorEvent("value-help-trigger")}tokenDelete(e){const t=e.detail.tokens,n=this.tokens.filter(i=>i.selected),o=this.tokens.length-1===0||this.tokens.length===n.length;this._readonly||t&&(this.fireDecoratorEvent("token-delete",{tokens:t}),o&&this.focus())}valueHelpMouseDown(e){const t=e.target;this.closeValueStatePopover(),this.tokenizer.open=!1,this._valueHelpIconPressed=!0,t.focus()}_tokenizerFocusOut(e){!this.contains(e.relatedTarget)&&!this.shadowRoot.contains(e.relatedTarget)&&(this.tokenizer._tokens.forEach(t=>{t.selected=!1}),this.tokenizer.scrollToStart())}valueHelpMouseUp(){setTimeout(()=>{this._valueHelpIconPressed=!1},0)}innerFocusIn(){this.tokenizer.expanded=!0,this.focused=!0,this.tokenizer.scrollToEnd(),this.tokens.forEach(e=>{e.selected=!1})}_onkeydown(e){super._onkeydown(e);const t=e.target;if(I(e)&&t.selectionStart===0)return this._skipOpenSuggestions=!0,this._focusFirstToken(e);if(N(e))return this._skipOpenSuggestions=!0,this._handleLeft(e);if(D(e))return this._skipOpenSuggestions=!0,this._handleBackspace(e);this._skipOpenSuggestions=!1,q(e)&&this.valueHelpPress()}_onTokenizerKeydown(e){const t=C(e);if(V(e)||M(e)||R(e)||t){e.preventDefault();const n=this.tokens.length-1;e.target===this.tokens[n]&&this.tokens[n]===document.activeElement&&setTimeout(()=>{this.focus()},0)}}_handleLeft(e){const t=this.getDomRef().querySelector("input").selectionStart,n=this.tokens,o=n.length&&n[n.length-1];(t===null&&!this.value||t===0)&&o&&(e.preventDefault(),o.focus(),this.tokenizer._itemNav.setCurrentItem(o))}_handleBackspace(e){const t=this.getDomRef().querySelector("input").selectionStart,n=this.getDomRef().querySelector("input").selectionEnd,o=t===0&&n===this.value.length,i=this.tokens,s=i.length&&i[i.length-1];(!this.value||this.value&&t===0&&!o)&&s&&(e.preventDefault(),s.focus(),this.tokenizer._itemNav.setCurrentItem(s))}_focusFirstToken(e){const t=this.tokens,n=t.length&&t[0];n&&(e.preventDefault(),n.focus(),this.tokenizer._itemNav.setCurrentItem(n))}_onfocusout(e){super._onfocusout(e);const t=e.relatedTarget,n=this.contains(t),o=this.shadowRoot.contains(t);!n&&!o&&(this.tokenizer.expanded=!1),this.contains(t)&&t.hasAttribute("ui5-token")&&(this.focused=!1)}_onfocusin(e){const t=this.getInputDOMRef();e.target===t&&super._onfocusin(e)}onBeforeRendering(){super.onBeforeRendering(),this.style.setProperty(L("--_ui5-input-icons-count"),`${this.iconsCount}`),this.tokenizerAvailable=this.tokens&&this.tokens.length>0,this.tokenizer&&(this.tokenizer.readonly=this.readonly)}onAfterRendering(){super.onAfterRendering(),this.tokenizer.preventInitialFocus=!0,this.tokenizer.expanded?this.tokenizer.scrollToEnd():this.tokenizer.scrollToStart()}get iconsCount(){return super.iconsCount+(this.showValueHelpIcon?1:0)}get tokenizer(){return this.shadowRoot.querySelector("[ui5-tokenizer]")}get tokenizerExpanded(){return this.tokenizer&&this.tokenizer.expanded}get _tokensCountText(){return P(this.tokens.length)}get _tokensCountTextId(){return"hiddenText-nMore"}get _placeholder(){return this.tokens.length?"":this.placeholder}get accInfo(){const e=`${this._tokensCountTextId} ${this.suggestionsTextId} ${this.valueStateTextId}`.trim();return{...super.accInfo,ariaRoledescription:this.ariaRoleDescription,ariaDescribedBy:e}}get valueHelpLabel(){return h.i18nBundle.getText(z)}get ariaRoleDescription(){return h.i18nBundle.getText(A)}get morePopoverOpener(){return this.tokens.length===1&&this.tokens[0].isTruncatable?this.tokens[0]:this}get shouldDisplayOnlyValueStateMessage(){return this.hasValueStateMessage&&!this.readonly&&!this.open&&this.focused&&!this.tokenizer.open}};p([d({type:Boolean})],l.prototype,"showValueHelpIcon",void 0);p([d({type:Boolean})],l.prototype,"tokenizerAvailable",void 0);p([d()],l.prototype,"name",void 0);p([S({type:HTMLElement,individualSlots:!0})],l.prototype,"tokens",void 0);l=h=p([w({tag:"ui5-multi-input",renderer:k,formAssociated:!0,template:Y,styles:[g.styles,te]}),m("value-help-trigger",{bubbles:!0}),m("token-delete",{bubbles:!0})],l);l.define();const u=T("ui5-multi-input",["accessibleName","accessibleNameRef","maxlength","name","placeholder","type","value","valueState"],["disabled","noTypeahead","open","readonly","required","showClearIcon","showSuggestions","showValueHelpIcon"],["icon","tokens","valueStateMessage"],["change","close","input","open","select","selection-change","token-delete","value-help-trigger"]);u.displayName="MultiInput";try{u.displayName="MultiInput",u.__docgenInfo={description:"A `MultiInput` field allows the user to enter multiple values, which are displayed as `Token`.\n\nUser can choose interaction for creating tokens.\nFiori Guidelines say that user should create tokens when:\n\n- Type a value in the input and press enter or focus out the input field (`change` event is fired)\n- Move between suggestion items (`selection-change` event is fired)\n- Clicking on a suggestion item (`selection-change` event is fired if the clicked item is different than the current value. Also `change` event is fired )\n\n\n\n__Note__: This is a UI5 Web Component! [Repository](https://github.com/SAP/ui5-webcomponents) | [Documentation](https://sap.github.io/ui5-webcomponents/)",displayName:"MultiInput",props:{children:{defaultValue:null,description:"Defines the suggestion items.\n\n**Note:** The suggestions would be displayed only if the `showSuggestions`\nproperty is set to `true`.\n\n**Note:** The `<SuggestionItem>`, `<SuggestionItemGroup>` and `SuggestionItemCustom` are recommended to be used as suggestion items.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},icon:{defaultValue:null,description:`Defines the icon to be displayed in the component.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}try{u.displayName="MultiInput",u.__docgenInfo={description:"A `MultiInput` field allows the user to enter multiple values, which are displayed as `Token`.\n\nUser can choose interaction for creating tokens.\nFiori Guidelines say that user should create tokens when:\n\n- Type a value in the input and press enter or focus out the input field (`change` event is fired)\n- Move between suggestion items (`selection-change` event is fired)\n- Clicking on a suggestion item (`selection-change` event is fired if the clicked item is different than the current value. Also `change` event is fired )\n\n\n\n__Note__: This is a UI5 Web Component! [Repository](https://github.com/SAP/ui5-webcomponents) | [Documentation](https://sap.github.io/ui5-webcomponents/)",displayName:"MultiInput",props:{children:{defaultValue:null,description:"Defines the suggestion items.\n\n**Note:** The suggestions would be displayed only if the `showSuggestions`\nproperty is set to `true`.\n\n**Note:** The `<SuggestionItem>`, `<SuggestionItemGroup>` and `SuggestionItemCustom` are recommended to be used as suggestion items.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},icon:{defaultValue:null,description:`Defines the icon to be displayed in the component.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}export{u as M};
