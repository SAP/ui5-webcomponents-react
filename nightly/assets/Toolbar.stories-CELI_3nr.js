import{j as i}from"./jsx-runtime-D_zvdyIk.js";import{r as q}from"./index-C--kS4iy.js";import{P as L}from"./index-BEp0rhGg.js";import{r as D,c as P,a as x,T as N}from"./index-CvTGCLGt.js";import{j as d,s as u,m as _,w as T,S as M}from"./jsx-runtime-28PG-PhA.js";import{d as k}from"./slot-_4yKMUwC.js";import{l as O}from"./event-strict-DgQLNDEV.js";import{S as B}from"./Select-D7Z2L_G3.js";import{O as W}from"./Option-ixyVRt6w.js";function H(){return d(B,{class:"ui5-tb-item",style:this.styles,"data-ui5-external-action-item-id":this._id,valueState:this.valueState,disabled:this.disabled,accessibleName:this.accessibleName,accessibleNameRef:this.accessibleNameRef,onClick:(...e)=>this.onClick(...e),onClose:(...e)=>this.onClose(...e),onOpen:(...e)=>this.onOpen(...e),onChange:(...e)=>this.onChange(...e),children:this.options.map((e,t)=>d(W,{selected:e.selected,"data-ui5-external-action-item-index":t,children:e.textContent}))})}function G(){return d(B,{class:"ui5-tb-popover-item","data-ui5-external-action-item-id":this._id,valueState:this.valueState,disabled:this.disabled,accessibleName:this.accessibleName,accessibleNameRef:this.accessibleNameRef,onClick:(...e)=>this.onClick(...e),onClose:(...e)=>this.onClose(...e),onOpen:(...e)=>this.onOpen(...e),onChange:(...e)=>this.onChange(...e),children:this.options.map((e,t)=>d(W,{selected:e.selected,"data-ui5-external-action-item-index":t,children:e.textContent}))})}var h=function(e,t,n,a){var l=arguments.length,o=l<3?t:a===null?a=Object.getOwnPropertyDescriptor(t,n):a,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,n,a);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(o=(l<3?r(o):l>3?r(t,n,o):r(t,n))||o);return l>3&&o&&Object.defineProperty(t,n,o),o};let c=class extends P{constructor(){super(...arguments),this.valueState="None",this.disabled=!1}static get toolbarTemplate(){return H}static get toolbarPopoverTemplate(){return G}onClick(t){t.stopImmediatePropagation(),!this.fireDecoratorEvent("click",{targetRef:t.target})&&!this.preventOverflowClosing&&this.fireDecoratorEvent("close-overflow")}onOpen(t){t.stopImmediatePropagation(),!this.fireDecoratorEvent("open",{targetRef:t.target})&&this.fireDecoratorEvent("close-overflow")}onClose(t){t.stopImmediatePropagation(),!this.fireDecoratorEvent("close",{targetRef:t.target})&&this.fireDecoratorEvent("close-overflow")}onChange(t){t.stopImmediatePropagation(),!this.fireDecoratorEvent("change",{...t.detail,targetRef:t.target})||this.fireDecoratorEvent("close-overflow"),this._syncOptions(t.detail.selectedOption)}_syncOptions(t){const n=Number(t==null?void 0:t.getAttribute("data-ui5-external-action-item-index"));this.options.forEach((a,l)=>{l===n?a.setAttribute("selected",""):a.removeAttribute("selected")})}get styles(){return{width:this.width}}};h([u()],c.prototype,"width",void 0);h([k({default:!0,type:HTMLElement,invalidateOnChildChange:!0})],c.prototype,"options",void 0);h([u()],c.prototype,"valueState",void 0);h([u({type:Boolean})],c.prototype,"disabled",void 0);h([u()],c.prototype,"accessibleName",void 0);h([u()],c.prototype,"accessibleNameRef",void 0);c=h([_({tag:"ui5-toolbar-select"}),O("change",{bubbles:!0,cancelable:!0}),O("open",{bubbles:!0}),O("close")],c);D(c);c.define();const f=T("ui5-toolbar-select",["accessibleName","accessibleNameRef","overflowPriority","valueState","width"],["disabled","preventOverflowClosing"],[],["change","close","open"]);f.displayName="ToolbarSelect";try{f.displayName="ToolbarSelect",f.__docgenInfo={description:'The `ToolbarSelect` component is used to create a toolbar drop-down list.\nThe items inside the `ToolbarSelect` define the available options by using the `ToolbarSelectOption` component.\n\n\n\n`import "@ui5/webcomponents/dist/ToolbarSelectOption.js";` (comes with `ToolbarSelect`)\n\n__Note__: This is a UI5 Web Component! [Repository](https://github.com/SAP/ui5-webcomponents) | [Documentation](https://sap.github.io/ui5-webcomponents/)',displayName:"ToolbarSelect",props:{children:{defaultValue:null,description:`Defines the component options.
...
It will close by default.`,name:"preventOverflowClosing",required:!1,type:{name:"boolean"}},valueState:{defaultValue:{value:'"None"'},description:"Defines the value state of the component.",name:"valueState",required:!1,type:{name:"enum",value:[{value:'"Information"'},{value:'"Positive"'},{value:'"Negative"'},{value:'"Critical"'},{value:'"None"'},{value:'"None"'},{value:'"Positive"'},{value:'"Critical"'},{value:'"Negative"'},{value:'"Information"'}]}},width:{defaultValue:{value:"undefined"},description:`Defines the width of the select.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function J(){return d("div",{class:"ui5-tb-separator ui5-tb-item","data-ui5-external-action-item-id":this._id})}function K(){return d("div",{class:"ui5-tb-separator-in-overflow ui5-tb-popover-item","data-ui5-external-action-item-id":this._id})}var $=function(e,t,n,a){var l=arguments.length,o=l<3?t:a===null?a=Object.getOwnPropertyDescriptor(t,n):a,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,n,a);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(o=(l<3?r(o):l>3?r(t,n,o):r(t,n))||o);return l>3&&o&&Object.defineProperty(t,n,o),o};let g=class extends P{constructor(){super(...arguments),this.visible=!1}static get toolbarTemplate(){return J}static get toolbarPopoverTemplate(){return K}get isSeparator(){return!0}get isInteractive(){return!1}};$([u({type:Boolean})],g.prototype,"visible",void 0);g=$([_({tag:"ui5-toolbar-separator"})],g);D(g);g.define();const m=T("ui5-toolbar-separator",["overflowPriority"],["preventOverflowClosing"],[],[]);m.displayName="ToolbarSeparator";try{m.displayName="ToolbarSeparator",m.__docgenInfo={description:`The \`ToolbarSeparator\` is an element, used for visual separation between two elements.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function V(){return d("div",{class:"ui5-tb-spacer ui5-tb-item",style:this.styles,role:"separator","data-ui5-external-action-item-id":this._id})}var z=function(e,t,n,a){var l=arguments.length,o=l<3?t:a===null?a=Object.getOwnPropertyDescriptor(t,n):a,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,n,a);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(o=(l<3?r(o):l>3?r(t,n,o):r(t,n))||o);return l>3&&o&&Object.defineProperty(t,n,o),o};let S=class extends P{get styles(){return this.width?{width:this.width}:{flex:"auto"}}get ignoreSpace(){return this.width===""||this.width===void 0||this.width==="auto"}get hasFlexibleWidth(){return this.width===""||this.width===void 0||this.width==="auto"}static get toolbarTemplate(){return V}static get toolbarPopoverTemplate(){return V}get isInteractive(){return!1}};z([u()],S.prototype,"width",void 0);S=z([_({tag:"ui5-toolbar-spacer"})],S);D(S);S.define();const v=T("ui5-toolbar-spacer",["overflowPriority","width"],["preventOverflowClosing"],[],[]);v.displayName="ToolbarSpacer";try{v.displayName="ToolbarSpacer",v.__docgenInfo={description:`The \`ToolbarSpacer\` is an element, used for taking needed space for toolbar items to take 100% width.
It takes no space in calculating toolbar items width.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var C;(function(e){e.Start="Start",e.End="End"})(C||(C={}));const Q={title:"Layouts & Floorplans / Toolbar",component:x,argTypes:{children:{control:{disable:!0}}},args:{alignContent:C.Start},tags:["package:@ui5/webcomponents"]},b={render:e=>i.jsxs(x,{...e,children:[i.jsx(N,{text:"Button 1"}),i.jsxs(f,{children:[i.jsx(p,{children:"Option 1"}),i.jsx(p,{children:"Option 2"}),i.jsx(p,{children:"Option 3"})]}),i.jsx(m,{}),i.jsx(v,{}),i.jsx(m,{}),i.jsx(N,{text:"Button 2"}),i.jsxs(f,{children:[i.jsx(p,{children:"Option 1"}),i.jsx(p,{children:"Option 2"}),i.jsx(p,{children:"Option 3"})]})]})},w={name:"Opening Popovers via ToolbarButton",render(e){const[t,n]=q.useState(!1),a=q.useRef(null);return i.jsxs(i.Fragment,{children:[i.jsx(x,{...e,children:i.jsx(N,{onClick:l=>{const{targetRef:o}=l.detail;a.current&&(a.current.opener=o,n(!0))},text:"Open Popover"})}),i.jsx(L,{open:t,ref:a,onClose:()=>{n(!1)},children:"Content"})]})}};var I,j,A;b.parameters={...b.parameters,docs:{...(I=b.parameters)==null?void 0:I.docs,source:{originalSource:`{
...
}`,...(F=(U=w.parameters)==null?void 0:U.docs)==null?void 0:F.source}}};const X=["Default","OpenPopover"],ue=Object.freeze(Object.defineProperty({__proto__:null,Default:b,OpenPopover:w,__namedExportsOrder:X,default:Q},Symbol.toStringTag,{value:"Module"}));export{ue as C,b as D,w as O,f as T,p as a,m as b,v as c};
