import{c as R,s as fe,a as ye,e as be,t as Ce,l as ve}from"./DemoProps-Ck8HVVnR.js";import{j as o,r as q,ap as we,o as ke}from"./iframe-Ckbc0Bmx.js";import{T as A}from"./ThemingParameters-pyhX3s39.js";import{u as xe,t as Ae,a as Se,b as _e,c as Le,e as W,C as De}from"./staticProps-DoVkfF6d.js";import{u as Ie,B as Pe}from"./useCancelAnimationFallback-O9osuD3H.js";import{u as je,a as Ve,C as Te,X as qe,c as ze,Y as z,b as N}from"./YAxisTicks-DR5ytyJj.js";import{u as Ne,C as Oe}from"./ChartDataLabel-DTqP7-LR.js";import{u as Re}from"./useLongestYAxisLabel-CGrYNIBw.js";import{u as We}from"./useOnClickInternal-BdxJF8OD.js";import{u as Ye,a as Ee,r as Be,b as O}from"./useTooltipFormatter-pqcsL-pp.js";import{m as Fe,B as Me,e as Ke,o as He,n as $e,R as Ue,T as Xe,p as Ge}from"./ChartContainer-CBYE2Vsg.js";import{C as Je}from"./react-content-loader.es-CRNq1FHT.js";import{u as Qe}from"./useIsRTL-Bs-OA-9D.js";const w=a=>o.jsxs(Je,{viewBox:"0 0 165 145",preserveAspectRatio:"xMidYMid meet",width:"100%",height:"100%",speed:2,backgroundColor:A.sapContent_ImagePlaceholderBackground,foregroundColor:A.sapContent_ImagePlaceholderForegroundColor,backgroundOpacity:A.sapContent_DisabledOpacity,...a,children:[o.jsx("rect",{x:"10",y:"135",width:"135",height:"1"}),o.jsx("rect",{x:"20",y:"50",width:"15",height:"85"}),o.jsx("rect",{x:"40",y:"18",width:"15",height:"117"}),o.jsx("rect",{x:"60",y:"68",width:"15",height:"67"}),o.jsx("rect",{x:"80",y:"60",width:"15",height:"75"}),o.jsx("rect",{x:"100",y:"10",width:"15",height:"125"}),o.jsx("rect",{x:"120",y:"75",width:"15",height:"60"})]});try{w.displayName="ColumnChartPlaceholder",w.__docgenInfo={description:"",displayName:"ColumnChartPlaceholder",props:{}}}catch{}try{w.displayName="ColumnChartPlaceholder",w.__docgenInfo={description:"",displayName:"ColumnChartPlaceholder",props:{}}}catch{}const Ze={formatter:W},et={formatter:W,opacity:1},tt=a=>({payload:S})=>De.getValueByDataKey(S,a),i=q.forwardRef((a,S)=>{const{loading:Y,loadingDelay:E,dataset:s,noLegend:B,noAnimation:I,tooltipConfig:P,onDataPointClick:k,onLegendClick:F,onClick:j,style:M,className:K,slot:H,ChartPlaceholder:$,syncId:U,children:X,...G}=a,t={yAxisVisible:!1,xAxisVisible:!0,gridStroke:A.sapList_BorderColor,gridHorizontal:!0,gridVertical:!1,legendPosition:"bottom",legendHorizontalAlign:"left",barGap:3,zoomingTool:!1,resizeDebounce:250,yAxisConfig:{},xAxisConfig:{},secondYAxisConfig:{},...a.chartConfig},{referenceLine:r}=t,{dimensions:V,measures:l}=Ye(a.dimensions,a.measures,Ze,et),J=Ee(l),[Q,Z]=Re(s,l,t.legendPosition),_=V[0],{primaryMeasure:ee,secondaryMeasure:te}=Be(l,t?.secondYAxis?.dataKey),ae=Ne(_?.formatter),[oe,T]=we(S),ne=l.map(({accessor:e})=>e),L=t.secondYAxis?ne.findIndex(e=>e===t.secondYAxis?.dataKey):0,re=xe(F),se=q.useCallback((e,n,x)=>{e&&k&&k(ke(x,{dataKey:Object.keys(e).filter(c=>e.value.length?e[c]===e.value[1]-e.value[0]:e[c]===e.value&&c!=="value")[0],value:e.value.length?e.value[1]-e.value[0]:e.value,dataIndex:n,payload:e.payload}))},[k]),ie=We(j),le=s?.length>30,ce=_?.accessor,de=je(t.margin,t.zoomingTool),he=Ve(T,a.dimensions.length),D=Qe(T),{chartConfig:nt,dimensions:rt,measures:st,...ue}=G,{isMounted:me,handleBarAnimationStart:pe,handleBarAnimationEnd:ge}=Ie(I);return o.jsx(Fe,{dataset:s,loading:Y,loadingDelay:E,Placeholder:$??w,ref:oe,style:M,className:K,slot:H,resizeDebounce:t.resizeDebounce,...ue,children:o.jsxs(Pe,{syncId:U,onClick:ie,stackOffset:"sign",margin:de,data:s,barGap:t.barGap,accessibilityLayer:t.accessibilityLayer,className:typeof k=="function"||typeof j=="function"?"has-click-handler":void 0,children:[o.jsx(Te,{vertical:t.gridVertical,horizontal:t.gridHorizontal,stroke:t.gridStroke}),t.xAxisVisible&&V.map((e,n)=>o.jsx(qe,{dataKey:e.accessor,xAxisId:n,interval:e?.interval??(le?"preserveStart":0),tick:o.jsx(ze,{formatter:e?.formatter}),tickLine:n<1,axisLine:n<1,height:he[n],allowDuplicatedCategory:n===0,reversed:D,...t.xAxisConfig},e.reactKey)),o.jsx(z,{orientation:D===!0?"right":"left",axisLine:t.yAxisVisible,tickLine:Ae,yAxisId:"left",interval:0,tick:o.jsx(N,{formatter:ee?.formatter}),width:Q,...t.yAxisConfig}),t.secondYAxis?.dataKey&&o.jsx(z,{dataKey:t.secondYAxis.dataKey,axisLine:{stroke:t.secondYAxis.color??`var(--sapChart_OrderedColor_${L%12+1})`},tick:o.jsx(N,{formatter:te?.formatter,secondYAxisConfig:{color:t.secondYAxis.color??`var(--sapChart_OrderedColor_${L%12+1})`}}),tickLine:{stroke:t.secondYAxis.color??`var(--sapChart_OrderedColor_${L%12+1})`},label:{value:t.secondYAxis.name,offset:2,angle:90,position:"center"},orientation:D===!0?"left":"right",yAxisId:"right",interval:0,...t.secondYAxisConfig}),me&&l.map((e,n)=>o.jsxs(Me,{yAxisId:t.secondYAxis?.dataKey===e.accessor?"right":"left",stackId:e.stackId,fillOpacity:e.opacity,name:e.label??e.accessor,strokeOpacity:e.opacity,type:"monotone",dataKey:e.accessor,fill:e.color??`var(--sapChart_OrderedColor_${n%12+1})`,stroke:e.color??`var(--sapChart_OrderedColor_${n%12+1})`,barSize:e.width,onClick:se,isAnimationActive:!I,onAnimationStart:pe,onAnimationEnd:ge,children:[o.jsx(Ke,{data:s,valueAccessor:tt(e.accessor),content:o.jsx(Oe,{config:e,chartType:"column",position:"insideTop"})}),s.map((x,c)=>o.jsx(He,{fill:O(e,x,n),stroke:O(e,x,n)},c))]},e.reactKey)),!B&&o.jsx($e,{verticalAlign:t.legendPosition,align:t.legendHorizontalAlign,onClick:re,wrapperStyle:Z,...t.legendConfig}),r&&o.jsx(Ue,{...r,stroke:r?.color??r?.stroke,y:r?.value??r?.y,yAxisId:r?.yAxisId??"left",label:r?.label}),P?.active!==!1&&o.jsx(Xe,{cursor:_e,formatter:J,contentStyle:Se,labelFormatter:ae,...P}),!!t.zoomingTool&&o.jsx(Ge,{dataKey:ce,tickFormatter:_?.formatter,...Le,...typeof t.zoomingTool=="object"?t.zoomingTool:{}}),X]})})});i.displayName="ColumnChart";try{i.displayName="ColumnChart",i.__docgenInfo={description:"A `ColumnChart` is a data visualization where each category is represented by a rectangle, with the height of the rectangle being proportional to the values being plotted.",displayName:"ColumnChart",props:{dimensions:{defaultValue:null,description:`An array of config objects. Each object will define one dimension of the chart.
...
Use this prop carefully, some css properties might break the component.`,name:"style",required:!1,type:{name:"CSSProperties"}}}}}catch{}try{i.displayName="ColumnChart",i.__docgenInfo={description:"A `ColumnChart` is a data visualization where each category is represented by a rectangle, with the height of the rectangle being proportional to the values being plotted.",displayName:"ColumnChart",props:{dimensions:{defaultValue:null,description:`An array of config objects. Each object will define one dimension of the chart.
...
Use this prop carefully, some css properties might break the component.`,name:"style",required:!1,type:{name:"CSSProperties"}}}}}catch{}const at={title:"ColumnChart",component:i,argTypes:{dataset:{control:{disable:!0}},children:{control:{disable:!0}}},args:{dataset:R,dimensions:[{accessor:"name",formatter:a=>`${a} 2019`}],measures:[{accessor:"users",label:"Users",formatter:a=>a.toLocaleString()},{accessor:"sessions",label:"Active Sessions",formatter:a=>`${a} sessions`,hideDataLabel:!0},{accessor:"volume",label:"Vol."}]}},d={},h={args:{measures:[{accessor:"users",color:"red"}],dataset:fe}},u={args:{dimensions:[{accessor:"name"},{accessor:"dimension"}],measures:[{accessor:"users",color:"red"}],dataset:ye}},m={args:{measures:[{accessor:"users",stackId:"A"},{accessor:"sessions",stackId:"A"},{accessor:"volume"}],dataset:R}},p={args:be},g={args:{dimensions:[{accessor:"name",formatter:a=>a.slice(0,3)}],measures:[{accessor:"users",formatter:a=>`${a/10}`,label:"number of users"},{accessor:"sessions"},{accessor:"volume"}]}},f={args:{dataset:[]}},y={args:{chartConfig:{referenceLine:{color:"red",label:"MAX",value:650}}}},b={args:{measures:[{accessor:"users",label:"Users",formatter:a=>a.toLocaleString()},{accessor:"sessions",label:"Active Sessions",formatter:a=>`${a} sessions`,hideDataLabel:!0},{accessor:"volume",label:"Vol.",highlightColor:a=>{if(a>750)return"red"}}]}},C={args:Ce},v={args:ve};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"{}",...d.parameters?.docs?.source}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  ...
  args: legendConfig
}`,...v.parameters?.docs?.source}}};const ot=["Default","WithCustomColor","WithSecondaryDimension","WithStacks","WithNormalizedStacks","WithFormatter","LoadingPlaceholder","WithReferenceLine","WithHighlightedMeasure","WithCustomTooltipConfig","WithCustomLegendConfig"],vt=Object.freeze(Object.defineProperty({__proto__:null,Default:d,LoadingPlaceholder:f,WithCustomColor:h,WithCustomLegendConfig:v,WithCustomTooltipConfig:C,WithFormatter:g,WithHighlightedMeasure:b,WithNormalizedStacks:p,WithReferenceLine:y,WithSecondaryDimension:u,WithStacks:m,__namedExportsOrder:ot,default:at},Symbol.toStringTag,{value:"Module"}));export{vt as C,d as D,f as L,h as W,u as a,m as b,p as c,g as d,y as e,b as f,C as g,v as h};
