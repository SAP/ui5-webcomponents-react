import{m,k as b,a as u,s as g,q as f,v as _,z as v,S as y,w}from"./withWebComponent-D2290JWW.js";import{d as p}from"./slot-_4yKMUwC.js";import{f as c}from"./ResizeHandler-h_-KGn42.js";import{o as C}from"./class-map-BHSYgJ9u.js";import{s as S}from"./parameters-bundle.css-DlWxkghp.js";function N(o,e,t){return m`<div class="${C(this.classes.root)}" aria-label="${b(this.accInfo.label)}" role="toolbar" part="bar"><div class="ui5-bar-content-container ui5-bar-startcontent-container" part="startContent"><slot name="startContent"></slot></div><div class="ui5-bar-content-container ui5-bar-midcontent-container" part="midContent"><slot></slot></div><div class="ui5-bar-content-container ui5-bar-endcontent-container" part="endContent"><slot name="endContent"></slot></div></div>`}u("@ui5/webcomponents-theming","sap_horizon",async()=>g);u("@ui5/webcomponents","sap_horizon",async()=>S);const F={packageName:"@ui5/webcomponents",fileName:"themes/Bar.css.ts",content:`:host{background-color:var(--sapPageHeader_Background);height:var(--_ui5-v2-5-0_bar_base_height);width:100%;box-shadow:var(--sapContent_HeaderShadow);display:block}.ui5-bar-root{container-type:size;display:flex;align-items:center;justify-content:space-between;height:100%;width:100%;background-color:inherit;box-shadow:inherit;border-radius:inherit}.ui5-bar-root .ui5-bar-startcontent-container{padding-inline-start:var(--_ui5-v2-5-0_bar-start-container-padding-start);display:flex;flex-direction:row;align-items:center;justify-content:flex-start}.ui5-bar-root .ui5-bar-content-container{min-width:calc(30% - calc(var(--_ui5-v2-5-0_bar-start-container-padding-start) + var(--_ui5-v2-5-0_bar-end-container-padding-end) + (2*var(--_ui5-v2-5-0_bar-mid-container-padding-start-end))))}.ui5-bar-root.ui5-bar-root-shrinked .ui5-bar-content-container{min-width:0px;overflow:hidden;height:100%}.ui5-bar-root .ui5-bar-endcontent-container{padding-inline-end:var(--_ui5-v2-5-0_bar-end-container-padding-end);display:flex;flex-direction:row;align-items:center;justify-content:flex-end}.ui5-bar-root .ui5-bar-midcontent-container{padding:0 var(--_ui5-v2-5-0_bar-mid-container-padding-start-end);display:flex;flex-direction:row;align-items:center;justify-content:center}:host([design="Footer"]){background-color:var(--sapPageFooter_Background);border-top:.0625rem solid var(--sapPageFooter_BorderColor);box-shadow:none}:host([design="Subheader"]){height:var(--_ui5-v2-5-0_bar_subheader_height);margin-top:var(--_ui5-v2-5-0_bar_subheader_margin-top)}:host([design="FloatingFooter"]){border-radius:var(--sapElement_BorderCornerRadius);background-color:var(--sapPageFooter_Background);box-shadow:var(--sapContent_Shadow1);border:none}::slotted(*){margin:0 .25rem}@container (width < 600px){*{--_ui5-v2-5-0_bar-start-container-padding-start: var(--_ui5-v2-5-0_bar-start-container-padding-start_S);--_ui5-v2-5-0_bar-end-container-padding-end: var(--_ui5-v2-5-0_bar-end-container-padding-end_S) }}@container (width > 1439px){*{--_ui5-v2-5-0_bar-start-container-padding-start: var(--_ui5-v2-5-0_bar-start-container-padding-start_XL);--_ui5-v2-5-0_bar-end-container-padding-end: var(--_ui5-v2-5-0_bar-end-container-padding-end_XL)}}
