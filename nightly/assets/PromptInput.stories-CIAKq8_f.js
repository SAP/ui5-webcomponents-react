import{ad as S,l as m,c as r,cJ as g,a1 as A,p as N,d as x,s as o,A as _,ar as I,m as P,b7 as f,ah as C,b5 as T,b9 as D,w as q,R as E}from"./iframe-DofHecbS.js";import{d as V,P as M,a as R}from"./parameters-bundle.css-Chce_F9i.js";import{I as k}from"./Input-N_-j7LxY.js";const U="paper-plane",L="M494.98 31.928q7.982 0 13.47 7.483t2.494 15.465L361.28 471.936q-2.993 10.976-15.964 10.976-6.984 0-10.975-3.991l-115.74-105.762-69.842 61.86q-8.98 7.982-18.957 2.495t-8.98-16.463l10.975-126.714L6.082 180.593Q-1.9 173.609.594 164.13t13.47-12.472L490.989 32.926q.997-.998 3.99-.998zm-358.193 221.5L461.056 74.832 51.978 176.601zm70.84 110.751l-40.908-36.917-28.934 90.796zM467.043 75.83l-284.36 219.505 155.65 141.681z",z=!1,B="SAP-icons-v4",F="@ui5/webcomponents-icons";S(U,{pathData:L,ltr:z,collection:B,packageName:F});const O="paper-plane",W="M455 32q10 0 17.5 7.5T480 58q0 6-2 9L323 464q-7 16-24 16-8 0-14.5-4t-9.5-12l-64-164-163-65q-16-6-16-24 0-17 16-24L445 34q6-2 10-2zM127 212l97 39 126-125zm259-50L260 287l39 98z",H=!1,j="SAP-icons-v5",$="@ui5/webcomponents-icons";S(O,{pathData:W,ltr:H,collection:j,packageName:$});const G="paper-plane";function J(){return m("div",{class:"ai-prompt-input-wrapper",children:[this.label&&r(g,{for:"input",children:this.label}),m("div",{class:"ai-prompt-input-form-wrapper",children:[m("div",{class:"ai-prompt-inner-input-wrapper",children:[m(k,{id:"input",value:this.value,placeholder:this.placeholder,valueState:this.valueState,showClearIcon:this.showClearIcon,disabled:this.disabled,readonly:this.readonly,showSuggestions:this.showSuggestions,onKeyDown:this._onkeydown,onInput:this._onInnerInput,onChange:this._onInnerChange,onTypeAhead:this._onTypeAhead,children:[r("slot",{}),this.valueStateMessage.length>0&&r("slot",{name:"valueStateMessage",slot:"valueStateMessage"})]}),this.showExceededText&&r(g,{class:"ai-prompt-input-counter",children:this._exceededText})]}),r(A,{icon:G,disabled:this._submitButtonDisabled,class:"ai-prompt-input-button",design:"Emphasized",onClick:this._onButtonClick})]})]})}N("@ui5/webcomponents-theming","sap_horizon",async()=>x);N("@ui5/webcomponents-ai","sap_horizon",async()=>V);const K=`.ai-prompt-input-button{margin-left:.5rem;margin-top:3px}.ai-prompt-input-wrapper{display:flex;flex-direction:column;width:270px}.ai-prompt-input-form-wrapper{display:flex;flex:1}.ai-prompt-input-counter{font-size:.75rem;align-self:flex-end}#input{width:100%}.ai-prompt-inner-input-wrapper{display:flex;flex-direction:column;flex:1}
`;var n=function(i,e,a,p){var c=arguments.length,s=c<3?e:p===null?p=Object.getOwnPropertyDescriptor(e,a):p,h;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(i,e,a,p);else for(var b=i.length-1;b>=0;b--)(h=i[b])&&(s=(c<3?h(s):c>3?h(e,a,s):h(e,a))||s);return c>3&&s&&Object.defineProperty(e,a,s),s},d;let t=d=class extends T{constructor(){super(...arguments),this.value="",this.showClearIcon=!1,this.showExceededText=!1,this.disabled=!1,this.readonly=!1,this.valueState="None",this.showSuggestions=!1}_onkeydown(e){D(e)&&this.fireDecoratorEvent("submit")}_onInnerInput(e){this.value=e.currentTarget.value,this.fireDecoratorEvent("input")}_onInnerChange(){this.fireDecoratorEvent("change")}_onButtonClick(){this.fireDecoratorEvent("submit")}_onTypeAhead(e){this.value=e.currentTarget.value}get _exceededText(){if(this.showExceededText){let e;const a=this.maxlength;if(a!==void 0)return e=a-this.value.length,e>=0?d.i18nBundle.getText(M,e):d.i18nBundle.getText(R,Math.abs(e))}}get _maxLenght(){return this.maxlength||void 0}get _submitButtonDisabled(){return this.value.length<=0||this.disabled||this.readonly}};n([o()],t.prototype,"value",void 0);n([o()],t.prototype,"placeholder",void 0);n([o()],t.prototype,"label",void 0);n([o({type:Boolean})],t.prototype,"showClearIcon",void 0);n([o({type:Boolean})],t.prototype,"showExceededText",void 0);n([o({type:Boolean})],t.prototype,"disabled",void 0);n([o({type:Boolean})],t.prototype,"readonly",void 0);n([o({type:Number})],t.prototype,"maxlength",void 0);n([o()],t.prototype,"valueState",void 0);n([o({type:Boolean})],t.prototype,"showSuggestions",void 0);n([_({type:HTMLElement,default:!0})],t.prototype,"suggestionItems",void 0);n([_({type:HTMLElement,invalidateOnChildChange:!0})],t.prototype,"valueStateMessage",void 0);n([I("@ui5/webcomponents-ai")],t,"i18nBundle",void 0);t=d=n([P({tag:"ui5-ai-prompt-input",renderer:C,styles:K,template:J}),f("submit",{bubbles:!0}),f("input",{bubbles:!0}),f("change",{bubbles:!0})],t);t.define();const l=q("ui5-ai-prompt-input",["label","maxlength","placeholder","value","valueState"],["disabled","readonly","showClearIcon","showExceededText","showSuggestions"],["valueStateMessage"],["change","input","submit"]);l.displayName="PromptInput";try{l.displayName="PromptInput",l.__docgenInfo={description:`The \`PromptInput\` component allows the user to write custom instructions in natural language, so that AI is guided to generate content tailored to user needs.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const Q={title:"PromptInput",component:l,argTypes:{children:{control:{disable:!0}},valueStateMessage:{control:{disable:!0}}},args:{valueState:E.None},tags:["package:@ui5/webcomponents-ai"]},u={};var v,w,y;u.parameters={...u.parameters,docs:{...(v=u.parameters)==null?void 0:v.docs,source:{originalSource:"{}",...(y=(w=u.parameters)==null?void 0:w.docs)==null?void 0:y.source}}};const X=["Default"],ne=Object.freeze(Object.defineProperty({__proto__:null,Default:u,__namedExportsOrder:X,default:Q},Symbol.toStringTag,{value:"Module"}));export{ne as C,u as D};
