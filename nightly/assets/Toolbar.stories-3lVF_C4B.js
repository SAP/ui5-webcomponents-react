import{p as S,d as F,b as k,c as N,s as u,A as B,m as _,b5 as O,af as z,w as T,b3 as L,j as i,r as V,V as M}from"./iframe-CS0WNVf3.js";import{a as P,T as C}from"./index-D0P0M9o-.js";import{S as H}from"./Select-B8PsMZPZ.js";import{O as G}from"./Option-ndsoEHeD.js";import{T as x,a as J}from"./ToolbarButton-Kn4vuugs.js";S("@ui5/webcomponents-theming","sap_horizon",async()=>F);S("@ui5/webcomponents","sap_horizon",async()=>k);const K=`:host(:not([hidden])){width:100%}.ui5-tb-popover-item{width:inherit}
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function X(){return N("div",{class:"ui5-tb-separator ui5-tb-item","data-ui5-external-action-item-id":this._id})}S("@ui5/webcomponents-theming","sap_horizon",async()=>F);S("@ui5/webcomponents","sap_horizon",async()=>k);const Y=`.ui5-tb-separator{height:var(--_ui5-v2-12-0-toolbar-separator-height);width:.0625rem;background:var(--sapToolbar_SeparatorColor);box-sizing:border-box}
