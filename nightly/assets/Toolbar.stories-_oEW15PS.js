...
| cancelable | bubbles |
| :--------: | :-----: |
| ❌|✅|`,name:"onClick",required:!1,type:{name:"MouseEventHandler<ButtonDomRef>"}},type:{defaultValue:{value:'"Button"'},description:`Defines whether the button has special form-related functionality.
...
**Note:** Available since [v1.2.0](https://github.com/SAP/ui5-webcomponents/releases/tag/v1.2.0) of **@ui5/webcomponents**.`,name:"tooltip",required:!1,type:{name:"string"}},accessibleNameRef:{defaultValue:{value:"undefined"},description:`Receives id(or many ids) of the elements that label the component.
...
| cancelable | bubbles |
| :--------: | :-----: |
| ❌|✅|`,name:"onClick",required:!1,type:{name:"MouseEventHandler<ToggleButtonDomRef>"}},type:{defaultValue:{value:'"Button"'},description:`Defines whether the button has special form-related functionality.
...
}`,...(Y=(X=B.parameters)==null?void 0:X.docs)==null?void 0:Y.source}}};const ke=["Default","RightAlignedItems","EvenlyAlignedItems","WithSeparator","PopoverInOverflowPopover","WithOverflowButton","OverflowBtns","CustomOverflowButton"],tt=Object.freeze(Object.defineProperty({__proto__:null,CustomOverflowButton:B,Default:f,EvenlyAlignedItems:v,OverflowBtns:x,PopoverInOverflowPopover:w,RightAlignedItems:g,WithOverflowButton:T,WithSeparator:y,__namedExportsOrder:ke,default:Ie},Symbol.toStringTag,{value:"Module"}));export{tt as C,f as D,v as E,x as O,w as P,g as R,c as T,y as W,T as a,B as b,p as c,d};
