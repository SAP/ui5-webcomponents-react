import{r as I,ay as C,x as _,j as e,J as n}from"./iframe-nPyk7Pli.js";import{T as s}from"./ThemingParameters-pyhX3s39.js";const L="@layer ui5-webcomponents-react{._container_lhhv3_1{display:grid}@media (max-width:599px){._container_lhhv3_1{grid-template-columns:repeat(var(--_ui5wcr-rgl-columns-s),minmax(0,1fr))}._container_lhhv3_1>*{grid-column:span var(--_ui5wcr-rgl-column-span-s)}}@media (min-width:600px) and (max-width:1023px){._container_lhhv3_1{grid-template-columns:repeat(var(--_ui5wcr-rgl-columns-m),minmax(0,1fr))}._container_lhhv3_1>*{grid-column:span var(--_ui5wcr-rgl-column-span-m)}}@media (min-width:1024px) and (max-width:1439px){._container_lhhv3_1{grid-template-columns:repeat(var(--_ui5wcr-rgl-columns-l),minmax(0,1fr))}._container_lhhv3_1>*{grid-column:span var(--_ui5wcr-rgl-column-span-l)}}@media (min-width:1440px){._container_lhhv3_1{grid-template-columns:repeat(var(--_ui5wcr-rgl-columns-xl),minmax(0,1fr))}._container_lhhv3_1>*{grid-column:span var(--_ui5wcr-rgl-column-span-xl)}}}",N={container:"_container_lhhv3_1"},a=I.forwardRef((o,r)=>{const{children:t,columnGap:i="0.5rem",rowGap:m="0.5rem",columnsS:c=4,columnsM:d=8,columnsL:u=12,columnsXL:p=16,columnSpanS:h=1,columnSpanM:y=1,columnSpanL:g=1,columnSpanXL:v=1,style:x,className:f,...b}=o;C(L,a.displayName);const w=_(N.container,f);return e.jsx("div",{ref:r,className:w,style:{rowGap:m,columnGap:i,"--_ui5wcr-rgl-columns-s":c,"--_ui5wcr-rgl-columns-m":d,"--_ui5wcr-rgl-columns-l":u,"--_ui5wcr-rgl-columns-xl":p,"--_ui5wcr-rgl-column-span-s":h,"--_ui5wcr-rgl-column-span-m":y,"--_ui5wcr-rgl-column-span-l":g,"--_ui5wcr-rgl-column-span-xl":v,...x},...b,children:t})});a.displayName="ResponsiveGridLayout";try{a.displayName="ResponsiveGridLayout",a.__docgenInfo={description:`The Responsive Grid Layout positions UI elements in a multi-column flow layout.
