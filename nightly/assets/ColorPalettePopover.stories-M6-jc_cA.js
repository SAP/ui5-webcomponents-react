import{j as o}from"./jsx-runtime-D_zvdyIk.js";import{i as _}from"./utils-qlvtd81G.js";import{r as C}from"./index-C--kS4iy.js";import{B as D}from"./index-Dno20kSL.js";import{a as R,C as r}from"./index-DAcOxlfh.js";import{a as S,j as u,p as g,d as T,s as h,m as O,e as N,S as x}from"./jsx-runtime-D97XV8sh.js";import{d as k}from"./slot-_4yKMUwC.js";import{l as b}from"./event-strict-DgQLNDEV.js";import{i as E}from"./i18n-oG4QvOAt.js";import{e as I}from"./Popover-RfvVyLvj.js";import{d as q}from"./CustomElementsScope-DUj-UV8m.js";import{a as j}from"./Title-BOwCdWYi.js";import{a as V}from"./Button-ByA1SsYZ.js";import{R as A}from"./ResponsivePopover-B7ajB4G4.js";import{d as M}from"./parameters-bundle.css-Ct2Rzfjz.js";import{R as B}from"./ResponsivePopoverCommon.css-C5uTYG6E.js";import{ad as U,ae as L}from"./i18n-defaults-CmQf_FFT.js";import{w as F}from"./withWebComponent-BfnST9Sw.js";function Y(){return S(A,{hideArrow:!0,contentOnlyOnDesktop:!0,placement:"Bottom",opener:this.opener,open:this._open,onClose:this.onAfterClose,onOpen:this.onAfterOpen,children:[u("div",{slot:"header",class:"ui5-cp-header",children:u(j,{level:"H1",wrappingType:"None",children:this._colorPaletteTitle})}),u("div",{children:u(R,{showMoreColors:this.showMoreColors,showRecentColors:this.showRecentColors,showDefaultColor:this.showDefaultColor,defaultColor:this.defaultColor,popupMode:!0,onItemClick:this.onSelectedColor,children:this.colorPaletteColors.map(t=>u("slot",{name:t._individualSlot}))})}),u("div",{slot:"footer",class:"ui5-cp-footer",children:u(V,{design:"Transparent",onClick:this.closePopover,children:this._cancelButtonLabel})})]})}g("@ui5/webcomponents-theming","sap_horizon",async()=>T);g("@ui5/webcomponents","sap_horizon",async()=>M);const H=`.ui5-cp-header{width:100%;height:var(--_ui5-v2-7-3_color-palette-button-height);display:flex;align-items:center}.ui5-cp-footer{width:100%;display:flex;justify-content:flex-end;align-items:center;margin:.1875rem 0}[ui5-responsive-popover]::part(content){padding:0}.ui5-cp-item-container{padding:.3125rem .6875rem}
`;var i=function(t,e,s,l){var p=arguments.length,n=p<3?e:l===null?l=Object.getOwnPropertyDescriptor(e,s):l,f;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,s,l);else for(var v=t.length-1;v>=0;v--)(f=t[v])&&(n=(p<3?f(n):p>3?f(e,s,n):f(e,s))||n);return p>3&&n&&Object.defineProperty(e,s,n),n},m;let a=m=class extends x{constructor(){super(),this.showRecentColors=!1,this.showMoreColors=!1,this.showDefaultColor=!1,this.open=!1}get responsivePopover(){return this.shadowRoot.querySelector("[ui5-responsive-popover]")}get respPopover(){return this.shadowRoot.querySelector("[ui5-responsive-popover]")}closePopover(){this.open=!1}onAfterClose(){this.closePopover(),this.fireDecoratorEvent("close")}onAfterOpen(){var s;const e=this._colorPalette;e._currentlySelected?(s=e._currentlySelected)==null||s.focus():e.showRecentColors&&e.recentColorsElements.length?e.recentColorsElements[0].focus():e.showDefaultColor&&e.colorPaletteNavigationElements[0].focus(),e.allColorsInPalette.forEach(l=>{const p=l.offsetHeight+4;l.style.setProperty(q("--_ui5_color_palette_item_height"),`${p}px`)})}onSelectedColor(e){this.closePopover(),this.fireDecoratorEvent("item-click",e.detail)}get _colorPalette(){return this.responsivePopover.content[0].querySelector("[ui5-color-palette]")}isOpen(){return this.open}get colorPaletteColors(){return this.getSlottedNodes("colors")}get _colorPaletteTitle(){return m.i18nBundle.getText(U)}get _cancelButtonLabel(){return m.i18nBundle.getText(L)}get _open(){return this.open||void 0}};i([h({type:Boolean})],a.prototype,"showRecentColors",void 0);i([h({type:Boolean})],a.prototype,"showMoreColors",void 0);i([h({type:Boolean})],a.prototype,"showDefaultColor",void 0);i([h()],a.prototype,"defaultColor",void 0);i([h({type:Boolean})],a.prototype,"open",void 0);i([h({converter:I})],a.prototype,"opener",void 0);i([k({default:!0,type:HTMLElement,individualSlots:!0})],a.prototype,"colors",void 0);i([E("@ui5/webcomponents")],a,"i18nBundle",void 0);a=m=i([O({tag:"ui5-color-palette-popover",renderer:N,styles:[B,H],template:Y}),b("item-click",{bubbles:!0}),b("close",{bubbles:!0})],a);a.define();const c=F("ui5-color-palette-popover",["defaultColor","opener"],["open","showDefaultColor","showMoreColors","showRecentColors"],[],["close","item-click"]);c.displayName="ColorPalettePopover";try{c.displayName="ColorPalettePopover",c.__docgenInfo={description:`Represents a predefined range of colors for easier selection.
...
}`,...(P=(y=d.parameters)==null?void 0:y.docs)==null?void 0:P.source}}};const W=["Default"],he=Object.freeze(Object.defineProperty({__proto__:null,Default:d,__namedExportsOrder:W,default:z},Symbol.toStringTag,{value:"Module"}));export{he as C,d as D};
