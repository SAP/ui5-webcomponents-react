import{j as o}from"./jsx-runtime-CLpGMVip.js";import{i as _}from"./utils-CrmSEZsN.js";import{r as C}from"./index-D23YZj_x.js";import{B as D}from"./index-CwE3qlmk.js";import{a as R,C as r}from"./index-C4XtvDZg.js";import{c as S,j as p,p as g,d as T,s as h,m as N,e as O,I,w as k}from"./withWebComponent-DIBLIPif.js";import{d as x}from"./slot-_4yKMUwC.js";import{l as b}from"./event-strict-DgQLNDEV.js";import{i as j}from"./i18n-DEVDpFvK.js";import{e as q}from"./Popover-DWH7u18I.js";import{d as E}from"./useIsomorphicLayoutEffect-BuGJanM4.js";import{a as V}from"./Title-Bnj9fnoW.js";import{a as A}from"./Button-BYnClEc8.js";import{R as M}from"./ResponsivePopover-BCkoypY8.js";import{d as B}from"./parameters-bundle.css-C_3tvNHF.js";import{R as U}from"./ResponsivePopoverCommon.css-Cm0qzI48.js";import{ak as L,O as F}from"./i18n-defaults-Cyg2J0QB.js";function Y(){return S(M,{hideArrow:!0,contentOnlyOnDesktop:!0,placement:"Bottom",opener:this.opener,open:this._open,onClose:this.onAfterClose,onOpen:this.onAfterOpen,children:[p("div",{slot:"header",class:"ui5-cp-header",children:p(V,{level:"H1",wrappingType:"None",children:this._colorPaletteTitle})}),p("div",{children:p(R,{showMoreColors:this.showMoreColors,showRecentColors:this.showRecentColors,showDefaultColor:this.showDefaultColor,defaultColor:this.defaultColor,popupMode:!0,onItemClick:this.onSelectedColor,children:this.colorPaletteColors.map(t=>p("slot",{name:t._individualSlot}))})}),p("div",{slot:"footer",class:"ui5-cp-footer",children:p(A,{design:"Transparent",onClick:this.closePopover,children:this._cancelButtonLabel})})]})}g("@ui5/webcomponents-theming","sap_horizon",async()=>T);g("@ui5/webcomponents","sap_horizon",async()=>B);const H=`.ui5-cp-header{width:100%;height:var(--_ui5-v2-6-3_color-palette-button-height);display:flex;align-items:center}.ui5-cp-footer{width:100%;display:flex;justify-content:flex-end;align-items:center;margin:.1875rem 0}[ui5-responsive-popover]::part(content){padding:0}.ui5-cp-item-container{padding:.3125rem .6875rem}
