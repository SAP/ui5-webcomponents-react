import{j as s}from"./jsx-runtime-BjG_zV1W.js";import{B as I}from"./Button-BBQGaetD.js";import{a as F}from"./Icon-Cf72TZgw.js";import{P as k}from"./PopupsCommon.css-BerD7w9b.js";import{T as L}from"./Title-1rDkpSXf.js";import{o as u}from"./ValueState-Bg0UWejw.js";import"./withWebComponent-CEvNJu7C.js";import"./sys-help-2-C1sMmkr1.js";import{c as W}from"./clsx-B-dksMZM.js";import{r as m}from"./index-B7gF9TUu.js";import{u as H,g as U,h as P,i as j,D as $,j as K,N as Y,O as G,R as J,Y as Q,k as X,l as Z,m as ee,n as te,o as oe}from"./i18n-defaults-lSsYHFh1.js";import{D as ne}from"./index-CVdpV9EC.js";import{T as ae}from"./index-BIquPCJE.js";import{T as se}from"./index-CGNOavxc.js";import{u as ie}from"./useStylesheet-DVp2Y5Uf.js";import{B as re}from"./index-CdlG1iEF.js";import{I as le}from"./index-5H0EHDaD.js";var o=(e=>(e.Abort="Abort",e.Cancel="Cancel",e.Close="Close",e.Delete="Delete",e.Ignore="Ignore",e.No="No",e.OK="OK",e.Retry="Retry",e.Yes="Yes",e))(o||{}),a=(e=>(e.Confirm="Confirm",e.Error="Error",e.Information="Information",e.Success="Success",e.Warning="Warning",e))(a||{});const de="sys-help-2",ce={packageName:"@ui5/webcomponents-react",fileName:"MessageBox.module.css",content:"@layer ui5-webcomponents-react{._messageBox_13pdm_1[data-type=Confirm]::part(header){box-shadow:inset 0 -.0625rem var(--sapNeutralBorderColor),var(--sapContent_HeaderShadow)}._messageBox_13pdm_1[data-type=Confirm] ._header_13pdm_8{--sapContent_NonInteractiveIconColor:var(--sapNeutralElementColor)}._header_13pdm_8{align-items:center;border-bottom:1px solid var(--messageBoxBorderColor);box-sizing:border-box;color:var(--sapContent_LabelColor);display:flex;font-size:1rem;height:var(--_ui5wcr-BarHeight);text-align:center;width:100%}._header_13pdm_8 [ui5-icon]:first-child{height:1rem;width:1rem}._header_13pdm_8 [ui5-title]{font-size:1rem}._spacer_13pdm_34{width:.5rem}._confirmIcon_13pdm_38{color:var(--sapNeutralColor)}._footer_13pdm_42{align-items:center;display:flex;height:var(--_ui5wcr-BarHeight);justify-content:flex-end;width:100%}._footer_13pdm_42>*{margin:0 .25rem}._footer_13pdm_42>[ui5-button]{display:flex;min-width:4rem}}"},p={messageBox:"_messageBox_13pdm_1",header:"_header_13pdm_8",spacer:"_spacer_13pdm_34",confirmIcon:"_confirmIcon_13pdm_38",footer:"_footer_13pdm_42"},ue=(e,i,f)=>{if(m.isValidElement(e))return e;switch(i){case a.Confirm:return s.jsx(le,{name:de,mode:F.Decorative,className:f.confirmIcon});default:return null}},pe=e=>{switch(e){case a.Information:return u.Information;case a.Success:return u.Positive;case a.Warning:return u.Critical;case a.Error:return u.Negative;default:return u.None}},me=(e,i)=>e&&e.length>0?e:i===a.Confirm?[o.OK,o.Cancel]:i===a.Error?[o.Close]:[o.OK],d=m.forwardRef((e,i)=>{const{open:f,type:c=a.Confirm,children:B,className:R,titleText:v,icon:E,actions:V=[],emphasizedAction:q=o.OK,onClose:h,initialFocus:y,...S}=e;ie(ce,d.displayName);const n=H("@ui5/webcomponents-react"),M={[o.Abort]:n.getText(U),[o.Cancel]:n.getText(P),[o.Close]:n.getText(j),[o.Delete]:n.getText($),[o.Ignore]:n.getText(K),[o.No]:n.getText(Y),[o.OK]:n.getText(G),[o.Retry]:n.getText(J),[o.Yes]:n.getText(Q)},w=()=>{if(v)return v;switch(c){case a.Confirm:return n.getText(oe);case a.Error:return n.getText(te);case a.Information:return n.getText(ee);case a.Success:return n.getText(Z);case a.Warning:return n.getText(X);default:return null}},A=t=>{typeof e.onBeforeClose=="function"&&e.onBeforeClose(t),t.detail.escPressed&&typeof h=="function"&&h(void 0,t.detail.escPressed)},g=t=>{const{action:l}=t.currentTarget.dataset;typeof h=="function"&&h(l)},r=m.useId(),_=me(V,c),O=()=>{const t=_.find(l=>l===y);return typeof t=="string"?`${r}-action-${t}`:y},{footer:he,headerText:fe,onClose:ge,onBeforeClose:be,...z}=S,b=ue(E,c,p),N=!e.header&&!!b;return s.jsxs(ne,{open:f,ref:i,className:W(p.messageBox,R),onBeforeClose:A,accessibleNameRef:N?`${r}-title ${r}-text`:void 0,accessibleRole:k.AlertDialog,...z,headerText:w(),state:pe(c),initialFocus:O(),"data-type":c,children:[N&&s.jsxs("div",{slot:"header",className:p.header,children:[b,b&&s.jsx("span",{className:p.spacer}),s.jsx(ae,{id:`${r}-title`,level:L.H1,children:w()})]}),s.jsx(se,{id:`${r}-text`,children:B}),s.jsx("div",{slot:"footer",className:p.footer,children:_.map((t,l)=>{var C,x;return typeof t!="string"&&m.isValidElement(t)?m.cloneElement(t,{onClick:(C=t==null?void 0:t.props)!=null&&C.onClick?D=>{var T;(T=t==null?void 0:t.props)==null||T.onClick(D),g(D)}:g,"data-action":((x=t==null?void 0:t.props)==null?void 0:x["data-action"])??`${l}: custom action`}):typeof t=="string"?s.jsx(re,{id:`${r}-action-${t}`,design:q===t?I.Emphasized:I.Transparent,onClick:g,"data-action":t,children:M[t]??t},`${t}-${l}`):null})})]})});d.displayName="MessageBox";try{d.displayName="MessageBox",d.__docgenInfo={description:"The `MessageBox` component provides easier methods to create a `Dialog`, such as standard alerts, confirmation dialogs, or arbitrary message dialogs.",displayName:"MessageBox",props:{accessibleNameRef:{defaultValue:null,description:`Defines the IDs of the elements that label the component.
...
| cancelable | bubbles |
| :--------: | :-----: |
| ✅|❌|`,name:"onBeforeOpen",required:!1,type:{name:"(event: Ui5CustomEvent<DialogDomRef, never>) => void"}}}}}catch{}export{d as M,a,o as b};
