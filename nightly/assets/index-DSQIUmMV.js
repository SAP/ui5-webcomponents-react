import"./Tag-DzIJgOv0.js";import{w as n}from"./withWebComponent-CkJkBj4X.js";const e=n("ui5-tag",["colorScheme","design","size","wrappingType"],["hideStateIcon","interactive"],["icon"],["click"]);e.displayName="Tag";try{e.displayName="Tag",e.__docgenInfo={description:`The \`Tag\` is a component which serves
...
**Note:** Available since [v1.22.0](https://github.com/SAP/ui5-webcomponents/releases/tag/v1.22.0) of **@ui5/webcomponents**.`,name:"design",required:!1,type:{name:"enum",value:[{value:'"Positive"'},{value:'"Critical"'},{value:'"Negative"'},{value:'"Information"'},{value:'"Set1"'},{value:'"Set2"'},{value:'"Neutral"'},{value:'"Information"'},{value:'"Positive"'},{value:'"Negative"'},{value:'"Critical"'},{value:'"Set1"'},{value:'"Set2"'},{value:'"Neutral"'}]}},hideStateIcon:{defaultValue:{value:"false"},description:`Defines if the default state icon is shown.
