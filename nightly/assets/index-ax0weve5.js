import"./Popover-C5qlK_nP.js";import{w as n}from"./withWebComponent-wFYtA7If.js";const e=n("ui5-popover",["accessibleName","accessibleNameRef","accessibleRole","headerText","horizontalAlign","initialFocus","opener","placement","verticalAlign"],["allowTargetOverlap","hideArrow","modal","open","preventFocusRestore","preventInitialFocus"],["footer","header"],["before-close","before-open","close","open"]);e.displayName="Popover";try{e.displayName="Popover",e.__docgenInfo={description:`The \`Popover\` component displays additional information for an object
