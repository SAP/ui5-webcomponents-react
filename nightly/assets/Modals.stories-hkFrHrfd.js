import{j as e}from"./jsx-runtime-D_zvdyIk.js";import"./index-DYC_JezF.js";import{M as r}from"./index-ByKihU7o.js";import{B as o}from"./index-C2cs6waD.js";import{F as y,d as R}from"./index-Dy6UDmqx.js";import{M as l}from"./index-Ce-vWbj2.js";import{M as D}from"./index-CuBJg89L.js";const I={title:"User Feedback / Modals",component:r},s={render:()=>e.jsx(e.Fragment,{children:e.jsx(o,{onClick:()=>{const{close:k}=r.showDialog({headerText:"Dialog Title",children:"I'm a Dialog!",footer:e.jsxs(y,{justifyContent:R.End,fitContainer:!0,style:{paddingBlock:"0.25rem"},children:[e.jsx(o,{onClick:()=>k(),children:"Close"})," "]})})},children:"Show Dialog"})})},n={render:()=>e.jsx(e.Fragment,{children:e.jsx(o,{id:"modals-show-popover",onClick:()=>{r.showPopover({opener:"modals-show-popover",headerText:"Popover Title",children:"I'm a Popover!"})},children:"Show Popover"})})},t={render:()=>e.jsx(e.Fragment,{children:e.jsx(o,{id:"modals-show-responsive-popover",onClick:()=>{r.showResponsivePopover({opener:"modals-show-responsive-popover",headerText:"Responsive Popover Title",children:"I'm a Responsive Popover!"})},children:"Show ResponsivePopover"})})},a={render:()=>e.jsx(e.Fragment,{children:e.jsx(o,{id:"modals-show-menu",onClick:()=>{r.showMenu({opener:"modals-show-menu",headerText:"Menu Title",children:e.jsxs(e.Fragment,{children:[e.jsx(l,{text:"New File",icon:"add-document"}),e.jsx(l,{text:"New Folder",icon:"add-folder",disabled:!0})]})})},children:"Show Menu"})})},i={render:()=>e.jsx(e.Fragment,{children:e.jsx(o,{onClick:()=>{r.showMessageBox({type:D.Confirm,children:"Can you see this MessageBox?"})},children:"Show MessageBox"})})},d={render:()=>e.jsx(e.Fragment,{children:e.jsx(o,{onClick:()=>{r.showToast({children:"I'm a Message Toast!"})},children:"Show Toast"})})};var c,p,m;s.parameters={...s.parameters,docs:{...(c=s.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => {
    return <>
        <Button onClick={() => {
        const {
