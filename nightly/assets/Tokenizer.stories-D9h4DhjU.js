import{w as g,j as e,r as u,J as y}from"./iframe-BVTjwwa8.js";import{L as T}from"./index-BvWmgkkb.js";import{T as n}from"./index-DVR9_LSQ.js";import"./Token-BTANNLIp.js";const o=g("ui5-tokenizer",["accessibleName","accessibleNameRef"],["disabled","multiLine","readonly","showClearAll"],[],["selection-change","token-delete"]);o.displayName="Tokenizer";try{o.displayName="Tokenizer",o.__docgenInfo={description:`A \`Tokenizer\` is an invisible container for \`Token\`s that supports keyboard navigation and token selection.
