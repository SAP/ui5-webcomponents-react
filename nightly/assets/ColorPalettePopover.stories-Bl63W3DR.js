import{l as _,c as u,cP as D,a0 as R,aR as S,p as g,d as T,b as O,s as h,cQ as N,A as x,ap as k,m as E,b5 as b,af as I,b3 as q,z as j,cR as V,cS as A,w as M,K as B,r as C,j as o,Q as U}from"./iframe-CS0WNVf3.js";import{a as L,C as l}from"./index-BhcBRKAo.js";import{R as F}from"./ResponsivePopoverCommon.css-wgN2az89.js";function Y(){return _(S,{hideArrow:!0,contentOnlyOnDesktop:!0,placement:"Bottom",opener:this.opener,open:this._open,onClose:this.onAfterClose,onOpen:this.onAfterOpen,children:[u("div",{slot:"header",class:"ui5-cp-header",children:u(D,{level:"H1",wrappingType:"None",children:this._colorPaletteTitle})}),u("div",{children:u(L,{showMoreColors:this.showMoreColors,showRecentColors:this.showRecentColors,showDefaultColor:this.showDefaultColor,defaultColor:this.defaultColor,popupMode:!0,onItemClick:this.onSelectedColor,children:this.colorPaletteColors.map(t=>u("slot",{name:t._individualSlot}))})}),u("div",{slot:"footer",class:"ui5-cp-footer",children:u(R,{design:"Transparent",onClick:this.closePopover,children:this._cancelButtonLabel})})]})}g("@ui5/webcomponents-theming","sap_horizon",async()=>T);g("@ui5/webcomponents","sap_horizon",async()=>O);const z=`.ui5-cp-header{width:100%;height:var(--_ui5-v2-12-0_color-palette-button-height);display:flex;align-items:center}.ui5-cp-footer{width:100%;display:flex;justify-content:flex-end;align-items:center;margin:.1875rem 0}[ui5-responsive-popover]::part(content){padding:0}.ui5-cp-item-container{padding:.3125rem .6875rem}
...
}`,...(P=(y=d.parameters)==null?void 0:y.docs)==null?void 0:P.source}}};const W=["Default"],K=Object.freeze(Object.defineProperty({__proto__:null,Default:d,__namedExportsOrder:W,default:H},Symbol.toStringTag,{value:"Module"}));export{K as C,d as D};
