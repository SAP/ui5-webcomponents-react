import"./Tag-BSvd86KJ.js";import{w as n}from"./jsx-runtime-cXES_1K3.js";const e=n("ui5-tag",["colorScheme","design","size","wrappingType"],["hideStateIcon","interactive"],["icon"],["click"]);e.displayName="Tag";try{e.displayName="Tag",e.__docgenInfo={description:`The \`Tag\` is a component which serves
...
**Note:** Available since [v1.22.0](https://github.com/SAP/ui5-webcomponents/releases/tag/v1.22.0) of **@ui5/webcomponents**.`,name:"design",required:!1,type:{name:"enum",value:[{value:'"Positive"'},{value:'"Negative"'},{value:'"Critical"'},{value:'"Information"'},{value:'"Neutral"'},{value:'"Set1"'},{value:'"Set2"'},{value:'"Neutral"'},{value:'"Information"'},{value:'"Positive"'},{value:'"Negative"'},{value:'"Critical"'},{value:'"Set1"'},{value:'"Set2"'}]}},hideStateIcon:{defaultValue:{value:"false"},description:`Defines if the default state icon is shown.
