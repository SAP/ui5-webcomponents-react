import{j as e}from"./jsx-runtime-CLpGMVip.js";import"./index-BzjsyYch.js";import{F as E}from"./index-C24-mXTM.js";import{T as $}from"./index-Cimm6LhF.js";import"./index-BTMmqcpf.js";import{r as l}from"./index-D23YZj_x.js";import{c as pe}from"./clsx-B-dksMZM.js";import{B as ge}from"./Button-C6xPwCPp.js";import{h as J,x as Y}from"./withWebComponent-LqdGbSZi.js";import{f as me}from"./Icon-CA9P0PMV.js";import{v as Q}from"./vertical-grip-tpbWjvOn.js";import{u as _e,ab as Z}from"./i18n-defaults-UInS-fnV.js";import{u as Se}from"./useIsRTL-Dlk0qEqL.js";import{u as K}from"./useStylesheet-hr5H-IMi.js";import{u as be}from"./useCurrentTheme-CujH8sKw.js";import{B as h}from"./index-DWbw-aO0.js";import{I as xe}from"./index-BQ0unmIH.js";import{d as ze}from"./debounce-D7W5PopO.js";import{u as ee}from"./useIsomorphicLayoutEffect-ycvDkpIR.js";import{L as we}from"./index-Dwb1LPrJ.js";import{a as Ce,S as te}from"./index-DuAnx79P.js";const he=l.createContext({vertical:!0,reset:!1}),ve="@layer ui5-webcomponents-react{._splitterElement_5jt3n_1{display:flex;min-height:0;min-width:0;overflow:hidden;position:relative;will-change:flex-basis}}",Ee={splitterElement:"_splitterElement_5jt3n_1"},i=l.forwardRef((n,u)=>{const{children:o,style:_,className:z,minSize:t=0,size:a="auto",resizable:c,...w}=n,[B,R]=J(u),{vertical:S,reset:v}=l.useContext(he),r=Y()?{width:"min-content",flex:"1 1 auto"}:{},C=a!=="auto"?{flex:`0 1 ${a}`}:{flex:"1 0 min-content",...r},[j,s]=l.useState(C),[V,k]=l.useState(!1);return K(ve,i.displayName),l.useEffect(()=>{const L=new ResizeObserver(([D])=>{if(D.target.getBoundingClientRect().width!==0&&!V){const G=Y()?{width:"unset"}:{};s({flex:`0 0 ${D.target.getBoundingClientRect()[S?"height":"width"]}px`,...G}),k(!0)}});return a==="auto"&&R.current?L.observe(R.current):s({flex:`0 1 ${a}`}),()=>{L.disconnect()}},[a,V,S]),ee(()=>{v&&(s(void 0),k(!1))},[v,a]),ee(()=>{j===void 0&&s(C)},[j]),e.jsx("div",{ref:B,className:pe(Ee.splitterElement,z),style:{minHeight:S&&t?`${t}px`:void 0,minWidth:!S&&t?`${t}px`:void 0,...j,..._},...w,"data-min-size":t,children:o})});i.displayName="SplitterElement";try{i.displayName="SplitterElement",i.__docgenInfo={description:"The `SplitterElement` holds the component of the content area. Allowed size values are of the type css property width or\nheight according to the orientation of the `SplitterLayout`. If `size` isn't passed to the element, the width or\nheight of the content area will be calculated automatically according to the size of the given `SplitterLayout`.\nThe `minSize` defines the minimum width or height of the area and is set to 0 when no minimum size is given, so the\ncontent can be completely collapsed.",displayName:"SplitterElement",props:{resizable:{defaultValue:null,description:"Defines whether a resizer element is displayed.\n\nIf the next `SplitterElement` has the prop `resizable={false}`, no resizer element will be shown after this\n`SplitterElement`. The resizer element is only shown when all siblings of the resizer are resizable.\nDefault value of resizable is `true`.",name:"resizable",required:!1,type:{name:"boolean"}},size:{defaultValue:{value:'`"auto"`'},description:"Defines the initial size of the `SplitterElement`.",name:"size",required:!1,type:{name:"string | number | (string & {})"}},minSize:{defaultValue:{value:"`0`"},description:"Defines the minimum size of the `SplitterElement`. The resizer element stops when the minimum size is reached.",name:"minSize",required:!1,type:{name:"number"}},children:{defaultValue:null,description:"Defines the content which is shown inside the `SplitterElement`.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},style:{defaultValue:null,description:`Element style which will be appended to the most outer element of a component.
...
Use this prop carefully, some css properties might break the component.`,name:"style",required:!1,type:{name:"CSSProperties"}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
Use this prop carefully, overwriting CSS rules might break the component.`,name:"className",required:!1,type:{name:"string"}}}}}catch{}const Be="@layer ui5-webcomponents-react{._splitterLayout_6n3m3_1{--_ui5wcr-SplitterSize:1rem;display:flex;overflow:hidden;position:relative}._splitterLayout_6n3m3_1[data-splitter-orientation=horizontal]{flex-direction:row;width:100%}._splitterLayout_6n3m3_1[data-splitter-orientation=horizontal]>*{height:100%}._splitterLayout_6n3m3_1[data-splitter-orientation=vertical]{flex-direction:column;height:100%}._splitterLayout_6n3m3_1[data-splitter-orientation=vertical]>*{width:100%}}",je={splitterLayout:"_splitterLayout_6n3m3_1"},ke="horizontal-grip",Le="M96 224v64H32v-64h64zm256 0v64h-64v-64h64zm-192 0h64v64h-64v-64zm320 0v64h-64v-64h64z",Ne=!1,qe="SAP-icons-v4",Te="@ui5/webcomponents-icons";me(ke,{pathData:Le,ltr:Ne,collection:qe,packageName:Te});const Ve="horizontal-grip",Ie="M0 336q0-20 14-34t34-14 34 14 14 34-14 34-34 14-34-14-14-34zm96-160q0 20-14 34t-34 14-34-14-14-34 14-34 34-14 34 14 14 34zm42 160q0-20 14-34t34-14 34 14 14 34-14 34-34 14-34-14-14-34zm0-160q0-20 14-34t34-14 34 14 14 34-14 34-34 14-34-14-14-34zm140 0q0-20 14-34t34-14 34 14.5 14 33.5-14 33.5-34 14.5-34-14-14-34zm0 160q0-20 14-34t34-14 34 14.5 14 33.5-14 33.5-34 14.5-34-14-14-34zm138-160q0-20 14-34t34-14 34 14 14 34-14 34-34 14-34-14-14-34zm0 160q0-20 14-34t34-14 34 14 14 34-14 34-34 14-34-14-14-34z",Re=!1,Ae="SAP-icons-v5",De="@ui5/webcomponents-icons";me(Ve,{pathData:Ie,ltr:Re,collection:Ae,packageName:De});const ne="horizontal-grip",Fe="@layer ui5-webcomponents-react{._splitter_ce1yt_1{align-items:center;background-color:var(--sapShell_Background);box-sizing:border-box;display:flex;justify-content:center;position:relative;touch-action:none;will-change:flex}._splitter_ce1yt_1[data-splitter-vertical]:focus{outline:var(--_ui5wcr_Splitter_BarOutline);outline-offset:-.2rem}._splitter_ce1yt_1[data-splitter-vertical=horizontal]{border-inline:var(--_ui5wcr_Splitter_BarBorderStyle);cursor:col-resize;flex-direction:column;height:100%;min-width:var(--_ui5wcr-SplitterSize);width:var(--_ui5wcr-SplitterSize)}._splitter_ce1yt_1[data-splitter-vertical=horizontal]:focus{border-block:var(--_ui5wcr_Splitter_BarBorderHighContrastFix);border-inline:var(--_ui5wcr_Splitter_BarBorderFocus)}._splitter_ce1yt_1[data-splitter-vertical=horizontal] ._lineAfter_ce1yt_30,._splitter_ce1yt_1[data-splitter-vertical=horizontal] ._lineBefore_ce1yt_29{background-size:.0625rem 100%;height:4rem;width:var(--_ui5wcr-SplitterSize)}._splitter_ce1yt_1[data-splitter-vertical=horizontal] ._lineBefore_ce1yt_29{background-image:linear-gradient(to top,var(--_ui5wcr_Splitter_ContentBorderColor),#0000)}._splitter_ce1yt_1[data-splitter-vertical=horizontal] ._icon_ce1yt_38{padding:.5rem 0}._splitter_ce1yt_1[data-splitter-vertical=horizontal] ._lineAfter_ce1yt_30{background-image:linear-gradient(to bottom,var(--_ui5wcr_Splitter_ContentBorderColor),#0000)}._splitter_ce1yt_1[data-splitter-vertical=horizontal] ._gripContainer_ce1yt_44{height:2rem;width:1.5rem}._splitter_ce1yt_1[data-splitter-vertical=horizontal] ._gripButton_ce1yt_48{height:1.625rem;min-width:1.5rem}._splitter_ce1yt_1[data-splitter-vertical=vertical]{border-block:var(--_ui5wcr_Splitter_BarBorderStyle);cursor:row-resize;flex-direction:row;height:var(--_ui5wcr-SplitterSize);min-height:var(--_ui5wcr-SplitterSize);width:100%}._splitter_ce1yt_1[data-splitter-vertical=vertical]:focus{border-block:var(--_ui5wcr_Splitter_BarBorderFocus);border-inline:var(--_ui5wcr_Splitter_BarBorderHighContrastFix)}._splitter_ce1yt_1[data-splitter-vertical=vertical] ._lineAfter_ce1yt_30,._splitter_ce1yt_1[data-splitter-vertical=vertical] ._lineBefore_ce1yt_29{background-size:100% .0625rem;height:var(--_ui5wcr-SplitterSize);width:5rem}._splitter_ce1yt_1[data-splitter-vertical=vertical] ._lineBefore_ce1yt_29{background-image:linear-gradient(to left,var(--_ui5wcr_Splitter_ContentBorderColor),#0000)}:is(._splitter_ce1yt_1[data-splitter-vertical=vertical] ._lineBefore_ce1yt_29):dir(rtl){background-image:linear-gradient(to right,var(--_ui5wcr_Splitter_ContentBorderColor),#0000)}._splitter_ce1yt_1[data-splitter-vertical=vertical] ._icon_ce1yt_38{padding:0 .5rem}._splitter_ce1yt_1[data-splitter-vertical=vertical] ._lineAfter_ce1yt_30{background-image:linear-gradient(to right,var(--_ui5wcr_Splitter_ContentBorderColor),#0000)}:is(._splitter_ce1yt_1[data-splitter-vertical=vertical] ._lineAfter_ce1yt_30):dir(rtl){background-image:linear-gradient(to left,var(--_ui5wcr_Splitter_ContentBorderColor),#0000)}._splitter_ce1yt_1[data-splitter-vertical=vertical] ._gripContainer_ce1yt_44{height:1.5rem;width:2rem}._splitter_ce1yt_1[data-splitter-vertical=vertical] ._gripButton_ce1yt_48{height:1.5rem;min-width:1.625rem}._splitter_ce1yt_1:hover ._lineAfter_ce1yt_30,._splitter_ce1yt_1:hover ._lineBefore_ce1yt_29{flex-grow:1;transition:all .1s ease-in}._gripContainer_ce1yt_44{align-items:center;display:flex;justify-content:center;z-index:1}._gripButton_ce1yt_48{cursor:inherit}._gripButton_ce1yt_48:active{z-index:2}._icon_ce1yt_38{box-sizing:initial;color:var(--_ui5wcr_Splitter_IconColor)}._lineAfter_ce1yt_30,._lineBefore_ce1yt_29{background-position:50%;background-repeat:no-repeat}}",A={splitter:"_splitter_ce1yt_1",lineBefore:"_lineBefore_ce1yt_29",lineAfter:"_lineAfter_ce1yt_30",icon:"_icon_ce1yt_38",gripContainer:"_gripContainer_ce1yt_44",gripButton:"_gripButton_ce1yt_48"},$e={start:"top",startUppercase:"Top",end:"bottom",position:"Y",positionRect:"y",size:"height",min:"minHeight",offset:"offsetY"},Oe={start:"left",startUppercase:"Left",end:"right",position:"X",positionRect:"x",size:"width",min:"minWidth",offset:"offsetX"},I=l.forwardRef((n,u)=>{const{vertical:o}=n,_=_e("@ui5/webcomponents-react"),[z,t]=J(u),a=Se(t),c=l.useRef(null);K(Fe,I.displayName);const w=l.useRef(null),B=l.useRef(null),R=l.useRef(null),S=l.useRef(null),v=l.useRef(0),r=o?$e:Oe,[C,j]=l.useState(!1),[s,V]=l.useState(["previousSibling","nextSibling"]),k=d=>{const b=v.current,y=t.current[s[0]],f=t.current[s[1]],m=C==="touch"?d.touches[0][`client${r.position}`]:d[`client${r.position}`],p=m-c.current,N=t.current.getBoundingClientRect()[r.size],x=p<0,q=()=>{y.style.flex=`0 0 ${w.current+p}px`,f.nextSibling&&w.current+p>0&&(f.style.flex=`0 0 ${B.current-p}px`)};w.current+p>0&&m+(N-b)<=S.current&&(parseInt(y.dataset.minSize,10)<=w.current+p&&x&&q(),B.current-p>=parseInt(f.dataset.minSize,10)&&!x&&q()),!f[s[1]]&&!a&&(f.style.flex="1 0 0px")},L=(d,b)=>{var x,q,F,X;if(!t.current)return;const y=t.current[s[0]],f=t.current[s[1]],m=t.current[s[0]].getBoundingClientRect(),p=t.current[s[1]].getBoundingClientRect(),N=b?Math.round(d.changedTouches[0][`client${r.position}`]):d[`client${r.position}`];!t.current.contains(d.target)&&N-t.current[`offset${r.startUppercase}`]+1<0&&(y.style.flex="0 0 0px",(x=y.style)!=null&&x[r.min]?f.style.flex=`0 0 ${(p==null?void 0:p[r.size])+((m==null?void 0:m[r.size])-((q=y.style)==null?void 0:q[r.min].replace("px","")))}px`:f.style.flex=`0 0 ${(p==null?void 0:p[r.size])+(m==null?void 0:m[r.size])}px`),S.current<N&&(f.style.flex="0 0 0px",(F=f.style)!=null&&F[r.min]?y.style.flex=`0 0 ${(m==null?void 0:m[r.size])+((p==null?void 0:p[r.size])-((X=f.style)==null?void 0:X[r.min].replace("px","")))}px`:y.style.flex=`0 0 ${(m==null?void 0:m[r.size])+(p==null?void 0:p[r.size])}px`)},D=d=>{var b,y,f,m;d.type==="pointerdown"&&d.pointerType!=="touch"||(d.currentTarget.focus(),d.preventDefault(),j(d.pointerType??"mouse"),v.current=d.nativeEvent[r.offset],R.current=(b=t.current[s[0]].getBoundingClientRect())==null?void 0:b[r.end],t.current[s[1]][s[1]]?S.current=(y=t.current[s[1]][s[1]].getBoundingClientRect())==null?void 0:y[r.start]:S.current=t.current.parentElement.getBoundingClientRect()[r.end],w.current=(f=t.current[s[0]].getBoundingClientRect())==null?void 0:f[r.size],B.current=(m=t.current[s[1]].getBoundingClientRect())==null?void 0:m[r.size],c.current=d[`client${r.position}`])},G=d=>{var y,f,m,p;const b=d.code??d.key;if(b==="ArrowRight"||b==="ArrowLeft"||b==="ArrowUp"||b==="ArrowDown"){d.preventDefault();let N=t.current[s[0]],x=t.current[s[1]];(b==="ArrowLeft"||b==="ArrowUp")&&(x=t.current[s[0]],N=t.current[s[1]]);const q=x.style[r.min]?((y=x.getBoundingClientRect())==null?void 0:y[r.size])-Number(x.style[r.min].replace("px","")):(f=x.getBoundingClientRect())==null?void 0:f[r.size];if(document.activeElement===t.current){const F=q>=20?20:q,X=(m=N.getBoundingClientRect())==null?void 0:m[r.size],ye=(p=x.getBoundingClientRect())==null?void 0:p[r.size];x.style.flex=`0 0 ${ye-F}px`,N.style.flex=`0 0 ${X+F}px`}}},M=d=>{L(d,C==="touch"),j(!1)};l.useEffect(()=>{const d=()=>{C==="touch"?(document.removeEventListener("touchmove",k),document.removeEventListener("touchend",M)):(document.removeEventListener("mouseup",M),document.removeEventListener("mousemove",k))};return C?C==="touch"?(document.addEventListener("touchmove",k),document.addEventListener("touchend",M)):(document.addEventListener("mousemove",k),document.addEventListener("mouseup",M)):d(),()=>{d()}},[C]),l.useEffect(()=>{V(a&&!o?["nextSibling","previousSibling"]:["previousSibling","nextSibling"])},[a,o]);const W=be(),fe=W==="sap_fiori_3_hcb"||W==="sap_fiori_3_hcw"||W==="sap_horizon_hcb"||W==="sap_horizon_hcw";return e.jsxs("div",{className:A.splitter,tabIndex:0,onKeyDown:G,onPointerDown:D,onMouseDown:D,ref:z,role:"separator","data-splitter-vertical":o?"vertical":"horizontal",title:_.getText(Z),"aria-orientation":o?"vertical":"horizontal","aria-label":_.getText(Z),children:[e.jsx("div",{className:A.lineBefore}),e.jsx("div",{className:A.gripContainer,children:fe?e.jsx(h,{className:A.gripButton,tabIndex:-1,icon:o?ne:Q,design:ge.Transparent,"data-component-name":"SplitterLayoutSplitterGrip"}):e.jsx(xe,{className:A.icon,name:o?ne:Q,"data-component-name":"SplitterLayoutSplitterGrip"})}),e.jsx("div",{className:A.lineAfter})]})});I.displayName="Splitter";try{I.displayName="Splitter",I.__docgenInfo={description:"",displayName:"Splitter",props:{height:{defaultValue:null,description:"",name:"height",required:!0,type:{name:"string | number"}},width:{defaultValue:null,description:"",name:"width",required:!0,type:{name:"string | number"}},vertical:{defaultValue:null,description:"",name:"vertical",required:!0,type:{name:"boolean"}},style:{defaultValue:null,description:`Element style which will be appended to the most outer element of a component.
Use this prop carefully, some css properties might break the component.`,name:"style",required:!1,type:{name:"CSSProperties"}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
