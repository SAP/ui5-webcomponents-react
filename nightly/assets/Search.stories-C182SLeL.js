import{w,j as e,r as v}from"./iframe-yjMKSaW2.js";import{S,a as r}from"./index-BERHUKqZ.js";import"./Search-ChPfrlKZ.js";const t=w("ui5-search",["accessibleDescription","accessibleName","placeholder","value"],["loading","noTypeahead","open","showClearIcon"],["action","filterButton","illustration","messageArea","scopes"],["close","input","open","scope-change","search"]);t.displayName="Search";try{t.displayName="Search",t.__docgenInfo={description:`A \`Search\` is an input with suggestions, used for user search.
