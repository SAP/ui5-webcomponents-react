import"./ResponsivePopover-DkVgEbSU.js";import{w as n}from"./jsx-runtime-cXES_1K3.js";const e=n("ui5-responsive-popover",["accessibleName","accessibleNameRef","accessibleRole","headerText","horizontalAlign","initialFocus","opener","placement","verticalAlign"],["allowTargetOverlap","hideArrow","modal","open","preventFocusRestore","preventInitialFocus"],["footer","header"],["before-close","before-open","close","open"]);e.displayName="ResponsivePopover";try{e.displayName="ResponsivePopover",e.__docgenInfo={description:`The \`ResponsivePopover\` acts as a Popover on desktop and tablet, while on phone it acts as a Dialog.
