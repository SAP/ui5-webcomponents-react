import{j as d}from"./jsx-runtime-CLpGMVip.js";import{r}from"./index-D23YZj_x.js";import{r as w}from"./index-DJ2M8xrO.js";import{I as b,u as D}from"./useIsomorphicLayoutEffect-ycvDkpIR.js";import{M as N}from"./index-55Y70oOC.js";import{P as C}from"./index-Cr32hUX_.js";import{M as S}from"./index-CW0RC0zW.js";import{T as _}from"./index-BKyahDJZ.js";import{D as q}from"./index-DlFiyWq-.js";import{R as M}from"./index-DuWCAtbK.js";import{h as V}from"./withWebComponent-LqdGbSZi.js";const u=()=>"randomUUID"in crypto?crypto.randomUUID():window.crypto.getRandomValues(new Uint32Array(1))[0].toString(16);globalThis["@ui5/webcomponents-react"]??(globalThis["@ui5/webcomponents-react"]={});const s=globalThis["@ui5/webcomponents-react"];function p(){return Symbol.for(`@ui5/webcomponents-react/Modals-${b()}/Listeners`)}function c(){return Symbol.for(`@ui5/webcomponents-react/Modals-${b()}`)}const g=[];function y(){var e;return s[e=p()]??(s[e]=[]),s[p()]}function f(){for(const e of y())e()}function h(){var e;return s[e=c()]??(s[e]=g),s[c()]}function T(e){const n=y();return s[p()]=[...n,e],()=>{s[p()]=n.filter(a=>a!==e)}}const l={subscribe:T,getSnapshot:h,getServerSnapshot:()=>g,addModal(e){s[c()]=[...h(),e],f()},removeModal(e){s[c()]=h().filter(n=>n.id!==e),f()}};function R(e,n){const a=u(),o=r.createRef();return l.addModal({Component:q,props:{...e,open:!0,onClose:i=>{typeof e.onClose=="function"&&e.onClose(i),l.removeModal(a)}},ref:o,container:n,id:a}),{ref:o,close:()=>{o.current&&(o.current.open=!1)}}}function A(e,n){const a=u(),o=r.createRef();return l.addModal({Component:C,props:{...e,open:!0,onClose:i=>{typeof e.onClose=="function"&&e.onClose(i),l.removeModal(a)}},ref:o,container:n,id:a}),{ref:o,close:()=>{o.current&&(o.current.open=!1)}}}function E(e,n){const a=u(),o=r.createRef();return l.addModal({Component:M,props:{...e,open:!0,onClose:i=>{typeof e.onClose=="function"&&e.onClose(i),l.removeModal(a)}},ref:o,container:n,id:a}),{ref:o,close:()=>{o.current&&(o.current.open=!1)}}}function I(e,n){const a=u(),o=r.createRef();return l.addModal({Component:S,props:{...e,open:!0,onClose:i=>{typeof e.onClose=="function"&&e.onClose(i),l.removeModal(a)}},ref:o,container:n,id:a}),{ref:o,close:()=>{o.current&&(o.current.open=!1)}}}function P(e,n){const a=u(),o=r.createRef();return l.addModal({Component:N,props:{...e,open:!0,onClose:i=>{typeof e.onClose=="function"&&e.onClose(i),l.removeModal(a)}},ref:o,container:n,id:a}),{ref:o,close:()=>{o.current&&(o.current.open=!1)}}}function B(e,n){const a=r.createRef(),o=u();return l.addModal({Component:_,props:{...e,open:!0,onClose:i=>{typeof e.onClose=="function"&&e.onClose(i),l.removeModal(o)}},ref:a,container:n,id:o}),{ref:a}}function v({modal:e}){const[n,a]=V(e.ref);D(()=>{const m=a.current;m&&requestAnimationFrame(()=>{m.open=!0})},[]);const{open:o,...i}=e.props;return d.jsx(e.Component,{...i,ref:n,"data-id":e.id})}function t(){const e=r.useSyncExternalStore(l.subscribe,l.getSnapshot,l.getServerSnapshot);return d.jsx(d.Fragment,{children:e.map(n=>{if(n!=null&&n.Component)return n.container?w.createPortal(d.jsx(v,{modal:n},n.id),n.container):d.jsx(v,{modal:n},n.id)})})}t.displayName="Modals";t.showDialog=R;t.showPopover=A;t.showResponsivePopover=E;t.showMenu=I;t.showMessageBox=P;t.showToast=B;try{t.displayName="Modals",t.__docgenInfo={description:"Utility class for opening modals in an imperative way.\n\nThese static helper methods might be useful for showing e.g. Toasts or MessageBoxes after successful or failed\nnetwork calls.\n\n**In order to use these helpers, please make sure to render the `Modals` component somewhere in your application tree.**\n\n__Note:__ The `Toast` component does not currently use the [Popover API](https://developer.mozilla.org/en-US/docs/Web/API/Popover_API), which may cause issues like incorrect positioning or alignment. If that's the case, please mount the `Modals` component after all other components, or define a custom container via the `container` parameter.",displayName:"Modals",props:{}}}catch{}try{t.showDialog.displayName="Modals.showDialog",t.showDialog.__docgenInfo={description:"",displayName:"Modals.showDialog",props:{children:{defaultValue:null,description:"Defines the content of the Popup.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},footer:{defaultValue:null,description:`Defines the footer HTML Element.
...
**Note:** Upon resizing, externally defined height and width styling will be ignored.`,name:"resizable",required:!1,type:{name:"boolean"}},state:{defaultValue:{value:'"None"'},description:'Defines the state of the `Dialog`.\n\n**Note:** If `"Negative"` and `"Critical"` states is set, it will change the\naccessibility role to "alertdialog", if the accessibleRole property is set to `"Dialog"`.',name:"state",required:!1,type:{name:"enum",value:[{value:'"None"'},{value:'"Positive"'},{value:'"Critical"'},{value:'"Negative"'},{value:'"Information"'},{value:'"None"'},{value:'"Positive"'},{value:'"Critical"'},{value:'"Negative"'},{value:'"Information"'}]}},stretch:{defaultValue:{value:"false"},description:`Determines if the dialog will be stretched to full screen on mobile. On desktop,
...
Use this prop carefully, some css properties might break the component.`,name:"style",required:!1,type:{name:"CSSProperties"}},accessibleName:{defaultValue:{value:"undefined"},description:"Defines the accessible name of the component.",name:"accessibleName",required:!1,type:{name:"string"}},onOpen:{defaultValue:null,description:`Fired after the component is opened.

| cancelable | bubbles |
| :--------: | :-----: |
| ❌|❌|`,name:"onOpen",required:!1,type:{name:"(event: Ui5CustomEvent<DialogDomRef, never>) => void"}},header:{defaultValue:null,description:`Defines the header HTML Element.
...
__Note:__ When passing a custom React component to this prop, you have to make sure your component reads the \`slot\` prop and appends it to the most outer element of your component.
Learn more about it [here](https://sap.github.io/ui5-webcomponents-react/v2/?path=/docs/knowledge-base-handling-slots--docs).`,name:"header",required:!1,type:{name:"UI5WCSlotsNode"}},accessibleRole:{defaultValue:{value:'"Dialog"'},description:`Allows setting a custom role.
