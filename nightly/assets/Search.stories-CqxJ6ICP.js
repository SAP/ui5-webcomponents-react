import{w as d,j as e,r as m}from"./iframe-ir6pYnmz.js";import{S as f,a as r}from"./index-BWulYTkN.js";import"./Search-DbtTMUAw.js";const t=d("ui5-search",["accessibleDescription","accessibleName","placeholder","value"],["loading","noTypeahead","open","showClearIcon"],["action","filterButton","illustration","messageArea","scopes"],["close","input","open","scope-change","search"]);t.displayName="Search";try{t.displayName="Search",t.__docgenInfo={description:`A \`Search\` is an input with suggestions, used for user search.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const b={title:"Inputs / Search",component:t,argTypes:{children:{control:{disable:!0}},illustration:{control:{disable:!0}},scopes:{control:{disable:!0}},messageArea:{control:{disable:!0}},action:{control:{disable:!0}}},tags:["package:@ui5/webcomponents-fiori","experimental"]},n={},i=[{name:"Laptop",scope:"products"},{name:"Leave Requests",scope:"apps"},{name:"Log work",scope:"apps"},{name:"Manage Products",scope:"apps"},{name:"Mobile Phones",scope:"products"},{name:"Tablet",scope:"products"}],a={args:{showClearIcon:!0,placeholder:"Search Apps, Products",scopes:e.jsxs(e.Fragment,{children:[e.jsx(r,{selected:!0,text:"All"}),e.jsx(r,{text:"Apps"}),e.jsx(r,{text:"Products"})]})},render(s){const[c,l]=m.useState(i),h=o=>{s.onScopeChange(o);const{scope:p}=o.detail;p.text==="All"?l(i):l(i.filter(u=>u.scope===p.text.toLowerCase()))};return e.jsx(t,{...s,onScopeChange:h,children:c.map(o=>e.jsx(f,{text:o.name,scopeName:o.scope},o.name))})}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"{}",...n.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
    showClearIcon: true,
...
}`,...a.parameters?.docs?.source}}};const g=["Default","WithScopeAndItems"],S=Object.freeze(Object.defineProperty({__proto__:null,Default:n,WithScopeAndItems:a,__namedExportsOrder:g,default:b},Symbol.toStringTag,{value:"Module"}));export{S as C,n as D,a as W};
