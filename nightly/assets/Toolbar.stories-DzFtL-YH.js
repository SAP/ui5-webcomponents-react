import{p as S,d as F,b as k,c as N,s as u,A as B,m as _,b7 as O,ah as z,w as T,b5 as L,j as i,r as V,V as M}from"./iframe-C5HYk_w9.js";import{a as P,T as C}from"./index-DBXI_T6Z.js";import{S as H}from"./Select-SEMtVca9.js";import{O as G}from"./Option-c-UVfgap.js";import{T as x,a as J}from"./ToolbarButton-DhuJsCUg.js";S("@ui5/webcomponents-theming","sap_horizon",async()=>F);S("@ui5/webcomponents","sap_horizon",async()=>k);const K=`:host(:not([hidden])){width:100%}.ui5-tb-popover-item{width:inherit}
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function X(){return N("div",{class:"ui5-tb-separator ui5-tb-item","data-ui5-external-action-item-id":this._id})}S("@ui5/webcomponents-theming","sap_horizon",async()=>F);S("@ui5/webcomponents","sap_horizon",async()=>k);const Y=`.ui5-tb-separator{height:var(--_ui5-v2-13-2-toolbar-separator-height);width:.0625rem;background:var(--sapToolbar_SeparatorColor);box-sizing:border-box}
