import{j as c,F as b,p as _,d as y,s as d,m as w,e as g,S as T,A as C,w as E}from"./withWebComponent-LqdGbSZi.js";import{H as S}from"./Keys-Can65e7H.js";import{l as F}from"./event-strict-DgQLNDEV.js";import{d as N}from"./parameters-bundle.css-BQD_Xb6z.js";function D(){return c(b,{children:this.open&&c("div",{class:"ui5-toast-root",role:"alert",tabindex:this._tabindex,children:c("bdi",{children:c("slot",{})})})})}_("@ui5/webcomponents-theming","sap_horizon",async()=>y);_("@ui5/webcomponents","sap_horizon",async()=>N);const x=`:host{font-family:"72override",var(--sapFontFamily);color:var(--sapList_TextColor);font-size:var(--sapFontSize);position:fixed;display:none;box-sizing:border-box;max-width:15rem;overflow:hidden;background:var(--_ui5-v2-7-0_toast_background);box-shadow:var(--_ui5-v2-7-0_toast_shadow);border-radius:var(--sapElement_BorderCornerRadius);transition-property:opacity;opacity:1;word-wrap:break-word;text-align:center;text-overflow:ellipsis;white-space:pre-line;padding:1rem;inset:unset;margin:0;border:none}.ui5-toast-root{height:100%;width:100%;padding:0;outline:none;box-sizing:border-box}:host([open]){display:block}:host(:not([placement])){bottom:var(--_ui5-v2-7-0_toast_vertical_offset);left:50%;transform:translate(-50%)}:host([placement="TopStart"]){top:var(--_ui5-v2-7-0_toast_vertical_offset);left:var(--_ui5-v2-7-0_toast_horizontal_offset)}:host([placement="MiddleStart"]){left:var(--_ui5-v2-7-0_toast_horizontal_offset);top:50%;transform:translateY(-50%)}:host([placement="BottomStart"]){left:var(--_ui5-v2-7-0_toast_horizontal_offset);bottom:var(--_ui5-v2-7-0_toast_vertical_offset)}:host([placement="TopCenter"]){top:var(--_ui5-v2-7-0_toast_vertical_offset);left:50%;transform:translate(-50%)}:host([placement="MiddleCenter"]){left:50%;top:50%;transform:translate(-50%,-50%)}:host([placement="BottomCenter"]){bottom:var(--_ui5-v2-7-0_toast_vertical_offset);left:50%;transform:translate(-50%)}:host([placement="TopEnd"]){right:var(--_ui5-v2-7-0_toast_horizontal_offset);top:var(--_ui5-v2-7-0_toast_vertical_offset)}:host([placement="MiddleEnd"]){right:var(--_ui5-v2-7-0_toast_horizontal_offset);top:50%;transform:translateY(-50%)}:host([placement="BottomEnd"]){right:var(--_ui5-v2-7-0_toast_horizontal_offset);bottom:var(--_ui5-v2-7-0_toast_vertical_offset)}:host([focused]){outline-width:var(--sapContent_FocusWidth);outline-style:var(--sapContent_FocusStyle);outline-color:var(--sapContent_FocusColor);outline-offset:var(--_ui5-v2-7-0_toast_offset_width)}
