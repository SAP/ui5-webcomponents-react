import{c as Ye,s as Me,a as Ke,t as He}from"./DemoProps-CfK95Xbq.js";import{j as a}from"./jsx-runtime-DEdD30eg.js";import{T as x}from"./ThemingParameters-B358vlzA.js";import{e as $e}from"./index-C-Zfmu7Z.js";import{r as q}from"./index-RYns6xqu.js";import{d as Ue,C as ge,u as Xe,t as Ge,a as Je,b as Qe,c as ye}from"./staticProps-Dcru6MzA.js";import{u as Ze,B as et}from"./useCancelAnimationFallback-DPZiosnB.js";import{u as tt,a as at,C as ot,X as N,c as E,Y as nt,b as rt}from"./YAxisTicks-D86oyfZv.js";import{u as st,C as it}from"./ChartDataLabel-BZgcZDYh.js";import{g as lt,u as ct,a as dt,r as ht,b as F}from"./useTooltipFormatter-DfEjvplz.js";import{u as ut}from"./useOnClickInternal-CrvD_ZAc.js";import{q as mt,B as pt,g as ft,s as gt,r as yt,R as bt,T as Ct,t as vt}from"./ChartContainer-CyI2BzYs.js";import{C as wt}from"./react-content-loader.es-BcmDwNEo.js";import{k as kt}from"./withWebComponent-m_Fq5lNf.js";import{u as xt}from"./useIsRTL-C5iQ0Bor.js";const At=(o,c,u="")=>q.useMemo(()=>{let d=Array(c.length).fill(0),s=0;if(o instanceof Array&&c){const I=i=>c.map(l=>l.formatter(ge.getValueByDataKey(i,l.accessor,"")));o.map(I).forEach(i=>{i.forEach((l,A)=>{d[A]=Math.max(lt(l),d[A])})}),d=d.map(i=>Math.min(Ue,i)),s=d.reduce((i,l)=>i+l,0)}return u==="middle"?[d,{width:"auto"}]:[d,{marginLeft:s,maxWidth:`calc(100% - ${s+8}px)`}]},[o,c,u]),St=()=>a.jsxs(wt,{viewBox:"0 0 165 145",preserveAspectRatio:"xMidYMid meet",width:"100%",height:"100%",speed:2,backgroundColor:x.sapContent_ImagePlaceholderBackground,foregroundColor:x.sapContent_ImagePlaceholderForegroundColor,backgroundOpacity:x.sapContent_DisabledOpacity,children:[a.jsx("rect",{x:"20",y:"10",width:"1",height:"135"}),a.jsx("rect",{x:"20",y:"20",width:"85",height:"15"}),a.jsx("rect",{x:"20",y:"40",width:"117",height:"15"}),a.jsx("rect",{x:"20",y:"60",width:"67",height:"15"}),a.jsx("rect",{x:"20",y:"80",width:"75",height:"15"}),a.jsx("rect",{x:"20",y:"100",width:"125",height:"15"}),a.jsx("rect",{x:"20",y:"120",width:"60",height:"15"})]}),Dt={formatter:ye},_t={formatter:ye,opacity:1},Lt=o=>({payload:c})=>ge.getValueByDataKey(c,o),m=q.forwardRef((o,c)=>{var R,W;const{loading:u,loadingDelay:d,dataset:s,noLegend:I,noAnimation:j,tooltipConfig:i,onDataPointClick:l,onLegendClick:A,onClick:z,style:be,className:Ce,slot:ve,syncId:we,ChartPlaceholder:ke,children:xe,...Ae}=o,t={margin:{},yAxisVisible:!0,xAxisVisible:!0,gridStroke:x.sapList_BorderColor,gridHorizontal:!0,gridVertical:!1,legendPosition:"bottom",legendHorizontalAlign:"left",barGap:3,zoomingTool:!1,resizeDebounce:250,yAxisConfig:{},xAxisConfig:{},secondXAxisConfig:{},...o.chartConfig},n=t.referenceLine,{dimensions:V,measures:S}=ct(o.dimensions,o.measures,Dt,_t),Se=dt(S),h=V[0],{primaryMeasure:D,secondaryMeasure:De}=ht(S,(R=t==null?void 0:t.secondYAxis)==null?void 0:R.dataKey),_e=S.map(({accessor:e})=>e),P=t.secondYAxis?_e.findIndex(e=>{var r;return e===((r=t.secondYAxis)==null?void 0:r.dataKey)}):0,[Le,B]=kt(c),Ie=Xe(A),je=st(h),Ve=q.useCallback((e,r,_)=>{if(e&&l){const L=e.value.length?e.value[1]-e.value[0]:e.value;l($e(_,{dataKey:Object.keys(e).filter(T=>T!=="value").find(T=>e[T]===L),value:L,payload:e.payload,dataIndex:r}))}},[l]),Pe=ut(z),Te=(s==null?void 0:s.length)>30,qe=h==null?void 0:h.accessor,[ze,Be]=At(s,V,t.legendPosition),Oe=tt(t.margin,t.zoomingTool),[Re]=at(B,1),O=xt(B),{isMounted:We,handleBarAnimationStart:Ne,handleBarAnimationEnd:Ee}=Ze(j),{chartConfig:Vt,dimensions:Pt,measures:Tt,...Fe}=Ae;return a.jsx(mt,{dataset:s,loading:u,loadingDelay:d,Placeholder:ke??St,ref:Le,style:be,className:Ce,slot:ve,resizeDebounce:t.resizeDebounce,...Fe,children:a.jsxs(et,{syncId:we,onClick:Pe,stackOffset:"sign",margin:Oe,layout:"vertical",data:s,barGap:t.barGap,accessibilityLayer:t.accessibilityLayer,className:typeof l=="function"||typeof z=="function"?"has-click-handler":void 0,children:[a.jsx(ot,{vertical:t.gridVertical,horizontal:t.gridHorizontal,stroke:t.gridStroke}),t.xAxisVisible&&a.jsx(N,{interval:0,type:"number",tick:a.jsx(E,{config:D}),axisLine:t.xAxisVisible,tickLine:Ge,tickFormatter:D==null?void 0:D.formatter,height:Re,reversed:O,...t.xAxisConfig}),((W=t.secondYAxis)==null?void 0:W.dataKey)&&a.jsx(N,{dataKey:t.secondYAxis.dataKey,axisLine:{stroke:t.secondYAxis.color??`var(--sapChart_OrderedColor_${P%12+1})`},tick:a.jsx(E,{config:De,secondYAxisConfig:{color:t.secondYAxis.color??`var(--sapChart_OrderedColor_${P%12+1})`}}),tickLine:{stroke:t.secondYAxis.color??`var(--sapChart_OrderedColor_${P%12+1})`},label:{value:t.secondYAxis.name,offset:2,angle:90,position:"center"},orientation:"top",interval:0,xAxisId:"secondary",type:"number",...t.secondXAxisConfig}),t.yAxisVisible&&V.map((e,r)=>a.jsx(nt,{interval:(e==null?void 0:e.interval)??"preserveStartEnd",minTickGap:Te?void 0:-10,type:"category",dataKey:e.accessor,tick:a.jsx(rt,{config:e}),tickLine:r<1,axisLine:r<1,yAxisId:r,width:ze[r],allowDuplicatedCategory:r===0,orientation:O?"right":"left",...t.yAxisConfig},e.reactKey)),We&&S.map((e,r)=>a.jsxs(pt,{stackId:e.stackId,fillOpacity:e.opacity,name:e.label??e.accessor,strokeOpacity:e.opacity,type:"monotone",dataKey:e.accessor,fill:e.color??`var(--sapChart_OrderedColor_${r%12+1})`,stroke:e.color??`var(--sapChart_OrderedColor_${r%12+1})`,barSize:e.width,onClick:Ve,isAnimationActive:!j,onAnimationStart:Ne,onAnimationEnd:Ee,children:[a.jsx(ft,{data:s,valueAccessor:Lt(e.accessor),content:a.jsx(it,{config:e,chartType:"bar",position:"insideRight"})}),s.map((_,L)=>a.jsx(gt,{fill:F(e,_,r),stroke:F(e,_,r)},L))]},e.reactKey)),!I&&a.jsx(yt,{verticalAlign:t.legendPosition,align:t.legendHorizontalAlign,onClick:Ie,wrapperStyle:Be}),n&&a.jsx(bt,{...n,stroke:(n==null?void 0:n.color)??(n==null?void 0:n.stroke),x:(n==null?void 0:n.value)??(n==null?void 0:n.x),label:n==null?void 0:n.label}),(i==null?void 0:i.active)!==!1&&a.jsx(Ct,{cursor:Je,formatter:Se,contentStyle:Qe,labelFormatter:je,...i}),t.zoomingTool&&a.jsx(vt,{y:10,dataKey:qe,tickFormatter:h==null?void 0:h.formatter,stroke:x.sapObjectHeader_BorderColor,travellerWidth:10,height:20}),xe]})})});m.displayName="BarChart";try{m.displayName="BarChart",m.__docgenInfo={description:"A `BarChart` is a data visualization where each category is represented by a rectangle, with the width of the rectangle being proportional to the values being plotted.",displayName:"BarChart",props:{dimensions:{defaultValue:null,description:`An array of config objects. Each object will define one dimension of the chart.
...
Use this prop carefully, some css properties might break the component.`,name:"style",required:!1,type:{name:"CSSProperties"}}}}}catch{}const It={title:"BarChart",component:m,argTypes:{dataset:{control:{disable:!0}},children:{control:{disable:!0}}},args:{dataset:Ye,dimensions:[{accessor:"name"}],measures:[{accessor:"users",label:"Users",formatter:o=>o.toLocaleString(),opacity:.6},{accessor:"sessions",label:"Active Sessions",formatter:o=>`${o} sessions`,hideDataLabel:!0},{accessor:"volume",label:"Vol."}]}},p={},f={args:{measures:[{accessor:"users",color:"red"}],dataset:Me}},g={args:{dimensions:[{accessor:"name"},{accessor:"dimension"}],measures:[{accessor:"users",color:"red"}],dataset:Ke}},y={args:{measures:[{accessor:"users"},{accessor:"sessions"},{accessor:"volume"}]}},b={args:{dimensions:[{accessor:"name",formatter:o=>o.slice(0,3)}],measures:[{accessor:"users",formatter:o=>`${o/10}`,label:"number of users"},{accessor:"sessions"},{accessor:"volume"}],chartConfig:{zoomingTool:!0}}},C={args:{dataset:[]}},v={args:{measures:[{accessor:"users",stackId:"A"},{accessor:"sessions",stackId:"A"},{accessor:"volume"}],chartConfig:{referenceLine:{color:"red",label:"MAX",value:650}}}},w={args:{measures:[{accessor:"users",stackId:"A"},{accessor:"sessions",stackId:"A"},{accessor:"volume",highlightColor:(o,c,u)=>{if(u.name==="February")return"red"}}]}},k={args:He};var Y,M,K;p.parameters={...p.parameters,docs:{...(Y=p.parameters)==null?void 0:Y.docs,source:{originalSource:"{}",...(K=(M=p.parameters)==null?void 0:M.docs)==null?void 0:K.source}}};var H,$,U;f.parameters={...f.parameters,docs:{...(H=f.parameters)==null?void 0:H.docs,source:{originalSource:`{
  ...
  args: tooltipConfig
}`,...(fe=(pe=k.parameters)==null?void 0:pe.docs)==null?void 0:fe.source}}};const jt=["Default","WithCustomColor","WithSecondaryDimension","WithDataLabels","WithFormatter","LoadingPlaceholder","WithReferenceLine","WithHighlightedMeasure","WithCustomTooltipConfig"],Xt=Object.freeze(Object.defineProperty({__proto__:null,Default:p,LoadingPlaceholder:C,WithCustomColor:f,WithCustomTooltipConfig:k,WithDataLabels:y,WithFormatter:b,WithHighlightedMeasure:w,WithReferenceLine:v,WithSecondaryDimension:g,__namedExportsOrder:jt,default:It},Symbol.toStringTag,{value:"Module"}));export{Xt as C,p as D,C as L,f as W,g as a,y as b,b as c,v as d,w as e,k as f};
