import{h as m,f as u,s as b,a as f,m as g,k as y,I as _,w as v}from"./withWebComponent-6t4MTiZ-.js";import{d as p}from"./slot-_4yKMUwC.js";import{f as h}from"./ResizeHandler-BL_t98Y7.js";import{o as w}from"./class-map-D9jLILSY.js";import{l as C}from"./if-defined-B1auRMLy.js";import{s as S}from"./parameters-bundle.css-P4kwt3kq.js";function N(o,e,t){return m`<div class="${w(this.classes.root)}" aria-label="${C(this.accInfo.label)}" role="toolbar" part="bar"><div class="ui5-bar-content-container ui5-bar-startcontent-container"><slot name="startContent"></slot></div><div class="ui5-bar-content-container ui5-bar-midcontent-container"><slot></slot></div><div class="ui5-bar-content-container ui5-bar-endcontent-container"><slot name="endContent"></slot></div></div>`}u("@ui5/webcomponents-theming","sap_horizon",async()=>b);u("@ui5/webcomponents","sap_horizon",async()=>S);const F={packageName:"@ui5/webcomponents",fileName:"themes/Bar.css.ts",content:`:host{background-color:var(--sapPageHeader_Background);height:var(--_ui5-v2-1-2_bar_base_height);width:100%;box-shadow:var(--sapContent_HeaderShadow);display:block}.ui5-bar-root{display:flex;align-items:center;justify-content:space-between;height:inherit;width:inherit;background-color:inherit;box-shadow:inherit;border-radius:inherit}.ui5-bar-root .ui5-bar-startcontent-container{padding-inline-start:var(--_ui5-v2-1-2_bar-start-container-padding-start);display:flex;flex-direction:row;align-items:center;justify-content:flex-start}.ui5-bar-root .ui5-bar-content-container{min-width:calc(30% - calc(var(--_ui5-v2-1-2_bar-start-container-padding-start) + var(--_ui5-v2-1-2_bar-end-container-padding-end) + (2*var(--_ui5-v2-1-2_bar-mid-container-padding-start-end))))}.ui5-bar-root.ui5-bar-root-shrinked .ui5-bar-content-container{min-width:0px;overflow:hidden;height:100%}.ui5-bar-root .ui5-bar-endcontent-container{padding-inline-end:var(--_ui5-v2-1-2_bar-end-container-padding-end);display:flex;flex-direction:row;align-items:center;justify-content:flex-end}.ui5-bar-root .ui5-bar-midcontent-container{padding:0 var(--_ui5-v2-1-2_bar-mid-container-padding-start-end);display:flex;flex-direction:row;align-items:center;justify-content:center}:host([design="Footer"]){background-color:var(--sapPageFooter_Background);border-top:.0625rem solid var(--sapPageFooter_BorderColor);box-shadow:none}:host([design="Subheader"]){height:var(--_ui5-v2-1-2_bar_subheader_height);margin-top:var(--_ui5-v2-1-2_bar_subheader_margin-top)}:host([design="FloatingFooter"]){border-radius:var(--sapElement_BorderCornerRadius);background-color:var(--sapPageFooter_Background);box-shadow:var(--sapContent_Shadow1);border:none}::slotted(*){margin:0 .25rem}
`};var l=function(o,e,t,r){var i=arguments.length,n=i<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,d;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,e,t,r);else for(var c=o.length-1;c>=0;c--)(d=o[c])&&(n=(i<3?d(n):i>3?d(e,t,n):d(e,t))||n);return i>3&&n&&Object.defineProperty(e,t,n),n};let a=class extends _{get accInfo(){return{label:this.design}}constructor(){super(),this.design="Header",this._handleResizeBound=this.handleResize.bind(this)}handleResize(){const e=this.getDomRef(),t=e.offsetWidth,r=Array.from(e.children).some(i=>i.offsetWidth>t/3);e.classList.toggle("ui5-bar-root-shrinked",r)}get classes(){return{root:{"ui5-bar-root":!0}}}onEnterDOM(){h.register(this,this._handleResizeBound),this.getDomRef().querySelectorAll(".ui5-bar-content-container").forEach(e=>{h.register(e,this._handleResizeBound)},this)}onExitDOM(){h.deregister(this,this._handleResizeBound),this.getDomRef().querySelectorAll(".ui5-bar-content-container").forEach(e=>{h.deregister(e,this._handleResizeBound)},this)}};l([f()],a.prototype,"design",void 0);l([p({type:HTMLElement})],a.prototype,"startContent",void 0);l([p({type:HTMLElement,default:!0})],a.prototype,"middleContent",void 0);l([p({type:HTMLElement})],a.prototype,"endContent",void 0);a=l([g({tag:"ui5-bar",fastNavigation:!0,renderer:y,styles:F,template:N})],a);a.define();const s=v("ui5-bar",["design"],[],["endContent","startContent"],[]);s.displayName="Bar";try{s.displayName="Bar",s.__docgenInfo={description:`The Bar is a container which is primarily used to hold titles, buttons and input elements
