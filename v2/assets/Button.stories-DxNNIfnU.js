import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{c,B as D}from"./Button-BlFaFbRM.js";import{e as T}from"./employee-9yy2sSWI.js";import{j as A,p as _,d as N,s as w,m as S,l as C,A as j,w as I}from"./jsx-runtime-BhvuzFo7.js";import{T as O}from"./Tag-BTr-mxkm.js";import{d as P}from"./parameters-bundle.css-DHLNbl9v.js";import{B as m}from"./index-n4YNqY3D.js";function q(){return A(O,{design:"Critical","hide-state-icon":!0,children:this.effectiveText})}_("@ui5/webcomponents-theming","sap_horizon",async()=>N);_("@ui5/webcomponents","sap_horizon",async()=>P);const V=`[ui5-tag]::part(root){border:.0625rem solid var(--sapContent_BadgeBorderColor);background-color:var(--sapContent_BadgeBackground);color:var(--sapContent_BadgeTextColor);height:1rem;border-radius:.5rem}:host([design="AttentionDot"]) [ui5-tag]::part(root){min-width:var(--_ui5-v2-8-0-button-badge-diameter);min-height:var(--_ui5-v2-8-0-button-badge-diameter);height:var(--_ui5-v2-8-0-button-badge-diameter);width:var(--_ui5-v2-8-0-button-badge-diameter);border-radius:100%}
