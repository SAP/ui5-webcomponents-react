import"./Slider-DkuVKQ-A.js";import{w as n}from"./withWebComponent-LqdGbSZi.js";const e=n("ui5-slider",["accessibleName","labelInterval","max","min","name","step","value"],["disabled","editableTooltip","showTickmarks","showTooltip"],[],["change","input"]);e.displayName="Slider";try{e.displayName="Slider",e.__docgenInfo={description:`The Slider component represents a numerical range and a handle (grip).
