import{j as s}from"./jsx-runtime-CLpGMVip.js";import{d as ie,a as ae}from"./List-BXQECwfj.js";import{c as se}from"./copy-CofIAqn3.js";import{b as D,j as m,F as X,p as S,d as J,s as d,m as _,k as q,S as le,w as L}from"./jsx-runtime--4q9epG_.js";import{I as Z,f as C}from"./Icon-CqWzJ5OD.js";import{s as B}from"./general-leave-request-BfvT1p5t.js";import{r as U}from"./index-D23YZj_x.js";import{T as re}from"./index-PYuf3Agp.js";import{B as ue}from"./index-HYGEo9R5.js";import{B as de}from"./index-iR9PNDcN.js";import{I as O}from"./index-CSH6rE0O.js";import{d as A}from"./slot-_4yKMUwC.js";import{l as f}from"./event-strict-DgQLNDEV.js";import{c as ce,K as he,P as me,B as j,m as W,s as H}from"./Keys-Can65e7H.js";import{i as pe}from"./i18n-oG4QvOAt.js";import{d as fe}from"./CustomElementsScope-CyyomP-e.js";import{L as ve,a as ee}from"./ListItemTemplate-BG8P1BBq.js";import"./navigation-right-arrow-CHM4E1_C.js";import{n as be}from"./navigation-down-arrow-BzRoVXyK.js";import{c9 as ge,ca as ye,cb as we}from"./i18n-defaults-B3xVhWeJ.js";import{i as Te}from"./navigation-right-arrow-DL0_C4n6.js";import{d as te}from"./parameters-bundle.css-Ct2Rzfjz.js";import{D as Ie,p as P,m as Ne,w as _e,a as De,r as xe,i as Se}from"./DropIndicator-CGNu26vL.js";const qe={listItemPreContent:Ce,listItemContent:Ve,imageBegin:Pe,iconBegin:Ee};function k(a){const e={...qe,...a};return D("div",{children:[ve.call(this,e),Ae.call(this)]})}function Ce(){return m("div",{class:"ui5-li-tree-toggle-box",style:this.styles.preContent,children:this.showToggleButton&&m(Z,{part:"toggle-icon",class:"ui5-li-tree-toggle-icon",name:this.expanded?be:Te,showTooltip:!0,accessibleName:this.iconAccessibleName,onClick:this._toggleClick})})}function Ae(){if(this.expanded)return m("ul",{role:"group",id:`${this._id}-subtree`,class:"ui5-tree-li-subtree",children:m("slot",{})})}function Ve(){}function Pe(){}function Ee(){return this.icon?m(Z,{part:"icon",name:this.icon,class:"ui5-li-icon"}):m(X,{})}S("@ui5/webcomponents-theming","sap_horizon",async()=>J);S("@ui5/webcomponents","sap_horizon",async()=>te);const M=`.ui5-hidden-text{position:absolute;clip:rect(1px,1px,1px,1px);user-select:none;left:-1000px;top:-1000px;pointer-events:none;font-size:0}:host(:not([hidden])){display:block;position:relative}.ui5-li-tree-text-wrapper{flex:auto}.ui5-li-root-tree{padding-inline-start:0}:host(:not([level="1"])) .ui5-li-root{border-color:var(--sapList_AlternatingBackground)}:host([_toggle-button-end][selected]:not([level="1"])) .ui5-li-root{border-bottom:var(--ui5-v2-7-3-listitem-selected-border-bottom)}:host([_toggle-button-end]) .ui5-li-root-tree:hover,:host([_selection-mode]:not([_selection-mode="None"],[_selection-mode="Delete"],[active])) .ui5-li-root-tree:hover{cursor:pointer}:host([_toggle-button-end]:not([selected])) .ui5-li-root-tree:hover,:host(:not([_selection-mode="None"]):not([_selection-mode="Delete"]):not([active]):not([selected])) .ui5-li-root-tree:hover{background:var(--sapList_Hover_Background)}:host(:not([level="1"]):not([active]):not([selected])) .ui5-li-root-tree{background:var(--sapList_AlternatingBackground)}:host([_toggle-button-end]:not([level="1"])) .ui5-li-root-tree{background:var(--ui5-v2-7-3-listitem-background-color)}:host([_toggle-button-end][selected]:not([level="1"])) .ui5-li-root-tree{background:var(--sapList_SelectionBackgroundColor)}:host(:not([_selection-mode="None"]):not([_selection-mode="Delete"]):not([active])[selected]) .ui5-li-root-tree:hover{background-color:var(--sapList_Hover_SelectionBackground)}.ui5-li-tree-toggle-box{min-width:var(--_ui5-v2-7-3-tree-toggle-box-width);min-height:var(--_ui5-v2-7-3-tree-toggle-box-height);display:flex;align-items:center;justify-content:center;flex-shrink:0}.ui5-li-tree-toggle-icon{width:var(--_ui5-v2-7-3-tree-toggle-icon-size);height:var(--_ui5-v2-7-3-tree-toggle-icon-size);color:var(--sapContent_IconColor);cursor:pointer}:host([actionable]) .ui5-li-tree-toggle-icon{color:var(--sapButton_TextColor)}:host([active][actionable]) .ui5-li-tree-toggle-icon{color:var(--sapList_Active_TextColor)}:host{height:unset}.ui5-li-root{height:var(--_ui5-v2-7-3_list_item_base_height)}:host([selected]){background:unset}:host([selected]) .ui5-li-root{background:var(--sapList_SelectionBackgroundColor)}:host([has-border]){border-bottom:unset}:host([has-border]) .ui5-li-root{border-bottom:var(--ui5-v2-7-3-listitem-border-bottom)}:host(:not([focused])[selected][has-border]){border-bottom:unset}:host(:not([focused])[selected][has-border]) .ui5-li-root{border-bottom:var(--ui5-v2-7-3-listitem-selected-border-bottom)}:host([focused][selected]){border-bottom:unset}:host([focused][selected]) .ui5-li-root{border-bottom:var(--ui5-v2-7-3-listitem-focused-selected-border-bottom)}.ui5-tree-li-subtree{margin:0;padding:0;list-style:none}:host([focused][active]) .ui5-li-root-tree{background:var(--sapList_Active_Background)}:host([focused][active]) .ui5-li-root-tree .ui5-li-tree-toggle-icon,:host([focused][active]) .ui5-li-root-tree .ui5-li-title,:host([focused][active]) .ui5-li-root-tree .ui5-li-additional-text{color:var(--sapList_Active_TextColor)}
`;var h=function(a,e,t,n){var i=arguments.length,o=i<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(a,e,t,n);else for(var u=a.length-1;u>=0;u--)(l=a[u])&&(o=(i<3?l(o):i>3?l(e,t,o):l(e,t))||o);return i>3&&o&&Object.defineProperty(e,t,o),o},y;let c=y=class extends ee{constructor(){super(...arguments),this.level=1,this.showToggleButton=!1,this.expanded=!1,this.movable=!1,this.hasChildren=!1,this.additionalTextState="None",this.forcedSetsize=1,this.forcedPosinset=1,this._fixed=!1}onBeforeRendering(){this.showToggleButton=this.requiresToggleButton}get classes(){const e=super.classes;return e.main["ui5-li-root-tree"]=!0,e}get styles(){return{preContent:{"padding-inline-start":`calc(var(${fe("--_ui5-tree-indent-step")}) * ${this.effectiveLevel})`}}}get requiresToggleButton(){return this._fixed?!1:this.hasChildren||this.items.length>0}get effectiveLevel(){return this.level-1}get hasParent(){return this.level>1}get _toggleIconName(){return this.expanded?"navigation-down-arrow":"navigation-right-arrow"}get _ariaLabel(){return y.i18nBundle.getText(ge)}get _accInfo(){const e={role:"treeitem",ariaExpanded:this.showToggleButton?this.expanded:void 0,ariaLevel:this.level,posinset:this.forcedPosinset,setsize:this.forcedSetsize,ariaSelectedText:this.ariaSelectedText,listItemAriaLabel:this.accessibleName?void 0:this._ariaLabel,ariaOwns:this.expanded?`${this._id}-subtree`:void 0,ariaHaspopup:this.accessibilityAttributes.hasPopup};return{...super._accInfo,...e}}get isTreeItem(){return!0}toggle(){this.expanded=!this.expanded}_toggleClick(e){e.stopPropagation(),this.fireDecoratorEvent("toggle",{item:this})}async _onkeydown(e){await super._onkeydown(e),!this._fixed&&this.showToggleButton&&ce(e)&&(this.expanded?this.fireDecoratorEvent("step-in",{item:this}):this.fireDecoratorEvent("toggle",{item:this})),!this._fixed&&he(e)&&(this.expanded?this.fireDecoratorEvent("toggle",{item:this}):this.hasParent&&this.fireDecoratorEvent("step-out",{item:this}))}get iconAccessibleName(){return this.expanded?y.i18nBundle.getText(ye):y.i18nBundle.getText(we)}};h([d({type:Number})],c.prototype,"level",void 0);h([d()],c.prototype,"icon",void 0);h([d({type:Boolean})],c.prototype,"showToggleButton",void 0);h([d({type:Boolean})],c.prototype,"expanded",void 0);h([d({type:Boolean})],c.prototype,"movable",void 0);h([d({type:Boolean})],c.prototype,"indeterminate",void 0);h([d({type:Boolean})],c.prototype,"hasChildren",void 0);h([d()],c.prototype,"additionalTextState",void 0);h([d()],c.prototype,"accessibleName",void 0);h([d({type:Number,noAttribute:!0})],c.prototype,"forcedSetsize",void 0);h([d({type:Number,noAttribute:!0})],c.prototype,"forcedPosinset",void 0);h([d({type:Boolean})],c.prototype,"_fixed",void 0);h([A({type:HTMLElement,invalidateOnChildChange:{properties:!1,slots:["default"]},default:!0})],c.prototype,"items",void 0);h([pe("@ui5/webcomponents")],c,"i18nBundle",void 0);c=y=h([_({languageAware:!0,renderer:q,template:k,styles:[ee.styles,M]}),f("toggle",{bubbles:!0}),f("step-in",{bubbles:!0}),f("step-out",{bubbles:!0})],c);const V=c,Le={listItemContent:Me};function ke(a){const e={...Le,...a};return k.call(this,e)}function Me(){return D(X,{children:[m("div",{class:"ui5-li-text-wrapper",children:!!this._showTitle&&D("div",{part:"title",class:"ui5-li-title",children:[" ",this.text]})}),this.additionalText&&m("span",{part:"additional-text",class:"ui5-li-additional-text",children:this.additionalText})]})}var R=function(a,e,t,n){var i=arguments.length,o=i<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(a,e,t,n);else for(var u=a.length-1;u>=0;u--)(l=a[u])&&(o=(i<3?l(o):i>3?l(e,t,o):l(e,t))||o);return i>3&&o&&Object.defineProperty(e,t,o),o};let I=class extends V{get _showTitle(){var e;return(e=this.text)==null?void 0:e.length}};R([d()],I.prototype,"text",void 0);R([d()],I.prototype,"additionalText",void 0);I=R([_({renderer:q,tag:"ui5-tree-item",template:ke,styles:[V.styles,M]})],I);I.define();const Re={listItemContent:Be};function ze(a){const e={...Re,...a};return k.call(this,e)}function Be(){return m("div",{class:"ui5-li-tree-text-wrapper",children:m("slot",{name:"content",slot:"content"})})}var z=function(a,e,t,n){var i=arguments.length,o=i<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(a,e,t,n);else for(var u=a.length-1;u>=0;u--)(l=a[u])&&(o=(i<3?l(o):i>3?l(e,t,o):l(e,t))||o);return i>3&&o&&Object.defineProperty(e,t,o),o};let N=class extends V{constructor(){super(...arguments),this.hideSelectionElement=!1}async _onkeydown(e){var i;if(me(e)&&((i=this.content)!=null&&i.some(o=>o.contains(e.target)))){e.stopPropagation();return}const t=j(e)||W(e),n=this.matches(":focus");!t&&!n&&!H(e)||await super._onkeydown(e)}_onkeyup(e){const t=j(e)||W(e),n=this.matches(":focus");!t&&!n&&!H(e)||super._onkeyup(e)}get placeSelectionElementBefore(){return!this.hideSelectionElement&&super.placeSelectionElementBefore}get placeSelectionElementAfter(){return!this.hideSelectionElement&&super.placeSelectionElementAfter}};z([d({type:Boolean})],N.prototype,"hideSelectionElement",void 0);z([A()],N.prototype,"content",void 0);N=z([_({renderer:q,tag:"ui5-tree-item-custom",template:ze,styles:[V.styles,M]})],N);N.define();var E;(function(a){a.List="List",a.Menu="Menu",a.Tree="Tree",a.ListBox="ListBox"})(E||(E={}));const Ue=E;var Oe=function(a,e,t,n){var i=arguments.length,o=i<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(a,e,t,n);else for(var u=a.length-1;u>=0;u--)(l=a[u])&&(o=(i<3?l(o):i>3?l(e,t,o):l(e,t))||o);return i>3&&o&&Object.defineProperty(e,t,o),o};let x=class extends ie{getItems(e=!1){const t=this.getSlottedNodes("items"),n=[];return ne(t,n,e),n}getItemsForProcessing(){return this.getItems(!0)}};x=Oe([_("ui5-tree-list")],x);const ne=(a,e,t=!1)=>{a.forEach(n=>{e.push(n),(n.expanded||t)&&n.items&&ne(n.items,e,t)})};x.define();const je=x;function We(){return D(je,{class:"ui5-tree-root",selectionMode:this.selectionMode,headerText:this.headerText,footerText:this.footerText,noDataText:this.noDataText,accessibleRole:this._role,accessibleName:this.accessibleName,accessibleNameRef:this.accessibleNameRef,accessibleDescription:this.accessibleDescription,accessibleDescriptionRef:this.accessibleDescriptionRef,onDragEnter:this._ondragenter,onDragOver:this._ondragover,onDrop:this._ondrop,onDragLeave:this._ondragleave,onItemClick:this._onListItemClick,onItemDelete:this._onListItemDelete,onItemFocused:this._onListItemFocus,onSelectionChange:this._onListSelectionChange,onMouseOver:this._onListItemMouseOver,onMouseOut:this._onListItemMouseOut,"onui5-toggle":this._onListItemToggle,"onui5-step-in":this._onListItemStepIn,"onui5-step-out":this._onListItemStepOut,children:[this._hasHeader&&m("slot",{name:"header",slot:"header"}),m("slot",{}),m(Ie,{orientation:"Horizontal",ownerReference:this})]})}S("@ui5/webcomponents-theming","sap_horizon",async()=>J);S("@ui5/webcomponents","sap_horizon",async()=>te);const He=`.ui5-hidden-text{position:absolute;clip:rect(1px,1px,1px,1px);user-select:none;left:-1000px;top:-1000px;pointer-events:none;font-size:0}:host(:not([hidden])){display:block;width:100%}.ui5-tree-root{height:100%;width:100%}
`;var v=function(a,e,t,n){var i=arguments.length,o=i<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(a,e,t,n);else for(var u=a.length-1;u>=0;u--)(l=a[u])&&(o=(i<3?l(o):i>3?l(e,t,o):l(e,t))||o);return i>3&&o&&Object.defineProperty(e,t,o),o};let p=class extends le{constructor(){super(...arguments),this.selectionMode="None"}onEnterDOM(){P.subscribe(this)}onExitDOM(){P.unsubscribe(this)}onBeforeRendering(){this._prepareTreeItems()}onAfterRendering(){this.shadowRoot.querySelector("[ui5-tree-list]").onBeforeRendering()}get dropIndicatorDOM(){return this.shadowRoot.querySelector("[ui5-drop-indicator]")}get list(){return this.getDomRef()}get _role(){return Ue.Tree}get _hasHeader(){return!!this.header.length}_ondragenter(e){e.preventDefault()}_ondragleave(e){e.relatedTarget instanceof Node&&this.shadowRoot.contains(e.relatedTarget)||(this.dropIndicatorDOM.targetReference=null)}_ondragover(e){const t=P.getDraggedElement(),n=[];if(!(e.target instanceof HTMLElement)||!t)return;this.walk(u=>{n.push(u.shadowRoot.querySelector("li"))});const i=_e(n,e.clientY,De.Vertical);if(!i){this.dropIndicatorDOM.targetReference=null;return}if(i.element=i.element.getRootNode().host,t.contains(i.element))return;i.element===t&&(i.placements=i.placements.filter(u=>u!==xe.On));const{targetReference:o,placement:l}=Se(e,this,i,i.element);this.dropIndicatorDOM.targetReference=o,this.dropIndicatorDOM.placement=l}_ondrop(e){var t,n;!((t=this.dropIndicatorDOM)!=null&&t.targetReference)||!((n=this.dropIndicatorDOM)!=null&&n.placement)||(Ne(e,this,this.dropIndicatorDOM.targetReference,this.dropIndicatorDOM.placement),this.dropIndicatorDOM.targetReference=null)}_onListItemStepIn(e){const t=e.detail.item;if(t.items.length>0){const n=t.items[0],i=this._getListItemForTreeItem(n);i&&this.list.focusItem(i)}}_onListItemStepOut(e){const t=e.detail.item;if(t.parentElement!==this){const n=t.parentElement,i=this._getListItemForTreeItem(n);i&&this.list.focusItem(i)}}_onListItemToggle(e){const t=e.detail.item;!this.fireDecoratorEvent("item-toggle",{item:t})||t.toggle()}_onListItemClick(e){const t=e.detail.item;this.fireDecoratorEvent("item-click",{item:t})||e.preventDefault()}_onListItemDelete(e){const t=e.detail.item;this.fireDecoratorEvent("item-delete",{item:t})}_onListItemFocus(e){const t=e.detail.item;this.fireDecoratorEvent("item-focus",{item:t})}_onListItemMouseOver(e){const t=e.target;this._isInstanceOfTreeItemBase(t)&&this.fireDecoratorEvent("item-mouseover",{item:t})}_onListItemMouseOut(e){const t=e.target;this._isInstanceOfTreeItemBase(t)&&this.fireDecoratorEvent("item-mouseout",{item:t})}_onListSelectionChange(e){const t=e.detail.previouslySelectedItems,n=e.detail.selectedItems,i=e.detail.targetItem;t.forEach(o=>{o.selected=!1}),n.forEach(o=>{o.selected=!0}),this.fireDecoratorEvent("selection-change",{previouslySelectedItems:t,selectedItems:n,targetItem:i})}_prepareTreeItems(){this.walk((e,t,n)=>{const i=e.parentNode,o=i&&i.children.length||this.items.length;e.setAttribute("level",t.toString()),e.forcedSetsize=o,e.forcedPosinset=n+1})}_getListItemForTreeItem(e){return this.getItems().find(t=>t===e)}getItems(){return this.list.getItems()}focusItemByIndex(e){const t=this.getItems()[e];t&&this.list.focusItem(t)}walk(e){oe(this,1,e)}_isInstanceOfTreeItemBase(e){return"isTreeItem"in e}};v([d()],p.prototype,"selectionMode",void 0);v([d()],p.prototype,"noDataText",void 0);v([d()],p.prototype,"headerText",void 0);v([d()],p.prototype,"footerText",void 0);v([d()],p.prototype,"accessibleName",void 0);v([d()],p.prototype,"accessibleNameRef",void 0);v([d()],p.prototype,"accessibleDescription",void 0);v([d()],p.prototype,"accessibleDescriptionRef",void 0);v([A({type:HTMLElement,invalidateOnChildChange:!0,default:!0})],p.prototype,"items",void 0);v([A()],p.prototype,"header",void 0);p=v([_({tag:"ui5-tree",renderer:q,styles:He,template:We}),f("item-toggle",{bubbles:!0,cancelable:!0}),f("item-mouseover",{bubbles:!0}),f("item-mouseout",{bubbles:!0}),f("item-click",{bubbles:!0,cancelable:!0}),f("item-delete",{bubbles:!0}),f("item-focus",{bubbles:!0}),f("selection-change",{bubbles:!0}),f("move",{bubbles:!0}),f("move-over",{bubbles:!0,cancelable:!0})],p);const oe=(a,e,t)=>{a.items.forEach((n,i)=>{t(n,e,i),n.items.length>0&&oe(n,e+1,t)})};p.define();const b=L("ui5-tree",["accessibleDescription","accessibleDescriptionRef","accessibleName","accessibleNameRef","footerText","headerText","noDataText","selectionMode"],[],["header"],["item-click","item-delete","item-mouseout","item-mouseover","item-toggle","selection-change"]);b.displayName="Tree";try{b.displayName="Tree",b.__docgenInfo={description:`The \`Tree\` component provides a tree structure for displaying data in a hierarchy.
...
**Note:** Available since [v1.8.0](https://github.com/SAP/ui5-webcomponents/releases/tag/v1.8.0) of **@ui5/webcomponents**.`,name:"accessibleName",required:!1,type:{name:"string"}},additionalText:{defaultValue:{value:"undefined"},description:"Defines the `additionalText`, displayed in the end of the tree item.",name:"additionalText",required:!1,type:{name:"string"}},additionalTextState:{defaultValue:{value:'"None"'},description:'Defines the state of the `additionalText`.\n\nAvailable options are: `"None"` (by default), `"Positive"`, `"Critical"`, `"Information"` and `"Negative"`.',name:"additionalTextState",required:!1,type:{name:"enum",value:[{value:'"Information"'},{value:'"None"'},{value:'"Positive"'},{value:'"Negative"'},{value:'"Critical"'},{value:'"None"'},{value:'"Positive"'},{value:'"Critical"'},{value:'"Negative"'},{value:'"Information"'}]}},expanded:{defaultValue:{value:"false"},description:"Defines whether the tree list item will show a collapse or expand icon inside its toggle button.",name:"expanded",required:!1,type:{name:"boolean"}},hasChildren:{defaultValue:{value:"false"},description:`Defines whether the tree node has children, even if currently no other tree nodes are slotted inside.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const g=L("ui5-tree-item-custom",["accessibilityAttributes","accessibleName","additionalTextState","highlight","icon","tooltip","type"],["expanded","hasChildren","hideSelectionElement","indeterminate","movable","navigated","selected"],["content","deleteButton"],["detail-click"]);g.displayName="TreeItemCustom";try{g.displayName="TreeItemCustom",g.__docgenInfo={description:`The \`TreeItemCustom\` represents a node in a tree structure, shown as a \`List\`.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const Fe="download-from-cloud",$e="M493.037 211.587q17.965 22.955 17.965 55.89 0 17.965-6.986 30.94-2.995 7.985-17.965 28.944-5.989 6.986-10.48 9.98t-12.475 5.988q-18.963 7.985-33.934 7.985h-13.973v-31.938h13.973q6.986 0 21.957-4.99 4.99-1.996 6.487-2.994t4.491-3.992q3.993-4.99 6.987-9.98t4.99-9.981l1.996-3.993q2.994-5.988 2.994-15.968 0-23.954-10.978-35.93-8.983-11.977-29.942-17.965l-40.92-10.979 21.957-35.93q3.992-6.986 3.992-17.964 0-24.952-16.966-40.92-15.97-15.97-41.919-15.97-20.959 0-35.93 11.977l-32.935 28.944-16.967-39.922q-12.975-27.946-36.928-43.915-22.955-16.966-57.887-16.966-12.974 0-31.937 7.984-16.967 7.984-33.934 22.955-10.979 9.98-20.96 30.94-6.985 13.972-6.985 34.932 0 18.963 8.982 33.933l21.957 36.928-41.918 9.98q-21.957 5.989-32.936 19.962l-.998.998v.998q-12.974 14.97-12.974 35.93 0 8.982 4.99 18.963.998 1.996 4.99 7.984t16.967 16.967q1.996 1.996 12.975 4.99t39.922 2.994v31.938q-22.955 0-42.917-2.994t-30.94-12.975q-23.952-20.959-30.939-35.93T0 267.478q0-34.932 20.96-57.887 18.962-22.956 49.902-30.94-12.975-21.957-12.975-49.902 0-28.944 9.98-48.905 10.979-23.953 27.946-40.92 17.965-16.967 41.918-27.945T183.641 0q44.913 0 75.852 21.957 31.938 21.957 47.907 57.887 22.955-19.961 56.888-19.961 38.924 0 63.876 24.951 26.947 25.95 26.947 63.876 0 18.963-8.982 33.933 27.945 6.987 46.908 28.944zM279.454 502.019Q269.474 512 256.5 512t-21.957-9.98L132.74 401.215q-5.989-5.988-5.989-11.976t5.989-10.979q4.99-4.99 10.978-4.99t10.979 4.99l84.834 84.835V192.624q0-15.969 15.969-15.969t15.969 15.969v272.468l86.83-86.83q5.988-5.99 10.979-5.99 5.988 0 11.976 5.99 5.989 4.99 5.989 10.978t-5.989 11.976z",Ge=!1,Ye="SAP-icons-v4",Ke="@ui5/webcomponents-icons";C(Fe,{pathData:$e,ltr:Ge,collection:Ye,packageName:Ke});const Qe="download-from-cloud",Xe="M486 288q11 0 18.5 7.5T512 314q0 27-10 51.5t-27.5 43-41 29T382 448H109q-22 0-42-9t-35-24-23.5-35.5T0 336t8.5-43 23-35 34-24 41.5-9q4-25 16-47.5t29-40 39.5-28.5T239 96h4q10-1 17.5 6t8.5 17v2q0 10-7.5 17.5T237 148q-16 1-30.5 10t-26 22-18 29-6.5 32q0 18-7.5 26.5T130 276h-21q-24 0-41 17.5T51 336q0 26 17 43.5t41 17.5h273q33 0 56-24.5t23-58.5q0-11 7-18.5t18-7.5zm-222-52q-8-8-8-18 0-11 7.5-18.5T282 192t18 7l33 34V90q0-11 7-18.5t18-7.5 18.5 7.5T384 90v143l33-34q7-7 18-7t18.5 7.5T461 218q0 10-8 18l-76 76q-8 8-19 8-10 0-18-8z",Je=!1,Ze="SAP-icons-v5",et="@ui5/webcomponents-icons";C(Qe,{pathData:Xe,ltr:Je,collection:Ze,packageName:et});const tt="download-from-cloud",nt="paste",ot="M192 224q0-14 9-23t23-9h224q13 0 22.5 9t9.5 23v256q0 13-9.5 22.5T448 512H224q-14 0-23-9.5t-9-22.5V224zm32 256h224V224H224v256zM32 96q0-14 9.5-23T65 64h65q11-28 38-32 8-14 23-23t33-9q17 0 32 9t23 23q27 4 38 32h67q13 0 22 9t9 23v64h-31V96h-68q-5 12-12.5 22T281 128H166q-15 0-22.5-10T131 96H65v384h95v32H65q-14 0-23.5-9.5T32 480V96zm143 0h96q7 0 11.5-5t4.5-11q0-16-16-16h-15q0-14-9.5-23T224 32q-14 0-23 9t-9 23h-17q-6 0-11 4.5T159 80q0 6 5 11t11 5zm97 224h128q16 0 16 16 0 6-4.5 11t-11.5 5H272q-6 0-11-5t-5-11q0-7 5-11.5t11-4.5zm0 63h128q16 0 16 16 0 6-4.5 11t-11.5 5H272q-6 0-11-5t-5-11q0-7 5-11.5t11-4.5z",it=!1,at="SAP-icons-v4",st="@ui5/webcomponents-icons";C(nt,{pathData:ot,ltr:it,collection:at,packageName:st});const lt="paste",rt="M243 461h186V243H243v218zM186 51q-7 0-7 7v44q0 7 7 7h76q7 0 7-7V58q0-7-7-7h-76zm-84 461H90q-24 0-41-17t-17-41V122q0-24 17-41t41-17h38v-6q0-24 17-41t41-17h76q24 0 41 17t17 41v6h38q24 0 41 17t17 41v12q0 11-7.5 18.5T390 160t-18-7.5-7-18.5v-12q0-7-7-7h-39q-5 20-20.5 32.5T262 160h-76q-21 0-36.5-12.5T129 115H90q-7 0-7 7v332q0 7 7 7h12q11 0 18.5 7t7.5 18-7.5 18.5T102 512zm352 0H218q-11 0-18.5-7.5T192 486V218q0-11 7.5-18.5T218 192h236q11 0 18.5 7.5T480 218v268q0 11-7.5 18.5T454 512zm-96-179h-44q-11 0-18.5-7.5T288 307t7.5-18 18.5-7h44q11 0 18.5 7t7.5 18-7.5 18.5T358 333zm0 83h-44q-11 0-18.5-7.5T288 390t7.5-18 18.5-7h44q11 0 18.5 7t7.5 18-7.5 18.5T358 416z",ut=!1,dt="SAP-icons-v5",ct="@ui5/webcomponents-icons";C(lt,{pathData:rt,ltr:ut,collection:dt,packageName:ct});const ht="paste",mt={title:"Data Display / Tree",component:b,argTypes:{children:{control:{disable:!0}},header:{control:{disable:!0}}},args:{selectionMode:ae.None},tags:["package:@ui5/webcomponents"]},w={render:a=>s.jsxs(b,{...a,children:[s.jsx(r,{expanded:!0,text:"Tree 1",icon:ht,selected:!0,children:s.jsxs(r,{expanded:!0,text:"Tree 1.1",children:[s.jsx(r,{text:"Tree 1.1.1"}),s.jsx(r,{text:"Tree 1.1.2"})]})}),s.jsxs(r,{text:"Tree 2",icon:se,children:[s.jsxs(r,{text:"Tree 2.1",children:[s.jsx(r,{text:"Tree 2.1.1"}),s.jsxs(r,{text:"Tree 2.1.2",children:[s.jsx(r,{text:"Tree 2.1.2.1"}),s.jsx(r,{text:"Tree 2.1.2.2"}),s.jsx(r,{text:"Tree 2.1.2.3"}),s.jsx(r,{text:"Tree 2.1.2.5"})]})]}),s.jsx(r,{text:"Tree 2.2"})]}),s.jsx(r,{text:"Tree 3 (no icon)"}),s.jsx(g,{content:s.jsxs("div",{style:{display:"flex",alignItems:"center"},children:[s.jsx(O,{name:B,style:{marginInlineEnd:"2rem"}}),s.jsx(re,{children:"I'm a fully customizable TreeItemCustom!"}),s.jsx(de,{children:"Btn"}),s.jsx(O,{name:B,style:{marginInlineStart:"2rem"}})]})})]})},T={render:a=>{const[e,t]=U.useState(null),[n,i]=U.useState(!1),o=l=>{l.detail.item.dataset.id==="lazychildren"&&!e&&(l.preventDefault(),i(!0),setTimeout(()=>{i(!1),t(s.jsxs(s.Fragment,{children:[s.jsx(r,{text:"Tree 3.1"}),s.jsx(r,{text:"Tree 3.2"})]})),l.detail.item.toggle()},3e3))};return s.jsx(ue,{active:n,style:{width:"100%"},children:s.jsxs(b,{...a,onItemToggle:o,children:[s.jsxs(r,{text:"Has pre-loaded children",children:[s.jsx(r,{text:"Tree 1.1"}),s.jsx(r,{text:"Tree 1.2"})]}),s.jsx(r,{text:"Has no children"}),s.jsx(r,{text:"Has children but not yet loaded",hasChildren:!0,icon:tt,"data-id":"lazychildren",children:e})]})})}};var F,$,G;w.parameters={...w.parameters,docs:{...(F=w.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: args => {
    return <Tree {...args}>
...
}`,...(G=($=w.parameters)==null?void 0:$.docs)==null?void 0:G.source}}};var Y,K,Q;T.parameters={...T.parameters,docs:{...(Y=T.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  render: args => {
...
}`,...(Q=(K=T.parameters)==null?void 0:K.docs)==null?void 0:Q.source}}};const pt=["Default","LazyLoading"],Wt=Object.freeze(Object.defineProperty({__proto__:null,Default:w,LazyLoading:T,__namedExportsOrder:pt,default:mt},Symbol.toStringTag,{value:"Module"}));export{Wt as C,w as D,T as L,r as T,g as a};
