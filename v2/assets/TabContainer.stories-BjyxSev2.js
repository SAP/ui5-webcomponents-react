import{j as e}from"./jsx-runtime-DEdD30eg.js";import{a as F,b as T,c as M,T as n}from"./index-DZeKenll.js";import{p as g,q as i,v as w,a as h,s as P,m as E,y as H,S as U,X as S,w as A}from"./withWebComponent-v3aPz19k.js";import{f as R}from"./Icon-Bq3V4Dpj.js";import{a as B}from"./add-DSZdD1hf.js";import{e as G}from"./employee-ZWYszjKL.js";import{m as V}from"./menu-D45EmAHV.js";import{s as X}from"./settings-DVj09KCj.js";import{o as x}from"./class-map-CH6JYcvP.js";import{s as v}from"./style-map-D4Rgk784.js";import{s as W}from"./parameters-bundle.css-R51uC6BG.js";function J(t,a,o){return g`<div id="${i(this._id)}" role="separator" class="${x(this.classes.root)}" .realTabReference="${i(this)}"></div>`}function K(t,a,o){return o?g`<${w("ui5-li-custom",a,o)} id="${i(this._id)}" role="separator" class="${x(this.classes.root)}" disabled style="${v(this._forcedStyleInOverflow)}" .realTabReference="${i(this)}"></${w("ui5-li-custom",a,o)}>`:g`<ui5-li-custom id="${i(this._id)}" role="separator" class="${x(this.classes.root)}" disabled style="${v(this._forcedStyleInOverflow)}" .realTabReference="${i(this)}"></ui5-li-custom>`}h("@ui5/webcomponents-theming","sap_horizon",async()=>P);h("@ui5/webcomponents","sap_horizon",async()=>W);const Q={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInStrip.css.ts",content:`div.ui5-tc__separator{position:relative;width:.5625rem}div.ui5-tc__separator:before{content:" ";position:absolute;width:.0625rem;left:.25rem;top:.5rem;bottom:.5rem;background:var(--sapGroup_TitleBorderColor)}
