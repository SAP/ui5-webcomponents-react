import{j as e}from"./jsx-runtime-CLpGMVip.js";import{i as g}from"./Person-Bk5r7PMP.js";import{a as S}from"./add-BIxWy81c.js";import{s as _}from"./search-CGNjvtGZ.js";import{S as w}from"./index-BpUo3JAN.js";import{s as h,m as v,S as I,w as x}from"./withWebComponent-LqdGbSZi.js";import{l as C}from"./event-strict-DgQLNDEV.js";import{A as D}from"./index-DM-FMAOd.js";import{L as p}from"./index-B6lNmb2R.js";import{I as B}from"./index-vjqslgt_.js";import{I as N}from"./index-BkAzdWG7.js";var u=function(o,t,a,s){var m=arguments.length,n=m<3?t:s===null?s=Object.getOwnPropertyDescriptor(t,a):s,c;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,t,a,s);else for(var d=o.length-1;d>=0;d--)(c=o[d])&&(n=(m<3?c(n):m>3?c(t,a,n):c(t,a))||n);return m>3&&n&&Object.defineProperty(t,a,n),n};let i=class extends I{get stableDomRef(){return this.getAttribute("stable-dom-ref")||`${this._id}-stable-dom-ref`}fireClickEvent(t){return this.fireDecoratorEvent("click",{targetRef:t.target})}};u([h()],i.prototype,"icon",void 0);u([h()],i.prototype,"text",void 0);u([h()],i.prototype,"count",void 0);i=u([v("ui5-shellbar-item"),C("click",{bubbles:!0,cancelable:!0})],i);i.define();const r=x("ui5-shellbar-item",["count","icon","text"],[],[],["click"]);r.displayName="ShellBarItem";try{r.displayName="ShellBarItem",r.__docgenInfo={description:`The \`ShellBarItem\` represents a custom item, that
