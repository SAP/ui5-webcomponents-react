import{j as i}from"./jsx-runtime-BjG_zV1W.js";import{r as R}from"./index-B7gF9TUu.js";import{P as M}from"./index-BnqhWvMZ.js";import{r as D,c as P,a as x,T as O}from"./index-1B7D4rRF.js";import{j as d,s as u,m as _,w as T,I as z}from"./withWebComponent-CT6sGXpP.js";import{d as k}from"./slot-_4yKMUwC.js";import{l as N}from"./event-strict-DgQLNDEV.js";import{S as B}from"./Select-C0sOWMyg.js";import{O as L}from"./Option-528FNDxl.js";function H(){return d(B,{class:"ui5-tb-item",style:this.styles,"data-ui5-external-action-item-id":this._id,valueState:this.valueState,disabled:this.disabled,accessibleName:this.accessibleName,accessibleNameRef:this.accessibleNameRef,children:this.options.map((t,e)=>d(L,{selected:t.selected,"data-ui5-external-action-item-index":e,children:t.textContent}))})}function G(){return d(B,{class:"ui5-tb-popover-item","data-ui5-external-action-item-id":this._id,valueState:this.valueState,disabled:this.disabled,accessibleName:this.accessibleName,accessibleNameRef:this.accessibleNameRef,children:this.options.map((t,e)=>d(L,{selected:t.selected,"data-ui5-external-action-item-index":e,children:t.textContent}))})}var h=function(t,e,n,a){var l=arguments.length,o=l<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,n):a,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,n,a);else for(var s=t.length-1;s>=0;s--)(r=t[s])&&(o=(l<3?r(o):l>3?r(e,n,o):r(e,n))||o);return l>3&&o&&Object.defineProperty(e,n,o),o};let c=class extends P{static get toolbarTemplate(){return H}static get toolbarPopoverTemplate(){return G}get subscribedEvents(){const e=new Map;return e.set("click",{preventClosing:!0}),e.set("ui5-change",{preventClosing:!1}),e.set("ui5-open",{preventClosing:!0}),e.set("ui5-close",{preventClosing:!0}),e}constructor(){super(),this.valueState="None",this.disabled=!1,this._onEvent=this._onEventHandler.bind(this)}onEnterDOM(){this.attachEventListeners()}onExitDOM(){this.detachEventListeners()}attachEventListeners(){[...this.subscribedEvents.keys()].forEach(e=>{this.addEventListener(e,this._onEvent)})}detachEventListeners(){[...this.subscribedEvents.keys()].forEach(e=>{this.removeEventListener(e,this._onEvent)})}_onEventHandler(e){if(e.type==="ui5-change"){const n=e.detail.selectedOption,a=Number(n==null?void 0:n.getAttribute("data-ui5-external-action-item-index"));this.options.forEach((l,o)=>{o===a?l.setAttribute("selected",""):l.removeAttribute("selected")})}}get styles(){return{width:this.width}}};h([u()],c.prototype,"width",void 0);h([k({default:!0,type:HTMLElement,invalidateOnChildChange:!0})],c.prototype,"options",void 0);h([u()],c.prototype,"valueState",void 0);h([u({type:Boolean})],c.prototype,"disabled",void 0);h([u()],c.prototype,"accessibleName",void 0);h([u()],c.prototype,"accessibleNameRef",void 0);c=h([_({tag:"ui5-toolbar-select"}),N("change",{bubbles:!0,cancelable:!0}),N("open",{bubbles:!0}),N("close")],c);D(c);c.define();const m=T("ui5-toolbar-select",["accessibleName","accessibleNameRef","overflowPriority","valueState","width"],["disabled","preventOverflowClosing"],[],["change","close","open"]);m.displayName="ToolbarSelect";try{m.displayName="ToolbarSelect",m.__docgenInfo={description:'The `ToolbarSelect` component is used to create a toolbar drop-down list.\nThe items inside the `ToolbarSelect` define the available options by using the `ToolbarSelectOption` component.\n\n\n\n`import "@ui5/webcomponents/dist/ToolbarSelectOption.js";` (comes with `ToolbarSelect`)\n\n__Note__: This is a UI5 Web Component! [Repository](https://github.com/SAP/ui5-webcomponents) | [Documentation](https://sap.github.io/ui5-webcomponents/)',displayName:"ToolbarSelect",props:{children:{defaultValue:null,description:`Defines the component options.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function V(){return d("div",{class:"ui5-tb-spacer ui5-tb-item",style:this.styles,role:"separator","data-ui5-external-action-item-id":this._id})}var $=function(t,e,n,a){var l=arguments.length,o=l<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,n):a,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,n,a);else for(var s=t.length-1;s>=0;s--)(r=t[s])&&(o=(l<3?r(o):l>3?r(e,n,o):r(e,n))||o);return l>3&&o&&Object.defineProperty(e,n,o),o};let S=class extends P{get styles(){return this.width?{width:this.width}:{flex:"auto"}}get ignoreSpace(){return this.width===""||this.width===void 0||this.width==="auto"}get hasFlexibleWidth(){return this.width===""||this.width===void 0||this.width==="auto"}static get toolbarTemplate(){return V}static get toolbarPopoverTemplate(){return V}get isInteractive(){return!1}};$([u()],S.prototype,"width",void 0);S=$([_({tag:"ui5-toolbar-spacer"})],S);D(S);S.define();const v=T("ui5-toolbar-spacer",["overflowPriority","width"],["preventOverflowClosing"],[],[]);v.displayName="ToolbarSpacer";try{v.displayName="ToolbarSpacer",v.__docgenInfo={description:`The \`ToolbarSpacer\` is an element, used for taking needed space for toolbar items to take 100% width.
It takes no space in calculating toolbar items width.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var C;(function(t){t.Start="Start",t.End="End"})(C||(C={}));const Q=C,X={title:"Layouts & Floorplans / Toolbar",component:x,argTypes:{children:{control:{disable:!0}}},args:{alignContent:Q.Start},tags:["package:@ui5/webcomponents"]},b={render:t=>i.jsxs(x,{...t,children:[i.jsx(O,{text:"Button 1"}),i.jsxs(m,{children:[i.jsx(p,{children:"Option 1"}),i.jsx(p,{children:"Option 2"}),i.jsx(p,{children:"Option 3"})]}),i.jsx(f,{}),i.jsx(v,{}),i.jsx(f,{}),i.jsx(O,{text:"Button 2"}),i.jsxs(m,{children:[i.jsx(p,{children:"Option 1"}),i.jsx(p,{children:"Option 2"}),i.jsx(p,{children:"Option 3"})]})]})},w={name:"Opening Popovers via ToolbarButton",render(t){const[e,n]=R.useState(!1),a=R.useRef(null);return i.jsxs(i.Fragment,{children:[i.jsx(x,{...t,children:i.jsx(O,{onClick:l=>{const{targetRef:o}=l.detail;a.current&&(a.current.opener=o,n(!0))},text:"Open Popover"})}),i.jsx(M,{open:e,ref:a,onClose:()=>{n(!1)},children:"Content"})]})}};var I,E,j;b.parameters={...b.parameters,docs:{...(I=b.parameters)==null?void 0:I.docs,source:{originalSource:`{
...
}`,...(F=(U=w.parameters)==null?void 0:U.docs)==null?void 0:F.source}}};const Y=["Default","OpenPopover"],de=Object.freeze(Object.defineProperty({__proto__:null,Default:b,OpenPopover:w,__namedExportsOrder:Y,default:X},Symbol.toStringTag,{value:"Module"}));export{de as C,b as D,w as O,m as T,p as a,f as b,v as c};
