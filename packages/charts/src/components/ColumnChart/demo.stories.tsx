...
storiesOf('Charts | ColumnChart', module)
  .add('Default', () => <ColumnChart width={700} height={500} labels={labels} datasets={datasets} />)
  .add('stacked', () => (
    <ColumnChart
      labels={labels}
      datasets={datasets}
  ...
  .add('with Formatter', () => (
    <ColumnChart labels={labels} datasets={datasets} valueAxisFormatter={(d) => `${d}USD`} />
  ))
  .add('with growth line', () => <ColumnChart labels={labels} datasets={dataset2} options={growthLineOptions} />)
