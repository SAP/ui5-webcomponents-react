...
interface CheckBoxAttributes {
  ...
  /**
   * Determines whether the `CheckBox` is in display only state. When set to `true`, the `CheckBox` is not interactive, not editable, not focusable and not in the tab chain. This setting is used for forms in review mode. When the property `disabled` is set to `true` this property has no effect.
   * @default false
   */
  displayOnly?: boolean;
