      ...
      return (
        <List>
          <NotificationListItem
            ...
            heading="New order (#2526) with multiple NotificationAction buttons and close button"
            actions={
              <>
          ...
          <NotificationListItem
            ...
            footnotes={<Label>3 Days</Label>}
            heading="New order (#2527) with single NotificationAction and close button"
            showClose
          ...
          <NotificationListItem
            ...
            avatar={
              <Avatar size={AvatarSize.XS}>
                <img src="https://sap.github.io/ui5-webcomponents/assets/images/avatars/man_avatar_1.png" />
              </Avatar>
            }
            footnotes={
              <>
