...
| ------------------ | ----------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **closePicker**    |                                                                                                                   | Closes the picker.                                                                                                                                         |
| **formatValue**    | **oDate**<ul><li>type: object</li><li>description: A Java Script date object to be formatted as string</li></ul>  | Formats a Java Script date object into a string representing a locale date according to the <code>formatPattern</code> property of the DatePicker instance |
| **isInValidRange** | **value**<ul><li>type: object</li></ul>                                                                           | Checks if a date is in range between minimum and maximum date.                                                                                             |
| **isOpen**         |                                                                                                                   | Checks if the picker is open.                                                                                                                              |
| **isValid**        | **value**<ul><li>type: string</li><li>description: A value to be tested against the current date format</li></ul> | Checks if a value is valid against the current date format of the DatePicker.                                                                              |
| **openPicker**     |                                                                                                                   | Opens the picker.                                                                                                                                          |
