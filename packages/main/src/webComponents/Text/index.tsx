...
// todo: add story
// todo: remove aliases after Text React component has been removed
export { Text as UI5WCText };
export type { TextDomRef as UI5WcTextDomRef, TextPropTypes as UI5WcTextPropTypes };
