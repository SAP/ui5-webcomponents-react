...
/**
 * The `CalendarLegend` component is designed for use within the `Calendar` to display a legend. Each `CalendarLegendItem` represents a unique date type, specifying its visual style and a corresponding textual label.
 *
