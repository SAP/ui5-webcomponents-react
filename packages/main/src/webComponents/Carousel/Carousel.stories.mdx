...
>
  <h3>Usage</h3>
  <b>When to use:</b> <br />
  The items you want to display are very different from each other. - You want to display the items one after the other.{' '}
  <br />
  <b>When not to use:</b>
  <br />
  The items you want to display need to be visible at the same time. - The items you want to display are uniform and very
  similar For the <code>Carousel</code>
</div>
