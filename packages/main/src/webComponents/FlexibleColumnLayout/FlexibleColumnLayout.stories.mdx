...
import { sapUiContentPadding } from '@ui5/webcomponents-react-base';
...
import { ToolbarSpacer } from '../../enums/ToolbarSpacer';
import { Avatar } from '../Avatar';
import { Button } from '../Button';
import { Card } from '../Card';
import { FCLLayout } from '../FCLLayout';
...
This component exposes public `readonly` properties. You can invoke them directly on the instance of the component, e.g. by using React Refs.

| Name                   | Description                                                                                                                                                                                                                                            |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **columnLayout**       | Returns the current column layout, based on both the `layout` property and the screen size. For example: `["67%", "33%", 0], ["100%", 0, 0], ["25%", "50%", "25%"]`, etc, where the numbers represents the width of the start, middle and end columns. |
| **endColumnVisible**   | Returns if the `end` column is visible.                                                                                                                                                                                                                |
| **midColumnVisible**   | Returns if the `middle` column is visible.                                                                                                                                                                                                             |
| **startColumnVisible** | Returns if the `start` column is visible.                                                                                                                                                                                                              |
| **visibleColumns**     | Returns the number of currently visible columns.                                                                                                                                                                                                       |
...
<Canvas>
  <Story name="with different columns">
    {() => {
      const movieData = [
        {
          movie: 'Shanghai',
        ...
        <FlexibleColumnLayout
          ...
          startColumn={
            <>
              <ShellBar
                logo={
                  <img src="https://raw.githubusercontent.com/SAP/ui5-webcomponents-react/master/assets/Logo.png" />
                }
