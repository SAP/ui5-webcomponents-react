...
export interface DialogPropTypes extends WithWebComponentPropTypes {
  ...
  headerText?: string;
  /**
   * Determines whether the <code>ui5-dialog</code> should be stretched to fullscreen. <br><br> <b>Note:</b> The <code>ui5-dialog</code> will be stretched to approximately 90% of the viewport.
   */
  stretch?: boolean;
  /**
