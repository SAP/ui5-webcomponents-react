...
| **open**       | **preventInitialFocus**<ul><li>type: boolean</li><li>description: prevents applying the focus inside the popup</li></ul> | Shows the block layer (for modal popups only) and sets the correct z-index for the purpose of popup stacking              |
