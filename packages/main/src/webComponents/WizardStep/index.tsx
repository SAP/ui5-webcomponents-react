...
/**
 *  A component that represents a logical step as part of the <code>Wizard</code>. It is meant to aggregate arbitrary HTML elements that forms the content of a single step.
 *
