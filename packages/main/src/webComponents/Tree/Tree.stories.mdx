...
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| **walk** | **callback**<ul><li>type: function</li><li>description: function to execute on each node of the tree with 2 arguments: the node and the level</li></ul> | Perform Depth-First-Search walk on the tree and run a callback on each node |
