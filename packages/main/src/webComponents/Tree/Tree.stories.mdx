...
import TreeItemCustomDescription from '../TreeItemCustom/TreeItemCustomDescription.md';
...
<ArgsTableWithNote
  ...
  noteText={`The props in the table below are part of the "TreeItem" component and to of not the "Tree".`}
/>
