...
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| **openBy** | **opener**<ul><li>type: HTMLElement</li><li>description: the element that the popover is opened by</li></ul><br/> **preventInitialFocus**<ul><li>type: boolean</li><li>description: prevents applying the focus inside the popover</li></ul> | Opens the popover.                             |
| **close**  |                                                                                                                                                                                                                                              | Closes the popover/dialog.                     |
| **open**   | **opener**<ul><li>type: HTMLElement</li><li>description: the element that the popover is opened by</li></ul>                                                                                                                                 | Opens popover on desktop and dialog on mobile. |
