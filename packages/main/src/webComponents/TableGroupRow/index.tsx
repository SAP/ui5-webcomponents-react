...
export interface TableGroupRowPropTypes extends WithWebComponentPropTypes {
  /**
 ...
 */
const TableGroupRow: FC<TableGroupRowPropTypes> = withWebComponent<TableGroupRowPropTypes>(
  'ui5-table-group-row',
  [],
  [],
  [],
