...
/**
 *  The <code>SideNavigationItem</code> is used within <code>SideNavigation</code> only. Via the <code>SideNavigationItem</code> you control the content of the <code>SideNavigation</code>.
 *
