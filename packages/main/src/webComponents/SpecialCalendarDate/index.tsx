...
/**
 * The `SpecialCalendarDate` component defines a special calendar date to be used inside `Calendar`, which is visually distinguished from the rest of the dates.
 *
 * @abstract
