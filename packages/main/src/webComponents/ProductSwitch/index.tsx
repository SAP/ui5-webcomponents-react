...
/**
 * The <code>ProductSwitch</code> is an SAP Fiori specific web component that is used in <code>ShellBar</code> and allows
 the user to easily switch between products. <br /><br />
