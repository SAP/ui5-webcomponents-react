...
import Description from './ProductSwitchDescription.md';
...
import ProductSwitchItemDescription from '../ProductSwitchItem/ProductSwitchItemDescription.md';
