...
/**
 * Each `CalendarLegendItem` represents a legend item, displaying a color with a label. The color is determined by the `type` property and the label by the `text` property. If a `SpecialCalendarDate` is used within the `Calendar` and a type is set, clicking on a `CalendarLegendItem` with the same type will emphasize the respective date(s) in the calendar.
 *
 * ### Usage
 *
