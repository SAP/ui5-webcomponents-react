  ...
  <Story name="Default">
    {(args) => {
      ...
      const onButtonClick = (e) => {
        popoverRef.current.openPopover(e.target);
      };
      return (
        <>
...
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ |
| **openPopover** | <dl><dt className="methodText">**opener**</dt><dd className="methodText">the element that the popover is opened by</dd><dd><code>HTMLElement</code></dd></dl> | Opens the popover. |
