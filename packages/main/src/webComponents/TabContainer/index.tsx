...
interface TabContainerDomRef extends Required<TabContainerAttributes>, Ui5DomRef {
   ...
   * ```
   *
   * Calling `allItems` on this TabContainer will return the instances in the following order: `[ ui5-tab#First, ui5-tab#Nested, ui5-tab#Second, ui5-tab-separator#sep, ui5-tab#Third ]`
   */
