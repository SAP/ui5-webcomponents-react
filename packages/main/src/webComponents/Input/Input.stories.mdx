...
import SuggestionItemDescription from '../SuggestionItem/SuggestionItemDescription.md';
import SuggestionGroupItemDescription from '../SuggestionGroupItem/SuggestionGroupItemDescription.md';
import InputMethods from './InputMethods.md';
...
<SuggestionGroupItemDescription />
