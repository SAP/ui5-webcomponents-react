...
<Canvas>
  <Story
    ...
    argTypes={{
      ...
      info: {
        description: `Defines the <code>info</code>, displayed in the end of the item.`,
      },
      infoState: {
      ...
      text: {
        description: `Defines the text of the <code>SuggestionItem</code>.`,
      },
      type: {
  ...
  >
    {(args) => {
      return (
        <Input
          showSuggestions
          placeholder="click here to show suggestions"
          style={{ width: "400px" }}
        >
          <SuggestionItem {...args} />
