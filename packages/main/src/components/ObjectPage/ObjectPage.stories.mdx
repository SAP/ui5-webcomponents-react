...
## ObjectPage with customizable ObjectPageSection

<Canvas>
  <Story
    name="with customizable ObjectPageSection"
    argTypes={{
      ...
      imageShapeCircle: { table: { disable: true } },
      showHideHeaderButton: { table: { disable: true } },
      onSelectedSectionChanged: { table: { disable: true } },
      selectedSectionId: { table: { disable: true } },
      noHeader: { table: { disable: true } },
      alwaysShowContentHeader: { table: { disable: true } },
      showTitleInHeaderContent: { table: { disable: true } },
      headerContentPinnable: { table: { disable: true } },
      headerContent: { table: { disable: true } },
      breadcrumbs: { table: { disable: true } },
      keyInfos: { table: { disable: true } }
    }}
    args={{
      title: 'customizable ObjectPageSection',
      id: 'custom',
      titleUppercase: false,
      children: `This is a customizable "ObjectPageSection".`,
      style: { height: '150px' }
    }}
  >
    {(args) => {
      return (
        <ObjectPage
          title="ObjectPage"
          subTitle="with customizable ObjectPageSection"
          image={<Avatar backgroundColor={AvatarBackgroundColor.Accent1} icon="wrench" />}
          style={{ height: '400px' }}
        >
          <ObjectPageSection {...args} />
          <ObjectPageSection title="Goals" id="goals">
            <Form columnsL={3} columnsXL={3} labelSpanXL={6} labelSpanL={6} columnsM={2} labelSpanM={6}>
              <FormItem label="Evangelize the UI framework across the company">
                <Text>4 days overdue - Cascaded</Text>
...
<ArgsTable story="with customizable ObjectPageSection" />
