...
import { FlexBoxAlignItems, FlexBoxWrap } from '../..';
  ...
  <Story name="Default">
    {(args) => {
      ...
      return (
        <ObjectPage
          image={SampleImage}
          showTitleInHeaderContent={args.showTitleInHeaderContent}
          title={
            <DynamicPageTitle
              heading={args.title}
              subHeading={args.subTitle}
              actions={args.headerActions}
              breadcrumbs={args.breadcrumbs}
            >
              <div>{args.keyInfos}</div>
            </DynamicPageTitle>
          }
          header={
            <DynamicPageHeader>
