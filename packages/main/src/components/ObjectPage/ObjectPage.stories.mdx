...
import SampleImage from '../../../../../.storybook/demoImages/Person.png';

<Meta
  title="Layouts & Floorplans / ObjectPage"
  component={ObjectPage}
  subcomponents={{ DynamicPageHeader, DynamicPageTitle, ObjectPageSection, ObjectPageSubSection }}
  argTypes={{
    ...
    {(args) => {
      return (
        <ObjectPage {...args}>
          ...
          <ObjectPageSection
            titleText="Employment asd gaskdgah jsgdhjasg jhdgasjhgd hjasgdhj gashdg hjasgdhj agshjdg ashjgd jhasgdjh agshjdgas hjdghja sgdjha sgdhjgashdgasjh gd hjasghjagsjhasg hjgash gahsj gashjghsajg dhjasgd hjasghd gashjdg ashjgdh ajsgdhj asgdhj gashjdg ashjg ashg hasg ajsgjhas gdjhgashj gasjhg sahjg hajsghj asghj asghjas ghjsa"
            id="employment"
...
<Canvas>
  <Story name="with IllustratedMessage">
    {(args) => {
      return (
        <ObjectPage
          image={args.image}
