...
<Meta
  ...
  args={{
    ...
    columns: [
      ...
      { Header: 'Long', accessor: 'longColumn' },
      {
      ...
      { responsivePopIn: true, responsiveMinWidth: 400, Header: 'Friend Name', accessor: 'friend.name' },
      {
        responsivePopIn: true,
        responsiveMinWidth: 600,
        Header: (instance) => {
          //console.log('Header', instance);
          return <span>Friend Age</span>;
        },
        accessor: 'friend.age',
        hAlign: TextAlign.End,
        Cell: (instance) => {
          // console.log('renderer', instance);
      ...
      },
      {
        ...
        canResize: false,
        Cell: ({ cell, row, value }) => {
          // console.log('This is your row data', row.original, cell, value);
          return (
            <FlexBox>
              <Button icon="edit" />
              <Button icon="delete" />
  ...
  argTypes={{
    ...
    visibleRowCountMode: { control: { disable: true } },
  ...
  <Story name="Default">
    {(args) => (
      <div style={{ height: '90vh' }}>
        <AnalyticalTable {...args} reactTableOptions={{ initialState: { hiddenColumns: ['longColumn'] } }} />
      </div>
    )}
  </Story>
</Canvas>
