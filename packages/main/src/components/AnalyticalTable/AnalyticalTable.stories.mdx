...
```js
import { useRowDisableSelection } from '@ui5/webcomponents-react';
```
...
_ES6 Import: `import { useRowDisableSelection } from '@ui5/webcomponents-react';`_
...
_ES6 Import: `import { useIndeterminateRowSelection } from '@ui5/webcomponents-react';`_
      ...
      return (
        ...
        >
          <AnalyticalTable
            ...
            columns={args.columns}
            visibleRows={5}
            calculatePopInRowHeight={args.calculatePopInRowHeight}
