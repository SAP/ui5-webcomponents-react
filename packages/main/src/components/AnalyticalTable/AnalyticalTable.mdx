...
| `sortType`              | `string OR ((rowA, rowB, columnId: string, descending: boolean) => number)` | String or custom **memoized** sort function.<br />Supported String Values: <ul><li>`basic`</li><li>`datetime`</li><li>`alphanumeric`</li></ul><br />**Default:**`'alphanumeric'`                                                                                                                                                                                                                                |
...
| `scaleWidthModeOptions` | `ScaleWidthModeOptions`                                                     | Allows passing a custom string for the internal width calculation of custom cells for `scaleWidthMode` `Grow` and `Smart`. More <link href="https://sap.github.io/ui5-webcomponents-react/?path=/docs/data-display-analyticaltable-recipes--docs#how-to-scale-custom-cells">here</link>                                                                                                                         |
