...
const columnsDeps = (deps, { instance }) => {
  return [
    ...deps,
    instance.state.tableClientWidth,
    instance.webComponentsReactProperties.scaleWidthMode,
    instance.webComponentsReactProperties.loading
  ];
};
