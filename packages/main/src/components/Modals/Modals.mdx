...
import { Dialog, Menu, Panel, Popover, ResponsivePopover, Toast } from '../../webComponents';
...
<Canvas>
  <Story of={ComponentStories.Dialog} />
</Canvas>
...
<Canvas>
  <Story of={ComponentStories.Popover} />
</Canvas>
...
<Canvas>
  <Story of={ComponentStories.ResponsivePopover} />
</Canvas>
...
<Canvas>
  <Story of={ComponentStories.Menu} />
</Canvas>
...
<Canvas>
  <Story of={ComponentStories.MessageBox} />
</Canvas>
...
<Canvas>
  <ArgTypes of={ComponentStories.Toast} />
</Canvas>
