...
## With custom actions and navigationActions overflow button

With the `actionsOverflowButton` and the `navigationActionsOverflowButton` it is possible to change the overflow button of the respective actions toolbar.
        ...
        <>
          ...
          <DynamicPage
            ...
            headerTitle={
              <DynamicPageTitle
                {...titleProps}
                header={<Title>Custom overflow buttons for navigationActions and actions (width: 1300px)</Title>}
              />
            }
          />
        </>
