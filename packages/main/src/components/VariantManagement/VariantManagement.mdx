...
This example shows how a basic implementation of the `VariantManagement` inside a `FilterBar`. For a more in depth documentation you can take a look at the official [Fiori for Web Design Guidelines](https://experience.sap.com/fiori-design-web/variant-management/).
