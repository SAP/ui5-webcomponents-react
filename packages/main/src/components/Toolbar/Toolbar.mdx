...
import { OverflowToolbarButton, OverflowToolbarToggleButton, MessageStrip, MessageStripDesign, Text } from '../..';
...
<MessageStrip
  ...
  children={
    <>
      This component will be replaced by the <code>ui5-toolbar</code> web-component (currently available as{' '}
      <code>ToolbarV2</code>) with our next major release. Please use <code>ToolbarV2</code> instead.
    </>
  }
/>
