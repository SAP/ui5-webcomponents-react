...
| --------------------------------------------------------------------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------- |
| **applyFocus**                                                                    | &mdash;    | Focuses the element denoted by                                                                                            |
| <code>initialFocus</code>, if provided, or the first focusable element otherwise. |
...
| **show**                                                                          | <dl>       |
    ...
    <dt className="methodText">**preventInitialFocus** _optional_</dt>
    <dd className="methodText">prevents applying the focus inside the popup</dd>
    <dd><code>boolean</code></dd>

</dl> | Shows the block layer (for modal popups only) and sets the correct z-index for the purpose of popup stacking              |
